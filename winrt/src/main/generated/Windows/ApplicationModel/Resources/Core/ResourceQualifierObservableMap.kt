...
@ABIMarker(ResourceQualifierObservableMap.ABI::class)
@Signature("rc(Windows.ApplicationModel.Resources.Core.ResourceQualifierObservableMap;pinterface({65df2bf5-bf39-41b5-aebc-5a9d865e472b};string;string))")
@WinRTByReference(brClass = ResourceQualifierObservableMap.ByReference::class)
public class ResourceQualifierObservableMap(
  ptr: JNAPointer? = NULL
) : PointerType(ptr), IObservableMap<String?, String?>, IMap<String?, String?>,
    IIterable<IKeyValuePair<String?, String?>?>, IWinRTObject {
  ...
  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1606815573_Interface, __8028824_Interface, __1449643190_Interface)
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<ResourceQualifierObservableMap> {
    public override fun getValue() = ResourceQualifierObservableMap(pointer.getPointer(0))

    public fun setValue(value: ResourceQualifierObservableMap): Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  public object ABI : IABI<ResourceQualifierObservableMap, MemoryAddress> {
    public override val layout: MemoryLayout = ValueLayout.ADDRESS

    public override fun fromNative(segment: MemoryAddress): ResourceQualifierObservableMap {
      val address = segment.toRawLongValue()
      return ResourceQualifierObservableMap(Pointer(address))
    }

    public override fun toNative(obj: ResourceQualifierObservableMap): MemoryAddress =
