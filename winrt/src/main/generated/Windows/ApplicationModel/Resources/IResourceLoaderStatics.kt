...
@Signature("{bf777ce1-19c8-49c2-953c-47e9227b334e}")
@Guid("bf777ce119c849c2953c47e9227b334e")
@WinRTInterface("bf777ce119c849c2953c47e9227b334e")
...
public interface IResourceLoaderStatics : NativeMapped, IWinRTInterface {
  @InterfaceMethod(0)
  public fun GetStringForReference(uri: Uri?): String?
  ...
  public interface WithDefault : IResourceLoaderStatics {
    public val __176190550_Ptr: Pointer?

    public val _176190550_VtblPtr: Pointer?
      get() = __176190550_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun GetStringForReference(uri: Uri?): String? {
      val fnPtr = _176190550_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__176190550_Ptr, marshalToNative(uri), result))
      if (hr.toInt() != 0) {
  ...
  public class IResourceLoaderStatics_Impl(
    ...
    public override val __176190550_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IResourceLoaderStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("bf777ce119c849c2953c47e9227b334e")
    ...
    public override fun toNative(obj: IResourceLoaderStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__176190550_Ptr))
  }
