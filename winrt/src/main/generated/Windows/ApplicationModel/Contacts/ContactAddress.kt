...
@Signature("rc(Windows.ApplicationModel.Contacts.ContactAddress;{9739d39a-42ce-4872-8d70-3063aa584b70})")
@WinRTByReference(brClass = ContactAddress.ByReference::class)
public class ContactAddress(
  ptr: JNAPointer? = NULL
) : PointerType(ptr), IContactAddress.WithDefault, IWinRTObject {
  private val __1484325792_Interface: IContactAddress.WithDefault by lazy {
    as_1484325792()
  }


  public override val __1484325792_Ptr: JNAPointer? by lazy {
    __1484325792_Interface.__1484325792_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1484325792_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1484325792(): IContactAddress.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<ContactAddress, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Windows.ApplicationModel.Contacts.ContactAddress".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
