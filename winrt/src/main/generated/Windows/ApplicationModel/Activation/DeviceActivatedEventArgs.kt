...
@ABIMarker(DeviceActivatedEventArgs.ABI::class)
@Signature("rc(Windows.ApplicationModel.Activation.DeviceActivatedEventArgs;{cd50b9a9-ce10-44d2-8234-c355a073ef33})")
@WinRTByReference(brClass = DeviceActivatedEventArgs.ByReference::class)
public class DeviceActivatedEventArgs(
  ptr: JNAPointer? = NULL
  ...
  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__475441349_Interface, __1721660047_Interface, __1142708526_Interface,
        __1905429824_Interface, __988512_Interface)
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<DeviceActivatedEventArgs> {
    public override fun getValue() = DeviceActivatedEventArgs(pointer.getPointer(0))

    public fun setValue(value: DeviceActivatedEventArgs): Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  public object ABI : IABI<DeviceActivatedEventArgs, MemoryAddress> {
    public override val layout: MemoryLayout = ValueLayout.ADDRESS

    public override fun fromNative(segment: MemoryAddress): DeviceActivatedEventArgs {
      val address = segment.toRawLongValue()
      return DeviceActivatedEventArgs(Pointer(address))
    }

    public override fun toNative(obj: DeviceActivatedEventArgs): MemoryAddress =
