...
@ABIMarker(FileSavePickerContinuationEventArgs.ABI::class)
@Signature("rc(Windows.ApplicationModel.Activation.FileSavePickerContinuationEventArgs;{2c846fe1-3bad-4f33-8c8b-e46fae824b4b})")
@WinRTByReference(brClass = FileSavePickerContinuationEventArgs.ByReference::class)
public class FileSavePickerContinuationEventArgs(
  ptr: JNAPointer? = NULL
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<FileSavePickerContinuationEventArgs> {
    public override fun getValue() = FileSavePickerContinuationEventArgs(pointer.getPointer(0))

    public fun setValue(value: FileSavePickerContinuationEventArgs): Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  public object ABI : IABI<FileSavePickerContinuationEventArgs, MemoryAddress> {
    public override val layout: MemoryLayout = ValueLayout.ADDRESS

    public override fun fromNative(segment: MemoryAddress): FileSavePickerContinuationEventArgs {
      val address = segment.toRawLongValue()
      return FileSavePickerContinuationEventArgs(Pointer(address))
    }

    public override fun toNative(obj: FileSavePickerContinuationEventArgs): MemoryAddress =
