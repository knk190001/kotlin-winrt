...
@ABIMarker(FileSavePickerActivatedEventArgs.ABI::class)
@Signature("rc(Windows.ApplicationModel.Activation.FileSavePickerActivatedEventArgs;{81c19cf1-74e6-4387-82eb-bb8fd64b4346})")
@WinRTByReference(brClass = FileSavePickerActivatedEventArgs.ByReference::class)
public class FileSavePickerActivatedEventArgs(
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<FileSavePickerActivatedEventArgs> {
    public override fun getValue() = FileSavePickerActivatedEventArgs(pointer.getPointer(0))

    public fun setValue(value: FileSavePickerActivatedEventArgs): Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  public object ABI : IABI<FileSavePickerActivatedEventArgs, MemoryAddress> {
    public override val layout: MemoryLayout = ValueLayout.ADDRESS

    public override fun fromNative(segment: MemoryAddress): FileSavePickerActivatedEventArgs {
      val address = segment.toRawLongValue()
      return FileSavePickerActivatedEventArgs(Pointer(address))
    }

    public override fun toNative(obj: FileSavePickerActivatedEventArgs): MemoryAddress =
