...
@ABIMarker(VoiceCommandActivatedEventArgs.ABI::class)
@Signature("rc(Windows.ApplicationModel.Activation.VoiceCommandActivatedEventArgs;{ab92dcfd-8d43-4de6-9775-20704b581b00})")
@WinRTByReference(brClass = VoiceCommandActivatedEventArgs.ByReference::class)
public class VoiceCommandActivatedEventArgs(
  ptr: JNAPointer? = NULL
  ...
  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1715149144_Interface, __1721660047_Interface, __988512_Interface)
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<VoiceCommandActivatedEventArgs> {
    public override fun getValue() = VoiceCommandActivatedEventArgs(pointer.getPointer(0))

    public fun setValue(value: VoiceCommandActivatedEventArgs): Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  public object ABI : IABI<VoiceCommandActivatedEventArgs, MemoryAddress> {
    public override val layout: MemoryLayout = ValueLayout.ADDRESS

    public override fun fromNative(segment: MemoryAddress): VoiceCommandActivatedEventArgs {
      val address = segment.toRawLongValue()
      return VoiceCommandActivatedEventArgs(Pointer(address))
    }

    public override fun toNative(obj: VoiceCommandActivatedEventArgs): MemoryAddress =
