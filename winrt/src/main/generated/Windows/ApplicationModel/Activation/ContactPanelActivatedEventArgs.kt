...
@ABIMarker(ContactPanelActivatedEventArgs.ABI::class)
@Signature("rc(Windows.ApplicationModel.Activation.ContactPanelActivatedEventArgs;{52bb63e4-d3d4-4b63-8051-4af2082cab80})")
@WinRTByReference(brClass = ContactPanelActivatedEventArgs.ByReference::class)
public class ContactPanelActivatedEventArgs(
  ptr: JNAPointer? = NULL
  ...
  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1331992077_Interface, __1721660047_Interface, __988512_Interface)
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<ContactPanelActivatedEventArgs> {
    public override fun getValue() = ContactPanelActivatedEventArgs(pointer.getPointer(0))

    public fun setValue(value: ContactPanelActivatedEventArgs): Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  public object ABI : IABI<ContactPanelActivatedEventArgs, MemoryAddress> {
    public override val layout: MemoryLayout = ValueLayout.ADDRESS

    public override fun fromNative(segment: MemoryAddress): ContactPanelActivatedEventArgs {
      val address = segment.toRawLongValue()
      return ContactPanelActivatedEventArgs(Pointer(address))
    }

    public override fun toNative(obj: ContactPanelActivatedEventArgs): MemoryAddress =
