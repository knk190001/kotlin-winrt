...
@ABIMarker(ActivationKind.ABI::class)
@Signature("enum(Windows.ApplicationModel.Activation.ActivationKind;i4)")
@WinRTByReference(brClass = ActivationKind.ByReference::class)
public enum class ActivationKind(
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(4), IByReference<ActivationKind> {
    public fun setValue(newValue: ActivationKind): Unit {
      pointer.setInt(0, newValue.value)
    }

    public override fun getValue(): ActivationKind =
        ActivationKind.values()[0].fromNative(this.pointer.getInt(0), null)
  }

  public object ABI : IABI<ActivationKind, Int> {
    public override val layout: ValueLayout = JAVA_INT

    public override fun fromNative(value: Int): ActivationKind =
        ActivationKind.values()[0].fromNative(value, null)

    public override fun toNative(obj: ActivationKind): Int = obj.value
  }
}
