...
@ABIMarker(ContactPostActivatedEventArgs.ABI::class)
@Signature("rc(Windows.ApplicationModel.Activation.ContactPostActivatedEventArgs;{b35a3c67-f1e7-4655-ad6e-4857588f552f})")
@WinRTByReference(brClass = ContactPostActivatedEventArgs.ByReference::class)
public class ContactPostActivatedEventArgs(
  ptr: JNAPointer? = NULL
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<ContactPostActivatedEventArgs> {
    public override fun getValue() = ContactPostActivatedEventArgs(pointer.getPointer(0))

    public fun setValue(value: ContactPostActivatedEventArgs): Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  public object ABI : IABI<ContactPostActivatedEventArgs, MemoryAddress> {
    public override val layout: MemoryLayout = ValueLayout.ADDRESS

    public override fun fromNative(segment: MemoryAddress): ContactPostActivatedEventArgs {
      val address = segment.toRawLongValue()
      return ContactPostActivatedEventArgs(Pointer(address))
    }

    public override fun toNative(obj: ContactPostActivatedEventArgs): MemoryAddress =
