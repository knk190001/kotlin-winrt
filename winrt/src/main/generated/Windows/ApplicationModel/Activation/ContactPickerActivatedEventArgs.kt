...
@ABIMarker(ContactPickerActivatedEventArgs.ABI::class)
@Signature("rc(Windows.ApplicationModel.Activation.ContactPickerActivatedEventArgs;{ce57aae7-6449-45a7-971f-d113be7a8936})")
@WinRTByReference(brClass = ContactPickerActivatedEventArgs.ByReference::class)
public class ContactPickerActivatedEventArgs(
  ptr: JNAPointer? = NULL
  ...
  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__54142709_Interface, __1721660047_Interface)
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<ContactPickerActivatedEventArgs> {
    public override fun getValue() = ContactPickerActivatedEventArgs(pointer.getPointer(0))

    public fun setValue(value: ContactPickerActivatedEventArgs): Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  public object ABI : IABI<ContactPickerActivatedEventArgs, MemoryAddress> {
    public override val layout: MemoryLayout = ValueLayout.ADDRESS

    public override fun fromNative(segment: MemoryAddress): ContactPickerActivatedEventArgs {
      val address = segment.toRawLongValue()
      return ContactPickerActivatedEventArgs(Pointer(address))
    }

    public override fun toNative(obj: ContactPickerActivatedEventArgs): MemoryAddress =
