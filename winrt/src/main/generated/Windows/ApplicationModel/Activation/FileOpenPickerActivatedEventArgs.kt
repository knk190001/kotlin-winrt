...
@ABIMarker(FileOpenPickerActivatedEventArgs.ABI::class)
@Signature("rc(Windows.ApplicationModel.Activation.FileOpenPickerActivatedEventArgs;{72827082-5525-4bf2-bc09-1f5095d4964d})")
@WinRTByReference(brClass = FileOpenPickerActivatedEventArgs.ByReference::class)
public class FileOpenPickerActivatedEventArgs(
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<FileOpenPickerActivatedEventArgs> {
    public override fun getValue() = FileOpenPickerActivatedEventArgs(pointer.getPointer(0))

    public fun setValue(value: FileOpenPickerActivatedEventArgs): Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  public object ABI : IABI<FileOpenPickerActivatedEventArgs, MemoryAddress> {
    public override val layout: MemoryLayout = ValueLayout.ADDRESS

    public override fun fromNative(segment: MemoryAddress): FileOpenPickerActivatedEventArgs {
      val address = segment.toRawLongValue()
      return FileOpenPickerActivatedEventArgs(Pointer(address))
    }

    public override fun toNative(obj: FileOpenPickerActivatedEventArgs): MemoryAddress =
