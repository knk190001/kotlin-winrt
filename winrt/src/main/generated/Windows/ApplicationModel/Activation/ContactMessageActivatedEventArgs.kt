...
@ABIMarker(ContactMessageActivatedEventArgs.ABI::class)
@Signature("rc(Windows.ApplicationModel.Activation.ContactMessageActivatedEventArgs;{de598db2-0e03-43b0-bf56-bcc40b3162df})")
@WinRTByReference(brClass = ContactMessageActivatedEventArgs.ByReference::class)
public class ContactMessageActivatedEventArgs(
  ptr: JNAPointer? = NULL
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<ContactMessageActivatedEventArgs> {
    public override fun getValue() = ContactMessageActivatedEventArgs(pointer.getPointer(0))

    public fun setValue(value: ContactMessageActivatedEventArgs): Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  public object ABI : IABI<ContactMessageActivatedEventArgs, MemoryAddress> {
    public override val layout: MemoryLayout = ValueLayout.ADDRESS

    public override fun fromNative(segment: MemoryAddress): ContactMessageActivatedEventArgs {
      val address = segment.toRawLongValue()
      return ContactMessageActivatedEventArgs(Pointer(address))
    }

    public override fun toNative(obj: ContactMessageActivatedEventArgs): MemoryAddress =
