...
@ABIMarker(PrintTaskSettingsActivatedEventArgs.ABI::class)
@Signature("rc(Windows.ApplicationModel.Activation.PrintTaskSettingsActivatedEventArgs;{ee30a0c9-ce56-4865-ba8e-8954ac271107})")
@WinRTByReference(brClass = PrintTaskSettingsActivatedEventArgs.ByReference::class)
public class PrintTaskSettingsActivatedEventArgs(
  ptr: JNAPointer? = NULL
  ...
  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1889950994_Interface, __1721660047_Interface)
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<PrintTaskSettingsActivatedEventArgs> {
    public override fun getValue() = PrintTaskSettingsActivatedEventArgs(pointer.getPointer(0))

    public fun setValue(value: PrintTaskSettingsActivatedEventArgs): Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  public object ABI : IABI<PrintTaskSettingsActivatedEventArgs, MemoryAddress> {
    public override val layout: MemoryLayout = ValueLayout.ADDRESS

    public override fun fromNative(segment: MemoryAddress): PrintTaskSettingsActivatedEventArgs {
      val address = segment.toRawLongValue()
      return PrintTaskSettingsActivatedEventArgs(Pointer(address))
    }

    public override fun toNative(obj: PrintTaskSettingsActivatedEventArgs): MemoryAddress =
