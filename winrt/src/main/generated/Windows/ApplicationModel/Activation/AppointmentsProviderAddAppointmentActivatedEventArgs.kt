...
@ABIMarker(AppointmentsProviderAddAppointmentActivatedEventArgs.ABI::class)
@Signature("rc(Windows.ApplicationModel.Activation.AppointmentsProviderAddAppointmentActivatedEventArgs;{a2861367-cee5-4e4d-9ed7-41c34ec18b02})")
@WinRTByReference(brClass = AppointmentsProviderAddAppointmentActivatedEventArgs.ByReference::class)
public class AppointmentsProviderAddAppointmentActivatedEventArgs(
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<AppointmentsProviderAddAppointmentActivatedEventArgs> {
    public override fun getValue() =
        AppointmentsProviderAddAppointmentActivatedEventArgs(pointer.getPointer(0))

    public fun setValue(value: AppointmentsProviderAddAppointmentActivatedEventArgs): Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  public object ABI : IABI<AppointmentsProviderAddAppointmentActivatedEventArgs, MemoryAddress> {
    public override val layout: MemoryLayout = ValueLayout.ADDRESS

    public override fun fromNative(segment: MemoryAddress):
        AppointmentsProviderAddAppointmentActivatedEventArgs {
      val address = segment.toRawLongValue()
      return AppointmentsProviderAddAppointmentActivatedEventArgs(Pointer(address))
    }

    public override fun toNative(obj: AppointmentsProviderAddAppointmentActivatedEventArgs):
