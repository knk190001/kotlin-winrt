...
@ABIMarker(PropertySet.ABI::class)
@Signature("rc(Windows.Foundation.Collections.PropertySet;{8a43ed9f-f4e6-4421-acf9-1dab2986820c})")
@WinRTByReference(brClass = PropertySet.ByReference::class)
public class PropertySet(
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE), IByReference<PropertySet> {
    public override fun getValue() = PropertySet(pointer.getPointer(0))
  ...
  public object ABI : IABI<PropertySet, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Windows.Foundation.Collections.PropertySet".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public override fun fromNative(segment: MemoryAddress): PropertySet {
      val address = segment.toRawLongValue()
      return PropertySet(Pointer(address))
    }

    public override fun toNative(obj: PropertySet): MemoryAddress =
