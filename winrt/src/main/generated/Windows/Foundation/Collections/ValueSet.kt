...
@ABIMarker(ValueSet.ABI::class)
@Signature("rc(Windows.Foundation.Collections.ValueSet;{8a43ed9f-f4e6-4421-acf9-1dab2986820c})")
@WinRTByReference(brClass = ValueSet.ByReference::class)
public class ValueSet(
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE), IByReference<ValueSet> {
    public override fun getValue() = ValueSet(pointer.getPointer(0))
  ...
  public object ABI : IABI<ValueSet, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr = INSTANCE.RoGetActivationFactory("Windows.Foundation.Collections.ValueSet".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public override fun fromNative(segment: MemoryAddress): ValueSet {
      val address = segment.toRawLongValue()
      return ValueSet(Pointer(address))
    }

    public override fun toNative(obj: ValueSet): MemoryAddress =
