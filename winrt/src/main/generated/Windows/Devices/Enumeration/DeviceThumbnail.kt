...
@ABIMarker(DeviceThumbnail.ABI::class)
@Signature("rc(Windows.Devices.Enumeration.DeviceThumbnail;{cc254827-4b3d-438f-9232-10c76bc7e038})")
@WinRTByReference(brClass = DeviceThumbnail.ByReference::class)
public class DeviceThumbnail(
  ptr: JNAPointer? = NULL
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<DeviceThumbnail> {
    public override fun getValue() = DeviceThumbnail(pointer.getPointer(0))

    public fun setValue(value: DeviceThumbnail): Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  public object ABI : IABI<DeviceThumbnail, MemoryAddress> {
    public override val layout: MemoryLayout = ValueLayout.ADDRESS

    public override fun fromNative(segment: MemoryAddress): DeviceThumbnail {
      val address = segment.toRawLongValue()
      return DeviceThumbnail(Pointer(address))
    }

    public override fun toNative(obj: DeviceThumbnail): MemoryAddress =
