...
@ABIMarker(SendSmsMessageOperation.ABI::class)
@Signature("rc(Windows.Devices.Sms.SendSmsMessageOperation;{5a648006-843a-4da9-865b-9d26e5dfad7b})")
@WinRTByReference(brClass = SendSmsMessageOperation.ByReference::class)
public class SendSmsMessageOperation(
  ptr: JNAPointer? = NULL
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<SendSmsMessageOperation> {
    public override fun getValue() = SendSmsMessageOperation(pointer.getPointer(0))

    public fun setValue(value: SendSmsMessageOperation): Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  public object ABI : IABI<SendSmsMessageOperation, MemoryAddress> {
    public override val layout: MemoryLayout = ValueLayout.ADDRESS

    public override fun fromNative(segment: MemoryAddress): SendSmsMessageOperation {
      val address = segment.toRawLongValue()
      return SendSmsMessageOperation(Pointer(address))
    }

    public override fun toNative(obj: SendSmsMessageOperation): MemoryAddress =
