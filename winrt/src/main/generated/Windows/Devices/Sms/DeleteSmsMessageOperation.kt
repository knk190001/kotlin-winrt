...
@ABIMarker(DeleteSmsMessageOperation.ABI::class)
@Signature("rc(Windows.Devices.Sms.DeleteSmsMessageOperation;{5a648006-843a-4da9-865b-9d26e5dfad7b})")
@WinRTByReference(brClass = DeleteSmsMessageOperation.ByReference::class)
public class DeleteSmsMessageOperation(
  ptr: JNAPointer? = NULL
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<DeleteSmsMessageOperation> {
    public override fun getValue() = DeleteSmsMessageOperation(pointer.getPointer(0))

    public fun setValue(value: DeleteSmsMessageOperation): Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  public object ABI : IABI<DeleteSmsMessageOperation, MemoryAddress> {
    public override val layout: MemoryLayout = ValueLayout.ADDRESS

    public override fun fromNative(segment: MemoryAddress): DeleteSmsMessageOperation {
      val address = segment.toRawLongValue()
      return DeleteSmsMessageOperation(Pointer(address))
    }

    public override fun toNative(obj: DeleteSmsMessageOperation): MemoryAddress =
