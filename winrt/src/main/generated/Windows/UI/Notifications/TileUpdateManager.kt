...
@ABIMarker(TileUpdateManager.ABI::class)
@WinRTByReference(brClass = TileUpdateManager.ByReference::class)
public class TileUpdateManager(
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<TileUpdateManager> {
    public override fun getValue() = TileUpdateManager(pointer.getPointer(0))
  ...
  public object ABI : IABI<TileUpdateManager, MemoryAddress> {
    ...
    public override fun fromNative(segment: MemoryAddress): TileUpdateManager {
      val address = segment.toRawLongValue()
      return TileUpdateManager(Pointer(address))
    }

    public override fun toNative(obj: TileUpdateManager): MemoryAddress =
