...
@Signature("rc(Windows.UI.WindowManagement.AppWindowChangedEventArgs;{1de1f3be-a655-55ad-b2b6-eb240f880356})")
@WinRTByReference(brClass = AppWindowChangedEventArgs.ByReference::class)
public class AppWindowChangedEventArgs(
  ptr: JNAPointer? = NULL
) : PointerType(ptr), IAppWindowChangedEventArgs.WithDefault, IWinRTObject {
  private val __714238861_Interface: IAppWindowChangedEventArgs.WithDefault by lazy {
    as_714238861()
  }


  public override val __714238861_Ptr: JNAPointer? by lazy {
    __714238861_Interface.__714238861_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__714238861_Interface)

  private fun as_714238861(): IAppWindowChangedEventArgs.WithDefault {
    if(pointer == NULL) {
