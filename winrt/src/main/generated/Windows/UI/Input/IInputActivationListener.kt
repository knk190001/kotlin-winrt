...
@Signature("{5d6d4ed2-28c7-5ae3-aa74-c918a9f243ca}")
@Guid("5d6d4ed228c75ae3aa74c918a9f243ca")
@WinRTInterface("5d6d4ed228c75ae3aa74c918a9f243ca")
...
public interface IInputActivationListener : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IInputActivationListener {
    public val __1023372090_Ptr: Pointer?

    public val _1023372090_VtblPtr: Pointer?
      get() = __1023372090_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_State(): InputActivationState? {
      val fnPtr = _1023372090_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<InputActivationState>()
      val hr = fn.invokeHR(arrayOf(__1023372090_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override
        ...
        InputActivationListenerActivationChangedEventArgs?>?): EventRegistrationToken? {
      val fnPtr = _1023372090_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__1023372090_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun remove_InputActivationChanged(token: EventRegistrationToken?): Unit {
      val fnPtr = _1023372090_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1023372090_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IInputActivationListener_Impl(
    ...
    public override val __1023372090_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IInputActivationListener, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("5d6d4ed228c75ae3aa74c918a9f243ca")
    ...
    public override fun toNative(obj: IInputActivationListener): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1023372090_Ptr))
  }
