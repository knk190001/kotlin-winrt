...
@Signature("{7699b465-1dcf-5791-b4b9-6cafbeed2056}")
@Guid("7699b4651dcf5791b4b96cafbeed2056")
@WinRTInterface("7699b4651dcf5791b4b96cafbeed2056")
...
public interface IInputActivationListenerActivationChangedEventArgs : NativeMapped, IWinRTInterface
  ...
  public interface WithDefault : IInputActivationListenerActivationChangedEventArgs {
    public val __1079156513_Ptr: Pointer?

    public val _1079156513_VtblPtr: Pointer?
      get() = __1079156513_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_State(): InputActivationState? {
      val fnPtr = _1079156513_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<InputActivationState>()
      val hr = fn.invokeHR(arrayOf(__1079156513_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IInputActivationListenerActivationChangedEventArgs_Impl(
    ...
    public override val __1079156513_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IInputActivationListenerActivationChangedEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("7699b4651dcf5791b4b96cafbeed2056")
