...
@Signature("{c79d8a4b-c163-4ee7-803f-67ce79f9972d}")
@Guid("c79d8a4bc1634ee7803f67ce79f9972d")
@WinRTInterface("c79d8a4bc1634ee7803f67ce79f9972d")
...
public interface IPointerPointProperties : NativeMapped, IWinRTInterface {
  ...
  @InterfaceMethod(8)
  public fun get_ContactRectRaw(): Rect?
  ...
  @InterfaceMethod(22)
  public fun HasUsage(usagePage: WinDef.UINT, usageId: WinDef.UINT): Boolean

  @InterfaceMethod(23)
  public fun GetUsageValue(usagePage: WinDef.UINT, usageId: WinDef.UINT): Int
  ...
  public interface WithDefault : IPointerPointProperties {
    public val __1702657740_Ptr: Pointer?

    public val _1702657740_VtblPtr: Pointer?
      get() = __1702657740_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Pressure(): Float {
      val fnPtr = _1702657740_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__1702657740_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsInverted(): Boolean {
      val fnPtr = _1702657740_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_IsEraser(): Boolean {
      val fnPtr = _1702657740_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1702657740_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Orientation(): Float {
      val fnPtr = _1702657740_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__1702657740_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_XTilt(): Float {
      val fnPtr = _1702657740_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__1702657740_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_YTilt(): Float {
      val fnPtr = _1702657740_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__1702657740_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Twist(): Float {
      val fnPtr = _1702657740_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__1702657740_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ContactRect(): Rect? {
      val fnPtr = _1702657740_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    @InterfaceMethod(8)
    public override fun get_ContactRectRaw(): Rect? {
      val fnPtr = _1702657740_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Rect>()
      val hr = fn.invokeHR(arrayOf(__1702657740_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_TouchConfidence(): Boolean {
      val fnPtr = _1702657740_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1702657740_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsLeftButtonPressed(): Boolean {
      val fnPtr = _1702657740_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1702657740_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsRightButtonPressed(): Boolean {
      val fnPtr = _1702657740_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1702657740_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsMiddleButtonPressed(): Boolean {
      val fnPtr = _1702657740_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1702657740_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_MouseWheelDelta(): Int {
      val fnPtr = _1702657740_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_IsHorizontalMouseWheel(): Boolean {
      val fnPtr = _1702657740_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1702657740_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsPrimary(): Boolean {
      val fnPtr = _1702657740_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1702657740_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsInRange(): Boolean {
      val fnPtr = _1702657740_VtblPtr!!.getPointer(22L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1702657740_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsCanceled(): Boolean {
      val fnPtr = _1702657740_VtblPtr!!.getPointer(23L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1702657740_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsBarrelButtonPressed(): Boolean {
      val fnPtr = _1702657740_VtblPtr!!.getPointer(24L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1702657740_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsXButton1Pressed(): Boolean {
      val fnPtr = _1702657740_VtblPtr!!.getPointer(25L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1702657740_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsXButton2Pressed(): Boolean {
      val fnPtr = _1702657740_VtblPtr!!.getPointer(26L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1702657740_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_PointerUpdateKind(): PointerUpdateKind? {
      val fnPtr = _1702657740_VtblPtr!!.getPointer(27L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    @InterfaceMethod(22)
    public override fun HasUsage(usagePage: WinDef.UINT, usageId: WinDef.UINT): Boolean {
      val fnPtr = _1702657740_VtblPtr!!.getPointer(28L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1702657740_Ptr, usagePage, usageId, result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
      val resultValue = marshalFromNative<Boolean>(result.getValue())
    ...
    @InterfaceMethod(23)
    public override fun GetUsageValue(usagePage: WinDef.UINT, usageId: WinDef.UINT): Int {
      val fnPtr = _1702657740_VtblPtr!!.getPointer(29L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__1702657740_Ptr, usagePage, usageId, result))
      if (hr.toInt() != 0) {
  ...
  public class IPointerPointProperties_Impl(
    ...
    public override val __1702657740_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPointerPointProperties, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("c79d8a4bc1634ee7803f67ce79f9972d")
    ...
    public override fun toNative(obj: IPointerPointProperties): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1702657740_Ptr))
  }
