...
@Signature("{a7263939-a17b-4011-99fd-b5c24f143748}")
@Guid("a7263939a17b401199fdb5c24f143748")
@WinRTInterface("a7263939a17b401199fdb5c24f143748")
...
public interface IInteractionTrackerInteractingStateEnteredArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IInteractionTrackerInteractingStateEnteredArgs {
    public val __84384244_Ptr: Pointer?

    public val _84384244_VtblPtr: Pointer?
      get() = __84384244_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_RequestId(): Int {
      val fnPtr = _84384244_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__84384244_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IInteractionTrackerInteractingStateEnteredArgs_Impl(
    ...
    public override val __84384244_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IInteractionTrackerInteractingStateEnteredArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("a7263939a17b401199fdb5c24f143748")
    ...
    public override fun toNative(obj: IInteractionTrackerInteractingStateEnteredArgs): MemoryAddress
        = MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__84384244_Ptr))
  }
