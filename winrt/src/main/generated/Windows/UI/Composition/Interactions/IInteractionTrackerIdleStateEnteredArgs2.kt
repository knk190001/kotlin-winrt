...
@Signature("{f2e771ed-b803-5137-9435-1c96e48721e9}")
@Guid("f2e771edb803513794351c96e48721e9")
@WinRTInterface("f2e771edb803513794351c96e48721e9")
...
public interface IInteractionTrackerIdleStateEnteredArgs2 : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IInteractionTrackerIdleStateEnteredArgs2 {
    public val __599059584_Ptr: Pointer?

    public val _599059584_VtblPtr: Pointer?
      get() = __599059584_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_IsFromBinding(): Boolean {
      val fnPtr = _599059584_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__599059584_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IInteractionTrackerIdleStateEnteredArgs2_Impl(
    ...
    public override val __599059584_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IInteractionTrackerIdleStateEnteredArgs2, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("f2e771edb803513794351c96e48721e9")
    ...
    public override fun toNative(obj: IInteractionTrackerIdleStateEnteredArgs2): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__599059584_Ptr))
  }
