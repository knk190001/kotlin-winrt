...
@Signature("{b1eb32f6-c26c-41f6-a189-fabc22b323cc}")
@Guid("b1eb32f6c26c41f6a189fabc22b323cc")
@WinRTInterface("b1eb32f6c26c41f6a189fabc22b323cc")
...
public interface IInteractionTrackerInertiaStateEnteredArgs2 : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IInteractionTrackerInertiaStateEnteredArgs2 {
    public val __1659310896_Ptr: Pointer?

    public val _1659310896_VtblPtr: Pointer?
      get() = __1659310896_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_IsInertiaFromImpulse(): Boolean {
      val fnPtr = _1659310896_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1659310896_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IInteractionTrackerInertiaStateEnteredArgs2_Impl(
    ...
    public override val __1659310896_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IInteractionTrackerInertiaStateEnteredArgs2, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("b1eb32f6c26c41f6a189fabc22b323cc")
    ...
    public override fun toNative(obj: IInteractionTrackerInertiaStateEnteredArgs2): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1659310896_Ptr))
  }
