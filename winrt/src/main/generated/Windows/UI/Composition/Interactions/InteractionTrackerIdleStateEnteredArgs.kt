...
@Signature("rc(Windows.UI.Composition.Interactions.InteractionTrackerIdleStateEnteredArgs;{50012faa-1510-4142-a1a5-019b09f8857b})")
...
public class InteractionTrackerIdleStateEnteredArgs(
  ...
  private val __1820439822_Interface: IInteractionTrackerIdleStateEnteredArgs.WithDefault by lazy {
    as_1820439822()
  }


  private val __599059584_Interface: IInteractionTrackerIdleStateEnteredArgs2.WithDefault by lazy {
    as_599059584()
  }


  public override val __1820439822_Ptr: JNAPointer? by lazy {
    __1820439822_Interface.__1820439822_Ptr
  }


  public override val __599059584_Ptr: JNAPointer? by lazy {
    __599059584_Interface.__599059584_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1820439822_Interface, __599059584_Interface)

  private fun as_1820439822(): IInteractionTrackerIdleStateEnteredArgs.WithDefault {
    if(pointer == NULL) {
  ...
  private fun as_599059584(): IInteractionTrackerIdleStateEnteredArgs2.WithDefault {
    if(pointer == NULL) {
