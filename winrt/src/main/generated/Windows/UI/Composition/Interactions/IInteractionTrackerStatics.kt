...
@Signature("{bba5d7b7-6590-4498-8d6c-eb62b514c92a}")
@Guid("bba5d7b7659044988d6ceb62b514c92a")
@WinRTInterface("bba5d7b7659044988d6ceb62b514c92a")
...
public interface IInteractionTrackerStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IInteractionTrackerStatics {
    public val __821397878_Ptr: Pointer?

    public val _821397878_VtblPtr: Pointer?
      get() = __821397878_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun Create(compositor: Compositor?): InteractionTracker? {
      val fnPtr = _821397878_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<InteractionTracker>()
      val hr = fn.invokeHR(arrayOf(__821397878_Ptr, marshalToNative(compositor), result))
      if (hr.toInt() != 0) {
    ...
    public override fun CreateWithOwner(compositor: Compositor?, owner: IInteractionTrackerOwner?):
        InteractionTracker? {
      val fnPtr = _821397878_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<InteractionTracker>()
      val hr = fn.invokeHR(arrayOf(__821397878_Ptr, marshalToNative(compositor),
  ...
  public class IInteractionTrackerStatics_Impl(
    ...
    public override val __821397878_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IInteractionTrackerStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("bba5d7b7659044988d6ceb62b514c92a")
    ...
    public override fun toNative(obj: IInteractionTrackerStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__821397878_Ptr))
  }
