...
@Signature("rc(Windows.UI.Composition.Interactions.CompositionInteractionSourceCollection;{1b468e4b-a5bf-47d8-a547-3894155a158c})")
...
public class CompositionInteractionSourceCollection(
  ...
  private val __1169689930_Interface: ICompositionInteractionSourceCollection.WithDefault by lazy {
    as_1169689930()
  }
  ...
  public override val __1169689930_Ptr: JNAPointer? by lazy {
    __1169689930_Interface.__1169689930_Ptr
  }
  ...
  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1169689930_Interface, __1449643190_Interface)

  private fun as_1169689930(): ICompositionInteractionSourceCollection.WithDefault {
    if(pointer == NULL) {
