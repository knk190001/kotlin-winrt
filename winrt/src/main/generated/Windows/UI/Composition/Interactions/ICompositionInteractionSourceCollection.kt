...
@Signature("{1b468e4b-a5bf-47d8-a547-3894155a158c}")
@Guid("1b468e4ba5bf47d8a5473894155a158c")
@WinRTInterface("1b468e4ba5bf47d8a5473894155a158c")
...
public interface ICompositionInteractionSourceCollection : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionInteractionSourceCollection {
    public val __1169689930_Ptr: Pointer?

    public val _1169689930_VtblPtr: Pointer?
      get() = __1169689930_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Count(): Int {
      val fnPtr = _1169689930_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__1169689930_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun Add(value: ICompositionInteractionSource?): Unit {
      val fnPtr = _1169689930_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1169689930_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun Remove(value: ICompositionInteractionSource?): Unit {
      val fnPtr = _1169689930_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1169689930_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun RemoveAll(): Unit {
      val fnPtr = _1169689930_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1169689930_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class ICompositionInteractionSourceCollection_Impl(
    ...
    public override val __1169689930_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionInteractionSourceCollection, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("1b468e4ba5bf47d8a5473894155a158c")
    ...
    public override fun toNative(obj: ICompositionInteractionSourceCollection): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1169689930_Ptr))
  }
