...
@Signature("{ca0e8a86-d8d6-4111-b088-70347bd2b0ed}")
@Guid("ca0e8a86d8d64111b08870347bd2b0ed")
@WinRTInterface("ca0e8a86d8d64111b08870347bd2b0ed")
...
public interface IVisualInteractionSource : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IVisualInteractionSource {
    public val __177881448_Ptr: Pointer?

    public val _177881448_VtblPtr: Pointer?
      get() = __177881448_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_IsPositionXRailsEnabled(): Boolean {
      val fnPtr = _177881448_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__177881448_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_IsPositionXRailsEnabled(value: Boolean): Unit {
      val fnPtr = _177881448_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__177881448_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_IsPositionYRailsEnabled(): Boolean {
      val fnPtr = _177881448_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__177881448_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_IsPositionYRailsEnabled(value: Boolean): Unit {
      val fnPtr = _177881448_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__177881448_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ManipulationRedirectionMode(): VisualInteractionSourceRedirectionMode? {
      val fnPtr = _177881448_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override
      ...
      val fnPtr = _177881448_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__177881448_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_PositionXChainingMode(): InteractionChainingMode? {
      val fnPtr = _177881448_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_PositionXChainingMode(value: InteractionChainingMode?): Unit {
      val fnPtr = _177881448_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__177881448_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_PositionXSourceMode(): InteractionSourceMode? {
      val fnPtr = _177881448_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_PositionXSourceMode(value: InteractionSourceMode?): Unit {
      val fnPtr = _177881448_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__177881448_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_PositionYChainingMode(): InteractionChainingMode? {
      val fnPtr = _177881448_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<InteractionChainingMode>()
      val hr = fn.invokeHR(arrayOf(__177881448_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_PositionYChainingMode(value: InteractionChainingMode?): Unit {
      val fnPtr = _177881448_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__177881448_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_PositionYSourceMode(): InteractionSourceMode? {
      val fnPtr = _177881448_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<InteractionSourceMode>()
      val hr = fn.invokeHR(arrayOf(__177881448_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_PositionYSourceMode(value: InteractionSourceMode?): Unit {
      val fnPtr = _177881448_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__177881448_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ScaleChainingMode(): InteractionChainingMode? {
      val fnPtr = _177881448_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<InteractionChainingMode>()
      val hr = fn.invokeHR(arrayOf(__177881448_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ScaleChainingMode(value: InteractionChainingMode?): Unit {
      val fnPtr = _177881448_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__177881448_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ScaleSourceMode(): InteractionSourceMode? {
      val fnPtr = _177881448_VtblPtr!!.getPointer(22L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<InteractionSourceMode>()
      val hr = fn.invokeHR(arrayOf(__177881448_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ScaleSourceMode(value: InteractionSourceMode?): Unit {
      val fnPtr = _177881448_VtblPtr!!.getPointer(23L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__177881448_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Source(): Visual? {
      val fnPtr = _177881448_VtblPtr!!.getPointer(24L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun TryRedirectForManipulation(pointerPoint: PointerPoint?): Unit {
      val fnPtr = _177881448_VtblPtr!!.getPointer(25L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__177881448_Ptr, marshalToNative(pointerPoint),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IVisualInteractionSource_Impl(
    ...
    public override val __177881448_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IVisualInteractionSource, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("ca0e8a86d8d64111b08870347bd2b0ed")
    ...
    public override fun toNative(obj: IVisualInteractionSource): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__177881448_Ptr))
  }
