...
@Signature("{cfda55b0-5e3e-4289-932d-ee5f50e74283}")
@Guid("cfda55b05e3e4289932dee5f50e74283")
@WinRTInterface("cfda55b05e3e4289932dee5f50e74283")
...
public interface IInteractionTrackerInertiaNaturalMotionStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IInteractionTrackerInertiaNaturalMotionStatics {
    public val __1269592485_Ptr: Pointer?

    public val _1269592485_VtblPtr: Pointer?
      get() = __1269592485_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun Create(compositor: Compositor?): InteractionTrackerInertiaNaturalMotion? {
      val fnPtr = _1269592485_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<InteractionTrackerInertiaNaturalMotion>()
      val hr = fn.invokeHR(arrayOf(__1269592485_Ptr, marshalToNative(compositor), result))
      if (hr.toInt() != 0) {
  ...
  public class IInteractionTrackerInertiaNaturalMotionStatics_Impl(
    ...
    public override val __1269592485_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IInteractionTrackerInertiaNaturalMotionStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("cfda55b05e3e4289932dee5f50e74283")
    ...
    public override fun toNative(obj: IInteractionTrackerInertiaNaturalMotionStatics): MemoryAddress
        = MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1269592485_Ptr))
  }
