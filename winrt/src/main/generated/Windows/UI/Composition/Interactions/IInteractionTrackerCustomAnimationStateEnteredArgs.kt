...
@Signature("{8d1c8cf1-d7b0-434c-a5d2-2d7611864834}")
@Guid("8d1c8cf1d7b0434ca5d22d7611864834")
@WinRTInterface("8d1c8cf1d7b0434ca5d22d7611864834")
...
public interface IInteractionTrackerCustomAnimationStateEnteredArgs : NativeMapped, IWinRTInterface
  ...
  public interface WithDefault : IInteractionTrackerCustomAnimationStateEnteredArgs {
    public val __1855655269_Ptr: Pointer?

    public val _1855655269_VtblPtr: Pointer?
      get() = __1855655269_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_RequestId(): Int {
      val fnPtr = _1855655269_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__1855655269_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IInteractionTrackerCustomAnimationStateEnteredArgs_Impl(
    ...
    public override val __1855655269_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IInteractionTrackerCustomAnimationStateEnteredArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("8d1c8cf1d7b0434ca5d22d7611864834")
