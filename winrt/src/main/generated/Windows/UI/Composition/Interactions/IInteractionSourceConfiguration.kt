...
@Signature("{a78347e5-a9d1-4d02-985e-b930cd0b9da4}")
@Guid("a78347e5a9d14d02985eb930cd0b9da4")
@WinRTInterface("a78347e5a9d14d02985eb930cd0b9da4")
...
public interface IInteractionSourceConfiguration : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IInteractionSourceConfiguration {
    public val __873831010_Ptr: Pointer?

    public val _873831010_VtblPtr: Pointer?
      get() = __873831010_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_PositionXSourceMode(): InteractionSourceRedirectionMode? {
      val fnPtr = _873831010_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<InteractionSourceRedirectionMode>()
      val hr = fn.invokeHR(arrayOf(__873831010_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_PositionXSourceMode(value: InteractionSourceRedirectionMode?): Unit {
      val fnPtr = _873831010_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__873831010_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_PositionYSourceMode(): InteractionSourceRedirectionMode? {
      val fnPtr = _873831010_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<InteractionSourceRedirectionMode>()
      val hr = fn.invokeHR(arrayOf(__873831010_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_PositionYSourceMode(value: InteractionSourceRedirectionMode?): Unit {
      val fnPtr = _873831010_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__873831010_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ScaleSourceMode(): InteractionSourceRedirectionMode? {
      val fnPtr = _873831010_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<InteractionSourceRedirectionMode>()
      val hr = fn.invokeHR(arrayOf(__873831010_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ScaleSourceMode(value: InteractionSourceRedirectionMode?): Unit {
      val fnPtr = _873831010_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__873831010_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IInteractionSourceConfiguration_Impl(
    ...
    public override val __873831010_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IInteractionSourceConfiguration, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("a78347e5a9d14d02985eb930cd0b9da4")
    ...
    public override fun toNative(obj: IInteractionSourceConfiguration): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__873831010_Ptr))
  }
