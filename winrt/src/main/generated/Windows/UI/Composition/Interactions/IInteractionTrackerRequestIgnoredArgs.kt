...
@Signature("{80dd82f1-ce25-488f-91dd-cb6455ccff2e}")
@Guid("80dd82f1ce25488f91ddcb6455ccff2e")
@WinRTInterface("80dd82f1ce25488f91ddcb6455ccff2e")
...
public interface IInteractionTrackerRequestIgnoredArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IInteractionTrackerRequestIgnoredArgs {
    public val __1793010395_Ptr: Pointer?

    public val _1793010395_VtblPtr: Pointer?
      get() = __1793010395_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_RequestId(): Int {
      val fnPtr = _1793010395_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__1793010395_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IInteractionTrackerRequestIgnoredArgs_Impl(
    ...
    public override val __1793010395_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IInteractionTrackerRequestIgnoredArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("80dd82f1ce25488f91ddcb6455ccff2e")
    ...
    public override fun toNative(obj: IInteractionTrackerRequestIgnoredArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1793010395_Ptr))
  }
