...
@Signature("{47d579b7-0985-5e99-b024-2f32c380c1a4}")
@Guid("47d579b709855e99b0242f32c380c1a4")
@WinRTInterface("47d579b709855e99b0242f32c380c1a4")
...
public interface IInteractionTrackerCustomAnimationStateEnteredArgs2 : NativeMapped, IWinRTInterface
  ...
  public interface WithDefault : IInteractionTrackerCustomAnimationStateEnteredArgs2 {
    public val __1690738441_Ptr: Pointer?

    public val _1690738441_VtblPtr: Pointer?
      get() = __1690738441_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_IsFromBinding(): Boolean {
      val fnPtr = _1690738441_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1690738441_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IInteractionTrackerCustomAnimationStateEnteredArgs2_Impl(
    ...
    public override val __1690738441_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IInteractionTrackerCustomAnimationStateEnteredArgs2, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("47d579b709855e99b0242f32c380c1a4")
