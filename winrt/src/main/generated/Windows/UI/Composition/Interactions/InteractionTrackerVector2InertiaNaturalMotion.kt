...
@Signature("rc(Windows.UI.Composition.Interactions.InteractionTrackerVector2InertiaNaturalMotion;{5f17695c-162d-4c07-9400-c282b28276ca})")
...
public class InteractionTrackerVector2InertiaNaturalMotion(
  ...
  private val __1289087783_Interface: IInteractionTrackerVector2InertiaNaturalMotion.WithDefault by
      lazy {
    as_1289087783()
  }


  public override val __1289087783_Ptr: JNAPointer? by lazy {
    __1289087783_Interface.__1289087783_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1289087783_Interface)

  private fun as_1289087783(): IInteractionTrackerVector2InertiaNaturalMotion.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<InteractionTrackerVector2InertiaNaturalMotion, MemoryAddress> {
    ...
    public fun createIInteractionTrackerVector2InertiaNaturalMotionStatics():
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Composition.Interactions.InteractionTrackerVector2InertiaNaturalMotion".toHandle(),refiid,interfacePtr)
      val result =
