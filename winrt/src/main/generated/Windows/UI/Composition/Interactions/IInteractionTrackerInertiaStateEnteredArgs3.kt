...
@Signature("{48ac1c2f-47bd-59af-a58c-79bd2eb9ef71}")
@Guid("48ac1c2f47bd59afa58c79bd2eb9ef71")
@WinRTInterface("48ac1c2f47bd59afa58c79bd2eb9ef71")
...
public interface IInteractionTrackerInertiaStateEnteredArgs3 : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IInteractionTrackerInertiaStateEnteredArgs3 {
    public val __1659310897_Ptr: Pointer?

    public val _1659310897_VtblPtr: Pointer?
      get() = __1659310897_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_IsFromBinding(): Boolean {
      val fnPtr = _1659310897_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1659310897_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IInteractionTrackerInertiaStateEnteredArgs3_Impl(
    ...
    public override val __1659310897_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IInteractionTrackerInertiaStateEnteredArgs3, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("48ac1c2f47bd59afa58c79bd2eb9ef71")
    ...
    public override fun toNative(obj: IInteractionTrackerInertiaStateEnteredArgs3): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1659310897_Ptr))
  }
