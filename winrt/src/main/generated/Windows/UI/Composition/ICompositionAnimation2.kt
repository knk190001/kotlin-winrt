...
@Signature("{369b603e-a80f-4948-93e3-ed23fb38c6cb}")
@Guid("369b603ea80f494893e3ed23fb38c6cb")
@WinRTInterface("369b603ea80f494893e3ed23fb38c6cb")
...
public interface ICompositionAnimation2 : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionAnimation2 {
    public val __1786839158_Ptr: Pointer?

    public val _1786839158_VtblPtr: Pointer?
      get() = __1786839158_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun SetBooleanParameter(key: String?, value: Boolean): Unit {
      val fnPtr = _1786839158_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1786839158_Ptr, marshalToNative(key), value,))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Target(): String? {
      val fnPtr = _1786839158_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__1786839158_Ptr,  result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun put_Target(value: String?): Unit {
      val fnPtr = _1786839158_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1786839158_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class ICompositionAnimation2_Impl(
    ...
    public override val __1786839158_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionAnimation2, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("369b603ea80f494893e3ed23fb38c6cb")
    ...
    public override fun toNative(obj: ICompositionAnimation2): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1786839158_Ptr))
  }
