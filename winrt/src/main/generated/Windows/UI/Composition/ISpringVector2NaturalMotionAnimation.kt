...
@Signature("{23f494b5-ee73-4f0f-a423-402b946df4b3}")
@Guid("23f494b5ee734f0fa423402b946df4b3")
@WinRTInterface("23f494b5ee734f0fa423402b946df4b3")
...
public interface ISpringVector2NaturalMotionAnimation : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISpringVector2NaturalMotionAnimation {
    public val __606952889_Ptr: Pointer?

    public val _606952889_VtblPtr: Pointer?
      get() = __606952889_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_DampingRatio(): Float {
      val fnPtr = _606952889_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__606952889_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_DampingRatio(value: Float): Unit {
      val fnPtr = _606952889_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__606952889_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Period(): TimeSpan? {
      val fnPtr = _606952889_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Period(value: TimeSpan?): Unit {
      val fnPtr = _606952889_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__606952889_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class ISpringVector2NaturalMotionAnimation_Impl(
    ...
    public override val __606952889_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISpringVector2NaturalMotionAnimation, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("23f494b5ee734f0fa423402b946df4b3")
    ...
    public override fun toNative(obj: ISpringVector2NaturalMotionAnimation): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__606952889_Ptr))
  }
