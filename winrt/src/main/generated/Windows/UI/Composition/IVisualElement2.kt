...
@Signature("{993ae8a0-6057-5e40-918c-e06e0b7e7c64}")
@Guid("993ae8a060575e40918ce06e0b7e7c64")
@WinRTInterface("993ae8a060575e40918ce06e0b7e7c64")
...
public interface IVisualElement2 : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IVisualElement2 {
    public val __1181201596_Ptr: Pointer?

    public val _1181201596_VtblPtr: Pointer?
      get() = __1181201596_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun GetVisualInternal(): Visual? {
      val fnPtr = _1181201596_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Visual>()
      val hr = fn.invokeHR(arrayOf(__1181201596_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IVisualElement2_Impl(
    ...
    public override val __1181201596_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IVisualElement2, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("993ae8a060575e40918ce06e0b7e7c64")
    ...
    public override fun toNative(obj: IVisualElement2): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1181201596_Ptr))
  }
