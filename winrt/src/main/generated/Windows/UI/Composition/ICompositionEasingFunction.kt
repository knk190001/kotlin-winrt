...
@Signature("{5145e356-bf79-4ea8-8cc2-6b5b472e6c9a}")
@Guid("5145e356bf794ea88cc26b5b472e6c9a")
@WinRTInterface("5145e356bf794ea88cc26b5b472e6c9a")
...
public interface ICompositionEasingFunction : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionEasingFunction {
    public val __141809279_Ptr: Pointer?

    public val _141809279_VtblPtr: Pointer?
      get() = __141809279_Ptr?.getPointer(0)
  }

  public class ICompositionEasingFunction_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __141809279_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionEasingFunction, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("5145e356bf794ea88cc26b5b472e6c9a")
    ...
    public override fun toNative(obj: ICompositionEasingFunction): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__141809279_Ptr))
  }
