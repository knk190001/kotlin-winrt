...
@Signature("rc(Windows.UI.Composition.CompositionObject;{bcb4ad45-7609-4550-934f-16002a68fded})")
...
public open class CompositionObject(
  ptr: JNAPointer? = NULL
    ...
    ICompositionObject3.WithDefault, ICompositionObject4.WithDefault, IClosable.WithDefault,
    IAnimationObject.WithDefault, IWinRTObject {
  private val __1150475163_Interface: ICompositionObject.WithDefault by lazy {
    as_1150475163()
  }


  private val __1304991735_Interface: ICompositionObject2.WithDefault by lazy {
    as_1304991735()
  }


  private val __1304991736_Interface: ICompositionObject3.WithDefault by lazy {
    as_1304991736()
  }


  private val __1304991737_Interface: ICompositionObject4.WithDefault by lazy {
    as_1304991737()
  }
  ...
  public override val __1150475163_Ptr: JNAPointer? by lazy {
    __1150475163_Interface.__1150475163_Ptr
  }


  public override val __1304991735_Ptr: JNAPointer? by lazy {
    __1304991735_Interface.__1304991735_Ptr
  }


  public override val __1304991736_Ptr: JNAPointer? by lazy {
    __1304991736_Interface.__1304991736_Ptr
  }


  public override val __1304991737_Ptr: JNAPointer? by lazy {
    __1304991737_Interface.__1304991737_Ptr
  }
  ...
  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1150475163_Interface, __1304991735_Interface, __1304991736_Interface,
        __1304991737_Interface, __1260617006_Interface, __1365507701_Interface)

  private fun as_1150475163(): ICompositionObject.WithDefault {
    if(pointer == NULL) {
  ...
  private fun as_1304991735(): ICompositionObject2.WithDefault {
    if(pointer == NULL) {
  ...
  private fun as_1304991736(): ICompositionObject3.WithDefault {
    if(pointer == NULL) {
  ...
  private fun as_1304991737(): ICompositionObject4.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<CompositionObject, MemoryAddress> {
    ...
    public fun createICompositionObjectStatics(): ICompositionObjectStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Composition.CompositionObject".toHandle(),refiid,interfacePtr)
