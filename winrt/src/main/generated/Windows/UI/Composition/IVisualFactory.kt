...
@Signature("{ad0ff93e-b502-4eb5-87b4-9a38a71d0137}")
@Guid("ad0ff93eb5024eb587b49a38a71d0137")
@WinRTInterface("ad0ff93eb5024eb587b49a38a71d0137")
...
public interface IVisualFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IVisualFactory {
    public val __1502682300_Ptr: Pointer?

    public val _1502682300_VtblPtr: Pointer?
      get() = __1502682300_Ptr?.getPointer(0)
  }

  public class IVisualFactory_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __1502682300_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IVisualFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("ad0ff93eb5024eb587b49a38a71d0137")
    ...
    public override fun toNative(obj: IVisualFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1502682300_Ptr))
  }
