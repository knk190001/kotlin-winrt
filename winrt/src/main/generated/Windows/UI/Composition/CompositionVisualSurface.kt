...
@Signature("rc(Windows.UI.Composition.CompositionVisualSurface;{b224d803-4f6e-4a3f-8cae-3dc1cda74fc6})")
...
public class CompositionVisualSurface(
  ptr: JNAPointer? = NULL
    ...
    IWinRTObject {
  private val __589905265_Interface: ICompositionVisualSurface.WithDefault by lazy {
    as_589905265()
  }
  ...
  public override val __589905265_Ptr: JNAPointer? by lazy {
    __589905265_Interface.__589905265_Ptr
  }
  ...
  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__589905265_Interface, __1111408593_Interface)

  private fun as_589905265(): ICompositionVisualSurface.WithDefault {
    if(pointer == NULL) {
