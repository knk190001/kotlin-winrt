...
@Signature("rc(Windows.UI.Composition.CompositionProjectedShadowCasterCollection;{d2525c0c-e07f-58a3-ac91-37f73ee91740})")
...
public class CompositionProjectedShadowCasterCollection(
  ...
  private val __2052598810_Interface: ICompositionProjectedShadowCasterCollection.WithDefault by
      lazy {
    as_2052598810()
  }
  ...
  public override val __2052598810_Ptr: JNAPointer? by lazy {
    __2052598810_Interface.__2052598810_Ptr
  }
  ...
  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__2052598810_Interface, __1449643190_Interface)

  private fun as_2052598810(): ICompositionProjectedShadowCasterCollection.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<CompositionProjectedShadowCasterCollection, MemoryAddress> {
    ...
    public fun createICompositionProjectedShadowCasterCollectionStatics():
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Composition.CompositionProjectedShadowCasterCollection".toHandle(),refiid,interfacePtr)
      val result =
