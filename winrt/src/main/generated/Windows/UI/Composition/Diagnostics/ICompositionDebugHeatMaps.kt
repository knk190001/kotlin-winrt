...
@Signature("{e49c90ac-2ff3-5805-718c-b725ee07650f}")
@Guid("e49c90ac2ff35805718cb725ee07650f")
@WinRTInterface("e49c90ac2ff35805718cb725ee07650f")
...
public interface ICompositionDebugHeatMaps : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionDebugHeatMaps {
    public val __354141664_Ptr: Pointer?

    public val _354141664_VtblPtr: Pointer?
      get() = __354141664_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun Hide(subtree: Visual?): Unit {
      val fnPtr = _354141664_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__354141664_Ptr, marshalToNative(subtree),))
      if (hr.toInt() != 0) {
    ...
    public override fun ShowMemoryUsage(subtree: Visual?): Unit {
      val fnPtr = _354141664_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__354141664_Ptr, marshalToNative(subtree),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun ShowOverdraw(subtree: Visual?,
      ...
      val fnPtr = _354141664_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__354141664_Ptr, marshalToNative(subtree),
    ...
    public override fun ShowRedraw(subtree: Visual?): Unit {
      val fnPtr = _354141664_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__354141664_Ptr, marshalToNative(subtree),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class ICompositionDebugHeatMaps_Impl(
    ...
    public override val __354141664_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionDebugHeatMaps, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("e49c90ac2ff35805718cb725ee07650f")
    ...
    public override fun toNative(obj: ICompositionDebugHeatMaps): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__354141664_Ptr))
  }
