...
@Signature("{285b8e72-4328-523f-bcf2-5557c52c3b25}")
@Guid("285b8e724328523fbcf25557c52c3b25")
@WinRTInterface("285b8e724328523fbcf25557c52c3b25")
...
public interface ICompositionProjectedShadow : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionProjectedShadow {
    public val __467980252_Ptr: Pointer?

    public val _467980252_VtblPtr: Pointer?
      get() = __467980252_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_BlurRadiusMultiplier(): Float {
      val fnPtr = _467980252_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__467980252_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_BlurRadiusMultiplier(value: Float): Unit {
      val fnPtr = _467980252_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__467980252_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Casters(): CompositionProjectedShadowCasterCollection? {
      val fnPtr = _467980252_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_LightSource(): CompositionLight? {
      val fnPtr = _467980252_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_LightSource(value: CompositionLight?): Unit {
      val fnPtr = _467980252_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__467980252_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_MaxBlurRadius(): Float {
      val fnPtr = _467980252_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__467980252_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_MaxBlurRadius(value: Float): Unit {
      val fnPtr = _467980252_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__467980252_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_MinBlurRadius(): Float {
      val fnPtr = _467980252_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__467980252_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_MinBlurRadius(value: Float): Unit {
      val fnPtr = _467980252_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__467980252_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Receivers(): CompositionProjectedShadowReceiverUnorderedCollection? {
      val fnPtr = _467980252_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class ICompositionProjectedShadow_Impl(
    ...
    public override val __467980252_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionProjectedShadow, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("285b8e724328523fbcf25557c52c3b25")
    ...
    public override fun toNative(obj: ICompositionProjectedShadow): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__467980252_Ptr))
  }
