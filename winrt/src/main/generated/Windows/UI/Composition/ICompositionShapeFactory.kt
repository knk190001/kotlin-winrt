...
@Signature("{1dfc36d0-b05a-44ef-82b0-12118bcd4cd0}")
@Guid("1dfc36d0b05a44ef82b012118bcd4cd0")
@WinRTInterface("1dfc36d0b05a44ef82b012118bcd4cd0")
...
public interface ICompositionShapeFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionShapeFactory {
    public val __1765430661_Ptr: Pointer?

    public val _1765430661_VtblPtr: Pointer?
      get() = __1765430661_Ptr?.getPointer(0)
  }

  public class ICompositionShapeFactory_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __1765430661_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionShapeFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("1dfc36d0b05a44ef82b012118bcd4cd0")
    ...
    public override fun toNative(obj: ICompositionShapeFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1765430661_Ptr))
  }
