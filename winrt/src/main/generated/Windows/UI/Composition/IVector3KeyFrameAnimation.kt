...
@Signature("{c8039daa-a281-43c2-a73d-b68e3c533c40}")
@Guid("c8039daaa28143c2a73db68e3c533c40")
@WinRTInterface("c8039daaa28143c2a73db68e3c533c40")
...
public interface IVector3KeyFrameAnimation : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IVector3KeyFrameAnimation {
    public val __1069675796_Ptr: Pointer?

    public val _1069675796_VtblPtr: Pointer?
      get() = __1069675796_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun InsertKeyFrame(normalizedProgressKey: Float, value: Vector3?): Unit {
      val fnPtr = _1069675796_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1069675796_Ptr, normalizedProgressKey,
    ...
    public override fun InsertKeyFrame(
      ...
      val fnPtr = _1069675796_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1069675796_Ptr, normalizedProgressKey, marshalToNative(value),
  ...
  public class IVector3KeyFrameAnimation_Impl(
    ...
    public override val __1069675796_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IVector3KeyFrameAnimation, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("c8039daaa28143c2a73db68e3c533c40")
    ...
    public override fun toNative(obj: IVector3KeyFrameAnimation): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1069675796_Ptr))
  }
