...
@Signature("{0572a95f-37f9-4fbe-b87b-5cd03a89501c}")
@Guid("0572a95f37f94fbeb87b5cd03a89501c")
@WinRTInterface("0572a95f37f94fbeb87b5cd03a89501c")
...
public interface ISpringScalarNaturalMotionAnimation : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISpringScalarNaturalMotionAnimation {
    public val __1829695724_Ptr: Pointer?

    public val _1829695724_VtblPtr: Pointer?
      get() = __1829695724_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_DampingRatio(): Float {
      val fnPtr = _1829695724_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__1829695724_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_DampingRatio(value: Float): Unit {
      val fnPtr = _1829695724_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1829695724_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Period(): TimeSpan? {
      val fnPtr = _1829695724_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Period(value: TimeSpan?): Unit {
      val fnPtr = _1829695724_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1829695724_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class ISpringScalarNaturalMotionAnimation_Impl(
    ...
    public override val __1829695724_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISpringScalarNaturalMotionAnimation, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("0572a95f37f94fbeb87b5cd03a89501c")
    ...
    public override fun toNative(obj: ISpringScalarNaturalMotionAnimation): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1829695724_Ptr))
  }
