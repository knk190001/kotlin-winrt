...
@Signature("rc(Windows.UI.Composition.LinearEasingFunction;{9400975a-c7a6-46b3-acf7-1a268a0a117d})")
...
public class LinearEasingFunction(
  ...
  private val __635008342_Interface: ILinearEasingFunction.WithDefault by lazy {
    as_635008342()
  }


  public override val __635008342_Ptr: JNAPointer? by lazy {
    __635008342_Interface.__635008342_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__635008342_Interface)

  private fun as_635008342(): ILinearEasingFunction.WithDefault {
    if(pointer == NULL) {
