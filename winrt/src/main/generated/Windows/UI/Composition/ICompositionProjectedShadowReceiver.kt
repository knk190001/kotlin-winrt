...
@Signature("{1377985a-6a49-536a-9be4-a96a8e5298a9}")
@Guid("1377985a6a49536a9be4a96a8e5298a9")
@WinRTInterface("1377985a6a49536a9be4a96a8e5298a9")
...
public interface ICompositionProjectedShadowReceiver : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionProjectedShadowReceiver {
    public val __1944354325_Ptr: Pointer?

    public val _1944354325_VtblPtr: Pointer?
      get() = __1944354325_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ReceivingVisual(): Visual? {
      val fnPtr = _1944354325_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Visual>()
      val hr = fn.invokeHR(arrayOf(__1944354325_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ReceivingVisual(value: Visual?): Unit {
      val fnPtr = _1944354325_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1944354325_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class ICompositionProjectedShadowReceiver_Impl(
    ...
    public override val __1944354325_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionProjectedShadowReceiver, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("1377985a6a49536a9be4a96a8e5298a9")
    ...
    public override fun toNative(obj: ICompositionProjectedShadowReceiver): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1944354325_Ptr))
  }
