...
@Signature("{47dabc31-10d3-4518-86f1-09caf742d113}")
@Guid("47dabc3110d3451886f109caf742d113")
@WinRTInterface("47dabc3110d3451886f109caf742d113")
...
public interface IBounceVector3NaturalMotionAnimation : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IBounceVector3NaturalMotionAnimation {
    public val __1745291169_Ptr: Pointer?

    public val _1745291169_VtblPtr: Pointer?
      get() = __1745291169_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Acceleration(): Float {
      val fnPtr = _1745291169_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__1745291169_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Acceleration(value: Float): Unit {
      val fnPtr = _1745291169_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1745291169_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Restitution(): Float {
      val fnPtr = _1745291169_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__1745291169_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Restitution(value: Float): Unit {
      val fnPtr = _1745291169_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1745291169_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IBounceVector3NaturalMotionAnimation_Impl(
    ...
    public override val __1745291169_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IBounceVector3NaturalMotionAnimation, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("47dabc3110d3451886f109caf742d113")
    ...
    public override fun toNative(obj: IBounceVector3NaturalMotionAnimation): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1745291169_Ptr))
  }
