...
@Signature("{94a94581-bf92-495b-b5bd-d2c659430737}")
@Guid("94a94581bf92495bb5bdd2c659430737")
@WinRTInterface("94a94581bf92495bb5bdd2c659430737")
...
public interface IScalarNaturalMotionAnimation : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IScalarNaturalMotionAnimation {
    public val __312509761_Ptr: Pointer?

    public val _312509761_VtblPtr: Pointer?
      get() = __312509761_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_FinalValue(): IReference<Float>? {
      val fnPtr = _312509761_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IReference<Float>>()
      val hr = fn.invokeHR(arrayOf(__312509761_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_FinalValue(value: IReference<Float>?): Unit {
      val fnPtr = _312509761_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__312509761_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_InitialValue(): IReference<Float>? {
      val fnPtr = _312509761_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IReference<Float>>()
      val hr = fn.invokeHR(arrayOf(__312509761_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_InitialValue(value: IReference<Float>?): Unit {
      val fnPtr = _312509761_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__312509761_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_InitialVelocity(): Float {
      val fnPtr = _312509761_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_InitialVelocity(value: Float): Unit {
      val fnPtr = _312509761_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__312509761_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IScalarNaturalMotionAnimation_Impl(
    ...
    public override val __312509761_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IScalarNaturalMotionAnimation, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("94a94581bf92495bb5bdd2c659430737")
    ...
    public override fun toNative(obj: IScalarNaturalMotionAnimation): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__312509761_Ptr))
  }
