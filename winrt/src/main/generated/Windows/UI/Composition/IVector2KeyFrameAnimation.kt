...
@Signature("{df414515-4e29-4f11-b55e-bf2a6eb36294}")
@Guid("df4145154e294f11b55ebf2a6eb36294")
@WinRTInterface("df4145154e294f11b55ebf2a6eb36294")
...
public interface IVector2KeyFrameAnimation : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IVector2KeyFrameAnimation {
    public val __2066748149_Ptr: Pointer?

    public val _2066748149_VtblPtr: Pointer?
      get() = __2066748149_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun InsertKeyFrame(normalizedProgressKey: Float, value: Vector2?): Unit {
      val fnPtr = _2066748149_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2066748149_Ptr, normalizedProgressKey,
    ...
    public override fun InsertKeyFrame(
      ...
      val fnPtr = _2066748149_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2066748149_Ptr, normalizedProgressKey, marshalToNative(value),
  ...
  public class IVector2KeyFrameAnimation_Impl(
    ...
    public override val __2066748149_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IVector2KeyFrameAnimation, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("df4145154e294f11b55ebf2a6eb36294")
    ...
    public override fun toNative(obj: IVector2KeyFrameAnimation): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2066748149_Ptr))
  }
