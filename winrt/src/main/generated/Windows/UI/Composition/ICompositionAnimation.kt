...
@Signature("{464c4c2c-1caa-4061-9b40-e13fde1503ca}")
@Guid("464c4c2c1caa40619b40e13fde1503ca")
@WinRTInterface("464c4c2c1caa40619b40e13fde1503ca")
...
public interface ICompositionAnimation : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionAnimation {
    public val __1720207960_Ptr: Pointer?

    public val _1720207960_VtblPtr: Pointer?
      get() = __1720207960_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun ClearAllParameters(): Unit {
      val fnPtr = _1720207960_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1720207960_Ptr, ))
      if (hr.toInt() != 0) {
    ...
    public override fun ClearParameter(key: String?): Unit {
      val fnPtr = _1720207960_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1720207960_Ptr, marshalToNative(key),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun SetColorParameter(key: String?, value: Color?): Unit {
      val fnPtr = _1720207960_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1720207960_Ptr, marshalToNative(key), marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun SetMatrix3x2Parameter(key: String?, value: Matrix3x2?): Unit {
      val fnPtr = _1720207960_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1720207960_Ptr, marshalToNative(key), marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun SetMatrix4x4Parameter(key: String?, value: Matrix4x4?): Unit {
      val fnPtr = _1720207960_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1720207960_Ptr, marshalToNative(key), marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun SetQuaternionParameter(key: String?, value: Quaternion?): Unit {
      val fnPtr = _1720207960_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1720207960_Ptr, marshalToNative(key), marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun SetReferenceParameter(key: String?, compositionObject: CompositionObject?):
        Unit {
      val fnPtr = _1720207960_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1720207960_Ptr, marshalToNative(key),
    ...
    public override fun SetScalarParameter(key: String?, value: Float): Unit {
      val fnPtr = _1720207960_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1720207960_Ptr, marshalToNative(key), value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun SetVector2Parameter(key: String?, value: Vector2?): Unit {
      val fnPtr = _1720207960_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1720207960_Ptr, marshalToNative(key), marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun SetVector3Parameter(key: String?, value: Vector3?): Unit {
      val fnPtr = _1720207960_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1720207960_Ptr, marshalToNative(key), marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun SetVector4Parameter(key: String?, value: Vector4?): Unit {
      val fnPtr = _1720207960_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1720207960_Ptr, marshalToNative(key), marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class ICompositionAnimation_Impl(
    ...
    public override val __1720207960_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionAnimation, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("464c4c2c1caa40619b40e13fde1503ca")
    ...
    public override fun toNative(obj: ICompositionAnimation): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1720207960_Ptr))
  }
