...
@Signature("{401b61bb-0007-4363-b1f3-6bcc003fb83e}")
@Guid("401b61bb00074363b1f36bcc003fb83e")
@WinRTInterface("401b61bb00074363b1f36bcc003fb83e")
...
public interface ICompositionSpriteShape : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionSpriteShape {
    public val __466620160_Ptr: Pointer?

    public val _466620160_VtblPtr: Pointer?
      get() = __466620160_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_FillBrush(): CompositionBrush? {
      val fnPtr = _466620160_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CompositionBrush>()
      val hr = fn.invokeHR(arrayOf(__466620160_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_FillBrush(value: CompositionBrush?): Unit {
      val fnPtr = _466620160_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__466620160_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Geometry(): CompositionGeometry? {
      val fnPtr = _466620160_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Geometry(value: CompositionGeometry?): Unit {
      val fnPtr = _466620160_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__466620160_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_IsStrokeNonScaling(): Boolean {
      val fnPtr = _466620160_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_IsStrokeNonScaling(value: Boolean): Unit {
      val fnPtr = _466620160_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__466620160_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_StrokeBrush(): CompositionBrush? {
      val fnPtr = _466620160_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CompositionBrush>()
      val hr = fn.invokeHR(arrayOf(__466620160_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_StrokeBrush(value: CompositionBrush?): Unit {
      val fnPtr = _466620160_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__466620160_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_StrokeDashArray(): CompositionStrokeDashArray? {
      val fnPtr = _466620160_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_StrokeDashCap(): CompositionStrokeCap? {
      val fnPtr = _466620160_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_StrokeDashCap(value: CompositionStrokeCap?): Unit {
      val fnPtr = _466620160_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__466620160_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_StrokeDashOffset(): Float {
      val fnPtr = _466620160_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_StrokeDashOffset(value: Float): Unit {
      val fnPtr = _466620160_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__466620160_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_StrokeEndCap(): CompositionStrokeCap? {
      val fnPtr = _466620160_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CompositionStrokeCap>()
      val hr = fn.invokeHR(arrayOf(__466620160_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_StrokeEndCap(value: CompositionStrokeCap?): Unit {
      val fnPtr = _466620160_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__466620160_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_StrokeLineJoin(): CompositionStrokeLineJoin? {
      val fnPtr = _466620160_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_StrokeLineJoin(value: CompositionStrokeLineJoin?): Unit {
      val fnPtr = _466620160_VtblPtr!!.getPointer(22L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__466620160_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_StrokeMiterLimit(): Float {
      val fnPtr = _466620160_VtblPtr!!.getPointer(23L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__466620160_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_StrokeMiterLimit(value: Float): Unit {
      val fnPtr = _466620160_VtblPtr!!.getPointer(24L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__466620160_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_StrokeStartCap(): CompositionStrokeCap? {
      val fnPtr = _466620160_VtblPtr!!.getPointer(25L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CompositionStrokeCap>()
      val hr = fn.invokeHR(arrayOf(__466620160_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_StrokeStartCap(value: CompositionStrokeCap?): Unit {
      val fnPtr = _466620160_VtblPtr!!.getPointer(26L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__466620160_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_StrokeThickness(): Float {
      val fnPtr = _466620160_VtblPtr!!.getPointer(27L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__466620160_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_StrokeThickness(value: Float): Unit {
      val fnPtr = _466620160_VtblPtr!!.getPointer(28L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__466620160_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class ICompositionSpriteShape_Impl(
    ...
    public override val __466620160_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionSpriteShape, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("401b61bb00074363b1f36bcc003fb83e")
    ...
    public override fun toNative(obj: ICompositionSpriteShape): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__466620160_Ptr))
  }
