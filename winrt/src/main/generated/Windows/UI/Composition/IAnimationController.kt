...
@Signature("{c934efd2-0722-4f5f-a4e2-9510f3d43bf7}")
@Guid("c934efd207224f5fa4e29510f3d43bf7")
@WinRTInterface("c934efd207224f5fa4e29510f3d43bf7")
...
public interface IAnimationController : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IAnimationController {
    public val __801819694_Ptr: Pointer?

    public val _801819694_VtblPtr: Pointer?
      get() = __801819694_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_PlaybackRate(): Float {
      val fnPtr = _801819694_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__801819694_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_PlaybackRate(value: Float): Unit {
      val fnPtr = _801819694_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__801819694_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Progress(): Float {
      val fnPtr = _801819694_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__801819694_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Progress(value: Float): Unit {
      val fnPtr = _801819694_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__801819694_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ProgressBehavior(): AnimationControllerProgressBehavior? {
      val fnPtr = _801819694_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_ProgressBehavior(value: AnimationControllerProgressBehavior?): Unit {
      val fnPtr = _801819694_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__801819694_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun Pause(): Unit {
      val fnPtr = _801819694_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__801819694_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun Resume(): Unit {
      val fnPtr = _801819694_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__801819694_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IAnimationController_Impl(
    ...
    public override val __801819694_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IAnimationController, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("c934efd207224f5fa4e29510f3d43bf7")
    ...
    public override fun toNative(obj: IAnimationController): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__801819694_Ptr))
  }
