...
@Signature("{e4d03eea-131f-480e-859e-b82705b74360}")
@Guid("e4d03eea131f480e859eb82705b74360")
@WinRTInterface("e4d03eea131f480e859eb82705b74360")
...
public interface ISpotLight3 : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISpotLight3 {
    public val __1283829677_Ptr: Pointer?

    public val _1283829677_VtblPtr: Pointer?
      get() = __1283829677_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_MinAttenuationCutoff(): Float {
      val fnPtr = _1283829677_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__1283829677_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_MinAttenuationCutoff(value: Float): Unit {
      val fnPtr = _1283829677_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1283829677_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_MaxAttenuationCutoff(): Float {
      val fnPtr = _1283829677_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__1283829677_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_MaxAttenuationCutoff(value: Float): Unit {
      val fnPtr = _1283829677_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1283829677_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class ISpotLight3_Impl(
    ...
    public override val __1283829677_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISpotLight3, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("e4d03eea131f480e859eb82705b74360")
    ...
    public override fun toNative(obj: ISpotLight3): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1283829677_Ptr))
  }
