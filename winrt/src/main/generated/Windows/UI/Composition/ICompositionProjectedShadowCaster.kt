...
@Signature("{b1d7d426-1e36-5a62-be56-a16112fdd148}")
@Guid("b1d7d4261e365a62be56a16112fdd148")
@WinRTInterface("b1d7d4261e365a62be56a16112fdd148")
...
public interface ICompositionProjectedShadowCaster : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionProjectedShadowCaster {
    public val __1198908632_Ptr: Pointer?

    public val _1198908632_VtblPtr: Pointer?
      get() = __1198908632_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Brush(): CompositionBrush? {
      val fnPtr = _1198908632_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CompositionBrush>()
      val hr = fn.invokeHR(arrayOf(__1198908632_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Brush(value: CompositionBrush?): Unit {
      val fnPtr = _1198908632_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1198908632_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_CastingVisual(): Visual? {
      val fnPtr = _1198908632_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_CastingVisual(value: Visual?): Unit {
      val fnPtr = _1198908632_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1198908632_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class ICompositionProjectedShadowCaster_Impl(
    ...
    public override val __1198908632_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionProjectedShadowCaster, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("b1d7d4261e365a62be56a16112fdd148")
    ...
    public override fun toNative(obj: ICompositionProjectedShadowCaster): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1198908632_Ptr))
  }
