...
@Signature("{da344196-2154-4b3c-88aa-47361204eccd}")
@Guid("da34419621544b3c88aa47361204eccd")
@WinRTInterface("da34419621544b3c88aa47361204eccd")
...
public interface IBounceVector2NaturalMotionAnimation : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IBounceVector2NaturalMotionAnimation {
    public val __1304911646_Ptr: Pointer?

    public val _1304911646_VtblPtr: Pointer?
      get() = __1304911646_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Acceleration(): Float {
      val fnPtr = _1304911646_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__1304911646_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Acceleration(value: Float): Unit {
      val fnPtr = _1304911646_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1304911646_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Restitution(): Float {
      val fnPtr = _1304911646_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__1304911646_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Restitution(value: Float): Unit {
      val fnPtr = _1304911646_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1304911646_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IBounceVector2NaturalMotionAnimation_Impl(
    ...
    public override val __1304911646_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IBounceVector2NaturalMotionAnimation, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("da34419621544b3c88aa47361204eccd")
    ...
    public override fun toNative(obj: IBounceVector2NaturalMotionAnimation): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1304911646_Ptr))
  }
