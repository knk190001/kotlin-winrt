...
@Signature("rc(Windows.UI.Composition.SpringVector3NaturalMotionAnimation;{6c8749df-d57b-4794-8e2d-cecb11e194e5})")
...
public class SpringVector3NaturalMotionAnimation(
  ptr: JNAPointer? = NULL
    ...
    IWinRTObject {
  private val __1851717370_Interface: ISpringVector3NaturalMotionAnimation.WithDefault by lazy {
    as_1851717370()
  }


  public override val __1851717370_Ptr: JNAPointer? by lazy {
    __1851717370_Interface.__1851717370_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1851717370_Interface)

  private fun as_1851717370(): ISpringVector3NaturalMotionAnimation.WithDefault {
    if(pointer == NULL) {
