...
@Signature("{6c4218bc-15b9-4c2d-8d4a-0767df11977a}")
@Guid("6c4218bc15b94c2d8d4a0767df11977a")
@WinRTInterface("6c4218bc15b94c2d8d4a0767df11977a")
...
public interface IDropShadow2 : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IDropShadow2 {
    public val __1142446261_Ptr: Pointer?

    public val _1142446261_VtblPtr: Pointer?
      get() = __1142446261_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_SourcePolicy(): CompositionDropShadowSourcePolicy? {
      val fnPtr = _1142446261_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CompositionDropShadowSourcePolicy>()
      val hr = fn.invokeHR(arrayOf(__1142446261_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_SourcePolicy(value: CompositionDropShadowSourcePolicy?): Unit {
      val fnPtr = _1142446261_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1142446261_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IDropShadow2_Impl(
    ...
    public override val __1142446261_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IDropShadow2, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("6c4218bc15b94c2d8d4a0767df11977a")
    ...
    public override fun toNative(obj: IDropShadow2): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1142446261_Ptr))
  }
