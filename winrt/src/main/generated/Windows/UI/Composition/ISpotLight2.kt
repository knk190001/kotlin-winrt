...
@Signature("{64ee615e-0686-4dea-a9e8-bc3a8c701459}")
@Guid("64ee615e06864deaa9e8bc3a8c701459")
@WinRTInterface("64ee615e06864deaa9e8bc3a8c701459")
...
public interface ISpotLight2 : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISpotLight2 {
    public val __1283829676_Ptr: Pointer?

    public val _1283829676_VtblPtr: Pointer?
      get() = __1283829676_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_InnerConeIntensity(): Float {
      val fnPtr = _1283829676_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__1283829676_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_InnerConeIntensity(value: Float): Unit {
      val fnPtr = _1283829676_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1283829676_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_OuterConeIntensity(): Float {
      val fnPtr = _1283829676_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__1283829676_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_OuterConeIntensity(value: Float): Unit {
      val fnPtr = _1283829676_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1283829676_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class ISpotLight2_Impl(
    ...
    public override val __1283829676_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISpotLight2, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("64ee615e06864deaa9e8bc3a8c701459")
    ...
    public override fun toNative(obj: ISpotLight2): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1283829676_Ptr))
  }
