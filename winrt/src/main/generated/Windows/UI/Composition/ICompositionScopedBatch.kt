...
@Signature("{0d00dad0-fb07-46fd-8c72-6280d1a3d1dd}")
@Guid("0d00dad0fb0746fd8c726280d1a3d1dd")
@WinRTInterface("0d00dad0fb0746fd8c726280d1a3d1dd")
...
public interface ICompositionScopedBatch : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionScopedBatch {
    public val __2058048942_Ptr: Pointer?

    public val _2058048942_VtblPtr: Pointer?
      get() = __2058048942_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_IsActive(): Boolean {
      val fnPtr = _2058048942_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__2058048942_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsEnded(): Boolean {
      val fnPtr = _2058048942_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__2058048942_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun End(): Unit {
      val fnPtr = _2058048942_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2058048942_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun Resume(): Unit {
      val fnPtr = _2058048942_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2058048942_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun Suspend(): Unit {
      val fnPtr = _2058048942_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2058048942_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun add_Completed(handler: TypedEventHandler<IUnknown?,
        CompositionBatchCompletedEventArgs?>?): EventRegistrationToken? {
      val fnPtr = _2058048942_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__2058048942_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun remove_Completed(token: EventRegistrationToken?): Unit {
      val fnPtr = _2058048942_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2058048942_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class ICompositionScopedBatch_Impl(
    ...
    public override val __2058048942_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionScopedBatch, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("0d00dad0fb0746fd8c726280d1a3d1dd")
    ...
    public override fun toNative(obj: ICompositionScopedBatch): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2058048942_Ptr))
  }
