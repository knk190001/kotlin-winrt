...
@Signature("{6f00ca92-c801-4e41-9a8f-a53e20f57778}")
@Guid("6f00ca92c8014e419a8fa53e20f57778")
@WinRTInterface("6f00ca92c8014e419a8fa53e20f57778")
...
public interface ICompositionColorGradientStop : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionColorGradientStop {
    public val __72489081_Ptr: Pointer?

    public val _72489081_VtblPtr: Pointer?
      get() = __72489081_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Color(): Color? {
      val fnPtr = _72489081_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__72489081_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Color(value: Color?): Unit {
      val fnPtr = _72489081_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__72489081_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Offset(): Float {
      val fnPtr = _72489081_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Offset(value: Float): Unit {
      val fnPtr = _72489081_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__72489081_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class ICompositionColorGradientStop_Impl(
    ...
    public override val __72489081_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionColorGradientStop, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("6f00ca92c8014e419a8fa53e20f57778")
    ...
    public override fun toNative(obj: ICompositionColorGradientStop): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__72489081_Ptr))
  }
