...
@Signature("{ae288fa9-252c-4b95-a725-bf85e38000a1}")
@Guid("ae288fa9252c4b95a725bf85e38000a1")
@WinRTInterface("ae288fa9252c4b95a725bf85e38000a1")
...
public interface IScalarKeyFrameAnimation : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IScalarKeyFrameAnimation {
    public val __406257956_Ptr: Pointer?

    public val _406257956_VtblPtr: Pointer?
      get() = __406257956_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun InsertKeyFrame(normalizedProgressKey: Float, value: Float): Unit {
      val fnPtr = _406257956_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__406257956_Ptr, normalizedProgressKey, value,))
      if (hr.toInt() != 0) {
    ...
    public override fun InsertKeyFrame(
      ...
      val fnPtr = _406257956_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__406257956_Ptr, normalizedProgressKey, value,
  ...
  public class IScalarKeyFrameAnimation_Impl(
    ...
    public override val __406257956_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IScalarKeyFrameAnimation, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("ae288fa9252c4b95a725bf85e38000a1")
    ...
    public override fun toNative(obj: IScalarKeyFrameAnimation): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__406257956_Ptr))
  }
