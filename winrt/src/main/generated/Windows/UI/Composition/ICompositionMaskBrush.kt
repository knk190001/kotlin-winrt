...
@Signature("{522cf09e-be6b-4f41-be49-f9226d471b4a}")
@Guid("522cf09ebe6b4f41be49f9226d471b4a")
@WinRTInterface("522cf09ebe6b4f41be49f9226d471b4a")
...
public interface ICompositionMaskBrush : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionMaskBrush {
    public val __1377611218_Ptr: Pointer?

    public val _1377611218_VtblPtr: Pointer?
      get() = __1377611218_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Mask(): CompositionBrush? {
      val fnPtr = _1377611218_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CompositionBrush>()
      val hr = fn.invokeHR(arrayOf(__1377611218_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Mask(value: CompositionBrush?): Unit {
      val fnPtr = _1377611218_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1377611218_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Source(): CompositionBrush? {
      val fnPtr = _1377611218_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CompositionBrush>()
      val hr = fn.invokeHR(arrayOf(__1377611218_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Source(value: CompositionBrush?): Unit {
      val fnPtr = _1377611218_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1377611218_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class ICompositionMaskBrush_Impl(
    ...
    public override val __1377611218_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionMaskBrush, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("522cf09ebe6b4f41be49f9226d471b4a")
    ...
    public override fun toNative(obj: ICompositionMaskBrush): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1377611218_Ptr))
  }
