...
@Signature("{6acc5431-7d3d-4bf3-abb6-f44bdc4888c1}")
@Guid("6acc54317d3d4bf3abb6f44bdc4888c1")
@WinRTInterface("6acc54317d3d4bf3abb6f44bdc4888c1")
...
public interface IExpressionAnimation : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IExpressionAnimation {
    public val __1554742946_Ptr: Pointer?

    public val _1554742946_VtblPtr: Pointer?
      get() = __1554742946_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Expression(): String? {
      val fnPtr = _1554742946_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__1554742946_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Expression(value: String?): Unit {
      val fnPtr = _1554742946_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1554742946_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IExpressionAnimation_Impl(
    ...
    public override val __1554742946_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IExpressionAnimation, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("6acc54317d3d4bf3abb6f44bdc4888c1")
    ...
    public override fun toNative(obj: IExpressionAnimation): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1554742946_Ptr))
  }
