...
@Signature("{5a9fe273-44a1-4f95-a422-8fa5116bdb44}")
@Guid("5a9fe27344a14f95a4228fa5116bdb44")
@WinRTInterface("5a9fe27344a14f95a4228fa5116bdb44")
...
public interface ISpotLight : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISpotLight {
    public val __928417466_Ptr: Pointer?

    public val _928417466_VtblPtr: Pointer?
      get() = __928417466_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ConstantAttenuation(): Float {
      val fnPtr = _928417466_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__928417466_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ConstantAttenuation(value: Float): Unit {
      val fnPtr = _928417466_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__928417466_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_CoordinateSpace(): Visual? {
      val fnPtr = _928417466_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_CoordinateSpace(value: Visual?): Unit {
      val fnPtr = _928417466_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__928417466_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Direction(): Vector3? {
      val fnPtr = _928417466_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Direction(value: Vector3?): Unit {
      val fnPtr = _928417466_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__928417466_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_InnerConeAngle(): Float {
      val fnPtr = _928417466_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__928417466_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_InnerConeAngle(value: Float): Unit {
      val fnPtr = _928417466_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__928417466_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_InnerConeAngleInDegrees(): Float {
      val fnPtr = _928417466_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__928417466_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_InnerConeAngleInDegrees(value: Float): Unit {
      val fnPtr = _928417466_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__928417466_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_InnerConeColor(): Color? {
      val fnPtr = _928417466_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_InnerConeColor(value: Color?): Unit {
      val fnPtr = _928417466_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__928417466_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_LinearAttenuation(): Float {
      val fnPtr = _928417466_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__928417466_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_LinearAttenuation(value: Float): Unit {
      val fnPtr = _928417466_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__928417466_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Offset(): Vector3? {
      val fnPtr = _928417466_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Vector3>()
      val hr = fn.invokeHR(arrayOf(__928417466_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Offset(value: Vector3?): Unit {
      val fnPtr = _928417466_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__928417466_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_OuterConeAngle(): Float {
      val fnPtr = _928417466_VtblPtr!!.getPointer(22L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__928417466_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_OuterConeAngle(value: Float): Unit {
      val fnPtr = _928417466_VtblPtr!!.getPointer(23L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__928417466_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_OuterConeAngleInDegrees(): Float {
      val fnPtr = _928417466_VtblPtr!!.getPointer(24L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__928417466_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_OuterConeAngleInDegrees(value: Float): Unit {
      val fnPtr = _928417466_VtblPtr!!.getPointer(25L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__928417466_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_OuterConeColor(): Color? {
      val fnPtr = _928417466_VtblPtr!!.getPointer(26L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__928417466_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_OuterConeColor(value: Color?): Unit {
      val fnPtr = _928417466_VtblPtr!!.getPointer(27L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__928417466_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_QuadraticAttenuation(): Float {
      val fnPtr = _928417466_VtblPtr!!.getPointer(28L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__928417466_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_QuadraticAttenuation(value: Float): Unit {
      val fnPtr = _928417466_VtblPtr!!.getPointer(29L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__928417466_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class ISpotLight_Impl(
    ...
    public override val __928417466_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISpotLight, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("5a9fe27344a14f95a4228fa5116bdb44")
    ...
    public override fun toNative(obj: ISpotLight): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__928417466_Ptr))
  }
