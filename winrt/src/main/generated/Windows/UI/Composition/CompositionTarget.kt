...
@Signature("rc(Windows.UI.Composition.CompositionTarget;{a1bea8ba-d726-4663-8129-6b5e7927ffa6})")
@WinRTByReference(brClass = CompositionTarget.ByReference::class)
public open class CompositionTarget(
  ptr: JNAPointer? = NULL
) : CompositionObject(ptr), ICompositionTarget.WithDefault, IWinRTObject {
  private val __1292937709_Interface: ICompositionTarget.WithDefault by lazy {
    as_1292937709()
  }


  public override val __1292937709_Ptr: JNAPointer? by lazy {
    __1292937709_Interface.__1292937709_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1292937709_Interface)

  private fun as_1292937709(): ICompositionTarget.WithDefault {
    if(pointer == NULL) {
