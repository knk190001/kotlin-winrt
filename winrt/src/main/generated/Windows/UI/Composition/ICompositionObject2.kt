...
@Signature("{ef874ea1-5cff-4b68-9e30-a1519d08ba03}")
@Guid("ef874ea15cff4b689e30a1519d08ba03")
@WinRTInterface("ef874ea15cff4b689e30a1519d08ba03")
...
public interface ICompositionObject2 : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionObject2 {
    public val __1304991735_Ptr: Pointer?

    public val _1304991735_VtblPtr: Pointer?
      get() = __1304991735_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Comment(): String? {
      val fnPtr = _1304991735_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__1304991735_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Comment(value: String?): Unit {
      val fnPtr = _1304991735_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1304991735_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_ImplicitAnimations(): ImplicitAnimationCollection? {
      val fnPtr = _1304991735_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_ImplicitAnimations(value: ImplicitAnimationCollection?): Unit {
      val fnPtr = _1304991735_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1304991735_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun StartAnimationGroup(value: ICompositionAnimationBase?): Unit {
      val fnPtr = _1304991735_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1304991735_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun StopAnimationGroup(value: ICompositionAnimationBase?): Unit {
      val fnPtr = _1304991735_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1304991735_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class ICompositionObject2_Impl(
    ...
    public override val __1304991735_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionObject2, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("ef874ea15cff4b689e30a1519d08ba03")
    ...
    public override fun toNative(obj: ICompositionObject2): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1304991735_Ptr))
  }
