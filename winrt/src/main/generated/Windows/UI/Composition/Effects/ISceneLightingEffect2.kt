...
@Signature("{9e270e81-72f0-4c5c-95f8-8a6e0024f409}")
@Guid("9e270e8172f04c5c95f88a6e0024f409")
@WinRTInterface("9e270e8172f04c5c95f88a6e0024f409")
...
public interface ISceneLightingEffect2 : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISceneLightingEffect2 {
    public val __77065507_Ptr: Pointer?

    public val _77065507_VtblPtr: Pointer?
      get() = __77065507_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ReflectanceModel(): SceneLightingEffectReflectanceModel? {
      val fnPtr = _77065507_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<SceneLightingEffectReflectanceModel>()
      val hr = fn.invokeHR(arrayOf(__77065507_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ReflectanceModel(value: SceneLightingEffectReflectanceModel?): Unit {
      val fnPtr = _77065507_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__77065507_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class ISceneLightingEffect2_Impl(
    ...
    public override val __77065507_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISceneLightingEffect2, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("9e270e8172f04c5c95f88a6e0024f409")
    ...
    public override fun toNative(obj: ISceneLightingEffect2): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__77065507_Ptr))
  }
