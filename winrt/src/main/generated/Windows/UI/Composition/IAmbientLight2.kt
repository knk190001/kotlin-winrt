...
@Signature("{3b64a6bf-5f97-4c94-86e5-042dd386b27d}")
@Guid("3b64a6bf5f974c9486e5042dd386b27d")
@WinRTInterface("3b64a6bf5f974c9486e5042dd386b27d")
...
public interface IAmbientLight2 : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IAmbientLight2 {
    public val __262307238_Ptr: Pointer?

    public val _262307238_VtblPtr: Pointer?
      get() = __262307238_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Intensity(): Float {
      val fnPtr = _262307238_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__262307238_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Intensity(value: Float): Unit {
      val fnPtr = _262307238_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__262307238_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IAmbientLight2_Impl(
    ...
    public override val __262307238_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IAmbientLight2, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("3b64a6bf5f974c9486e5042dd386b27d")
    ...
    public override fun toNative(obj: IAmbientLight2): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__262307238_Ptr))
  }
