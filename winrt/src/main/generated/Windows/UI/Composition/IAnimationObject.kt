...
@Signature("{e7141e0a-04b8-4fc5-a4dc-195392e57807}")
@Guid("e7141e0a04b84fc5a4dc195392e57807")
@WinRTInterface("e7141e0a04b84fc5a4dc195392e57807")
...
public interface IAnimationObject : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IAnimationObject {
    public val __1365507701_Ptr: Pointer?

    public val _1365507701_VtblPtr: Pointer?
      get() = __1365507701_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun PopulatePropertyInfo(propertyName: String?,
        propertyInfo: AnimationPropertyInfo?): Unit {
      val fnPtr = _1365507701_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1365507701_Ptr, marshalToNative(propertyName),
  ...
  public class IAnimationObject_Impl(
    ...
    public override val __1365507701_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IAnimationObject, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("e7141e0a04b84fc5a4dc195392e57807")
    ...
    public override fun toNative(obj: IAnimationObject): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1365507701_Ptr))
  }
