...
@Signature("rc(Windows.UI.Composition.DistantLight;{318cfafc-5ce3-4b55-ab5d-07a00353ac99})")
...
public class DistantLight(
  ...
  private val __804044227_Interface: IDistantLight.WithDefault by lazy {
    as_804044227()
  }


  private val __844432689_Interface: IDistantLight2.WithDefault by lazy {
    as_844432689()
  }


  public override val __804044227_Ptr: JNAPointer? by lazy {
    __804044227_Interface.__804044227_Ptr
  }


  public override val __844432689_Ptr: JNAPointer? by lazy {
    __844432689_Interface.__844432689_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__804044227_Interface, __844432689_Interface)

  private fun as_804044227(): IDistantLight.WithDefault {
    if(pointer == NULL) {
  ...
  private fun as_844432689(): IDistantLight2.WithDefault {
    if(pointer == NULL) {
