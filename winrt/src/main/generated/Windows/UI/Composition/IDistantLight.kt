...
@Signature("{318cfafc-5ce3-4b55-ab5d-07a00353ac99}")
@Guid("318cfafc5ce34b55ab5d07a00353ac99")
@WinRTInterface("318cfafc5ce34b55ab5d07a00353ac99")
...
public interface IDistantLight : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IDistantLight {
    public val __804044227_Ptr: Pointer?

    public val _804044227_VtblPtr: Pointer?
      get() = __804044227_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Color(): Color? {
      val fnPtr = _804044227_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__804044227_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Color(value: Color?): Unit {
      val fnPtr = _804044227_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__804044227_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_CoordinateSpace(): Visual? {
      val fnPtr = _804044227_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_CoordinateSpace(value: Visual?): Unit {
      val fnPtr = _804044227_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__804044227_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Direction(): Vector3? {
      val fnPtr = _804044227_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Direction(value: Vector3?): Unit {
      val fnPtr = _804044227_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__804044227_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IDistantLight_Impl(
    ...
    public override val __804044227_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IDistantLight, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("318cfafc5ce34b55ab5d07a00353ac99")
    ...
    public override fun toNative(obj: IDistantLight): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__804044227_Ptr))
  }
