...
@Signature("{efe98f2c-0678-4f69-b164-a810d995bcb7}")
@Guid("efe98f2c06784f69b164a810d995bcb7")
@WinRTInterface("efe98f2c06784f69b164a810d995bcb7")
...
public interface IPointLight2 : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPointLight2 {
    public val __1158716642_Ptr: Pointer?

    public val _1158716642_VtblPtr: Pointer?
      get() = __1158716642_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Intensity(): Float {
      val fnPtr = _1158716642_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__1158716642_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Intensity(value: Float): Unit {
      val fnPtr = _1158716642_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1158716642_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IPointLight2_Impl(
    ...
    public override val __1158716642_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPointLight2, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("efe98f2c06784f69b164a810d995bcb7")
    ...
    public override fun toNative(obj: IPointLight2): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1158716642_Ptr))
  }
