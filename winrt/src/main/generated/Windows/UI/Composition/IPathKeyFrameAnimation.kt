...
@Signature("{9d0d18c9-1576-4b3f-be60-1d5031f5e71b}")
@Guid("9d0d18c915764b3fbe601d5031f5e71b")
@WinRTInterface("9d0d18c915764b3fbe601d5031f5e71b")
...
public interface IPathKeyFrameAnimation : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPathKeyFrameAnimation {
    public val __1460572227_Ptr: Pointer?

    public val _1460572227_VtblPtr: Pointer?
      get() = __1460572227_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun InsertKeyFrame(normalizedProgressKey: Float, path: CompositionPath?): Unit {
      val fnPtr = _1460572227_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1460572227_Ptr, normalizedProgressKey, marshalToNative(path),))
      if (hr.toInt() != 0) {
    ...
    public override fun InsertKeyFrame(
      ...
      val fnPtr = _1460572227_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1460572227_Ptr, normalizedProgressKey, marshalToNative(path),
  ...
  public class IPathKeyFrameAnimation_Impl(
    ...
    public override val __1460572227_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPathKeyFrameAnimation, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("9d0d18c915764b3fbe601d5031f5e71b")
    ...
    public override fun toNative(obj: IPathKeyFrameAnimation): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1460572227_Ptr))
  }
