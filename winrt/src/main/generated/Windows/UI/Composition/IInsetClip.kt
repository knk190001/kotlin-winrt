...
@Signature("{1e73e647-84c7-477a-b474-5880e0442e15}")
@Guid("1e73e64784c7477ab4745880e0442e15")
@WinRTInterface("1e73e64784c7477ab4745880e0442e15")
...
public interface IInsetClip : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IInsetClip {
    public val __362971617_Ptr: Pointer?

    public val _362971617_VtblPtr: Pointer?
      get() = __362971617_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_BottomInset(): Float {
      val fnPtr = _362971617_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__362971617_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_BottomInset(value: Float): Unit {
      val fnPtr = _362971617_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__362971617_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_LeftInset(): Float {
      val fnPtr = _362971617_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__362971617_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_LeftInset(value: Float): Unit {
      val fnPtr = _362971617_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__362971617_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_RightInset(): Float {
      val fnPtr = _362971617_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__362971617_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_RightInset(value: Float): Unit {
      val fnPtr = _362971617_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__362971617_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_TopInset(): Float {
      val fnPtr = _362971617_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__362971617_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_TopInset(value: Float): Unit {
      val fnPtr = _362971617_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__362971617_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IInsetClip_Impl(
    ...
    public override val __362971617_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IInsetClip, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("1e73e64784c7477ab4745880e0442e15")
    ...
    public override fun toNative(obj: IInsetClip): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__362971617_Ptr))
  }
