...
@Signature("{3a31ac7d-28bf-4e7a-8524-71679d480f38}")
@Guid("3a31ac7d28bf4e7a852471679d480f38")
@WinRTInterface("3a31ac7d28bf4e7a852471679d480f38")
...
public interface IRenderingDeviceReplacedEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IRenderingDeviceReplacedEventArgs {
    public val __497543187_Ptr: Pointer?

    public val _497543187_VtblPtr: Pointer?
      get() = __497543187_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_GraphicsDevice(): CompositionGraphicsDevice? {
      val fnPtr = _497543187_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CompositionGraphicsDevice>()
      val hr = fn.invokeHR(arrayOf(__497543187_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IRenderingDeviceReplacedEventArgs_Impl(
    ...
    public override val __497543187_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IRenderingDeviceReplacedEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("3a31ac7d28bf4e7a852471679d480f38")
    ...
    public override fun toNative(obj: IRenderingDeviceReplacedEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__497543187_Ptr))
  }
