...
@Signature("{a48130a1-b7c4-46f7-b9bf-daf43a44e6ee}")
@Guid("a48130a1b7c446f7b9bfdaf43a44e6ee")
@WinRTInterface("a48130a1b7c446f7b9bfdaf43a44e6ee")
...
public interface IAmbientLight : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IAmbientLight {
    public val __1948124172_Ptr: Pointer?

    public val _1948124172_VtblPtr: Pointer?
      get() = __1948124172_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Color(): Color? {
      val fnPtr = _1948124172_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1948124172_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Color(value: Color?): Unit {
      val fnPtr = _1948124172_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1948124172_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IAmbientLight_Impl(
    ...
    public override val __1948124172_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IAmbientLight, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("a48130a1b7c446f7b9bfdaf43a44e6ee")
    ...
    public override fun toNative(obj: IAmbientLight): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1948124172_Ptr))
  }
