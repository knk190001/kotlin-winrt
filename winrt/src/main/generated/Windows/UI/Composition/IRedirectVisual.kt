...
@Signature("{8cc6e340-8b75-5422-b06f-09ffe9f8617e}")
@Guid("8cc6e3408b755422b06f09ffe9f8617e")
@WinRTInterface("8cc6e3408b755422b06f09ffe9f8617e")
...
public interface IRedirectVisual : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IRedirectVisual {
    public val __289409686_Ptr: Pointer?

    public val _289409686_VtblPtr: Pointer?
      get() = __289409686_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Source(): Visual? {
      val fnPtr = _289409686_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Visual>()
      val hr = fn.invokeHR(arrayOf(__289409686_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Source(value: Visual?): Unit {
      val fnPtr = _289409686_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__289409686_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IRedirectVisual_Impl(
    ...
    public override val __289409686_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IRedirectVisual, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("8cc6e3408b755422b06f09ffe9f8617e")
    ...
    public override fun toNative(obj: IRedirectVisual): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__289409686_Ptr))
  }
