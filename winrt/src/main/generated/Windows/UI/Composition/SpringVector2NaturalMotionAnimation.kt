...
@Signature("rc(Windows.UI.Composition.SpringVector2NaturalMotionAnimation;{23f494b5-ee73-4f0f-a423-402b946df4b3})")
...
public class SpringVector2NaturalMotionAnimation(
  ptr: JNAPointer? = NULL
    ...
    IWinRTObject {
  private val __606952889_Interface: ISpringVector2NaturalMotionAnimation.WithDefault by lazy {
    as_606952889()
  }


  public override val __606952889_Ptr: JNAPointer? by lazy {
    __606952889_Interface.__606952889_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__606952889_Interface)

  private fun as_606952889(): ISpringVector2NaturalMotionAnimation.WithDefault {
    if(pointer == NULL) {
