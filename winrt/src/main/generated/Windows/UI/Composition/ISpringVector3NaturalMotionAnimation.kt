...
@Signature("{6c8749df-d57b-4794-8e2d-cecb11e194e5}")
@Guid("6c8749dfd57b47948e2dcecb11e194e5")
@WinRTInterface("6c8749dfd57b47948e2dcecb11e194e5")
...
public interface ISpringVector3NaturalMotionAnimation : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISpringVector3NaturalMotionAnimation {
    public val __1851717370_Ptr: Pointer?

    public val _1851717370_VtblPtr: Pointer?
      get() = __1851717370_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_DampingRatio(): Float {
      val fnPtr = _1851717370_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__1851717370_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_DampingRatio(value: Float): Unit {
      val fnPtr = _1851717370_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1851717370_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Period(): TimeSpan? {
      val fnPtr = _1851717370_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Period(value: TimeSpan?): Unit {
      val fnPtr = _1851717370_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1851717370_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class ISpringVector3NaturalMotionAnimation_Impl(
    ...
    public override val __1851717370_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISpringVector3NaturalMotionAnimation, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("6c8749dfd57b47948e2dcecb11e194e5")
    ...
    public override fun toNative(obj: ISpringVector3NaturalMotionAnimation): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1851717370_Ptr))
  }
