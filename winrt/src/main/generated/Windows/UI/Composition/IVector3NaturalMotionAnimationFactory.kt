...
@Signature("{21a81d2f-0880-457b-ac87-b609018c876d}")
@Guid("21a81d2f0880457bac87b609018c876d")
@WinRTInterface("21a81d2f0880457bac87b609018c876d")
...
public interface IVector3NaturalMotionAnimationFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IVector3NaturalMotionAnimationFactory {
    public val __1160309635_Ptr: Pointer?

    public val _1160309635_VtblPtr: Pointer?
      get() = __1160309635_Ptr?.getPointer(0)
  }

  public class IVector3NaturalMotionAnimationFactory_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __1160309635_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IVector3NaturalMotionAnimationFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("21a81d2f0880457bac87b609018c876d")
    ...
    public override fun toNative(obj: IVector3NaturalMotionAnimationFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1160309635_Ptr))
  }
