...
@Signature("{8253353e-b517-48bc-b1e8-4b3561a2e181}")
@Guid("8253353eb51748bcb1e84b3561a2e181")
@WinRTInterface("8253353eb51748bcb1e84b3561a2e181")
...
public interface ICompositionCapabilities : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionCapabilities {
    public val __1826974958_Ptr: Pointer?

    public val _1826974958_VtblPtr: Pointer?
      get() = __1826974958_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun AreEffectsSupported(): Boolean {
      val fnPtr = _1826974958_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1826974958_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun AreEffectsFast(): Boolean {
      val fnPtr = _1826974958_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1826974958_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun add_Changed(handler: TypedEventHandler<CompositionCapabilities?,
      ...
      val fnPtr = _1826974958_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__1826974958_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun remove_Changed(token: EventRegistrationToken?): Unit {
      val fnPtr = _1826974958_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1826974958_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class ICompositionCapabilities_Impl(
    ...
    public override val __1826974958_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionCapabilities, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("8253353eb51748bcb1e84b3561a2e181")
    ...
    public override fun toNative(obj: ICompositionCapabilities): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1826974958_Ptr))
  }
