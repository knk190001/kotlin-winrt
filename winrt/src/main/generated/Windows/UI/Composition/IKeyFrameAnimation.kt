...
@Signature("{126e7f22-3ae9-4540-9a8a-deae8a4a4a84}")
@Guid("126e7f223ae945409a8adeae8a4a4a84")
@WinRTInterface("126e7f223ae945409a8adeae8a4a4a84")
...
public interface IKeyFrameAnimation : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IKeyFrameAnimation {
    public val __25436440_Ptr: Pointer?

    public val _25436440_VtblPtr: Pointer?
      get() = __25436440_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_DelayTime(): TimeSpan? {
      val fnPtr = _25436440_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<TimeSpan>()
      val hr = fn.invokeHR(arrayOf(__25436440_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_DelayTime(value: TimeSpan?): Unit {
      val fnPtr = _25436440_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__25436440_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Duration(): TimeSpan? {
      val fnPtr = _25436440_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<TimeSpan>()
      val hr = fn.invokeHR(arrayOf(__25436440_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Duration(value: TimeSpan?): Unit {
      val fnPtr = _25436440_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__25436440_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_IterationBehavior(): AnimationIterationBehavior? {
      val fnPtr = _25436440_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_IterationBehavior(value: AnimationIterationBehavior?): Unit {
      val fnPtr = _25436440_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__25436440_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_IterationCount(): Int {
      val fnPtr = _25436440_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_IterationCount(value: Int): Unit {
      val fnPtr = _25436440_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__25436440_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_KeyFrameCount(): Int {
      val fnPtr = _25436440_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__25436440_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_StopBehavior(): AnimationStopBehavior? {
      val fnPtr = _25436440_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_StopBehavior(value: AnimationStopBehavior?): Unit {
      val fnPtr = _25436440_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__25436440_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun InsertExpressionKeyFrame(normalizedProgressKey: Float, value: String?):
        Unit {
      val fnPtr = _25436440_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__25436440_Ptr, normalizedProgressKey, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun InsertExpressionKeyFrame(
      ...
      val fnPtr = _25436440_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__25436440_Ptr, normalizedProgressKey, marshalToNative(value),
  ...
  public class IKeyFrameAnimation_Impl(
    ...
    public override val __25436440_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IKeyFrameAnimation, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("126e7f223ae945409a8adeae8a4a4a84")
    ...
    public override fun toNative(obj: IKeyFrameAnimation): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__25436440_Ptr))
  }
