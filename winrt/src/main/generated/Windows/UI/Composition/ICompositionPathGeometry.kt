...
@Signature("{0b6a417e-2c77-4c23-af5e-6304c147bb61}")
@Guid("0b6a417e2c774c23af5e6304c147bb61")
@WinRTInterface("0b6a417e2c774c23af5e6304c147bb61")
...
public interface ICompositionPathGeometry : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionPathGeometry {
    public val __320626451_Ptr: Pointer?

    public val _320626451_VtblPtr: Pointer?
      get() = __320626451_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Path(): CompositionPath? {
      val fnPtr = _320626451_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CompositionPath>()
      val hr = fn.invokeHR(arrayOf(__320626451_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Path(value: CompositionPath?): Unit {
      val fnPtr = _320626451_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__320626451_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class ICompositionPathGeometry_Impl(
    ...
    public override val __320626451_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionPathGeometry, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("0b6a417e2c774c23af5e6304c147bb61")
    ...
    public override fun toNative(obj: ICompositionPathGeometry): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__320626451_Ptr))
  }
