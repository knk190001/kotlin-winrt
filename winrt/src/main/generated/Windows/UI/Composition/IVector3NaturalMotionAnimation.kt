...
@Signature("{9c17042c-e2ca-45ad-969e-4e78b7b9ad41}")
@Guid("9c17042ce2ca45ad969e4e78b7b9ad41")
@WinRTInterface("9c17042ce2ca45ad969e4e78b7b9ad41")
...
public interface IVector3NaturalMotionAnimation : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IVector3NaturalMotionAnimation {
    public val __132143225_Ptr: Pointer?

    public val _132143225_VtblPtr: Pointer?
      get() = __132143225_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_FinalValue(): IReference<Vector3?>? {
      val fnPtr = _132143225_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IReference<Vector3?>>()
      val hr = fn.invokeHR(arrayOf(__132143225_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_FinalValue(value: IReference<Vector3?>?): Unit {
      val fnPtr = _132143225_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__132143225_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_InitialValue(): IReference<Vector3?>? {
      val fnPtr = _132143225_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IReference<Vector3?>>()
      val hr = fn.invokeHR(arrayOf(__132143225_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_InitialValue(value: IReference<Vector3?>?): Unit {
      val fnPtr = _132143225_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__132143225_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_InitialVelocity(): Vector3? {
      val fnPtr = _132143225_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_InitialVelocity(value: Vector3?): Unit {
      val fnPtr = _132143225_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__132143225_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IVector3NaturalMotionAnimation_Impl(
    ...
    public override val __132143225_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IVector3NaturalMotionAnimation, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("9c17042ce2ca45ad969e4e78b7b9ad41")
    ...
    public override fun toNative(obj: IVector3NaturalMotionAnimation): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__132143225_Ptr))
  }
