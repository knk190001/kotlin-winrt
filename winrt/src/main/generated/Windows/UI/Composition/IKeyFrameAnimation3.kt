...
@Signature("{845bf0b4-d8de-462f-8753-c80d43c6ff5a}")
@Guid("845bf0b4d8de462f8753c80d43c6ff5a")
@WinRTInterface("845bf0b4d8de462f8753c80d43c6ff5a")
...
public interface IKeyFrameAnimation3 : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IKeyFrameAnimation3 {
    public val __788529589_Ptr: Pointer?

    public val _788529589_VtblPtr: Pointer?
      get() = __788529589_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_DelayBehavior(): AnimationDelayBehavior? {
      val fnPtr = _788529589_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AnimationDelayBehavior>()
      val hr = fn.invokeHR(arrayOf(__788529589_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_DelayBehavior(value: AnimationDelayBehavior?): Unit {
      val fnPtr = _788529589_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__788529589_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IKeyFrameAnimation3_Impl(
    ...
    public override val __788529589_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IKeyFrameAnimation3, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("845bf0b4d8de462f8753c80d43c6ff5a")
    ...
    public override fun toNative(obj: IKeyFrameAnimation3): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__788529589_Ptr))
  }
