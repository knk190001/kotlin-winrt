...
@Signature("{770137be-76bc-4e23-bfed-fe9cc20f6ec9}")
@Guid("770137be76bc4e23bfedfe9cc20f6ec9")
@WinRTInterface("770137be76bc4e23bfedfe9cc20f6ec9")
...
public interface ICompositionAnimation4 : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionAnimation4 {
    public val __1786839156_Ptr: Pointer?

    public val _1786839156_VtblPtr: Pointer?
      get() = __1786839156_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun SetExpressionReferenceParameter(parameterName: String?,
        source: IAnimationObject?): Unit {
      val fnPtr = _1786839156_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1786839156_Ptr, marshalToNative(parameterName),
  ...
  public class ICompositionAnimation4_Impl(
    ...
    public override val __1786839156_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionAnimation4, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("770137be76bc4e23bfedfe9cc20f6ec9")
    ...
    public override fun toNative(obj: ICompositionAnimation4): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1786839156_Ptr))
  }
