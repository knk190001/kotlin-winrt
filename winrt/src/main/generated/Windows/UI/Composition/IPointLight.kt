...
@Signature("{b18545b3-0c5a-4ab0-bedc-4f3546948272}")
@Guid("b18545b30c5a4ab0bedc4f3546948272")
@WinRTInterface("b18545b30c5a4ab0bedc4f3546948272")
...
public interface IPointLight : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPointLight {
    public val __1902284692_Ptr: Pointer?

    public val _1902284692_VtblPtr: Pointer?
      get() = __1902284692_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Color(): Color? {
      val fnPtr = _1902284692_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1902284692_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Color(value: Color?): Unit {
      val fnPtr = _1902284692_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1902284692_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_ConstantAttenuation(): Float {
      val fnPtr = _1902284692_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_ConstantAttenuation(value: Float): Unit {
      val fnPtr = _1902284692_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1902284692_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_CoordinateSpace(): Visual? {
      val fnPtr = _1902284692_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_CoordinateSpace(value: Visual?): Unit {
      val fnPtr = _1902284692_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1902284692_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_LinearAttenuation(): Float {
      val fnPtr = _1902284692_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__1902284692_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_LinearAttenuation(value: Float): Unit {
      val fnPtr = _1902284692_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1902284692_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Offset(): Vector3? {
      val fnPtr = _1902284692_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Offset(value: Vector3?): Unit {
      val fnPtr = _1902284692_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1902284692_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_QuadraticAttenuation(): Float {
      val fnPtr = _1902284692_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__1902284692_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_QuadraticAttenuation(value: Float): Unit {
      val fnPtr = _1902284692_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1902284692_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IPointLight_Impl(
    ...
    public override val __1902284692_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPointLight, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("b18545b30c5a4ab0bedc4f3546948272")
    ...
    public override fun toNative(obj: IPointLight): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1902284692_Ptr))
  }
