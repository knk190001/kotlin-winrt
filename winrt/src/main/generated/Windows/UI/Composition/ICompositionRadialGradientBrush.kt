...
@Signature("{3d3b50c5-e3fa-4ce2-b9fc-3ee12561788f}")
@Guid("3d3b50c5e3fa4ce2b9fc3ee12561788f")
@WinRTInterface("3d3b50c5e3fa4ce2b9fc3ee12561788f")
...
public interface ICompositionRadialGradientBrush : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionRadialGradientBrush {
    public val __185574609_Ptr: Pointer?

    public val _185574609_VtblPtr: Pointer?
      get() = __185574609_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_EllipseCenter(): Vector2? {
      val fnPtr = _185574609_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Vector2>()
      val hr = fn.invokeHR(arrayOf(__185574609_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_EllipseCenter(value: Vector2?): Unit {
      val fnPtr = _185574609_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__185574609_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_EllipseRadius(): Vector2? {
      val fnPtr = _185574609_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Vector2>()
      val hr = fn.invokeHR(arrayOf(__185574609_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_EllipseRadius(value: Vector2?): Unit {
      val fnPtr = _185574609_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__185574609_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_GradientOriginOffset(): Vector2? {
      val fnPtr = _185574609_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Vector2>()
      val hr = fn.invokeHR(arrayOf(__185574609_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_GradientOriginOffset(value: Vector2?): Unit {
      val fnPtr = _185574609_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__185574609_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class ICompositionRadialGradientBrush_Impl(
    ...
    public override val __185574609_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionRadialGradientBrush, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("3d3b50c5e3fa4ce2b9fc3ee12561788f")
    ...
    public override fun toNative(obj: ICompositionRadialGradientBrush): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__185574609_Ptr))
  }
