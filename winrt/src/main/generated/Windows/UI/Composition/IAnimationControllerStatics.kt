...
@Signature("{e71164df-651b-4800-b9e5-6a3bcfed3365}")
@Guid("e71164df651b4800b9e56a3bcfed3365")
@WinRTInterface("e71164df651b4800b9e56a3bcfed3365")
...
public interface IAnimationControllerStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IAnimationControllerStatics {
    public val __2130105235_Ptr: Pointer?

    public val _2130105235_VtblPtr: Pointer?
      get() = __2130105235_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_MaxPlaybackRate(): Float {
      val fnPtr = _2130105235_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__2130105235_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_MinPlaybackRate(): Float {
      val fnPtr = _2130105235_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__2130105235_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IAnimationControllerStatics_Impl(
    ...
    public override val __2130105235_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IAnimationControllerStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("e71164df651b4800b9e56a3bcfed3365")
    ...
    public override fun toNative(obj: IAnimationControllerStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2130105235_Ptr))
  }
