...
@Signature("{10f6c4fb-6e51-4c25-bbd3-586a9bec3ef4}")
@Guid("10f6c4fb6e514c25bbd3586a9bec3ef4")
@WinRTInterface("10f6c4fb6e514c25bbd3586a9bec3ef4")
...
public interface ICompositionAnimationFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionAnimationFactory {
    public val __1521752510_Ptr: Pointer?

    public val _1521752510_VtblPtr: Pointer?
      get() = __1521752510_Ptr?.getPointer(0)
  }

  public class ICompositionAnimationFactory_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __1521752510_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionAnimationFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("10f6c4fb6e514c25bbd3586a9bec3ef4")
    ...
    public override fun toNative(obj: ICompositionAnimationFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1521752510_Ptr))
  }
