...
@Signature("rc(Windows.UI.Composition.PointLight;{b18545b3-0c5a-4ab0-bedc-4f3546948272})")
...
public class PointLight(
  ...
  private val __1902284692_Interface: IPointLight.WithDefault by lazy {
    as_1902284692()
  }


  private val __1158716642_Interface: IPointLight2.WithDefault by lazy {
    as_1158716642()
  }


  private val __1158716641_Interface: IPointLight3.WithDefault by lazy {
    as_1158716641()
  }


  public override val __1902284692_Ptr: JNAPointer? by lazy {
    __1902284692_Interface.__1902284692_Ptr
  }


  public override val __1158716642_Ptr: JNAPointer? by lazy {
    __1158716642_Interface.__1158716642_Ptr
  }


  public override val __1158716641_Ptr: JNAPointer? by lazy {
    __1158716641_Interface.__1158716641_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1902284692_Interface, __1158716642_Interface, __1158716641_Interface)

  private fun as_1902284692(): IPointLight.WithDefault {
    if(pointer == NULL) {
  ...
  private fun as_1158716642(): IPointLight2.WithDefault {
    if(pointer == NULL) {
  ...
  private fun as_1158716641(): IPointLight3.WithDefault {
    if(pointer == NULL) {
