...
@Signature("{2457945b-addd-4385-9606-b6a3d5e4e1b9}")
@Guid("2457945baddd43859606b6a3d5e4e1b9")
@WinRTInterface("2457945baddd43859606b6a3d5e4e1b9")
...
public interface IVector4KeyFrameAnimation : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IVector4KeyFrameAnimation {
    public val __72603443_Ptr: Pointer?

    public val _72603443_VtblPtr: Pointer?
      get() = __72603443_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun InsertKeyFrame(normalizedProgressKey: Float, value: Vector4?): Unit {
      val fnPtr = _72603443_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__72603443_Ptr, normalizedProgressKey, marshalToNative(value),))
      if (hr.toInt() != 0) {
    ...
    public override fun InsertKeyFrame(
      ...
      val fnPtr = _72603443_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__72603443_Ptr, normalizedProgressKey, marshalToNative(value),
  ...
  public class IVector4KeyFrameAnimation_Impl(
    ...
    public override val __72603443_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IVector4KeyFrameAnimation, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("2457945baddd43859606b6a3d5e4e1b9")
    ...
    public override fun toNative(obj: IVector4KeyFrameAnimation): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__72603443_Ptr))
  }
