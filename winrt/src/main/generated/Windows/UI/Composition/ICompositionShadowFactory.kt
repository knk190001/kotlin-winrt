...
@Signature("{221f492f-dcba-4b91-999e-1dc217a01530}")
@Guid("221f492fdcba4b91999e1dc217a01530")
@WinRTInterface("221f492fdcba4b91999e1dc217a01530")
...
public interface ICompositionShadowFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionShadowFactory {
    public val __1590014958_Ptr: Pointer?

    public val _1590014958_VtblPtr: Pointer?
      get() = __1590014958_Ptr?.getPointer(0)
  }

  public class ICompositionShadowFactory_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __1590014958_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionShadowFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("221f492fdcba4b91999e1dc217a01530")
    ...
    public override fun toNative(obj: ICompositionShadowFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1590014958_Ptr))
  }
