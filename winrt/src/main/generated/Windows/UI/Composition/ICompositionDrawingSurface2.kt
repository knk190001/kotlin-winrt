...
@Signature("{fad0e88b-e354-44e8-8e3d-c4880d5a213f}")
@Guid("fad0e88be35444e88e3dc4880d5a213f")
@WinRTInterface("fad0e88be35444e88e3dc4880d5a213f")
...
public interface ICompositionDrawingSurface2 : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionDrawingSurface2 {
    public val __201936249_Ptr: Pointer?

    public val _201936249_VtblPtr: Pointer?
      get() = __201936249_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_SizeInt32(): SizeInt32? {
      val fnPtr = _201936249_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<SizeInt32>()
      val hr = fn.invokeHR(arrayOf(__201936249_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun Resize(sizePixels: SizeInt32?): Unit {
      val fnPtr = _201936249_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__201936249_Ptr, marshalToNative(sizePixels),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun Scroll(offset: PointInt32?): Unit {
      val fnPtr = _201936249_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__201936249_Ptr, marshalToNative(offset),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun Scroll(offset: PointInt32?, scrollRect: RectInt32?): Unit {
      val fnPtr = _201936249_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__201936249_Ptr, marshalToNative(offset),
    ...
    public override fun ScrollWithClip(offset: PointInt32?, clipRect: RectInt32?): Unit {
      val fnPtr = _201936249_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__201936249_Ptr, marshalToNative(offset),
    ...
    public override fun ScrollWithClip(
      ...
      val fnPtr = _201936249_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__201936249_Ptr, marshalToNative(offset),
  ...
  public class ICompositionDrawingSurface2_Impl(
    ...
    public override val __201936249_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionDrawingSurface2, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("fad0e88be35444e88e3dc4880d5a213f")
    ...
    public override fun toNative(obj: ICompositionDrawingSurface2): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__201936249_Ptr))
  }
