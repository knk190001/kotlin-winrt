...
@Signature("{48ea31ad-7fcd-4076-a79c-90cc4b852c9b}")
@Guid("48ea31ad7fcd4076a79c90cc4b852c9b")
@WinRTInterface("48ea31ad7fcd4076a79c90cc4b852c9b")
...
public interface ICompositor5 : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositor5 {
    public val __2043002906_Ptr: Pointer?

    public val _2043002906_VtblPtr: Pointer?
      get() = __2043002906_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Comment(): String? {
      val fnPtr = _2043002906_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__2043002906_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Comment(value: String?): Unit {
      val fnPtr = _2043002906_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2043002906_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_GlobalPlaybackRate(): Float {
      val fnPtr = _2043002906_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_GlobalPlaybackRate(value: Float): Unit {
      val fnPtr = _2043002906_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2043002906_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun CreateBounceScalarAnimation(): BounceScalarNaturalMotionAnimation? {
      val fnPtr = _2043002906_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun CreateBounceVector2Animation(): BounceVector2NaturalMotionAnimation? {
      val fnPtr = _2043002906_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun CreateBounceVector3Animation(): BounceVector3NaturalMotionAnimation? {
      val fnPtr = _2043002906_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun CreateContainerShape(): CompositionContainerShape? {
      val fnPtr = _2043002906_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun CreateEllipseGeometry(): CompositionEllipseGeometry? {
      val fnPtr = _2043002906_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun CreateLineGeometry(): CompositionLineGeometry? {
      val fnPtr = _2043002906_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun CreatePathGeometry(): CompositionPathGeometry? {
      val fnPtr = _2043002906_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun CreatePathGeometry(path: CompositionPath?): CompositionPathGeometry? {
      val fnPtr = _2043002906_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CompositionPathGeometry>()
      val hr = fn.invokeHR(arrayOf(__2043002906_Ptr, marshalToNative(path), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
      val resultValue = marshalFromNative<CompositionPathGeometry>(result.getValue())
    ...
    public override fun CreatePathKeyFrameAnimation(): PathKeyFrameAnimation? {
      val fnPtr = _2043002906_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun CreateRectangleGeometry(): CompositionRectangleGeometry? {
      val fnPtr = _2043002906_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun CreateRoundedRectangleGeometry(): CompositionRoundedRectangleGeometry? {
      val fnPtr = _2043002906_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun CreateShapeVisual(): ShapeVisual? {
      val fnPtr = _2043002906_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun CreateSpriteShape(): CompositionSpriteShape? {
      val fnPtr = _2043002906_VtblPtr!!.getPointer(22L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun CreateSpriteShape(geometry: CompositionGeometry?): CompositionSpriteShape? {
      val fnPtr = _2043002906_VtblPtr!!.getPointer(23L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CompositionSpriteShape>()
      val hr = fn.invokeHR(arrayOf(__2043002906_Ptr, marshalToNative(geometry), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
      val resultValue = marshalFromNative<CompositionSpriteShape>(result.getValue())
    ...
    public override fun CreateViewBox(): CompositionViewBox? {
      val fnPtr = _2043002906_VtblPtr!!.getPointer(24L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun RequestCommitAsync(): IAsyncAction? {
      val fnPtr = _2043002906_VtblPtr!!.getPointer(25L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class ICompositor5_Impl(
    ...
    public override val __2043002906_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositor5, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("48ea31ad7fcd4076a79c90cc4b852c9b")
    ...
    public override fun toNative(obj: ICompositor5): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2043002906_Ptr))
  }
