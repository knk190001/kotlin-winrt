...
@Signature("rc(Windows.UI.Composition.CompositionEasingFunction;{5145e356-bf79-4ea8-8cc2-6b5b472e6c9a})")
...
public open class CompositionEasingFunction(
  ...
  private val __141809279_Interface: ICompositionEasingFunction.WithDefault by lazy {
    as_141809279()
  }


  public override val __141809279_Ptr: JNAPointer? by lazy {
    __141809279_Interface.__141809279_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__141809279_Interface)

  private fun as_141809279(): ICompositionEasingFunction.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<CompositionEasingFunction, MemoryAddress> {
    ...
    public fun createICompositionEasingFunctionStatics(): ICompositionEasingFunctionStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Composition.CompositionEasingFunction".toHandle(),refiid,interfacePtr)
      val result =
