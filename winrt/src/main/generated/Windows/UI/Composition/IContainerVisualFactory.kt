...
@Signature("{0363a65b-c7da-4d9a-95f4-69b5c8df670b}")
@Guid("0363a65bc7da4d9a95f469b5c8df670b")
@WinRTInterface("0363a65bc7da4d9a95f469b5c8df670b")
...
public interface IContainerVisualFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IContainerVisualFactory {
    public val __113809449_Ptr: Pointer?

    public val _113809449_VtblPtr: Pointer?
      get() = __113809449_Ptr?.getPointer(0)
  }

  public class IContainerVisualFactory_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __113809449_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IContainerVisualFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("0363a65bc7da4d9a95f469b5c8df670b")
    ...
    public override fun toNative(obj: IContainerVisualFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__113809449_Ptr))
  }
