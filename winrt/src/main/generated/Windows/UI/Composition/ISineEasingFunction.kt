...
@Signature("{f1b518bf-9563-5474-bd13-44b2df4b1d58}")
@Guid("f1b518bf95635474bd1344b2df4b1d58")
@WinRTInterface("f1b518bf95635474bd1344b2df4b1d58")
...
public interface ISineEasingFunction : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISineEasingFunction {
    public val __1577385410_Ptr: Pointer?

    public val _1577385410_VtblPtr: Pointer?
      get() = __1577385410_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Mode(): CompositionEasingFunctionMode? {
      val fnPtr = _1577385410_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CompositionEasingFunctionMode>()
      val hr = fn.invokeHR(arrayOf(__1577385410_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ISineEasingFunction_Impl(
    ...
    public override val __1577385410_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISineEasingFunction, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("f1b518bf95635474bd1344b2df4b1d58")
    ...
    public override fun toNative(obj: ISineEasingFunction): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1577385410_Ptr))
  }
