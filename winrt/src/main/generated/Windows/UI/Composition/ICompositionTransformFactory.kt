...
@Signature("{aaaeca26-c149-517a-8f72-6bff7a65ce08}")
@Guid("aaaeca26c149517a8f726bff7a65ce08")
@WinRTInterface("aaaeca26c149517a8f726bff7a65ce08")
...
public interface ICompositionTransformFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionTransformFactory {
    public val __516055386_Ptr: Pointer?

    public val _516055386_VtblPtr: Pointer?
      get() = __516055386_Ptr?.getPointer(0)
  }

  public class ICompositionTransformFactory_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __516055386_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionTransformFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("aaaeca26c149517a8f726bff7a65ce08")
    ...
    public override fun toNative(obj: ICompositionTransformFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__516055386_Ptr))
  }
