...
@Signature("{98b9c1a7-8e71-4b53-b4a8-69ba5d19dc5b}")
@Guid("98b9c1a78e714b53b4a869ba5d19dc5b")
@WinRTInterface("98b9c1a78e714b53b4a869ba5d19dc5b")
...
public interface ICompositorWithRadialGradient : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositorWithRadialGradient {
    public val __791964316_Ptr: Pointer?

    public val _791964316_VtblPtr: Pointer?
      get() = __791964316_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateRadialGradientBrush(): CompositionRadialGradientBrush? {
      val fnPtr = _791964316_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CompositionRadialGradientBrush>()
      val hr = fn.invokeHR(arrayOf(__791964316_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ICompositorWithRadialGradient_Impl(
    ...
    public override val __791964316_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositorWithRadialGradient, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("98b9c1a78e714b53b4a869ba5d19dc5b")
    ...
    public override fun toNative(obj: ICompositorWithRadialGradient): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__791964316_Ptr))
  }
