...
@Signature("{422a1642-1ef1-485c-97e9-ae6f95ad812f}")
@Guid("422a16421ef1485c97e9ae6f95ad812f")
@WinRTInterface("422a16421ef1485c97e9ae6f95ad812f")
...
public interface ISceneMaterialInput : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISceneMaterialInput {
    public val __146770714_Ptr: Pointer?

    public val _146770714_VtblPtr: Pointer?
      get() = __146770714_Ptr?.getPointer(0)
  }

  public class ISceneMaterialInput_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __146770714_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISceneMaterialInput, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("422a16421ef1485c97e9ae6f95ad812f")
    ...
    public override fun toNative(obj: ISceneMaterialInput): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__146770714_Ptr))
  }
