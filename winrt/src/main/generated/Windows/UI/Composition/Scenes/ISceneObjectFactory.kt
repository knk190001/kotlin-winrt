...
@Signature("{14fe799a-33e4-52ef-956c-44229d21f2c1}")
@Guid("14fe799a33e452ef956c44229d21f2c1")
@WinRTInterface("14fe799a33e452ef956c44229d21f2c1")
...
public interface ISceneObjectFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISceneObjectFactory {
    public val __739713742_Ptr: Pointer?

    public val _739713742_VtblPtr: Pointer?
      get() = __739713742_Ptr?.getPointer(0)
  }

  public class ISceneObjectFactory_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __739713742_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISceneObjectFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("14fe799a33e452ef956c44229d21f2c1")
    ...
    public override fun toNative(obj: ISceneObjectFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__739713742_Ptr))
  }
