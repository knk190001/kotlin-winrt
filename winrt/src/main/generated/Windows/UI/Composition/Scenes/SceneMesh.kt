...
@Signature("rc(Windows.UI.Composition.Scenes.SceneMesh;{ee9a1530-1155-4c0c-92bd-40020cf78347})")
...
public class SceneMesh(
  ...
  private val __1299323766_Interface: ISceneMesh.WithDefault by lazy {
    as_1299323766()
  }


  public override val __1299323766_Ptr: JNAPointer? by lazy {
    __1299323766_Interface.__1299323766_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1299323766_Interface)

  private fun as_1299323766(): ISceneMesh.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<SceneMesh, MemoryAddress> {
    ...
    public fun createISceneMeshStatics(): ISceneMeshStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Composition.Scenes.SceneMesh".toHandle(),refiid,interfacePtr)
