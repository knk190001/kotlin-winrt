...
@Signature("rc(Windows.UI.Composition.Scenes.SceneRendererComponent;{f1acb857-cf4f-4025-9b25-a2d1944cf507})")
...
public open class SceneRendererComponent(
  ...
  private val __1610727421_Interface: ISceneRendererComponent.WithDefault by lazy {
    as_1610727421()
  }


  public override val __1610727421_Ptr: JNAPointer? by lazy {
    __1610727421_Interface.__1610727421_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1610727421_Interface)

  private fun as_1610727421(): ISceneRendererComponent.WithDefault {
    if(pointer == NULL) {
