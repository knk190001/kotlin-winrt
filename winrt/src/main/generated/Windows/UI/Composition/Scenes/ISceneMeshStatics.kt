...
@Signature("{8412316c-7b57-473f-966b-81dc277b1751}")
@Guid("8412316c7b57473f966b81dc277b1751")
@WinRTInterface("8412316c7b57473f966b81dc277b1751")
...
public interface ISceneMeshStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISceneMeshStatics {
    public val __1112564699_Ptr: Pointer?

    public val _1112564699_VtblPtr: Pointer?
      get() = __1112564699_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun Create(compositor: Compositor?): SceneMesh? {
      val fnPtr = _1112564699_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<SceneMesh>()
      val hr = fn.invokeHR(arrayOf(__1112564699_Ptr, marshalToNative(compositor), result))
      if (hr.toInt() != 0) {
  ...
  public class ISceneMeshStatics_Impl(
    ...
    public override val __1112564699_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISceneMeshStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("8412316c7b57473f966b81dc277b1751")
    ...
    public override fun toNative(obj: ISceneMeshStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1112564699_Ptr))
  }
