...
@Signature("{ae20fc96-226c-44bd-95cb-dd5ed9ebe9a5}")
@Guid("ae20fc96226c44bd95cbdd5ed9ebe9a5")
@WinRTInterface("ae20fc96226c44bd95cbdd5ed9ebe9a5")
...
public interface ISceneComponent : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISceneComponent {
    public val __189929344_Ptr: Pointer?

    public val _189929344_VtblPtr: Pointer?
      get() = __189929344_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ComponentType(): SceneComponentType? {
      val fnPtr = _189929344_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<SceneComponentType>()
      val hr = fn.invokeHR(arrayOf(__189929344_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ISceneComponent_Impl(
    ...
    public override val __189929344_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISceneComponent, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("ae20fc96226c44bd95cbdd5ed9ebe9a5")
    ...
    public override fun toNative(obj: ISceneComponent): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__189929344_Ptr))
  }
