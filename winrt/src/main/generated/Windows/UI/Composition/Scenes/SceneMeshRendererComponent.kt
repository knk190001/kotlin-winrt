...
@Signature("rc(Windows.UI.Composition.Scenes.SceneMeshRendererComponent;{9929f7e3-6364-477e-98fe-74ed9fd4c2de})")
...
public class SceneMeshRendererComponent(
  ...
  private val __625481712_Interface: ISceneMeshRendererComponent.WithDefault by lazy {
    as_625481712()
  }


  public override val __625481712_Ptr: JNAPointer? by lazy {
    __625481712_Interface.__625481712_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__625481712_Interface)

  private fun as_625481712(): ISceneMeshRendererComponent.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<SceneMeshRendererComponent, MemoryAddress> {
    ...
    public fun createISceneMeshRendererComponentStatics(): ISceneMeshRendererComponentStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Composition.Scenes.SceneMeshRendererComponent".toHandle(),refiid,interfacePtr)
      val result =
