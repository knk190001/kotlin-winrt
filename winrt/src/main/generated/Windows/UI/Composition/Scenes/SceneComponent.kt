...
@Signature("rc(Windows.UI.Composition.Scenes.SceneComponent;{ae20fc96-226c-44bd-95cb-dd5ed9ebe9a5})")
...
public open class SceneComponent(
  ...
  private val __189929344_Interface: ISceneComponent.WithDefault by lazy {
    as_189929344()
  }


  public override val __189929344_Ptr: JNAPointer? by lazy {
    __189929344_Interface.__189929344_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__189929344_Interface)

  private fun as_189929344(): ISceneComponent.WithDefault {
    if(pointer == NULL) {
