...
import Windows.UI.Composition.CompositionBitmapInterpolationMode
...
@Signature("{9937da5c-a9ca-4cfc-b3aa-088356518742}")
@Guid("9937da5ca9ca4cfcb3aa088356518742")
@WinRTInterface("9937da5ca9ca4cfcb3aa088356518742")
...
public interface ISceneSurfaceMaterialInput : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISceneSurfaceMaterialInput {
    public val __555017261_Ptr: Pointer?

    public val _555017261_VtblPtr: Pointer?
      get() = __555017261_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_BitmapInterpolationMode(): CompositionBitmapInterpolationMode? {
      val fnPtr = _555017261_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CompositionBitmapInterpolationMode>()
      val hr = fn.invokeHR(arrayOf(__555017261_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_BitmapInterpolationMode(value: CompositionBitmapInterpolationMode?):
        Unit {
      val fnPtr = _555017261_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__555017261_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Surface(): ICompositionSurface? {
      val fnPtr = _555017261_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Surface(value: ICompositionSurface?): Unit {
      val fnPtr = _555017261_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__555017261_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_WrappingUMode(): SceneWrappingMode? {
      val fnPtr = _555017261_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_WrappingUMode(value: SceneWrappingMode?): Unit {
      val fnPtr = _555017261_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__555017261_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_WrappingVMode(): SceneWrappingMode? {
      val fnPtr = _555017261_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<SceneWrappingMode>()
      val hr = fn.invokeHR(arrayOf(__555017261_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_WrappingVMode(value: SceneWrappingMode?): Unit {
      val fnPtr = _555017261_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__555017261_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class ISceneSurfaceMaterialInput_Impl(
    ...
    public override val __555017261_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISceneSurfaceMaterialInput, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("9937da5ca9ca4cfcb3aa088356518742")
    ...
    public override fun toNative(obj: ISceneSurfaceMaterialInput): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__555017261_Ptr))
  }
