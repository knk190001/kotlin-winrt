...
@Signature("rc(Windows.UI.Composition.Scenes.SceneVisual;{8e672c1e-d734-47b1-be14-3d694ffa4301})")
...
public class SceneVisual(
  ...
  private val __1446716061_Interface: ISceneVisual.WithDefault by lazy {
    as_1446716061()
  }


  public override val __1446716061_Ptr: JNAPointer? by lazy {
    __1446716061_Interface.__1446716061_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1446716061_Interface)

  private fun as_1446716061(): ISceneVisual.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<SceneVisual, MemoryAddress> {
    ...
    public fun createISceneVisualStatics(): ISceneVisualStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Composition.Scenes.SceneVisual".toHandle(),refiid,interfacePtr)
