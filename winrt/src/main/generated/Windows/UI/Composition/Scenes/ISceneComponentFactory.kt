...
@Signature("{5fbc5574-ddd8-5889-ab5b-d8fa716e7c9e}")
@Guid("5fbc5574ddd85889ab5bd8fa716e7c9e")
@WinRTInterface("5fbc5574ddd85889ab5bd8fa716e7c9e")
...
public interface ISceneComponentFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISceneComponentFactory {
    public val __35082346_Ptr: Pointer?

    public val _35082346_VtblPtr: Pointer?
      get() = __35082346_Ptr?.getPointer(0)
  }

  public class ISceneComponentFactory_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __35082346_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISceneComponentFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("5fbc5574ddd85889ab5bd8fa716e7c9e")
    ...
    public override fun toNative(obj: ISceneComponentFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__35082346_Ptr))
  }
