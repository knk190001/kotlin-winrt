...
@Signature("{3bddca50-6d9d-4531-8dc4-b27e3e49b7ab}")
@Guid("3bddca506d9d45318dc4b27e3e49b7ab")
@WinRTInterface("3bddca506d9d45318dc4b27e3e49b7ab")
...
public interface ISceneMetallicRoughnessMaterialStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISceneMetallicRoughnessMaterialStatics {
    public val __1277516214_Ptr: Pointer?

    public val _1277516214_VtblPtr: Pointer?
      get() = __1277516214_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun Create(compositor: Compositor?): SceneMetallicRoughnessMaterial? {
      val fnPtr = _1277516214_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<SceneMetallicRoughnessMaterial>()
      val hr = fn.invokeHR(arrayOf(__1277516214_Ptr, marshalToNative(compositor), result))
      if (hr.toInt() != 0) {
  ...
  public class ISceneMetallicRoughnessMaterialStatics_Impl(
    ...
    public override val __1277516214_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISceneMetallicRoughnessMaterialStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("3bddca506d9d45318dc4b27e3e49b7ab")
    ...
    public override fun toNative(obj: ISceneMetallicRoughnessMaterialStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1277516214_Ptr))
  }
