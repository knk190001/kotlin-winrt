...
@Signature("{a88feb74-7d0a-5e4c-a748-1015af9ca74f}")
@Guid("a88feb747d0a5e4ca7481015af9ca74f")
@WinRTInterface("a88feb747d0a5e4ca7481015af9ca74f")
...
public interface ISceneMaterialInputFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISceneMaterialInputFactory {
    public val __544791228_Ptr: Pointer?

    public val _544791228_VtblPtr: Pointer?
      get() = __544791228_Ptr?.getPointer(0)
  }

  public class ISceneMaterialInputFactory_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __544791228_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISceneMaterialInputFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("a88feb747d0a5e4ca7481015af9ca74f")
    ...
    public override fun toNative(obj: ISceneMaterialInputFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__544791228_Ptr))
  }
