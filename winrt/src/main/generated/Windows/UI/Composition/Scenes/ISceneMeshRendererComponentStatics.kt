...
@Signature("{4954f37a-4459-4521-bd6e-2b38b8d711ea}")
@Guid("4954f37a44594521bd6e2b38b8d711ea")
@WinRTInterface("4954f37a44594521bd6e2b38b8d711ea")
...
public interface ISceneMeshRendererComponentStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISceneMeshRendererComponentStatics {
    public val __2051702165_Ptr: Pointer?

    public val _2051702165_VtblPtr: Pointer?
      get() = __2051702165_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun Create(compositor: Compositor?): SceneMeshRendererComponent? {
      val fnPtr = _2051702165_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<SceneMeshRendererComponent>()
      val hr = fn.invokeHR(arrayOf(__2051702165_Ptr, marshalToNative(compositor), result))
      if (hr.toInt() != 0) {
  ...
  public class ISceneMeshRendererComponentStatics_Impl(
    ...
    public override val __2051702165_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISceneMeshRendererComponentStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("4954f37a44594521bd6e2b38b8d711ea")
    ...
    public override fun toNative(obj: ISceneMeshRendererComponentStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2051702165_Ptr))
  }
