...
@Signature("{f2bd13c3-ba7e-4b0f-9126-ffb7536b8176}")
@Guid("f2bd13c3ba7e4b0f9126ffb7536b8176")
@WinRTInterface("f2bd13c3ba7e4b0f9126ffb7536b8176")
...
public interface IShapeVisual : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IShapeVisual {
    public val __254614061_Ptr: Pointer?

    public val _254614061_VtblPtr: Pointer?
      get() = __254614061_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Shapes(): CompositionShapeCollection? {
      val fnPtr = _254614061_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CompositionShapeCollection>()
      val hr = fn.invokeHR(arrayOf(__254614061_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ViewBox(): CompositionViewBox? {
      val fnPtr = _254614061_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_ViewBox(value: CompositionViewBox?): Unit {
      val fnPtr = _254614061_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__254614061_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IShapeVisual_Impl(
    ...
    public override val __254614061_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IShapeVisual, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("f2bd13c3ba7e4b0f9126ffb7536b8176")
    ...
    public override fun toNative(obj: IShapeVisual): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__254614061_Ptr))
  }
