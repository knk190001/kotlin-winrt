...
@Signature("{4863675c-cf4a-4b1c-9ece-c5ec0c2b2fe6}")
@Guid("4863675ccf4a4b1c9ecec5ec0c2b2fe6")
@WinRTInterface("4863675ccf4a4b1c9ecec5ec0c2b2fe6")
...
public interface ICompositionMipmapSurface : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionMipmapSurface {
    public val __15133399_Ptr: Pointer?

    public val _15133399_VtblPtr: Pointer?
      get() = __15133399_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_LevelCount(): WinDef.UINT {
      val fnPtr = _15133399_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<WinDef.UINT>()
      val hr = fn.invokeHR(arrayOf(__15133399_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_AlphaMode(): DirectXAlphaMode? {
      val fnPtr = _15133399_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_PixelFormat(): DirectXPixelFormat? {
      val fnPtr = _15133399_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_SizeInt32(): SizeInt32? {
      val fnPtr = _15133399_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun GetDrawingSurfaceForLevel(level: WinDef.UINT): CompositionDrawingSurface? {
      val fnPtr = _15133399_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CompositionDrawingSurface>()
      val hr = fn.invokeHR(arrayOf(__15133399_Ptr, level, result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
  ...
  public class ICompositionMipmapSurface_Impl(
    ...
    public override val __15133399_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionMipmapSurface, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("4863675ccf4a4b1c9ecec5ec0c2b2fe6")
    ...
    public override fun toNative(obj: ICompositionMipmapSurface): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__15133399_Ptr))
  }
