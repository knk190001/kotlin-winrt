...
@Signature("{7a38b2bd-cec8-4eeb-830f-d8d07aedebc3}")
@Guid("7a38b2bdcec84eeb830fd8d07aedebc3")
@WinRTInterface("7a38b2bdcec84eeb830fd8d07aedebc3")
...
public interface ICompositor6 : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositor6 {
    public val __2043002905_Ptr: Pointer?

    public val _2043002905_VtblPtr: Pointer?
      get() = __2043002905_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateGeometricClip(): CompositionGeometricClip? {
      val fnPtr = _2043002905_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CompositionGeometricClip>()
      val hr = fn.invokeHR(arrayOf(__2043002905_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun CreateGeometricClip(geometry: CompositionGeometry?):
      ...
      val fnPtr = _2043002905_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CompositionGeometricClip>()
      val hr = fn.invokeHR(arrayOf(__2043002905_Ptr, marshalToNative(geometry), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
      val resultValue = marshalFromNative<CompositionGeometricClip>(result.getValue())
    ...
    public override fun CreateRedirectVisual(): RedirectVisual? {
      val fnPtr = _2043002905_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun CreateRedirectVisual(source: Visual?): RedirectVisual? {
      val fnPtr = _2043002905_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<RedirectVisual>()
      val hr = fn.invokeHR(arrayOf(__2043002905_Ptr, marshalToNative(source), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
      val resultValue = marshalFromNative<RedirectVisual>(result.getValue())
    ...
    public override fun CreateBooleanKeyFrameAnimation(): BooleanKeyFrameAnimation? {
      val fnPtr = _2043002905_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class ICompositor6_Impl(
    ...
    public override val __2043002905_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositor6, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("7a38b2bdcec84eeb830fd8d07aedebc3")
    ...
    public override fun toNative(obj: ICompositor6): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2043002905_Ptr))
  }
