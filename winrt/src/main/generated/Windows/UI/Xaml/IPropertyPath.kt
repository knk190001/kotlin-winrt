...
@Signature("{300e5d8a-1ff3-4d2c-95ec-27f81debacb8}")
@Guid("300e5d8a1ff34d2c95ec27f81debacb8")
@WinRTInterface("300e5d8a1ff34d2c95ec27f81debacb8")
...
public interface IPropertyPath : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPropertyPath {
    public val __1281253652_Ptr: Pointer?

    public val _1281253652_VtblPtr: Pointer?
      get() = __1281253652_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Path(): String? {
      val fnPtr = _1281253652_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__1281253652_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IPropertyPath_Impl(
    ...
    public override val __1281253652_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPropertyPath, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("300e5d8a1ff34d2c95ec27f81debacb8")
    ...
    public override fun toNative(obj: IPropertyPath): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1281253652_Ptr))
  }
