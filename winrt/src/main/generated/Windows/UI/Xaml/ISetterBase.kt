...
@Signature("{418be27c-2ac4-4f22-8097-dea3aeeb2fb3}")
@Guid("418be27c2ac44f228097dea3aeeb2fb3")
@WinRTInterface("418be27c2ac44f228097dea3aeeb2fb3")
...
public interface ISetterBase : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISetterBase {
    public val __1166392258_Ptr: Pointer?

    public val _1166392258_VtblPtr: Pointer?
      get() = __1166392258_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_IsSealed(): Boolean {
      val fnPtr = _1166392258_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1166392258_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ISetterBase_Impl(
    ...
    public override val __1166392258_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISetterBase, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("418be27c2ac44f228097dea3aeeb2fb3")
    ...
    public override fun toNative(obj: ISetterBase): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1166392258_Ptr))
  }
