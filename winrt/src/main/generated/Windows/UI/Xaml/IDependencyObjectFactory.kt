...
@Signature("{9a03af92-7d8a-4937-884f-ecf34fe02acb}")
@Guid("9a03af927d8a4937884fecf34fe02acb")
@WinRTInterface("9a03af927d8a4937884fecf34fe02acb")
...
public interface IDependencyObjectFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IDependencyObjectFactory {
    public val __970040146_Ptr: Pointer?

    public val _970040146_VtblPtr: Pointer?
      get() = __970040146_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        DependencyObject? {
      val fnPtr = _970040146_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyObject>()
      val hr = fn.invokeHR(arrayOf(__970040146_Ptr, marshalToNative(baseInterface),
  ...
  public class IDependencyObjectFactory_Impl(
    ...
    public override val __970040146_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IDependencyObjectFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("9a03af927d8a4937884fecf34fe02acb")
    ...
    public override fun toNative(obj: IDependencyObjectFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__970040146_Ptr))
  }
