...
@Signature("{fe216ab1-f31f-4791-8989-c70e1d9b59ff}")
@Guid("fe216ab1f31f47918989c70e1d9b59ff")
@WinRTInterface("fe216ab1f31f47918989c70e1d9b59ff")
...
public interface IVisualStateChangedEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IVisualStateChangedEventArgs {
    public val __2016071682_Ptr: Pointer?

    public val _2016071682_VtblPtr: Pointer?
      get() = __2016071682_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_OldState(): VisualState? {
      val fnPtr = _2016071682_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<VisualState>()
      val hr = fn.invokeHR(arrayOf(__2016071682_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_OldState(value: VisualState?): Unit {
      val fnPtr = _2016071682_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2016071682_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_NewState(): VisualState? {
      val fnPtr = _2016071682_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<VisualState>()
      val hr = fn.invokeHR(arrayOf(__2016071682_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_NewState(value: VisualState?): Unit {
      val fnPtr = _2016071682_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2016071682_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Control(): Control? {
      val fnPtr = _2016071682_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Control(value: Control?): Unit {
      val fnPtr = _2016071682_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2016071682_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IVisualStateChangedEventArgs_Impl(
    ...
    public override val __2016071682_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IVisualStateChangedEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("fe216ab1f31f47918989c70e1d9b59ff")
    ...
    public override fun toNative(obj: IVisualStateChangedEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2016071682_Ptr))
  }
