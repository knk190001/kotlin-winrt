...
@Signature("{20c27545-a88b-43c8-bc24-cea9dafd04a3}")
@Guid("20c27545a88b43c8bc24cea9dafd04a3")
@WinRTInterface("20c27545a88b43c8bc24cea9dafd04a3")
...
public interface IAutomationPeerFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IAutomationPeerFactory {
    public val __1168642055_Ptr: Pointer?

    public val _1168642055_VtblPtr: Pointer?
      get() = __1168642055_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        AutomationPeer? {
      val fnPtr = _1168642055_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AutomationPeer>()
      val hr = fn.invokeHR(arrayOf(__1168642055_Ptr, marshalToNative(baseInterface),
  ...
  public class IAutomationPeerFactory_Impl(
    ...
    public override val __1168642055_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IAutomationPeerFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("20c27545a88b43c8bc24cea9dafd04a3")
    ...
    public override fun toNative(obj: IAutomationPeerFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1168642055_Ptr))
  }
