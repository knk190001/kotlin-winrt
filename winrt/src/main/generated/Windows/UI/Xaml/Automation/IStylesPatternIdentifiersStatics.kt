...
@Signature("{528a457a-bc3c-4d48-94af-1f68703ca296}")
@Guid("528a457abc3c4d4894af1f68703ca296")
@WinRTInterface("528a457abc3c4d4894af1f68703ca296")
...
public interface IStylesPatternIdentifiersStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IStylesPatternIdentifiersStatics {
    public val __79100270_Ptr: Pointer?

    public val _79100270_VtblPtr: Pointer?
      get() = __79100270_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ExtendedPropertiesProperty(): AutomationProperty? {
      val fnPtr = _79100270_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AutomationProperty>()
      val hr = fn.invokeHR(arrayOf(__79100270_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_FillColorProperty(): AutomationProperty? {
      val fnPtr = _79100270_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AutomationProperty>()
      val hr = fn.invokeHR(arrayOf(__79100270_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_FillPatternColorProperty(): AutomationProperty? {
      val fnPtr = _79100270_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AutomationProperty>()
      val hr = fn.invokeHR(arrayOf(__79100270_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_FillPatternStyleProperty(): AutomationProperty? {
      val fnPtr = _79100270_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AutomationProperty>()
      val hr = fn.invokeHR(arrayOf(__79100270_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ShapeProperty(): AutomationProperty? {
      val fnPtr = _79100270_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AutomationProperty>()
      val hr = fn.invokeHR(arrayOf(__79100270_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_StyleIdProperty(): AutomationProperty? {
      val fnPtr = _79100270_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AutomationProperty>()
      val hr = fn.invokeHR(arrayOf(__79100270_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_StyleNameProperty(): AutomationProperty? {
      val fnPtr = _79100270_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AutomationProperty>()
      val hr = fn.invokeHR(arrayOf(__79100270_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IStylesPatternIdentifiersStatics_Impl(
    ...
    public override val __79100270_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IStylesPatternIdentifiersStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("528a457abc3c4d4894af1f68703ca296")
    ...
    public override fun toNative(obj: IStylesPatternIdentifiersStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__79100270_Ptr))
  }
