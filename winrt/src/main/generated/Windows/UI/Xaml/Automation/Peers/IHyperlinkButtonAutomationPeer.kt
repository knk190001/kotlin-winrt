...
@Signature("{aa7afcb1-0edf-46d9-aa9e-0eb21d140097}")
@Guid("aa7afcb10edf46d9aa9e0eb21d140097")
@WinRTInterface("aa7afcb10edf46d9aa9e0eb21d140097")
...
public interface IHyperlinkButtonAutomationPeer : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IHyperlinkButtonAutomationPeer {
    public val __351231161_Ptr: Pointer?

    public val _351231161_VtblPtr: Pointer?
      get() = __351231161_Ptr?.getPointer(0)
  }

  public class IHyperlinkButtonAutomationPeer_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __351231161_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IHyperlinkButtonAutomationPeer, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("aa7afcb10edf46d9aa9e0eb21d140097")
    ...
    public override fun toNative(obj: IHyperlinkButtonAutomationPeer): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__351231161_Ptr))
  }
