...
import Windows.UI.Xaml.Automation.SupportedTextSelection
...
@Signature("{db5bbc9f-4807-4f2a-8678-1b13f3c60e22}")
@Guid("db5bbc9f48074f2a86781b13f3c60e22")
@WinRTInterface("db5bbc9f48074f2a86781b13f3c60e22")
...
public interface ITextProvider : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITextProvider {
    public val __675768150_Ptr: Pointer?

    public val _675768150_VtblPtr: Pointer?
      get() = __675768150_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_DocumentRange(): ITextRangeProvider? {
      val fnPtr = _675768150_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ITextRangeProvider>()
      val hr = fn.invokeHR(arrayOf(__675768150_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_SupportedTextSelection(): SupportedTextSelection? {
      val fnPtr = _675768150_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun GetSelection(): Array<ITextRangeProvider?>? {
      val fnPtr = _675768150_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun GetVisibleRanges(): Array<ITextRangeProvider?>? {
      val fnPtr = _675768150_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeOutArray<ITextRangeProvider>()
      val hr = fn.invokeHR(arrayOf(__675768150_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun RangeFromChild(childElement: IRawElementProviderSimple?):
        ITextRangeProvider? {
      val fnPtr = _675768150_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ITextRangeProvider>()
      val hr = fn.invokeHR(arrayOf(__675768150_Ptr, marshalToNative(childElement), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
      val resultValue = marshalFromNative<ITextRangeProvider>(result.getValue())
    ...
    public override fun RangeFromPoint(screenLocation: Point?): ITextRangeProvider? {
      val fnPtr = _675768150_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ITextRangeProvider>()
      val hr = fn.invokeHR(arrayOf(__675768150_Ptr, marshalToNative(screenLocation), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
      val resultValue = marshalFromNative<ITextRangeProvider>(result.getValue())
  ...
  public class ITextProvider_Impl(
    ...
    public override val __675768150_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITextProvider, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("db5bbc9f48074f2a86781b13f3c60e22")
    ...
    public override fun toNative(obj: ITextProvider): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__675768150_Ptr))
  }
