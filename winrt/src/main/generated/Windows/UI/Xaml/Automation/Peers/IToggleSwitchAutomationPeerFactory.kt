...
@Signature("{31f933e3-fef8-4419-9df5-d9ef7196ea34}")
@Guid("31f933e3fef844199df5d9ef7196ea34")
@WinRTInterface("31f933e3fef844199df5d9ef7196ea34")
...
public interface IToggleSwitchAutomationPeerFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IToggleSwitchAutomationPeerFactory {
    public val __770202929_Ptr: Pointer?

    public val _770202929_VtblPtr: Pointer?
      get() = __770202929_Ptr?.getPointer(0)
    ...
    public override fun CreateInstanceWithOwner(
      ...
      val fnPtr = _770202929_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ToggleSwitchAutomationPeer>()
      val hr = fn.invokeHR(arrayOf(__770202929_Ptr, marshalToNative(owner),
  ...
  public class IToggleSwitchAutomationPeerFactory_Impl(
    ...
    public override val __770202929_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IToggleSwitchAutomationPeerFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("31f933e3fef844199df5d9ef7196ea34")
    ...
    public override fun toNative(obj: IToggleSwitchAutomationPeerFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__770202929_Ptr))
  }
