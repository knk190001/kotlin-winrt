...
@Signature("{ce23450f-1c27-457f-b815-7a5e46863dbb}")
@Guid("ce23450f1c27457fb8157a5e46863dbb")
@WinRTInterface("ce23450f1c27457fb8157a5e46863dbb")
...
public interface IRangeValuePatternIdentifiersStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IRangeValuePatternIdentifiersStatics {
    public val __1604198876_Ptr: Pointer?

    public val _1604198876_VtblPtr: Pointer?
      get() = __1604198876_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_IsReadOnlyProperty(): AutomationProperty? {
      val fnPtr = _1604198876_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AutomationProperty>()
      val hr = fn.invokeHR(arrayOf(__1604198876_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_LargeChangeProperty(): AutomationProperty? {
      val fnPtr = _1604198876_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AutomationProperty>()
      val hr = fn.invokeHR(arrayOf(__1604198876_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_MaximumProperty(): AutomationProperty? {
      val fnPtr = _1604198876_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AutomationProperty>()
      val hr = fn.invokeHR(arrayOf(__1604198876_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_MinimumProperty(): AutomationProperty? {
      val fnPtr = _1604198876_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AutomationProperty>()
      val hr = fn.invokeHR(arrayOf(__1604198876_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_SmallChangeProperty(): AutomationProperty? {
      val fnPtr = _1604198876_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AutomationProperty>()
      val hr = fn.invokeHR(arrayOf(__1604198876_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ValueProperty(): AutomationProperty? {
      val fnPtr = _1604198876_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AutomationProperty>()
      val hr = fn.invokeHR(arrayOf(__1604198876_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IRangeValuePatternIdentifiersStatics_Impl(
    ...
    public override val __1604198876_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IRangeValuePatternIdentifiersStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("ce23450f1c27457fb8157a5e46863dbb")
    ...
    public override fun toNative(obj: IRangeValuePatternIdentifiersStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1604198876_Ptr))
  }
