...
@Signature("{75073d25-32c9-4903-aecf-dc3504cbd244}")
@Guid("75073d2532c94903aecfdc3504cbd244")
@WinRTInterface("75073d2532c94903aecfdc3504cbd244")
...
public interface ITablePatternIdentifiersStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITablePatternIdentifiersStatics {
    public val __1659367080_Ptr: Pointer?

    public val _1659367080_VtblPtr: Pointer?
      get() = __1659367080_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ColumnHeadersProperty(): AutomationProperty? {
      val fnPtr = _1659367080_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AutomationProperty>()
      val hr = fn.invokeHR(arrayOf(__1659367080_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_RowHeadersProperty(): AutomationProperty? {
      val fnPtr = _1659367080_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AutomationProperty>()
      val hr = fn.invokeHR(arrayOf(__1659367080_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_RowOrColumnMajorProperty(): AutomationProperty? {
      val fnPtr = _1659367080_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AutomationProperty>()
      val hr = fn.invokeHR(arrayOf(__1659367080_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ITablePatternIdentifiersStatics_Impl(
    ...
    public override val __1659367080_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITablePatternIdentifiersStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("75073d2532c94903aecfdc3504cbd244")
    ...
    public override fun toNative(obj: ITablePatternIdentifiersStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1659367080_Ptr))
  }
