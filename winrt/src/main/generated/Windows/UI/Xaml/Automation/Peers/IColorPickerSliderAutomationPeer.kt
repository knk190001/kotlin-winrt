...
@Signature("{a514215a-7293-4577-924c-47d4e0bf9b90}")
@Guid("a514215a72934577924c47d4e0bf9b90")
@WinRTInterface("a514215a72934577924c47d4e0bf9b90")
...
public interface IColorPickerSliderAutomationPeer : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IColorPickerSliderAutomationPeer {
    public val __1763528685_Ptr: Pointer?

    public val _1763528685_VtblPtr: Pointer?
      get() = __1763528685_Ptr?.getPointer(0)
  }

  public class IColorPickerSliderAutomationPeer_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __1763528685_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IColorPickerSliderAutomationPeer, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("a514215a72934577924c47d4e0bf9b90")
    ...
    public override fun toNative(obj: IColorPickerSliderAutomationPeer): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1763528685_Ptr))
  }
