...
@Signature("{e5667d19-9157-4436-9f4d-7fb99174b48e}")
@Guid("e5667d19915744369f4d7fb99174b48e")
@WinRTInterface("e5667d19915744369f4d7fb99174b48e")
...
public interface IDatePickerAutomationPeerFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IDatePickerAutomationPeerFactory {
    public val __1675795837_Ptr: Pointer?

    public val _1675795837_VtblPtr: Pointer?
      get() = __1675795837_Ptr?.getPointer(0)
    ...
    public override fun CreateInstanceWithOwner(
      ...
      val fnPtr = _1675795837_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DatePickerAutomationPeer>()
      val hr = fn.invokeHR(arrayOf(__1675795837_Ptr, marshalToNative(owner),
  ...
  public class IDatePickerAutomationPeerFactory_Impl(
    ...
    public override val __1675795837_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IDatePickerAutomationPeerFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("e5667d19915744369f4d7fb99174b48e")
    ...
    public override fun toNative(obj: IDatePickerAutomationPeerFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1675795837_Ptr))
  }
