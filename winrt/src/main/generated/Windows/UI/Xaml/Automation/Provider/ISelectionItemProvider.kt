...
@Signature("{6a4977c1-830d-42d2-bf62-042ebddecc19}")
@Guid("6a4977c1830d42d2bf62042ebddecc19")
@WinRTInterface("6a4977c1830d42d2bf62042ebddecc19")
...
public interface ISelectionItemProvider : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISelectionItemProvider {
    public val __735116216_Ptr: Pointer?

    public val _735116216_VtblPtr: Pointer?
      get() = __735116216_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_IsSelected(): Boolean {
      val fnPtr = _735116216_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__735116216_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_SelectionContainer(): IRawElementProviderSimple? {
      val fnPtr = _735116216_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun AddToSelection(): Unit {
      val fnPtr = _735116216_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__735116216_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun RemoveFromSelection(): Unit {
      val fnPtr = _735116216_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__735116216_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun Select(): Unit {
      val fnPtr = _735116216_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__735116216_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class ISelectionItemProvider_Impl(
    ...
    public override val __735116216_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISelectionItemProvider, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("6a4977c1830d42d2bf62042ebddecc19")
    ...
    public override fun toNative(obj: ISelectionItemProvider): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__735116216_Ptr))
  }
