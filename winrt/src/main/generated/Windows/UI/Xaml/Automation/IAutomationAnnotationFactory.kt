...
@Signature("{4906fa52-ddc0-4e69-b76b-019d928d822f}")
@Guid("4906fa52ddc04e69b76b019d928d822f")
@WinRTInterface("4906fa52ddc04e69b76b019d928d822f")
...
public interface IAutomationAnnotationFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IAutomationAnnotationFactory {
    public val __1655331337_Ptr: Pointer?

    public val _1655331337_VtblPtr: Pointer?
      get() = __1655331337_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(type: AnnotationType?): AutomationAnnotation? {
      val fnPtr = _1655331337_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AutomationAnnotation>()
      val hr = fn.invokeHR(arrayOf(__1655331337_Ptr, marshalToNative(type), result))
      if (hr.toInt() != 0) {
    ...
    public override fun CreateWithElementParameter(type: AnnotationType?, element: UIElement?):
        AutomationAnnotation? {
      val fnPtr = _1655331337_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AutomationAnnotation>()
      val hr = fn.invokeHR(arrayOf(__1655331337_Ptr, marshalToNative(type),
  ...
  public class IAutomationAnnotationFactory_Impl(
    ...
    public override val __1655331337_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IAutomationAnnotationFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("4906fa52ddc04e69b76b019d928d822f")
    ...
    public override fun toNative(obj: IAutomationAnnotationFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1655331337_Ptr))
  }
