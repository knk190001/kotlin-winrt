...
@Signature("{971b8056-9a7a-4df9-95fa-6f5c04c91cac}")
@Guid("971b80569a7a4df995fa6f5c04c91cac")
@WinRTInterface("971b80569a7a4df995fa6f5c04c91cac")
...
public interface ISliderAutomationPeerFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISliderAutomationPeerFactory {
    public val __1996519320_Ptr: Pointer?

    public val _1996519320_VtblPtr: Pointer?
      get() = __1996519320_Ptr?.getPointer(0)
    ...
    public override fun CreateInstanceWithOwner(
      ...
      val fnPtr = _1996519320_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<SliderAutomationPeer>()
      val hr = fn.invokeHR(arrayOf(__1996519320_Ptr, marshalToNative(owner),
  ...
  public class ISliderAutomationPeerFactory_Impl(
    ...
    public override val __1996519320_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISliderAutomationPeerFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("971b80569a7a4df995fa6f5c04c91cac")
    ...
    public override fun toNative(obj: ISliderAutomationPeerFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1996519320_Ptr))
  }
