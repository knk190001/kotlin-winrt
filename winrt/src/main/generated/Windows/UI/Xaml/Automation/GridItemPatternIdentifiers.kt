...
@Signature("rc(Windows.UI.Xaml.Automation.GridItemPatternIdentifiers;{757744f1-3285-4fb1-803b-2545bd431599})")
...
public class GridItemPatternIdentifiers(
  ...
  private val __869522030_Interface: IGridItemPatternIdentifiers.WithDefault by lazy {
    as_869522030()
  }


  public override val __869522030_Ptr: JNAPointer? by lazy {
    __869522030_Interface.__869522030_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__869522030_Interface)

  private fun as_869522030(): IGridItemPatternIdentifiers.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<GridItemPatternIdentifiers, MemoryAddress> {
    ...
    public fun createIGridItemPatternIdentifiersStatics(): IGridItemPatternIdentifiersStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Automation.GridItemPatternIdentifiers".toHandle(),refiid,interfacePtr)
      val result =
