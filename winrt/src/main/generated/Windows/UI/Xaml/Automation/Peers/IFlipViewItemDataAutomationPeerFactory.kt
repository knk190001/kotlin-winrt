...
@Signature("{3c864393-0aea-4e78-bc11-b775cac4114c}")
@Guid("3c8643930aea4e78bc11b775cac4114c")
@WinRTInterface("3c8643930aea4e78bc11b775cac4114c")
...
public interface IFlipViewItemDataAutomationPeerFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IFlipViewItemDataAutomationPeerFactory {
    public val __1867551498_Ptr: Pointer?

    public val _1867551498_VtblPtr: Pointer?
      get() = __1867551498_Ptr?.getPointer(0)
    ...
    public override fun CreateInstanceWithParentAndItem(
      ...
      val fnPtr = _1867551498_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<FlipViewItemDataAutomationPeer>()
      val hr = fn.invokeHR(arrayOf(__1867551498_Ptr, marshalToNative(item), marshalToNative(parent),
  ...
  public class IFlipViewItemDataAutomationPeerFactory_Impl(
    ...
    public override val __1867551498_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IFlipViewItemDataAutomationPeerFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("3c8643930aea4e78bc11b775cac4114c")
    ...
    public override fun toNative(obj: IFlipViewItemDataAutomationPeerFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1867551498_Ptr))
  }
