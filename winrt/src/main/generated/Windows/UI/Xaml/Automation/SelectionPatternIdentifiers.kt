...
@Signature("rc(Windows.UI.Xaml.Automation.SelectionPatternIdentifiers;{4aa66fb0-e3f7-475f-b78d-f8a83bb730c4})")
...
public class SelectionPatternIdentifiers(
  ...
  private val __1603358357_Interface: ISelectionPatternIdentifiers.WithDefault by lazy {
    as_1603358357()
  }


  public override val __1603358357_Ptr: JNAPointer? by lazy {
    __1603358357_Interface.__1603358357_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1603358357_Interface)

  private fun as_1603358357(): ISelectionPatternIdentifiers.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<SelectionPatternIdentifiers, MemoryAddress> {
    ...
    public fun createISelectionPatternIdentifiersStatics(): ISelectionPatternIdentifiersStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Automation.SelectionPatternIdentifiers".toHandle(),refiid,interfacePtr)
      val result =
