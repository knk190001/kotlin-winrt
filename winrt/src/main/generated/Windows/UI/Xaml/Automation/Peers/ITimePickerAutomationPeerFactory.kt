...
@Signature("{978f6671-47f8-40a7-9e21-68128b16b4fd}")
@Guid("978f667147f840a79e2168128b16b4fd")
@WinRTInterface("978f667147f840a79e2168128b16b4fd")
...
public interface ITimePickerAutomationPeerFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITimePickerAutomationPeerFactory {
    public val __1767555330_Ptr: Pointer?

    public val _1767555330_VtblPtr: Pointer?
      get() = __1767555330_Ptr?.getPointer(0)
    ...
    public override fun CreateInstanceWithOwner(
      ...
      val fnPtr = _1767555330_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<TimePickerAutomationPeer>()
      val hr = fn.invokeHR(arrayOf(__1767555330_Ptr, marshalToNative(owner),
  ...
  public class ITimePickerAutomationPeerFactory_Impl(
    ...
    public override val __1767555330_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITimePickerAutomationPeerFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("978f667147f840a79e2168128b16b4fd")
    ...
    public override fun toNative(obj: ITimePickerAutomationPeerFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1767555330_Ptr))
  }
