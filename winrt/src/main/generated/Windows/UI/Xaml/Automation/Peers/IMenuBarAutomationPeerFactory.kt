...
@Signature("{2a094871-4a9b-5a0b-9fda-7bc3ae957c53}")
@Guid("2a0948714a9b5a0b9fda7bc3ae957c53")
@WinRTInterface("2a0948714a9b5a0b9fda7bc3ae957c53")
...
public interface IMenuBarAutomationPeerFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IMenuBarAutomationPeerFactory {
    public val __1007521941_Ptr: Pointer?

    public val _1007521941_VtblPtr: Pointer?
      get() = __1007521941_Ptr?.getPointer(0)
    ...
    public override fun CreateInstance(
      ...
      val fnPtr = _1007521941_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<MenuBarAutomationPeer>()
      val hr = fn.invokeHR(arrayOf(__1007521941_Ptr, marshalToNative(owner),
  ...
  public class IMenuBarAutomationPeerFactory_Impl(
    ...
    public override val __1007521941_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IMenuBarAutomationPeerFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("2a0948714a9b5a0b9fda7bc3ae957c53")
    ...
    public override fun toNative(obj: IMenuBarAutomationPeerFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1007521941_Ptr))
  }
