...
import Windows.UI.Xaml.Automation.WindowInteractionState
import Windows.UI.Xaml.Automation.WindowVisualState
...
@Signature("{1baa8b3d-38cf-415a-85d3-20e43a0ec1b1}")
@Guid("1baa8b3d38cf415a85d320e43a0ec1b1")
@WinRTInterface("1baa8b3d38cf415a85d320e43a0ec1b1")
...
public interface IWindowProvider : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IWindowProvider {
    public val __370058521_Ptr: Pointer?

    public val _370058521_VtblPtr: Pointer?
      get() = __370058521_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_IsModal(): Boolean {
      val fnPtr = _370058521_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__370058521_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsTopmost(): Boolean {
      val fnPtr = _370058521_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__370058521_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Maximizable(): Boolean {
      val fnPtr = _370058521_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__370058521_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Minimizable(): Boolean {
      val fnPtr = _370058521_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__370058521_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_InteractionState(): WindowInteractionState? {
      val fnPtr = _370058521_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_VisualState(): WindowVisualState? {
      val fnPtr = _370058521_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun Close(): Unit {
      val fnPtr = _370058521_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__370058521_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun SetVisualState(state: WindowVisualState?): Unit {
      val fnPtr = _370058521_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__370058521_Ptr, marshalToNative(state),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun WaitForInputIdle(milliseconds: Int): Boolean {
      val fnPtr = _370058521_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__370058521_Ptr, milliseconds, result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
      val resultValue = marshalFromNative<Boolean>(result.getValue())
  ...
  public class IWindowProvider_Impl(
    ...
    public override val __370058521_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IWindowProvider, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("1baa8b3d38cf415a85d320e43a0ec1b1")
    ...
    public override fun toNative(obj: IWindowProvider): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__370058521_Ptr))
  }
