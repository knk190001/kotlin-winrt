...
@Signature("{fd7d5fee-fde0-482a-8084-dcebba5b9806}")
@Guid("fd7d5feefde0482a8084dcebba5b9806")
@WinRTInterface("fd7d5feefde0482a8084dcebba5b9806")
...
public interface IListBoxItemDataAutomationPeer : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IListBoxItemDataAutomationPeer {
    public val __910473931_Ptr: Pointer?

    public val _910473931_VtblPtr: Pointer?
      get() = __910473931_Ptr?.getPointer(0)
  }

  public class IListBoxItemDataAutomationPeer_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __910473931_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IListBoxItemDataAutomationPeer, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("fd7d5feefde0482a8084dcebba5b9806")
    ...
    public override fun toNative(obj: IListBoxItemDataAutomationPeer): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__910473931_Ptr))
  }
