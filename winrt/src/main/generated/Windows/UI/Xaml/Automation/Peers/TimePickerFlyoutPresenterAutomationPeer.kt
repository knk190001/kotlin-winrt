...
@Signature("rc(Windows.UI.Xaml.Automation.Peers.TimePickerFlyoutPresenterAutomationPeer;{da93ee27-82f1-4701-8706-be297bf06043})")
...
public class TimePickerFlyoutPresenterAutomationPeer(
  ptr: JNAPointer? = NULL
    ...
    IWinRTObject {
  private val __1423421875_Interface: ITimePickerFlyoutPresenterAutomationPeer.WithDefault by lazy {
    as_1423421875()
  }


  public override val __1423421875_Ptr: JNAPointer? by lazy {
    __1423421875_Interface.__1423421875_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1423421875_Interface)

  private fun as_1423421875(): ITimePickerFlyoutPresenterAutomationPeer.WithDefault {
    if(pointer == NULL) {
