...
@Signature("{c83034de-fa08-4bd3-aeb2-d2e5bfa04df9}")
@Guid("c83034defa084bd3aeb2d2e5bfa04df9")
@WinRTInterface("c83034defa084bd3aeb2d2e5bfa04df9")
...
public interface IFlipViewItemAutomationPeer : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IFlipViewItemAutomationPeer {
    public val __1214638570_Ptr: Pointer?

    public val _1214638570_VtblPtr: Pointer?
      get() = __1214638570_Ptr?.getPointer(0)
  }

  public class IFlipViewItemAutomationPeer_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __1214638570_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IFlipViewItemAutomationPeer, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("c83034defa084bd3aeb2d2e5bfa04df9")
    ...
    public override fun toNative(obj: IFlipViewItemAutomationPeer): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1214638570_Ptr))
  }
