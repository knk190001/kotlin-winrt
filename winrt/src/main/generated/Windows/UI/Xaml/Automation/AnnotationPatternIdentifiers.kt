...
@Signature("rc(Windows.UI.Xaml.Automation.AnnotationPatternIdentifiers;{d475a0c1-48b2-4e40-a6cf-3dc4b638c0de})")
...
public class AnnotationPatternIdentifiers(
  ...
  private val __48524828_Interface: IAnnotationPatternIdentifiers.WithDefault by lazy {
    as_48524828()
  }


  public override val __48524828_Ptr: JNAPointer? by lazy {
    __48524828_Interface.__48524828_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__48524828_Interface)

  private fun as_48524828(): IAnnotationPatternIdentifiers.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<AnnotationPatternIdentifiers, MemoryAddress> {
    ...
    public fun createIAnnotationPatternIdentifiersStatics(): IAnnotationPatternIdentifiersStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Automation.AnnotationPatternIdentifiers".toHandle(),refiid,interfacePtr)
      val result =
