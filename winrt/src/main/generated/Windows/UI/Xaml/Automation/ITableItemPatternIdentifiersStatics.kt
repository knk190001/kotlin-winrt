...
@Signature("{24c4b923-e9a2-4de9-b2a4-a8b22d0be362}")
@Guid("24c4b923e9a24de9b2a4a8b22d0be362")
@WinRTInterface("24c4b923e9a24de9b2a4a8b22d0be362")
...
public interface ITableItemPatternIdentifiersStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITableItemPatternIdentifiersStatics {
    public val __1715184389_Ptr: Pointer?

    public val _1715184389_VtblPtr: Pointer?
      get() = __1715184389_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ColumnHeaderItemsProperty(): AutomationProperty? {
      val fnPtr = _1715184389_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AutomationProperty>()
      val hr = fn.invokeHR(arrayOf(__1715184389_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_RowHeaderItemsProperty(): AutomationProperty? {
      val fnPtr = _1715184389_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AutomationProperty>()
      val hr = fn.invokeHR(arrayOf(__1715184389_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ITableItemPatternIdentifiersStatics_Impl(
    ...
    public override val __1715184389_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITableItemPatternIdentifiersStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("24c4b923e9a24de9b2a4a8b22d0be362")
    ...
    public override fun toNative(obj: ITableItemPatternIdentifiersStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1715184389_Ptr))
  }
