...
@Signature("{752c8399-d296-4d87-9020-a4750e885b3c}")
@Guid("752c8399d2964d879020a4750e885b3c")
@WinRTInterface("752c8399d2964d879020a4750e885b3c")
...
public interface IRichEditBoxAutomationPeerFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IRichEditBoxAutomationPeerFactory {
    public val __1250875524_Ptr: Pointer?

    public val _1250875524_VtblPtr: Pointer?
      get() = __1250875524_Ptr?.getPointer(0)
    ...
    public override fun CreateInstanceWithOwner(
      ...
      val fnPtr = _1250875524_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<RichEditBoxAutomationPeer>()
      val hr = fn.invokeHR(arrayOf(__1250875524_Ptr, marshalToNative(owner),
  ...
  public class IRichEditBoxAutomationPeerFactory_Impl(
    ...
    public override val __1250875524_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IRichEditBoxAutomationPeerFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("752c8399d2964d879020a4750e885b3c")
    ...
    public override fun toNative(obj: IRichEditBoxAutomationPeerFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1250875524_Ptr))
  }
