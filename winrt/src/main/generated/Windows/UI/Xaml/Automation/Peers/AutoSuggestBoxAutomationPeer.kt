...
import Windows.UI.Xaml.Automation.Peers.IAutoSuggestBoxAutomationPeerFactory.ABI.IID
...
@Signature("rc(Windows.UI.Xaml.Automation.Peers.AutoSuggestBoxAutomationPeer;{2f32c302-f99b-491d-9726-a5e181643efa})")
...
public class AutoSuggestBoxAutomationPeer(
  ...
  private val __816565721_Interface: IAutoSuggestBoxAutomationPeer.WithDefault by lazy {
    as_816565721()
  }
  ...
  public override val __816565721_Ptr: JNAPointer? by lazy {
    __816565721_Interface.__816565721_Ptr
  }
  ...
  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__816565721_Interface, __907541087_Interface)

  public constructor(owner: AutoSuggestBox) : this(ABI.activate(owner))

  private fun as_816565721(): IAutoSuggestBoxAutomationPeer.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<AutoSuggestBoxAutomationPeer, MemoryAddress> {
    ...
    public fun createIAutoSuggestBoxAutomationPeerFactory(): IAutoSuggestBoxAutomationPeerFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Automation.Peers.AutoSuggestBoxAutomationPeer".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
