...
@Signature("{4bf8e0a1-fb7f-4fa4-83b3-cfaeb103a685}")
@Guid("4bf8e0a1fb7f4fa483b3cfaeb103a685")
@WinRTInterface("4bf8e0a1fb7f4fa483b3cfaeb103a685")
...
public interface IScrollPatternIdentifiersStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IScrollPatternIdentifiersStatics {
    public val __784964067_Ptr: Pointer?

    public val _784964067_VtblPtr: Pointer?
      get() = __784964067_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_HorizontallyScrollableProperty(): AutomationProperty? {
      val fnPtr = _784964067_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AutomationProperty>()
      val hr = fn.invokeHR(arrayOf(__784964067_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_HorizontalScrollPercentProperty(): AutomationProperty? {
      val fnPtr = _784964067_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AutomationProperty>()
      val hr = fn.invokeHR(arrayOf(__784964067_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_HorizontalViewSizeProperty(): AutomationProperty? {
      val fnPtr = _784964067_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AutomationProperty>()
      val hr = fn.invokeHR(arrayOf(__784964067_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_NoScroll(): Double {
      val fnPtr = _784964067_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_VerticallyScrollableProperty(): AutomationProperty? {
      val fnPtr = _784964067_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AutomationProperty>()
      val hr = fn.invokeHR(arrayOf(__784964067_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_VerticalScrollPercentProperty(): AutomationProperty? {
      val fnPtr = _784964067_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AutomationProperty>()
      val hr = fn.invokeHR(arrayOf(__784964067_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_VerticalViewSizeProperty(): AutomationProperty? {
      val fnPtr = _784964067_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AutomationProperty>()
      val hr = fn.invokeHR(arrayOf(__784964067_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IScrollPatternIdentifiersStatics_Impl(
    ...
    public override val __784964067_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IScrollPatternIdentifiersStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("4bf8e0a1fb7f4fa483b3cfaeb103a685")
    ...
    public override fun toNative(obj: IScrollPatternIdentifiersStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__784964067_Ptr))
  }
