...
import Windows.UI.Xaml.Automation.Peers.ISelectorItemAutomationPeerFactory.ABI.IID
...
@Signature("rc(Windows.UI.Xaml.Automation.Peers.SelectorItemAutomationPeer;{ae8b3477-860a-45bb-bf7c-e1b27419d1dd})")
...
public open class SelectorItemAutomationPeer(
  ...
  private val __1569703939_Interface: ISelectorItemAutomationPeer.WithDefault by lazy {
    as_1569703939()
  }
  ...
  public override val __1569703939_Ptr: JNAPointer? by lazy {
    __1569703939_Interface.__1569703939_Ptr
  }
  ...
  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1569703939_Interface, __735116216_Interface)

  public constructor(item: IUnknown, parent: SelectorAutomationPeer) : this(ABI.activate(item,
      parent))

  private fun as_1569703939(): ISelectorItemAutomationPeer.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<SelectorItemAutomationPeer, MemoryAddress> {
    ...
    public fun createISelectorItemAutomationPeerFactory(): ISelectorItemAutomationPeerFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Automation.Peers.SelectorItemAutomationPeer".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
