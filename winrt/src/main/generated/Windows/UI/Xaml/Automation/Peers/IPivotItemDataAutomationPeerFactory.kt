...
@Signature("{517a2480-d3b6-412e-82b6-94a0a84c13b0}")
@Guid("517a2480d3b6412e82b694a0a84c13b0")
@WinRTInterface("517a2480d3b6412e82b694a0a84c13b0")
...
public interface IPivotItemDataAutomationPeerFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPivotItemDataAutomationPeerFactory {
    public val __965160426_Ptr: Pointer?

    public val _965160426_VtblPtr: Pointer?
      get() = __965160426_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstanceWithParentAndItem(item: IUnknown?,
        parent: PivotAutomationPeer?): PivotItemDataAutomationPeer? {
      val fnPtr = _965160426_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<PivotItemDataAutomationPeer>()
      val hr = fn.invokeHR(arrayOf(__965160426_Ptr, marshalToNative(item), marshalToNative(parent),
          result))
      if (hr.toInt() != 0) {
  ...
  public class IPivotItemDataAutomationPeerFactory_Impl(
    ...
    public override val __965160426_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPivotItemDataAutomationPeerFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("517a2480d3b6412e82b694a0a84c13b0")
    ...
    public override fun toNative(obj: IPivotItemDataAutomationPeerFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__965160426_Ptr))
  }
