...
import Windows.UI.Xaml.Automation.Peers.IPivotItemAutomationPeerFactory.ABI.IID
...
@Signature("rc(Windows.UI.Xaml.Automation.Peers.PivotItemAutomationPeer;{1a4241ad-5d55-4d27-b40f-2d37506fbe78})")
...
public class PivotItemAutomationPeer(
  ...
  private val __1903658806_Interface: IPivotItemAutomationPeer.WithDefault by lazy {
    as_1903658806()
  }


  public override val __1903658806_Ptr: JNAPointer? by lazy {
    __1903658806_Interface.__1903658806_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1903658806_Interface)

  public constructor(owner: PivotItem) : this(ABI.activate(owner))

  private fun as_1903658806(): IPivotItemAutomationPeer.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<PivotItemAutomationPeer, MemoryAddress> {
    ...
    public fun createIPivotItemAutomationPeerFactory(): IPivotItemAutomationPeerFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Automation.Peers.PivotItemAutomationPeer".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
