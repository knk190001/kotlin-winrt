...
@Signature("{e0e3a35d-d167-46dc-95ab-330af61aebb5}")
@Guid("e0e3a35dd16746dc95ab330af61aebb5")
@WinRTInterface("e0e3a35dd16746dc95ab330af61aebb5")
...
public interface IAnnotationPatternIdentifiersStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IAnnotationPatternIdentifiersStatics {
    public val __530570561_Ptr: Pointer?

    public val _530570561_VtblPtr: Pointer?
      get() = __530570561_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_AnnotationTypeIdProperty(): AutomationProperty? {
      val fnPtr = _530570561_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AutomationProperty>()
      val hr = fn.invokeHR(arrayOf(__530570561_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_AnnotationTypeNameProperty(): AutomationProperty? {
      val fnPtr = _530570561_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AutomationProperty>()
      val hr = fn.invokeHR(arrayOf(__530570561_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_AuthorProperty(): AutomationProperty? {
      val fnPtr = _530570561_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AutomationProperty>()
      val hr = fn.invokeHR(arrayOf(__530570561_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_DateTimeProperty(): AutomationProperty? {
      val fnPtr = _530570561_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AutomationProperty>()
      val hr = fn.invokeHR(arrayOf(__530570561_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_TargetProperty(): AutomationProperty? {
      val fnPtr = _530570561_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AutomationProperty>()
      val hr = fn.invokeHR(arrayOf(__530570561_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IAnnotationPatternIdentifiersStatics_Impl(
    ...
    public override val __530570561_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IAnnotationPatternIdentifiersStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("e0e3a35dd16746dc95ab330af61aebb5")
    ...
    public override fun toNative(obj: IAnnotationPatternIdentifiersStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__530570561_Ptr))
  }
