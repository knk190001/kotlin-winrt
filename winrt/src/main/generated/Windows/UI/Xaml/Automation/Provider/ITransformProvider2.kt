...
import Windows.UI.Xaml.Automation.Provider.ITransformProvider.ABI.IID
import Windows.UI.Xaml.Automation.ZoomUnit
...
@Signature("{a8b11756-a39f-4e97-8c7d-c1ea8dd633c5}")
@Guid("a8b11756a39f4e978c7dc1ea8dd633c5")
@WinRTInterface("a8b11756a39f4e978c7dc1ea8dd633c5")
...
public interface ITransformProvider2 : NativeMapped, IWinRTInterface, ITransformProvider {
  ...
  public interface WithDefault : ITransformProvider2, ITransformProvider.WithDefault {
    public val __905016979_Ptr: Pointer?

    public val _905016979_VtblPtr: Pointer?
      get() = __905016979_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_CanZoom(): Boolean {
      val fnPtr = _905016979_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__905016979_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ZoomLevel(): Double {
      val fnPtr = _905016979_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_MaxZoom(): Double {
      val fnPtr = _905016979_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__905016979_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_MinZoom(): Double {
      val fnPtr = _905016979_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__905016979_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun Zoom(zoom: Double): Unit {
      val fnPtr = _905016979_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__905016979_Ptr, zoom,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun ZoomByUnit(zoomUnit: ZoomUnit?): Unit {
      val fnPtr = _905016979_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__905016979_Ptr, marshalToNative(zoomUnit),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class ITransformProvider2_Impl(
    ...
    public override val __1414667419_Ptr: JNAPointer by lazy {
      ...
      IUnknownVtbl(_905016979_VtblPtr).queryInterface(pointer,refiid,result)
      result.value
    }


    public override val __905016979_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITransformProvider2, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("a8b11756a39f4e978c7dc1ea8dd633c5")
    ...
    public override fun toNative(obj: ITransformProvider2): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__905016979_Ptr))
  }
