...
import Windows.UI.Xaml.Automation.ToggleState
...
@Signature("{93b88290-656f-44f7-aeaf-78b8f944d062}")
@Guid("93b88290656f44f7aeaf78b8f944d062")
@WinRTInterface("93b88290656f44f7aeaf78b8f944d062")
...
public interface IToggleProvider : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IToggleProvider {
    public val __1185800317_Ptr: Pointer?

    public val _1185800317_VtblPtr: Pointer?
      get() = __1185800317_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ToggleState(): ToggleState? {
      val fnPtr = _1185800317_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ToggleState>()
      val hr = fn.invokeHR(arrayOf(__1185800317_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun Toggle(): Unit {
      val fnPtr = _1185800317_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1185800317_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IToggleProvider_Impl(
    ...
    public override val __1185800317_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IToggleProvider, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("93b88290656f44f7aeaf78b8f944d062")
    ...
    public override fun toNative(obj: IToggleProvider): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1185800317_Ptr))
  }
