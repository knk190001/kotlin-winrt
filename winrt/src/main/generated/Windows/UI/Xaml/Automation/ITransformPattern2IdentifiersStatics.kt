...
@Signature("{78963644-11f0-467c-a72b-5dac41c1f6fe}")
@Guid("7896364411f0467ca72b5dac41c1f6fe")
@WinRTInterface("7896364411f0467ca72b5dac41c1f6fe")
...
public interface ITransformPattern2IdentifiersStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITransformPattern2IdentifiersStatics {
    public val __570546382_Ptr: Pointer?

    public val _570546382_VtblPtr: Pointer?
      get() = __570546382_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_CanZoomProperty(): AutomationProperty? {
      val fnPtr = _570546382_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AutomationProperty>()
      val hr = fn.invokeHR(arrayOf(__570546382_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ZoomLevelProperty(): AutomationProperty? {
      val fnPtr = _570546382_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AutomationProperty>()
      val hr = fn.invokeHR(arrayOf(__570546382_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_MaxZoomProperty(): AutomationProperty? {
      val fnPtr = _570546382_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AutomationProperty>()
      val hr = fn.invokeHR(arrayOf(__570546382_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_MinZoomProperty(): AutomationProperty? {
      val fnPtr = _570546382_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AutomationProperty>()
      val hr = fn.invokeHR(arrayOf(__570546382_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ITransformPattern2IdentifiersStatics_Impl(
    ...
    public override val __570546382_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITransformPattern2IdentifiersStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("7896364411f0467ca72b5dac41c1f6fe")
    ...
    public override fun toNative(obj: ITransformPattern2IdentifiersStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__570546382_Ptr))
  }
