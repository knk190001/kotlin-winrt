...
@Signature("{ec30015a-d611-46d0-ae4f-6ecf27dfbaa5}")
@Guid("ec30015ad61146d0ae4f6ecf27dfbaa5")
@WinRTInterface("ec30015ad61146d0ae4f6ecf27dfbaa5")
...
public interface ISliderAutomationPeer : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISliderAutomationPeer {
    public val __2125309678_Ptr: Pointer?

    public val _2125309678_VtblPtr: Pointer?
      get() = __2125309678_Ptr?.getPointer(0)
  }

  public class ISliderAutomationPeer_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __2125309678_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISliderAutomationPeer, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("ec30015ad61146d0ae4f6ecf27dfbaa5")
    ...
    public override fun toNative(obj: ISliderAutomationPeer): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2125309678_Ptr))
  }
