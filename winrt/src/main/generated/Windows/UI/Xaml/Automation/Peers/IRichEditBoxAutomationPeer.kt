...
@Signature("{c69f5c04-16ee-467a-a833-c3da8458ad64}")
@Guid("c69f5c0416ee467aa833c3da8458ad64")
@WinRTInterface("c69f5c0416ee467aa833c3da8458ad64")
...
public interface IRichEditBoxAutomationPeer : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IRichEditBoxAutomationPeer {
    public val __1989142950_Ptr: Pointer?

    public val _1989142950_VtblPtr: Pointer?
      get() = __1989142950_Ptr?.getPointer(0)
  }

  public class IRichEditBoxAutomationPeer_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __1989142950_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IRichEditBoxAutomationPeer, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("c69f5c0416ee467aa833c3da8458ad64")
    ...
    public override fun toNative(obj: IRichEditBoxAutomationPeer): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1989142950_Ptr))
  }
