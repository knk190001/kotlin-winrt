...
@Signature("{28414bf7-8382-4eae-93c1-d6f035aa8155}")
@Guid("28414bf783824eae93c1d6f035aa8155")
@WinRTInterface("28414bf783824eae93c1d6f035aa8155")
...
public interface IPickerFlyoutPresenterAutomationPeer : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPickerFlyoutPresenterAutomationPeer {
    public val __1375765568_Ptr: Pointer?

    public val _1375765568_VtblPtr: Pointer?
      get() = __1375765568_Ptr?.getPointer(0)
  }

  public class IPickerFlyoutPresenterAutomationPeer_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __1375765568_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPickerFlyoutPresenterAutomationPeer, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("28414bf783824eae93c1d6f035aa8155")
    ...
    public override fun toNative(obj: IPickerFlyoutPresenterAutomationPeer): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1375765568_Ptr))
  }
