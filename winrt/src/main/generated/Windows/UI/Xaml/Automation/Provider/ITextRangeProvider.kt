...
import Windows.UI.Xaml.Automation.Text.TextPatternRangeEndpoint
import Windows.UI.Xaml.Automation.Text.TextUnit
...
@Signature("{0274688d-06e9-4f66-9446-28a5be98fbd0}")
@Guid("0274688d06e94f66944628a5be98fbd0")
@WinRTInterface("0274688d06e94f66944628a5be98fbd0")
...
public interface ITextRangeProvider : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITextRangeProvider {
    public val __106771447_Ptr: Pointer?

    public val _106771447_VtblPtr: Pointer?
      get() = __106771447_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun Clone(): ITextRangeProvider? {
      val fnPtr = _106771447_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ITextRangeProvider>()
      val hr = fn.invokeHR(arrayOf(__106771447_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun Compare(textRangeProvider: ITextRangeProvider?): Boolean {
      val fnPtr = _106771447_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__106771447_Ptr, marshalToNative(textRangeProvider), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun CompareEndpoints(
      ...
      val fnPtr = _106771447_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__106771447_Ptr, marshalToNative(endpoint),
    ...
    public override fun ExpandToEnclosingUnit(unit: TextUnit?): Unit {
      val fnPtr = _106771447_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__106771447_Ptr, marshalToNative(unit),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun FindAttribute(
      ...
      val fnPtr = _106771447_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ITextRangeProvider>()
      val hr = fn.invokeHR(arrayOf(__106771447_Ptr, attributeId, marshalToNative(value), backward,
          result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun FindText(
      ...
      val fnPtr = _106771447_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ITextRangeProvider>()
      val hr = fn.invokeHR(arrayOf(__106771447_Ptr, marshalToNative(text), backward, ignoreCase,
          result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun GetAttributeValue(attributeId: Int): IUnknown? {
      val fnPtr = _106771447_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IUnknown>()
      val hr = fn.invokeHR(arrayOf(__106771447_Ptr, attributeId, result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun GetBoundingRectangles(returnValue: OutArray<Double>): Unit {
      val fnPtr = _106771447_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__106771447_Ptr, returnValue.size,marshalToNative(returnValue),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun GetEnclosingElement(): IRawElementProviderSimple? {
      val fnPtr = _106771447_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun GetText(maxLength: Int): String? {
      val fnPtr = _106771447_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__106771447_Ptr, maxLength, result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun Move(unit: TextUnit?, count: Int): Int {
      val fnPtr = _106771447_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__106771447_Ptr, marshalToNative(unit), count, result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
      val resultValue = marshalFromNative<Int>(result.getValue())
    ...
    public override fun MoveEndpointByUnit(
      ...
      val fnPtr = _106771447_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__106771447_Ptr, marshalToNative(endpoint),
    ...
    public override fun MoveEndpointByRange(
      ...
      val fnPtr = _106771447_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__106771447_Ptr, marshalToNative(endpoint),
    ...
    public override fun Select(): Unit {
      val fnPtr = _106771447_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__106771447_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun AddToSelection(): Unit {
      val fnPtr = _106771447_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__106771447_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun RemoveFromSelection(): Unit {
      val fnPtr = _106771447_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__106771447_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun ScrollIntoView(alignToTop: Boolean): Unit {
      val fnPtr = _106771447_VtblPtr!!.getPointer(22L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__106771447_Ptr, alignToTop,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun GetChildren(): Array<IRawElementProviderSimple?>? {
      val fnPtr = _106771447_VtblPtr!!.getPointer(23L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class ITextRangeProvider_Impl(
    ...
    public override val __106771447_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITextRangeProvider, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("0274688d06e94f66944628a5be98fbd0")
    ...
    public override fun toNative(obj: ITextRangeProvider): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__106771447_Ptr))
  }
