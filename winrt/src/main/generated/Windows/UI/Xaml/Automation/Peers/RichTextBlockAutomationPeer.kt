...
import Windows.UI.Xaml.Automation.Peers.IRichTextBlockAutomationPeerFactory.ABI.IID
...
@Signature("rc(Windows.UI.Xaml.Automation.Peers.RichTextBlockAutomationPeer;{93a01a9c-9609-41fa-82f3-909c09f49a72})")
...
public open class RichTextBlockAutomationPeer(
  ...
  private val __736371611_Interface: IRichTextBlockAutomationPeer.WithDefault by lazy {
    as_736371611()
  }


  public override val __736371611_Ptr: JNAPointer? by lazy {
    __736371611_Interface.__736371611_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__736371611_Interface)

  public constructor(owner: RichTextBlock) : this(ABI.activate(owner))

  private fun as_736371611(): IRichTextBlockAutomationPeer.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<RichTextBlockAutomationPeer, MemoryAddress> {
    ...
    public fun createIRichTextBlockAutomationPeerFactory(): IRichTextBlockAutomationPeerFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Automation.Peers.RichTextBlockAutomationPeer".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
