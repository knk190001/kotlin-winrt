...
@Signature("{95ba1417-4437-451b-9461-050a49b59d06}")
@Guid("95ba14174437451b9461050a49b59d06")
@WinRTInterface("95ba14174437451b9461050a49b59d06")
...
public interface IAnnotationProvider : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IAnnotationProvider {
    public val __222447272_Ptr: Pointer?

    public val _222447272_VtblPtr: Pointer?
      get() = __222447272_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_AnnotationTypeId(): Int {
      val fnPtr = _222447272_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__222447272_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_AnnotationTypeName(): String? {
      val fnPtr = _222447272_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_Author(): String? {
      val fnPtr = _222447272_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__222447272_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_DateTime(): String? {
      val fnPtr = _222447272_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__222447272_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Target(): IRawElementProviderSimple? {
      val fnPtr = _222447272_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class IAnnotationProvider_Impl(
    ...
    public override val __222447272_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IAnnotationProvider, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("95ba14174437451b9461050a49b59d06")
    ...
    public override fun toNative(obj: IAnnotationProvider): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__222447272_Ptr))
  }
