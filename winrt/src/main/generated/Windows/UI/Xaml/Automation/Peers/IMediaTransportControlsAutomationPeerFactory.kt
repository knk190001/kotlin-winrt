...
@Signature("{f41cb003-e103-4ab0-812a-a08fbdb570ce}")
@Guid("f41cb003e1034ab0812aa08fbdb570ce")
@WinRTInterface("f41cb003e1034ab0812aa08fbdb570ce")
...
public interface IMediaTransportControlsAutomationPeerFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IMediaTransportControlsAutomationPeerFactory {
    public val __1828149442_Ptr: Pointer?

    public val _1828149442_VtblPtr: Pointer?
      get() = __1828149442_Ptr?.getPointer(0)
    ...
    public override fun CreateInstanceWithOwner(
      ...
      val fnPtr = _1828149442_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<MediaTransportControlsAutomationPeer>()
      val hr = fn.invokeHR(arrayOf(__1828149442_Ptr, marshalToNative(owner),
  ...
  public class IMediaTransportControlsAutomationPeerFactory_Impl(
    ...
    public override val __1828149442_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IMediaTransportControlsAutomationPeerFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("f41cb003e1034ab0812aa08fbdb570ce")
    ...
    public override fun toNative(obj: IMediaTransportControlsAutomationPeerFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1828149442_Ptr))
  }
