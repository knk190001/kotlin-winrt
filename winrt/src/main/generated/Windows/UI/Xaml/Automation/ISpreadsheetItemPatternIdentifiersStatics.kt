...
@Signature("{43658779-5380-4f12-b468-b4f368ad4499}")
@Guid("4365877953804f12b468b4f368ad4499")
@WinRTInterface("4365877953804f12b468b4f368ad4499")
...
public interface ISpreadsheetItemPatternIdentifiersStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISpreadsheetItemPatternIdentifiersStatics {
    public val __1376115591_Ptr: Pointer?

    public val _1376115591_VtblPtr: Pointer?
      get() = __1376115591_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_FormulaProperty(): AutomationProperty? {
      val fnPtr = _1376115591_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AutomationProperty>()
      val hr = fn.invokeHR(arrayOf(__1376115591_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ISpreadsheetItemPatternIdentifiersStatics_Impl(
    ...
    public override val __1376115591_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISpreadsheetItemPatternIdentifiersStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("4365877953804f12b468b4f368ad4499")
    ...
    public override fun toNative(obj: ISpreadsheetItemPatternIdentifiersStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1376115591_Ptr))
  }
