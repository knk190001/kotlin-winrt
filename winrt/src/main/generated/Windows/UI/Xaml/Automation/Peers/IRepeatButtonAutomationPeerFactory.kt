...
@Signature("{6a6ff9d4-575e-4e60-bdd6-ec14419b4ff6}")
@Guid("6a6ff9d4575e4e60bdd6ec14419b4ff6")
@WinRTInterface("6a6ff9d4575e4e60bdd6ec14419b4ff6")
...
public interface IRepeatButtonAutomationPeerFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IRepeatButtonAutomationPeerFactory {
    public val __1852887372_Ptr: Pointer?

    public val _1852887372_VtblPtr: Pointer?
      get() = __1852887372_Ptr?.getPointer(0)
    ...
    public override fun CreateInstanceWithOwner(
      ...
      val fnPtr = _1852887372_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<RepeatButtonAutomationPeer>()
      val hr = fn.invokeHR(arrayOf(__1852887372_Ptr, marshalToNative(owner),
  ...
  public class IRepeatButtonAutomationPeerFactory_Impl(
    ...
    public override val __1852887372_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IRepeatButtonAutomationPeerFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("6a6ff9d4575e4e60bdd6ec14419b4ff6")
    ...
    public override fun toNative(obj: IRepeatButtonAutomationPeerFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1852887372_Ptr))
  }
