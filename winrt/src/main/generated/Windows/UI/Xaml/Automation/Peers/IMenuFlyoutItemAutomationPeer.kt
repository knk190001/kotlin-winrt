...
@Signature("{1fc19462-21df-456e-aa11-8fac6b4b2af6}")
@Guid("1fc1946221df456eaa118fac6b4b2af6")
@WinRTInterface("1fc1946221df456eaa118fac6b4b2af6")
...
public interface IMenuFlyoutItemAutomationPeer : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IMenuFlyoutItemAutomationPeer {
    public val __1556704670_Ptr: Pointer?

    public val _1556704670_VtblPtr: Pointer?
      get() = __1556704670_Ptr?.getPointer(0)
  }

  public class IMenuFlyoutItemAutomationPeer_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __1556704670_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IMenuFlyoutItemAutomationPeer, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("1fc1946221df456eaa118fac6b4b2af6")
    ...
    public override fun toNative(obj: IMenuFlyoutItemAutomationPeer): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1556704670_Ptr))
  }
