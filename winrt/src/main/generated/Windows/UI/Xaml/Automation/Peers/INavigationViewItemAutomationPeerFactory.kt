...
@Signature("{0bc2835d-aa38-4f97-9664-e6fc821d81ed}")
@Guid("0bc2835daa384f979664e6fc821d81ed")
@WinRTInterface("0bc2835daa384f979664e6fc821d81ed")
...
public interface INavigationViewItemAutomationPeerFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : INavigationViewItemAutomationPeerFactory {
    public val __1963590605_Ptr: Pointer?

    public val _1963590605_VtblPtr: Pointer?
      get() = __1963590605_Ptr?.getPointer(0)
    ...
    public override fun CreateInstanceWithOwner(
      ...
      val fnPtr = _1963590605_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<NavigationViewItemAutomationPeer>()
      val hr = fn.invokeHR(arrayOf(__1963590605_Ptr, marshalToNative(owner),
  ...
  public class INavigationViewItemAutomationPeerFactory_Impl(
    ...
    public override val __1963590605_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<INavigationViewItemAutomationPeerFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("0bc2835daa384f979664e6fc821d81ed")
    ...
    public override fun toNative(obj: INavigationViewItemAutomationPeerFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1963590605_Ptr))
  }
