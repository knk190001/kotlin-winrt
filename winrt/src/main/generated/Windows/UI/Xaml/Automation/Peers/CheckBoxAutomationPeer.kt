...
import Windows.UI.Xaml.Automation.Peers.ICheckBoxAutomationPeerFactory.ABI.IID
...
@Signature("rc(Windows.UI.Xaml.Automation.Peers.CheckBoxAutomationPeer;{eb15bc42-c0a9-46c6-ac24-b83de429c733})")
...
public open class CheckBoxAutomationPeer(
  ...
  private val __1457896020_Interface: ICheckBoxAutomationPeer.WithDefault by lazy {
    as_1457896020()
  }


  public override val __1457896020_Ptr: JNAPointer? by lazy {
    __1457896020_Interface.__1457896020_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1457896020_Interface)

  public constructor(owner: CheckBox) : this(ABI.activate(owner))

  private fun as_1457896020(): ICheckBoxAutomationPeer.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<CheckBoxAutomationPeer, MemoryAddress> {
    ...
    public fun createICheckBoxAutomationPeerFactory(): ICheckBoxAutomationPeerFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Automation.Peers.CheckBoxAutomationPeer".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
