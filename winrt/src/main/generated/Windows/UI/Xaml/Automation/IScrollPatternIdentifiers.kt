...
@Signature("{366b1003-425c-4951-ae83-d521e73bc696}")
@Guid("366b1003425c4951ae83d521e73bc696")
@WinRTInterface("366b1003425c4951ae83d521e73bc696")
...
public interface IScrollPatternIdentifiers : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IScrollPatternIdentifiers {
    public val __300816510_Ptr: Pointer?

    public val _300816510_VtblPtr: Pointer?
      get() = __300816510_Ptr?.getPointer(0)
  }

  public class IScrollPatternIdentifiers_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __300816510_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IScrollPatternIdentifiers, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("366b1003425c4951ae83d521e73bc696")
    ...
    public override fun toNative(obj: IScrollPatternIdentifiers): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__300816510_Ptr))
  }
