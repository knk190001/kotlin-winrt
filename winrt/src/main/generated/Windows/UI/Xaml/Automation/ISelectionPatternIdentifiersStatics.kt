...
@Signature("{93035b4c-6b50-40a1-b23f-5c78ddbd479a}")
@Guid("93035b4c6b5040a1b23f5c78ddbd479a")
@WinRTInterface("93035b4c6b5040a1b23f5c78ddbd479a")
...
public interface ISelectionPatternIdentifiersStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISelectionPatternIdentifiersStatics {
    public val __1256552486_Ptr: Pointer?

    public val _1256552486_VtblPtr: Pointer?
      get() = __1256552486_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_CanSelectMultipleProperty(): AutomationProperty? {
      val fnPtr = _1256552486_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AutomationProperty>()
      val hr = fn.invokeHR(arrayOf(__1256552486_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsSelectionRequiredProperty(): AutomationProperty? {
      val fnPtr = _1256552486_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AutomationProperty>()
      val hr = fn.invokeHR(arrayOf(__1256552486_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_SelectionProperty(): AutomationProperty? {
      val fnPtr = _1256552486_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AutomationProperty>()
      val hr = fn.invokeHR(arrayOf(__1256552486_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ISelectionPatternIdentifiersStatics_Impl(
    ...
    public override val __1256552486_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISelectionPatternIdentifiersStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("93035b4c6b5040a1b23f5c78ddbd479a")
    ...
    public override fun toNative(obj: ISelectionPatternIdentifiersStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1256552486_Ptr))
  }
