...
import Windows.UI.Xaml.Automation.Peers.IFlyoutPresenterAutomationPeerFactory.ABI.IID
import Windows.UI.Xaml.Controls.FlyoutPresenter
...
@Signature("rc(Windows.UI.Xaml.Automation.Peers.FlyoutPresenterAutomationPeer;{a01840b4-5fca-456f-98ea-300eb40b585e})")
...
public open class FlyoutPresenterAutomationPeer(
  ...
  private val __301152174_Interface: IFlyoutPresenterAutomationPeer.WithDefault by lazy {
    as_301152174()
  }


  public override val __301152174_Ptr: JNAPointer? by lazy {
    __301152174_Interface.__301152174_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__301152174_Interface)

  public constructor(owner: FlyoutPresenter) : this(ABI.activate(owner))

  private fun as_301152174(): IFlyoutPresenterAutomationPeer.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<FlyoutPresenterAutomationPeer, MemoryAddress> {
    ...
    public fun createIFlyoutPresenterAutomationPeerFactory():
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Automation.Peers.FlyoutPresenterAutomationPeer".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
