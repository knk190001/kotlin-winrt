...
@Signature("rc(Windows.UI.Xaml.Automation.ValuePatternIdentifiers;{425bf64c-5333-4e41-b470-2bad14ecd085})")
...
public class ValuePatternIdentifiers(
  ...
  private val __420678800_Interface: IValuePatternIdentifiers.WithDefault by lazy {
    as_420678800()
  }


  public override val __420678800_Ptr: JNAPointer? by lazy {
    __420678800_Interface.__420678800_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__420678800_Interface)

  private fun as_420678800(): IValuePatternIdentifiers.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<ValuePatternIdentifiers, MemoryAddress> {
    ...
    public fun createIValuePatternIdentifiersStatics(): IValuePatternIdentifiersStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Automation.ValuePatternIdentifiers".toHandle(),refiid,interfacePtr)
      val result =
