...
@Signature("{2a05379d-1755-4082-9d90-46f1411d7986}")
@Guid("2a05379d175540829d9046f1411d7986")
@WinRTInterface("2a05379d175540829d9046f1411d7986")
...
public interface IDragPatternIdentifiersStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IDragPatternIdentifiersStatics {
    public val __698352284_Ptr: Pointer?

    public val _698352284_VtblPtr: Pointer?
      get() = __698352284_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_DropEffectProperty(): AutomationProperty? {
      val fnPtr = _698352284_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AutomationProperty>()
      val hr = fn.invokeHR(arrayOf(__698352284_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_DropEffectsProperty(): AutomationProperty? {
      val fnPtr = _698352284_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AutomationProperty>()
      val hr = fn.invokeHR(arrayOf(__698352284_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_GrabbedItemsProperty(): AutomationProperty? {
      val fnPtr = _698352284_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AutomationProperty>()
      val hr = fn.invokeHR(arrayOf(__698352284_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsGrabbedProperty(): AutomationProperty? {
      val fnPtr = _698352284_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AutomationProperty>()
      val hr = fn.invokeHR(arrayOf(__698352284_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IDragPatternIdentifiersStatics_Impl(
    ...
    public override val __698352284_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IDragPatternIdentifiersStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("2a05379d175540829d9046f1411d7986")
    ...
    public override fun toNative(obj: IDragPatternIdentifiersStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__698352284_Ptr))
  }
