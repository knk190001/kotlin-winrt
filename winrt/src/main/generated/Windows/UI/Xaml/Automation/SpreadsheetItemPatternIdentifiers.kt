...
@Signature("rc(Windows.UI.Xaml.Automation.SpreadsheetItemPatternIdentifiers;{84347e19-ca4b-46a2-a794-c87928a3b1ab})")
...
public class SpreadsheetItemPatternIdentifiers(
  ...
  private val __1543272030_Interface: ISpreadsheetItemPatternIdentifiers.WithDefault by lazy {
    as_1543272030()
  }


  public override val __1543272030_Ptr: JNAPointer? by lazy {
    __1543272030_Interface.__1543272030_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1543272030_Interface)

  private fun as_1543272030(): ISpreadsheetItemPatternIdentifiers.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<SpreadsheetItemPatternIdentifiers, MemoryAddress> {
    ...
    public fun createISpreadsheetItemPatternIdentifiersStatics():
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Automation.SpreadsheetItemPatternIdentifiers".toHandle(),refiid,interfacePtr)
      val result =
