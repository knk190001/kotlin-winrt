...
@Signature("{69e0c369-bbe7-41f2-87ca-aad813fe550e}")
@Guid("69e0c369bbe741f287caaad813fe550e")
@WinRTInterface("69e0c369bbe741f287caaad813fe550e")
...
public interface IScrollBarAutomationPeer : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IScrollBarAutomationPeer {
    public val __486983417_Ptr: Pointer?

    public val _486983417_VtblPtr: Pointer?
      get() = __486983417_Ptr?.getPointer(0)
  }

  public class IScrollBarAutomationPeer_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __486983417_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IScrollBarAutomationPeer, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("69e0c369bbe741f287caaad813fe550e")
    ...
    public override fun toNative(obj: IScrollBarAutomationPeer): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__486983417_Ptr))
  }
