...
@Signature("rc(Windows.UI.Xaml.Automation.Peers.AutomationPeerAnnotation;{0c456061-52cf-43fa-82f8-07f137351e5a})")
...
public class AutomationPeerAnnotation(
  ...
  private val __925831648_Interface: IAutomationPeerAnnotation.WithDefault by lazy {
    as_925831648()
  }


  public override val __925831648_Ptr: JNAPointer? by lazy {
    __925831648_Interface.__925831648_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__925831648_Interface)
  ...
  private fun as_925831648(): IAutomationPeerAnnotation.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<AutomationPeerAnnotation, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Automation.Peers.AutomationPeerAnnotation".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIAutomationPeerAnnotationStatics(): IAutomationPeerAnnotationStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Automation.Peers.AutomationPeerAnnotation".toHandle(),refiid,interfacePtr)
      val result =
    ...
    public fun createIAutomationPeerAnnotationFactory(): IAutomationPeerAnnotationFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Automation.Peers.AutomationPeerAnnotation".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
