...
@Signature("{79670fdd-f6a9-4a65-af17-861db799a2da}")
@Guid("79670fddf6a94a65af17861db799a2da")
@WinRTInterface("79670fddf6a94a65af17861db799a2da")
...
public interface ITransformProvider : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITransformProvider {
    public val __1414667419_Ptr: Pointer?

    public val _1414667419_VtblPtr: Pointer?
      get() = __1414667419_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_CanMove(): Boolean {
      val fnPtr = _1414667419_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1414667419_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_CanResize(): Boolean {
      val fnPtr = _1414667419_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1414667419_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_CanRotate(): Boolean {
      val fnPtr = _1414667419_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1414667419_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun Move(x: Double, y: Double): Unit {
      val fnPtr = _1414667419_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1414667419_Ptr, x, y,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun Resize(width: Double, height: Double): Unit {
      val fnPtr = _1414667419_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1414667419_Ptr, width, height,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun Rotate(degrees: Double): Unit {
      val fnPtr = _1414667419_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1414667419_Ptr, degrees,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class ITransformProvider_Impl(
    ...
    public override val __1414667419_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITransformProvider, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("79670fddf6a94a65af17861db799a2da")
    ...
    public override fun toNative(obj: ITransformProvider): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1414667419_Ptr))
  }
