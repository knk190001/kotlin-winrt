...
import Windows.UI.Xaml.Automation.Peers.IListViewHeaderItemAutomationPeerFactory.ABI.IID
...
@Signature("rc(Windows.UI.Xaml.Automation.Peers.ListViewHeaderItemAutomationPeer;{67ab1e4b-ad61-4c88-ba45-0f3a8d061f8f})")
...
public open class ListViewHeaderItemAutomationPeer(
  ptr: JNAPointer? = NULL
    ...
    IWinRTObject {
  private val __1419118772_Interface: IListViewHeaderItemAutomationPeer.WithDefault by lazy {
    as_1419118772()
  }


  public override val __1419118772_Ptr: JNAPointer? by lazy {
    __1419118772_Interface.__1419118772_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1419118772_Interface)

  public constructor(owner: ListViewHeaderItem) : this(ABI.activate(owner))

  private fun as_1419118772(): IListViewHeaderItemAutomationPeer.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<ListViewHeaderItemAutomationPeer, MemoryAddress> {
    ...
    public fun createIListViewHeaderItemAutomationPeerFactory():
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Automation.Peers.ListViewHeaderItemAutomationPeer".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
