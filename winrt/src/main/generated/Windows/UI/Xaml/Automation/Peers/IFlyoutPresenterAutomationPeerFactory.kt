...
@Signature("{f350155f-8924-44c0-ba44-653fe79f1efb}")
@Guid("f350155f892444c0ba44653fe79f1efb")
@WinRTInterface("f350155f892444c0ba44653fe79f1efb")
...
public interface IFlyoutPresenterAutomationPeerFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IFlyoutPresenterAutomationPeerFactory {
    public val __2071907972_Ptr: Pointer?

    public val _2071907972_VtblPtr: Pointer?
      get() = __2071907972_Ptr?.getPointer(0)
    ...
    public override fun CreateInstanceWithOwner(
      ...
      val fnPtr = _2071907972_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<FlyoutPresenterAutomationPeer>()
      val hr = fn.invokeHR(arrayOf(__2071907972_Ptr, marshalToNative(owner),
  ...
  public class IFlyoutPresenterAutomationPeerFactory_Impl(
    ...
    public override val __2071907972_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IFlyoutPresenterAutomationPeerFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("f350155f892444c0ba44653fe79f1efb")
    ...
    public override fun toNative(obj: IFlyoutPresenterAutomationPeerFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2071907972_Ptr))
  }
