...
@Signature("{15359093-bd99-4cfd-9f07-3b14b315e23d}")
@Guid("15359093bd994cfd9f073b14b315e23d")
@WinRTInterface("15359093bd994cfd9f073b14b315e23d")
...
public interface ISpreadsheetProvider : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISpreadsheetProvider {
    public val __349608389_Ptr: Pointer?

    public val _349608389_VtblPtr: Pointer?
      get() = __349608389_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun GetItemByName(name: String?): IRawElementProviderSimple? {
      val fnPtr = _349608389_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IRawElementProviderSimple>()
      val hr = fn.invokeHR(arrayOf(__349608389_Ptr, marshalToNative(name), result))
      if (hr.toInt() != 0) {
  ...
  public class ISpreadsheetProvider_Impl(
    ...
    public override val __349608389_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISpreadsheetProvider, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("15359093bd994cfd9f073b14b315e23d")
    ...
    public override fun toNative(obj: ISpreadsheetProvider): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__349608389_Ptr))
  }
