...
@Signature("{7eb40d0b-75c5-4263-ba6a-d4a54fb0f239}")
@Guid("7eb40d0b75c54263ba6ad4a54fb0f239")
@WinRTInterface("7eb40d0b75c54263ba6ad4a54fb0f239")
...
public interface IComboBoxAutomationPeer : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IComboBoxAutomationPeer {
    public val __817908366_Ptr: Pointer?

    public val _817908366_VtblPtr: Pointer?
      get() = __817908366_Ptr?.getPointer(0)
  }

  public class IComboBoxAutomationPeer_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __817908366_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IComboBoxAutomationPeer, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("7eb40d0b75c54263ba6ad4a54fb0f239")
    ...
    public override fun toNative(obj: IComboBoxAutomationPeer): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__817908366_Ptr))
  }
