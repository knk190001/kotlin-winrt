...
@Signature("{df1d48bc-0487-4e7f-9d5e-f09e77e41246}")
@Guid("df1d48bc04874e7f9d5ef09e77e41246")
@WinRTInterface("df1d48bc04874e7f9d5ef09e77e41246")
...
public interface ITextProvider2 : NativeMapped, IWinRTInterface, ITextProvider {
  ...
  public interface WithDefault : ITextProvider2, ITextProvider.WithDefault {
    public val __526023780_Ptr: Pointer?

    public val _526023780_VtblPtr: Pointer?
      get() = __526023780_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun RangeFromAnnotation(annotationElement: IRawElementProviderSimple?):
        ITextRangeProvider? {
      val fnPtr = _526023780_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ITextRangeProvider>()
      val hr = fn.invokeHR(arrayOf(__526023780_Ptr, marshalToNative(annotationElement), result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetCaretRange(isActive: Boolean): ITextRangeProvider? {
      val fnPtr = _526023780_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ITextRangeProvider>()
      val hr = fn.invokeHR(arrayOf(__526023780_Ptr, isActive, result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
      val resultValue = marshalFromNative<ITextRangeProvider>(result.getValue())
  ...
  public class ITextProvider2_Impl(
    ...
    public override val __675768150_Ptr: JNAPointer by lazy {
      ...
      IUnknownVtbl(_526023780_VtblPtr).queryInterface(pointer,refiid,result)
      result.value
    }


    public override val __526023780_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITextProvider2, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("df1d48bc04874e7f9d5ef09e77e41246")
    ...
    public override fun toNative(obj: ITextProvider2): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__526023780_Ptr))
  }
