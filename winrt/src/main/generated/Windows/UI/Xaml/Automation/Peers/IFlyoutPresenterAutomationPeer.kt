...
@Signature("{a01840b4-5fca-456f-98ea-300eb40b585e}")
@Guid("a01840b45fca456f98ea300eb40b585e")
@WinRTInterface("a01840b45fca456f98ea300eb40b585e")
...
public interface IFlyoutPresenterAutomationPeer : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IFlyoutPresenterAutomationPeer {
    public val __301152174_Ptr: Pointer?

    public val _301152174_VtblPtr: Pointer?
      get() = __301152174_Ptr?.getPointer(0)
  }

  public class IFlyoutPresenterAutomationPeer_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __301152174_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IFlyoutPresenterAutomationPeer, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("a01840b45fca456f98ea300eb40b585e")
    ...
    public override fun toNative(obj: IFlyoutPresenterAutomationPeer): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__301152174_Ptr))
  }
