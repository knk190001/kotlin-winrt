...
@Signature("{2086b7a7-ac0e-47d1-ab9b-2a64292afdf8}")
@Guid("2086b7a7ac0e47d1ab9b2a64292afdf8")
@WinRTInterface("2086b7a7ac0e47d1ab9b2a64292afdf8")
...
public interface IValueProvider : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IValueProvider {
    public val __1985648534_Ptr: Pointer?

    public val _1985648534_VtblPtr: Pointer?
      get() = __1985648534_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_IsReadOnly(): Boolean {
      val fnPtr = _1985648534_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1985648534_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Value(): String? {
      val fnPtr = _1985648534_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun SetValue(value: String?): Unit {
      val fnPtr = _1985648534_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1985648534_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IValueProvider_Impl(
    ...
    public override val __1985648534_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IValueProvider, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("2086b7a7ac0e47d1ab9b2a64292afdf8")
    ...
    public override fun toNative(obj: IValueProvider): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1985648534_Ptr))
  }
