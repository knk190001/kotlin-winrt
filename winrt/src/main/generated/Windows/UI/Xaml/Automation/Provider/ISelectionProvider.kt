...
@Signature("{1f018fca-b944-4395-8de1-88f674af51d3}")
@Guid("1f018fcab94443958de188f674af51d3")
@WinRTInterface("1f018fcab94443958de188f674af51d3")
...
public interface ISelectionProvider : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISelectionProvider {
    public val __1882207867_Ptr: Pointer?

    public val _1882207867_VtblPtr: Pointer?
      get() = __1882207867_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_CanSelectMultiple(): Boolean {
      val fnPtr = _1882207867_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1882207867_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsSelectionRequired(): Boolean {
      val fnPtr = _1882207867_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1882207867_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetSelection(): Array<IRawElementProviderSimple?>? {
      val fnPtr = _1882207867_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class ISelectionProvider_Impl(
    ...
    public override val __1882207867_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISelectionProvider, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("1f018fcab94443958de188f674af51d3")
    ...
    public override fun toNative(obj: ISelectionProvider): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1882207867_Ptr))
  }
