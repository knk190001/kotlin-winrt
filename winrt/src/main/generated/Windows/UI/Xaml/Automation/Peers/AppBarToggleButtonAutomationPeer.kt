...
import Windows.UI.Xaml.Automation.Peers.IAppBarToggleButtonAutomationPeerFactory.ABI.IID
...
@Signature("rc(Windows.UI.Xaml.Automation.Peers.AppBarToggleButtonAutomationPeer;{8464efad-9655-4aff-9550-63ae9ec8fe9c})")
...
public open class AppBarToggleButtonAutomationPeer(
  ...
  private val __302155031_Interface: IAppBarToggleButtonAutomationPeer.WithDefault by lazy {
    as_302155031()
  }


  public override val __302155031_Ptr: JNAPointer? by lazy {
    __302155031_Interface.__302155031_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__302155031_Interface)

  public constructor(owner: AppBarToggleButton) : this(ABI.activate(owner))

  private fun as_302155031(): IAppBarToggleButtonAutomationPeer.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<AppBarToggleButtonAutomationPeer, MemoryAddress> {
    ...
    public fun createIAppBarToggleButtonAutomationPeerFactory():
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Automation.Peers.AppBarToggleButtonAutomationPeer".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
