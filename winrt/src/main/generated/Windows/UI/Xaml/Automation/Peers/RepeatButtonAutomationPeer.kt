...
import Windows.UI.Xaml.Automation.Peers.IRepeatButtonAutomationPeerFactory.ABI.IID
import Windows.UI.Xaml.Automation.Provider.IInvokeProvider
import Windows.UI.Xaml.Controls.Primitives.RepeatButton
...
@Signature("rc(Windows.UI.Xaml.Automation.Peers.RepeatButtonAutomationPeer;{29e41ad5-a8ac-4e8a-83d8-09e37e054257})")
...
public open class RepeatButtonAutomationPeer(
  ...
  private val __508346846_Interface: IRepeatButtonAutomationPeer.WithDefault by lazy {
    as_508346846()
  }
  ...
  public override val __508346846_Ptr: JNAPointer? by lazy {
    __508346846_Interface.__508346846_Ptr
  }
  ...
  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__508346846_Interface, __907541087_Interface)

  public constructor(owner: RepeatButton) : this(ABI.activate(owner))

  private fun as_508346846(): IRepeatButtonAutomationPeer.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<RepeatButtonAutomationPeer, MemoryAddress> {
    ...
    public fun createIRepeatButtonAutomationPeerFactory(): IRepeatButtonAutomationPeerFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Automation.Peers.RepeatButtonAutomationPeer".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
