...
@Signature("{d014e196-0e50-4843-a5d2-c22897c8845a}")
@Guid("d014e1960e504843a5d2c22897c8845a")
@WinRTInterface("d014e1960e504843a5d2c22897c8845a")
...
public interface IMultipleViewProvider : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IMultipleViewProvider {
    public val __1932013310_Ptr: Pointer?

    public val _1932013310_VtblPtr: Pointer?
      get() = __1932013310_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_CurrentView(): Int {
      val fnPtr = _1932013310_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__1932013310_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetSupportedViews(): Array<Int>? {
      val fnPtr = _1932013310_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun GetViewName(viewId: Int): String? {
      val fnPtr = _1932013310_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__1932013310_Ptr, viewId, result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun SetCurrentView(viewId: Int): Unit {
      val fnPtr = _1932013310_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1932013310_Ptr, viewId,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IMultipleViewProvider_Impl(
    ...
    public override val __1932013310_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IMultipleViewProvider, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("d014e1960e504843a5d2c22897c8845a")
    ...
    public override fun toNative(obj: IMultipleViewProvider): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1932013310_Ptr))
  }
