...
@Signature("{1a5b7a17-7c01-4bec-9cd4-2dfa7dc246cd}")
@Guid("1a5b7a177c014bec9cd42dfa7dc246cd")
@WinRTInterface("1a5b7a177c014bec9cd42dfa7dc246cd")
...
public interface IStylesProvider : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IStylesProvider {
    public val __300920821_Ptr: Pointer?

    public val _300920821_VtblPtr: Pointer?
      get() = __300920821_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ExtendedProperties(): String? {
      val fnPtr = _300920821_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__300920821_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_FillColor(): Color? {
      val fnPtr = _300920821_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_FillPatternColor(): Color? {
      val fnPtr = _300920821_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__300920821_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_FillPatternStyle(): String? {
      val fnPtr = _300920821_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__300920821_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Shape(): String? {
      val fnPtr = _300920821_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__300920821_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_StyleId(): Int {
      val fnPtr = _300920821_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_StyleName(): String? {
      val fnPtr = _300920821_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__300920821_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IStylesProvider_Impl(
    ...
    public override val __300920821_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IStylesProvider, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("1a5b7a177c014bec9cd42dfa7dc246cd")
    ...
    public override fun toNative(obj: IStylesProvider): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__300920821_Ptr))
  }
