...
import Windows.UI.Xaml.Automation.Peers.IListViewItemDataAutomationPeerFactory.ABI.IID
...
@Signature("rc(Windows.UI.Xaml.Automation.Peers.ListViewItemDataAutomationPeer;{15a8d7fd-d7a5-4a6c-963c-6f7ce464671a})")
...
public open class ListViewItemDataAutomationPeer(
  ...
  private val __612417839_Interface: IListViewItemDataAutomationPeer.WithDefault by lazy {
    as_612417839()
  }
  ...
  public override val __612417839_Ptr: JNAPointer? by lazy {
    __612417839_Interface.__612417839_Ptr
  }
  ...
  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__612417839_Interface, __8885417_Interface)

  public constructor(item: IUnknown, parent: ListViewBaseAutomationPeer) : this(ABI.activate(item,
      parent))

  private fun as_612417839(): IListViewItemDataAutomationPeer.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<ListViewItemDataAutomationPeer, MemoryAddress> {
    ...
    public fun createIListViewItemDataAutomationPeerFactory():
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Automation.Peers.ListViewItemDataAutomationPeer".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
