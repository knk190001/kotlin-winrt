...
import Windows.UI.Xaml.Automation.Peers.IMenuBarAutomationPeerFactory.ABI.IID
import Windows.UI.Xaml.Controls.MenuBar
...
@Signature("rc(Windows.UI.Xaml.Automation.Peers.MenuBarAutomationPeer;{4b6adcf1-f274-5592-85a8-7b099e99b320})")
...
public open class MenuBarAutomationPeer(
  ...
  private val __1472115381_Interface: IMenuBarAutomationPeer.WithDefault by lazy {
    as_1472115381()
  }


  public override val __1472115381_Ptr: JNAPointer? by lazy {
    __1472115381_Interface.__1472115381_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1472115381_Interface)

  public constructor(owner: MenuBar) : this(ABI.activate(owner))

  private fun as_1472115381(): IMenuBarAutomationPeer.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<MenuBarAutomationPeer, MemoryAddress> {
    ...
    public fun createIMenuBarAutomationPeerFactory(): IMenuBarAutomationPeerFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Automation.Peers.MenuBarAutomationPeer".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
