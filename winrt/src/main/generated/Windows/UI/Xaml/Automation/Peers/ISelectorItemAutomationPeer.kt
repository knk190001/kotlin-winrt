...
@Signature("{ae8b3477-860a-45bb-bf7c-e1b27419d1dd}")
@Guid("ae8b3477860a45bbbf7ce1b27419d1dd")
@WinRTInterface("ae8b3477860a45bbbf7ce1b27419d1dd")
...
public interface ISelectorItemAutomationPeer : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISelectorItemAutomationPeer {
    public val __1569703939_Ptr: Pointer?

    public val _1569703939_VtblPtr: Pointer?
      get() = __1569703939_Ptr?.getPointer(0)
  }

  public class ISelectorItemAutomationPeer_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __1569703939_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISelectorItemAutomationPeer, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("ae8b3477860a45bbbf7ce1b27419d1dd")
    ...
    public override fun toNative(obj: ISelectorItemAutomationPeer): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1569703939_Ptr))
  }
