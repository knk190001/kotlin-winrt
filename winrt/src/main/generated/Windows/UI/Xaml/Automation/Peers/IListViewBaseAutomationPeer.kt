...
@Signature("{87ec7649-b83d-4e55-9afd-bd835e748f5c}")
@Guid("87ec7649b83d4e559afdbd835e748f5c")
@WinRTInterface("87ec7649b83d4e559afdbd835e748f5c")
...
public interface IListViewBaseAutomationPeer : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IListViewBaseAutomationPeer {
    public val __1635599045_Ptr: Pointer?

    public val _1635599045_VtblPtr: Pointer?
      get() = __1635599045_Ptr?.getPointer(0)
  }

  public class IListViewBaseAutomationPeer_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __1635599045_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IListViewBaseAutomationPeer, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("87ec7649b83d4e559afdbd835e748f5c")
    ...
    public override fun toNative(obj: IListViewBaseAutomationPeer): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1635599045_Ptr))
  }
