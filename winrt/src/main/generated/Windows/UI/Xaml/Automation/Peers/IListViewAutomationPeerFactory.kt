...
@Signature("{65f39174-eaa2-4e44-8be6-4cca28cd0288}")
@Guid("65f39174eaa24e448be64cca28cd0288")
@WinRTInterface("65f39174eaa24e448be64cca28cd0288")
...
public interface IListViewAutomationPeerFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IListViewAutomationPeerFactory {
    public val __1503018154_Ptr: Pointer?

    public val _1503018154_VtblPtr: Pointer?
      get() = __1503018154_Ptr?.getPointer(0)
    ...
    public override fun CreateInstanceWithOwner(
      ...
      val fnPtr = _1503018154_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ListViewAutomationPeer>()
      val hr = fn.invokeHR(arrayOf(__1503018154_Ptr, marshalToNative(owner),
  ...
  public class IListViewAutomationPeerFactory_Impl(
    ...
    public override val __1503018154_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IListViewAutomationPeerFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("65f39174eaa24e448be64cca28cd0288")
    ...
    public override fun toNative(obj: IListViewAutomationPeerFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1503018154_Ptr))
  }
