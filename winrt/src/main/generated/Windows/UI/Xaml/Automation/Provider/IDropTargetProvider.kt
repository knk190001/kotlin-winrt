...
@Signature("{7a245bdd-b458-4fe0-98c8-aac89df56d61}")
@Guid("7a245bddb4584fe098c8aac89df56d61")
@WinRTInterface("7a245bddb4584fe098c8aac89df56d61")
...
public interface IDropTargetProvider : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IDropTargetProvider {
    public val __945711753_Ptr: Pointer?

    public val _945711753_VtblPtr: Pointer?
      get() = __945711753_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_DropEffect(): String? {
      val fnPtr = _945711753_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__945711753_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_DropEffects(): Array<String?>? {
      val fnPtr = _945711753_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class IDropTargetProvider_Impl(
    ...
    public override val __945711753_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IDropTargetProvider, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("7a245bddb4584fe098c8aac89df56d61")
    ...
    public override fun toNative(obj: IDropTargetProvider): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__945711753_Ptr))
  }
