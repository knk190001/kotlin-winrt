...
import Windows.UI.Xaml.Automation.Peers.IRichTextBlockOverflowAutomationPeerFactory.ABI.IID
...
@Signature("rc(Windows.UI.Xaml.Automation.Peers.RichTextBlockOverflowAutomationPeer;{8c9a409a-2736-437b-ab36-a16a202f105d})")
...
public open class RichTextBlockOverflowAutomationPeer(
  ptr: JNAPointer? = NULL
    ...
    IWinRTObject {
  private val __690215673_Interface: IRichTextBlockOverflowAutomationPeer.WithDefault by lazy {
    as_690215673()
  }


  public override val __690215673_Ptr: JNAPointer? by lazy {
    __690215673_Interface.__690215673_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__690215673_Interface)

  public constructor(owner: RichTextBlockOverflow) : this(ABI.activate(owner))

  private fun as_690215673(): IRichTextBlockOverflowAutomationPeer.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<RichTextBlockOverflowAutomationPeer, MemoryAddress> {
    ...
    public fun createIRichTextBlockOverflowAutomationPeerFactory():
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Automation.Peers.RichTextBlockOverflowAutomationPeer".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
