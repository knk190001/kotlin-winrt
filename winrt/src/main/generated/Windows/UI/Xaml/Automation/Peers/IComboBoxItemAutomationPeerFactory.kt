...
@Signature("{134ac7fc-397a-403f-a6ec-1ce8beda15e5}")
@Guid("134ac7fc397a403fa6ec1ce8beda15e5")
@WinRTInterface("134ac7fc397a403fa6ec1ce8beda15e5")
...
public interface IComboBoxItemAutomationPeerFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IComboBoxItemAutomationPeerFactory {
    public val __776780855_Ptr: Pointer?

    public val _776780855_VtblPtr: Pointer?
      get() = __776780855_Ptr?.getPointer(0)
    ...
    public override fun CreateInstanceWithOwner(
      ...
      val fnPtr = _776780855_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ComboBoxItemAutomationPeer>()
      val hr = fn.invokeHR(arrayOf(__776780855_Ptr, marshalToNative(owner),
  ...
  public class IComboBoxItemAutomationPeerFactory_Impl(
    ...
    public override val __776780855_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IComboBoxItemAutomationPeerFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("134ac7fc397a403fa6ec1ce8beda15e5")
    ...
    public override fun toNative(obj: IComboBoxItemAutomationPeerFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__776780855_Ptr))
  }
