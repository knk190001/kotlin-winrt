...
@Signature("{e244a871-fcbb-48fc-8a93-41ea134b53ce}")
@Guid("e244a871fcbb48fc8a9341ea134b53ce")
@WinRTInterface("e244a871fcbb48fc8a9341ea134b53ce")
...
public interface IMenuFlyoutPresenterAutomationPeer : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IMenuFlyoutPresenterAutomationPeer {
    public val __48758415_Ptr: Pointer?

    public val _48758415_VtblPtr: Pointer?
      get() = __48758415_Ptr?.getPointer(0)
  }

  public class IMenuFlyoutPresenterAutomationPeer_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __48758415_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IMenuFlyoutPresenterAutomationPeer, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("e244a871fcbb48fc8a9341ea134b53ce")
    ...
    public override fun toNative(obj: IMenuFlyoutPresenterAutomationPeer): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__48758415_Ptr))
  }
