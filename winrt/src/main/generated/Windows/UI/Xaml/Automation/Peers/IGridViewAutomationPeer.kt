...
@Signature("{1c4401a4-d951-49ca-8f82-c7f3c60681b0}")
@Guid("1c4401a4d95149ca8f82c7f3c60681b0")
@WinRTInterface("1c4401a4d95149ca8f82c7f3c60681b0")
...
public interface IGridViewAutomationPeer : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IGridViewAutomationPeer {
    public val __1535322044_Ptr: Pointer?

    public val _1535322044_VtblPtr: Pointer?
      get() = __1535322044_Ptr?.getPointer(0)
  }

  public class IGridViewAutomationPeer_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __1535322044_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IGridViewAutomationPeer, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("1c4401a4d95149ca8f82c7f3c60681b0")
    ...
    public override fun toNative(obj: IGridViewAutomationPeer): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1535322044_Ptr))
  }
