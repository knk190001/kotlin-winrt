...
@Signature("{953c34f6-3b31-47a7-b3bf-25d3ae99c317}")
@Guid("953c34f63b3147a7b3bf25d3ae99c317")
@WinRTInterface("953c34f63b3147a7b3bf25d3ae99c317")
...
public interface IItemAutomationPeer : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IItemAutomationPeer {
    public val __544609852_Ptr: Pointer?

    public val _544609852_VtblPtr: Pointer?
      get() = __544609852_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Item(): IUnknown? {
      val fnPtr = _544609852_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IUnknown>()
      val hr = fn.invokeHR(arrayOf(__544609852_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ItemsControlAutomationPeer(): ItemsControlAutomationPeer? {
      val fnPtr = _544609852_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class IItemAutomationPeer_Impl(
    ...
    public override val __544609852_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IItemAutomationPeer, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("953c34f63b3147a7b3bf25d3ae99c317")
    ...
    public override fun toNative(obj: IItemAutomationPeer): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__544609852_Ptr))
  }
