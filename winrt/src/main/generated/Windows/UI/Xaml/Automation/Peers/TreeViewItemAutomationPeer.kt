...
import Windows.UI.Xaml.Automation.Peers.ITreeViewItemAutomationPeerFactory.ABI.IID
...
@Signature("rc(Windows.UI.Xaml.Automation.Peers.TreeViewItemAutomationPeer;{2331d648-b617-437f-920c-71d450503e65})")
...
public open class TreeViewItemAutomationPeer(
  ...
  private val __898195833_Interface: ITreeViewItemAutomationPeer.WithDefault by lazy {
    as_898195833()
  }
  ...
  public override val __898195833_Ptr: JNAPointer? by lazy {
    __898195833_Interface.__898195833_Ptr
  }
  ...
  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__898195833_Interface, __1930365296_Interface)

  public constructor(owner: TreeViewItem) : this(ABI.activate(owner))

  private fun as_898195833(): ITreeViewItemAutomationPeer.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<TreeViewItemAutomationPeer, MemoryAddress> {
    ...
    public fun createITreeViewItemAutomationPeerFactory(): ITreeViewItemAutomationPeerFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Automation.Peers.TreeViewItemAutomationPeer".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
