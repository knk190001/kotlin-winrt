...
import Windows.UI.Xaml.Automation.Peers.IMenuFlyoutItemAutomationPeerFactory.ABI.IID
...
@Signature("rc(Windows.UI.Xaml.Automation.Peers.MenuFlyoutItemAutomationPeer;{1fc19462-21df-456e-aa11-8fac6b4b2af6})")
...
public open class MenuFlyoutItemAutomationPeer(
  ...
  private val __1556704670_Interface: IMenuFlyoutItemAutomationPeer.WithDefault by lazy {
    as_1556704670()
  }
  ...
  public override val __1556704670_Ptr: JNAPointer? by lazy {
    __1556704670_Interface.__1556704670_Ptr
  }
  ...
  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1556704670_Interface, __907541087_Interface)

  public constructor(owner: MenuFlyoutItem) : this(ABI.activate(owner))

  private fun as_1556704670(): IMenuFlyoutItemAutomationPeer.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<MenuFlyoutItemAutomationPeer, MemoryAddress> {
    ...
    public fun createIMenuFlyoutItemAutomationPeerFactory(): IMenuFlyoutItemAutomationPeerFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Automation.Peers.MenuFlyoutItemAutomationPeer".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
