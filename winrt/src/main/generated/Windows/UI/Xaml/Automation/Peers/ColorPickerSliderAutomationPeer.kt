...
import Windows.UI.Xaml.Automation.Peers.IColorPickerSliderAutomationPeerFactory.ABI.IID
...
@Signature("rc(Windows.UI.Xaml.Automation.Peers.ColorPickerSliderAutomationPeer;{a514215a-7293-4577-924c-47d4e0bf9b90})")
...
public open class ColorPickerSliderAutomationPeer(
  ...
  private val __1763528685_Interface: IColorPickerSliderAutomationPeer.WithDefault by lazy {
    as_1763528685()
  }


  public override val __1763528685_Ptr: JNAPointer? by lazy {
    __1763528685_Interface.__1763528685_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1763528685_Interface)

  public constructor(owner: ColorPickerSlider) : this(ABI.activate(owner))

  private fun as_1763528685(): IColorPickerSliderAutomationPeer.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<ColorPickerSliderAutomationPeer, MemoryAddress> {
    ...
    public fun createIColorPickerSliderAutomationPeerFactory():
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Automation.Peers.ColorPickerSliderAutomationPeer".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
