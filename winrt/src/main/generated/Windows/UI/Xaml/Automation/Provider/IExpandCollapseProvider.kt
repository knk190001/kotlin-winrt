...
import Windows.UI.Xaml.Automation.ExpandCollapseState
...
@Signature("{49ac8399-d626-4543-94b9-a6d9a9593af6}")
@Guid("49ac8399d626454394b9a6d9a9593af6")
@WinRTInterface("49ac8399d626454394b9a6d9a9593af6")
...
public interface IExpandCollapseProvider : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IExpandCollapseProvider {
    public val __1930365296_Ptr: Pointer?

    public val _1930365296_VtblPtr: Pointer?
      get() = __1930365296_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ExpandCollapseState(): ExpandCollapseState? {
      val fnPtr = _1930365296_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ExpandCollapseState>()
      val hr = fn.invokeHR(arrayOf(__1930365296_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun Collapse(): Unit {
      val fnPtr = _1930365296_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1930365296_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun Expand(): Unit {
      val fnPtr = _1930365296_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1930365296_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IExpandCollapseProvider_Impl(
    ...
    public override val __1930365296_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IExpandCollapseProvider, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("49ac8399d626454394b9a6d9a9593af6")
    ...
    public override fun toNative(obj: IExpandCollapseProvider): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1930365296_Ptr))
  }
