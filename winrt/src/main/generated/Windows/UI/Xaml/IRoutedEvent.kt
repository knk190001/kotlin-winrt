...
@Signature("{a6b25818-43c1-4c70-865c-7bdd5a32e327}")
@Guid("a6b2581843c14c70865c7bdd5a32e327")
@WinRTInterface("a6b2581843c14c70865c7bdd5a32e327")
...
public interface IRoutedEvent : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IRoutedEvent {
    public val __574641523_Ptr: Pointer?

    public val _574641523_VtblPtr: Pointer?
      get() = __574641523_Ptr?.getPointer(0)
  }

  public class IRoutedEvent_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __574641523_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IRoutedEvent, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("a6b2581843c14c70865c7bdd5a32e327")
    ...
    public override fun toNative(obj: IRoutedEvent): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__574641523_Ptr))
  }
