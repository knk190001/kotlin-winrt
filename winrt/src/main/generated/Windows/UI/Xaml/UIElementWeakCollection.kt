...
import Windows.UI.Xaml.IUIElementWeakCollectionFactory.ABI.IID
...
@Signature("rc(Windows.UI.Xaml.UIElementWeakCollection;{10341223-e66d-519e-acf8-556bd244eac3})")
@WinRTByReference(brClass = UIElementWeakCollection.ByReference::class)
public open class UIElementWeakCollection(
  ptr: JNAPointer? = NULL
) : PointerType(ptr), IUIElementWeakCollection.WithDefault, IVector<UIElement?>,
    IIterable<UIElement?>, IWinRTObject {
  private val __179701164_Interface: IUIElementWeakCollection.WithDefault by lazy {
    as_179701164()
  }
  ...
  public override val __179701164_Ptr: JNAPointer? by lazy {
    __179701164_Interface.__179701164_Ptr
  }
  ...
  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__179701164_Interface, __1070388601_Interface, __1449643190_Interface)

  public constructor() : this(ABI.activate())

  private fun as_179701164(): IUIElementWeakCollection.WithDefault {
    if(pointer == NULL) {
      return(IUIElementWeakCollection.ABI.makeIUIElementWeakCollection(NULL))
    }
    val refiid = Guid.REFIID(guidOf<IUIElementWeakCollection>())
    val ref = PointerByReference()
    IUnknownVtbl(pointer.getPointer(0)).queryInterface(pointer, refiid, ref)
    return(IUIElementWeakCollection.ABI.makeIUIElementWeakCollection(ref.value))
  }
  ...
  public object ABI : IABI<UIElementWeakCollection, MemoryAddress> {
    ...
    public fun createIUIElementWeakCollectionFactory(): IUIElementWeakCollectionFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.UIElementWeakCollection".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
