...
@Signature("{88eeccc8-99e2-4a44-9907-b44bc86e2bbe}")
@Guid("88eeccc899e24a449907b44bc86e2bbe")
@WinRTInterface("88eeccc899e24a449907b44bc86e2bbe")
...
public interface ITargetPropertyPathFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITargetPropertyPathFactory {
    public val __303275859_Ptr: Pointer?

    public val _303275859_VtblPtr: Pointer?
      get() = __303275859_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(targetProperty: DependencyProperty?): TargetPropertyPath? {
      val fnPtr = _303275859_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<TargetPropertyPath>()
      val hr = fn.invokeHR(arrayOf(__303275859_Ptr, marshalToNative(targetProperty), result))
      if (hr.toInt() != 0) {
  ...
  public class ITargetPropertyPathFactory_Impl(
    ...
    public override val __303275859_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITargetPropertyPathFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("88eeccc899e24a449907b44bc86e2bbe")
    ...
    public override fun toNative(obj: ITargetPropertyPathFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__303275859_Ptr))
  }
