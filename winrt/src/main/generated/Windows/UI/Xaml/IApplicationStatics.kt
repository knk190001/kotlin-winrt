...
@Signature("{06499997-f7b4-45fe-b763-7577d1d3cb4a}")
@Guid("06499997f7b445feb7637577d1d3cb4a")
@WinRTInterface("06499997f7b445feb7637577d1d3cb4a")
...
public interface IApplicationStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IApplicationStatics {
    public val __145191385_Ptr: Pointer?

    public val _145191385_VtblPtr: Pointer?
      get() = __145191385_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Current(): Application? {
      val fnPtr = _145191385_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Application>()
      val hr = fn.invokeHR(arrayOf(__145191385_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun Start(callback: ApplicationInitializationCallback?): Unit {
      val fnPtr = _145191385_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__145191385_Ptr, marshalToNative(callback),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun LoadComponent(component: IUnknown?, resourceLocator: Uri?): Unit {
      val fnPtr = _145191385_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__145191385_Ptr, marshalToNative(component),
    ...
    public override fun LoadComponent(
      ...
      val fnPtr = _145191385_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__145191385_Ptr, marshalToNative(component),
  ...
  public class IApplicationStatics_Impl(
    ...
    public override val __145191385_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IApplicationStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("06499997f7b445feb7637577d1d3cb4a")
    ...
    public override fun toNative(obj: IApplicationStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__145191385_Ptr))
  }
