...
@Signature("{1eec08c3-e061-5e10-9f2a-2baa840885c2}")
@Guid("1eec08c3e0615e109f2a2baa840885c2")
@WinRTInterface("1eec08c3e0615e109f2a2baa840885c2")
...
public interface IXamlUICommandFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IXamlUICommandFactory {
    public val __974468847_Ptr: Pointer?

    public val _974468847_VtblPtr: Pointer?
      get() = __974468847_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        XamlUICommand? {
      val fnPtr = _974468847_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<XamlUICommand>()
      val hr = fn.invokeHR(arrayOf(__974468847_Ptr, marshalToNative(baseInterface),
  ...
  public class IXamlUICommandFactory_Impl(
    ...
    public override val __974468847_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IXamlUICommandFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("1eec08c3e0615e109f2a2baa840885c2")
    ...
    public override fun toNative(obj: IXamlUICommandFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__974468847_Ptr))
  }
