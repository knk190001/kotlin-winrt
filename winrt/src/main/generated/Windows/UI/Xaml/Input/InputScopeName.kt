...
@Signature("rc(Windows.UI.Xaml.Input.InputScopeName;{fd3e6997-08fb-4cba-a021-792d7589fd5a})")
...
public class InputScopeName(
  ...
  private val __660912469_Interface: IInputScopeName.WithDefault by lazy {
    as_660912469()
  }


  public override val __660912469_Ptr: JNAPointer? by lazy {
    __660912469_Interface.__660912469_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__660912469_Interface)

  public constructor() : this(ABI.activate())

  public constructor(nameValue: InputScopeNameValue) : this(ABI.activate(nameValue))

  private fun as_660912469(): IInputScopeName.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<InputScopeName, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr = INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Input.InputScopeName".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIInputScopeNameFactory(): IInputScopeNameFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Input.InputScopeName".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
