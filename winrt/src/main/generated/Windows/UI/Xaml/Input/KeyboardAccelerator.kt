...
import Windows.UI.Xaml.Input.IKeyboardAcceleratorFactory.ABI.IID
...
@Signature("rc(Windows.UI.Xaml.Input.KeyboardAccelerator;{92e6181e-19ae-465a-9b3c-a71ee9ea7420})")
...
public open class KeyboardAccelerator(
  ...
  private val __1269415278_Interface: IKeyboardAccelerator.WithDefault by lazy {
    as_1269415278()
  }


  public override val __1269415278_Ptr: JNAPointer? by lazy {
    __1269415278_Interface.__1269415278_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1269415278_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1269415278(): IKeyboardAccelerator.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<KeyboardAccelerator, MemoryAddress> {
    ...
    public fun createIKeyboardAcceleratorStatics(): IKeyboardAcceleratorStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Input.KeyboardAccelerator".toHandle(),refiid,interfacePtr)
      val result =
    ...
    public fun createIKeyboardAcceleratorFactory(): IKeyboardAcceleratorFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Input.KeyboardAccelerator".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
