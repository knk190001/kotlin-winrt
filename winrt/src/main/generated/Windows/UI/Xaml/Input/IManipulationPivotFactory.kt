...
@Signature("{6d05b039-3702-4396-ad9b-a825efa63a3b}")
@Guid("6d05b03937024396ad9ba825efa63a3b")
@WinRTInterface("6d05b03937024396ad9ba825efa63a3b")
...
public interface IManipulationPivotFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IManipulationPivotFactory {
    public val __2110979963_Ptr: Pointer?

    public val _2110979963_VtblPtr: Pointer?
      get() = __2110979963_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstanceWithCenterAndRadius(center: Point?, radius: Double):
        ManipulationPivot? {
      val fnPtr = _2110979963_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ManipulationPivot>()
      val hr = fn.invokeHR(arrayOf(__2110979963_Ptr, marshalToNative(center), radius, result))
      if (hr.toInt() != 0) {
  ...
  public class IManipulationPivotFactory_Impl(
    ...
    public override val __2110979963_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IManipulationPivotFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("6d05b03937024396ad9ba825efa63a3b")
    ...
    public override fun toNative(obj: IManipulationPivotFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2110979963_Ptr))
  }
