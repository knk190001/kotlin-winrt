...
@Signature("{3e157e7a-9578-5cd3-aaa8-051b3d391978}")
@Guid("3e157e7a95785cd3aaa8051b3d391978")
@WinRTInterface("3e157e7a95785cd3aaa8051b3d391978")
...
public interface IFocusManagerLostFocusEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IFocusManagerLostFocusEventArgs {
    public val __456503758_Ptr: Pointer?

    public val _456503758_VtblPtr: Pointer?
      get() = __456503758_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_OldFocusedElement(): DependencyObject? {
      val fnPtr = _456503758_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyObject>()
      val hr = fn.invokeHR(arrayOf(__456503758_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_CorrelationId(): com.sun.jna.platform.win32.Guid.GUID? {
      val fnPtr = _456503758_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class IFocusManagerLostFocusEventArgs_Impl(
    ...
    public override val __456503758_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IFocusManagerLostFocusEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("3e157e7a95785cd3aaa8051b3d391978")
    ...
    public override fun toNative(obj: IFocusManagerLostFocusEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__456503758_Ptr))
  }
