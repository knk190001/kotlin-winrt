...
import Windows.UI.Xaml.Controls.IconSource
...
@Signature("{8494f8d4-ead1-5f01-ad2e-a8cad4f9dc0e}")
@Guid("8494f8d4ead15f01ad2ea8cad4f9dc0e")
@WinRTInterface("8494f8d4ead15f01ad2ea8cad4f9dc0e")
...
public interface IXamlUICommand : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IXamlUICommand {
    public val __868339129_Ptr: Pointer?

    public val _868339129_VtblPtr: Pointer?
      get() = __868339129_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Label(): String? {
      val fnPtr = _868339129_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__868339129_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Label(value: String?): Unit {
      val fnPtr = _868339129_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__868339129_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_IconSource(): IconSource? {
      val fnPtr = _868339129_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_IconSource(value: IconSource?): Unit {
      val fnPtr = _868339129_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__868339129_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_KeyboardAccelerators(): IVector<KeyboardAccelerator?>? {
      val fnPtr = _868339129_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_AccessKey(): String? {
      val fnPtr = _868339129_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__868339129_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_AccessKey(value: String?): Unit {
      val fnPtr = _868339129_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__868339129_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Description(): String? {
      val fnPtr = _868339129_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__868339129_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Description(value: String?): Unit {
      val fnPtr = _868339129_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__868339129_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Command(): ICommand? {
      val fnPtr = _868339129_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Command(value: ICommand?): Unit {
      val fnPtr = _868339129_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__868339129_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun add_ExecuteRequested(handler: TypedEventHandler<XamlUICommand?,
        ExecuteRequestedEventArgs?>?): EventRegistrationToken? {
      val fnPtr = _868339129_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__868339129_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun remove_ExecuteRequested(token: EventRegistrationToken?): Unit {
      val fnPtr = _868339129_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__868339129_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun add_CanExecuteRequested(handler: TypedEventHandler<XamlUICommand?,
        CanExecuteRequestedEventArgs?>?): EventRegistrationToken? {
      val fnPtr = _868339129_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__868339129_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
    ...
    public override fun remove_CanExecuteRequested(token: EventRegistrationToken?): Unit {
      val fnPtr = _868339129_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__868339129_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun NotifyCanExecuteChanged(): Unit {
      val fnPtr = _868339129_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__868339129_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IXamlUICommand_Impl(
    ...
    public override val __868339129_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IXamlUICommand, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("8494f8d4ead15f01ad2ea8cad4f9dc0e")
    ...
    public override fun toNative(obj: IXamlUICommand): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__868339129_Ptr))
  }
