...
@Signature("rc(Windows.UI.Xaml.Input.AccessKeyDisplayDismissedEventArgs;{8a610dc6-d72d-4ca8-9f66-556f35b513da})")
...
public class AccessKeyDisplayDismissedEventArgs(
  ...
  private val __93365131_Interface: IAccessKeyDisplayDismissedEventArgs.WithDefault by lazy {
    as_93365131()
  }


  public override val __93365131_Ptr: JNAPointer? by lazy {
    __93365131_Interface.__93365131_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__93365131_Interface)

  public constructor() : this(ABI.activate())

  private fun as_93365131(): IAccessKeyDisplayDismissedEventArgs.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<AccessKeyDisplayDismissedEventArgs, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Input.AccessKeyDisplayDismissedEventArgs".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
