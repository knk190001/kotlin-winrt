...
@Signature("{18d636b7-53a4-4c15-a498-f3a9ca212a42}")
@Guid("18d636b753a44c15a498f3a9ca212a42")
@WinRTInterface("18d636b753a44c15a498f3a9ca212a42")
...
public interface IManipulationStartingRoutedEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IManipulationStartingRoutedEventArgs {
    public val __559326647_Ptr: Pointer?

    public val _559326647_VtblPtr: Pointer?
      get() = __559326647_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Mode(): ManipulationModes? {
      val fnPtr = _559326647_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ManipulationModes>()
      val hr = fn.invokeHR(arrayOf(__559326647_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Mode(value: ManipulationModes?): Unit {
      val fnPtr = _559326647_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__559326647_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Container(): UIElement? {
      val fnPtr = _559326647_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Container(value: UIElement?): Unit {
      val fnPtr = _559326647_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__559326647_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Pivot(): ManipulationPivot? {
      val fnPtr = _559326647_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Pivot(value: ManipulationPivot?): Unit {
      val fnPtr = _559326647_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__559326647_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Handled(): Boolean {
      val fnPtr = _559326647_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Handled(value: Boolean): Unit {
      val fnPtr = _559326647_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__559326647_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IManipulationStartingRoutedEventArgs_Impl(
    ...
    public override val __559326647_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IManipulationStartingRoutedEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("18d636b753a44c15a498f3a9ca212a42")
    ...
    public override fun toNative(obj: IManipulationStartingRoutedEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__559326647_Ptr))
  }
