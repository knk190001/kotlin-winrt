...
@Signature("rc(Windows.UI.Xaml.Input.InputScope;{5c0f85f3-f9d8-4220-b666-045d074d9bfa})")
...
public class InputScope(
  ...
  private val __2124261376_Interface: IInputScope.WithDefault by lazy {
    as_2124261376()
  }


  public override val __2124261376_Ptr: JNAPointer? by lazy {
    __2124261376_Interface.__2124261376_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__2124261376_Interface)

  public constructor() : this(ABI.activate())

  private fun as_2124261376(): IInputScope.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<InputScope, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr = INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Input.InputScope".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
