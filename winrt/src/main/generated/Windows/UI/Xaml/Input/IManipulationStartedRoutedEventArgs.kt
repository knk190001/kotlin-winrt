...
@Signature("{5db1aa05-9f80-48b6-ae6c-4f119de8ff13}")
@Guid("5db1aa059f8048b6ae6c4f119de8ff13")
@WinRTInterface("5db1aa059f8048b6ae6c4f119de8ff13")
...
public interface IManipulationStartedRoutedEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IManipulationStartedRoutedEventArgs {
    public val __1324380114_Ptr: Pointer?

    public val _1324380114_VtblPtr: Pointer?
      get() = __1324380114_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Container(): UIElement? {
      val fnPtr = _1324380114_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<UIElement>()
      val hr = fn.invokeHR(arrayOf(__1324380114_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Position(): Point? {
      val fnPtr = _1324380114_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_Handled(): Boolean {
      val fnPtr = _1324380114_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Handled(value: Boolean): Unit {
      val fnPtr = _1324380114_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1324380114_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_PointerDeviceType(): PointerDeviceType? {
      val fnPtr = _1324380114_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_Cumulative(): ManipulationDelta? {
      val fnPtr = _1324380114_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun Complete(): Unit {
      val fnPtr = _1324380114_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1324380114_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IManipulationStartedRoutedEventArgs_Impl(
    ...
    public override val __1324380114_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IManipulationStartedRoutedEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("5db1aa059f8048b6ae6c4f119de8ff13")
    ...
    public override fun toNative(obj: IManipulationStartedRoutedEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1324380114_Ptr))
  }
