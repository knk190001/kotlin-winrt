...
@Signature("{4a40bb52-4bd7-4e54-8617-1cda8a1eda7f}")
@Guid("4a40bb524bd74e5486171cda8a1eda7f")
@WinRTInterface("4a40bb524bd74e5486171cda8a1eda7f")
...
public interface IInputScopeNameFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IInputScopeNameFactory {
    public val __1792457695_Ptr: Pointer?

    public val _1792457695_VtblPtr: Pointer?
      get() = __1792457695_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(nameValue: InputScopeNameValue?): InputScopeName? {
      val fnPtr = _1792457695_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<InputScopeName>()
      val hr = fn.invokeHR(arrayOf(__1792457695_Ptr, marshalToNative(nameValue), result))
      if (hr.toInt() != 0) {
  ...
  public class IInputScopeNameFactory_Impl(
    ...
    public override val __1792457695_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IInputScopeNameFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("4a40bb524bd74e5486171cda8a1eda7f")
    ...
    public override fun toNative(obj: IInputScopeNameFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1792457695_Ptr))
  }
