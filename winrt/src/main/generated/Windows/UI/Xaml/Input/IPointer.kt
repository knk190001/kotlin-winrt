...
@Signature("{5ee8f39f-747d-4171-90e6-cd37a9dffb11}")
@Guid("5ee8f39f747d417190e6cd37a9dffb11")
@WinRTInterface("5ee8f39f747d417190e6cd37a9dffb11")
...
public interface IPointer : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPointer {
    public val __822991527_Ptr: Pointer?

    public val _822991527_VtblPtr: Pointer?
      get() = __822991527_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_PointerId(): WinDef.UINT {
      val fnPtr = _822991527_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<WinDef.UINT>()
      val hr = fn.invokeHR(arrayOf(__822991527_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_PointerDeviceType(): PointerDeviceType? {
      val fnPtr = _822991527_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_IsInContact(): Boolean {
      val fnPtr = _822991527_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_IsInRange(): Boolean {
      val fnPtr = _822991527_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__822991527_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IPointer_Impl(
    ...
    public override val __822991527_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPointer, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("5ee8f39f747d417190e6cd37a9dffb11")
    ...
    public override fun toNative(obj: IPointer): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__822991527_Ptr))
  }
