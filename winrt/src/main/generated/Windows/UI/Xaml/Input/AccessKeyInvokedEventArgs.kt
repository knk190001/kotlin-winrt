...
@Signature("rc(Windows.UI.Xaml.Input.AccessKeyInvokedEventArgs;{cfe9cd97-c718-4091-b7dd-adf1c072b1e1})")
...
public class AccessKeyInvokedEventArgs(
  ...
  private val __1794065264_Interface: IAccessKeyInvokedEventArgs.WithDefault by lazy {
    as_1794065264()
  }


  public override val __1794065264_Ptr: JNAPointer? by lazy {
    __1794065264_Interface.__1794065264_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1794065264_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1794065264(): IAccessKeyInvokedEventArgs.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<AccessKeyInvokedEventArgs, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Input.AccessKeyInvokedEventArgs".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
