...
@Signature("{92e6181e-19ae-465a-9b3c-a71ee9ea7420}")
@Guid("92e6181e19ae465a9b3ca71ee9ea7420")
@WinRTInterface("92e6181e19ae465a9b3ca71ee9ea7420")
...
public interface IKeyboardAccelerator : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IKeyboardAccelerator {
    public val __1269415278_Ptr: Pointer?

    public val _1269415278_VtblPtr: Pointer?
      get() = __1269415278_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Key(): VirtualKey? {
      val fnPtr = _1269415278_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<VirtualKey>()
      val hr = fn.invokeHR(arrayOf(__1269415278_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Key(value: VirtualKey?): Unit {
      val fnPtr = _1269415278_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1269415278_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Modifiers(): VirtualKeyModifiers? {
      val fnPtr = _1269415278_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Modifiers(value: VirtualKeyModifiers?): Unit {
      val fnPtr = _1269415278_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1269415278_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_IsEnabled(): Boolean {
      val fnPtr = _1269415278_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_IsEnabled(value: Boolean): Unit {
      val fnPtr = _1269415278_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1269415278_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_ScopeOwner(): DependencyObject? {
      val fnPtr = _1269415278_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_ScopeOwner(value: DependencyObject?): Unit {
      val fnPtr = _1269415278_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1269415278_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun add_Invoked(handler: TypedEventHandler<KeyboardAccelerator?,
        KeyboardAcceleratorInvokedEventArgs?>?): EventRegistrationToken? {
      val fnPtr = _1269415278_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__1269415278_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun remove_Invoked(token: EventRegistrationToken?): Unit {
      val fnPtr = _1269415278_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1269415278_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IKeyboardAccelerator_Impl(
    ...
    public override val __1269415278_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IKeyboardAccelerator, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("92e6181e19ae465a9b3ca71ee9ea7420")
    ...
    public override fun toNative(obj: IKeyboardAccelerator): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1269415278_Ptr))
  }
