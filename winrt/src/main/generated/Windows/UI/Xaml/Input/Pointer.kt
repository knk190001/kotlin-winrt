...
@Signature("rc(Windows.UI.Xaml.Input.Pointer;{5ee8f39f-747d-4171-90e6-cd37a9dffb11})")
@WinRTByReference(brClass = Pointer.ByReference::class)
public class Pointer(
  ptr: JNAPointer? = NULL
) : PointerType(ptr), IPointer.WithDefault, IWinRTObject {
  private val __822991527_Interface: IPointer.WithDefault by lazy {
    as_822991527()
  }


  public override val __822991527_Ptr: JNAPointer? by lazy {
    __822991527_Interface.__822991527_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__822991527_Interface)

  private fun as_822991527(): IPointer.WithDefault {
    if(pointer == NULL) {
