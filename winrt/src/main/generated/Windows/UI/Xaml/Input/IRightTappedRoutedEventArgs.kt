...
@Signature("{6834869d-7bd5-4033-b237-172f79abe393}")
@Guid("6834869d7bd54033b237172f79abe393")
@WinRTInterface("6834869d7bd54033b237172f79abe393")
...
public interface IRightTappedRoutedEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IRightTappedRoutedEventArgs {
    public val __1093445622_Ptr: Pointer?

    public val _1093445622_VtblPtr: Pointer?
      get() = __1093445622_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_PointerDeviceType(): PointerDeviceType? {
      val fnPtr = _1093445622_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<PointerDeviceType>()
      val hr = fn.invokeHR(arrayOf(__1093445622_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Handled(): Boolean {
      val fnPtr = _1093445622_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Handled(value: Boolean): Unit {
      val fnPtr = _1093445622_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1093445622_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun GetPosition(relativeTo: UIElement?): Point? {
      val fnPtr = _1093445622_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Point>()
      val hr = fn.invokeHR(arrayOf(__1093445622_Ptr, marshalToNative(relativeTo), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
  ...
  public class IRightTappedRoutedEventArgs_Impl(
    ...
    public override val __1093445622_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IRightTappedRoutedEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("6834869d7bd54033b237172f79abe393")
    ...
    public override fun toNative(obj: IRightTappedRoutedEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1093445622_Ptr))
  }
