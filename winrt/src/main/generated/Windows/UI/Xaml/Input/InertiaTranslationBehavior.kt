...
@Signature("rc(Windows.UI.Xaml.Input.InertiaTranslationBehavior;{45d3a512-3b32-4882-a4c2-ecfa2d4b6df0})")
...
public class InertiaTranslationBehavior(
  ...
  private val __1956938145_Interface: IInertiaTranslationBehavior.WithDefault by lazy {
    as_1956938145()
  }


  public override val __1956938145_Ptr: JNAPointer? by lazy {
    __1956938145_Interface.__1956938145_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1956938145_Interface)

  private fun as_1956938145(): IInertiaTranslationBehavior.WithDefault {
    if(pointer == NULL) {
