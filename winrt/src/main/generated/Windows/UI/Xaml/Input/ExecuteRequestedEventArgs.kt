...
@Signature("rc(Windows.UI.Xaml.Input.ExecuteRequestedEventArgs;{e07fa734-a0b6-5755-9e87-24f54cca9372})")
...
public class ExecuteRequestedEventArgs(
  ...
  private val __1653380360_Interface: IExecuteRequestedEventArgs.WithDefault by lazy {
    as_1653380360()
  }


  public override val __1653380360_Ptr: JNAPointer? by lazy {
    __1653380360_Interface.__1653380360_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1653380360_Interface)

  private fun as_1653380360(): IExecuteRequestedEventArgs.WithDefault {
    if(pointer == NULL) {
