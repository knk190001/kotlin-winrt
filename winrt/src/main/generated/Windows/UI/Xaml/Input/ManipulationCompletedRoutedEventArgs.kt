...
@Signature("rc(Windows.UI.Xaml.Input.ManipulationCompletedRoutedEventArgs;{b5ad9b23-2f41-498e-8319-015ee8a75346})")
...
public class ManipulationCompletedRoutedEventArgs(
  ...
  private val __252331108_Interface: IManipulationCompletedRoutedEventArgs.WithDefault by lazy {
    as_252331108()
  }


  public override val __252331108_Ptr: JNAPointer? by lazy {
    __252331108_Interface.__252331108_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__252331108_Interface)

  public constructor() : this(ABI.activate())

  private fun as_252331108(): IManipulationCompletedRoutedEventArgs.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<ManipulationCompletedRoutedEventArgs, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Input.ManipulationCompletedRoutedEventArgs".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
