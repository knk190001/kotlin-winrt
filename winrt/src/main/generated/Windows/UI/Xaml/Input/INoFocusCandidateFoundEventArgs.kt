...
@Signature("{ec3601a7-1007-48f9-b6b3-ed0bea53937d}")
@Guid("ec3601a7100748f9b6b3ed0bea53937d")
@WinRTInterface("ec3601a7100748f9b6b3ed0bea53937d")
...
public interface INoFocusCandidateFoundEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : INoFocusCandidateFoundEventArgs {
    public val __1281177687_Ptr: Pointer?

    public val _1281177687_VtblPtr: Pointer?
      get() = __1281177687_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Direction(): FocusNavigationDirection? {
      val fnPtr = _1281177687_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<FocusNavigationDirection>()
      val hr = fn.invokeHR(arrayOf(__1281177687_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Handled(): Boolean {
      val fnPtr = _1281177687_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Handled(value: Boolean): Unit {
      val fnPtr = _1281177687_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1281177687_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_InputDevice(): FocusInputDeviceKind? {
      val fnPtr = _1281177687_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class INoFocusCandidateFoundEventArgs_Impl(
    ...
    public override val __1281177687_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<INoFocusCandidateFoundEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("ec3601a7100748f9b6b3ed0bea53937d")
    ...
    public override fun toNative(obj: INoFocusCandidateFoundEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1281177687_Ptr))
  }
