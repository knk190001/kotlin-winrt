...
@Signature("{44d88a99-4bfd-4a47-a893-515f388623f6}")
@Guid("44d88a994bfd4a47a893515f388623f6")
@WinRTInterface("44d88a994bfd4a47a893515f388623f6")
...
public interface IKeyboardAcceleratorFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IKeyboardAcceleratorFactory {
    public val __147016772_Ptr: Pointer?

    public val _147016772_VtblPtr: Pointer?
      get() = __147016772_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        KeyboardAccelerator? {
      val fnPtr = _147016772_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<KeyboardAccelerator>()
      val hr = fn.invokeHR(arrayOf(__147016772_Ptr, marshalToNative(baseInterface),
  ...
  public class IKeyboardAcceleratorFactory_Impl(
    ...
    public override val __147016772_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IKeyboardAcceleratorFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("44d88a994bfd4a47a893515f388623f6")
    ...
    public override fun toNative(obj: IKeyboardAcceleratorFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__147016772_Ptr))
  }
