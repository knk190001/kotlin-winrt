...
@Signature("rc(Windows.UI.Xaml.XamlRoot;{34b50756-1696-5b6d-8e9b-c71464ccad5a})")
@WinRTByReference(brClass = XamlRoot.ByReference::class)
public class XamlRoot(
  ptr: JNAPointer? = NULL
) : PointerType(ptr), IXamlRoot.WithDefault, IWinRTObject {
  private val __531371108_Interface: IXamlRoot.WithDefault by lazy {
    as_531371108()
  }


  public override val __531371108_Ptr: JNAPointer? by lazy {
    __531371108_Interface.__531371108_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__531371108_Interface)

  private fun as_531371108(): IXamlRoot.WithDefault {
    if(pointer == NULL) {
