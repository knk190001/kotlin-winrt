...
@Signature("rc(Windows.UI.Xaml.DragOperationDeferral;{ba73ecba-1b73-4086-b3d3-c223beea1633})")
...
public class DragOperationDeferral(
  ...
  private val __128928780_Interface: IDragOperationDeferral.WithDefault by lazy {
    as_128928780()
  }


  public override val __128928780_Ptr: JNAPointer? by lazy {
    __128928780_Interface.__128928780_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__128928780_Interface)

  private fun as_128928780(): IDragOperationDeferral.WithDefault {
    if(pointer == NULL) {
