...
@Signature("{a36824e3-3d81-4ce5-aa51-8b410f602fcd}")
@Guid("a36824e33d814ce5aa518b410f602fcd")
@WinRTInterface("a36824e33d814ce5aa518b410f602fcd")
...
public interface IStyleFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IStyleFactory {
    public val __181867157_Ptr: Pointer?

    public val _181867157_VtblPtr: Pointer?
      get() = __181867157_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(targetType: TypeName?): Style? {
      val fnPtr = _181867157_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Style>()
      val hr = fn.invokeHR(arrayOf(__181867157_Ptr, marshalToNative(targetType), result))
      if (hr.toInt() != 0) {
  ...
  public class IStyleFactory_Impl(
    ...
    public override val __181867157_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IStyleFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("a36824e33d814ce5aa518b410f602fcd")
    ...
    public override fun toNative(obj: IStyleFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__181867157_Ptr))
  }
