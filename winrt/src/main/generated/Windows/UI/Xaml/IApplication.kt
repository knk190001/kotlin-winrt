...
@Signature("{74b861a1-7487-46a9-9a6e-c78b512726c5}")
@Guid("74b861a1748746a99a6ec78b512726c5")
@WinRTInterface("74b861a1748746a99a6ec78b512726c5")
...
public interface IApplication : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IApplication {
    public val __1645774914_Ptr: Pointer?

    public val _1645774914_VtblPtr: Pointer?
      get() = __1645774914_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Resources(): ResourceDictionary? {
      val fnPtr = _1645774914_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ResourceDictionary>()
      val hr = fn.invokeHR(arrayOf(__1645774914_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Resources(value: ResourceDictionary?): Unit {
      val fnPtr = _1645774914_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1645774914_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_DebugSettings(): DebugSettings? {
      val fnPtr = _1645774914_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_RequestedTheme(): ApplicationTheme? {
      val fnPtr = _1645774914_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_RequestedTheme(value: ApplicationTheme?): Unit {
      val fnPtr = _1645774914_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1645774914_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun add_UnhandledException(handler: UnhandledExceptionEventHandler?):
        EventRegistrationToken? {
      val fnPtr = _1645774914_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__1645774914_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun remove_UnhandledException(token: EventRegistrationToken?): Unit {
      val fnPtr = _1645774914_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1645774914_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun add_Suspending(handler: SuspendingEventHandler?): EventRegistrationToken? {
      val fnPtr = _1645774914_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__1645774914_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
    ...
    public override fun remove_Suspending(token: EventRegistrationToken?): Unit {
      val fnPtr = _1645774914_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1645774914_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun add_Resuming(handler: EventHandler<IUnknown?>?): EventRegistrationToken? {
      val fnPtr = _1645774914_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__1645774914_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
    ...
    public override fun remove_Resuming(token: EventRegistrationToken?): Unit {
      val fnPtr = _1645774914_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1645774914_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun Exit(): Unit {
      val fnPtr = _1645774914_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1645774914_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IApplication_Impl(
    ...
    public override val __1645774914_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IApplication, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("74b861a1748746a99a6ec78b512726c5")
    ...
    public override fun toNative(obj: IApplication): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1645774914_Ptr))
  }
