...
import Windows.UI.Xaml.Media.Animation.EasingFunctionBase
...
@Signature("{55c5905e-2bc7-400d-aaa4-1a2981491ee0}")
@Guid("55c5905e2bc7400daaa41a2981491ee0")
@WinRTInterface("55c5905e2bc7400daaa41a2981491ee0")
...
public interface IVisualTransition : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IVisualTransition {
    public val __1818206983_Ptr: Pointer?

    public val _1818206983_VtblPtr: Pointer?
      get() = __1818206983_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_GeneratedDuration(): Duration? {
      val fnPtr = _1818206983_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Duration>()
      val hr = fn.invokeHR(arrayOf(__1818206983_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_GeneratedDuration(value: Duration?): Unit {
      val fnPtr = _1818206983_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1818206983_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_GeneratedEasingFunction(): EasingFunctionBase? {
      val fnPtr = _1818206983_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_GeneratedEasingFunction(value: EasingFunctionBase?): Unit {
      val fnPtr = _1818206983_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1818206983_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_To(): String? {
      val fnPtr = _1818206983_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_To(value: String?): Unit {
      val fnPtr = _1818206983_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1818206983_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_From(): String? {
      val fnPtr = _1818206983_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__1818206983_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_From(value: String?): Unit {
      val fnPtr = _1818206983_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1818206983_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Storyboard(): Storyboard? {
      val fnPtr = _1818206983_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Storyboard(value: Storyboard?): Unit {
      val fnPtr = _1818206983_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1818206983_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IVisualTransition_Impl(
    ...
    public override val __1818206983_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IVisualTransition, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("55c5905e2bc7400daaa41a2981491ee0")
    ...
    public override fun toNative(obj: IVisualTransition): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1818206983_Ptr))
  }
