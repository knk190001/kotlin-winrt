...
@Signature("{015aca75-76d8-4b7e-8a33-7d79204691ee}")
@Guid("015aca7576d84b7e8a337d79204691ee")
@WinRTInterface("015aca7576d84b7e8a337d79204691ee")
...
public interface IPointHelperStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPointHelperStatics {
    public val __992354905_Ptr: Pointer?

    public val _992354905_VtblPtr: Pointer?
      get() = __992354905_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun FromCoordinates(x: Float, y: Float): Point? {
      val fnPtr = _992354905_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Point>()
      val hr = fn.invokeHR(arrayOf(__992354905_Ptr, x, y, result))
      if (hr.toInt() != 0) {
  ...
  public class IPointHelperStatics_Impl(
    ...
    public override val __992354905_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPointHelperStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("015aca7576d84b7e8a337d79204691ee")
    ...
    public override fun toNative(obj: IPointHelperStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__992354905_Ptr))
  }
