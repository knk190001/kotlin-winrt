...
import Windows.UI.Xaml.IAdaptiveTriggerFactory.ABI.IID
...
@Signature("rc(Windows.UI.Xaml.AdaptiveTrigger;{a5f04119-0cd9-49f1-a23f-44e547ab9f1a})")
...
public open class AdaptiveTrigger(
  ...
  private val __1503302096_Interface: IAdaptiveTrigger.WithDefault by lazy {
    as_1503302096()
  }


  public override val __1503302096_Ptr: JNAPointer? by lazy {
    __1503302096_Interface.__1503302096_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1503302096_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1503302096(): IAdaptiveTrigger.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<AdaptiveTrigger, MemoryAddress> {
    ...
    public fun createIAdaptiveTriggerStatics(): IAdaptiveTriggerStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.AdaptiveTrigger".toHandle(),refiid,interfacePtr)
    ...
    public fun createIAdaptiveTriggerFactory(): IAdaptiveTriggerFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.AdaptiveTrigger".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
