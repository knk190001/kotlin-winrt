...
@Signature("rc(Windows.UI.Xaml.ExceptionRoutedEventArgs;{dd9ff16a-4b62-4a6c-a49d-0671ef6136be})")
...
public open class ExceptionRoutedEventArgs(
  ...
  private val __248718751_Interface: IExceptionRoutedEventArgs.WithDefault by lazy {
    as_248718751()
  }


  public override val __248718751_Ptr: JNAPointer? by lazy {
    __248718751_Interface.__248718751_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__248718751_Interface)

  private fun as_248718751(): IExceptionRoutedEventArgs.WithDefault {
    if(pointer == NULL) {
