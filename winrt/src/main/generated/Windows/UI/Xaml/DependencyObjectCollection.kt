...
import Windows.UI.Xaml.IDependencyObjectCollectionFactory.ABI.IID
...
@Signature("rc(Windows.UI.Xaml.DependencyObjectCollection;pinterface({5917eb53-50b4-4a0d-b309-65862b3f1dbc};rc(Windows.UI.Xaml.DependencyObject;{5c526665-f60e-4912-af59-5fe0680f089d})))")
...
public open class DependencyObjectCollection(
  ...
  public object ABI : IABI<DependencyObjectCollection, MemoryAddress> {
    ...
    public fun createIDependencyObjectCollectionFactory(): IDependencyObjectCollectionFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.DependencyObjectCollection".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
