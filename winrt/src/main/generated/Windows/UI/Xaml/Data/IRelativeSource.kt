...
@Signature("{2397ce84-2822-483a-b499-d0f031e06c6b}")
@Guid("2397ce842822483ab499d0f031e06c6b")
@WinRTInterface("2397ce842822483ab499d0f031e06c6b")
...
public interface IRelativeSource : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IRelativeSource {
    public val __2012163631_Ptr: Pointer?

    public val _2012163631_VtblPtr: Pointer?
      get() = __2012163631_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Mode(): RelativeSourceMode? {
      val fnPtr = _2012163631_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<RelativeSourceMode>()
      val hr = fn.invokeHR(arrayOf(__2012163631_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Mode(value: RelativeSourceMode?): Unit {
      val fnPtr = _2012163631_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2012163631_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IRelativeSource_Impl(
    ...
    public override val __2012163631_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IRelativeSource, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("2397ce842822483ab499d0f031e06c6b")
    ...
    public override fun toNative(obj: IRelativeSource): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2012163631_Ptr))
  }
