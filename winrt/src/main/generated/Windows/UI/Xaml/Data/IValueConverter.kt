...
@Signature("{e6f2fef0-0712-487f-b313-f300b8d79aa1}")
@Guid("e6f2fef00712487fb313f300b8d79aa1")
@WinRTInterface("e6f2fef00712487fb313f300b8d79aa1")
...
public interface IValueConverter : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IValueConverter {
    public val __723693737_Ptr: Pointer?

    public val _723693737_VtblPtr: Pointer?
      get() = __723693737_Ptr?.getPointer(0)
    ...
    public override fun Convert(
      ...
      val fnPtr = _723693737_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IUnknown>()
      val hr = fn.invokeHR(arrayOf(__723693737_Ptr, marshalToNative(value),
    ...
    public override fun ConvertBack(
      ...
      val fnPtr = _723693737_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IUnknown>()
      val hr = fn.invokeHR(arrayOf(__723693737_Ptr, marshalToNative(value),
          marshalToNative(targetType), marshalToNative(parameter), marshalToNative(language),
  ...
  public class IValueConverter_Impl(
    ...
    public override val __723693737_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IValueConverter, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("e6f2fef00712487fb313f300b8d79aa1")
    ...
    public override fun toNative(obj: IValueConverter): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__723693737_Ptr))
  }
