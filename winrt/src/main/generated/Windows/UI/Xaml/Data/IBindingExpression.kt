...
@Signature("{516a19a5-c2fd-4a9e-9fd3-9aa42f995a3c}")
@Guid("516a19a5c2fd4a9e9fd39aa42f995a3c")
@WinRTInterface("516a19a5c2fd4a9e9fd39aa42f995a3c")
...
public interface IBindingExpression : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IBindingExpression {
    public val __2109243861_Ptr: Pointer?

    public val _2109243861_VtblPtr: Pointer?
      get() = __2109243861_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_DataItem(): IUnknown? {
      val fnPtr = _2109243861_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IUnknown>()
      val hr = fn.invokeHR(arrayOf(__2109243861_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ParentBinding(): Binding? {
      val fnPtr = _2109243861_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun UpdateSource(): Unit {
      val fnPtr = _2109243861_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2109243861_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IBindingExpression_Impl(
    ...
    public override val __2109243861_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IBindingExpression, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("516a19a5c2fd4a9e9fd39aa42f995a3c")
    ...
    public override fun toNative(obj: IBindingExpression): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2109243861_Ptr))
  }
