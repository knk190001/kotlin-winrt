...
@Signature("{173a0710-46af-4c0c-818b-21b6ef81bf65}")
@Guid("173a071046af4c0c818b21b6ef81bf65")
@WinRTInterface("173a071046af4c0c818b21b6ef81bf65")
...
public interface ICollectionViewSourceStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICollectionViewSourceStatics {
    public val __1733840479_Ptr: Pointer?

    public val _1733840479_VtblPtr: Pointer?
      get() = __1733840479_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_SourceProperty(): DependencyProperty? {
      val fnPtr = _1733840479_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1733840479_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ViewProperty(): DependencyProperty? {
      val fnPtr = _1733840479_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1733840479_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsSourceGroupedProperty(): DependencyProperty? {
      val fnPtr = _1733840479_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1733840479_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ItemsPathProperty(): DependencyProperty? {
      val fnPtr = _1733840479_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1733840479_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ICollectionViewSourceStatics_Impl(
    ...
    public override val __1733840479_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICollectionViewSourceStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("173a071046af4c0c818b21b6ef81bf65")
    ...
    public override fun toNative(obj: ICollectionViewSourceStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1733840479_Ptr))
  }
