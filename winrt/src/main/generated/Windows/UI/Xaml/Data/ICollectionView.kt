...
@Guid("8be8bfe4dbef44df8126a31a89121ddc")
@WinRTByReference(ICollectionView.ByReference::class)
@TypeHash("__1551632011_Type")
public interface ICollectionView : NativeMapped, IWinRTInterface, IObservableVector<IUnknown?>,
  ...
  public val __1551632011_Ptr: Pointer?

  public val _1551632011_VtblPtr: Pointer?
    get() = __1551632011_Ptr?.getPointer(0)
  ...
  public interface WithDefault : ICollectionView {
    public override fun get_CurrentItem(): IUnknown? {
      val fnPtr = _1551632011_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr)
      val result = makeByReferenceType<IUnknown>()
      val hr = fn.invokeHR(arrayOf(__1551632011_Ptr,result))
      if( hr.toInt() != 0) {
    ...
    public override fun get_CurrentPosition(): Int {
      val fnPtr = _1551632011_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr)
    ...
    public override fun get_IsCurrentAfterLast(): Boolean {
      val fnPtr = _1551632011_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr)
    ...
    public override fun get_IsCurrentBeforeFirst(): Boolean {
      val fnPtr = _1551632011_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1551632011_Ptr,result))
      if( hr.toInt() != 0) {
    ...
    public override fun get_CollectionGroups(): IObservableVector<IUnknown?>? {
      val fnPtr = _1551632011_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr)
    ...
    public override fun get_HasMoreItems(): Boolean {
      val fnPtr = _1551632011_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1551632011_Ptr,result))
      if( hr.toInt() != 0) {
    ...
    public override fun add_CurrentChanged(handler: EventHandler<IUnknown?>?):
      ...
      val fnPtr = _1551632011_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr)
      val result = makeByReferenceType<EventRegistrationToken.ByValue>()
      val hr = fn.invokeHR(arrayOf(__1551632011_Ptr,marshalToNative(handler),result))
      if( hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun remove_CurrentChanged(token: EventRegistrationToken?): Unit {
      val fnPtr = _1551632011_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr)
      val hr = fn.invokeHR(arrayOf(__1551632011_Ptr,marshalToNative(token)))
      if( hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun add_CurrentChanging(handler: CurrentChangingEventHandler?):
        EventRegistrationToken? {
      val fnPtr = _1551632011_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr)
      val result = makeByReferenceType<EventRegistrationToken.ByValue>()
      val hr = fn.invokeHR(arrayOf(__1551632011_Ptr,marshalToNative(handler),result))
      if( hr.toInt() != 0) {
    ...
    public override fun remove_CurrentChanging(token: EventRegistrationToken?): Unit {
      val fnPtr = _1551632011_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr)
      val hr = fn.invokeHR(arrayOf(__1551632011_Ptr,marshalToNative(token)))
      if( hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun MoveCurrentTo(item: IUnknown?): Boolean {
      val fnPtr = _1551632011_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1551632011_Ptr,marshalToNative(item),result))
      if( hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
      val returnType = Boolean::class.createType()
    ...
    public override fun MoveCurrentToPosition(index: Int): Boolean {
      val fnPtr = _1551632011_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1551632011_Ptr,marshalToNative(index),result))
      if( hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
      val returnType = Boolean::class.createType()
    ...
    public override fun MoveCurrentToFirst(): Boolean {
      val fnPtr = _1551632011_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1551632011_Ptr,result))
      if( hr.toInt() != 0) {
    ...
    public override fun MoveCurrentToLast(): Boolean {
      val fnPtr = _1551632011_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1551632011_Ptr,result))
      if( hr.toInt() != 0) {
    ...
    public override fun MoveCurrentToNext(): Boolean {
      val fnPtr = _1551632011_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1551632011_Ptr,result))
      if( hr.toInt() != 0) {
    ...
    public override fun MoveCurrentToPrevious(): Boolean {
      val fnPtr = _1551632011_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1551632011_Ptr,result))
      if( hr.toInt() != 0) {
    ...
    public override fun LoadMoreItemsAsync(count: WinDef.UINT):
      ...
      val fnPtr = _1551632011_VtblPtr!!.getPointer(22L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr)
      ...
      val hr = fn.invokeHR(arrayOf(__1551632011_Ptr,marshalToNative(count),result))
      if( hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
    ...
    public fun setValue(value: ICollectionView): Unit {
      pointer = value.__1551632011_Ptr!!
    }
  }
  ...
  public class ICollectionViewImpl(
    ...
    public override val __1551632011_Ptr: JNAPointer?
      get() = pointer

    public override val _1551632011_VtblPtr: JNAPointer?
    ...
    public override val __1493305514_Ptr: JNAPointer? by lazy { 
      ...
      IUnknownVtbl(_1551632011_VtblPtr).queryInterface(pointer, refiid, result)
      result.value
    }
  ...
  public object ABI : IABI<ICollectionView, MemoryAddress> {
    ...
    public override fun toNative(obj: ICollectionView): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1551632011_Ptr))
  }
}
