...
import Windows.UI.Xaml.Data.ICurrentChangingEventArgsFactory.ABI.IID
...
@Signature("rc(Windows.UI.Xaml.Data.CurrentChangingEventArgs;{f9891e29-51cc-47dd-a5b9-35dc4914af69})")
...
public open class CurrentChangingEventArgs(
  ...
  private val __1829485145_Interface: ICurrentChangingEventArgs.WithDefault by lazy {
    as_1829485145()
  }


  public override val __1829485145_Ptr: JNAPointer? by lazy {
    __1829485145_Interface.__1829485145_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1829485145_Interface)

  public constructor() : this(ABI.activate())

  public constructor(isCancelable: Boolean) : this(ABI.activate(isCancelable))

  private fun as_1829485145(): ICurrentChangingEventArgs.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<CurrentChangingEventArgs, MemoryAddress> {
    ...
    public fun createICurrentChangingEventArgsFactory(): ICurrentChangingEventArgsFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Data.CurrentChangingEventArgs".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
