...
@Signature("{6dcc9c03-e0c7-4eee-8ea9-37e3406eeb1c}")
@Guid("6dcc9c03e0c74eee8ea937e3406eeb1c")
@WinRTInterface("6dcc9c03e0c74eee8ea937e3406eeb1c")
...
public interface IPropertyChangedEventArgsFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPropertyChangedEventArgsFactory {
    public val __901690230_Ptr: Pointer?

    public val _901690230_VtblPtr: Pointer?
      get() = __901690230_Ptr?.getPointer(0)
    ...
    public override fun CreateInstance(
      ...
      val fnPtr = _901690230_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<PropertyChangedEventArgs>()
      val hr = fn.invokeHR(arrayOf(__901690230_Ptr, marshalToNative(name),
  ...
  public class IPropertyChangedEventArgsFactory_Impl(
    ...
    public override val __901690230_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPropertyChangedEventArgsFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("6dcc9c03e0c74eee8ea937e3406eeb1c")
    ...
    public override fun toNative(obj: IPropertyChangedEventArgsFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__901690230_Ptr))
  }
