...
@Signature("{1cb55cd9-db72-40b3-a2b5-24ee6ea5c328}")
@Guid("1cb55cd9db7240b3a2b524ee6ea5c328")
@WinRTInterface("1cb55cd9db7240b3a2b524ee6ea5c328")
...
public interface IBindingExpressionFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IBindingExpressionFactory {
    public val __727874933_Ptr: Pointer?

    public val _727874933_VtblPtr: Pointer?
      get() = __727874933_Ptr?.getPointer(0)
  }

  public class IBindingExpressionFactory_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __727874933_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IBindingExpressionFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("1cb55cd9db7240b3a2b524ee6ea5c328")
    ...
    public override fun toNative(obj: IBindingExpressionFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__727874933_Ptr))
  }
