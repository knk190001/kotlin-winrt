...
@Signature("{7f5ee992-7694-4e6c-a51b-e34bf43de743}")
@Guid("7f5ee99276944e6ca51be34bf43de743")
@WinRTInterface("7f5ee99276944e6ca51be34bf43de743")
...
public interface ISupportIncrementalLoading : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISupportIncrementalLoading {
    public val __646673143_Ptr: Pointer?

    public val _646673143_VtblPtr: Pointer?
      get() = __646673143_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun LoadMoreItemsAsync(count: WinDef.UINT):
        IAsyncOperation<LoadMoreItemsResult?>? {
      val fnPtr = _646673143_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IAsyncOperation<LoadMoreItemsResult?>>()
      val hr = fn.invokeHR(arrayOf(__646673143_Ptr, count, result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_HasMoreItems(): Boolean {
      val fnPtr = _646673143_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__646673143_Ptr,  result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
  ...
  public class ISupportIncrementalLoading_Impl(
    ...
    public override val __646673143_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISupportIncrementalLoading, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("7f5ee99276944e6ca51be34bf43de743")
    ...
    public override fun toNative(obj: ISupportIncrementalLoading): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__646673143_Ptr))
  }
