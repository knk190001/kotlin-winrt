...
@Signature("{f05f5665-71fd-45a2-be13-a081d294a68d}")
@Guid("f05f566571fd45a2be13a081d294a68d")
@WinRTInterface("f05f566571fd45a2be13a081d294a68d")
...
public interface IItemsRangeInfo : NativeMapped, IWinRTInterface, IClosable {
  ...
  public interface WithDefault : IItemsRangeInfo, IClosable.WithDefault {
    public val __2002600915_Ptr: Pointer?

    public val _2002600915_VtblPtr: Pointer?
      get() = __2002600915_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun RangesChanged(visibleRange: ItemIndexRange?,
        trackedItems: IVectorView<ItemIndexRange?>?): Unit {
      val fnPtr = _2002600915_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2002600915_Ptr, marshalToNative(visibleRange),
  ...
  public class IItemsRangeInfo_Impl(
    ...
    public override val __1260617006_Ptr: JNAPointer by lazy {
      ...
      IUnknownVtbl(_2002600915_VtblPtr).queryInterface(pointer,refiid,result)
      result.value
    }


    public override val __2002600915_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IItemsRangeInfo, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("f05f566571fd45a2be13a081d294a68d")
    ...
    public override fun toNative(obj: IItemsRangeInfo): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2002600915_Ptr))
  }
