...
@Signature("{1ee3416d-562b-486e-9ee5-0f0cbcc8048c}")
@Guid("1ee3416d562b486e9ee50f0cbcc8048c")
@WinRTInterface("1ee3416d562b486e9ee50f0cbcc8048c")
...
public interface IMarkupExtension : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IMarkupExtension {
    public val __476673907_Ptr: Pointer?

    public val _476673907_VtblPtr: Pointer?
      get() = __476673907_Ptr?.getPointer(0)
  }

  public class IMarkupExtension_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __476673907_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IMarkupExtension, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("1ee3416d562b486e9ee50f0cbcc8048c")
    ...
    public override fun toNative(obj: IMarkupExtension): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__476673907_Ptr))
  }
