...
@Signature("rc(Windows.UI.Xaml.Markup.XamlMarkupHelper;{d0e6673c-5342-44ef-85a7-ed327a739d9a})")
...
public class XamlMarkupHelper(
  ...
  private val __1373782136_Interface: IXamlMarkupHelper.WithDefault by lazy {
    as_1373782136()
  }


  public override val __1373782136_Ptr: JNAPointer? by lazy {
    __1373782136_Interface.__1373782136_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1373782136_Interface)

  private fun as_1373782136(): IXamlMarkupHelper.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<XamlMarkupHelper, MemoryAddress> {
    ...
    public fun createIXamlMarkupHelperStatics(): IXamlMarkupHelperStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Markup.XamlMarkupHelper".toHandle(),refiid,interfacePtr)
