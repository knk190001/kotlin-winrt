...
@Signature("{65329c05-fb5a-4567-9d55-5cdfbada2739}")
@Guid("65329c05fb5a45679d555cdfbada2739")
@WinRTInterface("65329c05fb5a45679d555cdfbada2739")
...
public interface IMarkupExtensionFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IMarkupExtensionFactory {
    public val __11139005_Ptr: Pointer?

    public val _11139005_VtblPtr: Pointer?
      get() = __11139005_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        MarkupExtension? {
      val fnPtr = _11139005_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<MarkupExtension>()
      val hr = fn.invokeHR(arrayOf(__11139005_Ptr, marshalToNative(baseInterface),
  ...
  public class IMarkupExtensionFactory_Impl(
    ...
    public override val __11139005_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IMarkupExtensionFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("65329c05fb5a45679d555cdfbada2739")
    ...
    public override fun toNative(obj: IMarkupExtensionFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__11139005_Ptr))
  }
