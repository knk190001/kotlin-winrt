...
@Signature("{393779bf-b9c0-4ffb-a57f-58e7356e425f}")
@Guid("393779bfb9c04ffba57f58e7356e425f")
@WinRTInterface("393779bfb9c04ffba57f58e7356e425f")
...
public interface IMarkupExtensionOverrides : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IMarkupExtensionOverrides {
    public val __1602993126_Ptr: Pointer?

    public val _1602993126_VtblPtr: Pointer?
      get() = __1602993126_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun ProvideValue(): IUnknown? {
      val fnPtr = _1602993126_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IUnknown>()
      val hr = fn.invokeHR(arrayOf(__1602993126_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IMarkupExtensionOverrides_Impl(
    ...
    public override val __1602993126_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IMarkupExtensionOverrides, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("393779bfb9c04ffba57f58e7356e425f")
    ...
    public override fun toNative(obj: IMarkupExtensionOverrides): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1602993126_Ptr))
  }
