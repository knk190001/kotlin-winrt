...
@Signature("{a38781e2-4bfb-4ee2-afe5-89f31b37478d}")
@Guid("a38781e24bfb4ee2afe589f31b37478d")
@WinRTInterface("a38781e24bfb4ee2afe589f31b37478d")
...
public interface IRectHelper : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IRectHelper {
    public val __958915204_Ptr: Pointer?

    public val _958915204_VtblPtr: Pointer?
      get() = __958915204_Ptr?.getPointer(0)
  }

  public class IRectHelper_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __958915204_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IRectHelper, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("a38781e24bfb4ee2afe589f31b37478d")
    ...
    public override fun toNative(obj: IRectHelper): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__958915204_Ptr))
  }
