...
@Signature("{a5f04119-0cd9-49f1-a23f-44e547ab9f1a}")
@Guid("a5f041190cd949f1a23f44e547ab9f1a")
@WinRTInterface("a5f041190cd949f1a23f44e547ab9f1a")
...
public interface IAdaptiveTrigger : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IAdaptiveTrigger {
    public val __1503302096_Ptr: Pointer?

    public val _1503302096_VtblPtr: Pointer?
      get() = __1503302096_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_MinWindowWidth(): Double {
      val fnPtr = _1503302096_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1503302096_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_MinWindowWidth(value: Double): Unit {
      val fnPtr = _1503302096_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1503302096_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_MinWindowHeight(): Double {
      val fnPtr = _1503302096_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1503302096_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_MinWindowHeight(value: Double): Unit {
      val fnPtr = _1503302096_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1503302096_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IAdaptiveTrigger_Impl(
    ...
    public override val __1503302096_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IAdaptiveTrigger, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("a5f041190cd949f1a23f44e547ab9f1a")
    ...
    public override fun toNative(obj: IAdaptiveTrigger): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1503302096_Ptr))
  }
