...
@Signature("{3d451f98-c6a7-4d17-8398-d83a067183d8}")
@Guid("3d451f98c6a74d178398d83a067183d8")
@WinRTInterface("3d451f98c6a74d178398d83a067183d8")
...
public interface IDebugSettings : NativeMapped, IWinRTInterface {
  ...
  @InterfaceMethod(4)
  public fun get_IsOverdrawHeatMapEnabled(): Boolean

  @InterfaceMethod(5)
  public fun put_IsOverdrawHeatMapEnabled(value: Boolean): Unit
  ...
  public interface WithDefault : IDebugSettings {
    public val __663207292_Ptr: Pointer?

    public val _663207292_VtblPtr: Pointer?
      get() = __663207292_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_EnableFrameRateCounter(): Boolean {
      val fnPtr = _663207292_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__663207292_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_EnableFrameRateCounter(value: Boolean): Unit {
      val fnPtr = _663207292_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__663207292_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_IsBindingTracingEnabled(): Boolean {
      val fnPtr = _663207292_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__663207292_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_IsBindingTracingEnabled(value: Boolean): Unit {
      val fnPtr = _663207292_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__663207292_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    @InterfaceMethod(4)
    public override fun get_IsOverdrawHeatMapEnabled(): Boolean {
      val fnPtr = _663207292_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__663207292_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    @InterfaceMethod(5)
    public override fun put_IsOverdrawHeatMapEnabled(value: Boolean): Unit {
      val fnPtr = _663207292_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__663207292_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun add_BindingFailed(handler: BindingFailedEventHandler?):
      ...
      val fnPtr = _663207292_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__663207292_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun remove_BindingFailed(token: EventRegistrationToken?): Unit {
      val fnPtr = _663207292_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__663207292_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IDebugSettings_Impl(
    ...
    public override val __663207292_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IDebugSettings, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("3d451f98c6a74d178398d83a067183d8")
    ...
    public override fun toNative(obj: IDebugSettings): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__663207292_Ptr))
  }
