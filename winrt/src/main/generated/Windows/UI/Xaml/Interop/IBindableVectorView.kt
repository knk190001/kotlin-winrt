...
public interface IBindableVectorView : NativeMapped, IWinRTInterface, IBindableIterable {
  ...
  public interface WithDefault : IBindableVectorView, IBindableIterable.WithDefault {
    public val __128838082_Ptr: Pointer?

    public val _128838082_VtblPtr: Pointer?
      get() = __128838082_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun GetAt(index: WinDef.UINT): IUnknown? {
      val fnPtr = _128838082_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IUnknown>()
      val hr = fn.invokeHR(arrayOf(__128838082_Ptr, index, result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Size(): WinDef.UINT {
      val fnPtr = _128838082_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<WinDef.UINT>()
      val hr = fn.invokeHR(arrayOf(__128838082_Ptr,  result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun IndexOf(value: IUnknown?, index: WinDef.UINT): Boolean {
      val fnPtr = _128838082_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__128838082_Ptr, marshalToNative(value), index, result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
  ...
  public class IBindableVectorView_Impl(
    ...
    public override val __2130116140_Ptr: JNAPointer by lazy {
      ...
      IUnknownVtbl(_128838082_VtblPtr).queryInterface(pointer,refiid,result)
      result.value
    }


    public override val __128838082_Ptr: Pointer?
      get() = pointer
  }
  ...
  public object ABI : IABI<IBindableVectorView, MemoryAddress> {
    ...
    public override fun toNative(obj: IBindableVectorView): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__128838082_Ptr))
  }
