...
import Windows.UI.Xaml.Interop.IBindableVector.ABI.IID
...
public interface IBindableObservableVector : NativeMapped, IWinRTInterface, IBindableVector,
  ...
  public interface WithDefault : IBindableObservableVector, IBindableVector.WithDefault,
    ...
    public val __212114400_Ptr: Pointer?

    public val _212114400_VtblPtr: Pointer?
      get() = __212114400_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun add_VectorChanged(handler: BindableVectorChangedEventHandler?):
        EventRegistrationToken? {
      val fnPtr = _212114400_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__212114400_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
    ...
    public override fun remove_VectorChanged(token: EventRegistrationToken?): Unit {
      val fnPtr = _212114400_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__212114400_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IBindableObservableVector_Impl(
    ptr: Pointer? = NULL
      ...
      IBindableIterable {
    public override val __1565769347_Ptr: JNAPointer by lazy {
      val refiid = com.sun.jna.platform.win32.Guid.REFIID(IID)
      val result = PointerByReference()
      IUnknownVtbl(_212114400_VtblPtr).queryInterface(pointer,refiid,result)
      result.value
    }
    ...
    public override val __212114400_Ptr: Pointer?
      get() = pointer
  }
  ...
  public object ABI : IABI<IBindableObservableVector, MemoryAddress> {
    ...
    public override fun toNative(obj: IBindableObservableVector): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__212114400_Ptr))
  }
