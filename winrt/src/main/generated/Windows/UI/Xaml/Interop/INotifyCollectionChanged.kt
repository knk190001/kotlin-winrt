...
@Signature("{28b167d5-1a31-465b-9b25-d5c3ae686c40}")
@Guid("28b167d51a31465b9b25d5c3ae686c40")
@WinRTInterface("28b167d51a31465b9b25d5c3ae686c40")
...
public interface INotifyCollectionChanged : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : INotifyCollectionChanged {
    public val __1622896886_Ptr: Pointer?

    public val _1622896886_VtblPtr: Pointer?
      get() = __1622896886_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun add_CollectionChanged(handler: NotifyCollectionChangedEventHandler?):
        EventRegistrationToken? {
      val fnPtr = _1622896886_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__1622896886_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
    ...
    public override fun remove_CollectionChanged(token: EventRegistrationToken?): Unit {
      val fnPtr = _1622896886_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1622896886_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class INotifyCollectionChanged_Impl(
    ...
    public override val __1622896886_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<INotifyCollectionChanged, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("28b167d51a31465b9b25d5c3ae686c40")
    ...
    public override fun toNative(obj: INotifyCollectionChanged): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1622896886_Ptr))
  }
