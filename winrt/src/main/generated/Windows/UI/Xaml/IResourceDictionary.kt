...
@Signature("{c1ea4f24-d6de-4191-8e3a-f48601f7489c}")
@Guid("c1ea4f24d6de41918e3af48601f7489c")
@WinRTInterface("c1ea4f24d6de41918e3af48601f7489c")
...
public interface IResourceDictionary : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IResourceDictionary {
    public val __1495700202_Ptr: Pointer?

    public val _1495700202_VtblPtr: Pointer?
      get() = __1495700202_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Source(): Uri? {
      val fnPtr = _1495700202_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Uri>()
      val hr = fn.invokeHR(arrayOf(__1495700202_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Source(value: Uri?): Unit {
      val fnPtr = _1495700202_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1495700202_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_MergedDictionaries(): IVector<ResourceDictionary?>? {
      val fnPtr = _1495700202_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_ThemeDictionaries(): IMap<IUnknown?, IUnknown?>? {
      val fnPtr = _1495700202_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class IResourceDictionary_Impl(
    ...
    public override val __1495700202_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IResourceDictionary, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("c1ea4f24d6de41918e3af48601f7489c")
    ...
    public override fun toNative(obj: IResourceDictionary): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1495700202_Ptr))
  }
