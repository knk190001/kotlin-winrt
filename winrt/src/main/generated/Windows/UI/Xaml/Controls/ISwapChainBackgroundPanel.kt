...
@Signature("{1c59db48-8233-4c0c-bcf5-02a5fb35ae00}")
@Guid("1c59db4882334c0cbcf502a5fb35ae00")
@WinRTInterface("1c59db4882334c0cbcf502a5fb35ae00")
...
public interface ISwapChainBackgroundPanel : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISwapChainBackgroundPanel {
    public val __301579972_Ptr: Pointer?

    public val _301579972_VtblPtr: Pointer?
      get() = __301579972_Ptr?.getPointer(0)
  }

  public class ISwapChainBackgroundPanel_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __301579972_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISwapChainBackgroundPanel, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("1c59db4882334c0cbcf502a5fb35ae00")
    ...
    public override fun toNative(obj: ISwapChainBackgroundPanel): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__301579972_Ptr))
  }
