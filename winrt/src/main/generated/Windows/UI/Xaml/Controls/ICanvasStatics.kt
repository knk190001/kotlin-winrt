...
@Signature("{40ce5c46-2962-446f-aafb-4cdc486939c9}")
@Guid("40ce5c462962446faafb4cdc486939c9")
@WinRTInterface("40ce5c462962446faafb4cdc486939c9")
...
public interface ICanvasStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICanvasStatics {
    public val __1498226865_Ptr: Pointer?

    public val _1498226865_VtblPtr: Pointer?
      get() = __1498226865_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_LeftProperty(): DependencyProperty? {
      val fnPtr = _1498226865_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1498226865_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetLeft(element: UIElement?): Double {
      val fnPtr = _1498226865_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1498226865_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun SetLeft(element: UIElement?, length: Double): Unit {
      val fnPtr = _1498226865_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1498226865_Ptr, marshalToNative(element), length,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_TopProperty(): DependencyProperty? {
      val fnPtr = _1498226865_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1498226865_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetTop(element: UIElement?): Double {
      val fnPtr = _1498226865_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1498226865_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
    ...
    public override fun SetTop(element: UIElement?, length: Double): Unit {
      val fnPtr = _1498226865_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1498226865_Ptr, marshalToNative(element), length,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ZIndexProperty(): DependencyProperty? {
      val fnPtr = _1498226865_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1498226865_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetZIndex(element: UIElement?): Int {
      val fnPtr = _1498226865_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun SetZIndex(element: UIElement?, value: Int): Unit {
      val fnPtr = _1498226865_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1498226865_Ptr, marshalToNative(element), value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class ICanvasStatics_Impl(
    ...
    public override val __1498226865_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICanvasStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("40ce5c462962446faafb4cdc486939c9")
    ...
    public override fun toNative(obj: ICanvasStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1498226865_Ptr))
  }
