...
@Signature("{fe9db859-8127-4aef-b7a2-949847486e96}")
@Guid("fe9db85981274aefb7a2949847486e96")
@WinRTInterface("fe9db85981274aefb7a2949847486e96")
...
public interface IVariableSizedWrapGridStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IVariableSizedWrapGridStatics {
    public val __1513620138_Ptr: Pointer?

    public val _1513620138_VtblPtr: Pointer?
      get() = __1513620138_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ItemHeightProperty(): DependencyProperty? {
      val fnPtr = _1513620138_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1513620138_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ItemWidthProperty(): DependencyProperty? {
      val fnPtr = _1513620138_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1513620138_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_OrientationProperty(): DependencyProperty? {
      val fnPtr = _1513620138_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1513620138_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_HorizontalChildrenAlignmentProperty(): DependencyProperty? {
      val fnPtr = _1513620138_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1513620138_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_VerticalChildrenAlignmentProperty(): DependencyProperty? {
      val fnPtr = _1513620138_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1513620138_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_MaximumRowsOrColumnsProperty(): DependencyProperty? {
      val fnPtr = _1513620138_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1513620138_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_RowSpanProperty(): DependencyProperty? {
      val fnPtr = _1513620138_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1513620138_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetRowSpan(element: UIElement?): Int {
      val fnPtr = _1513620138_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__1513620138_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun SetRowSpan(element: UIElement?, value: Int): Unit {
      val fnPtr = _1513620138_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1513620138_Ptr, marshalToNative(element), value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_ColumnSpanProperty(): DependencyProperty? {
      val fnPtr = _1513620138_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1513620138_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetColumnSpan(element: UIElement?): Int {
      val fnPtr = _1513620138_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__1513620138_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
    ...
    public override fun SetColumnSpan(element: UIElement?, value: Int): Unit {
      val fnPtr = _1513620138_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1513620138_Ptr, marshalToNative(element), value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IVariableSizedWrapGridStatics_Impl(
    ...
    public override val __1513620138_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IVariableSizedWrapGridStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("fe9db85981274aefb7a2949847486e96")
    ...
    public override fun toNative(obj: IVariableSizedWrapGridStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1513620138_Ptr))
  }
