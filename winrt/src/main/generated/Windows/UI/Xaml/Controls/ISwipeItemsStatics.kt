...
@Signature("{376250df-48db-43e3-b0e9-089e5da9a114}")
@Guid("376250df48db43e3b0e9089e5da9a114")
@WinRTInterface("376250df48db43e3b0e9089e5da9a114")
...
public interface ISwipeItemsStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISwipeItemsStatics {
    public val __1946098781_Ptr: Pointer?

    public val _1946098781_VtblPtr: Pointer?
      get() = __1946098781_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ModeProperty(): DependencyProperty? {
      val fnPtr = _1946098781_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1946098781_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ISwipeItemsStatics_Impl(
    ...
    public override val __1946098781_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISwipeItemsStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("376250df48db43e3b0e9089e5da9a114")
    ...
    public override fun toNative(obj: ISwipeItemsStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1946098781_Ptr))
  }
