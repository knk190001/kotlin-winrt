...
@Signature("{c8e33dc7-d4ae-4a87-947f-ac4d0bcf5af4}")
@Guid("c8e33dc7d4ae4a87947fac4d0bcf5af4")
@WinRTInterface("c8e33dc7d4ae4a87947fac4d0bcf5af4")
...
public interface IBitmapIconSource : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IBitmapIconSource {
    public val __373593247_Ptr: Pointer?

    public val _373593247_VtblPtr: Pointer?
      get() = __373593247_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_UriSource(): Uri? {
      val fnPtr = _373593247_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Uri>()
      val hr = fn.invokeHR(arrayOf(__373593247_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_UriSource(value: Uri?): Unit {
      val fnPtr = _373593247_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__373593247_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_ShowAsMonochrome(): Boolean {
      val fnPtr = _373593247_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_ShowAsMonochrome(value: Boolean): Unit {
      val fnPtr = _373593247_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__373593247_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IBitmapIconSource_Impl(
    ...
    public override val __373593247_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IBitmapIconSource, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("c8e33dc7d4ae4a87947fac4d0bcf5af4")
    ...
    public override fun toNative(obj: IBitmapIconSource): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__373593247_Ptr))
  }
