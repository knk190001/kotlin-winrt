...
@Signature("rc(Windows.UI.Xaml.Controls.ContextMenuEventArgs;{1f7df263-c14b-4528-b6f0-637999d83cc6})")
...
public class ContextMenuEventArgs(
  ...
  private val __957654181_Interface: IContextMenuEventArgs.WithDefault by lazy {
    as_957654181()
  }


  public override val __957654181_Ptr: JNAPointer? by lazy {
    __957654181_Interface.__957654181_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__957654181_Interface)

  private fun as_957654181(): IContextMenuEventArgs.WithDefault {
    if(pointer == NULL) {
