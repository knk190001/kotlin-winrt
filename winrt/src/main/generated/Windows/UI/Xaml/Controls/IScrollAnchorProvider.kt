...
@Signature("{6ae99a0f-478c-5440-b2c6-ead4378ef8e4}")
@Guid("6ae99a0f478c5440b2c6ead4378ef8e4")
@WinRTInterface("6ae99a0f478c5440b2c6ead4378ef8e4")
...
public interface IScrollAnchorProvider : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IScrollAnchorProvider {
    public val __1380656655_Ptr: Pointer?

    public val _1380656655_VtblPtr: Pointer?
      get() = __1380656655_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_CurrentAnchor(): UIElement? {
      val fnPtr = _1380656655_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<UIElement>()
      val hr = fn.invokeHR(arrayOf(__1380656655_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun RegisterAnchorCandidate(element: UIElement?): Unit {
      val fnPtr = _1380656655_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1380656655_Ptr, marshalToNative(element),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun UnregisterAnchorCandidate(element: UIElement?): Unit {
      val fnPtr = _1380656655_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1380656655_Ptr, marshalToNative(element),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IScrollAnchorProvider_Impl(
    ...
    public override val __1380656655_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IScrollAnchorProvider, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("6ae99a0f478c5440b2c6ead4378ef8e4")
    ...
    public override fun toNative(obj: IScrollAnchorProvider): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1380656655_Ptr))
  }
