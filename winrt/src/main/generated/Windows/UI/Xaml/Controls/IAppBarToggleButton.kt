...
@Signature("{2e914438-fd53-4b8d-858b-3644269f8e4d}")
@Guid("2e914438fd534b8d858b3644269f8e4d")
@WinRTInterface("2e914438fd534b8d858b3644269f8e4d")
...
public interface IAppBarToggleButton : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IAppBarToggleButton {
    public val __1564282860_Ptr: Pointer?

    public val _1564282860_VtblPtr: Pointer?
      get() = __1564282860_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Label(): String? {
      val fnPtr = _1564282860_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__1564282860_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Label(value: String?): Unit {
      val fnPtr = _1564282860_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1564282860_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Icon(): IconElement? {
      val fnPtr = _1564282860_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Icon(value: IconElement?): Unit {
      val fnPtr = _1564282860_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1564282860_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IAppBarToggleButton_Impl(
    ...
    public override val __1564282860_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IAppBarToggleButton, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("2e914438fd534b8d858b3644269f8e4d")
    ...
    public override fun toNative(obj: IAppBarToggleButton): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1564282860_Ptr))
  }
