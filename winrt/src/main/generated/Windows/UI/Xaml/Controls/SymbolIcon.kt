...
@Signature("rc(Windows.UI.Xaml.Controls.SymbolIcon;{7a4774c9-a6a3-4b30-8ff1-9081d70e9a5c})")
...
public class SymbolIcon(
  ...
  private val __1256815795_Interface: ISymbolIcon.WithDefault by lazy {
    as_1256815795()
  }


  public override val __1256815795_Ptr: JNAPointer? by lazy {
    __1256815795_Interface.__1256815795_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1256815795_Interface)

  public constructor() : this(ABI.activate())

  public constructor(symbol: Symbol) : this(ABI.activate(symbol))

  private fun as_1256815795(): ISymbolIcon.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<SymbolIcon, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr = INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.SymbolIcon".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createISymbolIconStatics(): ISymbolIconStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.SymbolIcon".toHandle(),refiid,interfacePtr)
    ...
    public fun createISymbolIconFactory(): ISymbolIconFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.SymbolIcon".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
