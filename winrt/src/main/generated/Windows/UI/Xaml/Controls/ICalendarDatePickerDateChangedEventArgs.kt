...
@Signature("{60d90db2-5010-46ba-842d-a4152c6504e7}")
@Guid("60d90db2501046ba842da4152c6504e7")
@WinRTInterface("60d90db2501046ba842da4152c6504e7")
...
public interface ICalendarDatePickerDateChangedEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICalendarDatePickerDateChangedEventArgs {
    public val __162643961_Ptr: Pointer?

    public val _162643961_VtblPtr: Pointer?
      get() = __162643961_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_NewDate(): IReference<DateTime?>? {
      val fnPtr = _162643961_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IReference<DateTime?>>()
      val hr = fn.invokeHR(arrayOf(__162643961_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_OldDate(): IReference<DateTime?>? {
      val fnPtr = _162643961_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IReference<DateTime?>>()
      val hr = fn.invokeHR(arrayOf(__162643961_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ICalendarDatePickerDateChangedEventArgs_Impl(
    ...
    public override val __162643961_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICalendarDatePickerDateChangedEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("60d90db2501046ba842da4152c6504e7")
    ...
    public override fun toNative(obj: ICalendarDatePickerDateChangedEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__162643961_Ptr))
  }
