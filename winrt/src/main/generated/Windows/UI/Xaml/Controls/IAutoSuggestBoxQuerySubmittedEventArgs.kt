...
@Signature("{78dcb116-818a-4cb5-bca7-382ce6ddc90d}")
@Guid("78dcb116818a4cb5bca7382ce6ddc90d")
@WinRTInterface("78dcb116818a4cb5bca7382ce6ddc90d")
...
public interface IAutoSuggestBoxQuerySubmittedEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IAutoSuggestBoxQuerySubmittedEventArgs {
    public val __1207550830_Ptr: Pointer?

    public val _1207550830_VtblPtr: Pointer?
      get() = __1207550830_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_QueryText(): String? {
      val fnPtr = _1207550830_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__1207550830_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ChosenSuggestion(): IUnknown? {
      val fnPtr = _1207550830_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class IAutoSuggestBoxQuerySubmittedEventArgs_Impl(
    ...
    public override val __1207550830_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IAutoSuggestBoxQuerySubmittedEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("78dcb116818a4cb5bca7382ce6ddc90d")
    ...
    public override fun toNative(obj: IAutoSuggestBoxQuerySubmittedEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1207550830_Ptr))
  }
