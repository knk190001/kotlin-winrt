...
@Signature("{f101773a-084e-4fb9-8442-63221b44533f}")
@Guid("f101773a084e4fb9844263221b44533f")
@WinRTInterface("f101773a084e4fb9844263221b44533f")
...
public interface ISplitViewFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISplitViewFactory {
    public val __202352825_Ptr: Pointer?

    public val _202352825_VtblPtr: Pointer?
      get() = __202352825_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        SplitView? {
      val fnPtr = _202352825_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<SplitView>()
      val hr = fn.invokeHR(arrayOf(__202352825_Ptr, marshalToNative(baseInterface),
  ...
  public class ISplitViewFactory_Impl(
    ...
    public override val __202352825_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISplitViewFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("f101773a084e4fb9844263221b44533f")
    ...
    public override fun toNative(obj: ISplitViewFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__202352825_Ptr))
  }
