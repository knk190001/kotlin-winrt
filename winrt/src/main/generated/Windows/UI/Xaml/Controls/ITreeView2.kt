...
@Signature("{4f33a2e6-2f29-55d3-a1ab-1f4a863bf960}")
@Guid("4f33a2e62f2955d3a1ab1f4a863bf960")
@WinRTInterface("4f33a2e62f2955d3a1ab1f4a863bf960")
...
public interface ITreeView2 : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITreeView2 {
    public val __2052443283_Ptr: Pointer?

    public val _2052443283_VtblPtr: Pointer?
      get() = __2052443283_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun NodeFromContainer(container: DependencyObject?): TreeViewNode? {
      val fnPtr = _2052443283_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<TreeViewNode>()
      val hr = fn.invokeHR(arrayOf(__2052443283_Ptr, marshalToNative(container), result))
      if (hr.toInt() != 0) {
    ...
    public override fun ContainerFromNode(node: TreeViewNode?): DependencyObject? {
      val fnPtr = _2052443283_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyObject>()
      val hr = fn.invokeHR(arrayOf(__2052443283_Ptr, marshalToNative(node), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun ItemFromContainer(container: DependencyObject?): IUnknown? {
      val fnPtr = _2052443283_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun ContainerFromItem(item: IUnknown?): DependencyObject? {
      val fnPtr = _2052443283_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyObject>()
      val hr = fn.invokeHR(arrayOf(__2052443283_Ptr, marshalToNative(item), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
      val resultValue = marshalFromNative<DependencyObject>(result.getValue())
    ...
    public override fun get_CanDragItems(): Boolean {
      val fnPtr = _2052443283_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__2052443283_Ptr,  result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun put_CanDragItems(value: Boolean): Unit {
      val fnPtr = _2052443283_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2052443283_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_CanReorderItems(): Boolean {
      val fnPtr = _2052443283_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__2052443283_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_CanReorderItems(value: Boolean): Unit {
      val fnPtr = _2052443283_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2052443283_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ItemTemplate(): DataTemplate? {
      val fnPtr = _2052443283_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_ItemTemplate(value: DataTemplate?): Unit {
      val fnPtr = _2052443283_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2052443283_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_ItemTemplateSelector(): DataTemplateSelector? {
      val fnPtr = _2052443283_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_ItemTemplateSelector(value: DataTemplateSelector?): Unit {
      val fnPtr = _2052443283_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2052443283_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ItemContainerStyle(): Style? {
      val fnPtr = _2052443283_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_ItemContainerStyle(value: Style?): Unit {
      val fnPtr = _2052443283_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2052443283_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ItemContainerStyleSelector(): StyleSelector? {
      val fnPtr = _2052443283_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_ItemContainerStyleSelector(value: StyleSelector?): Unit {
      val fnPtr = _2052443283_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2052443283_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ItemContainerTransitions(): TransitionCollection? {
      val fnPtr = _2052443283_VtblPtr!!.getPointer(22L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_ItemContainerTransitions(value: TransitionCollection?): Unit {
      val fnPtr = _2052443283_VtblPtr!!.getPointer(23L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2052443283_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ItemsSource(): IUnknown? {
      val fnPtr = _2052443283_VtblPtr!!.getPointer(24L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IUnknown>()
      val hr = fn.invokeHR(arrayOf(__2052443283_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ItemsSource(value: IUnknown?): Unit {
      val fnPtr = _2052443283_VtblPtr!!.getPointer(25L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2052443283_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun add_DragItemsStarting(handler: TypedEventHandler<TreeView?,
        TreeViewDragItemsStartingEventArgs?>?): EventRegistrationToken? {
      val fnPtr = _2052443283_VtblPtr!!.getPointer(26L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__2052443283_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun remove_DragItemsStarting(token: EventRegistrationToken?): Unit {
      val fnPtr = _2052443283_VtblPtr!!.getPointer(27L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2052443283_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun add_DragItemsCompleted(handler: TypedEventHandler<TreeView?,
        TreeViewDragItemsCompletedEventArgs?>?): EventRegistrationToken? {
      val fnPtr = _2052443283_VtblPtr!!.getPointer(28L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__2052443283_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
    ...
    public override fun remove_DragItemsCompleted(token: EventRegistrationToken?): Unit {
      val fnPtr = _2052443283_VtblPtr!!.getPointer(29L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2052443283_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class ITreeView2_Impl(
    ...
    public override val __2052443283_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITreeView2, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("4f33a2e62f2955d3a1ab1f4a863bf960")
    ...
    public override fun toNative(obj: ITreeView2): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2052443283_Ptr))
  }
