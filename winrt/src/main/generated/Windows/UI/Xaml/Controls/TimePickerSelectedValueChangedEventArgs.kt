...
@Signature("rc(Windows.UI.Xaml.Controls.TimePickerSelectedValueChangedEventArgs;{6e20fb35-3b9b-5bb6-9888-266524db181e})")
...
public class TimePickerSelectedValueChangedEventArgs(
  ...
  private val __293831266_Interface: ITimePickerSelectedValueChangedEventArgs.WithDefault by lazy {
    as_293831266()
  }


  public override val __293831266_Ptr: JNAPointer? by lazy {
    __293831266_Interface.__293831266_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__293831266_Interface)

  private fun as_293831266(): ITimePickerSelectedValueChangedEventArgs.WithDefault {
    if(pointer == NULL) {
