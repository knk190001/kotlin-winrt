...
@Signature("{4d117cf1-1fd6-49d7-b483-02ec3de997d6}")
@Guid("4d117cf11fd649d7b48302ec3de997d6")
@WinRTInterface("4d117cf11fd649d7b48302ec3de997d6")
...
public interface IIconSourceFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IIconSourceFactory {
    public val __808172506_Ptr: Pointer?

    public val _808172506_VtblPtr: Pointer?
      get() = __808172506_Ptr?.getPointer(0)
  }

  public class IIconSourceFactory_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __808172506_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IIconSourceFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("4d117cf11fd649d7b48302ec3de997d6")
    ...
    public override fun toNative(obj: IIconSourceFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__808172506_Ptr))
  }
