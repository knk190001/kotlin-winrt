...
import Windows.UI.Xaml.Controls.Primitives.GridViewItemTemplateSettings
...
@Signature("{7d9901f1-e7c1-4e83-b470-c9d6d7bda9f5}")
@Guid("7d9901f1e7c14e83b470c9d6d7bda9f5")
@WinRTInterface("7d9901f1e7c14e83b470c9d6d7bda9f5")
...
public interface IGridViewItem : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IGridViewItem {
    public val __527543002_Ptr: Pointer?

    public val _527543002_VtblPtr: Pointer?
      get() = __527543002_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_TemplateSettings(): GridViewItemTemplateSettings? {
      val fnPtr = _527543002_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<GridViewItemTemplateSettings>()
      val hr = fn.invokeHR(arrayOf(__527543002_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IGridViewItem_Impl(
    ...
    public override val __527543002_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IGridViewItem, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("7d9901f1e7c14e83b470c9d6d7bda9f5")
    ...
    public override fun toNative(obj: IGridViewItem): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__527543002_Ptr))
  }
