...
@Signature("{116982a4-5cf5-4c05-a53f-15e4876c85ec}")
@Guid("116982a45cf54c05a53f15e4876c85ec")
@WinRTInterface("116982a45cf54c05a53f15e4876c85ec")
...
public interface IContentControlStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IContentControlStatics {
    public val __722118117_Ptr: Pointer?

    public val _722118117_VtblPtr: Pointer?
      get() = __722118117_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ContentProperty(): DependencyProperty? {
      val fnPtr = _722118117_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__722118117_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ContentTemplateProperty(): DependencyProperty? {
      val fnPtr = _722118117_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__722118117_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ContentTemplateSelectorProperty(): DependencyProperty? {
      val fnPtr = _722118117_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__722118117_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ContentTransitionsProperty(): DependencyProperty? {
      val fnPtr = _722118117_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__722118117_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IContentControlStatics_Impl(
    ...
    public override val __722118117_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IContentControlStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("116982a45cf54c05a53f15e4876c85ec")
    ...
    public override fun toNative(obj: IContentControlStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__722118117_Ptr))
  }
