...
@Signature("{90384f66-cd3d-5325-8f40-59b076463c40}")
@Guid("90384f66cd3d53258f4059b076463c40")
@WinRTInterface("90384f66cd3d53258f4059b076463c40")
...
public interface ITextCommandBarFlyout : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITextCommandBarFlyout {
    public val __1773944244_Ptr: Pointer?

    public val _1773944244_VtblPtr: Pointer?
      get() = __1773944244_Ptr?.getPointer(0)
  }

  public class ITextCommandBarFlyout_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __1773944244_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITextCommandBarFlyout, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("90384f66cd3d53258f4059b076463c40")
    ...
    public override fun toNative(obj: ITextCommandBarFlyout): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1773944244_Ptr))
  }
