...
@Signature("{5a35c389-85c4-55f4-abb1-97451bc32d71}")
@Guid("5a35c38985c455f4abb197451bc32d71")
@WinRTInterface("5a35c38985c455f4abb197451bc32d71")
...
public interface ITwoPaneViewStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITwoPaneViewStatics {
    public val __2016199160_Ptr: Pointer?

    public val _2016199160_VtblPtr: Pointer?
      get() = __2016199160_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Pane1Property(): DependencyProperty? {
      val fnPtr = _2016199160_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__2016199160_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Pane2Property(): DependencyProperty? {
      val fnPtr = _2016199160_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__2016199160_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Pane1LengthProperty(): DependencyProperty? {
      val fnPtr = _2016199160_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__2016199160_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Pane2LengthProperty(): DependencyProperty? {
      val fnPtr = _2016199160_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__2016199160_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_PanePriorityProperty(): DependencyProperty? {
      val fnPtr = _2016199160_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__2016199160_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ModeProperty(): DependencyProperty? {
      val fnPtr = _2016199160_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__2016199160_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_WideModeConfigurationProperty(): DependencyProperty? {
      val fnPtr = _2016199160_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__2016199160_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_TallModeConfigurationProperty(): DependencyProperty? {
      val fnPtr = _2016199160_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__2016199160_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_MinWideModeWidthProperty(): DependencyProperty? {
      val fnPtr = _2016199160_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__2016199160_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_MinTallModeHeightProperty(): DependencyProperty? {
      val fnPtr = _2016199160_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__2016199160_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ITwoPaneViewStatics_Impl(
    ...
    public override val __2016199160_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITwoPaneViewStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("5a35c38985c455f4abb197451bc32d71")
    ...
    public override fun toNative(obj: ITwoPaneViewStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2016199160_Ptr))
  }
