...
@Signature("{a26dd1dc-cd44-435c-be94-01d6241c231c}")
@Guid("a26dd1dccd44435cbe9401d6241c231c")
@WinRTInterface("a26dd1dccd44435cbe9401d6241c231c")
...
public interface IContentControl : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IContentControl {
    public val __116295232_Ptr: Pointer?

    public val _116295232_VtblPtr: Pointer?
      get() = __116295232_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Content(): IUnknown? {
      val fnPtr = _116295232_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IUnknown>()
      val hr = fn.invokeHR(arrayOf(__116295232_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Content(value: IUnknown?): Unit {
      val fnPtr = _116295232_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__116295232_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_ContentTemplate(): DataTemplate? {
      val fnPtr = _116295232_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_ContentTemplate(value: DataTemplate?): Unit {
      val fnPtr = _116295232_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__116295232_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ContentTemplateSelector(): DataTemplateSelector? {
      val fnPtr = _116295232_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_ContentTemplateSelector(value: DataTemplateSelector?): Unit {
      val fnPtr = _116295232_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__116295232_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ContentTransitions(): TransitionCollection? {
      val fnPtr = _116295232_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_ContentTransitions(value: TransitionCollection?): Unit {
      val fnPtr = _116295232_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__116295232_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IContentControl_Impl(
    ...
    public override val __116295232_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IContentControl, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("a26dd1dccd44435cbe9401d6241c231c")
    ...
    public override fun toNative(obj: IContentControl): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__116295232_Ptr))
  }
