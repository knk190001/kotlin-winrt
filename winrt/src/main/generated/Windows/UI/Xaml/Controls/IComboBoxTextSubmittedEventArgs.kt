...
@Signature("{cb698cbb-6879-558e-af82-df1d08f62afa}")
@Guid("cb698cbb6879558eaf82df1d08f62afa")
@WinRTInterface("cb698cbb6879558eaf82df1d08f62afa")
...
public interface IComboBoxTextSubmittedEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IComboBoxTextSubmittedEventArgs {
    public val __1258288958_Ptr: Pointer?

    public val _1258288958_VtblPtr: Pointer?
      get() = __1258288958_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Text(): String? {
      val fnPtr = _1258288958_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__1258288958_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Handled(): Boolean {
      val fnPtr = _1258288958_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Handled(value: Boolean): Unit {
      val fnPtr = _1258288958_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1258288958_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IComboBoxTextSubmittedEventArgs_Impl(
    ...
    public override val __1258288958_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IComboBoxTextSubmittedEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("cb698cbb6879558eaf82df1d08f62afa")
    ...
    public override fun toNative(obj: IComboBoxTextSubmittedEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1258288958_Ptr))
  }
