...
@Signature("rc(Windows.UI.Xaml.Controls.PickerFlyout;{a336ffdb-08d9-43e6-944e-f2e5c7cee630})")
...
public class PickerFlyout(
  ...
  private val __967495237_Interface: IPickerFlyout.WithDefault by lazy {
    as_967495237()
  }


  public override val __967495237_Ptr: JNAPointer? by lazy {
    __967495237_Interface.__967495237_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__967495237_Interface)

  public constructor() : this(ABI.activate())

  private fun as_967495237(): IPickerFlyout.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<PickerFlyout, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr = INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.PickerFlyout".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIPickerFlyoutStatics(): IPickerFlyoutStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.PickerFlyout".toHandle(),refiid,interfacePtr)
