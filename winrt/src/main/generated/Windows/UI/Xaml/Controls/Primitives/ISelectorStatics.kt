...
@Signature("{13300b06-bd10-4e09-bff7-71efb8bbb42b}")
@Guid("13300b06bd104e09bff771efb8bbb42b")
@WinRTInterface("13300b06bd104e09bff771efb8bbb42b")
...
public interface ISelectorStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISelectorStatics {
    public val __486212470_Ptr: Pointer?

    public val _486212470_VtblPtr: Pointer?
      get() = __486212470_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_SelectedIndexProperty(): DependencyProperty? {
      val fnPtr = _486212470_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__486212470_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_SelectedItemProperty(): DependencyProperty? {
      val fnPtr = _486212470_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__486212470_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_SelectedValueProperty(): DependencyProperty? {
      val fnPtr = _486212470_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__486212470_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_SelectedValuePathProperty(): DependencyProperty? {
      val fnPtr = _486212470_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__486212470_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsSynchronizedWithCurrentItemProperty(): DependencyProperty? {
      val fnPtr = _486212470_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__486212470_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetIsSelectionActive(element: DependencyObject?): Boolean {
      val fnPtr = _486212470_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__486212470_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
  ...
  public class ISelectorStatics_Impl(
    ...
    public override val __486212470_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISelectorStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("13300b06bd104e09bff771efb8bbb42b")
    ...
    public override fun toNative(obj: ISelectorStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__486212470_Ptr))
  }
