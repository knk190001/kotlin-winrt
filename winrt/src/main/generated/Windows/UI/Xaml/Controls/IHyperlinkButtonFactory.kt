...
@Signature("{43521bad-4e97-4da9-a64d-935dfd8cedf2}")
@Guid("43521bad4e974da9a64d935dfd8cedf2")
@WinRTInterface("43521bad4e974da9a64d935dfd8cedf2")
...
public interface IHyperlinkButtonFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IHyperlinkButtonFactory {
    public val __2013614542_Ptr: Pointer?

    public val _2013614542_VtblPtr: Pointer?
      get() = __2013614542_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        HyperlinkButton? {
      val fnPtr = _2013614542_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<HyperlinkButton>()
      val hr = fn.invokeHR(arrayOf(__2013614542_Ptr, marshalToNative(baseInterface),
  ...
  public class IHyperlinkButtonFactory_Impl(
    ...
    public override val __2013614542_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IHyperlinkButtonFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("43521bad4e974da9a64d935dfd8cedf2")
    ...
    public override fun toNative(obj: IHyperlinkButtonFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2013614542_Ptr))
  }
