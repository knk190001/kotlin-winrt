...
@Signature("{46e7a1ef-ae15-44a6-8a04-95b0bf9ab876}")
@Guid("46e7a1efae1544a68a0495b0bf9ab876")
@WinRTInterface("46e7a1efae1544a68a0495b0bf9ab876")
...
public interface IDragDeltaEventArgsFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IDragDeltaEventArgsFactory {
    public val __1203059173_Ptr: Pointer?

    public val _1203059173_VtblPtr: Pointer?
      get() = __1203059173_Ptr?.getPointer(0)
    ...
    public override fun CreateInstanceWithHorizontalChangeAndVerticalChange(
      ...
      val fnPtr = _1203059173_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DragDeltaEventArgs>()
      val hr = fn.invokeHR(arrayOf(__1203059173_Ptr, horizontalChange, verticalChange,
  ...
  public class IDragDeltaEventArgsFactory_Impl(
    ...
    public override val __1203059173_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IDragDeltaEventArgsFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("46e7a1efae1544a68a0495b0bf9ab876")
    ...
    public override fun toNative(obj: IDragDeltaEventArgsFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1203059173_Ptr))
  }
