...
@Signature("{18de66cd-4a6c-4b2e-aa86-cb126c9a2920}")
@Guid("18de66cd4a6c4b2eaa86cb126c9a2920")
@WinRTInterface("18de66cd4a6c4b2eaa86cb126c9a2920")
...
public interface IItemsPresenterStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IItemsPresenterStatics {
    public val __744341825_Ptr: Pointer?

    public val _744341825_VtblPtr: Pointer?
      get() = __744341825_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_HeaderProperty(): DependencyProperty? {
      val fnPtr = _744341825_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__744341825_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_HeaderTemplateProperty(): DependencyProperty? {
      val fnPtr = _744341825_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__744341825_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_HeaderTransitionsProperty(): DependencyProperty? {
      val fnPtr = _744341825_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__744341825_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_PaddingProperty(): DependencyProperty? {
      val fnPtr = _744341825_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__744341825_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IItemsPresenterStatics_Impl(
    ...
    public override val __744341825_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IItemsPresenterStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("18de66cd4a6c4b2eaa86cb126c9a2920")
    ...
    public override fun toNative(obj: IItemsPresenterStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__744341825_Ptr))
  }
