...
@Signature("{63d8248a-8b34-445a-808f-b6ecd62a27d9}")
@Guid("63d8248a8b34445a808fb6ecd62a27d9")
@WinRTInterface("63d8248a8b34445a808fb6ecd62a27d9")
...
public interface IStackPanelFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IStackPanelFactory {
    public val __1385587598_Ptr: Pointer?

    public val _1385587598_VtblPtr: Pointer?
      get() = __1385587598_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        StackPanel? {
      val fnPtr = _1385587598_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<StackPanel>()
      val hr = fn.invokeHR(arrayOf(__1385587598_Ptr, marshalToNative(baseInterface),
  ...
  public class IStackPanelFactory_Impl(
    ...
    public override val __1385587598_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IStackPanelFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("63d8248a8b34445a808fb6ecd62a27d9")
    ...
    public override fun toNative(obj: IStackPanelFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1385587598_Ptr))
  }
