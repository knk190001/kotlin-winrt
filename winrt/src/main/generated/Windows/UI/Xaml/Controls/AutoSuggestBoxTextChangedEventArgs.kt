...
@Signature("rc(Windows.UI.Xaml.Controls.AutoSuggestBoxTextChangedEventArgs;{3a6f7254-1ed5-4bc5-a060-655530bca6ba})")
...
public class AutoSuggestBoxTextChangedEventArgs(
  ...
  private val __266331778_Interface: IAutoSuggestBoxTextChangedEventArgs.WithDefault by lazy {
    as_266331778()
  }


  public override val __266331778_Ptr: JNAPointer? by lazy {
    __266331778_Interface.__266331778_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__266331778_Interface)

  public constructor() : this(ABI.activate())

  private fun as_266331778(): IAutoSuggestBoxTextChangedEventArgs.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<AutoSuggestBoxTextChangedEventArgs, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.AutoSuggestBoxTextChangedEventArgs".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIAutoSuggestBoxTextChangedEventArgsStatics():
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.AutoSuggestBoxTextChangedEventArgs".toHandle(),refiid,interfacePtr)
      val result =
