...
@Signature("{5a105887-e494-4d2b-8528-39472296133f}")
@Guid("5a105887e4944d2b852839472296133f")
@WinRTInterface("5a105887e4944d2b852839472296133f")
...
public interface IBitmapIconSourceStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IBitmapIconSourceStatics {
    public val __1171496410_Ptr: Pointer?

    public val _1171496410_VtblPtr: Pointer?
      get() = __1171496410_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_UriSourceProperty(): DependencyProperty? {
      val fnPtr = _1171496410_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1171496410_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ShowAsMonochromeProperty(): DependencyProperty? {
      val fnPtr = _1171496410_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1171496410_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IBitmapIconSourceStatics_Impl(
    ...
    public override val __1171496410_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IBitmapIconSourceStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("5a105887e4944d2b852839472296133f")
    ...
    public override fun toNative(obj: IBitmapIconSourceStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1171496410_Ptr))
  }
