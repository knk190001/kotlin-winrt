...
@Signature("{1b328bd1-b400-4a8e-943b-5ad2c45be0df}")
@Guid("1b328bd1b4004a8e943b5ad2c45be0df")
@WinRTInterface("1b328bd1b4004a8e943b5ad2c45be0df")
...
public interface ICanvasFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICanvasFactory {
    public val __1991486986_Ptr: Pointer?

    public val _1991486986_VtblPtr: Pointer?
      get() = __1991486986_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        Canvas? {
      val fnPtr = _1991486986_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Canvas>()
      val hr = fn.invokeHR(arrayOf(__1991486986_Ptr, marshalToNative(baseInterface),
  ...
  public class ICanvasFactory_Impl(
    ...
    public override val __1991486986_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICanvasFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("1b328bd1b4004a8e943b5ad2c45be0df")
    ...
    public override fun toNative(obj: ICanvasFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1991486986_Ptr))
  }
