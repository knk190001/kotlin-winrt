...
@Signature("{bed31c25-7db8-51cc-9706-1d79327daf93}")
@Guid("bed31c257db851cc97061d79327daf93")
@WinRTInterface("bed31c257db851cc97061d79327daf93")
...
public interface IMenuBarStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IMenuBarStatics {
    public val __1469058547_Ptr: Pointer?

    public val _1469058547_VtblPtr: Pointer?
      get() = __1469058547_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ItemsProperty(): DependencyProperty? {
      val fnPtr = _1469058547_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1469058547_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IMenuBarStatics_Impl(
    ...
    public override val __1469058547_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IMenuBarStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("bed31c257db851cc97061d79327daf93")
    ...
    public override fun toNative(obj: IMenuBarStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1469058547_Ptr))
  }
