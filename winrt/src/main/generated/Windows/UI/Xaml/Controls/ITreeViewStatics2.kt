...
@Signature("{16b1c8f9-7aa1-5e38-8218-7bba3ea417c0}")
@Guid("16b1c8f97aa15e3882187bba3ea417c0")
@WinRTInterface("16b1c8f97aa15e3882187bba3ea417c0")
...
public interface ITreeViewStatics2 : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITreeViewStatics2 {
    public val __1250759084_Ptr: Pointer?

    public val _1250759084_VtblPtr: Pointer?
      get() = __1250759084_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_CanDragItemsProperty(): DependencyProperty? {
      val fnPtr = _1250759084_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1250759084_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_CanReorderItemsProperty(): DependencyProperty? {
      val fnPtr = _1250759084_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1250759084_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ItemTemplateProperty(): DependencyProperty? {
      val fnPtr = _1250759084_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1250759084_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ItemTemplateSelectorProperty(): DependencyProperty? {
      val fnPtr = _1250759084_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1250759084_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ItemContainerStyleProperty(): DependencyProperty? {
      val fnPtr = _1250759084_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1250759084_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ItemContainerStyleSelectorProperty(): DependencyProperty? {
      val fnPtr = _1250759084_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1250759084_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ItemContainerTransitionsProperty(): DependencyProperty? {
      val fnPtr = _1250759084_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1250759084_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ItemsSourceProperty(): DependencyProperty? {
      val fnPtr = _1250759084_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1250759084_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ITreeViewStatics2_Impl(
    ...
    public override val __1250759084_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITreeViewStatics2, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("16b1c8f97aa15e3882187bba3ea417c0")
    ...
    public override fun toNative(obj: ITreeViewStatics2): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1250759084_Ptr))
  }
