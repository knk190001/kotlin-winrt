...
@Signature("{af1eab12-0128-4f67-9c5a-82320c445d19}")
@Guid("af1eab1201284f679c5a82320c445d19")
@WinRTInterface("af1eab1201284f679c5a82320c445d19")
...
public interface IToggleButtonStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IToggleButtonStatics {
    public val __669515549_Ptr: Pointer?

    public val _669515549_VtblPtr: Pointer?
      get() = __669515549_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_IsCheckedProperty(): DependencyProperty? {
      val fnPtr = _669515549_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__669515549_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsThreeStateProperty(): DependencyProperty? {
      val fnPtr = _669515549_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__669515549_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IToggleButtonStatics_Impl(
    ...
    public override val __669515549_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IToggleButtonStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("af1eab1201284f679c5a82320c445d19")
    ...
    public override fun toNative(obj: IToggleButtonStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__669515549_Ptr))
  }
