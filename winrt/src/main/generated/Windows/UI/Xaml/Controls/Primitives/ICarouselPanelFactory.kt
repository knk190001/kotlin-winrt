...
@Signature("{c1109404-9ae1-440e-a0dd-bbb6e2293cbe}")
@Guid("c11094049ae1440ea0ddbbb6e2293cbe")
@WinRTInterface("c11094049ae1440ea0ddbbb6e2293cbe")
...
public interface ICarouselPanelFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICarouselPanelFactory {
    public val __777100482_Ptr: Pointer?

    public val _777100482_VtblPtr: Pointer?
      get() = __777100482_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        CarouselPanel? {
      val fnPtr = _777100482_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CarouselPanel>()
      val hr = fn.invokeHR(arrayOf(__777100482_Ptr, marshalToNative(baseInterface),
  ...
  public class ICarouselPanelFactory_Impl(
    ...
    public override val __777100482_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICarouselPanelFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("c11094049ae1440ea0ddbbb6e2293cbe")
    ...
    public override fun toNative(obj: ICarouselPanelFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__777100482_Ptr))
  }
