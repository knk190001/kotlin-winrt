...
@Signature("{47dfc068-b569-4b19-842d-8e6cf90989af}")
@Guid("47dfc068b5694b19842d8e6cf90989af")
@WinRTInterface("47dfc068b5694b19842d8e6cf90989af")
...
public interface ISemanticZoomViewChangedEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISemanticZoomViewChangedEventArgs {
    public val __74108035_Ptr: Pointer?

    public val _74108035_VtblPtr: Pointer?
      get() = __74108035_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_IsSourceZoomedInView(): Boolean {
      val fnPtr = _74108035_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__74108035_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_IsSourceZoomedInView(value: Boolean): Unit {
      val fnPtr = _74108035_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__74108035_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_SourceItem(): SemanticZoomLocation? {
      val fnPtr = _74108035_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_SourceItem(value: SemanticZoomLocation?): Unit {
      val fnPtr = _74108035_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__74108035_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_DestinationItem(): SemanticZoomLocation? {
      val fnPtr = _74108035_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<SemanticZoomLocation>()
      val hr = fn.invokeHR(arrayOf(__74108035_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_DestinationItem(value: SemanticZoomLocation?): Unit {
      val fnPtr = _74108035_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__74108035_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class ISemanticZoomViewChangedEventArgs_Impl(
    ...
    public override val __74108035_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISemanticZoomViewChangedEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("47dfc068b5694b19842d8e6cf90989af")
    ...
    public override fun toNative(obj: ISemanticZoomViewChangedEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__74108035_Ptr))
  }
