...
@Signature("{9603fe56-9e9f-40b5-bae1-4481bb73bcd3}")
@Guid("9603fe569e9f40b5bae14481bb73bcd3")
@WinRTInterface("9603fe569e9f40b5bae14481bb73bcd3")
...
public interface IRatingItemFontInfoFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IRatingItemFontInfoFactory {
    public val __1673463713_Ptr: Pointer?

    public val _1673463713_VtblPtr: Pointer?
      get() = __1673463713_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        RatingItemFontInfo? {
      val fnPtr = _1673463713_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<RatingItemFontInfo>()
      val hr = fn.invokeHR(arrayOf(__1673463713_Ptr, marshalToNative(baseInterface),
  ...
  public class IRatingItemFontInfoFactory_Impl(
    ...
    public override val __1673463713_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IRatingItemFontInfoFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("9603fe569e9f40b5bae14481bb73bcd3")
    ...
    public override fun toNative(obj: IRatingItemFontInfoFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1673463713_Ptr))
  }
