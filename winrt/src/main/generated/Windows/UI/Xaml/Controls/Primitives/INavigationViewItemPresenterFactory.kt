...
@Signature("{bb062c50-4a36-52e7-9459-e89d02f3fc42}")
@Guid("bb062c504a3652e79459e89d02f3fc42")
@WinRTInterface("bb062c504a3652e79459e89d02f3fc42")
...
public interface INavigationViewItemPresenterFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : INavigationViewItemPresenterFactory {
    public val __1255137994_Ptr: Pointer?

    public val _1255137994_VtblPtr: Pointer?
      get() = __1255137994_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        NavigationViewItemPresenter? {
      val fnPtr = _1255137994_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<NavigationViewItemPresenter>()
      val hr = fn.invokeHR(arrayOf(__1255137994_Ptr, marshalToNative(baseInterface),
  ...
  public class INavigationViewItemPresenterFactory_Impl(
    ...
    public override val __1255137994_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<INavigationViewItemPresenterFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("bb062c504a3652e79459e89d02f3fc42")
    ...
    public override fun toNative(obj: INavigationViewItemPresenterFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1255137994_Ptr))
  }
