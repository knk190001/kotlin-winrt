...
@Signature("{b3be7bf6-1467-4086-bbcb-4e21d97a7b4d}")
@Guid("b3be7bf614674086bbcb4e21d97a7b4d")
@WinRTInterface("b3be7bf614674086bbcb4e21d97a7b4d")
...
public interface IFontIconStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IFontIconStatics {
    public val __1006935457_Ptr: Pointer?

    public val _1006935457_VtblPtr: Pointer?
      get() = __1006935457_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_GlyphProperty(): DependencyProperty? {
      val fnPtr = _1006935457_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1006935457_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_FontSizeProperty(): DependencyProperty? {
      val fnPtr = _1006935457_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1006935457_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_FontFamilyProperty(): DependencyProperty? {
      val fnPtr = _1006935457_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1006935457_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_FontWeightProperty(): DependencyProperty? {
      val fnPtr = _1006935457_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1006935457_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_FontStyleProperty(): DependencyProperty? {
      val fnPtr = _1006935457_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1006935457_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IFontIconStatics_Impl(
    ...
    public override val __1006935457_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IFontIconStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("b3be7bf614674086bbcb4e21d97a7b4d")
    ...
    public override fun toNative(obj: IFontIconStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1006935457_Ptr))
  }
