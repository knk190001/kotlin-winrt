...
@Signature("{98bc4280-4a3d-4cee-bd07-22ce94c5af76}")
@Guid("98bc42804a3d4ceebd0722ce94c5af76")
@WinRTInterface("98bc42804a3d4ceebd0722ce94c5af76")
...
public interface ICommandBar : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICommandBar {
    public val __738474524_Ptr: Pointer?

    public val _738474524_VtblPtr: Pointer?
      get() = __738474524_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_PrimaryCommands(): IObservableVector<ICommandBarElement?>? {
      val fnPtr = _738474524_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IObservableVector<ICommandBarElement?>>()
      val hr = fn.invokeHR(arrayOf(__738474524_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_SecondaryCommands(): IObservableVector<ICommandBarElement?>? {
      val fnPtr = _738474524_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IObservableVector<ICommandBarElement?>>()
      val hr = fn.invokeHR(arrayOf(__738474524_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ICommandBar_Impl(
    ...
    public override val __738474524_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICommandBar, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("98bc42804a3d4ceebd0722ce94c5af76")
    ...
    public override fun toNative(obj: ICommandBar): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__738474524_Ptr))
  }
