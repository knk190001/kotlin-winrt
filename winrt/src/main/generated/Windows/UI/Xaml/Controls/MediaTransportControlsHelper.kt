...
@Signature("rc(Windows.UI.Xaml.Controls.MediaTransportControlsHelper;{3d41d509-ff44-4420-807e-8f7a2e2c4251})")
...
public class MediaTransportControlsHelper(
  ...
  private val __1030452443_Interface: IMediaTransportControlsHelper.WithDefault by lazy {
    as_1030452443()
  }


  public override val __1030452443_Ptr: JNAPointer? by lazy {
    __1030452443_Interface.__1030452443_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1030452443_Interface)

  private fun as_1030452443(): IMediaTransportControlsHelper.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<MediaTransportControlsHelper, MemoryAddress> {
    ...
    public fun createIMediaTransportControlsHelperStatics(): IMediaTransportControlsHelperStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.MediaTransportControlsHelper".toHandle(),refiid,interfacePtr)
      val result =
