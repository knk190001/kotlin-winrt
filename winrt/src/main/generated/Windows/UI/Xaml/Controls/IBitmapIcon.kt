...
@Signature("{e8fe17cb-35f7-40f3-a185-48b397b73e68}")
@Guid("e8fe17cb35f740f3a18548b397b73e68")
@WinRTInterface("e8fe17cb35f740f3a18548b397b73e68")
...
public interface IBitmapIcon : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IBitmapIcon {
    public val __1028676452_Ptr: Pointer?

    public val _1028676452_VtblPtr: Pointer?
      get() = __1028676452_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_UriSource(): Uri? {
      val fnPtr = _1028676452_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Uri>()
      val hr = fn.invokeHR(arrayOf(__1028676452_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_UriSource(value: Uri?): Unit {
      val fnPtr = _1028676452_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1028676452_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IBitmapIcon_Impl(
    ...
    public override val __1028676452_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IBitmapIcon, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("e8fe17cb35f740f3a18548b397b73e68")
    ...
    public override fun toNative(obj: IBitmapIcon): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1028676452_Ptr))
  }
