...
@Signature("{614708d1-8e65-43cb-92d7-8eee17515f8d}")
@Guid("614708d18e6543cb92d78eee17515f8d")
@WinRTInterface("614708d18e6543cb92d78eee17515f8d")
...
public interface IAppBarFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IAppBarFactory {
    public val __1118581724_Ptr: Pointer?

    public val _1118581724_VtblPtr: Pointer?
      get() = __1118581724_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        AppBar? {
      val fnPtr = _1118581724_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AppBar>()
      val hr = fn.invokeHR(arrayOf(__1118581724_Ptr, marshalToNative(baseInterface),
  ...
  public class IAppBarFactory_Impl(
    ...
    public override val __1118581724_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IAppBarFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("614708d18e6543cb92d78eee17515f8d")
    ...
    public override fun toNative(obj: IAppBarFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1118581724_Ptr))
  }
