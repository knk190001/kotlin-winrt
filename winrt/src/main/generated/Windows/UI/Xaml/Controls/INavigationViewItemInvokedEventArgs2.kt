...
@Signature("{b568f2dd-515e-5770-a466-bd5f43fb6442}")
@Guid("b568f2dd515e5770a466bd5f43fb6442")
@WinRTInterface("b568f2dd515e5770a466bd5f43fb6442")
...
public interface INavigationViewItemInvokedEventArgs2 : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : INavigationViewItemInvokedEventArgs2 {
    public val __214640961_Ptr: Pointer?

    public val _214640961_VtblPtr: Pointer?
      get() = __214640961_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_InvokedItemContainer(): NavigationViewItemBase? {
      val fnPtr = _214640961_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<NavigationViewItemBase>()
      val hr = fn.invokeHR(arrayOf(__214640961_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_RecommendedNavigationTransitionInfo(): NavigationTransitionInfo? {
      val fnPtr = _214640961_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class INavigationViewItemInvokedEventArgs2_Impl(
    ...
    public override val __214640961_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<INavigationViewItemInvokedEventArgs2, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("b568f2dd515e5770a466bd5f43fb6442")
    ...
    public override fun toNative(obj: INavigationViewItemInvokedEventArgs2): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__214640961_Ptr))
  }
