...
@Signature("rc(Windows.UI.Xaml.Controls.Primitives.CalendarPanel;{fcd55a2d-02d3-4ee6-9a90-9df3ead00994})")
@WinRTByReference(brClass = CalendarPanel.ByReference::class)
public class CalendarPanel(
  ptr: JNAPointer? = NULL
) : Panel(ptr), ICalendarPanel.WithDefault, IWinRTObject {
  private val __1962094602_Interface: ICalendarPanel.WithDefault by lazy {
    as_1962094602()
  }


  public override val __1962094602_Ptr: JNAPointer? by lazy {
    __1962094602_Interface.__1962094602_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1962094602_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1962094602(): ICalendarPanel.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<CalendarPanel, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.Primitives.CalendarPanel".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
