...
@Signature("{ddfe6b5f-ba88-4a7d-8a5b-e58caf0f4e2d}")
@Guid("ddfe6b5fba884a7d8a5be58caf0f4e2d")
@WinRTInterface("ddfe6b5fba884a7d8a5be58caf0f4e2d")
...
public interface IItemsWrapGrid : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IItemsWrapGrid {
    public val __139614196_Ptr: Pointer?

    public val _139614196_VtblPtr: Pointer?
      get() = __139614196_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_GroupPadding(): Thickness? {
      val fnPtr = _139614196_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Thickness>()
      val hr = fn.invokeHR(arrayOf(__139614196_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_GroupPadding(value: Thickness?): Unit {
      val fnPtr = _139614196_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__139614196_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Orientation(): Orientation? {
      val fnPtr = _139614196_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Orientation(value: Orientation?): Unit {
      val fnPtr = _139614196_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__139614196_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_MaximumRowsOrColumns(): Int {
      val fnPtr = _139614196_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_MaximumRowsOrColumns(value: Int): Unit {
      val fnPtr = _139614196_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__139614196_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_ItemWidth(): Double {
      val fnPtr = _139614196_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_ItemWidth(value: Double): Unit {
      val fnPtr = _139614196_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__139614196_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ItemHeight(): Double {
      val fnPtr = _139614196_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__139614196_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ItemHeight(value: Double): Unit {
      val fnPtr = _139614196_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__139614196_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_FirstCacheIndex(): Int {
      val fnPtr = _139614196_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__139614196_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_FirstVisibleIndex(): Int {
      val fnPtr = _139614196_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__139614196_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_LastVisibleIndex(): Int {
      val fnPtr = _139614196_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__139614196_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_LastCacheIndex(): Int {
      val fnPtr = _139614196_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__139614196_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ScrollingDirection(): PanelScrollingDirection? {
      val fnPtr = _139614196_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_GroupHeaderPlacement(): GroupHeaderPlacement? {
      val fnPtr = _139614196_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_GroupHeaderPlacement(value: GroupHeaderPlacement?): Unit {
      val fnPtr = _139614196_VtblPtr!!.getPointer(22L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__139614196_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_CacheLength(): Double {
      val fnPtr = _139614196_VtblPtr!!.getPointer(23L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__139614196_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_CacheLength(value: Double): Unit {
      val fnPtr = _139614196_VtblPtr!!.getPointer(24L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__139614196_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IItemsWrapGrid_Impl(
    ...
    public override val __139614196_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IItemsWrapGrid, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("ddfe6b5fba884a7d8a5be58caf0f4e2d")
    ...
    public override fun toNative(obj: IItemsWrapGrid): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__139614196_Ptr))
  }
