...
import Windows.UI.Xaml.Controls.IToggleMenuFlyoutItemFactory.ABI.IID
...
@Signature("rc(Windows.UI.Xaml.Controls.ToggleMenuFlyoutItem;{49841edd-88e9-4663-a701-cd4fd25e398f})")
...
public open class ToggleMenuFlyoutItem(
  ...
  private val __26098435_Interface: IToggleMenuFlyoutItem.WithDefault by lazy {
    as_26098435()
  }


  public override val __26098435_Ptr: JNAPointer? by lazy {
    __26098435_Interface.__26098435_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__26098435_Interface)

  public constructor() : this(ABI.activate())

  private fun as_26098435(): IToggleMenuFlyoutItem.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<ToggleMenuFlyoutItem, MemoryAddress> {
    ...
    public fun createIToggleMenuFlyoutItemStatics(): IToggleMenuFlyoutItemStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.ToggleMenuFlyoutItem".toHandle(),refiid,interfacePtr)
      val result =
    ...
    public fun createIToggleMenuFlyoutItemFactory(): IToggleMenuFlyoutItemFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.ToggleMenuFlyoutItem".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
