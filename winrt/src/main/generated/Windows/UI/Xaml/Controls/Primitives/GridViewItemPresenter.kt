...
import Windows.UI.Xaml.Controls.Primitives.IGridViewItemPresenterFactory.ABI.IID
...
@Signature("rc(Windows.UI.Xaml.Controls.Primitives.GridViewItemPresenter;{214f9010-56e2-4821-8a1c-2305709af94b})")
...
public open class GridViewItemPresenter(
  ...
  private val __1490315730_Interface: IGridViewItemPresenter.WithDefault by lazy {
    as_1490315730()
  }


  public override val __1490315730_Ptr: JNAPointer? by lazy {
    __1490315730_Interface.__1490315730_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1490315730_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1490315730(): IGridViewItemPresenter.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<GridViewItemPresenter, MemoryAddress> {
    ...
    public fun createIGridViewItemPresenterStatics(): IGridViewItemPresenterStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.Primitives.GridViewItemPresenter".toHandle(),refiid,interfacePtr)
      val result =
    ...
    public fun createIGridViewItemPresenterFactory(): IGridViewItemPresenterFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.Primitives.GridViewItemPresenter".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
