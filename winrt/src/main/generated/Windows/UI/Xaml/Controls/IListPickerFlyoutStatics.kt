...
@Signature("{fee25b97-8b96-4602-81d2-82fd8e0f7ea8}")
@Guid("fee25b978b96460281d282fd8e0f7ea8")
@WinRTInterface("fee25b978b96460281d282fd8e0f7ea8")
...
public interface IListPickerFlyoutStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IListPickerFlyoutStatics {
    public val __380455358_Ptr: Pointer?

    public val _380455358_VtblPtr: Pointer?
      get() = __380455358_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ItemsSourceProperty(): DependencyProperty? {
      val fnPtr = _380455358_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__380455358_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ItemTemplateProperty(): DependencyProperty? {
      val fnPtr = _380455358_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__380455358_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_DisplayMemberPathProperty(): DependencyProperty? {
      val fnPtr = _380455358_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__380455358_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_SelectionModeProperty(): DependencyProperty? {
      val fnPtr = _380455358_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__380455358_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_SelectedIndexProperty(): DependencyProperty? {
      val fnPtr = _380455358_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__380455358_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_SelectedItemProperty(): DependencyProperty? {
      val fnPtr = _380455358_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__380455358_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_SelectedValueProperty(): DependencyProperty? {
      val fnPtr = _380455358_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__380455358_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_SelectedValuePathProperty(): DependencyProperty? {
      val fnPtr = _380455358_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__380455358_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IListPickerFlyoutStatics_Impl(
    ...
    public override val __380455358_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IListPickerFlyoutStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("fee25b978b96460281d282fd8e0f7ea8")
    ...
    public override fun toNative(obj: IListPickerFlyoutStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__380455358_Ptr))
  }
