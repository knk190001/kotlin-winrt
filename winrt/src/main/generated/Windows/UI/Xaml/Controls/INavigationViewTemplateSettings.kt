...
@Signature("{2956cbc4-0528-55d5-b2d1-eae807aea6da}")
@Guid("2956cbc4052855d5b2d1eae807aea6da")
@WinRTInterface("2956cbc4052855d5b2d1eae807aea6da")
...
public interface INavigationViewTemplateSettings : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : INavigationViewTemplateSettings {
    public val __1059919570_Ptr: Pointer?

    public val _1059919570_VtblPtr: Pointer?
      get() = __1059919570_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_TopPadding(): Double {
      val fnPtr = _1059919570_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1059919570_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_OverflowButtonVisibility(): Visibility? {
      val fnPtr = _1059919570_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_PaneToggleButtonVisibility(): Visibility? {
      val fnPtr = _1059919570_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Visibility>()
      val hr = fn.invokeHR(arrayOf(__1059919570_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_BackButtonVisibility(): Visibility? {
      val fnPtr = _1059919570_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Visibility>()
      val hr = fn.invokeHR(arrayOf(__1059919570_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_TopPaneVisibility(): Visibility? {
      val fnPtr = _1059919570_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Visibility>()
      val hr = fn.invokeHR(arrayOf(__1059919570_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_LeftPaneVisibility(): Visibility? {
      val fnPtr = _1059919570_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Visibility>()
      val hr = fn.invokeHR(arrayOf(__1059919570_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_SingleSelectionFollowsFocus(): Boolean {
      val fnPtr = _1059919570_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class INavigationViewTemplateSettings_Impl(
    ...
    public override val __1059919570_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<INavigationViewTemplateSettings, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("2956cbc4052855d5b2d1eae807aea6da")
    ...
    public override fun toNative(obj: INavigationViewTemplateSettings): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1059919570_Ptr))
  }
