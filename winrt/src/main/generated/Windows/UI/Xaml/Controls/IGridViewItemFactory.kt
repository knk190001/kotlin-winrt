...
@Signature("{229b00af-3fa6-43e9-979d-07ea0d6280dc}")
@Guid("229b00af3fa643e9979d07ea0d6280dc")
@WinRTInterface("229b00af3fa643e9979d07ea0d6280dc")
...
public interface IGridViewItemFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IGridViewItemFactory {
    public val __283175728_Ptr: Pointer?

    public val _283175728_VtblPtr: Pointer?
      get() = __283175728_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        GridViewItem? {
      val fnPtr = _283175728_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<GridViewItem>()
      val hr = fn.invokeHR(arrayOf(__283175728_Ptr, marshalToNative(baseInterface),
  ...
  public class IGridViewItemFactory_Impl(
    ...
    public override val __283175728_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IGridViewItemFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("229b00af3fa643e9979d07ea0d6280dc")
    ...
    public override fun toNative(obj: IGridViewItemFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__283175728_Ptr))
  }
