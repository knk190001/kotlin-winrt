...
@Signature("{973bdb4a-7e08-4f76-923c-f12bd685e86e}")
@Guid("973bdb4a7e084f76923cf12bd685e86e")
@WinRTInterface("973bdb4a7e084f76923cf12bd685e86e")
...
public interface INavigationViewItemFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : INavigationViewItemFactory {
    public val __1616575166_Ptr: Pointer?

    public val _1616575166_VtblPtr: Pointer?
      get() = __1616575166_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        NavigationViewItem? {
      val fnPtr = _1616575166_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<NavigationViewItem>()
      val hr = fn.invokeHR(arrayOf(__1616575166_Ptr, marshalToNative(baseInterface),
  ...
  public class INavigationViewItemFactory_Impl(
    ...
    public override val __1616575166_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<INavigationViewItemFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("973bdb4a7e084f76923cf12bd685e86e")
    ...
    public override fun toNative(obj: INavigationViewItemFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1616575166_Ptr))
  }
