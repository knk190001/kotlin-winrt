...
import Windows.UI.Xaml.Controls.ClickMode
...
@Signature("{fa002c1a-494e-46cf-91d4-e14a8d798674}")
@Guid("fa002c1a494e46cf91d4e14a8d798674")
@WinRTInterface("fa002c1a494e46cf91d4e14a8d798674")
...
public interface IButtonBase : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IButtonBase {
    public val __665952511_Ptr: Pointer?

    public val _665952511_VtblPtr: Pointer?
      get() = __665952511_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ClickMode(): ClickMode? {
      val fnPtr = _665952511_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ClickMode>()
      val hr = fn.invokeHR(arrayOf(__665952511_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ClickMode(value: ClickMode?): Unit {
      val fnPtr = _665952511_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__665952511_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_IsPointerOver(): Boolean {
      val fnPtr = _665952511_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_IsPressed(): Boolean {
      val fnPtr = _665952511_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__665952511_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Command(): ICommand? {
      val fnPtr = _665952511_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Command(value: ICommand?): Unit {
      val fnPtr = _665952511_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__665952511_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_CommandParameter(): IUnknown? {
      val fnPtr = _665952511_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_CommandParameter(value: IUnknown?): Unit {
      val fnPtr = _665952511_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__665952511_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun add_Click(handler: RoutedEventHandler?): EventRegistrationToken? {
      val fnPtr = _665952511_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__665952511_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun remove_Click(token: EventRegistrationToken?): Unit {
      val fnPtr = _665952511_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__665952511_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IButtonBase_Impl(
    ...
    public override val __665952511_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IButtonBase, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("fa002c1a494e46cf91d4e14a8d798674")
    ...
    public override fun toNative(obj: IButtonBase): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__665952511_Ptr))
  }
