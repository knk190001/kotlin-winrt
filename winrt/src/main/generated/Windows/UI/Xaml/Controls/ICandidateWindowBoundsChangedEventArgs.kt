...
@Signature("{8a946458-83b0-4c32-9450-5169a5838b55}")
@Guid("8a94645883b04c3294505169a5838b55")
@WinRTInterface("8a94645883b04c3294505169a5838b55")
...
public interface ICandidateWindowBoundsChangedEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICandidateWindowBoundsChangedEventArgs {
    public val __249371729_Ptr: Pointer?

    public val _249371729_VtblPtr: Pointer?
      get() = __249371729_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Bounds(): Rect? {
      val fnPtr = _249371729_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Rect>()
      val hr = fn.invokeHR(arrayOf(__249371729_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ICandidateWindowBoundsChangedEventArgs_Impl(
    ...
    public override val __249371729_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICandidateWindowBoundsChangedEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("8a94645883b04c3294505169a5838b55")
    ...
    public override fun toNative(obj: ICandidateWindowBoundsChangedEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__249371729_Ptr))
  }
