...
@Signature("{6b8de08f-6527-4d39-bcbf-58b01da923d7}")
@Guid("6b8de08f65274d39bcbf58b01da923d7")
@WinRTInterface("6b8de08f65274d39bcbf58b01da923d7")
...
public interface IInsertionPanel : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IInsertionPanel {
    public val __1101609905_Ptr: Pointer?

    public val _1101609905_VtblPtr: Pointer?
      get() = __1101609905_Ptr?.getPointer(0)
    ...
    public override fun GetInsertionIndexes(
      ...
      val fnPtr = _1101609905_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1101609905_Ptr, marshalToNative(position), first, second,))
      if (hr.toInt() != 0) {
  ...
  public class IInsertionPanel_Impl(
    ...
    public override val __1101609905_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IInsertionPanel, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("6b8de08f65274d39bcbf58b01da923d7")
    ...
    public override fun toNative(obj: IInsertionPanel): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1101609905_Ptr))
  }
