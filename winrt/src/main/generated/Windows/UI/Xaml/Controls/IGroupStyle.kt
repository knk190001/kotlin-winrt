...
@Signature("{71ca300b-b89e-4184-b0df-a9e95447de8d}")
@Guid("71ca300bb89e4184b0dfa9e95447de8d")
@WinRTInterface("71ca300bb89e4184b0dfa9e95447de8d")
...
public interface IGroupStyle : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IGroupStyle {
    public val __251177074_Ptr: Pointer?

    public val _251177074_VtblPtr: Pointer?
      get() = __251177074_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Panel(): ItemsPanelTemplate? {
      val fnPtr = _251177074_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ItemsPanelTemplate>()
      val hr = fn.invokeHR(arrayOf(__251177074_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Panel(value: ItemsPanelTemplate?): Unit {
      val fnPtr = _251177074_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__251177074_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_ContainerStyle(): Style? {
      val fnPtr = _251177074_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_ContainerStyle(value: Style?): Unit {
      val fnPtr = _251177074_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__251177074_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ContainerStyleSelector(): StyleSelector? {
      val fnPtr = _251177074_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_ContainerStyleSelector(value: StyleSelector?): Unit {
      val fnPtr = _251177074_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__251177074_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_HeaderTemplate(): DataTemplate? {
      val fnPtr = _251177074_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_HeaderTemplate(value: DataTemplate?): Unit {
      val fnPtr = _251177074_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__251177074_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_HeaderTemplateSelector(): DataTemplateSelector? {
      val fnPtr = _251177074_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_HeaderTemplateSelector(value: DataTemplateSelector?): Unit {
      val fnPtr = _251177074_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__251177074_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_HidesIfEmpty(): Boolean {
      val fnPtr = _251177074_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_HidesIfEmpty(value: Boolean): Unit {
      val fnPtr = _251177074_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__251177074_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IGroupStyle_Impl(
    ...
    public override val __251177074_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IGroupStyle, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("71ca300bb89e4184b0dfa9e95447de8d")
    ...
    public override fun toNative(obj: IGroupStyle): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__251177074_Ptr))
  }
