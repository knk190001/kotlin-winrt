...
import Windows.UI.Xaml.Controls.ISwipeItemsFactory.ABI.IID
...
@Signature("rc(Windows.UI.Xaml.Controls.SwipeItems;{b01726ff-969a-40d0-9f04-76084ce6d7b7})")
...
public open class SwipeItems(
  ptr: JNAPointer? = NULL
    ...
    IWinRTObject {
  private val __1095363134_Interface: ISwipeItems.WithDefault by lazy {
    as_1095363134()
  }
  ...
  public override val __1095363134_Ptr: JNAPointer? by lazy {
    __1095363134_Interface.__1095363134_Ptr
  }
  ...
  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1095363134_Interface, __1070388601_Interface, __1449643190_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1095363134(): ISwipeItems.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<SwipeItems, MemoryAddress> {
    ...
    public fun createISwipeItemsStatics(): ISwipeItemsStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.SwipeItems".toHandle(),refiid,interfacePtr)
    ...
    public fun createISwipeItemsFactory(): ISwipeItemsFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.SwipeItems".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
