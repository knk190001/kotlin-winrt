...
import Windows.UI.Xaml.Controls.IconElement
...
@Signature("{9956d3fc-4693-59cb-b6bf-37249058be96}")
@Guid("9956d3fc469359cbb6bf37249058be96")
@WinRTInterface("9956d3fc469359cbb6bf37249058be96")
...
public interface INavigationViewItemPresenter : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : INavigationViewItemPresenter {
    public val __1700052448_Ptr: Pointer?

    public val _1700052448_VtblPtr: Pointer?
      get() = __1700052448_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Icon(): IconElement? {
      val fnPtr = _1700052448_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IconElement>()
      val hr = fn.invokeHR(arrayOf(__1700052448_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Icon(value: IconElement?): Unit {
      val fnPtr = _1700052448_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1700052448_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class INavigationViewItemPresenter_Impl(
    ...
    public override val __1700052448_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<INavigationViewItemPresenter, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("9956d3fc469359cbb6bf37249058be96")
    ...
    public override fun toNative(obj: INavigationViewItemPresenter): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1700052448_Ptr))
  }
