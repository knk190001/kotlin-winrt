...
import Windows.UI.Xaml.Navigation.NavigatingCancelEventArgs
import Windows.UI.Xaml.Navigation.NavigationEventArgs
...
@Signature("{230b9cb8-3419-4306-aabe-4a8e680d3627}")
@Guid("230b9cb834194306aabe4a8e680d3627")
@WinRTInterface("230b9cb834194306aabe4a8e680d3627")
...
public interface IPageOverrides : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPageOverrides {
    public val __1420313156_Ptr: Pointer?

    public val _1420313156_VtblPtr: Pointer?
      get() = __1420313156_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun OnNavigatedFrom(e: NavigationEventArgs?): Unit {
      val fnPtr = _1420313156_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1420313156_Ptr, marshalToNative(e),))
      if (hr.toInt() != 0) {
    ...
    public override fun OnNavigatedTo(e: NavigationEventArgs?): Unit {
      val fnPtr = _1420313156_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1420313156_Ptr, marshalToNative(e),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun OnNavigatingFrom(e: NavigatingCancelEventArgs?): Unit {
      val fnPtr = _1420313156_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1420313156_Ptr, marshalToNative(e),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IPageOverrides_Impl(
    ...
    public override val __1420313156_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPageOverrides, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("230b9cb834194306aabe4a8e680d3627")
    ...
    public override fun toNative(obj: IPageOverrides): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1420313156_Ptr))
  }
