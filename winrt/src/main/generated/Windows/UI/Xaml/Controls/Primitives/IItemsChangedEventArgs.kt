...
@Signature("{e8b45568-7d10-421e-be29-81839a91de20}")
@Guid("e8b455687d10421ebe2981839a91de20")
@WinRTInterface("e8b455687d10421ebe2981839a91de20")
...
public interface IItemsChangedEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IItemsChangedEventArgs {
    public val __1163060423_Ptr: Pointer?

    public val _1163060423_VtblPtr: Pointer?
      get() = __1163060423_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Action(): Int {
      val fnPtr = _1163060423_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__1163060423_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Position(): GeneratorPosition? {
      val fnPtr = _1163060423_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_OldPosition(): GeneratorPosition? {
      val fnPtr = _1163060423_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<GeneratorPosition>()
      val hr = fn.invokeHR(arrayOf(__1163060423_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ItemCount(): Int {
      val fnPtr = _1163060423_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__1163060423_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ItemUICount(): Int {
      val fnPtr = _1163060423_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__1163060423_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IItemsChangedEventArgs_Impl(
    ...
    public override val __1163060423_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IItemsChangedEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("e8b455687d10421ebe2981839a91de20")
    ...
    public override fun toNative(obj: IItemsChangedEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1163060423_Ptr))
  }
