...
@Signature("{7567cd9a-a3b4-4dea-bb11-549e2c2f919d}")
@Guid("7567cd9aa3b44deabb11549e2c2f919d")
@WinRTInterface("7567cd9aa3b44deabb11549e2c2f919d")
...
public interface IVirtualizingStackPanel : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IVirtualizingStackPanel {
    public val __1680375554_Ptr: Pointer?

    public val _1680375554_VtblPtr: Pointer?
      get() = __1680375554_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_AreScrollSnapPointsRegular(): Boolean {
      val fnPtr = _1680375554_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1680375554_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_AreScrollSnapPointsRegular(value: Boolean): Unit {
      val fnPtr = _1680375554_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1680375554_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Orientation(): Orientation? {
      val fnPtr = _1680375554_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Orientation(value: Orientation?): Unit {
      val fnPtr = _1680375554_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1680375554_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override
        ...
        EventRegistrationToken? {
      val fnPtr = _1680375554_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__1680375554_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun remove_CleanUpVirtualizedItemEvent(token: EventRegistrationToken?): Unit {
      val fnPtr = _1680375554_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1680375554_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IVirtualizingStackPanel_Impl(
    ...
    public override val __1680375554_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IVirtualizingStackPanel, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("7567cd9aa3b44deabb11549e2c2f919d")
    ...
    public override fun toNative(obj: IVirtualizingStackPanel): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1680375554_Ptr))
  }
