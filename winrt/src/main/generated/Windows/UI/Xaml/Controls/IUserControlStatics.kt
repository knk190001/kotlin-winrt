...
@Signature("{e8887976-2c5c-41cf-be6a-9e44befdf655}")
@Guid("e88879762c5c41cfbe6a9e44befdf655")
@WinRTInterface("e88879762c5c41cfbe6a9e44befdf655")
...
public interface IUserControlStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IUserControlStatics {
    public val __1112843631_Ptr: Pointer?

    public val _1112843631_VtblPtr: Pointer?
      get() = __1112843631_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ContentProperty(): DependencyProperty? {
      val fnPtr = _1112843631_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1112843631_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IUserControlStatics_Impl(
    ...
    public override val __1112843631_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IUserControlStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("e88879762c5c41cfbe6a9e44befdf655")
    ...
    public override fun toNative(obj: IUserControlStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1112843631_Ptr))
  }
