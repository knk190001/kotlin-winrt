...
@Signature("{7ec27a53-9502-4beb-b342-00566c8f16b0}")
@Guid("7ec27a5395024bebb34200566c8f16b0")
@WinRTInterface("7ec27a5395024bebb34200566c8f16b0")
...
public interface IPickerFlyoutBaseFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPickerFlyoutBaseFactory {
    public val __347359924_Ptr: Pointer?

    public val _347359924_VtblPtr: Pointer?
      get() = __347359924_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        PickerFlyoutBase? {
      val fnPtr = _347359924_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<PickerFlyoutBase>()
      val hr = fn.invokeHR(arrayOf(__347359924_Ptr, marshalToNative(baseInterface),
  ...
  public class IPickerFlyoutBaseFactory_Impl(
    ...
    public override val __347359924_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPickerFlyoutBaseFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("7ec27a5395024bebb34200566c8f16b0")
    ...
    public override fun toNative(obj: IPickerFlyoutBaseFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__347359924_Ptr))
  }
