...
@Signature("{f7f1b229-f024-467f-970a-7e705615db7b}")
@Guid("f7f1b229f024467f970a7e705615db7b")
@WinRTInterface("f7f1b229f024467f970a7e705615db7b")
...
public interface IColumnDefinition : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IColumnDefinition {
    public val __1944267419_Ptr: Pointer?

    public val _1944267419_VtblPtr: Pointer?
      get() = __1944267419_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Width(): GridLength? {
      val fnPtr = _1944267419_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<GridLength>()
      val hr = fn.invokeHR(arrayOf(__1944267419_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Width(value: GridLength?): Unit {
      val fnPtr = _1944267419_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1944267419_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_MaxWidth(): Double {
      val fnPtr = _1944267419_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_MaxWidth(value: Double): Unit {
      val fnPtr = _1944267419_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1944267419_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_MinWidth(): Double {
      val fnPtr = _1944267419_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1944267419_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_MinWidth(value: Double): Unit {
      val fnPtr = _1944267419_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1944267419_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ActualWidth(): Double {
      val fnPtr = _1944267419_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1944267419_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IColumnDefinition_Impl(
    ...
    public override val __1944267419_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IColumnDefinition, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("f7f1b229f024467f970a7e705615db7b")
    ...
    public override fun toNative(obj: IColumnDefinition): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1944267419_Ptr))
  }
