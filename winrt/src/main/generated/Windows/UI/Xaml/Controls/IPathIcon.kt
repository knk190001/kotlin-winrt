...
@Signature("{214c62db-c366-4a0e-b9ad-dcf168d7ec0c}")
@Guid("214c62dbc3664a0eb9addcf168d7ec0c")
@WinRTInterface("214c62dbc3664a0eb9addcf168d7ec0c")
...
public interface IPathIcon : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPathIcon {
    public val __745339482_Ptr: Pointer?

    public val _745339482_VtblPtr: Pointer?
      get() = __745339482_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Data(): Geometry? {
      val fnPtr = _745339482_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Geometry>()
      val hr = fn.invokeHR(arrayOf(__745339482_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Data(value: Geometry?): Unit {
      val fnPtr = _745339482_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__745339482_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IPathIcon_Impl(
    ...
    public override val __745339482_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPathIcon, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("214c62dbc3664a0eb9addcf168d7ec0c")
    ...
    public override fun toNative(obj: IPathIcon): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__745339482_Ptr))
  }
