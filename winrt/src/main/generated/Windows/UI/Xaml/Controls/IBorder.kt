...
@Signature("{797c4539-45bd-4633-a044-bfb02ef5170f}")
@Guid("797c453945bd4633a044bfb02ef5170f")
@WinRTInterface("797c453945bd4633a044bfb02ef5170f")
...
public interface IBorder : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IBorder {
    public val __251939656_Ptr: Pointer?

    public val _251939656_VtblPtr: Pointer?
      get() = __251939656_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_BorderBrush(): Brush? {
      val fnPtr = _251939656_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Brush>()
      val hr = fn.invokeHR(arrayOf(__251939656_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_BorderBrush(value: Brush?): Unit {
      val fnPtr = _251939656_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__251939656_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_BorderThickness(): Thickness? {
      val fnPtr = _251939656_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_BorderThickness(value: Thickness?): Unit {
      val fnPtr = _251939656_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__251939656_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Background(): Brush? {
      val fnPtr = _251939656_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Brush>()
      val hr = fn.invokeHR(arrayOf(__251939656_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Background(value: Brush?): Unit {
      val fnPtr = _251939656_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__251939656_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_CornerRadius(): CornerRadius? {
      val fnPtr = _251939656_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_CornerRadius(value: CornerRadius?): Unit {
      val fnPtr = _251939656_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__251939656_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Padding(): Thickness? {
      val fnPtr = _251939656_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Thickness>()
      val hr = fn.invokeHR(arrayOf(__251939656_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Padding(value: Thickness?): Unit {
      val fnPtr = _251939656_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__251939656_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Child(): UIElement? {
      val fnPtr = _251939656_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Child(value: UIElement?): Unit {
      val fnPtr = _251939656_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__251939656_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ChildTransitions(): TransitionCollection? {
      val fnPtr = _251939656_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_ChildTransitions(value: TransitionCollection?): Unit {
      val fnPtr = _251939656_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__251939656_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IBorder_Impl(
    ...
    public override val __251939656_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IBorder, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("797c453945bd4633a044bfb02ef5170f")
    ...
    public override fun toNative(obj: IBorder): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__251939656_Ptr))
  }
