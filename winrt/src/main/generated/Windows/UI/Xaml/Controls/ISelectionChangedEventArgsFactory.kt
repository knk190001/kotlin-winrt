...
@Signature("{11a8b6b5-2830-4517-84cd-5524c8b88b45}")
@Guid("11a8b6b52830451784cd5524c8b88b45")
@WinRTInterface("11a8b6b52830451784cd5524c8b88b45")
...
public interface ISelectionChangedEventArgsFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISelectionChangedEventArgsFactory {
    public val __1115109943_Ptr: Pointer?

    public val _1115109943_VtblPtr: Pointer?
      get() = __1115109943_Ptr?.getPointer(0)
    ...
    public override fun CreateInstanceWithRemovedItemsAndAddedItems(
      ...
      val fnPtr = _1115109943_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<SelectionChangedEventArgs>()
      val hr = fn.invokeHR(arrayOf(__1115109943_Ptr, marshalToNative(removedItems),
  ...
  public class ISelectionChangedEventArgsFactory_Impl(
    ...
    public override val __1115109943_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISelectionChangedEventArgsFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("11a8b6b52830451784cd5524c8b88b45")
    ...
    public override fun toNative(obj: ISelectionChangedEventArgsFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1115109943_Ptr))
  }
