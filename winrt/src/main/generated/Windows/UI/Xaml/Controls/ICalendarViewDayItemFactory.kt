...
@Signature("{62112bdc-1d2f-4e44-9baf-1665749521f2}")
@Guid("62112bdc1d2f4e449baf1665749521f2")
@WinRTInterface("62112bdc1d2f4e449baf1665749521f2")
...
public interface ICalendarViewDayItemFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICalendarViewDayItemFactory {
    public val __874259514_Ptr: Pointer?

    public val _874259514_VtblPtr: Pointer?
      get() = __874259514_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        CalendarViewDayItem? {
      val fnPtr = _874259514_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CalendarViewDayItem>()
      val hr = fn.invokeHR(arrayOf(__874259514_Ptr, marshalToNative(baseInterface),
  ...
  public class ICalendarViewDayItemFactory_Impl(
    ...
    public override val __874259514_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICalendarViewDayItemFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("62112bdc1d2f4e449baf1665749521f2")
    ...
    public override fun toNative(obj: ICalendarViewDayItemFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__874259514_Ptr))
  }
