...
import Windows.UI.Xaml.Controls.IGridViewHeaderItemFactory.ABI.IID
...
@Signature("rc(Windows.UI.Xaml.Controls.GridViewHeaderItem;{72d75d7e-5dc3-4ffc-9b1c-939b5c37161c})")
...
public open class GridViewHeaderItem(
  ...
  private val __1997356601_Interface: IGridViewHeaderItem.WithDefault by lazy {
    as_1997356601()
  }


  public override val __1997356601_Ptr: JNAPointer? by lazy {
    __1997356601_Interface.__1997356601_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1997356601_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1997356601(): IGridViewHeaderItem.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<GridViewHeaderItem, MemoryAddress> {
    ...
    public fun createIGridViewHeaderItemFactory(): IGridViewHeaderItemFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.GridViewHeaderItem".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
