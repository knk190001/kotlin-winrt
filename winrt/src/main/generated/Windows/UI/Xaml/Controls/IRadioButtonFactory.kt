...
@Signature("{f1d04933-34e1-4a5c-b2ae-ca3b1c0b20de}")
@Guid("f1d0493334e14a5cb2aeca3b1c0b20de")
@WinRTInterface("f1d0493334e14a5cb2aeca3b1c0b20de")
...
public interface IRadioButtonFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IRadioButtonFactory {
    public val __1101741657_Ptr: Pointer?

    public val _1101741657_VtblPtr: Pointer?
      get() = __1101741657_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        RadioButton? {
      val fnPtr = _1101741657_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<RadioButton>()
      val hr = fn.invokeHR(arrayOf(__1101741657_Ptr, marshalToNative(baseInterface),
  ...
  public class IRadioButtonFactory_Impl(
    ...
    public override val __1101741657_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IRadioButtonFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("f1d0493334e14a5cb2aeca3b1c0b20de")
    ...
    public override fun toNative(obj: IRadioButtonFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1101741657_Ptr))
  }
