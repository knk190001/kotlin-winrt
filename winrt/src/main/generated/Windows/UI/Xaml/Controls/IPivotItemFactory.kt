...
@Signature("{0dced981-636e-4a34-8a3f-8ee018639285}")
@Guid("0dced981636e4a348a3f8ee018639285")
@WinRTInterface("0dced981636e4a348a3f8ee018639285")
...
public interface IPivotItemFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPivotItemFactory {
    public val __615900401_Ptr: Pointer?

    public val _615900401_VtblPtr: Pointer?
      get() = __615900401_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        PivotItem? {
      val fnPtr = _615900401_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<PivotItem>()
      val hr = fn.invokeHR(arrayOf(__615900401_Ptr, marshalToNative(baseInterface),
  ...
  public class IPivotItemFactory_Impl(
    ...
    public override val __615900401_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPivotItemFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("0dced981636e4a348a3f8ee018639285")
    ...
    public override fun toNative(obj: IPivotItemFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__615900401_Ptr))
  }
