...
@Signature("{5175f55d-4785-5a72-b462-eb11e9bdf897}")
@Guid("5175f55d47855a72b462eb11e9bdf897")
@WinRTInterface("5175f55d47855a72b462eb11e9bdf897")
...
public interface IAnchorRequestedEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IAnchorRequestedEventArgs {
    public val __2109260410_Ptr: Pointer?

    public val _2109260410_VtblPtr: Pointer?
      get() = __2109260410_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Anchor(): UIElement? {
      val fnPtr = _2109260410_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<UIElement>()
      val hr = fn.invokeHR(arrayOf(__2109260410_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Anchor(value: UIElement?): Unit {
      val fnPtr = _2109260410_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2109260410_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_AnchorCandidates(): IVector<UIElement?>? {
      val fnPtr = _2109260410_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class IAnchorRequestedEventArgs_Impl(
    ...
    public override val __2109260410_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IAnchorRequestedEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("5175f55d47855a72b462eb11e9bdf897")
    ...
    public override fun toNative(obj: IAnchorRequestedEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2109260410_Ptr))
  }
