...
@Signature("{376a8c4c-aac0-4b20-966a-0b9364feb4b5}")
@Guid("376a8c4caac04b20966a0b9364feb4b5")
@WinRTInterface("376a8c4caac04b20966a0b9364feb4b5")
...
public interface IPopup2 : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPopup2 {
    public val __1185883422_Ptr: Pointer?

    public val _1185883422_VtblPtr: Pointer?
      get() = __1185883422_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_LightDismissOverlayMode(): LightDismissOverlayMode? {
      val fnPtr = _1185883422_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<LightDismissOverlayMode>()
      val hr = fn.invokeHR(arrayOf(__1185883422_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_LightDismissOverlayMode(value: LightDismissOverlayMode?): Unit {
      val fnPtr = _1185883422_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1185883422_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IPopup2_Impl(
    ...
    public override val __1185883422_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPopup2, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("376a8c4caac04b20966a0b9364feb4b5")
    ...
    public override fun toNative(obj: IPopup2): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1185883422_Ptr))
  }
