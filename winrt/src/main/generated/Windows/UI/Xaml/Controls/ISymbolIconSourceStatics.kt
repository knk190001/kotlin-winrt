...
@Signature("{8bc49738-d94e-4148-8d64-1adf0f23f25f}")
@Guid("8bc49738d94e41488d641adf0f23f25f")
@WinRTInterface("8bc49738d94e41488d641adf0f23f25f")
...
public interface ISymbolIconSourceStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISymbolIconSourceStatics {
    public val __256238371_Ptr: Pointer?

    public val _256238371_VtblPtr: Pointer?
      get() = __256238371_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_SymbolProperty(): DependencyProperty? {
      val fnPtr = _256238371_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__256238371_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ISymbolIconSourceStatics_Impl(
    ...
    public override val __256238371_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISymbolIconSourceStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("8bc49738d94e41488d641adf0f23f25f")
    ...
    public override fun toNative(obj: ISymbolIconSourceStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__256238371_Ptr))
  }
