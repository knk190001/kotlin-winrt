...
@Signature("{6c230b6d-0d75-4059-91bc-7b174d1d7315}")
@Guid("6c230b6d0d75405991bc7b174d1d7315")
@WinRTInterface("6c230b6d0d75405991bc7b174d1d7315")
...
public interface IPersonPicture : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPersonPicture {
    public val __1852707149_Ptr: Pointer?

    public val _1852707149_VtblPtr: Pointer?
      get() = __1852707149_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_BadgeNumber(): Int {
      val fnPtr = _1852707149_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__1852707149_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_BadgeNumber(value: Int): Unit {
      val fnPtr = _1852707149_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1852707149_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_BadgeGlyph(): String? {
      val fnPtr = _1852707149_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_BadgeGlyph(value: String?): Unit {
      val fnPtr = _1852707149_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1852707149_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_BadgeImageSource(): ImageSource? {
      val fnPtr = _1852707149_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_BadgeImageSource(value: ImageSource?): Unit {
      val fnPtr = _1852707149_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1852707149_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_BadgeText(): String? {
      val fnPtr = _1852707149_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__1852707149_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_BadgeText(value: String?): Unit {
      val fnPtr = _1852707149_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1852707149_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_IsGroup(): Boolean {
      val fnPtr = _1852707149_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_IsGroup(value: Boolean): Unit {
      val fnPtr = _1852707149_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1852707149_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Contact(): Contact? {
      val fnPtr = _1852707149_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Contact(value: Contact?): Unit {
      val fnPtr = _1852707149_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1852707149_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_DisplayName(): String? {
      val fnPtr = _1852707149_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__1852707149_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_DisplayName(value: String?): Unit {
      val fnPtr = _1852707149_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1852707149_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Initials(): String? {
      val fnPtr = _1852707149_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__1852707149_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Initials(value: String?): Unit {
      val fnPtr = _1852707149_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1852707149_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_PreferSmallImage(): Boolean {
      val fnPtr = _1852707149_VtblPtr!!.getPointer(22L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1852707149_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_PreferSmallImage(value: Boolean): Unit {
      val fnPtr = _1852707149_VtblPtr!!.getPointer(23L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1852707149_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ProfilePicture(): ImageSource? {
      val fnPtr = _1852707149_VtblPtr!!.getPointer(24L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ImageSource>()
      val hr = fn.invokeHR(arrayOf(__1852707149_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ProfilePicture(value: ImageSource?): Unit {
      val fnPtr = _1852707149_VtblPtr!!.getPointer(25L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1852707149_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IPersonPicture_Impl(
    ...
    public override val __1852707149_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPersonPicture, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("6c230b6d0d75405991bc7b174d1d7315")
    ...
    public override fun toNative(obj: IPersonPicture): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1852707149_Ptr))
  }
