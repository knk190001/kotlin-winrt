...
@Signature("{67af84bf-8279-4686-9326-cd189f27575d}")
@Guid("67af84bf827946869326cd189f27575d")
@WinRTInterface("67af84bf827946869326cd189f27575d")
...
public interface IListViewItemTemplateSettings : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IListViewItemTemplateSettings {
    public val __1714341425_Ptr: Pointer?

    public val _1714341425_VtblPtr: Pointer?
      get() = __1714341425_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_DragItemsCount(): Int {
      val fnPtr = _1714341425_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__1714341425_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IListViewItemTemplateSettings_Impl(
    ...
    public override val __1714341425_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IListViewItemTemplateSettings, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("67af84bf827946869326cd189f27575d")
    ...
    public override fun toNative(obj: IListViewItemTemplateSettings): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1714341425_Ptr))
  }
