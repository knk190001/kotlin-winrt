...
@Signature("{a20af5a5-7015-475d-9de3-81a0479dda38}")
@Guid("a20af5a57015475d9de381a0479dda38")
@WinRTInterface("a20af5a57015475d9de381a0479dda38")
...
public interface IRefreshContainerStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IRefreshContainerStatics {
    public val __636939619_Ptr: Pointer?

    public val _636939619_VtblPtr: Pointer?
      get() = __636939619_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_VisualizerProperty(): DependencyProperty? {
      val fnPtr = _636939619_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__636939619_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_PullDirectionProperty(): DependencyProperty? {
      val fnPtr = _636939619_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__636939619_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IRefreshContainerStatics_Impl(
    ...
    public override val __636939619_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IRefreshContainerStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("a20af5a57015475d9de381a0479dda38")
    ...
    public override fun toNative(obj: IRefreshContainerStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__636939619_Ptr))
  }
