...
@Signature("{67bdeb44-20e1-4177-ad44-f617b374e8e8}")
@Guid("67bdeb4420e14177ad44f617b374e8e8")
@WinRTInterface("67bdeb4420e14177ad44f617b374e8e8")
...
public interface ICommandBarFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICommandBarFactory {
    public val __1176741242_Ptr: Pointer?

    public val _1176741242_VtblPtr: Pointer?
      get() = __1176741242_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        CommandBar? {
      val fnPtr = _1176741242_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CommandBar>()
      val hr = fn.invokeHR(arrayOf(__1176741242_Ptr, marshalToNative(baseInterface),
  ...
  public class ICommandBarFactory_Impl(
    ...
    public override val __1176741242_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICommandBarFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("67bdeb4420e14177ad44f617b374e8e8")
    ...
    public override fun toNative(obj: ICommandBarFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1176741242_Ptr))
  }
