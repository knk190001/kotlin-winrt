...
@Signature("{e6766fb7-d96f-4b95-b33c-59e81cb1e9ba}")
@Guid("e6766fb7d96f4b95b33c59e81cb1e9ba")
@WinRTInterface("e6766fb7d96f4b95b33c59e81cb1e9ba")
...
public interface IMediaPlayerPresenterFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IMediaPlayerPresenterFactory {
    public val __1810235819_Ptr: Pointer?

    public val _1810235819_VtblPtr: Pointer?
      get() = __1810235819_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        MediaPlayerPresenter? {
      val fnPtr = _1810235819_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<MediaPlayerPresenter>()
      val hr = fn.invokeHR(arrayOf(__1810235819_Ptr, marshalToNative(baseInterface),
  ...
  public class IMediaPlayerPresenterFactory_Impl(
    ...
    public override val __1810235819_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IMediaPlayerPresenterFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("e6766fb7d96f4b95b33c59e81cb1e9ba")
    ...
    public override fun toNative(obj: IMediaPlayerPresenterFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1810235819_Ptr))
  }
