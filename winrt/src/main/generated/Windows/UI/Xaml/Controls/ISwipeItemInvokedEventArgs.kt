...
@Signature("{c5b025f5-cb32-4733-8011-5d0d37f4550a}")
@Guid("c5b025f5cb32473380115d0d37f4550a")
@WinRTInterface("c5b025f5cb32473380115d0d37f4550a")
...
public interface ISwipeItemInvokedEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISwipeItemInvokedEventArgs {
    public val __589250556_Ptr: Pointer?

    public val _589250556_VtblPtr: Pointer?
      get() = __589250556_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_SwipeControl(): SwipeControl? {
      val fnPtr = _589250556_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<SwipeControl>()
      val hr = fn.invokeHR(arrayOf(__589250556_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ISwipeItemInvokedEventArgs_Impl(
    ...
    public override val __589250556_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISwipeItemInvokedEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("c5b025f5cb32473380115d0d37f4550a")
    ...
    public override fun toNative(obj: ISwipeItemInvokedEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__589250556_Ptr))
  }
