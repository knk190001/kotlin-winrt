...
@Signature("{71fa2b7d-0b51-4950-a1a4-bbc42eac4c12}")
@Guid("71fa2b7d0b514950a1a4bbc42eac4c12")
@WinRTInterface("71fa2b7d0b514950a1a4bbc42eac4c12")
...
public interface IMenuFlyoutSeparator : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IMenuFlyoutSeparator {
    public val __1515065903_Ptr: Pointer?

    public val _1515065903_VtblPtr: Pointer?
      get() = __1515065903_Ptr?.getPointer(0)
  }

  public class IMenuFlyoutSeparator_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __1515065903_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IMenuFlyoutSeparator, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("71fa2b7d0b514950a1a4bbc42eac4c12")
    ...
    public override fun toNative(obj: IMenuFlyoutSeparator): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1515065903_Ptr))
  }
