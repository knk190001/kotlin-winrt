...
@Signature("{4dd04f7f-7a11-4b2e-9933-577df39252b6}")
@Guid("4dd04f7f7a114b2e9933577df39252b6")
@WinRTInterface("4dd04f7f7a114b2e9933577df39252b6")
...
public interface IScrollViewerViewChangingEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IScrollViewerViewChangingEventArgs {
    public val __354083306_Ptr: Pointer?

    public val _354083306_VtblPtr: Pointer?
      get() = __354083306_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_NextView(): ScrollViewerView? {
      val fnPtr = _354083306_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ScrollViewerView>()
      val hr = fn.invokeHR(arrayOf(__354083306_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_FinalView(): ScrollViewerView? {
      val fnPtr = _354083306_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ScrollViewerView>()
      val hr = fn.invokeHR(arrayOf(__354083306_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsInertial(): Boolean {
      val fnPtr = _354083306_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class IScrollViewerViewChangingEventArgs_Impl(
    ...
    public override val __354083306_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IScrollViewerViewChangingEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("4dd04f7f7a114b2e9933577df39252b6")
    ...
    public override fun toNative(obj: IScrollViewerViewChangingEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__354083306_Ptr))
  }
