...
@Signature("{4950b424-a43a-41f7-aa3a-9ce9619747d5}")
@Guid("4950b424a43a41f7aa3a9ce9619747d5")
@WinRTInterface("4950b424a43a41f7aa3a9ce9619747d5")
...
public interface IMenuFlyoutItemStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IMenuFlyoutItemStatics {
    public val __1248881156_Ptr: Pointer?

    public val _1248881156_VtblPtr: Pointer?
      get() = __1248881156_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_TextProperty(): DependencyProperty? {
      val fnPtr = _1248881156_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1248881156_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_CommandProperty(): DependencyProperty? {
      val fnPtr = _1248881156_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1248881156_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_CommandParameterProperty(): DependencyProperty? {
      val fnPtr = _1248881156_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1248881156_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IMenuFlyoutItemStatics_Impl(
    ...
    public override val __1248881156_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IMenuFlyoutItemStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("4950b424a43a41f7aa3a9ce9619747d5")
    ...
    public override fun toNative(obj: IMenuFlyoutItemStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1248881156_Ptr))
  }
