...
@Signature("{a5541db3-7784-4258-aa83-e4bedd727467}")
@Guid("a5541db377844258aa83e4bedd727467")
@WinRTInterface("a5541db377844258aa83e4bedd727467")
...
public interface ITextBoxBeforeTextChangingEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITextBoxBeforeTextChangingEventArgs {
    public val __1717846628_Ptr: Pointer?

    public val _1717846628_VtblPtr: Pointer?
      get() = __1717846628_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_NewText(): String? {
      val fnPtr = _1717846628_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__1717846628_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Cancel(): Boolean {
      val fnPtr = _1717846628_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Cancel(value: Boolean): Unit {
      val fnPtr = _1717846628_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1717846628_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class ITextBoxBeforeTextChangingEventArgs_Impl(
    ...
    public override val __1717846628_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITextBoxBeforeTextChangingEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("a5541db377844258aa83e4bedd727467")
    ...
    public override fun toNative(obj: ITextBoxBeforeTextChangingEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1717846628_Ptr))
  }
