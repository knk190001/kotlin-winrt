...
@Signature("{198289d4-c89b-49b2-896c-5917bf8adcae}")
@Guid("198289d4c89b49b2896c5917bf8adcae")
@WinRTInterface("198289d4c89b49b2896c5917bf8adcae")
...
public interface ISwapChainBackgroundPanelFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISwapChainBackgroundPanelFactory {
    public val __1035904422_Ptr: Pointer?

    public val _1035904422_VtblPtr: Pointer?
      get() = __1035904422_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        SwapChainBackgroundPanel? {
      val fnPtr = _1035904422_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<SwapChainBackgroundPanel>()
      val hr = fn.invokeHR(arrayOf(__1035904422_Ptr, marshalToNative(baseInterface),
  ...
  public class ISwapChainBackgroundPanelFactory_Impl(
    ...
    public override val __1035904422_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISwapChainBackgroundPanelFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("198289d4c89b49b2896c5917bf8adcae")
    ...
    public override fun toNative(obj: ISwapChainBackgroundPanelFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1035904422_Ptr))
  }
