...
@Signature("{0552178b-7567-47c2-bd5c-ad8394c828ba}")
@Guid("0552178b756747c2bd5cad8394c828ba")
@WinRTInterface("0552178b756747c2bd5cad8394c828ba")
...
public interface IWrapGrid : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IWrapGrid {
    public val __1726159564_Ptr: Pointer?

    public val _1726159564_VtblPtr: Pointer?
      get() = __1726159564_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ItemWidth(): Double {
      val fnPtr = _1726159564_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1726159564_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ItemWidth(value: Double): Unit {
      val fnPtr = _1726159564_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1726159564_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_ItemHeight(): Double {
      val fnPtr = _1726159564_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1726159564_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ItemHeight(value: Double): Unit {
      val fnPtr = _1726159564_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1726159564_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Orientation(): Orientation? {
      val fnPtr = _1726159564_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Orientation(value: Orientation?): Unit {
      val fnPtr = _1726159564_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1726159564_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_HorizontalChildrenAlignment(): HorizontalAlignment? {
      val fnPtr = _1726159564_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_HorizontalChildrenAlignment(value: HorizontalAlignment?): Unit {
      val fnPtr = _1726159564_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1726159564_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_VerticalChildrenAlignment(): VerticalAlignment? {
      val fnPtr = _1726159564_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_VerticalChildrenAlignment(value: VerticalAlignment?): Unit {
      val fnPtr = _1726159564_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1726159564_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_MaximumRowsOrColumns(): Int {
      val fnPtr = _1726159564_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_MaximumRowsOrColumns(value: Int): Unit {
      val fnPtr = _1726159564_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1726159564_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IWrapGrid_Impl(
    ...
    public override val __1726159564_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IWrapGrid, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("0552178b756747c2bd5cad8394c828ba")
    ...
    public override fun toNative(obj: IWrapGrid): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1726159564_Ptr))
  }
