...
@Signature("{625d95a2-b6b1-408a-b289-eab2ecba62d8}")
@Guid("625d95a2b6b1408ab289eab2ecba62d8")
@WinRTInterface("625d95a2b6b1408ab289eab2ecba62d8")
...
public interface ISymbolIconSource : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISymbolIconSource {
    public val __1511877064_Ptr: Pointer?

    public val _1511877064_VtblPtr: Pointer?
      get() = __1511877064_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Symbol(): Symbol? {
      val fnPtr = _1511877064_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Symbol>()
      val hr = fn.invokeHR(arrayOf(__1511877064_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Symbol(value: Symbol?): Unit {
      val fnPtr = _1511877064_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1511877064_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class ISymbolIconSource_Impl(
    ...
    public override val __1511877064_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISymbolIconSource, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("625d95a2b6b1408ab289eab2ecba62d8")
    ...
    public override fun toNative(obj: ISymbolIconSource): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1511877064_Ptr))
  }
