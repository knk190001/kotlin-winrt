...
@Signature("rc(Windows.UI.Xaml.Controls.CalendarViewDayItemChangingEventArgs;{73146666-1fb1-44f9-b7ad-4de859ecc565})")
...
public class CalendarViewDayItemChangingEventArgs(
  ...
  private val __2083498022_Interface: ICalendarViewDayItemChangingEventArgs.WithDefault by lazy {
    as_2083498022()
  }


  public override val __2083498022_Ptr: JNAPointer? by lazy {
    __2083498022_Interface.__2083498022_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__2083498022_Interface)

  private fun as_2083498022(): ICalendarViewDayItemChangingEventArgs.WithDefault {
    if(pointer == NULL) {
