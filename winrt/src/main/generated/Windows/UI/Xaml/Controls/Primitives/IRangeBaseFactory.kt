...
@Signature("{389b7c71-5220-42b2-9992-2690c1a67030}")
@Guid("389b7c71522042b299922690c1a67030")
@WinRTInterface("389b7c71522042b299922690c1a67030")
...
public interface IRangeBaseFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IRangeBaseFactory {
    public val __740200872_Ptr: Pointer?

    public val _740200872_VtblPtr: Pointer?
      get() = __740200872_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        RangeBase? {
      val fnPtr = _740200872_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<RangeBase>()
      val hr = fn.invokeHR(arrayOf(__740200872_Ptr, marshalToNative(baseInterface),
  ...
  public class IRangeBaseFactory_Impl(
    ...
    public override val __740200872_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IRangeBaseFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("389b7c71522042b299922690c1a67030")
    ...
    public override fun toNative(obj: IRangeBaseFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__740200872_Ptr))
  }
