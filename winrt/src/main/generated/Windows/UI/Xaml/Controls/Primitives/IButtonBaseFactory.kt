...
@Signature("{389b7c71-5220-42b2-9992-2690c1a6702f}")
@Guid("389b7c71522042b299922690c1a6702f")
@WinRTInterface("389b7c71522042b299922690c1a6702f")
...
public interface IButtonBaseFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IButtonBaseFactory {
    public val __1453972235_Ptr: Pointer?

    public val _1453972235_VtblPtr: Pointer?
      get() = __1453972235_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        ButtonBase? {
      val fnPtr = _1453972235_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ButtonBase>()
      val hr = fn.invokeHR(arrayOf(__1453972235_Ptr, marshalToNative(baseInterface),
  ...
  public class IButtonBaseFactory_Impl(
    ...
    public override val __1453972235_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IButtonBaseFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("389b7c71522042b299922690c1a6702f")
    ...
    public override fun toNative(obj: IButtonBaseFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1453972235_Ptr))
  }
