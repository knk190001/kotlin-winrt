...
@Signature("{c9be2995-d136-4600-b187-8ad56079b48a}")
@Guid("c9be2995d1364600b1878ad56079b48a")
@WinRTInterface("c9be2995d1364600b1878ad56079b48a")
...
public interface ISelectorFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISelectorFactory {
    public val __319040975_Ptr: Pointer?

    public val _319040975_VtblPtr: Pointer?
      get() = __319040975_Ptr?.getPointer(0)
  }

  public class ISelectorFactory_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __319040975_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISelectorFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("c9be2995d1364600b1878ad56079b48a")
    ...
    public override fun toNative(obj: ISelectorFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__319040975_Ptr))
  }
