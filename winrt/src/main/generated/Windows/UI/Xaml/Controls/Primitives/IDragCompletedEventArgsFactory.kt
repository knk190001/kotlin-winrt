...
@Signature("{36a7d99d-148c-495f-a0fc-afc871d62f33}")
@Guid("36a7d99d148c495fa0fcafc871d62f33")
@WinRTInterface("36a7d99d148c495fa0fcafc871d62f33")
...
public interface IDragCompletedEventArgsFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IDragCompletedEventArgsFactory {
    public val __1809509714_Ptr: Pointer?

    public val _1809509714_VtblPtr: Pointer?
      get() = __1809509714_Ptr?.getPointer(0)
    ...
    public override fun CreateInstanceWithHorizontalChangeVerticalChangeAndCanceled(
      ...
      val fnPtr = _1809509714_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DragCompletedEventArgs>()
      val hr = fn.invokeHR(arrayOf(__1809509714_Ptr, horizontalChange, verticalChange, canceled,
  ...
  public class IDragCompletedEventArgsFactory_Impl(
    ...
    public override val __1809509714_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IDragCompletedEventArgsFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("36a7d99d148c495fa0fcafc871d62f33")
    ...
    public override fun toNative(obj: IDragCompletedEventArgsFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1809509714_Ptr))
  }
