...
@Signature("{019fff21-ece6-4fbc-bf40-8938d4813e27}")
@Guid("019fff21ece64fbcbf408938d4813e27")
@WinRTInterface("019fff21ece64fbcbf408938d4813e27")
...
public interface ISemanticZoom : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISemanticZoom {
    public val __155370709_Ptr: Pointer?

    public val _155370709_VtblPtr: Pointer?
      get() = __155370709_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ZoomedInView(): ISemanticZoomInformation? {
      val fnPtr = _155370709_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ISemanticZoomInformation>()
      val hr = fn.invokeHR(arrayOf(__155370709_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ZoomedInView(value: ISemanticZoomInformation?): Unit {
      val fnPtr = _155370709_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__155370709_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_ZoomedOutView(): ISemanticZoomInformation? {
      val fnPtr = _155370709_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ISemanticZoomInformation>()
      val hr = fn.invokeHR(arrayOf(__155370709_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ZoomedOutView(value: ISemanticZoomInformation?): Unit {
      val fnPtr = _155370709_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__155370709_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_IsZoomedInViewActive(): Boolean {
      val fnPtr = _155370709_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_IsZoomedInViewActive(value: Boolean): Unit {
      val fnPtr = _155370709_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__155370709_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_CanChangeViews(): Boolean {
      val fnPtr = _155370709_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__155370709_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_CanChangeViews(value: Boolean): Unit {
      val fnPtr = _155370709_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__155370709_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun add_ViewChangeStarted(handler: SemanticZoomViewChangedEventHandler?):
        EventRegistrationToken? {
      val fnPtr = _155370709_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__155370709_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun remove_ViewChangeStarted(token: EventRegistrationToken?): Unit {
      val fnPtr = _155370709_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__155370709_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun add_ViewChangeCompleted(handler: SemanticZoomViewChangedEventHandler?):
        EventRegistrationToken? {
      val fnPtr = _155370709_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__155370709_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
    ...
    public override fun remove_ViewChangeCompleted(token: EventRegistrationToken?): Unit {
      val fnPtr = _155370709_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__155370709_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun ToggleActiveView(): Unit {
      val fnPtr = _155370709_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__155370709_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_IsZoomOutButtonEnabled(): Boolean {
      val fnPtr = _155370709_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__155370709_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_IsZoomOutButtonEnabled(value: Boolean): Unit {
      val fnPtr = _155370709_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__155370709_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class ISemanticZoom_Impl(
    ...
    public override val __155370709_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISemanticZoom, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("019fff21ece64fbcbf408938d4813e27")
    ...
    public override fun toNative(obj: ISemanticZoom): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__155370709_Ptr))
  }
