...
import Windows.UI.Xaml.Controls.Primitives.ItemsChangedEventArgs
...
@Signature("{5ef6bd7d-677f-408d-a96c-b19507750466}")
@Guid("5ef6bd7d677f408da96cb19507750466")
@WinRTInterface("5ef6bd7d677f408da96cb19507750466")
...
public interface IVirtualizingPanelOverrides : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IVirtualizingPanelOverrides {
    public val __1185492005_Ptr: Pointer?

    public val _1185492005_VtblPtr: Pointer?
      get() = __1185492005_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun OnItemsChanged(sender: IUnknown?, args: ItemsChangedEventArgs?): Unit {
      val fnPtr = _1185492005_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1185492005_Ptr, marshalToNative(sender),
    ...
    public override fun OnClearChildren(): Unit {
      val fnPtr = _1185492005_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1185492005_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun BringIndexIntoView(index: Int): Unit {
      val fnPtr = _1185492005_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1185492005_Ptr, index,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IVirtualizingPanelOverrides_Impl(
    ...
    public override val __1185492005_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IVirtualizingPanelOverrides, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("5ef6bd7d677f408da96cb19507750466")
    ...
    public override fun toNative(obj: IVirtualizingPanelOverrides): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1185492005_Ptr))
  }
