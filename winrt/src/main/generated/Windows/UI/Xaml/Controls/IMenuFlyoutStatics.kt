...
@Signature("{3dbefba1-9522-4045-9e58-c99b13aab9b9}")
@Guid("3dbefba1952240459e58c99b13aab9b9")
@WinRTInterface("3dbefba1952240459e58c99b13aab9b9")
...
public interface IMenuFlyoutStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IMenuFlyoutStatics {
    public val __1624737393_Ptr: Pointer?

    public val _1624737393_VtblPtr: Pointer?
      get() = __1624737393_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_MenuFlyoutPresenterStyleProperty(): DependencyProperty? {
      val fnPtr = _1624737393_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1624737393_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IMenuFlyoutStatics_Impl(
    ...
    public override val __1624737393_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IMenuFlyoutStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("3dbefba1952240459e58c99b13aab9b9")
    ...
    public override fun toNative(obj: IMenuFlyoutStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1624737393_Ptr))
  }
