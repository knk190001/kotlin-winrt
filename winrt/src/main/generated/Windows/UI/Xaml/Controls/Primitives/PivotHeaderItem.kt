...
import Windows.UI.Xaml.Controls.Primitives.IPivotHeaderItemFactory.ABI.IID
...
@Signature("rc(Windows.UI.Xaml.Controls.Primitives.PivotHeaderItem;{594572c2-82aa-410b-9e55-fd8e2c98862d})")
...
public open class PivotHeaderItem(
  ...
  private val __1686756666_Interface: IPivotHeaderItem.WithDefault by lazy {
    as_1686756666()
  }


  public override val __1686756666_Ptr: JNAPointer? by lazy {
    __1686756666_Interface.__1686756666_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1686756666_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1686756666(): IPivotHeaderItem.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<PivotHeaderItem, MemoryAddress> {
    ...
    public fun createIPivotHeaderItemFactory(): IPivotHeaderItemFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.Primitives.PivotHeaderItem".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
