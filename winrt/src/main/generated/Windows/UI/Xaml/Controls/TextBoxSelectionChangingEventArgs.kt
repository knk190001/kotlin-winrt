...
@Signature("rc(Windows.UI.Xaml.Controls.TextBoxSelectionChangingEventArgs;{847a24dd-9abe-52df-a80a-0cce4b496632})")
...
public class TextBoxSelectionChangingEventArgs(
  ...
  private val __2027788320_Interface: ITextBoxSelectionChangingEventArgs.WithDefault by lazy {
    as_2027788320()
  }


  public override val __2027788320_Ptr: JNAPointer? by lazy {
    __2027788320_Interface.__2027788320_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__2027788320_Interface)

  private fun as_2027788320(): ITextBoxSelectionChangingEventArgs.WithDefault {
    if(pointer == NULL) {
