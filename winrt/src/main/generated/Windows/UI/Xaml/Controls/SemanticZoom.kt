...
@Signature("rc(Windows.UI.Xaml.Controls.SemanticZoom;{019fff21-ece6-4fbc-bf40-8938d4813e27})")
...
public class SemanticZoom(
  ...
  private val __155370709_Interface: ISemanticZoom.WithDefault by lazy {
    as_155370709()
  }


  public override val __155370709_Ptr: JNAPointer? by lazy {
    __155370709_Interface.__155370709_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__155370709_Interface)

  public constructor() : this(ABI.activate())

  private fun as_155370709(): ISemanticZoom.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<SemanticZoom, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr = INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.SemanticZoom".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createISemanticZoomStatics(): ISemanticZoomStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.SemanticZoom".toHandle(),refiid,interfacePtr)
