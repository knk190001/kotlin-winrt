...
@Signature("{847a24dd-9abe-52df-a80a-0cce4b496632}")
@Guid("847a24dd9abe52dfa80a0cce4b496632")
@WinRTInterface("847a24dd9abe52dfa80a0cce4b496632")
...
public interface ITextBoxSelectionChangingEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITextBoxSelectionChangingEventArgs {
    public val __2027788320_Ptr: Pointer?

    public val _2027788320_VtblPtr: Pointer?
      get() = __2027788320_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_SelectionStart(): Int {
      val fnPtr = _2027788320_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__2027788320_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_SelectionLength(): Int {
      val fnPtr = _2027788320_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__2027788320_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Cancel(): Boolean {
      val fnPtr = _2027788320_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Cancel(value: Boolean): Unit {
      val fnPtr = _2027788320_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2027788320_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class ITextBoxSelectionChangingEventArgs_Impl(
    ...
    public override val __2027788320_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITextBoxSelectionChangingEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("847a24dd9abe52dfa80a0cce4b496632")
    ...
    public override fun toNative(obj: ITextBoxSelectionChangingEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2027788320_Ptr))
  }
