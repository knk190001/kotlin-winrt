...
@Signature("{8836e49c-0e0e-57d8-9395-f0a9a0d1bb28}")
@Guid("8836e49c0e0e57d89395f0a9a0d1bb28")
@WinRTInterface("8836e49c0e0e57d89395f0a9a0d1bb28")
...
public interface IParallaxViewStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IParallaxViewStatics {
    public val __385120851_Ptr: Pointer?

    public val _385120851_VtblPtr: Pointer?
      get() = __385120851_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ChildProperty(): DependencyProperty? {
      val fnPtr = _385120851_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__385120851_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_HorizontalSourceEndOffsetProperty(): DependencyProperty? {
      val fnPtr = _385120851_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__385120851_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_HorizontalSourceOffsetKindProperty(): DependencyProperty? {
      val fnPtr = _385120851_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__385120851_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_HorizontalSourceStartOffsetProperty(): DependencyProperty? {
      val fnPtr = _385120851_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__385120851_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_MaxHorizontalShiftRatioProperty(): DependencyProperty? {
      val fnPtr = _385120851_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__385120851_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_HorizontalShiftProperty(): DependencyProperty? {
      val fnPtr = _385120851_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__385120851_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsHorizontalShiftClampedProperty(): DependencyProperty? {
      val fnPtr = _385120851_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__385120851_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsVerticalShiftClampedProperty(): DependencyProperty? {
      val fnPtr = _385120851_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__385120851_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_SourceProperty(): DependencyProperty? {
      val fnPtr = _385120851_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__385120851_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_VerticalSourceEndOffsetProperty(): DependencyProperty? {
      val fnPtr = _385120851_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__385120851_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_VerticalSourceOffsetKindProperty(): DependencyProperty? {
      val fnPtr = _385120851_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__385120851_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_VerticalSourceStartOffsetProperty(): DependencyProperty? {
      val fnPtr = _385120851_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__385120851_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_MaxVerticalShiftRatioProperty(): DependencyProperty? {
      val fnPtr = _385120851_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__385120851_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_VerticalShiftProperty(): DependencyProperty? {
      val fnPtr = _385120851_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__385120851_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IParallaxViewStatics_Impl(
    ...
    public override val __385120851_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IParallaxViewStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("8836e49c0e0e57d89395f0a9a0d1bb28")
    ...
    public override fun toNative(obj: IParallaxViewStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__385120851_Ptr))
  }
