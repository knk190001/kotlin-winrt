...
@Signature("{77e525c3-eb17-4b8d-889d-1ea8abdbd4ef}")
@Guid("77e525c3eb174b8d889d1ea8abdbd4ef")
@WinRTInterface("77e525c3eb174b8d889d1ea8abdbd4ef")
...
public interface IMediaPlayerElementFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IMediaPlayerElementFactory {
    public val __2036636393_Ptr: Pointer?

    public val _2036636393_VtblPtr: Pointer?
      get() = __2036636393_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        MediaPlayerElement? {
      val fnPtr = _2036636393_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<MediaPlayerElement>()
      val hr = fn.invokeHR(arrayOf(__2036636393_Ptr, marshalToNative(baseInterface),
  ...
  public class IMediaPlayerElementFactory_Impl(
    ...
    public override val __2036636393_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IMediaPlayerElementFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("77e525c3eb174b8d889d1ea8abdbd4ef")
    ...
    public override fun toNative(obj: IMediaPlayerElementFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2036636393_Ptr))
  }
