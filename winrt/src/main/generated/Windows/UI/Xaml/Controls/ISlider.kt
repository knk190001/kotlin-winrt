...
import Windows.UI.Xaml.Controls.Primitives.SliderSnapsTo
import Windows.UI.Xaml.Controls.Primitives.TickPlacement
...
@Signature("{89572027-4c48-4700-8076-497ba73d9c18}")
@Guid("895720274c4847008076497ba73d9c18")
@WinRTInterface("895720274c4847008076497ba73d9c18")
...
public interface ISlider : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISlider {
    public val __735596541_Ptr: Pointer?

    public val _735596541_VtblPtr: Pointer?
      get() = __735596541_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_IntermediateValue(): Double {
      val fnPtr = _735596541_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__735596541_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_IntermediateValue(value: Double): Unit {
      val fnPtr = _735596541_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__735596541_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_StepFrequency(): Double {
      val fnPtr = _735596541_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__735596541_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_StepFrequency(value: Double): Unit {
      val fnPtr = _735596541_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__735596541_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_SnapsTo(): SliderSnapsTo? {
      val fnPtr = _735596541_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_SnapsTo(value: SliderSnapsTo?): Unit {
      val fnPtr = _735596541_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__735596541_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_TickFrequency(): Double {
      val fnPtr = _735596541_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__735596541_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_TickFrequency(value: Double): Unit {
      val fnPtr = _735596541_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__735596541_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_TickPlacement(): TickPlacement? {
      val fnPtr = _735596541_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_TickPlacement(value: TickPlacement?): Unit {
      val fnPtr = _735596541_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__735596541_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Orientation(): Orientation? {
      val fnPtr = _735596541_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Orientation(value: Orientation?): Unit {
      val fnPtr = _735596541_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__735596541_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_IsDirectionReversed(): Boolean {
      val fnPtr = _735596541_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_IsDirectionReversed(value: Boolean): Unit {
      val fnPtr = _735596541_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__735596541_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_IsThumbToolTipEnabled(): Boolean {
      val fnPtr = _735596541_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__735596541_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_IsThumbToolTipEnabled(value: Boolean): Unit {
      val fnPtr = _735596541_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__735596541_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ThumbToolTipValueConverter(): IValueConverter? {
      val fnPtr = _735596541_VtblPtr!!.getPointer(22L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_ThumbToolTipValueConverter(value: IValueConverter?): Unit {
      val fnPtr = _735596541_VtblPtr!!.getPointer(23L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__735596541_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class ISlider_Impl(
    ...
    public override val __735596541_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISlider, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("895720274c4847008076497ba73d9c18")
    ...
    public override fun toNative(obj: ISlider): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__735596541_Ptr))
  }
