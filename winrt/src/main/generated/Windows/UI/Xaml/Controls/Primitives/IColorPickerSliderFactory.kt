...
@Signature("{06d879a2-8c07-4b1e-a940-9fbce8f49639}")
@Guid("06d879a28c074b1ea9409fbce8f49639")
@WinRTInterface("06d879a28c074b1ea9409fbce8f49639")
...
public interface IColorPickerSliderFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IColorPickerSliderFactory {
    public val __2073679220_Ptr: Pointer?

    public val _2073679220_VtblPtr: Pointer?
      get() = __2073679220_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        ColorPickerSlider? {
      val fnPtr = _2073679220_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ColorPickerSlider>()
      val hr = fn.invokeHR(arrayOf(__2073679220_Ptr, marshalToNative(baseInterface),
  ...
  public class IColorPickerSliderFactory_Impl(
    ...
    public override val __2073679220_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IColorPickerSliderFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("06d879a28c074b1ea9409fbce8f49639")
    ...
    public override fun toNative(obj: IColorPickerSliderFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2073679220_Ptr))
  }
