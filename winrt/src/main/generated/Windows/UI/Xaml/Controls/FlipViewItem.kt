...
import Windows.UI.Xaml.Controls.IFlipViewItemFactory.ABI.IID
...
@Signature("rc(Windows.UI.Xaml.Controls.FlipViewItem;{56196565-ce2b-4bda-a36b-82a2b8b0d4c0})")
...
public open class FlipViewItem(
  ...
  private val __1919350527_Interface: IFlipViewItem.WithDefault by lazy {
    as_1919350527()
  }


  public override val __1919350527_Ptr: JNAPointer? by lazy {
    __1919350527_Interface.__1919350527_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1919350527_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1919350527(): IFlipViewItem.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<FlipViewItem, MemoryAddress> {
    ...
    public fun createIFlipViewItemFactory(): IFlipViewItemFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.FlipViewItem".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
