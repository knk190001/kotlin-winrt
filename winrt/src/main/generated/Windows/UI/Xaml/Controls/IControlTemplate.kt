...
@Signature("{efd2418e-41e0-48bb-8b82-91eda1ba3fe2}")
@Guid("efd2418e41e048bb8b8291eda1ba3fe2")
@WinRTInterface("efd2418e41e048bb8b8291eda1ba3fe2")
...
public interface IControlTemplate : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IControlTemplate {
    public val __572108453_Ptr: Pointer?

    public val _572108453_VtblPtr: Pointer?
      get() = __572108453_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_TargetType(): TypeName? {
      val fnPtr = _572108453_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<TypeName>()
      val hr = fn.invokeHR(arrayOf(__572108453_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_TargetType(value: TypeName?): Unit {
      val fnPtr = _572108453_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__572108453_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IControlTemplate_Impl(
    ...
    public override val __572108453_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IControlTemplate, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("efd2418e41e048bb8b8291eda1ba3fe2")
    ...
    public override fun toNative(obj: IControlTemplate): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__572108453_Ptr))
  }
