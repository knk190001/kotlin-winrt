...
@Signature("{b5384c9b-c8cf-41b3-bf16-18c8420e72c9}")
@Guid("b5384c9bc8cf41b3bf1618c8420e72c9")
@WinRTInterface("b5384c9bc8cf41b3bf1618c8420e72c9")
...
public interface ILayoutInformation : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ILayoutInformation {
    public val __676670534_Ptr: Pointer?

    public val _676670534_VtblPtr: Pointer?
      get() = __676670534_Ptr?.getPointer(0)
  }

  public class ILayoutInformation_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __676670534_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ILayoutInformation, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("b5384c9bc8cf41b3bf1618c8420e72c9")
    ...
    public override fun toNative(obj: ILayoutInformation): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__676670534_Ptr))
  }
