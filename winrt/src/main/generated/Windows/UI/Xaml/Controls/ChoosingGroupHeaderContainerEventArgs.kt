...
@Signature("rc(Windows.UI.Xaml.Controls.ChoosingGroupHeaderContainerEventArgs;{67db44d6-d201-4d72-beac-5e8e58afd8c7})")
...
public class ChoosingGroupHeaderContainerEventArgs(
  ...
  private val __811583186_Interface: IChoosingGroupHeaderContainerEventArgs.WithDefault by lazy {
    as_811583186()
  }


  public override val __811583186_Ptr: JNAPointer? by lazy {
    __811583186_Interface.__811583186_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__811583186_Interface)

  public constructor() : this(ABI.activate())

  private fun as_811583186(): IChoosingGroupHeaderContainerEventArgs.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<ChoosingGroupHeaderContainerEventArgs, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.ChoosingGroupHeaderContainerEventArgs".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
