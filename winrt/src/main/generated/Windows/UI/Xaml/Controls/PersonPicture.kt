...
import Windows.UI.Xaml.Controls.IPersonPictureFactory.ABI.IID
...
@Signature("rc(Windows.UI.Xaml.Controls.PersonPicture;{6c230b6d-0d75-4059-91bc-7b174d1d7315})")
...
public open class PersonPicture(
  ...
  private val __1852707149_Interface: IPersonPicture.WithDefault by lazy {
    as_1852707149()
  }


  public override val __1852707149_Ptr: JNAPointer? by lazy {
    __1852707149_Interface.__1852707149_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1852707149_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1852707149(): IPersonPicture.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<PersonPicture, MemoryAddress> {
    ...
    public fun createIPersonPictureStatics(): IPersonPictureStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.PersonPicture".toHandle(),refiid,interfacePtr)
    ...
    public fun createIPersonPictureFactory(): IPersonPictureFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.PersonPicture".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
