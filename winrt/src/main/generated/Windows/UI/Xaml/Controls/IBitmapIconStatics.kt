...
@Signature("{e072d117-e4e7-4e0c-9470-53ff1ce84f67}")
@Guid("e072d117e4e74e0c947053ff1ce84f67")
@WinRTInterface("e072d117e4e74e0c947053ff1ce84f67")
...
public interface IBitmapIconStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IBitmapIconStatics {
    public val __1178770495_Ptr: Pointer?

    public val _1178770495_VtblPtr: Pointer?
      get() = __1178770495_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_UriSourceProperty(): DependencyProperty? {
      val fnPtr = _1178770495_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1178770495_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IBitmapIconStatics_Impl(
    ...
    public override val __1178770495_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IBitmapIconStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("e072d117e4e74e0c947053ff1ce84f67")
    ...
    public override fun toNative(obj: IBitmapIconStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1178770495_Ptr))
  }
