...
@Signature("{1d389dbe-1cd3-4f4f-83b0-55dc6387685b}")
@Guid("1d389dbe1cd34f4f83b055dc6387685b")
@WinRTInterface("1d389dbe1cd34f4f83b055dc6387685b")
...
public interface IIconSourceStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IIconSourceStatics {
    public val __2919061_Ptr: Pointer?

    public val _2919061_VtblPtr: Pointer?
      get() = __2919061_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ForegroundProperty(): DependencyProperty? {
      val fnPtr = _2919061_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__2919061_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IIconSourceStatics_Impl(
    ...
    public override val __2919061_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IIconSourceStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("1d389dbe1cd34f4f83b055dc6387685b")
    ...
    public override fun toNative(obj: IIconSourceStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2919061_Ptr))
  }
