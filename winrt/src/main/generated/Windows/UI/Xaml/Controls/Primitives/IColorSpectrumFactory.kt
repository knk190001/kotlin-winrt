...
@Signature("{90c7e61e-904d-42ab-b44f-e68dbf0cdee9}")
@Guid("90c7e61e904d42abb44fe68dbf0cdee9")
@WinRTInterface("90c7e61e904d42abb44fe68dbf0cdee9")
...
public interface IColorSpectrumFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IColorSpectrumFactory {
    public val __1031646962_Ptr: Pointer?

    public val _1031646962_VtblPtr: Pointer?
      get() = __1031646962_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        ColorSpectrum? {
      val fnPtr = _1031646962_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ColorSpectrum>()
      val hr = fn.invokeHR(arrayOf(__1031646962_Ptr, marshalToNative(baseInterface),
  ...
  public class IColorSpectrumFactory_Impl(
    ...
    public override val __1031646962_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IColorSpectrumFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("90c7e61e904d42abb44fe68dbf0cdee9")
    ...
    public override fun toNative(obj: IColorSpectrumFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1031646962_Ptr))
  }
