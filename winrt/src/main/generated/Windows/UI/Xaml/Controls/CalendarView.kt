...
import Windows.UI.Xaml.Controls.ICalendarViewFactory.ABI.IID
...
@Signature("rc(Windows.UI.Xaml.Controls.CalendarView;{cd639203-dfb5-4312-ac07-c0391824607b})")
@WinRTByReference(brClass = CalendarView.ByReference::class)
public open class CalendarView(
  ptr: JNAPointer? = NULL
) : Control(ptr), ICalendarView.WithDefault, ICalendarView2.WithDefault, IWinRTObject {
  private val __1009052959_Interface: ICalendarView.WithDefault by lazy {
    as_1009052959()
  }


  private val __1215870707_Interface: ICalendarView2.WithDefault by lazy {
    as_1215870707()
  }


  public override val __1009052959_Ptr: JNAPointer? by lazy {
    __1009052959_Interface.__1009052959_Ptr
  }


  public override val __1215870707_Ptr: JNAPointer? by lazy {
    __1215870707_Interface.__1215870707_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1009052959_Interface, __1215870707_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1009052959(): ICalendarView.WithDefault {
    if(pointer == NULL) {
  ...
  private fun as_1215870707(): ICalendarView2.WithDefault {
    if(pointer == NULL) {
      return(ICalendarView2.ABI.makeICalendarView2(NULL))
    }
    val refiid = Guid.REFIID(guidOf<ICalendarView2>())
    val ref = PointerByReference()
    IUnknownVtbl(pointer.getPointer(0)).queryInterface(pointer, refiid, ref)
    return(ICalendarView2.ABI.makeICalendarView2(ref.value))
  }
  ...
  public object ABI : IABI<CalendarView, MemoryAddress> {
    ...
    public val ICalendarViewStatics2_Instance: ICalendarViewStatics2 by lazy {
      createICalendarViewStatics2()
    }
    ...
    public fun createICalendarViewStatics(): ICalendarViewStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.CalendarView".toHandle(),refiid,interfacePtr)
      val result = ICalendarViewStatics.ABI.makeICalendarViewStatics(interfacePtr.value)
      return result
    }

    public fun createICalendarViewStatics2(): ICalendarViewStatics2 {
      val refiid = Guid.REFIID(ICalendarViewStatics2.ABI.IID)
      val interfacePtr = PointerByReference()
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.CalendarView".toHandle(),refiid,interfacePtr)
      val result = ICalendarViewStatics2.ABI.makeICalendarViewStatics2(interfacePtr.value)
      return result
    }
    ...
    public fun createICalendarViewFactory(): ICalendarViewFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.CalendarView".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
  ...
  public companion object {
    ...
    public fun get_SelectedDisabledBorderBrushProperty() =
        ABI.ICalendarViewStatics2_Instance.get_SelectedDisabledBorderBrushProperty()

    public fun get_TodaySelectedInnerBorderBrushProperty() =
        ABI.ICalendarViewStatics2_Instance.get_TodaySelectedInnerBorderBrushProperty()

    public fun get_BlackoutStrikethroughBrushProperty() =
        ABI.ICalendarViewStatics2_Instance.get_BlackoutStrikethroughBrushProperty()

    public fun get_BlackoutBackgroundProperty() =
        ABI.ICalendarViewStatics2_Instance.get_BlackoutBackgroundProperty()

    public fun get_CalendarItemHoverBackgroundProperty() =
        ABI.ICalendarViewStatics2_Instance.get_CalendarItemHoverBackgroundProperty()

    public fun get_CalendarItemPressedBackgroundProperty() =
        ABI.ICalendarViewStatics2_Instance.get_CalendarItemPressedBackgroundProperty()

    public fun get_CalendarItemDisabledBackgroundProperty() =
        ABI.ICalendarViewStatics2_Instance.get_CalendarItemDisabledBackgroundProperty()

    public fun get_TodayBackgroundProperty() =
        ABI.ICalendarViewStatics2_Instance.get_TodayBackgroundProperty()

    public fun get_TodayBlackoutBackgroundProperty() =
        ABI.ICalendarViewStatics2_Instance.get_TodayBlackoutBackgroundProperty()

    public fun get_TodayHoverBackgroundProperty() =
        ABI.ICalendarViewStatics2_Instance.get_TodayHoverBackgroundProperty()

    public fun get_TodayPressedBackgroundProperty() =
        ABI.ICalendarViewStatics2_Instance.get_TodayPressedBackgroundProperty()

    public fun get_TodayDisabledBackgroundProperty() =
        ABI.ICalendarViewStatics2_Instance.get_TodayDisabledBackgroundProperty()

    public fun get_TodayBlackoutForegroundProperty() =
        ABI.ICalendarViewStatics2_Instance.get_TodayBlackoutForegroundProperty()

    public fun get_SelectedHoverForegroundProperty() =
        ABI.ICalendarViewStatics2_Instance.get_SelectedHoverForegroundProperty()

    public fun get_SelectedPressedForegroundProperty() =
        ABI.ICalendarViewStatics2_Instance.get_SelectedPressedForegroundProperty()

    public fun get_SelectedDisabledForegroundProperty() =
        ABI.ICalendarViewStatics2_Instance.get_SelectedDisabledForegroundProperty()

    public fun get_OutOfScopeHoverForegroundProperty() =
        ABI.ICalendarViewStatics2_Instance.get_OutOfScopeHoverForegroundProperty()

    public fun get_OutOfScopePressedForegroundProperty() =
        ABI.ICalendarViewStatics2_Instance.get_OutOfScopePressedForegroundProperty()

    public fun get_DisabledForegroundProperty() =
        ABI.ICalendarViewStatics2_Instance.get_DisabledForegroundProperty()

    public fun get_DayItemMarginProperty() =
        ABI.ICalendarViewStatics2_Instance.get_DayItemMarginProperty()

    public fun get_MonthYearItemMarginProperty() =
        ABI.ICalendarViewStatics2_Instance.get_MonthYearItemMarginProperty()

    public fun get_FirstOfMonthLabelMarginProperty() =
        ABI.ICalendarViewStatics2_Instance.get_FirstOfMonthLabelMarginProperty()

    public fun get_FirstOfYearDecadeLabelMarginProperty() =
        ABI.ICalendarViewStatics2_Instance.get_FirstOfYearDecadeLabelMarginProperty()

    public fun get_CalendarItemCornerRadiusProperty() =
        ABI.ICalendarViewStatics2_Instance.get_CalendarItemCornerRadiusProperty()
  }
}
