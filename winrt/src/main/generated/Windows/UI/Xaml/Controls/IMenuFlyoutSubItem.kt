...
@Signature("{e5386550-fe2c-43e2-a73f-62168f619973}")
@Guid("e5386550fe2c43e2a73f62168f619973")
@WinRTInterface("e5386550fe2c43e2a73f62168f619973")
...
public interface IMenuFlyoutSubItem : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IMenuFlyoutSubItem {
    public val __1596455107_Ptr: Pointer?

    public val _1596455107_VtblPtr: Pointer?
      get() = __1596455107_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Items(): IVector<MenuFlyoutItemBase?>? {
      val fnPtr = _1596455107_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IVector<MenuFlyoutItemBase?>>()
      val hr = fn.invokeHR(arrayOf(__1596455107_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Text(): String? {
      val fnPtr = _1596455107_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Text(value: String?): Unit {
      val fnPtr = _1596455107_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1596455107_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IMenuFlyoutSubItem_Impl(
    ...
    public override val __1596455107_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IMenuFlyoutSubItem, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("e5386550fe2c43e2a73f62168f619973")
    ...
    public override fun toNative(obj: IMenuFlyoutSubItem): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1596455107_Ptr))
  }
