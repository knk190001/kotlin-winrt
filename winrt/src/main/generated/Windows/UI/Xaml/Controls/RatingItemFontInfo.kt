...
import Windows.UI.Xaml.Controls.IRatingItemFontInfoFactory.ABI.IID
...
@Signature("rc(Windows.UI.Xaml.Controls.RatingItemFontInfo;{054723e9-7989-4d5c-9d01-a7eb876f1071})")
...
public open class RatingItemFontInfo(
  ...
  private val __2067255593_Interface: IRatingItemFontInfo.WithDefault by lazy {
    as_2067255593()
  }


  public override val __2067255593_Ptr: JNAPointer? by lazy {
    __2067255593_Interface.__2067255593_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__2067255593_Interface)

  public constructor() : this(ABI.activate())

  private fun as_2067255593(): IRatingItemFontInfo.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<RatingItemFontInfo, MemoryAddress> {
    ...
    public fun createIRatingItemFontInfoStatics(): IRatingItemFontInfoStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.RatingItemFontInfo".toHandle(),refiid,interfacePtr)
    ...
    public fun createIRatingItemFontInfoFactory(): IRatingItemFontInfoFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.RatingItemFontInfo".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
