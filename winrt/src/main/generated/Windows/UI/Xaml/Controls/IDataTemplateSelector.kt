...
@Signature("{a907d496-46a0-4cd7-8dbe-f9a581df60b1}")
@Guid("a907d49646a04cd78dbef9a581df60b1")
@WinRTInterface("a907d49646a04cd78dbef9a581df60b1")
...
public interface IDataTemplateSelector : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IDataTemplateSelector {
    public val __1268899935_Ptr: Pointer?

    public val _1268899935_VtblPtr: Pointer?
      get() = __1268899935_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun SelectTemplate(item: IUnknown?, container: DependencyObject?):
        DataTemplate? {
      val fnPtr = _1268899935_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DataTemplate>()
      val hr = fn.invokeHR(arrayOf(__1268899935_Ptr, marshalToNative(item),
  ...
  public class IDataTemplateSelector_Impl(
    ...
    public override val __1268899935_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IDataTemplateSelector, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("a907d49646a04cd78dbef9a581df60b1")
    ...
    public override fun toNative(obj: IDataTemplateSelector): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1268899935_Ptr))
  }
