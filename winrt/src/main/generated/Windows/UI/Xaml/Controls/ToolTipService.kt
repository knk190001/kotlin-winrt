...
@Signature("rc(Windows.UI.Xaml.Controls.ToolTipService;{03a55f87-bfcc-4a1e-8fea-98f610832cea})")
@WinRTByReference(brClass = ToolTipService.ByReference::class)
public class ToolTipService(
  ptr: JNAPointer? = NULL
) : PointerType(ptr), IToolTipService.WithDefault, IWinRTObject {
  private val __651629458_Interface: IToolTipService.WithDefault by lazy {
    as_651629458()
  }


  public override val __651629458_Ptr: JNAPointer? by lazy {
    __651629458_Interface.__651629458_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__651629458_Interface)

  private fun as_651629458(): IToolTipService.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<ToolTipService, MemoryAddress> {
    ...
    public fun createIToolTipServiceStatics(): IToolTipServiceStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.ToolTipService".toHandle(),refiid,interfacePtr)
