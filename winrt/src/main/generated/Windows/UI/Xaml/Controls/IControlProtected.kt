...
@Signature("{1791587a-2a7c-4981-a2d8-ab99fffc65b9}")
@Guid("1791587a2a7c4981a2d8ab99fffc65b9")
@WinRTInterface("1791587a2a7c4981a2d8ab99fffc65b9")
...
public interface IControlProtected : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IControlProtected {
    public val __1149207277_Ptr: Pointer?

    public val _1149207277_VtblPtr: Pointer?
      get() = __1149207277_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_DefaultStyleKey(): IUnknown? {
      val fnPtr = _1149207277_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IUnknown>()
      val hr = fn.invokeHR(arrayOf(__1149207277_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_DefaultStyleKey(value: IUnknown?): Unit {
      val fnPtr = _1149207277_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1149207277_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun GetTemplateChild(childName: String?): DependencyObject? {
      val fnPtr = _1149207277_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyObject>()
      val hr = fn.invokeHR(arrayOf(__1149207277_Ptr, marshalToNative(childName), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
  ...
  public class IControlProtected_Impl(
    ...
    public override val __1149207277_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IControlProtected, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("1791587a2a7c4981a2d8ab99fffc65b9")
    ...
    public override fun toNative(obj: IControlProtected): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1149207277_Ptr))
  }
