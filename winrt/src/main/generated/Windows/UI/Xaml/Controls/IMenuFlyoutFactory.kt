...
@Signature("{644533ab-bbb9-499b-9ff3-30d40e2c56d8}")
@Guid("644533abbbb9499b9ff330d40e2c56d8")
@WinRTInterface("644533abbbb9499b9ff330d40e2c56d8")
...
public interface IMenuFlyoutFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IMenuFlyoutFactory {
    public val __819483948_Ptr: Pointer?

    public val _819483948_VtblPtr: Pointer?
      get() = __819483948_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        MenuFlyout? {
      val fnPtr = _819483948_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<MenuFlyout>()
      val hr = fn.invokeHR(arrayOf(__819483948_Ptr, marshalToNative(baseInterface),
  ...
  public class IMenuFlyoutFactory_Impl(
    ...
    public override val __819483948_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IMenuFlyoutFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("644533abbbb9499b9ff330d40e2c56d8")
    ...
    public override fun toNative(obj: IMenuFlyoutFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__819483948_Ptr))
  }
