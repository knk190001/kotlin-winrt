...
@Signature("rc(Windows.UI.Xaml.Controls.TextControlCopyingToClipboardEventArgs;{e405ef19-d0df-43da-ace6-16f9113868c3})")
...
public class TextControlCopyingToClipboardEventArgs(
  ...
  private val __1872643851_Interface: ITextControlCopyingToClipboardEventArgs.WithDefault by lazy {
    as_1872643851()
  }


  public override val __1872643851_Ptr: JNAPointer? by lazy {
    __1872643851_Interface.__1872643851_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1872643851_Interface)

  private fun as_1872643851(): ITextControlCopyingToClipboardEventArgs.WithDefault {
    if(pointer == NULL) {
