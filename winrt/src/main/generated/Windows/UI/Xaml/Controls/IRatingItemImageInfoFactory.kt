...
@Signature("{269e03f2-da79-4787-9f4a-24a6fa56cde2}")
@Guid("269e03f2da7947879f4a24a6fa56cde2")
@WinRTInterface("269e03f2da7947879f4a24a6fa56cde2")
...
public interface IRatingItemImageInfoFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IRatingItemImageInfoFactory {
    public val __954919853_Ptr: Pointer?

    public val _954919853_VtblPtr: Pointer?
      get() = __954919853_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        RatingItemImageInfo? {
      val fnPtr = _954919853_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<RatingItemImageInfo>()
      val hr = fn.invokeHR(arrayOf(__954919853_Ptr, marshalToNative(baseInterface),
  ...
  public class IRatingItemImageInfoFactory_Impl(
    ...
    public override val __954919853_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IRatingItemImageInfoFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("269e03f2da7947879f4a24a6fa56cde2")
    ...
    public override fun toNative(obj: IRatingItemImageInfoFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__954919853_Ptr))
  }
