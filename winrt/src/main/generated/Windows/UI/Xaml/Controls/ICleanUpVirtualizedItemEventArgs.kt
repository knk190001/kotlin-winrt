...
@Signature("{ea05cce9-937c-4120-8406-792185784338}")
@Guid("ea05cce9937c41208406792185784338")
@WinRTInterface("ea05cce9937c41208406792185784338")
...
public interface ICleanUpVirtualizedItemEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICleanUpVirtualizedItemEventArgs {
    public val __2105085775_Ptr: Pointer?

    public val _2105085775_VtblPtr: Pointer?
      get() = __2105085775_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Value(): IUnknown? {
      val fnPtr = _2105085775_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IUnknown>()
      val hr = fn.invokeHR(arrayOf(__2105085775_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_UIElement(): UIElement? {
      val fnPtr = _2105085775_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_Cancel(): Boolean {
      val fnPtr = _2105085775_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Cancel(value: Boolean): Unit {
      val fnPtr = _2105085775_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2105085775_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class ICleanUpVirtualizedItemEventArgs_Impl(
    ...
    public override val __2105085775_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICleanUpVirtualizedItemEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("ea05cce9937c41208406792185784338")
    ...
    public override fun toNative(obj: ICleanUpVirtualizedItemEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2105085775_Ptr))
  }
