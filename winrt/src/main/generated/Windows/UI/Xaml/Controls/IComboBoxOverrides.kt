...
@Signature("{4f016541-bcfe-4a22-8932-c914981c2240}")
@Guid("4f016541bcfe4a228932c914981c2240")
@WinRTInterface("4f016541bcfe4a228932c914981c2240")
...
public interface IComboBoxOverrides : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IComboBoxOverrides {
    public val __1672402094_Ptr: Pointer?

    public val _1672402094_VtblPtr: Pointer?
      get() = __1672402094_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun OnDropDownClosed(e: IUnknown?): Unit {
      val fnPtr = _1672402094_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1672402094_Ptr, marshalToNative(e),))
      if (hr.toInt() != 0) {
    ...
    public override fun OnDropDownOpened(e: IUnknown?): Unit {
      val fnPtr = _1672402094_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1672402094_Ptr, marshalToNative(e),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IComboBoxOverrides_Impl(
    ...
    public override val __1672402094_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IComboBoxOverrides, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("4f016541bcfe4a228932c914981c2240")
    ...
    public override fun toNative(obj: IComboBoxOverrides): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1672402094_Ptr))
  }
