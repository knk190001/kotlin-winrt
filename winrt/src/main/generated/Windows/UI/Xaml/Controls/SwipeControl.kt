...
import Windows.UI.Xaml.Controls.ISwipeControlFactory.ABI.IID
...
@Signature("rc(Windows.UI.Xaml.Controls.SwipeControl;{9ee3d96f-6704-4823-aa15-1c143bc53cf7})")
...
public open class SwipeControl(
  ...
  private val __1541661985_Interface: ISwipeControl.WithDefault by lazy {
    as_1541661985()
  }


  public override val __1541661985_Ptr: JNAPointer? by lazy {
    __1541661985_Interface.__1541661985_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1541661985_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1541661985(): ISwipeControl.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<SwipeControl, MemoryAddress> {
    ...
    public fun createISwipeControlStatics(): ISwipeControlStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.SwipeControl".toHandle(),refiid,interfacePtr)
    ...
    public fun createISwipeControlFactory(): ISwipeControlFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.SwipeControl".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
