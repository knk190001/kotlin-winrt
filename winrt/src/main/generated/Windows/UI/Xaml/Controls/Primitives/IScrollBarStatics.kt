...
@Signature("{45eaf38d-b814-48cf-97f2-539eb16dfd4d}")
@Guid("45eaf38db81448cf97f2539eb16dfd4d")
@WinRTInterface("45eaf38db81448cf97f2539eb16dfd4d")
...
public interface IScrollBarStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IScrollBarStatics {
    public val __483781051_Ptr: Pointer?

    public val _483781051_VtblPtr: Pointer?
      get() = __483781051_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_OrientationProperty(): DependencyProperty? {
      val fnPtr = _483781051_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__483781051_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ViewportSizeProperty(): DependencyProperty? {
      val fnPtr = _483781051_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__483781051_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IndicatorModeProperty(): DependencyProperty? {
      val fnPtr = _483781051_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__483781051_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IScrollBarStatics_Impl(
    ...
    public override val __483781051_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IScrollBarStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("45eaf38db81448cf97f2539eb16dfd4d")
    ...
    public override fun toNative(obj: IScrollBarStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__483781051_Ptr))
  }
