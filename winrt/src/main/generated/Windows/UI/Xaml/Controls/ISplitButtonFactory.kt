...
@Signature("{3201c32f-4d55-589d-97dd-617fa3642137}")
@Guid("3201c32f4d55589d97dd617fa3642137")
@WinRTInterface("3201c32f4d55589d97dd617fa3642137")
...
public interface ISplitButtonFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISplitButtonFactory {
    public val __907346330_Ptr: Pointer?

    public val _907346330_VtblPtr: Pointer?
      get() = __907346330_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        SplitButton? {
      val fnPtr = _907346330_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<SplitButton>()
      val hr = fn.invokeHR(arrayOf(__907346330_Ptr, marshalToNative(baseInterface),
  ...
  public class ISplitButtonFactory_Impl(
    ...
    public override val __907346330_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISplitButtonFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("3201c32f4d55589d97dd617fa3642137")
    ...
    public override fun toNative(obj: ISplitButtonFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__907346330_Ptr))
  }
