...
@Signature("{57d693ad-0c74-54dd-b110-1ee43fabadd9}")
@Guid("57d693ad0c7454ddb1101ee43fabadd9")
@WinRTInterface("57d693ad0c7454ddb1101ee43fabadd9")
...
public interface IFlyoutShowOptions : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IFlyoutShowOptions {
    public val __1290889354_Ptr: Pointer?

    public val _1290889354_VtblPtr: Pointer?
      get() = __1290889354_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Position(): IReference<Point?>? {
      val fnPtr = _1290889354_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IReference<Point?>>()
      val hr = fn.invokeHR(arrayOf(__1290889354_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Position(value: IReference<Point?>?): Unit {
      val fnPtr = _1290889354_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1290889354_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_ExclusionRect(): IReference<Rect?>? {
      val fnPtr = _1290889354_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_ExclusionRect(value: IReference<Rect?>?): Unit {
      val fnPtr = _1290889354_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1290889354_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ShowMode(): FlyoutShowMode? {
      val fnPtr = _1290889354_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_ShowMode(value: FlyoutShowMode?): Unit {
      val fnPtr = _1290889354_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1290889354_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Placement(): FlyoutPlacementMode? {
      val fnPtr = _1290889354_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Placement(value: FlyoutPlacementMode?): Unit {
      val fnPtr = _1290889354_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1290889354_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IFlyoutShowOptions_Impl(
    ...
    public override val __1290889354_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IFlyoutShowOptions, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("57d693ad0c7454ddb1101ee43fabadd9")
    ...
    public override fun toNative(obj: IFlyoutShowOptions): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1290889354_Ptr))
  }
