...
@Signature("{ee4d668f-da76-469a-acd7-3060e613ade7}")
@Guid("ee4d668fda76469aacd73060e613ade7")
@WinRTInterface("ee4d668fda76469aacd73060e613ade7")
...
public interface IFlyoutPresenterFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IFlyoutPresenterFactory {
    public val __1610920057_Ptr: Pointer?

    public val _1610920057_VtblPtr: Pointer?
      get() = __1610920057_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        FlyoutPresenter? {
      val fnPtr = _1610920057_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<FlyoutPresenter>()
      val hr = fn.invokeHR(arrayOf(__1610920057_Ptr, marshalToNative(baseInterface),
  ...
  public class IFlyoutPresenterFactory_Impl(
    ...
    public override val __1610920057_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IFlyoutPresenterFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("ee4d668fda76469aacd73060e613ade7")
    ...
    public override fun toNative(obj: IFlyoutPresenterFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1610920057_Ptr))
  }
