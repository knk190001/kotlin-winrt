...
import Windows.UI.Xaml.Controls.IPathIconSourceFactory.ABI.IID
...
@Signature("rc(Windows.UI.Xaml.Controls.PathIconSource;{1f47010e-b305-4863-8b7a-15d08d633c7a})")
...
public open class PathIconSource(
  ...
  private val __774873877_Interface: IPathIconSource.WithDefault by lazy {
    as_774873877()
  }


  public override val __774873877_Ptr: JNAPointer? by lazy {
    __774873877_Interface.__774873877_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__774873877_Interface)

  public constructor() : this(ABI.activate())

  private fun as_774873877(): IPathIconSource.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<PathIconSource, MemoryAddress> {
    ...
    public fun createIPathIconSourceStatics(): IPathIconSourceStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.PathIconSource".toHandle(),refiid,interfacePtr)
    ...
    public fun createIPathIconSourceFactory(): IPathIconSourceFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.PathIconSource".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
