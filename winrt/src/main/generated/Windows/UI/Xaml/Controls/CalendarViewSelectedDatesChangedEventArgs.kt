...
@Signature("rc(Windows.UI.Xaml.Controls.CalendarViewSelectedDatesChangedEventArgs;{ee6069f6-13ef-4896-8ffc-5302b1b17539})")
...
public class CalendarViewSelectedDatesChangedEventArgs(
  ...
  private val __939526702_Interface: ICalendarViewSelectedDatesChangedEventArgs.WithDefault by
      lazy {
    as_939526702()
  }


  public override val __939526702_Ptr: JNAPointer? by lazy {
    __939526702_Interface.__939526702_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__939526702_Interface)

  private fun as_939526702(): ICalendarViewSelectedDatesChangedEventArgs.WithDefault {
    if(pointer == NULL) {
