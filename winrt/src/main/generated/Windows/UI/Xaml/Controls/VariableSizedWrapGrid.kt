...
@Signature("rc(Windows.UI.Xaml.Controls.VariableSizedWrapGrid;{9ca507c7-23c9-4f01-b80f-be5c21eef474})")
...
public class VariableSizedWrapGrid(
  ...
  private val __878002021_Interface: IVariableSizedWrapGrid.WithDefault by lazy {
    as_878002021()
  }


  public override val __878002021_Ptr: JNAPointer? by lazy {
    __878002021_Interface.__878002021_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__878002021_Interface)

  public constructor() : this(ABI.activate())

  private fun as_878002021(): IVariableSizedWrapGrid.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<VariableSizedWrapGrid, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.VariableSizedWrapGrid".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIVariableSizedWrapGridStatics(): IVariableSizedWrapGridStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.VariableSizedWrapGrid".toHandle(),refiid,interfacePtr)
      val result =
