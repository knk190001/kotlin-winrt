...
@Signature("{9353cc5c-dd6e-453c-aedd-0c3ac993978b}")
@Guid("9353cc5cdd6e453caedd0c3ac993978b")
@WinRTInterface("9353cc5cdd6e453caedd0c3ac993978b")
...
public interface ITreeView : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITreeView {
    public val __897491839_Ptr: Pointer?

    public val _897491839_VtblPtr: Pointer?
      get() = __897491839_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_RootNodes(): IVector<TreeViewNode?>? {
      val fnPtr = _897491839_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IVector<TreeViewNode?>>()
      val hr = fn.invokeHR(arrayOf(__897491839_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_SelectionMode(): TreeViewSelectionMode? {
      val fnPtr = _897491839_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_SelectionMode(value: TreeViewSelectionMode?): Unit {
      val fnPtr = _897491839_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__897491839_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_SelectedNodes(): IVector<TreeViewNode?>? {
      val fnPtr = _897491839_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IVector<TreeViewNode?>>()
      val hr = fn.invokeHR(arrayOf(__897491839_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun Expand(value: TreeViewNode?): Unit {
      val fnPtr = _897491839_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__897491839_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun Collapse(value: TreeViewNode?): Unit {
      val fnPtr = _897491839_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__897491839_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun SelectAll(): Unit {
      val fnPtr = _897491839_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__897491839_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun add_ItemInvoked(handler: TypedEventHandler<TreeView?,
      ...
      val fnPtr = _897491839_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__897491839_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun remove_ItemInvoked(token: EventRegistrationToken?): Unit {
      val fnPtr = _897491839_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__897491839_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun add_Expanding(handler: TypedEventHandler<TreeView?,
      ...
      val fnPtr = _897491839_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__897491839_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
    ...
    public override fun remove_Expanding(token: EventRegistrationToken?): Unit {
      val fnPtr = _897491839_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__897491839_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun add_Collapsed(handler: TypedEventHandler<TreeView?,
      ...
      val fnPtr = _897491839_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__897491839_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
    ...
    public override fun remove_Collapsed(token: EventRegistrationToken?): Unit {
      val fnPtr = _897491839_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__897491839_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class ITreeView_Impl(
    ...
    public override val __897491839_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITreeView, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("9353cc5cdd6e453caedd0c3ac993978b")
    ...
    public override fun toNative(obj: ITreeView): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__897491839_Ptr))
  }
