...
@Signature("{79bb7e8d-dca9-4b5f-a448-37b13238ed76}")
@Guid("79bb7e8ddca94b5fa44837b13238ed76")
@WinRTInterface("79bb7e8ddca94b5fa44837b13238ed76")
...
public interface IAppBarStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IAppBarStatics {
    public val __313328279_Ptr: Pointer?

    public val _313328279_VtblPtr: Pointer?
      get() = __313328279_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_IsOpenProperty(): DependencyProperty? {
      val fnPtr = _313328279_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__313328279_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsStickyProperty(): DependencyProperty? {
      val fnPtr = _313328279_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__313328279_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IAppBarStatics_Impl(
    ...
    public override val __313328279_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IAppBarStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("79bb7e8ddca94b5fa44837b13238ed76")
    ...
    public override fun toNative(obj: IAppBarStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__313328279_Ptr))
  }
