...
@Signature("{46e34db2-77c0-4015-8eb4-92eefdfc5914}")
@Guid("46e34db277c040158eb492eefdfc5914")
@WinRTInterface("46e34db277c040158eb492eefdfc5914")
...
public interface ITextCompositionEndedEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITextCompositionEndedEventArgs {
    public val __104233474_Ptr: Pointer?

    public val _104233474_VtblPtr: Pointer?
      get() = __104233474_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_StartIndex(): Int {
      val fnPtr = _104233474_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__104233474_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Length(): Int {
      val fnPtr = _104233474_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__104233474_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ITextCompositionEndedEventArgs_Impl(
    ...
    public override val __104233474_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITextCompositionEndedEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("46e34db277c040158eb492eefdfc5914")
    ...
    public override fun toNative(obj: ITextCompositionEndedEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__104233474_Ptr))
  }
