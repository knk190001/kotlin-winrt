...
import Windows.UI.Xaml.Controls.Primitives.GeneratorDirection
import Windows.UI.Xaml.Controls.Primitives.GeneratorPosition
import Windows.UI.Xaml.Controls.Primitives.ItemsChangedEventHandler
...
@Signature("{40765f00-83f0-4d7f-b1b8-f19de4f1d5da}")
@Guid("40765f0083f04d7fb1b8f19de4f1d5da")
@WinRTInterface("40765f0083f04d7fb1b8f19de4f1d5da")
...
public interface IItemContainerGenerator : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IItemContainerGenerator {
    public val __1131231519_Ptr: Pointer?

    public val _1131231519_VtblPtr: Pointer?
      get() = __1131231519_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun add_ItemsChanged(handler: ItemsChangedEventHandler?):
        EventRegistrationToken? {
      val fnPtr = _1131231519_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__1131231519_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
    ...
    public override fun remove_ItemsChanged(token: EventRegistrationToken?): Unit {
      val fnPtr = _1131231519_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1131231519_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun ItemFromContainer(container: DependencyObject?): IUnknown? {
      val fnPtr = _1131231519_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IUnknown>()
      val hr = fn.invokeHR(arrayOf(__1131231519_Ptr, marshalToNative(container), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun ContainerFromItem(item: IUnknown?): DependencyObject? {
      val fnPtr = _1131231519_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyObject>()
      val hr = fn.invokeHR(arrayOf(__1131231519_Ptr, marshalToNative(item), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun IndexFromContainer(container: DependencyObject?): Int {
      val fnPtr = _1131231519_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun ContainerFromIndex(index: Int): DependencyObject? {
      val fnPtr = _1131231519_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyObject>()
      val hr = fn.invokeHR(arrayOf(__1131231519_Ptr, index, result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
      val resultValue = marshalFromNative<DependencyObject>(result.getValue())
    ...
    public override fun GetItemContainerGeneratorForPanel(panel: Panel?): ItemContainerGenerator? {
      val fnPtr = _1131231519_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ItemContainerGenerator>()
      val hr = fn.invokeHR(arrayOf(__1131231519_Ptr, marshalToNative(panel), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun StartAt(
      ...
      val fnPtr = _1131231519_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1131231519_Ptr, marshalToNative(position),
    ...
    public override fun Stop(): Unit {
      val fnPtr = _1131231519_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1131231519_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun GenerateNext(isNewlyRealized: Boolean): DependencyObject? {
      val fnPtr = _1131231519_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyObject>()
      val hr = fn.invokeHR(arrayOf(__1131231519_Ptr, isNewlyRealized, result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
      val resultValue = marshalFromNative<DependencyObject>(result.getValue())
    ...
    public override fun PrepareItemContainer(container: DependencyObject?): Unit {
      val fnPtr = _1131231519_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1131231519_Ptr, marshalToNative(container),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun RemoveAll(): Unit {
      val fnPtr = _1131231519_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1131231519_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun Remove(position: GeneratorPosition?, count: Int): Unit {
      val fnPtr = _1131231519_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1131231519_Ptr, marshalToNative(position), count,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun GeneratorPositionFromIndex(itemIndex: Int): GeneratorPosition? {
      val fnPtr = _1131231519_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<GeneratorPosition>()
      val hr = fn.invokeHR(arrayOf(__1131231519_Ptr, itemIndex, result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun IndexFromGeneratorPosition(position: GeneratorPosition?): Int {
      val fnPtr = _1131231519_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__1131231519_Ptr, marshalToNative(position), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
      val resultValue = marshalFromNative<Int>(result.getValue())
    ...
    public override fun Recycle(position: GeneratorPosition?, count: Int): Unit {
      val fnPtr = _1131231519_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1131231519_Ptr, marshalToNative(position), count,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IItemContainerGenerator_Impl(
    ...
    public override val __1131231519_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IItemContainerGenerator, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("40765f0083f04d7fb1b8f19de4f1d5da")
    ...
    public override fun toNative(obj: IItemContainerGenerator): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1131231519_Ptr))
  }
