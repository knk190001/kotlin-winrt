...
@Signature("{803c0081-fda5-4b90-aace-3f2306dbe5c4}")
@Guid("803c0081fda54b90aace3f2306dbe5c4")
@WinRTInterface("803c0081fda54b90aace3f2306dbe5c4")
...
public interface INavigationViewItemStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : INavigationViewItemStatics {
    public val __1873138685_Ptr: Pointer?

    public val _1873138685_VtblPtr: Pointer?
      get() = __1873138685_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_IconProperty(): DependencyProperty? {
      val fnPtr = _1873138685_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1873138685_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_CompactPaneLengthProperty(): DependencyProperty? {
      val fnPtr = _1873138685_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1873138685_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class INavigationViewItemStatics_Impl(
    ...
    public override val __1873138685_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<INavigationViewItemStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("803c0081fda54b90aace3f2306dbe5c4")
    ...
    public override fun toNative(obj: INavigationViewItemStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1873138685_Ptr))
  }
