...
@Signature("{7b0fc253-86a5-4b43-9872-0b8a6234b74b}")
@Guid("7b0fc25386a54b4398720b8a6234b74b")
@WinRTInterface("7b0fc25386a54b4398720b8a6234b74b")
...
public interface IAppBar : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IAppBar {
    public val __224141646_Ptr: Pointer?

    public val _224141646_VtblPtr: Pointer?
      get() = __224141646_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_IsOpen(): Boolean {
      val fnPtr = _224141646_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__224141646_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_IsOpen(value: Boolean): Unit {
      val fnPtr = _224141646_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__224141646_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_IsSticky(): Boolean {
      val fnPtr = _224141646_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__224141646_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_IsSticky(value: Boolean): Unit {
      val fnPtr = _224141646_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__224141646_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun add_Opened(handler: EventHandler<IUnknown?>?): EventRegistrationToken? {
      val fnPtr = _224141646_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__224141646_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun remove_Opened(token: EventRegistrationToken?): Unit {
      val fnPtr = _224141646_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__224141646_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun add_Closed(handler: EventHandler<IUnknown?>?): EventRegistrationToken? {
      val fnPtr = _224141646_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__224141646_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
    ...
    public override fun remove_Closed(token: EventRegistrationToken?): Unit {
      val fnPtr = _224141646_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__224141646_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IAppBar_Impl(
    ...
    public override val __224141646_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IAppBar, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("7b0fc25386a54b4398720b8a6234b74b")
    ...
    public override fun toNative(obj: IAppBar): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__224141646_Ptr))
  }
