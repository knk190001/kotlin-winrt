...
@Signature("{c159dcc8-b437-44e0-b24b-5720aea1dbac}")
@Guid("c159dcc8b43744e0b24b5720aea1dbac")
@WinRTInterface("c159dcc8b43744e0b24b5720aea1dbac")
...
public interface IMenuFlyoutSeparatorFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IMenuFlyoutSeparatorFactory {
    public val __462730203_Ptr: Pointer?

    public val _462730203_VtblPtr: Pointer?
      get() = __462730203_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        MenuFlyoutSeparator? {
      val fnPtr = _462730203_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<MenuFlyoutSeparator>()
      val hr = fn.invokeHR(arrayOf(__462730203_Ptr, marshalToNative(baseInterface),
  ...
  public class IMenuFlyoutSeparatorFactory_Impl(
    ...
    public override val __462730203_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IMenuFlyoutSeparatorFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("c159dcc8b43744e0b24b5720aea1dbac")
    ...
    public override fun toNative(obj: IMenuFlyoutSeparatorFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__462730203_Ptr))
  }
