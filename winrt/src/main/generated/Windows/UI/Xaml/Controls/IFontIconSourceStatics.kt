...
@Signature("{8c0e422f-8269-43b1-b95a-ef070e86770d}")
@Guid("8c0e422f826943b1b95aef070e86770d")
@WinRTInterface("8c0e422f826943b1b95aef070e86770d")
...
public interface IFontIconSourceStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IFontIconSourceStatics {
    public val __1210534906_Ptr: Pointer?

    public val _1210534906_VtblPtr: Pointer?
      get() = __1210534906_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_GlyphProperty(): DependencyProperty? {
      val fnPtr = _1210534906_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1210534906_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_FontSizeProperty(): DependencyProperty? {
      val fnPtr = _1210534906_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1210534906_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_FontFamilyProperty(): DependencyProperty? {
      val fnPtr = _1210534906_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1210534906_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_FontWeightProperty(): DependencyProperty? {
      val fnPtr = _1210534906_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1210534906_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_FontStyleProperty(): DependencyProperty? {
      val fnPtr = _1210534906_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1210534906_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsTextScaleFactorEnabledProperty(): DependencyProperty? {
      val fnPtr = _1210534906_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1210534906_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_MirroredWhenRightToLeftProperty(): DependencyProperty? {
      val fnPtr = _1210534906_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1210534906_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IFontIconSourceStatics_Impl(
    ...
    public override val __1210534906_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IFontIconSourceStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("8c0e422f826943b1b95aef070e86770d")
    ...
    public override fun toNative(obj: IFontIconSourceStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1210534906_Ptr))
  }
