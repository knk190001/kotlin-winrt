...
@Signature("{3b4ca526-2e25-4598-bc71-d491f8e8de39}")
@Guid("3b4ca5262e254598bc71d491f8e8de39")
@WinRTInterface("3b4ca5262e254598bc71d491f8e8de39")
...
public interface IMediaPlayerElement : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IMediaPlayerElement {
    public val __2071327629_Ptr: Pointer?

    public val _2071327629_VtblPtr: Pointer?
      get() = __2071327629_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Source(): IMediaPlaybackSource? {
      val fnPtr = _2071327629_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IMediaPlaybackSource>()
      val hr = fn.invokeHR(arrayOf(__2071327629_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Source(value: IMediaPlaybackSource?): Unit {
      val fnPtr = _2071327629_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2071327629_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_TransportControls(): MediaTransportControls? {
      val fnPtr = _2071327629_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_TransportControls(value: MediaTransportControls?): Unit {
      val fnPtr = _2071327629_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2071327629_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_AreTransportControlsEnabled(): Boolean {
      val fnPtr = _2071327629_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_AreTransportControlsEnabled(value: Boolean): Unit {
      val fnPtr = _2071327629_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2071327629_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_PosterSource(): ImageSource? {
      val fnPtr = _2071327629_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_PosterSource(value: ImageSource?): Unit {
      val fnPtr = _2071327629_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2071327629_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Stretch(): Stretch? {
      val fnPtr = _2071327629_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Stretch(value: Stretch?): Unit {
      val fnPtr = _2071327629_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2071327629_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_AutoPlay(): Boolean {
      val fnPtr = _2071327629_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__2071327629_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_AutoPlay(value: Boolean): Unit {
      val fnPtr = _2071327629_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2071327629_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_IsFullWindow(): Boolean {
      val fnPtr = _2071327629_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__2071327629_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_IsFullWindow(value: Boolean): Unit {
      val fnPtr = _2071327629_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2071327629_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_MediaPlayer(): MediaPlayer? {
      val fnPtr = _2071327629_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun SetMediaPlayer(mediaPlayer: MediaPlayer?): Unit {
      val fnPtr = _2071327629_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2071327629_Ptr, marshalToNative(mediaPlayer),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IMediaPlayerElement_Impl(
    ...
    public override val __2071327629_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IMediaPlayerElement, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("3b4ca5262e254598bc71d491f8e8de39")
    ...
    public override fun toNative(obj: IMediaPlayerElement): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2071327629_Ptr))
  }
