...
@Signature("{af9d9652-9c5d-4a37-9e1a-044abeef792b}")
@Guid("af9d96529c5d4a379e1a044abeef792b")
@WinRTInterface("af9d96529c5d4a379e1a044abeef792b")
...
public interface IPathIconFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPathIconFactory {
    public val __818719408_Ptr: Pointer?

    public val _818719408_VtblPtr: Pointer?
      get() = __818719408_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        PathIcon? {
      val fnPtr = _818719408_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<PathIcon>()
      val hr = fn.invokeHR(arrayOf(__818719408_Ptr, marshalToNative(baseInterface),
  ...
  public class IPathIconFactory_Impl(
    ...
    public override val __818719408_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPathIconFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("af9d96529c5d4a379e1a044abeef792b")
    ...
    public override fun toNative(obj: IPathIconFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__818719408_Ptr))
  }
