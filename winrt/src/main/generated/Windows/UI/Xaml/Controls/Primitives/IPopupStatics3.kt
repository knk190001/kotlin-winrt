...
@Signature("{00789589-c580-558f-945a-7d02ee004d3e}")
@Guid("00789589c580558f945a7d02ee004d3e")
@WinRTInterface("00789589c580558f945a7d02ee004d3e")
...
public interface IPopupStatics3 : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPopupStatics3 {
    public val __1440539522_Ptr: Pointer?

    public val _1440539522_VtblPtr: Pointer?
      get() = __1440539522_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ShouldConstrainToRootBoundsProperty(): DependencyProperty? {
      val fnPtr = _1440539522_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1440539522_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IPopupStatics3_Impl(
    ...
    public override val __1440539522_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPopupStatics3, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("00789589c580558f945a7d02ee004d3e")
    ...
    public override fun toNative(obj: IPopupStatics3): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1440539522_Ptr))
  }
