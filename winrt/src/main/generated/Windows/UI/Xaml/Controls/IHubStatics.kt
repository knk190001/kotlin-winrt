...
@Signature("{0e6fa034-ad3c-4f32-b701-e24fab562028}")
@Guid("0e6fa034ad3c4f32b701e24fab562028")
@WinRTInterface("0e6fa034ad3c4f32b701e24fab562028")
...
public interface IHubStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IHubStatics {
    public val __1555258924_Ptr: Pointer?

    public val _1555258924_VtblPtr: Pointer?
      get() = __1555258924_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_HeaderProperty(): DependencyProperty? {
      val fnPtr = _1555258924_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1555258924_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_HeaderTemplateProperty(): DependencyProperty? {
      val fnPtr = _1555258924_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1555258924_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_OrientationProperty(): DependencyProperty? {
      val fnPtr = _1555258924_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1555258924_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_DefaultSectionIndexProperty(): DependencyProperty? {
      val fnPtr = _1555258924_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1555258924_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_SemanticZoomOwnerProperty(): DependencyProperty? {
      val fnPtr = _1555258924_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1555258924_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsActiveViewProperty(): DependencyProperty? {
      val fnPtr = _1555258924_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1555258924_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsZoomedInViewProperty(): DependencyProperty? {
      val fnPtr = _1555258924_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1555258924_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IHubStatics_Impl(
    ...
    public override val __1555258924_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IHubStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("0e6fa034ad3c4f32b701e24fab562028")
    ...
    public override fun toNative(obj: IHubStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1555258924_Ptr))
  }
