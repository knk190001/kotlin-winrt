...
@Signature("{a151966f-3bf7-46b6-b61c-9b2c1ba68843}")
@Guid("a151966f3bf746b6b61c9b2c1ba68843")
@WinRTInterface("a151966f3bf746b6b61c9b2c1ba68843")
...
public interface IToggleMenuFlyoutItemFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IToggleMenuFlyoutItemFactory {
    public val __1115086157_Ptr: Pointer?

    public val _1115086157_VtblPtr: Pointer?
      get() = __1115086157_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        ToggleMenuFlyoutItem? {
      val fnPtr = _1115086157_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ToggleMenuFlyoutItem>()
      val hr = fn.invokeHR(arrayOf(__1115086157_Ptr, marshalToNative(baseInterface),
  ...
  public class IToggleMenuFlyoutItemFactory_Impl(
    ...
    public override val __1115086157_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IToggleMenuFlyoutItemFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("a151966f3bf746b6b61c9b2c1ba68843")
    ...
    public override fun toNative(obj: IToggleMenuFlyoutItemFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1115086157_Ptr))
  }
