...
@Signature("{8fffe867-d94c-4e87-8fc4-6ebcd63c5ac2}")
@Guid("8fffe867d94c4e878fc46ebcd63c5ac2")
@WinRTInterface("8fffe867d94c4e878fc46ebcd63c5ac2")
...
public interface IComboBoxItemFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IComboBoxItemFactory {
    public val __1598606530_Ptr: Pointer?

    public val _1598606530_VtblPtr: Pointer?
      get() = __1598606530_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        ComboBoxItem? {
      val fnPtr = _1598606530_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ComboBoxItem>()
      val hr = fn.invokeHR(arrayOf(__1598606530_Ptr, marshalToNative(baseInterface),
  ...
  public class IComboBoxItemFactory_Impl(
    ...
    public override val __1598606530_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IComboBoxItemFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("8fffe867d94c4e878fc46ebcd63c5ac2")
    ...
    public override fun toNative(obj: IComboBoxItemFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1598606530_Ptr))
  }
