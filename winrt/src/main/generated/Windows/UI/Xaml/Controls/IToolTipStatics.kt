...
@Signature("{f00285b8-4ba9-4f4f-86a7-86003813ceb3}")
@Guid("f00285b84ba94f4f86a786003813ceb3")
@WinRTInterface("f00285b84ba94f4f86a786003813ceb3")
...
public interface IToolTipStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IToolTipStatics {
    public val __237951618_Ptr: Pointer?

    public val _237951618_VtblPtr: Pointer?
      get() = __237951618_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_HorizontalOffsetProperty(): DependencyProperty? {
      val fnPtr = _237951618_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__237951618_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsOpenProperty(): DependencyProperty? {
      val fnPtr = _237951618_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__237951618_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_PlacementProperty(): DependencyProperty? {
      val fnPtr = _237951618_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__237951618_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_PlacementTargetProperty(): DependencyProperty? {
      val fnPtr = _237951618_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__237951618_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_VerticalOffsetProperty(): DependencyProperty? {
      val fnPtr = _237951618_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__237951618_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IToolTipStatics_Impl(
    ...
    public override val __237951618_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IToolTipStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("f00285b84ba94f4f86a786003813ceb3")
    ...
    public override fun toNative(obj: IToolTipStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__237951618_Ptr))
  }
