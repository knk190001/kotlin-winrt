...
@Signature("{1b5d1336-e61b-4d51-be41-fd8ddc55c58c}")
@Guid("1b5d1336e61b4d51be41fd8ddc55c58c")
@WinRTInterface("1b5d1336e61b4d51be41fd8ddc55c58c")
...
public interface IScrollSnapPointsInfo : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IScrollSnapPointsInfo {
    public val __1877225636_Ptr: Pointer?

    public val _1877225636_VtblPtr: Pointer?
      get() = __1877225636_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_AreHorizontalSnapPointsRegular(): Boolean {
      val fnPtr = _1877225636_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1877225636_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_AreVerticalSnapPointsRegular(): Boolean {
      val fnPtr = _1877225636_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1877225636_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun add_HorizontalSnapPointsChanged(handler: EventHandler<IUnknown?>?):
        EventRegistrationToken? {
      val fnPtr = _1877225636_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__1877225636_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun remove_HorizontalSnapPointsChanged(token: EventRegistrationToken?): Unit {
      val fnPtr = _1877225636_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1877225636_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun add_VerticalSnapPointsChanged(handler: EventHandler<IUnknown?>?):
        EventRegistrationToken? {
      val fnPtr = _1877225636_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__1877225636_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
    ...
    public override fun remove_VerticalSnapPointsChanged(token: EventRegistrationToken?): Unit {
      val fnPtr = _1877225636_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1877225636_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun GetIrregularSnapPoints(orientation: Orientation?,
      ...
      val fnPtr = _1877225636_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IVectorView<Float>>()
      val hr = fn.invokeHR(arrayOf(__1877225636_Ptr, marshalToNative(orientation),
    ...
    public override fun GetRegularSnapPoints(
      ...
      val fnPtr = _1877225636_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class IScrollSnapPointsInfo_Impl(
    ...
    public override val __1877225636_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IScrollSnapPointsInfo, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("1b5d1336e61b4d51be41fd8ddc55c58c")
    ...
    public override fun toNative(obj: IScrollSnapPointsInfo): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1877225636_Ptr))
  }
