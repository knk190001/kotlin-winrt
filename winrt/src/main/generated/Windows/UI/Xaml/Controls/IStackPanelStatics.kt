...
@Signature("{f0d0cd93-4dbc-48a7-9914-954924657771}")
@Guid("f0d0cd934dbc48a79914954924657771")
@WinRTInterface("f0d0cd934dbc48a79914954924657771")
...
public interface IStackPanelStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IStackPanelStatics {
    public val __2104126253_Ptr: Pointer?

    public val _2104126253_VtblPtr: Pointer?
      get() = __2104126253_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_AreScrollSnapPointsRegularProperty(): DependencyProperty? {
      val fnPtr = _2104126253_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__2104126253_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_OrientationProperty(): DependencyProperty? {
      val fnPtr = _2104126253_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__2104126253_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IStackPanelStatics_Impl(
    ...
    public override val __2104126253_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IStackPanelStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("f0d0cd934dbc48a79914954924657771")
    ...
    public override fun toNative(obj: IStackPanelStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2104126253_Ptr))
  }
