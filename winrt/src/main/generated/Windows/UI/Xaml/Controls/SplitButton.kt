...
import Windows.UI.Xaml.Controls.ISplitButtonFactory.ABI.IID
...
@Signature("rc(Windows.UI.Xaml.Controls.SplitButton;{58bbb066-c2ea-5499-8150-40faa75f6bb5})")
...
public open class SplitButton(
  ...
  private val __1565535568_Interface: ISplitButton.WithDefault by lazy {
    as_1565535568()
  }


  public override val __1565535568_Ptr: JNAPointer? by lazy {
    __1565535568_Interface.__1565535568_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1565535568_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1565535568(): ISplitButton.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<SplitButton, MemoryAddress> {
    ...
    public fun createISplitButtonStatics(): ISplitButtonStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.SplitButton".toHandle(),refiid,interfacePtr)
    ...
    public fun createISplitButtonFactory(): ISplitButtonFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.SplitButton".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
