...
@Signature("{8438486b-4b1c-4123-ba0b-73484d68c338}")
@Guid("8438486b4b1c4123ba0b73484d68c338")
@WinRTInterface("8438486b4b1c4123ba0b73484d68c338")
...
public interface IRatingItemImageInfoStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IRatingItemImageInfoStatics {
    public val __149666408_Ptr: Pointer?

    public val _149666408_VtblPtr: Pointer?
      get() = __149666408_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_DisabledImageProperty(): DependencyProperty? {
      val fnPtr = _149666408_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__149666408_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ImageProperty(): DependencyProperty? {
      val fnPtr = _149666408_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__149666408_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_PlaceholderImageProperty(): DependencyProperty? {
      val fnPtr = _149666408_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__149666408_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_PointerOverImageProperty(): DependencyProperty? {
      val fnPtr = _149666408_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__149666408_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_PointerOverPlaceholderImageProperty(): DependencyProperty? {
      val fnPtr = _149666408_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__149666408_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_UnsetImageProperty(): DependencyProperty? {
      val fnPtr = _149666408_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__149666408_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IRatingItemImageInfoStatics_Impl(
    ...
    public override val __149666408_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IRatingItemImageInfoStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("8438486b4b1c4123ba0b73484d68c338")
    ...
    public override fun toNative(obj: IRatingItemImageInfoStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__149666408_Ptr))
  }
