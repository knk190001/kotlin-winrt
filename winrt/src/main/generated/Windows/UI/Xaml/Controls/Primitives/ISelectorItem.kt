...
@Signature("{541c8d6c-0283-4581-b945-2a64c28a0646}")
@Guid("541c8d6c02834581b9452a64c28a0646")
@WinRTInterface("541c8d6c02834581b9452a64c28a0646")
...
public interface ISelectorItem : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISelectorItem {
    public val __1870775186_Ptr: Pointer?

    public val _1870775186_VtblPtr: Pointer?
      get() = __1870775186_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_IsSelected(): Boolean {
      val fnPtr = _1870775186_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1870775186_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_IsSelected(value: Boolean): Unit {
      val fnPtr = _1870775186_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1870775186_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class ISelectorItem_Impl(
    ...
    public override val __1870775186_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISelectorItem, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("541c8d6c02834581b9452a64c28a0646")
    ...
    public override fun toNative(obj: ISelectorItem): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1870775186_Ptr))
  }
