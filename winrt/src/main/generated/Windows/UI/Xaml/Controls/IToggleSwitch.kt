...
import Windows.UI.Xaml.Controls.Primitives.ToggleSwitchTemplateSettings
...
@Signature("{331d8f00-c5f9-46a5-b6c8-ede539304567}")
@Guid("331d8f00c5f946a5b6c8ede539304567")
@WinRTInterface("331d8f00c5f946a5b6c8ede539304567")
...
public interface IToggleSwitch : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IToggleSwitch {
    public val __1810128444_Ptr: Pointer?

    public val _1810128444_VtblPtr: Pointer?
      get() = __1810128444_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_IsOn(): Boolean {
      val fnPtr = _1810128444_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1810128444_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_IsOn(value: Boolean): Unit {
      val fnPtr = _1810128444_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1810128444_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Header(): IUnknown? {
      val fnPtr = _1810128444_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Header(value: IUnknown?): Unit {
      val fnPtr = _1810128444_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1810128444_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_HeaderTemplate(): DataTemplate? {
      val fnPtr = _1810128444_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_HeaderTemplate(value: DataTemplate?): Unit {
      val fnPtr = _1810128444_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1810128444_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_OnContent(): IUnknown? {
      val fnPtr = _1810128444_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IUnknown>()
      val hr = fn.invokeHR(arrayOf(__1810128444_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_OnContent(value: IUnknown?): Unit {
      val fnPtr = _1810128444_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1810128444_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_OnContentTemplate(): DataTemplate? {
      val fnPtr = _1810128444_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DataTemplate>()
      val hr = fn.invokeHR(arrayOf(__1810128444_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_OnContentTemplate(value: DataTemplate?): Unit {
      val fnPtr = _1810128444_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1810128444_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_OffContent(): IUnknown? {
      val fnPtr = _1810128444_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IUnknown>()
      val hr = fn.invokeHR(arrayOf(__1810128444_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_OffContent(value: IUnknown?): Unit {
      val fnPtr = _1810128444_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1810128444_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_OffContentTemplate(): DataTemplate? {
      val fnPtr = _1810128444_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DataTemplate>()
      val hr = fn.invokeHR(arrayOf(__1810128444_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_OffContentTemplate(value: DataTemplate?): Unit {
      val fnPtr = _1810128444_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1810128444_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_TemplateSettings(): ToggleSwitchTemplateSettings? {
      val fnPtr = _1810128444_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun add_Toggled(handler: RoutedEventHandler?): EventRegistrationToken? {
      val fnPtr = _1810128444_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__1810128444_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun remove_Toggled(token: EventRegistrationToken?): Unit {
      val fnPtr = _1810128444_VtblPtr!!.getPointer(22L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1810128444_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IToggleSwitch_Impl(
    ...
    public override val __1810128444_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IToggleSwitch, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("331d8f00c5f946a5b6c8ede539304567")
    ...
    public override fun toNative(obj: IToggleSwitch): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1810128444_Ptr))
  }
