...
import Windows.UI.Xaml.Controls.Primitives.ProgressBarTemplateSettings
...
@Signature("{ae752c89-0067-4963-bf4c-29db0c4a507e}")
@Guid("ae752c8900674963bf4c29db0c4a507e")
@WinRTInterface("ae752c8900674963bf4c29db0c4a507e")
...
public interface IProgressBar : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IProgressBar {
    public val __1175433482_Ptr: Pointer?

    public val _1175433482_VtblPtr: Pointer?
      get() = __1175433482_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_IsIndeterminate(): Boolean {
      val fnPtr = _1175433482_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1175433482_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_IsIndeterminate(value: Boolean): Unit {
      val fnPtr = _1175433482_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1175433482_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_ShowError(): Boolean {
      val fnPtr = _1175433482_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1175433482_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ShowError(value: Boolean): Unit {
      val fnPtr = _1175433482_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1175433482_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ShowPaused(): Boolean {
      val fnPtr = _1175433482_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1175433482_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ShowPaused(value: Boolean): Unit {
      val fnPtr = _1175433482_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1175433482_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_TemplateSettings(): ProgressBarTemplateSettings? {
      val fnPtr = _1175433482_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class IProgressBar_Impl(
    ...
    public override val __1175433482_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IProgressBar, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("ae752c8900674963bf4c29db0c4a507e")
    ...
    public override fun toNative(obj: IProgressBar): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1175433482_Ptr))
  }
