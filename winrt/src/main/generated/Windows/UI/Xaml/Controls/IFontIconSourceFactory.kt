...
@Signature("{8bdcf6bd-fc06-42b8-b30b-7505082ac38f}")
@Guid("8bdcf6bdfc0642b8b30b7505082ac38f")
@WinRTInterface("8bdcf6bdfc0642b8b30b7505082ac38f")
...
public interface IFontIconSourceFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IFontIconSourceFactory {
    public val __405281461_Ptr: Pointer?

    public val _405281461_VtblPtr: Pointer?
      get() = __405281461_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        FontIconSource? {
      val fnPtr = _405281461_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<FontIconSource>()
      val hr = fn.invokeHR(arrayOf(__405281461_Ptr, marshalToNative(baseInterface),
  ...
  public class IFontIconSourceFactory_Impl(
    ...
    public override val __405281461_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IFontIconSourceFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("8bdcf6bdfc0642b8b30b7505082ac38f")
    ...
    public override fun toNative(obj: IFontIconSourceFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__405281461_Ptr))
  }
