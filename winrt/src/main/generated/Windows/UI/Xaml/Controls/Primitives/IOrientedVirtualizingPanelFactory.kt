...
@Signature("{7b8eaeaf-f92f-439d-9ebf-e9919f56c94d}")
@Guid("7b8eaeaff92f439d9ebfe9919f56c94d")
@WinRTInterface("7b8eaeaff92f439d9ebfe9919f56c94d")
...
public interface IOrientedVirtualizingPanelFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IOrientedVirtualizingPanelFactory {
    public val __726456052_Ptr: Pointer?

    public val _726456052_VtblPtr: Pointer?
      get() = __726456052_Ptr?.getPointer(0)
  }

  public class IOrientedVirtualizingPanelFactory_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __726456052_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IOrientedVirtualizingPanelFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("7b8eaeaff92f439d9ebfe9919f56c94d")
    ...
    public override fun toNative(obj: IOrientedVirtualizingPanelFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__726456052_Ptr))
  }
