...
import Windows.UI.Xaml.Controls.ISymbolIconSourceFactory.ABI.IID
...
@Signature("rc(Windows.UI.Xaml.Controls.SymbolIconSource;{625d95a2-b6b1-408a-b289-eab2ecba62d8})")
...
public open class SymbolIconSource(
  ...
  private val __1511877064_Interface: ISymbolIconSource.WithDefault by lazy {
    as_1511877064()
  }


  public override val __1511877064_Ptr: JNAPointer? by lazy {
    __1511877064_Interface.__1511877064_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1511877064_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1511877064(): ISymbolIconSource.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<SymbolIconSource, MemoryAddress> {
    ...
    public fun createISymbolIconSourceStatics(): ISymbolIconSourceStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.SymbolIconSource".toHandle(),refiid,interfacePtr)
    ...
    public fun createISymbolIconSourceFactory(): ISymbolIconSourceFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.SymbolIconSource".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
