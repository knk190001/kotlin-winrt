...
@Signature("rc(Windows.UI.Xaml.Controls.Primitives.TickBar;{994683fa-f1f6-487d-a5ac-c15921bfa995})")
...
public class TickBar(
  ...
  private val __963245786_Interface: ITickBar.WithDefault by lazy {
    as_963245786()
  }


  public override val __963245786_Ptr: JNAPointer? by lazy {
    __963245786_Interface.__963245786_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__963245786_Interface)

  public constructor() : this(ABI.activate())

  private fun as_963245786(): ITickBar.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<TickBar, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.Primitives.TickBar".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createITickBarStatics(): ITickBarStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.Primitives.TickBar".toHandle(),refiid,interfacePtr)
