...
@Signature("{53c9f23a-f25d-446a-99b8-c7aeb839050f}")
@Guid("53c9f23af25d446a99b8c7aeb839050f")
@WinRTInterface("53c9f23af25d446a99b8c7aeb839050f")
...
public interface IItemContainerMapping : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IItemContainerMapping {
    public val __1577324452_Ptr: Pointer?

    public val _1577324452_VtblPtr: Pointer?
      get() = __1577324452_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun ItemFromContainer(container: DependencyObject?): IUnknown? {
      val fnPtr = _1577324452_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IUnknown>()
      val hr = fn.invokeHR(arrayOf(__1577324452_Ptr, marshalToNative(container), result))
      if (hr.toInt() != 0) {
    ...
    public override fun ContainerFromItem(item: IUnknown?): DependencyObject? {
      val fnPtr = _1577324452_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyObject>()
      val hr = fn.invokeHR(arrayOf(__1577324452_Ptr, marshalToNative(item), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun IndexFromContainer(container: DependencyObject?): Int {
      val fnPtr = _1577324452_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun ContainerFromIndex(index: Int): DependencyObject? {
      val fnPtr = _1577324452_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyObject>()
      val hr = fn.invokeHR(arrayOf(__1577324452_Ptr, index, result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
      val resultValue = marshalFromNative<DependencyObject>(result.getValue())
  ...
  public class IItemContainerMapping_Impl(
    ...
    public override val __1577324452_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IItemContainerMapping, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("53c9f23af25d446a99b8c7aeb839050f")
    ...
    public override fun toNative(obj: IItemContainerMapping): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1577324452_Ptr))
  }
