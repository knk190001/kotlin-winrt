...
import Windows.UI.Xaml.Controls.Primitives.PlacementMode
import Windows.UI.Xaml.Controls.Primitives.ToolTipTemplateSettings
...
@Signature("{7de5d75f-4415-429f-b523-699bdb8c30db}")
@Guid("7de5d75f4415429fb523699bdb8c30db")
@WinRTInterface("7de5d75f4415429fb523699bdb8c30db")
...
public interface IToolTip : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IToolTip {
    public val __1987156921_Ptr: Pointer?

    public val _1987156921_VtblPtr: Pointer?
      get() = __1987156921_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_HorizontalOffset(): Double {
      val fnPtr = _1987156921_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1987156921_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_HorizontalOffset(value: Double): Unit {
      val fnPtr = _1987156921_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1987156921_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_IsOpen(): Boolean {
      val fnPtr = _1987156921_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_IsOpen(value: Boolean): Unit {
      val fnPtr = _1987156921_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1987156921_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Placement(): PlacementMode? {
      val fnPtr = _1987156921_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Placement(value: PlacementMode?): Unit {
      val fnPtr = _1987156921_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1987156921_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_PlacementTarget(): UIElement? {
      val fnPtr = _1987156921_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_PlacementTarget(value: UIElement?): Unit {
      val fnPtr = _1987156921_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1987156921_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_VerticalOffset(): Double {
      val fnPtr = _1987156921_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1987156921_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_VerticalOffset(value: Double): Unit {
      val fnPtr = _1987156921_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1987156921_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_TemplateSettings(): ToolTipTemplateSettings? {
      val fnPtr = _1987156921_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun add_Closed(handler: RoutedEventHandler?): EventRegistrationToken? {
      val fnPtr = _1987156921_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__1987156921_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun remove_Closed(token: EventRegistrationToken?): Unit {
      val fnPtr = _1987156921_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1987156921_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun add_Opened(handler: RoutedEventHandler?): EventRegistrationToken? {
      val fnPtr = _1987156921_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__1987156921_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
    ...
    public override fun remove_Opened(token: EventRegistrationToken?): Unit {
      val fnPtr = _1987156921_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1987156921_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IToolTip_Impl(
    ...
    public override val __1987156921_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IToolTip, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("7de5d75f4415429fb523699bdb8c30db")
    ...
    public override fun toNative(obj: IToolTip): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1987156921_Ptr))
  }
