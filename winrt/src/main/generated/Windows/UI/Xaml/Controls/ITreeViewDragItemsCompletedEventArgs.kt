...
@Signature("{3ca8632c-4311-574e-8ab4-3b7aa5de7a88}")
@Guid("3ca8632c4311574e8ab43b7aa5de7a88")
@WinRTInterface("3ca8632c4311574e8ab43b7aa5de7a88")
...
public interface ITreeViewDragItemsCompletedEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITreeViewDragItemsCompletedEventArgs {
    public val __976209511_Ptr: Pointer?

    public val _976209511_VtblPtr: Pointer?
      get() = __976209511_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_DropResult(): DataPackageOperation? {
      val fnPtr = _976209511_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DataPackageOperation>()
      val hr = fn.invokeHR(arrayOf(__976209511_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Items(): IVectorView<IUnknown?>? {
      val fnPtr = _976209511_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class ITreeViewDragItemsCompletedEventArgs_Impl(
    ...
    public override val __976209511_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITreeViewDragItemsCompletedEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("3ca8632c4311574e8ab43b7aa5de7a88")
    ...
    public override fun toNative(obj: ITreeViewDragItemsCompletedEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__976209511_Ptr))
  }
