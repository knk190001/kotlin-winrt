...
@Signature("{af18a436-f38a-4abd-b933-6286c115b07f}")
@Guid("af18a436f38a4abdb9336286c115b07f")
@WinRTInterface("af18a436f38a4abdb9336286c115b07f")
...
public interface IPickerFlyoutStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPickerFlyoutStatics {
    public val __1761140288_Ptr: Pointer?

    public val _1761140288_VtblPtr: Pointer?
      get() = __1761140288_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ContentProperty(): DependencyProperty? {
      val fnPtr = _1761140288_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1761140288_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ConfirmationButtonsVisibleProperty(): DependencyProperty? {
      val fnPtr = _1761140288_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1761140288_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IPickerFlyoutStatics_Impl(
    ...
    public override val __1761140288_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPickerFlyoutStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("af18a436f38a4abdb9336286c115b07f")
    ...
    public override fun toNative(obj: IPickerFlyoutStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1761140288_Ptr))
  }
