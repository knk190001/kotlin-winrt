...
@Signature("{8ef17ef2-9898-4666-b285-3ed38a07910e}")
@Guid("8ef17ef298984666b2853ed38a07910e")
@WinRTInterface("8ef17ef298984666b2853ed38a07910e")
...
public interface ISemanticZoomStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISemanticZoomStatics {
    public val __794274096_Ptr: Pointer?

    public val _794274096_VtblPtr: Pointer?
      get() = __794274096_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ZoomedInViewProperty(): DependencyProperty? {
      val fnPtr = _794274096_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__794274096_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ZoomedOutViewProperty(): DependencyProperty? {
      val fnPtr = _794274096_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__794274096_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsZoomedInViewActiveProperty(): DependencyProperty? {
      val fnPtr = _794274096_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__794274096_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_CanChangeViewsProperty(): DependencyProperty? {
      val fnPtr = _794274096_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__794274096_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsZoomOutButtonEnabledProperty(): DependencyProperty? {
      val fnPtr = _794274096_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__794274096_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ISemanticZoomStatics_Impl(
    ...
    public override val __794274096_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISemanticZoomStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("8ef17ef298984666b2853ed38a07910e")
    ...
    public override fun toNative(obj: ISemanticZoomStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__794274096_Ptr))
  }
