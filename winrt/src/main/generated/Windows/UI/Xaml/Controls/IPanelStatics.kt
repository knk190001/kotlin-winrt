...
@Signature("{f23d6b5d-8330-47a6-a046-25f509b25232}")
@Guid("f23d6b5d833047a6a04625f509b25232")
@WinRTInterface("f23d6b5d833047a6a04625f509b25232")
...
public interface IPanelStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPanelStatics {
    public val __1429934909_Ptr: Pointer?

    public val _1429934909_VtblPtr: Pointer?
      get() = __1429934909_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_BackgroundProperty(): DependencyProperty? {
      val fnPtr = _1429934909_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1429934909_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsItemsHostProperty(): DependencyProperty? {
      val fnPtr = _1429934909_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1429934909_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ChildrenTransitionsProperty(): DependencyProperty? {
      val fnPtr = _1429934909_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1429934909_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IPanelStatics_Impl(
    ...
    public override val __1429934909_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPanelStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("f23d6b5d833047a6a04625f509b25232")
    ...
    public override fun toNative(obj: IPanelStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1429934909_Ptr))
  }
