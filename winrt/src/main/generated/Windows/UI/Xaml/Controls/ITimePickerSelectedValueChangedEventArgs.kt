...
@Signature("{6e20fb35-3b9b-5bb6-9888-266524db181e}")
@Guid("6e20fb353b9b5bb69888266524db181e")
@WinRTInterface("6e20fb353b9b5bb69888266524db181e")
...
public interface ITimePickerSelectedValueChangedEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITimePickerSelectedValueChangedEventArgs {
    public val __293831266_Ptr: Pointer?

    public val _293831266_VtblPtr: Pointer?
      get() = __293831266_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_OldTime(): IReference<TimeSpan?>? {
      val fnPtr = _293831266_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IReference<TimeSpan?>>()
      val hr = fn.invokeHR(arrayOf(__293831266_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_NewTime(): IReference<TimeSpan?>? {
      val fnPtr = _293831266_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IReference<TimeSpan?>>()
      val hr = fn.invokeHR(arrayOf(__293831266_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ITimePickerSelectedValueChangedEventArgs_Impl(
    ...
    public override val __293831266_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITimePickerSelectedValueChangedEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("6e20fb353b9b5bb69888266524db181e")
    ...
    public override fun toNative(obj: ITimePickerSelectedValueChangedEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__293831266_Ptr))
  }
