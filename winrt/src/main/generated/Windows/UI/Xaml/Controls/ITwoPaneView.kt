...
@Signature("{1b4d0db5-14ad-5926-bb8a-5b0a5c0085f0}")
@Guid("1b4d0db514ad5926bb8a5b0a5c0085f0")
@WinRTInterface("1b4d0db514ad5926bb8a5b0a5c0085f0")
...
public interface ITwoPaneView : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITwoPaneView {
    public val __1793690883_Ptr: Pointer?

    public val _1793690883_VtblPtr: Pointer?
      get() = __1793690883_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Pane1(): UIElement? {
      val fnPtr = _1793690883_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<UIElement>()
      val hr = fn.invokeHR(arrayOf(__1793690883_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Pane1(value: UIElement?): Unit {
      val fnPtr = _1793690883_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1793690883_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Pane2(): UIElement? {
      val fnPtr = _1793690883_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<UIElement>()
      val hr = fn.invokeHR(arrayOf(__1793690883_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Pane2(value: UIElement?): Unit {
      val fnPtr = _1793690883_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1793690883_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Pane1Length(): GridLength? {
      val fnPtr = _1793690883_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Pane1Length(value: GridLength?): Unit {
      val fnPtr = _1793690883_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1793690883_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Pane2Length(): GridLength? {
      val fnPtr = _1793690883_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<GridLength>()
      val hr = fn.invokeHR(arrayOf(__1793690883_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Pane2Length(value: GridLength?): Unit {
      val fnPtr = _1793690883_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1793690883_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_PanePriority(): TwoPaneViewPriority? {
      val fnPtr = _1793690883_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_PanePriority(value: TwoPaneViewPriority?): Unit {
      val fnPtr = _1793690883_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1793690883_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Mode(): TwoPaneViewMode? {
      val fnPtr = _1793690883_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_WideModeConfiguration(): TwoPaneViewWideModeConfiguration? {
      val fnPtr = _1793690883_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_WideModeConfiguration(value: TwoPaneViewWideModeConfiguration?): Unit {
      val fnPtr = _1793690883_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1793690883_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_TallModeConfiguration(): TwoPaneViewTallModeConfiguration? {
      val fnPtr = _1793690883_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_TallModeConfiguration(value: TwoPaneViewTallModeConfiguration?): Unit {
      val fnPtr = _1793690883_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1793690883_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_MinWideModeWidth(): Double {
      val fnPtr = _1793690883_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_MinWideModeWidth(value: Double): Unit {
      val fnPtr = _1793690883_VtblPtr!!.getPointer(22L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1793690883_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_MinTallModeHeight(): Double {
      val fnPtr = _1793690883_VtblPtr!!.getPointer(23L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1793690883_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_MinTallModeHeight(value: Double): Unit {
      val fnPtr = _1793690883_VtblPtr!!.getPointer(24L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1793690883_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun add_ModeChanged(handler: TypedEventHandler<TwoPaneView?, IUnknown?>?):
        EventRegistrationToken? {
      val fnPtr = _1793690883_VtblPtr!!.getPointer(25L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__1793690883_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun remove_ModeChanged(token: EventRegistrationToken?): Unit {
      val fnPtr = _1793690883_VtblPtr!!.getPointer(26L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1793690883_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class ITwoPaneView_Impl(
    ...
    public override val __1793690883_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITwoPaneView, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("1b4d0db514ad5926bb8a5b0a5c0085f0")
    ...
    public override fun toNative(obj: ITwoPaneView): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1793690883_Ptr))
  }
