...
@Signature("{fecd2c4d-f16a-58cd-8aca-db0f046f25c3}")
@Guid("fecd2c4df16a58cd8acadb0f046f25c3")
@WinRTInterface("fecd2c4df16a58cd8acadb0f046f25c3")
...
public interface ICommandBarFlyout : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICommandBarFlyout {
    public val __1912512767_Ptr: Pointer?

    public val _1912512767_VtblPtr: Pointer?
      get() = __1912512767_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_PrimaryCommands(): IObservableVector<ICommandBarElement?>? {
      val fnPtr = _1912512767_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IObservableVector<ICommandBarElement?>>()
      val hr = fn.invokeHR(arrayOf(__1912512767_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_SecondaryCommands(): IObservableVector<ICommandBarElement?>? {
      val fnPtr = _1912512767_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IObservableVector<ICommandBarElement?>>()
      val hr = fn.invokeHR(arrayOf(__1912512767_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ICommandBarFlyout_Impl(
    ...
    public override val __1912512767_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICommandBarFlyout, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("fecd2c4df16a58cd8acadb0f046f25c3")
    ...
    public override fun toNative(obj: ICommandBarFlyout): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1912512767_Ptr))
  }
