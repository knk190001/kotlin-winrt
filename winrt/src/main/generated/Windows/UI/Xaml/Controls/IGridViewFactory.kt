...
@Signature("{d9bcca89-09f9-4c6e-a83e-f199146f0e7d}")
@Guid("d9bcca8909f94c6ea83ef199146f0e7d")
@WinRTInterface("d9bcca8909f94c6ea83ef199146f0e7d")
...
public interface IGridViewFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IGridViewFactory {
    public val __1835210723_Ptr: Pointer?

    public val _1835210723_VtblPtr: Pointer?
      get() = __1835210723_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        GridView? {
      val fnPtr = _1835210723_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<GridView>()
      val hr = fn.invokeHR(arrayOf(__1835210723_Ptr, marshalToNative(baseInterface),
  ...
  public class IGridViewFactory_Impl(
    ...
    public override val __1835210723_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IGridViewFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("d9bcca8909f94c6ea83ef199146f0e7d")
    ...
    public override fun toNative(obj: IGridViewFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1835210723_Ptr))
  }
