...
@Signature("{a4e66cb7-7fdd-4fe0-ab49-c246639dccf9}")
@Guid("a4e66cb77fdd4fe0ab49c246639dccf9")
@WinRTInterface("a4e66cb77fdd4fe0ab49c246639dccf9")
...
public interface IHubSection : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IHubSection {
    public val __1127669068_Ptr: Pointer?

    public val _1127669068_VtblPtr: Pointer?
      get() = __1127669068_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Header(): IUnknown? {
      val fnPtr = _1127669068_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IUnknown>()
      val hr = fn.invokeHR(arrayOf(__1127669068_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Header(value: IUnknown?): Unit {
      val fnPtr = _1127669068_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1127669068_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_HeaderTemplate(): DataTemplate? {
      val fnPtr = _1127669068_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_HeaderTemplate(value: DataTemplate?): Unit {
      val fnPtr = _1127669068_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1127669068_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ContentTemplate(): DataTemplate? {
      val fnPtr = _1127669068_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DataTemplate>()
      val hr = fn.invokeHR(arrayOf(__1127669068_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ContentTemplate(value: DataTemplate?): Unit {
      val fnPtr = _1127669068_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1127669068_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_IsHeaderInteractive(): Boolean {
      val fnPtr = _1127669068_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_IsHeaderInteractive(value: Boolean): Unit {
      val fnPtr = _1127669068_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1127669068_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IHubSection_Impl(
    ...
    public override val __1127669068_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IHubSection, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("a4e66cb77fdd4fe0ab49c246639dccf9")
    ...
    public override fun toNative(obj: IHubSection): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1127669068_Ptr))
  }
