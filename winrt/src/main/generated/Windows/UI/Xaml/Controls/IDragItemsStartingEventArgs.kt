...
@Signature("{71cf215c-daed-4783-aa11-dc574d2713e9}")
@Guid("71cf215cdaed4783aa11dc574d2713e9")
@WinRTInterface("71cf215cdaed4783aa11dc574d2713e9")
...
public interface IDragItemsStartingEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IDragItemsStartingEventArgs {
    public val __228302279_Ptr: Pointer?

    public val _228302279_VtblPtr: Pointer?
      get() = __228302279_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Cancel(): Boolean {
      val fnPtr = _228302279_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__228302279_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Cancel(value: Boolean): Unit {
      val fnPtr = _228302279_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__228302279_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Items(): IVector<IUnknown?>? {
      val fnPtr = _228302279_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_Data(): DataPackage? {
      val fnPtr = _228302279_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class IDragItemsStartingEventArgs_Impl(
    ...
    public override val __228302279_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IDragItemsStartingEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("71cf215cdaed4783aa11dc574d2713e9")
    ...
    public override fun toNative(obj: IDragItemsStartingEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__228302279_Ptr))
  }
