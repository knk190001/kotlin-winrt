...
@Signature("{4ea32731-568d-4d0d-adfd-3d8dc5aa5d88}")
@Guid("4ea32731568d4d0dadfd3d8dc5aa5d88")
@WinRTInterface("4ea32731568d4d0dadfd3d8dc5aa5d88")
...
public interface ITreeViewItemFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITreeViewItemFactory {
    public val __5213832_Ptr: Pointer?

    public val _5213832_VtblPtr: Pointer?
      get() = __5213832_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        TreeViewItem? {
      val fnPtr = _5213832_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<TreeViewItem>()
      val hr = fn.invokeHR(arrayOf(__5213832_Ptr, marshalToNative(baseInterface),
  ...
  public class ITreeViewItemFactory_Impl(
    ...
    public override val __5213832_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITreeViewItemFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("4ea32731568d4d0dadfd3d8dc5aa5d88")
    ...
    public override fun toNative(obj: ITreeViewItemFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__5213832_Ptr))
  }
