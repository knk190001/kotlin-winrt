...
@Signature("{61a1df62-2806-41ed-88ed-ae21f47ab422}")
@Guid("61a1df62280641ed88edae21f47ab422")
@WinRTInterface("61a1df62280641ed88edae21f47ab422")
...
public interface IRichEditBoxFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IRichEditBoxFactory {
    public val __649107329_Ptr: Pointer?

    public val _649107329_VtblPtr: Pointer?
      get() = __649107329_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        RichEditBox? {
      val fnPtr = _649107329_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<RichEditBox>()
      val hr = fn.invokeHR(arrayOf(__649107329_Ptr, marshalToNative(baseInterface),
  ...
  public class IRichEditBoxFactory_Impl(
    ...
    public override val __649107329_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IRichEditBoxFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("61a1df62280641ed88edae21f47ab422")
    ...
    public override fun toNative(obj: IRichEditBoxFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__649107329_Ptr))
  }
