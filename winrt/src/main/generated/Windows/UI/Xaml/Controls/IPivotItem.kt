...
@Signature("{a4764371-a502-47a3-915e-4aa096daf87f}")
@Guid("a4764371a50247a3915e4aa096daf87f")
@WinRTInterface("a4764371a50247a3915e4aa096daf87f")
...
public interface IPivotItem : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPivotItem {
    public val __407653849_Ptr: Pointer?

    public val _407653849_VtblPtr: Pointer?
      get() = __407653849_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Header(): IUnknown? {
      val fnPtr = _407653849_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IUnknown>()
      val hr = fn.invokeHR(arrayOf(__407653849_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Header(value: IUnknown?): Unit {
      val fnPtr = _407653849_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__407653849_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IPivotItem_Impl(
    ...
    public override val __407653849_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPivotItem, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("a4764371a50247a3915e4aa096daf87f")
    ...
    public override fun toNative(obj: IPivotItem): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__407653849_Ptr))
  }
