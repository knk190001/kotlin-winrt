...
import Windows.UI.Xaml.Controls.IRefreshVisualizerFactory.ABI.IID
...
@Signature("rc(Windows.UI.Xaml.Controls.RefreshVisualizer;{c0e30122-f3eb-4baa-a11f-c3f87342cbf4})")
...
public open class RefreshVisualizer(
  ...
  private val __1559613059_Interface: IRefreshVisualizer.WithDefault by lazy {
    as_1559613059()
  }


  public override val __1559613059_Ptr: JNAPointer? by lazy {
    __1559613059_Interface.__1559613059_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1559613059_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1559613059(): IRefreshVisualizer.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<RefreshVisualizer, MemoryAddress> {
    ...
    public fun createIRefreshVisualizerStatics(): IRefreshVisualizerStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.RefreshVisualizer".toHandle(),refiid,interfacePtr)
    ...
    public fun createIRefreshVisualizerFactory(): IRefreshVisualizerFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.RefreshVisualizer".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
