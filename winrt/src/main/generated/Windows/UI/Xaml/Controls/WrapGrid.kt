...
@Signature("rc(Windows.UI.Xaml.Controls.WrapGrid;{0552178b-7567-47c2-bd5c-ad8394c828ba})")
...
public class WrapGrid(
  ...
  private val __1726159564_Interface: IWrapGrid.WithDefault by lazy {
    as_1726159564()
  }


  public override val __1726159564_Ptr: JNAPointer? by lazy {
    __1726159564_Interface.__1726159564_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1726159564_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1726159564(): IWrapGrid.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<WrapGrid, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr = INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.WrapGrid".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIWrapGridStatics(): IWrapGridStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.WrapGrid".toHandle(),refiid,interfacePtr)
