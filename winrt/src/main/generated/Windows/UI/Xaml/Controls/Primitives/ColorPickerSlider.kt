...
import Windows.UI.Xaml.Controls.Primitives.IColorPickerSliderFactory.ABI.IID
...
@Signature("rc(Windows.UI.Xaml.Controls.Primitives.ColorPickerSlider;{94394d83-e0df-4c5f-bbcd-8155f4020440})")
...
public open class ColorPickerSlider(
  ...
  private val __2188618_Interface: IColorPickerSlider.WithDefault by lazy {
    as_2188618()
  }


  public override val __2188618_Ptr: JNAPointer? by lazy {
    __2188618_Interface.__2188618_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__2188618_Interface)

  public constructor() : this(ABI.activate())

  private fun as_2188618(): IColorPickerSlider.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<ColorPickerSlider, MemoryAddress> {
    ...
    public fun createIColorPickerSliderStatics(): IColorPickerSliderStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.Primitives.ColorPickerSlider".toHandle(),refiid,interfacePtr)
    ...
    public fun createIColorPickerSliderFactory(): IColorPickerSliderFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.Primitives.ColorPickerSlider".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
