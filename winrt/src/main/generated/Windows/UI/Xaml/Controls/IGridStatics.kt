...
@Signature("{64fe2e9f-f951-42b6-a9ce-bb179af11595}")
@Guid("64fe2e9ff95142b6a9cebb179af11595")
@WinRTInterface("64fe2e9ff95142b6a9cebb179af11595")
...
public interface IGridStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IGridStatics {
    public val __159525891_Ptr: Pointer?

    public val _159525891_VtblPtr: Pointer?
      get() = __159525891_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_RowProperty(): DependencyProperty? {
      val fnPtr = _159525891_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__159525891_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetRow(element: FrameworkElement?): Int {
      val fnPtr = _159525891_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__159525891_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun SetRow(element: FrameworkElement?, value: Int): Unit {
      val fnPtr = _159525891_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__159525891_Ptr, marshalToNative(element), value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_ColumnProperty(): DependencyProperty? {
      val fnPtr = _159525891_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__159525891_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetColumn(element: FrameworkElement?): Int {
      val fnPtr = _159525891_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__159525891_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
    ...
    public override fun SetColumn(element: FrameworkElement?, value: Int): Unit {
      val fnPtr = _159525891_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__159525891_Ptr, marshalToNative(element), value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_RowSpanProperty(): DependencyProperty? {
      val fnPtr = _159525891_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__159525891_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetRowSpan(element: FrameworkElement?): Int {
      val fnPtr = _159525891_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__159525891_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
    ...
    public override fun SetRowSpan(element: FrameworkElement?, value: Int): Unit {
      val fnPtr = _159525891_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__159525891_Ptr, marshalToNative(element), value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ColumnSpanProperty(): DependencyProperty? {
      val fnPtr = _159525891_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__159525891_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetColumnSpan(element: FrameworkElement?): Int {
      val fnPtr = _159525891_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__159525891_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
    ...
    public override fun SetColumnSpan(element: FrameworkElement?, value: Int): Unit {
      val fnPtr = _159525891_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__159525891_Ptr, marshalToNative(element), value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IGridStatics_Impl(
    ...
    public override val __159525891_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IGridStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("64fe2e9ff95142b6a9cebb179af11595")
    ...
    public override fun toNative(obj: IGridStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__159525891_Ptr))
  }
