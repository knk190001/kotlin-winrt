...
import Windows.UI.Xaml.Controls.IMenuFlyoutSeparatorFactory.ABI.IID
...
@Signature("rc(Windows.UI.Xaml.Controls.MenuFlyoutSeparator;{71fa2b7d-0b51-4950-a1a4-bbc42eac4c12})")
...
public open class MenuFlyoutSeparator(
  ...
  private val __1515065903_Interface: IMenuFlyoutSeparator.WithDefault by lazy {
    as_1515065903()
  }


  public override val __1515065903_Ptr: JNAPointer? by lazy {
    __1515065903_Interface.__1515065903_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1515065903_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1515065903(): IMenuFlyoutSeparator.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<MenuFlyoutSeparator, MemoryAddress> {
    ...
    public fun createIMenuFlyoutSeparatorFactory(): IMenuFlyoutSeparatorFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.MenuFlyoutSeparator".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
