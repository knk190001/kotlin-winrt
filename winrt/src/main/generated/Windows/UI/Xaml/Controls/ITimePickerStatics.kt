...
@Signature("{fa71dfb1-233e-4f31-b8be-a6ea670c25cd}")
@Guid("fa71dfb1233e4f31b8bea6ea670c25cd")
@WinRTInterface("fa71dfb1233e4f31b8bea6ea670c25cd")
...
public interface ITimePickerStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITimePickerStatics {
    public val __1804592366_Ptr: Pointer?

    public val _1804592366_VtblPtr: Pointer?
      get() = __1804592366_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_HeaderProperty(): DependencyProperty? {
      val fnPtr = _1804592366_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1804592366_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_HeaderTemplateProperty(): DependencyProperty? {
      val fnPtr = _1804592366_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1804592366_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ClockIdentifierProperty(): DependencyProperty? {
      val fnPtr = _1804592366_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1804592366_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_MinuteIncrementProperty(): DependencyProperty? {
      val fnPtr = _1804592366_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1804592366_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_TimeProperty(): DependencyProperty? {
      val fnPtr = _1804592366_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1804592366_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ITimePickerStatics_Impl(
    ...
    public override val __1804592366_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITimePickerStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("fa71dfb1233e4f31b8bea6ea670c25cd")
    ...
    public override fun toNative(obj: ITimePickerStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1804592366_Ptr))
  }
