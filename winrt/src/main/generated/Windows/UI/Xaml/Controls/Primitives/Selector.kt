...
@Signature("rc(Windows.UI.Xaml.Controls.Primitives.Selector;{e30eb3a5-b36b-42dc-8527-cd25136c083c})")
...
public open class Selector(
  ...
  private val __948886853_Interface: ISelector.WithDefault by lazy {
    as_948886853()
  }


  public override val __948886853_Ptr: JNAPointer? by lazy {
    __948886853_Interface.__948886853_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__948886853_Interface)

  private fun as_948886853(): ISelector.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<Selector, MemoryAddress> {
    ...
    public fun createISelectorStatics(): ISelectorStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.Primitives.Selector".toHandle(),refiid,interfacePtr)
