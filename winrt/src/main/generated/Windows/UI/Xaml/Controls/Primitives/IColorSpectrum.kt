...
import Windows.UI.Xaml.Controls.ColorChangedEventArgs
import Windows.UI.Xaml.Controls.ColorSpectrumComponents
import Windows.UI.Xaml.Controls.ColorSpectrumShape
...
@Signature("{ce46f271-f509-4f98-8288-e4942fb385df}")
@Guid("ce46f271f5094f988288e4942fb385df")
@WinRTInterface("ce46f271f5094f988288e4942fb385df")
...
public interface IColorSpectrum : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IColorSpectrum {
    public val __620145928_Ptr: Pointer?

    public val _620145928_VtblPtr: Pointer?
      get() = __620145928_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Color(): Color? {
      val fnPtr = _620145928_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__620145928_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Color(value: Color?): Unit {
      val fnPtr = _620145928_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__620145928_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_HsvColor(): Vector4? {
      val fnPtr = _620145928_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_HsvColor(value: Vector4?): Unit {
      val fnPtr = _620145928_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__620145928_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_MinHue(): Int {
      val fnPtr = _620145928_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_MinHue(value: Int): Unit {
      val fnPtr = _620145928_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__620145928_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_MaxHue(): Int {
      val fnPtr = _620145928_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__620145928_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_MaxHue(value: Int): Unit {
      val fnPtr = _620145928_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__620145928_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_MinSaturation(): Int {
      val fnPtr = _620145928_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__620145928_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_MinSaturation(value: Int): Unit {
      val fnPtr = _620145928_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__620145928_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_MaxSaturation(): Int {
      val fnPtr = _620145928_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__620145928_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_MaxSaturation(value: Int): Unit {
      val fnPtr = _620145928_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__620145928_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_MinValue(): Int {
      val fnPtr = _620145928_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__620145928_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_MinValue(value: Int): Unit {
      val fnPtr = _620145928_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__620145928_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_MaxValue(): Int {
      val fnPtr = _620145928_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__620145928_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_MaxValue(value: Int): Unit {
      val fnPtr = _620145928_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__620145928_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Shape(): ColorSpectrumShape? {
      val fnPtr = _620145928_VtblPtr!!.getPointer(22L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Shape(value: ColorSpectrumShape?): Unit {
      val fnPtr = _620145928_VtblPtr!!.getPointer(23L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__620145928_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Components(): ColorSpectrumComponents? {
      val fnPtr = _620145928_VtblPtr!!.getPointer(24L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Components(value: ColorSpectrumComponents?): Unit {
      val fnPtr = _620145928_VtblPtr!!.getPointer(25L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__620145928_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun add_ColorChanged(handler: TypedEventHandler<ColorSpectrum?,
      ...
      val fnPtr = _620145928_VtblPtr!!.getPointer(26L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__620145928_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun remove_ColorChanged(token: EventRegistrationToken?): Unit {
      val fnPtr = _620145928_VtblPtr!!.getPointer(27L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__620145928_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IColorSpectrum_Impl(
    ...
    public override val __620145928_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IColorSpectrum, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("ce46f271f5094f988288e4942fb385df")
    ...
    public override fun toNative(obj: IColorSpectrum): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__620145928_Ptr))
  }
