...
import Windows.UI.Xaml.Controls.IHubSectionFactory.ABI.IID
...
@Signature("rc(Windows.UI.Xaml.Controls.HubSection;{a4e66cb7-7fdd-4fe0-ab49-c246639dccf9})")
...
public open class HubSection(
  ...
  private val __1127669068_Interface: IHubSection.WithDefault by lazy {
    as_1127669068()
  }


  public override val __1127669068_Ptr: JNAPointer? by lazy {
    __1127669068_Interface.__1127669068_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1127669068_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1127669068(): IHubSection.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<HubSection, MemoryAddress> {
    ...
    public fun createIHubSectionStatics(): IHubSectionStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.HubSection".toHandle(),refiid,interfacePtr)
    ...
    public fun createIHubSectionFactory(): IHubSectionFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.HubSection".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
