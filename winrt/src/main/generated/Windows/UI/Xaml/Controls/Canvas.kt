...
import Windows.UI.Xaml.Controls.ICanvasFactory.ABI.IID
...
@Signature("rc(Windows.UI.Xaml.Controls.Canvas;{79190e19-cd38-4823-aeae-64a77132f519})")
@WinRTByReference(brClass = Canvas.ByReference::class)
public open class Canvas(
  ptr: JNAPointer? = NULL
) : Panel(ptr), ICanvas.WithDefault, IWinRTObject {
  private val __267537524_Interface: ICanvas.WithDefault by lazy {
    as_267537524()
  }


  public override val __267537524_Ptr: JNAPointer? by lazy {
    __267537524_Interface.__267537524_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__267537524_Interface)

  public constructor() : this(ABI.activate())

  private fun as_267537524(): ICanvas.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<Canvas, MemoryAddress> {
    ...
    public fun createICanvasStatics(): ICanvasStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.Canvas".toHandle(),refiid,interfacePtr)
    ...
    public fun createICanvasFactory(): ICanvasFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.Canvas".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
