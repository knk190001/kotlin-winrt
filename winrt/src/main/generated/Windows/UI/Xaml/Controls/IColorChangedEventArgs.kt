...
@Signature("{34f7201f-aad0-4c3a-b97b-2abf36455539}")
@Guid("34f7201faad04c3ab97b2abf36455539")
@WinRTInterface("34f7201faad04c3ab97b2abf36455539")
...
public interface IColorChangedEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IColorChangedEventArgs {
    public val __1616985386_Ptr: Pointer?

    public val _1616985386_VtblPtr: Pointer?
      get() = __1616985386_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_OldColor(): Color? {
      val fnPtr = _1616985386_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1616985386_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_NewColor(): Color? {
      val fnPtr = _1616985386_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1616985386_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IColorChangedEventArgs_Impl(
    ...
    public override val __1616985386_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IColorChangedEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("34f7201faad04c3ab97b2abf36455539")
    ...
    public override fun toNative(obj: IColorChangedEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1616985386_Ptr))
  }
