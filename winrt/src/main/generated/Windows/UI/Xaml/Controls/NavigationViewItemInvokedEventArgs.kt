...
@Signature("rc(Windows.UI.Xaml.Controls.NavigationViewItemInvokedEventArgs;{29496822-55d2-49fa-964b-f1dbafef85c4})")
...
public class NavigationViewItemInvokedEventArgs(
  ...
  private val __1530944557_Interface: INavigationViewItemInvokedEventArgs.WithDefault by lazy {
    as_1530944557()
  }


  private val __214640961_Interface: INavigationViewItemInvokedEventArgs2.WithDefault by lazy {
    as_214640961()
  }


  public override val __1530944557_Ptr: JNAPointer? by lazy {
    __1530944557_Interface.__1530944557_Ptr
  }


  public override val __214640961_Ptr: JNAPointer? by lazy {
    __214640961_Interface.__214640961_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1530944557_Interface, __214640961_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1530944557(): INavigationViewItemInvokedEventArgs.WithDefault {
    if(pointer == NULL) {
  ...
  private fun as_214640961(): INavigationViewItemInvokedEventArgs2.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<NavigationViewItemInvokedEventArgs, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.NavigationViewItemInvokedEventArgs".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
