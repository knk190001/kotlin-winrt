...
@Signature("{86e649f8-e245-48aa-a8c8-d1073ed76319}")
@Guid("86e649f8e24548aaa8c8d1073ed76319")
@WinRTInterface("86e649f8e24548aaa8c8d1073ed76319")
...
public interface IToolTipServiceStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IToolTipServiceStatics {
    public val __874214263_Ptr: Pointer?

    public val _874214263_VtblPtr: Pointer?
      get() = __874214263_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_PlacementProperty(): DependencyProperty? {
      val fnPtr = _874214263_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__874214263_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetPlacement(element: DependencyObject?): PlacementMode? {
      val fnPtr = _874214263_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<PlacementMode>()
      val hr = fn.invokeHR(arrayOf(__874214263_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun SetPlacement(element: DependencyObject?, value: PlacementMode?): Unit {
      val fnPtr = _874214263_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__874214263_Ptr, marshalToNative(element),
    ...
    public override fun get_PlacementTargetProperty(): DependencyProperty? {
      val fnPtr = _874214263_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__874214263_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetPlacementTarget(element: DependencyObject?): UIElement? {
      val fnPtr = _874214263_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun SetPlacementTarget(element: DependencyObject?, value: UIElement?): Unit {
      val fnPtr = _874214263_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__874214263_Ptr, marshalToNative(element),
          marshalToNative(value),))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ToolTipProperty(): DependencyProperty? {
      val fnPtr = _874214263_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__874214263_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetToolTip(element: DependencyObject?): IUnknown? {
      val fnPtr = _874214263_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun SetToolTip(element: DependencyObject?, value: IUnknown?): Unit {
      val fnPtr = _874214263_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__874214263_Ptr, marshalToNative(element),
          marshalToNative(value),))
      if (hr.toInt() != 0) {
  ...
  public class IToolTipServiceStatics_Impl(
    ...
    public override val __874214263_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IToolTipServiceStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("86e649f8e24548aaa8c8d1073ed76319")
    ...
    public override fun toNative(obj: IToolTipServiceStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__874214263_Ptr))
  }
