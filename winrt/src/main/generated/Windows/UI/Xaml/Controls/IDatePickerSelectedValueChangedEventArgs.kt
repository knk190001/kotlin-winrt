...
@Signature("{564dceed-744a-5c3a-9bd2-4dcd9919a7b7}")
@Guid("564dceed744a5c3a9bd24dcd9919a7b7")
@WinRTInterface("564dceed744a5c3a9bd24dcd9919a7b7")
...
public interface IDatePickerSelectedValueChangedEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IDatePickerSelectedValueChangedEventArgs {
    public val __7729633_Ptr: Pointer?

    public val _7729633_VtblPtr: Pointer?
      get() = __7729633_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_OldDate(): IReference<DateTime?>? {
      val fnPtr = _7729633_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IReference<DateTime?>>()
      val hr = fn.invokeHR(arrayOf(__7729633_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_NewDate(): IReference<DateTime?>? {
      val fnPtr = _7729633_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IReference<DateTime?>>()
      val hr = fn.invokeHR(arrayOf(__7729633_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IDatePickerSelectedValueChangedEventArgs_Impl(
    ...
    public override val __7729633_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IDatePickerSelectedValueChangedEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("564dceed744a5c3a9bd24dcd9919a7b7")
    ...
    public override fun toNative(obj: IDatePickerSelectedValueChangedEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__7729633_Ptr))
  }
