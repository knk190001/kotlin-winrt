...
@Signature("{4291af39-7f0b-4bc2-99c4-06e7062682d8}")
@Guid("4291af397f0b4bc299c406e7062682d8")
@WinRTInterface("4291af397f0b4bc299c406e7062682d8")
...
public interface IRangeBaseOverrides : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IRangeBaseOverrides {
    public val __2086109195_Ptr: Pointer?

    public val _2086109195_VtblPtr: Pointer?
      get() = __2086109195_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun OnMinimumChanged(oldMinimum: Double, newMinimum: Double): Unit {
      val fnPtr = _2086109195_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2086109195_Ptr, oldMinimum, newMinimum,))
      if (hr.toInt() != 0) {
    ...
    public override fun OnMaximumChanged(oldMaximum: Double, newMaximum: Double): Unit {
      val fnPtr = _2086109195_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2086109195_Ptr, oldMaximum, newMaximum,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun OnValueChanged(oldValue: Double, newValue: Double): Unit {
      val fnPtr = _2086109195_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2086109195_Ptr, oldValue, newValue,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IRangeBaseOverrides_Impl(
    ...
    public override val __2086109195_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IRangeBaseOverrides, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("4291af397f0b4bc299c406e7062682d8")
    ...
    public override fun toNative(obj: IRangeBaseOverrides): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2086109195_Ptr))
  }
