...
@Signature("{c0e30122-f3eb-4baa-a11f-c3f87342cbf4}")
@Guid("c0e30122f3eb4baaa11fc3f87342cbf4")
@WinRTInterface("c0e30122f3eb4baaa11fc3f87342cbf4")
...
public interface IRefreshVisualizer : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IRefreshVisualizer {
    public val __1559613059_Ptr: Pointer?

    public val _1559613059_VtblPtr: Pointer?
      get() = __1559613059_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun RequestRefresh(): Unit {
      val fnPtr = _1559613059_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1559613059_Ptr, ))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Orientation(): RefreshVisualizerOrientation? {
      val fnPtr = _1559613059_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<RefreshVisualizerOrientation>()
      val hr = fn.invokeHR(arrayOf(__1559613059_Ptr,  result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun put_Orientation(value: RefreshVisualizerOrientation?): Unit {
      val fnPtr = _1559613059_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1559613059_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Content(): UIElement? {
      val fnPtr = _1559613059_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Content(value: UIElement?): Unit {
      val fnPtr = _1559613059_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1559613059_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_State(): RefreshVisualizerState? {
      val fnPtr = _1559613059_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun add_RefreshRequested(handler: TypedEventHandler<RefreshVisualizer?,
        RefreshRequestedEventArgs?>?): EventRegistrationToken? {
      val fnPtr = _1559613059_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__1559613059_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun remove_RefreshRequested(token: EventRegistrationToken?): Unit {
      val fnPtr = _1559613059_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1559613059_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun add_RefreshStateChanged(handler: TypedEventHandler<RefreshVisualizer?,
        RefreshStateChangedEventArgs?>?): EventRegistrationToken? {
      val fnPtr = _1559613059_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__1559613059_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
    ...
    public override fun remove_RefreshStateChanged(token: EventRegistrationToken?): Unit {
      val fnPtr = _1559613059_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1559613059_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IRefreshVisualizer_Impl(
    ...
    public override val __1559613059_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IRefreshVisualizer, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("c0e30122f3eb4baaa11fc3f87342cbf4")
    ...
    public override fun toNative(obj: IRefreshVisualizer): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1559613059_Ptr))
  }
