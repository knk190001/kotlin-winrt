...
@Signature("{80a13c19-843a-451c-8cf5-44c701b0e216}")
@Guid("80a13c19843a451c8cf544c701b0e216")
@WinRTInterface("80a13c19843a451c8cf544c701b0e216")
...
public interface IButtonFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IButtonFactory {
    public val __573851940_Ptr: Pointer?

    public val _573851940_VtblPtr: Pointer?
      get() = __573851940_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        Button? {
      val fnPtr = _573851940_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Button>()
      val hr = fn.invokeHR(arrayOf(__573851940_Ptr, marshalToNative(baseInterface),
  ...
  public class IButtonFactory_Impl(
    ...
    public override val __573851940_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IButtonFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("80a13c19843a451c8cf544c701b0e216")
    ...
    public override fun toNative(obj: IButtonFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__573851940_Ptr))
  }
