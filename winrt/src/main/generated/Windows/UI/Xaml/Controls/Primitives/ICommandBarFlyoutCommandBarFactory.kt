...
@Signature("{f8236f9f-5559-5697-8e6f-20d70ca17dd0}")
@Guid("f8236f9f555956978e6f20d70ca17dd0")
@WinRTInterface("f8236f9f555956978e6f20d70ca17dd0")
...
public interface ICommandBarFlyoutCommandBarFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICommandBarFlyoutCommandBarFactory {
    public val __1392361763_Ptr: Pointer?

    public val _1392361763_VtblPtr: Pointer?
      get() = __1392361763_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        CommandBarFlyoutCommandBar? {
      val fnPtr = _1392361763_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CommandBarFlyoutCommandBar>()
      val hr = fn.invokeHR(arrayOf(__1392361763_Ptr, marshalToNative(baseInterface),
  ...
  public class ICommandBarFlyoutCommandBarFactory_Impl(
    ...
    public override val __1392361763_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICommandBarFlyoutCommandBarFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("f8236f9f555956978e6f20d70ca17dd0")
    ...
    public override fun toNative(obj: ICommandBarFlyoutCommandBarFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1392361763_Ptr))
  }
