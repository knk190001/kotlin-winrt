...
@Signature("{e8b2b281-0d6a-45cf-b333-2402b037f099}")
@Guid("e8b2b2810d6a45cfb3332402b037f099")
@WinRTInterface("e8b2b2810d6a45cfb3332402b037f099")
...
public interface IThumb : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IThumb {
    public val __1627803770_Ptr: Pointer?

    public val _1627803770_VtblPtr: Pointer?
      get() = __1627803770_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_IsDragging(): Boolean {
      val fnPtr = _1627803770_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1627803770_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun add_DragStarted(handler: DragStartedEventHandler?):
      ...
      val fnPtr = _1627803770_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__1627803770_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun remove_DragStarted(token: EventRegistrationToken?): Unit {
      val fnPtr = _1627803770_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1627803770_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun add_DragDelta(handler: DragDeltaEventHandler?): EventRegistrationToken? {
      val fnPtr = _1627803770_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__1627803770_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
    ...
    public override fun remove_DragDelta(token: EventRegistrationToken?): Unit {
      val fnPtr = _1627803770_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1627803770_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun add_DragCompleted(handler: DragCompletedEventHandler?):
        EventRegistrationToken? {
      val fnPtr = _1627803770_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__1627803770_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
    ...
    public override fun remove_DragCompleted(token: EventRegistrationToken?): Unit {
      val fnPtr = _1627803770_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1627803770_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun CancelDrag(): Unit {
      val fnPtr = _1627803770_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1627803770_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IThumb_Impl(
    ...
    public override val __1627803770_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IThumb, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("e8b2b2810d6a45cfb3332402b037f099")
    ...
    public override fun toNative(obj: IThumb): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1627803770_Ptr))
  }
