...
@Signature("rc(Windows.UI.Xaml.Controls.Primitives.ScrollBar;{f57ae6ca-d1a6-4b90-a4e9-54df1ba8d2ec})")
@WinRTByReference(brClass = ScrollBar.ByReference::class)
public class ScrollBar(
  ptr: JNAPointer? = NULL
) : RangeBase(ptr), IScrollBar.WithDefault, IWinRTObject {
  private val __1511966038_Interface: IScrollBar.WithDefault by lazy {
    as_1511966038()
  }


  public override val __1511966038_Ptr: JNAPointer? by lazy {
    __1511966038_Interface.__1511966038_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1511966038_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1511966038(): IScrollBar.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<ScrollBar, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.Primitives.ScrollBar".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIScrollBarStatics(): IScrollBarStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.Primitives.ScrollBar".toHandle(),refiid,interfacePtr)
