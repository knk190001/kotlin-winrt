...
@Signature("{844bd61a-1716-4097-bba2-7526da22de39}")
@Guid("844bd61a17164097bba27526da22de39")
@WinRTInterface("844bd61a17164097bba27526da22de39")
...
public interface ISwipeItemFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISwipeItemFactory {
    public val __1237162247_Ptr: Pointer?

    public val _1237162247_VtblPtr: Pointer?
      get() = __1237162247_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        SwipeItem? {
      val fnPtr = _1237162247_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<SwipeItem>()
      val hr = fn.invokeHR(arrayOf(__1237162247_Ptr, marshalToNative(baseInterface),
  ...
  public class ISwipeItemFactory_Impl(
    ...
    public override val __1237162247_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISwipeItemFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("844bd61a17164097bba27526da22de39")
    ...
    public override fun toNative(obj: ISwipeItemFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1237162247_Ptr))
  }
