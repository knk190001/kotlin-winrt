...
@Signature("{a76a3b63-229b-4dc5-aa11-9d922fbf8a98}")
@Guid("a76a3b63229b4dc5aa119d922fbf8a98")
@WinRTInterface("a76a3b63229b4dc5aa119d922fbf8a98")
...
public interface ISemanticZoomInformation : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISemanticZoomInformation {
    public val __1000960279_Ptr: Pointer?

    public val _1000960279_VtblPtr: Pointer?
      get() = __1000960279_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_SemanticZoomOwner(): SemanticZoom? {
      val fnPtr = _1000960279_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<SemanticZoom>()
      val hr = fn.invokeHR(arrayOf(__1000960279_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_SemanticZoomOwner(value: SemanticZoom?): Unit {
      val fnPtr = _1000960279_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1000960279_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_IsActiveView(): Boolean {
      val fnPtr = _1000960279_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_IsActiveView(value: Boolean): Unit {
      val fnPtr = _1000960279_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1000960279_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_IsZoomedInView(): Boolean {
      val fnPtr = _1000960279_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1000960279_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_IsZoomedInView(value: Boolean): Unit {
      val fnPtr = _1000960279_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1000960279_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun InitializeViewChange(): Unit {
      val fnPtr = _1000960279_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1000960279_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun CompleteViewChange(): Unit {
      val fnPtr = _1000960279_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1000960279_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun MakeVisible(item: SemanticZoomLocation?): Unit {
      val fnPtr = _1000960279_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1000960279_Ptr, marshalToNative(item),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun StartViewChangeFrom(source: SemanticZoomLocation?,
        destination: SemanticZoomLocation?): Unit {
      val fnPtr = _1000960279_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1000960279_Ptr, marshalToNative(source),
    ...
    public override fun StartViewChangeTo(source: SemanticZoomLocation?,
        destination: SemanticZoomLocation?): Unit {
      val fnPtr = _1000960279_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1000960279_Ptr, marshalToNative(source),
          marshalToNative(destination),))
      if (hr.toInt() != 0) {
    ...
    public override fun CompleteViewChangeFrom(source: SemanticZoomLocation?,
        destination: SemanticZoomLocation?): Unit {
      val fnPtr = _1000960279_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1000960279_Ptr, marshalToNative(source),
          marshalToNative(destination),))
      if (hr.toInt() != 0) {
    ...
    public override fun CompleteViewChangeTo(source: SemanticZoomLocation?,
        destination: SemanticZoomLocation?): Unit {
      val fnPtr = _1000960279_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1000960279_Ptr, marshalToNative(source),
          marshalToNative(destination),))
      if (hr.toInt() != 0) {
  ...
  public class ISemanticZoomInformation_Impl(
    ...
    public override val __1000960279_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISemanticZoomInformation, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("a76a3b63229b4dc5aa119d922fbf8a98")
    ...
    public override fun toNative(obj: ISemanticZoomInformation): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1000960279_Ptr))
  }
