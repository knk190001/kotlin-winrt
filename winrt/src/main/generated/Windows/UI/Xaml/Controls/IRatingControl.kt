...
@Signature("{a7d91ca7-e5cf-4963-a24e-9673fe5ffdd5}")
@Guid("a7d91ca7e5cf4963a24e9673fe5ffdd5")
@WinRTInterface("a7d91ca7e5cf4963a24e9673fe5ffdd5")
...
public interface IRatingControl : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IRatingControl {
    public val __1152195996_Ptr: Pointer?

    public val _1152195996_VtblPtr: Pointer?
      get() = __1152195996_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Caption(): String? {
      val fnPtr = _1152195996_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__1152195996_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Caption(value: String?): Unit {
      val fnPtr = _1152195996_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1152195996_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_InitialSetValue(): Int {
      val fnPtr = _1152195996_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_InitialSetValue(value: Int): Unit {
      val fnPtr = _1152195996_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1152195996_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_IsClearEnabled(): Boolean {
      val fnPtr = _1152195996_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_IsClearEnabled(value: Boolean): Unit {
      val fnPtr = _1152195996_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1152195996_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_IsReadOnly(): Boolean {
      val fnPtr = _1152195996_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1152195996_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_IsReadOnly(value: Boolean): Unit {
      val fnPtr = _1152195996_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1152195996_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_MaxRating(): Int {
      val fnPtr = _1152195996_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__1152195996_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_MaxRating(value: Int): Unit {
      val fnPtr = _1152195996_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1152195996_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_PlaceholderValue(): Double {
      val fnPtr = _1152195996_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_PlaceholderValue(value: Double): Unit {
      val fnPtr = _1152195996_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1152195996_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ItemInfo(): RatingItemInfo? {
      val fnPtr = _1152195996_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_ItemInfo(value: RatingItemInfo?): Unit {
      val fnPtr = _1152195996_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1152195996_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Value(): Double {
      val fnPtr = _1152195996_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1152195996_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Value(value: Double): Unit {
      val fnPtr = _1152195996_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1152195996_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun add_ValueChanged(handler: TypedEventHandler<RatingControl?, IUnknown?>?):
        EventRegistrationToken? {
      val fnPtr = _1152195996_VtblPtr!!.getPointer(22L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__1152195996_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun remove_ValueChanged(token: EventRegistrationToken?): Unit {
      val fnPtr = _1152195996_VtblPtr!!.getPointer(23L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1152195996_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IRatingControl_Impl(
    ...
    public override val __1152195996_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IRatingControl, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("a7d91ca7e5cf4963a24e9673fe5ffdd5")
    ...
    public override fun toNative(obj: IRatingControl): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1152195996_Ptr))
  }
