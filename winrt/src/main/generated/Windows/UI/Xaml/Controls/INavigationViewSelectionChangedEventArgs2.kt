...
@Signature("{fd5af806-d10a-5e8b-973f-3b8fda944625}")
@Guid("fd5af806d10a5e8b973f3b8fda944625")
@WinRTInterface("fd5af806d10a5e8b973f3b8fda944625")
...
public interface INavigationViewSelectionChangedEventArgs2 : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : INavigationViewSelectionChangedEventArgs2 {
    public val __1656908792_Ptr: Pointer?

    public val _1656908792_VtblPtr: Pointer?
      get() = __1656908792_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_SelectedItemContainer(): NavigationViewItemBase? {
      val fnPtr = _1656908792_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<NavigationViewItemBase>()
      val hr = fn.invokeHR(arrayOf(__1656908792_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_RecommendedNavigationTransitionInfo(): NavigationTransitionInfo? {
      val fnPtr = _1656908792_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class INavigationViewSelectionChangedEventArgs2_Impl(
    ...
    public override val __1656908792_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<INavigationViewSelectionChangedEventArgs2, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("fd5af806d10a5e8b973f3b8fda944625")
    ...
    public override fun toNative(obj: INavigationViewSelectionChangedEventArgs2): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1656908792_Ptr))
  }
