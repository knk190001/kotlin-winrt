...
import Windows.UI.Xaml.Controls.IMenuBarFactory.ABI.IID
...
@Signature("rc(Windows.UI.Xaml.Controls.MenuBar;{c8f67b0c-0e76-5af2-bade-785049c80a41})")
@WinRTByReference(brClass = MenuBar.ByReference::class)
public open class MenuBar(
  ptr: JNAPointer? = NULL
) : Control(ptr), IMenuBar.WithDefault, IWinRTObject {
  private val __103287448_Interface: IMenuBar.WithDefault by lazy {
    as_103287448()
  }


  public override val __103287448_Ptr: JNAPointer? by lazy {
    __103287448_Interface.__103287448_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__103287448_Interface)

  public constructor() : this(ABI.activate())

  private fun as_103287448(): IMenuBar.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<MenuBar, MemoryAddress> {
    ...
    public fun createIMenuBarStatics(): IMenuBarStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.MenuBar".toHandle(),refiid,interfacePtr)
    ...
    public fun createIMenuBarFactory(): IMenuBarFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.MenuBar".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
