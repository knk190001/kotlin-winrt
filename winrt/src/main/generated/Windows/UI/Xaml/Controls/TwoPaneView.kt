...
import Windows.UI.Xaml.Controls.ITwoPaneViewFactory.ABI.IID
...
@Signature("rc(Windows.UI.Xaml.Controls.TwoPaneView;{1b4d0db5-14ad-5926-bb8a-5b0a5c0085f0})")
...
public open class TwoPaneView(
  ...
  private val __1793690883_Interface: ITwoPaneView.WithDefault by lazy {
    as_1793690883()
  }


  public override val __1793690883_Ptr: JNAPointer? by lazy {
    __1793690883_Interface.__1793690883_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1793690883_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1793690883(): ITwoPaneView.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<TwoPaneView, MemoryAddress> {
    ...
    public fun createITwoPaneViewStatics(): ITwoPaneViewStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.TwoPaneView".toHandle(),refiid,interfacePtr)
    ...
    public fun createITwoPaneViewFactory(): ITwoPaneViewFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.TwoPaneView".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
