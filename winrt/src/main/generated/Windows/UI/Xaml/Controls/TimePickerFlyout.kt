...
@Signature("rc(Windows.UI.Xaml.Controls.TimePickerFlyout;{bb739d75-e836-439e-86d5-506d2d18e404})")
...
public class TimePickerFlyout(
  ...
  private val __597738574_Interface: ITimePickerFlyout.WithDefault by lazy {
    as_597738574()
  }


  public override val __597738574_Ptr: JNAPointer? by lazy {
    __597738574_Interface.__597738574_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__597738574_Interface)

  public constructor() : this(ABI.activate())

  private fun as_597738574(): ITimePickerFlyout.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<TimePickerFlyout, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.TimePickerFlyout".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createITimePickerFlyoutStatics(): ITimePickerFlyoutStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Controls.TimePickerFlyout".toHandle(),refiid,interfacePtr)
