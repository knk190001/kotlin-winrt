...
@Signature("{28258a12-7d82-505b-b210-712b04a58882}")
@Guid("28258a127d82505bb210712b04a58882")
@WinRTInterface("28258a127d82505bb210712b04a58882")
...
public interface IWindowsXamlManagerStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IWindowsXamlManagerStatics {
    public val __1542697149_Ptr: Pointer?

    public val _1542697149_VtblPtr: Pointer?
      get() = __1542697149_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun InitializeForCurrentThread(): WindowsXamlManager? {
      val fnPtr = _1542697149_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<WindowsXamlManager>()
      val hr = fn.invokeHR(arrayOf(__1542697149_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IWindowsXamlManagerStatics_Impl(
    ...
    public override val __1542697149_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IWindowsXamlManagerStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("28258a127d82505bb210712b04a58882")
    ...
    public override fun toNative(obj: IWindowsXamlManagerStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1542697149_Ptr))
  }
