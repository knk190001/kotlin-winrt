...
@Signature("{39be4849-d9cc-5b70-8f05-1ad9a4aaa342}")
@Guid("39be4849d9cc5b708f051ad9a4aaa342")
@WinRTInterface("39be4849d9cc5b708f051ad9a4aaa342")
...
public interface IDesktopWindowXamlSourceGotFocusEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IDesktopWindowXamlSourceGotFocusEventArgs {
    public val __634308322_Ptr: Pointer?

    public val _634308322_VtblPtr: Pointer?
      get() = __634308322_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Request(): XamlSourceFocusNavigationRequest? {
      val fnPtr = _634308322_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<XamlSourceFocusNavigationRequest>()
      val hr = fn.invokeHR(arrayOf(__634308322_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IDesktopWindowXamlSourceGotFocusEventArgs_Impl(
    ...
    public override val __634308322_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IDesktopWindowXamlSourceGotFocusEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("39be4849d9cc5b708f051ad9a4aaa342")
    ...
    public override fun toNative(obj: IDesktopWindowXamlSourceGotFocusEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__634308322_Ptr))
  }
