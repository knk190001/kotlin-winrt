...
@Signature("{43bbadbf-f9e1-5527-b8c5-09339ff2ca76}")
@Guid("43bbadbff9e15527b8c509339ff2ca76")
@WinRTInterface("43bbadbff9e15527b8c509339ff2ca76")
...
public interface IXamlSourceFocusNavigationResultFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IXamlSourceFocusNavigationResultFactory {
    public val __42381366_Ptr: Pointer?

    public val _42381366_VtblPtr: Pointer?
      get() = __42381366_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(focusMoved: Boolean): XamlSourceFocusNavigationResult? {
      val fnPtr = _42381366_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<XamlSourceFocusNavigationResult>()
      val hr = fn.invokeHR(arrayOf(__42381366_Ptr, focusMoved, result))
      if (hr.toInt() != 0) {
  ...
  public class IXamlSourceFocusNavigationResultFactory_Impl(
    ...
    public override val __42381366_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IXamlSourceFocusNavigationResultFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("43bbadbff9e15527b8c509339ff2ca76")
    ...
    public override fun toNative(obj: IXamlSourceFocusNavigationResultFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__42381366_Ptr))
  }
