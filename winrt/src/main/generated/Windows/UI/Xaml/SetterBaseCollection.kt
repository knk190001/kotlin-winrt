...
@Signature("rc(Windows.UI.Xaml.SetterBaseCollection;{03c40ca8-909e-4117-811c-a4529496bdf1})")
...
public class SetterBaseCollection(
  ...
  private val __701563904_Interface: ISetterBaseCollection.WithDefault by lazy {
    as_701563904()
  }
  ...
  public override val __701563904_Ptr: JNAPointer? by lazy {
    __701563904_Interface.__701563904_Ptr
  }
  ...
  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__701563904_Interface, __1070388601_Interface, __1449643190_Interface)

  public constructor() : this(ABI.activate())

  private fun as_701563904(): ISetterBaseCollection.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<SetterBaseCollection, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr = INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.SetterBaseCollection".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
