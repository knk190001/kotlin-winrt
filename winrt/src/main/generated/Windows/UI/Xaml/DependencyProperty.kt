...
@Signature("rc(Windows.UI.Xaml.DependencyProperty;{85b13970-9bc4-4e96-acf1-30c8fd3d55c8})")
...
public class DependencyProperty(
  ...
  private val __1766182894_Interface: IDependencyProperty.WithDefault by lazy {
    as_1766182894()
  }


  public override val __1766182894_Ptr: JNAPointer? by lazy {
    __1766182894_Interface.__1766182894_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1766182894_Interface)

  private fun as_1766182894(): IDependencyProperty.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<DependencyProperty, MemoryAddress> {
    ...
    public fun createIDependencyPropertyStatics(): IDependencyPropertyStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.DependencyProperty".toHandle(),refiid,interfacePtr)
