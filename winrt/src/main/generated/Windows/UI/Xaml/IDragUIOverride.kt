...
@Signature("{bd6c9dfa-c961-4861-b7a5-bf4fe4a8a6ef}")
@Guid("bd6c9dfac9614861b7a5bf4fe4a8a6ef")
@WinRTInterface("bd6c9dfac9614861b7a5bf4fe4a8a6ef")
...
public interface IDragUIOverride : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IDragUIOverride {
    public val __1836564090_Ptr: Pointer?

    public val _1836564090_VtblPtr: Pointer?
      get() = __1836564090_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Caption(): String? {
      val fnPtr = _1836564090_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__1836564090_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Caption(value: String?): Unit {
      val fnPtr = _1836564090_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1836564090_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_IsContentVisible(): Boolean {
      val fnPtr = _1836564090_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_IsContentVisible(value: Boolean): Unit {
      val fnPtr = _1836564090_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1836564090_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_IsCaptionVisible(): Boolean {
      val fnPtr = _1836564090_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1836564090_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_IsCaptionVisible(value: Boolean): Unit {
      val fnPtr = _1836564090_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1836564090_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_IsGlyphVisible(): Boolean {
      val fnPtr = _1836564090_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1836564090_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_IsGlyphVisible(value: Boolean): Unit {
      val fnPtr = _1836564090_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1836564090_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun Clear(): Unit {
      val fnPtr = _1836564090_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1836564090_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun SetContentFromBitmapImage(bitmapImage: BitmapImage?): Unit {
      val fnPtr = _1836564090_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1836564090_Ptr, marshalToNative(bitmapImage),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun SetContentFromBitmapImage(bitmapImage: BitmapImage?, anchorPoint: Point?):
        Unit {
      val fnPtr = _1836564090_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1836564090_Ptr, marshalToNative(bitmapImage),
    ...
    public override fun SetContentFromSoftwareBitmap(softwareBitmap: SoftwareBitmap?): Unit {
      val fnPtr = _1836564090_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1836564090_Ptr, marshalToNative(softwareBitmap),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun SetContentFromSoftwareBitmap(softwareBitmap: SoftwareBitmap?,
      ...
      val fnPtr = _1836564090_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1836564090_Ptr, marshalToNative(softwareBitmap),
          marshalToNative(anchorPoint),))
      if (hr.toInt() != 0) {
  ...
  public class IDragUIOverride_Impl(
    ...
    public override val __1836564090_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IDragUIOverride, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("bd6c9dfac9614861b7a5bf4fe4a8a6ef")
    ...
    public override fun toNative(obj: IDragUIOverride): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1836564090_Ptr))
  }
