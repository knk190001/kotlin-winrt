...
@Signature("{855bc230-8a11-4e18-a136-4bc21c7827b0}")
@Guid("855bc2308a114e18a1364bc21c7827b0")
@WinRTInterface("855bc2308a114e18a1364bc21c7827b0")
...
public interface IRectangle : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IRectangle {
    public val __437246513_Ptr: Pointer?

    public val _437246513_VtblPtr: Pointer?
      get() = __437246513_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_RadiusX(): Double {
      val fnPtr = _437246513_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__437246513_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_RadiusX(value: Double): Unit {
      val fnPtr = _437246513_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__437246513_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_RadiusY(): Double {
      val fnPtr = _437246513_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__437246513_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_RadiusY(value: Double): Unit {
      val fnPtr = _437246513_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__437246513_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IRectangle_Impl(
    ...
    public override val __437246513_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IRectangle, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("855bc2308a114e18a1364bc21c7827b0")
    ...
    public override fun toNative(obj: IRectangle): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__437246513_Ptr))
  }
