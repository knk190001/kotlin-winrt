...
@Signature("rc(Windows.UI.Xaml.Shapes.Line;{46a5433d-4ffb-48df-8732-4e15c834816b})")
@WinRTByReference(brClass = Line.ByReference::class)
public class Line(
  ptr: JNAPointer? = NULL
) : Shape(ptr), ILine.WithDefault, IWinRTObject {
  private val __641303660_Interface: ILine.WithDefault by lazy {
    as_641303660()
  }


  public override val __641303660_Ptr: JNAPointer? by lazy {
    __641303660_Interface.__641303660_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__641303660_Interface)

  public constructor() : this(ABI.activate())

  private fun as_641303660(): ILine.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<Line, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr = INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Shapes.Line".toHandle(), refiid,
          iAFPtr)
      checkHR(hr)
    ...
    public fun createILineStatics(): ILineStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Shapes.Line".toHandle(),refiid,interfacePtr)
