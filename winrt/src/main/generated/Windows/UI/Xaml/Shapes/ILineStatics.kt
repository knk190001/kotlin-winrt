...
@Signature("{267c123d-6ea4-4c50-8b1d-50207aff1e8a}")
@Guid("267c123d6ea44c508b1d50207aff1e8a")
@WinRTInterface("267c123d6ea44c508b1d50207aff1e8a")
...
public interface ILineStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ILineStatics {
    public val __329536111_Ptr: Pointer?

    public val _329536111_VtblPtr: Pointer?
      get() = __329536111_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_X1Property(): DependencyProperty? {
      val fnPtr = _329536111_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__329536111_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Y1Property(): DependencyProperty? {
      val fnPtr = _329536111_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__329536111_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_X2Property(): DependencyProperty? {
      val fnPtr = _329536111_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__329536111_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Y2Property(): DependencyProperty? {
      val fnPtr = _329536111_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__329536111_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ILineStatics_Impl(
    ...
    public override val __329536111_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ILineStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("267c123d6ea44c508b1d50207aff1e8a")
    ...
    public override fun toNative(obj: ILineStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__329536111_Ptr))
  }
