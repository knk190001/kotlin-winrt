...
@Signature("rc(Windows.UI.Xaml.DependencyPropertyChangedEventArgs;{81212c2b-24d0-4957-abc3-224470a93a4e})")
...
public class DependencyPropertyChangedEventArgs(
  ...
  private val __1063292299_Interface: IDependencyPropertyChangedEventArgs.WithDefault by lazy {
    as_1063292299()
  }


  public override val __1063292299_Ptr: JNAPointer? by lazy {
    __1063292299_Interface.__1063292299_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1063292299_Interface)

  private fun as_1063292299(): IDependencyPropertyChangedEventArgs.WithDefault {
    if(pointer == NULL) {
