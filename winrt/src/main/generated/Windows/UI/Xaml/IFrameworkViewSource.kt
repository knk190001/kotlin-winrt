...
@Signature("{e3b077da-35ad-4b09-b5b2-27420041ba9f}")
@Guid("e3b077da35ad4b09b5b227420041ba9f")
@WinRTInterface("e3b077da35ad4b09b5b227420041ba9f")
...
public interface IFrameworkViewSource : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IFrameworkViewSource {
    public val __539380780_Ptr: Pointer?

    public val _539380780_VtblPtr: Pointer?
      get() = __539380780_Ptr?.getPointer(0)
  }

  public class IFrameworkViewSource_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __539380780_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IFrameworkViewSource, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("e3b077da35ad4b09b5b227420041ba9f")
    ...
    public override fun toNative(obj: IFrameworkViewSource): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__539380780_Ptr))
  }
