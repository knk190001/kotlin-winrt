...
@Signature("{7a826ce1-07a0-4083-b6d1-b1d917b976ac}")
@Guid("7a826ce107a04083b6d1b1d917b976ac")
@WinRTInterface("7a826ce107a04083b6d1b1d917b976ac")
...
public interface IGridLengthHelper : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IGridLengthHelper {
    public val __1617757460_Ptr: Pointer?

    public val _1617757460_VtblPtr: Pointer?
      get() = __1617757460_Ptr?.getPointer(0)
  }

  public class IGridLengthHelper_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __1617757460_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IGridLengthHelper, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("7a826ce107a04083b6d1b1d917b976ac")
    ...
    public override fun toNative(obj: IGridLengthHelper): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1617757460_Ptr))
  }
