...
@Signature("{1116972c-9dad-5429-a7dd-b2b7d061ab8e}")
@Guid("1116972c9dad5429a7ddb2b7d061ab8e")
@WinRTInterface("1116972c9dad5429a7ddb2b7d061ab8e")
...
public interface IBrushTransition : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IBrushTransition {
    public val __850406301_Ptr: Pointer?

    public val _850406301_VtblPtr: Pointer?
      get() = __850406301_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Duration(): TimeSpan? {
      val fnPtr = _850406301_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<TimeSpan>()
      val hr = fn.invokeHR(arrayOf(__850406301_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Duration(value: TimeSpan?): Unit {
      val fnPtr = _850406301_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__850406301_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IBrushTransition_Impl(
    ...
    public override val __850406301_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IBrushTransition, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("1116972c9dad5429a7ddb2b7d061ab8e")
    ...
    public override fun toNative(obj: IBrushTransition): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__850406301_Ptr))
  }
