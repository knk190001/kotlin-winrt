...
@Signature("rc(Windows.UI.Xaml.Media.Animation.EasingColorKeyFrame;{c733d630-f4b9-4934-9bdd-27ac5ed1cfd8})")
...
public class EasingColorKeyFrame(
  ...
  private val __64540768_Interface: IEasingColorKeyFrame.WithDefault by lazy {
    as_64540768()
  }


  public override val __64540768_Ptr: JNAPointer? by lazy {
    __64540768_Interface.__64540768_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__64540768_Interface)

  public constructor() : this(ABI.activate())

  private fun as_64540768(): IEasingColorKeyFrame.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<EasingColorKeyFrame, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Animation.EasingColorKeyFrame".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIEasingColorKeyFrameStatics(): IEasingColorKeyFrameStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Animation.EasingColorKeyFrame".toHandle(),refiid,interfacePtr)
      val result =
