...
@Signature("{f419aa91-e042-4111-9c2f-d201304123dd}")
@Guid("f419aa91e04241119c2fd201304123dd")
@WinRTInterface("f419aa91e04241119c2fd201304123dd")
...
public interface ITranslateTransformStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITranslateTransformStatics {
    public val __892958123_Ptr: Pointer?

    public val _892958123_VtblPtr: Pointer?
      get() = __892958123_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_XProperty(): DependencyProperty? {
      val fnPtr = _892958123_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__892958123_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_YProperty(): DependencyProperty? {
      val fnPtr = _892958123_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__892958123_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ITranslateTransformStatics_Impl(
    ...
    public override val __892958123_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITranslateTransformStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("f419aa91e04241119c2fd201304123dd")
    ...
    public override fun toNative(obj: ITranslateTransformStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__892958123_Ptr))
  }
