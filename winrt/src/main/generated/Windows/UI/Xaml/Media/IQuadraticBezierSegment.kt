...
@Signature("{2c509a5b-bf18-455a-a078-914b5232d8af}")
@Guid("2c509a5bbf18455aa078914b5232d8af")
@WinRTInterface("2c509a5bbf18455aa078914b5232d8af")
...
public interface IQuadraticBezierSegment : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IQuadraticBezierSegment {
    public val __316837912_Ptr: Pointer?

    public val _316837912_VtblPtr: Pointer?
      get() = __316837912_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Point1(): Point? {
      val fnPtr = _316837912_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Point>()
      val hr = fn.invokeHR(arrayOf(__316837912_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Point1(value: Point?): Unit {
      val fnPtr = _316837912_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__316837912_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Point2(): Point? {
      val fnPtr = _316837912_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Point>()
      val hr = fn.invokeHR(arrayOf(__316837912_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Point2(value: Point?): Unit {
      val fnPtr = _316837912_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__316837912_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IQuadraticBezierSegment_Impl(
    ...
    public override val __316837912_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IQuadraticBezierSegment, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("2c509a5bbf18455aa078914b5232d8af")
    ...
    public override fun toNative(obj: IQuadraticBezierSegment): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__316837912_Ptr))
  }
