...
@Signature("{081b9df8-bae6-4bcb-813c-bde0e46dc8b7}")
@Guid("081b9df8bae64bcb813cbde0e46dc8b7")
@WinRTInterface("081b9df8bae64bcb813cbde0e46dc8b7")
...
public interface IPathGeometry : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPathGeometry {
    public val __607857741_Ptr: Pointer?

    public val _607857741_VtblPtr: Pointer?
      get() = __607857741_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_FillRule(): FillRule? {
      val fnPtr = _607857741_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<FillRule>()
      val hr = fn.invokeHR(arrayOf(__607857741_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_FillRule(value: FillRule?): Unit {
      val fnPtr = _607857741_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__607857741_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Figures(): PathFigureCollection? {
      val fnPtr = _607857741_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Figures(value: PathFigureCollection?): Unit {
      val fnPtr = _607857741_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__607857741_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IPathGeometry_Impl(
    ...
    public override val __607857741_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPathGeometry, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("081b9df8bae64bcb813cbde0e46dc8b7")
    ...
    public override fun toNative(obj: IPathGeometry): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__607857741_Ptr))
  }
