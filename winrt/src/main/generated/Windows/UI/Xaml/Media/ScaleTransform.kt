...
@Signature("rc(Windows.UI.Xaml.Media.ScaleTransform;{ed67f18d-936e-43ab-929a-e9cd0a511e52})")
...
public class ScaleTransform(
  ...
  private val __703447490_Interface: IScaleTransform.WithDefault by lazy {
    as_703447490()
  }


  public override val __703447490_Ptr: JNAPointer? by lazy {
    __703447490_Interface.__703447490_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__703447490_Interface)

  public constructor() : this(ABI.activate())

  private fun as_703447490(): IScaleTransform.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<ScaleTransform, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr = INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.ScaleTransform".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIScaleTransformStatics(): IScaleTransformStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.ScaleTransform".toHandle(),refiid,interfacePtr)
