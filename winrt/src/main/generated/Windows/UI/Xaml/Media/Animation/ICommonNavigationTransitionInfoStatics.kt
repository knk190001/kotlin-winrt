...
@Signature("{1e3efe33-50be-4443-883c-e5627201c2e5}")
@Guid("1e3efe3350be4443883ce5627201c2e5")
@WinRTInterface("1e3efe3350be4443883ce5627201c2e5")
...
public interface ICommonNavigationTransitionInfoStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICommonNavigationTransitionInfoStatics {
    public val __1812350781_Ptr: Pointer?

    public val _1812350781_VtblPtr: Pointer?
      get() = __1812350781_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_IsStaggeringEnabledProperty(): DependencyProperty? {
      val fnPtr = _1812350781_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1812350781_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsStaggerElementProperty(): DependencyProperty? {
      val fnPtr = _1812350781_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1812350781_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetIsStaggerElement(element: UIElement?): Boolean {
      val fnPtr = _1812350781_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1812350781_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun SetIsStaggerElement(element: UIElement?, value: Boolean): Unit {
      val fnPtr = _1812350781_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1812350781_Ptr, marshalToNative(element), value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class ICommonNavigationTransitionInfoStatics_Impl(
    ...
    public override val __1812350781_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICommonNavigationTransitionInfoStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("1e3efe3350be4443883ce5627201c2e5")
    ...
    public override fun toNative(obj: ICommonNavigationTransitionInfoStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1812350781_Ptr))
  }
