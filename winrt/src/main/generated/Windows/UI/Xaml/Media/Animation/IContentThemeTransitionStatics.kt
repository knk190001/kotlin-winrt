...
@Signature("{0e8ee385-9a42-4459-afa9-337dc41e1587}")
@Guid("0e8ee3859a424459afa9337dc41e1587")
@WinRTInterface("0e8ee3859a424459afa9337dc41e1587")
...
public interface IContentThemeTransitionStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IContentThemeTransitionStatics {
    public val __466963078_Ptr: Pointer?

    public val _466963078_VtblPtr: Pointer?
      get() = __466963078_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_HorizontalOffsetProperty(): DependencyProperty? {
      val fnPtr = _466963078_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__466963078_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_VerticalOffsetProperty(): DependencyProperty? {
      val fnPtr = _466963078_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__466963078_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IContentThemeTransitionStatics_Impl(
    ...
    public override val __466963078_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IContentThemeTransitionStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("0e8ee3859a424459afa9337dc41e1587")
    ...
    public override fun toNative(obj: IContentThemeTransitionStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__466963078_Ptr))
  }
