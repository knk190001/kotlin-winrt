...
@Signature("rc(Windows.UI.Xaml.Media.Animation.ConnectedAnimationConfiguration;{00218aae-cd8c-5651-92a0-c1db95c03998})")
...
public open class ConnectedAnimationConfiguration(
  ...
  private val __1562698891_Interface: IConnectedAnimationConfiguration.WithDefault by lazy {
    as_1562698891()
  }


  public override val __1562698891_Ptr: JNAPointer? by lazy {
    __1562698891_Interface.__1562698891_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1562698891_Interface)

  private fun as_1562698891(): IConnectedAnimationConfiguration.WithDefault {
    if(pointer == NULL) {
