...
@Signature("{146ffe57-3c9d-41d9-a5ff-8d7239516810}")
@Guid("146ffe573c9d41d9a5ff8d7239516810")
@WinRTInterface("146ffe573c9d41d9a5ff8d7239516810")
...
public interface IDragOverThemeAnimationStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IDragOverThemeAnimationStatics {
    public val __1070916612_Ptr: Pointer?

    public val _1070916612_VtblPtr: Pointer?
      get() = __1070916612_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_TargetNameProperty(): DependencyProperty? {
      val fnPtr = _1070916612_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1070916612_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ToOffsetProperty(): DependencyProperty? {
      val fnPtr = _1070916612_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1070916612_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_DirectionProperty(): DependencyProperty? {
      val fnPtr = _1070916612_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1070916612_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IDragOverThemeAnimationStatics_Impl(
    ...
    public override val __1070916612_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IDragOverThemeAnimationStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("146ffe573c9d41d9a5ff8d7239516810")
    ...
    public override fun toNative(obj: IDragOverThemeAnimationStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1070916612_Ptr))
  }
