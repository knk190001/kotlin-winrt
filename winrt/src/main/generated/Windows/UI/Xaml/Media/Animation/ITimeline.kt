...
@Signature("{0bc465dc-be4d-4d0d-9549-2208b715f40d}")
@Guid("0bc465dcbe4d4d0d95492208b715f40d")
@WinRTInterface("0bc465dcbe4d4d0d95492208b715f40d")
...
public interface ITimeline : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITimeline {
    public val __2053426105_Ptr: Pointer?

    public val _2053426105_VtblPtr: Pointer?
      get() = __2053426105_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_AutoReverse(): Boolean {
      val fnPtr = _2053426105_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__2053426105_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_AutoReverse(value: Boolean): Unit {
      val fnPtr = _2053426105_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2053426105_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_BeginTime(): IReference<TimeSpan?>? {
      val fnPtr = _2053426105_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_BeginTime(value: IReference<TimeSpan?>?): Unit {
      val fnPtr = _2053426105_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2053426105_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Duration(): Duration? {
      val fnPtr = _2053426105_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Duration(value: Duration?): Unit {
      val fnPtr = _2053426105_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2053426105_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_SpeedRatio(): Double {
      val fnPtr = _2053426105_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_SpeedRatio(value: Double): Unit {
      val fnPtr = _2053426105_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2053426105_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_FillBehavior(): FillBehavior? {
      val fnPtr = _2053426105_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_FillBehavior(value: FillBehavior?): Unit {
      val fnPtr = _2053426105_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2053426105_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_RepeatBehavior(): RepeatBehavior? {
      val fnPtr = _2053426105_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_RepeatBehavior(value: RepeatBehavior?): Unit {
      val fnPtr = _2053426105_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2053426105_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun add_Completed(handler: EventHandler<IUnknown?>?): EventRegistrationToken? {
      val fnPtr = _2053426105_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__2053426105_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun remove_Completed(token: EventRegistrationToken?): Unit {
      val fnPtr = _2053426105_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2053426105_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class ITimeline_Impl(
    ...
    public override val __2053426105_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITimeline, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("0bc465dcbe4d4d0d95492208b715f40d")
    ...
    public override fun toNative(obj: ITimeline): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2053426105_Ptr))
  }
