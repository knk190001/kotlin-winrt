...
@Signature("rc(Windows.UI.Xaml.Media.Animation.DropTargetItemThemeAnimation;{1881c968-1824-462b-87e8-c357212b977b})")
...
public class DropTargetItemThemeAnimation(
  ...
  private val __531743796_Interface: IDropTargetItemThemeAnimation.WithDefault by lazy {
    as_531743796()
  }


  public override val __531743796_Ptr: JNAPointer? by lazy {
    __531743796_Interface.__531743796_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__531743796_Interface)

  public constructor() : this(ABI.activate())

  private fun as_531743796(): IDropTargetItemThemeAnimation.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<DropTargetItemThemeAnimation, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Animation.DropTargetItemThemeAnimation".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIDropTargetItemThemeAnimationStatics(): IDropTargetItemThemeAnimationStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Animation.DropTargetItemThemeAnimation".toHandle(),refiid,interfacePtr)
      val result =
