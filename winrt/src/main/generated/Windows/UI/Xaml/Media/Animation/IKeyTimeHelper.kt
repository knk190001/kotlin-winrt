...
@Signature("{3643e480-4823-466a-abe5-5e79c8ed77ed}")
@Guid("3643e4804823466aabe55e79c8ed77ed")
@WinRTInterface("3643e4804823466aabe55e79c8ed77ed")
...
public interface IKeyTimeHelper : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IKeyTimeHelper {
    public val __331891796_Ptr: Pointer?

    public val _331891796_VtblPtr: Pointer?
      get() = __331891796_Ptr?.getPointer(0)
  }

  public class IKeyTimeHelper_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __331891796_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IKeyTimeHelper, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("3643e4804823466aabe55e79c8ed77ed")
    ...
    public override fun toNative(obj: IKeyTimeHelper): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__331891796_Ptr))
  }
