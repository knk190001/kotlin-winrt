...
@Signature("{785fd7aa-5456-4639-8fd2-26bae6a5ffe4}")
@Guid("785fd7aa545646398fd226bae6a5ffe4")
@WinRTInterface("785fd7aa545646398fd226bae6a5ffe4")
...
public interface ISplitOpenThemeAnimation : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISplitOpenThemeAnimation {
    public val __1768212327_Ptr: Pointer?

    public val _1768212327_VtblPtr: Pointer?
      get() = __1768212327_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_OpenedTargetName(): String? {
      val fnPtr = _1768212327_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__1768212327_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_OpenedTargetName(value: String?): Unit {
      val fnPtr = _1768212327_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1768212327_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_OpenedTarget(): DependencyObject? {
      val fnPtr = _1768212327_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_OpenedTarget(value: DependencyObject?): Unit {
      val fnPtr = _1768212327_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1768212327_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ClosedTargetName(): String? {
      val fnPtr = _1768212327_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__1768212327_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ClosedTargetName(value: String?): Unit {
      val fnPtr = _1768212327_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1768212327_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ClosedTarget(): DependencyObject? {
      val fnPtr = _1768212327_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyObject>()
      val hr = fn.invokeHR(arrayOf(__1768212327_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ClosedTarget(value: DependencyObject?): Unit {
      val fnPtr = _1768212327_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1768212327_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ContentTargetName(): String? {
      val fnPtr = _1768212327_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__1768212327_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ContentTargetName(value: String?): Unit {
      val fnPtr = _1768212327_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1768212327_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ContentTarget(): DependencyObject? {
      val fnPtr = _1768212327_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyObject>()
      val hr = fn.invokeHR(arrayOf(__1768212327_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ContentTarget(value: DependencyObject?): Unit {
      val fnPtr = _1768212327_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1768212327_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_OpenedLength(): Double {
      val fnPtr = _1768212327_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_OpenedLength(value: Double): Unit {
      val fnPtr = _1768212327_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1768212327_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_ClosedLength(): Double {
      val fnPtr = _1768212327_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1768212327_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ClosedLength(value: Double): Unit {
      val fnPtr = _1768212327_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1768212327_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_OffsetFromCenter(): Double {
      val fnPtr = _1768212327_VtblPtr!!.getPointer(22L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1768212327_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_OffsetFromCenter(value: Double): Unit {
      val fnPtr = _1768212327_VtblPtr!!.getPointer(23L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1768212327_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ContentTranslationDirection(): AnimationDirection? {
      val fnPtr = _1768212327_VtblPtr!!.getPointer(24L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_ContentTranslationDirection(value: AnimationDirection?): Unit {
      val fnPtr = _1768212327_VtblPtr!!.getPointer(25L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1768212327_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ContentTranslationOffset(): Double {
      val fnPtr = _1768212327_VtblPtr!!.getPointer(26L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1768212327_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ContentTranslationOffset(value: Double): Unit {
      val fnPtr = _1768212327_VtblPtr!!.getPointer(27L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1768212327_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class ISplitOpenThemeAnimation_Impl(
    ...
    public override val __1768212327_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISplitOpenThemeAnimation, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("785fd7aa545646398fd226bae6a5ffe4")
    ...
    public override fun toNative(obj: ISplitOpenThemeAnimation): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1768212327_Ptr))
  }
