...
@Signature("{7cb9e41d-f0bb-4bca-9da5-9ba3a11734c4}")
@Guid("7cb9e41df0bb4bca9da59ba3a11734c4")
@WinRTInterface("7cb9e41df0bb4bca9da59ba3a11734c4")
...
public interface IExponentialEase : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IExponentialEase {
    public val __1880048653_Ptr: Pointer?

    public val _1880048653_VtblPtr: Pointer?
      get() = __1880048653_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Exponent(): Double {
      val fnPtr = _1880048653_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1880048653_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Exponent(value: Double): Unit {
      val fnPtr = _1880048653_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1880048653_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IExponentialEase_Impl(
    ...
    public override val __1880048653_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IExponentialEase, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("7cb9e41df0bb4bca9da59ba3a11734c4")
    ...
    public override fun toNative(obj: IExponentialEase): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1880048653_Ptr))
  }
