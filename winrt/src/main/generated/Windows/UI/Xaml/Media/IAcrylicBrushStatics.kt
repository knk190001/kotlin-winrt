...
@Signature("{2787fd79-a3da-423f-b81a-599147971523}")
@Guid("2787fd79a3da423fb81a599147971523")
@WinRTInterface("2787fd79a3da423fb81a599147971523")
...
public interface IAcrylicBrushStatics : NativeMapped, IWinRTInterface {
  @InterfaceMethod(0)
  public fun get_BackgroundSourceProperty(): DependencyProperty?
  ...
  public interface WithDefault : IAcrylicBrushStatics {
    public val __1597781068_Ptr: Pointer?

    public val _1597781068_VtblPtr: Pointer?
      get() = __1597781068_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_BackgroundSourceProperty(): DependencyProperty? {
      val fnPtr = _1597781068_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1597781068_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_TintColorProperty(): DependencyProperty? {
      val fnPtr = _1597781068_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1597781068_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_TintOpacityProperty(): DependencyProperty? {
      val fnPtr = _1597781068_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1597781068_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_TintTransitionDurationProperty(): DependencyProperty? {
      val fnPtr = _1597781068_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1597781068_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_AlwaysUseFallbackProperty(): DependencyProperty? {
      val fnPtr = _1597781068_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1597781068_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IAcrylicBrushStatics_Impl(
    ...
    public override val __1597781068_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IAcrylicBrushStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("2787fd79a3da423fb81a599147971523")
    ...
    public override fun toNative(obj: IAcrylicBrushStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1597781068_Ptr))
  }
