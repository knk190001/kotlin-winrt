...
@Signature("{e6f82bfa-6726-469a-b259-a5188347ca8f}")
@Guid("e6f82bfa6726469ab259a5188347ca8f")
@WinRTInterface("e6f82bfa6726469ab259a5188347ca8f")
...
public interface IPlaneProjection : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPlaneProjection {
    public val __799509425_Ptr: Pointer?

    public val _799509425_VtblPtr: Pointer?
      get() = __799509425_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_LocalOffsetX(): Double {
      val fnPtr = _799509425_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__799509425_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_LocalOffsetX(value: Double): Unit {
      val fnPtr = _799509425_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__799509425_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_LocalOffsetY(): Double {
      val fnPtr = _799509425_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__799509425_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_LocalOffsetY(value: Double): Unit {
      val fnPtr = _799509425_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__799509425_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_LocalOffsetZ(): Double {
      val fnPtr = _799509425_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__799509425_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_LocalOffsetZ(value: Double): Unit {
      val fnPtr = _799509425_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__799509425_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_RotationX(): Double {
      val fnPtr = _799509425_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__799509425_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_RotationX(value: Double): Unit {
      val fnPtr = _799509425_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__799509425_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_RotationY(): Double {
      val fnPtr = _799509425_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__799509425_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_RotationY(value: Double): Unit {
      val fnPtr = _799509425_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__799509425_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_RotationZ(): Double {
      val fnPtr = _799509425_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__799509425_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_RotationZ(value: Double): Unit {
      val fnPtr = _799509425_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__799509425_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_CenterOfRotationX(): Double {
      val fnPtr = _799509425_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__799509425_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_CenterOfRotationX(value: Double): Unit {
      val fnPtr = _799509425_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__799509425_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_CenterOfRotationY(): Double {
      val fnPtr = _799509425_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__799509425_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_CenterOfRotationY(value: Double): Unit {
      val fnPtr = _799509425_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__799509425_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_CenterOfRotationZ(): Double {
      val fnPtr = _799509425_VtblPtr!!.getPointer(22L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__799509425_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_CenterOfRotationZ(value: Double): Unit {
      val fnPtr = _799509425_VtblPtr!!.getPointer(23L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__799509425_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_GlobalOffsetX(): Double {
      val fnPtr = _799509425_VtblPtr!!.getPointer(24L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__799509425_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_GlobalOffsetX(value: Double): Unit {
      val fnPtr = _799509425_VtblPtr!!.getPointer(25L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__799509425_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_GlobalOffsetY(): Double {
      val fnPtr = _799509425_VtblPtr!!.getPointer(26L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__799509425_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_GlobalOffsetY(value: Double): Unit {
      val fnPtr = _799509425_VtblPtr!!.getPointer(27L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__799509425_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_GlobalOffsetZ(): Double {
      val fnPtr = _799509425_VtblPtr!!.getPointer(28L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__799509425_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_GlobalOffsetZ(value: Double): Unit {
      val fnPtr = _799509425_VtblPtr!!.getPointer(29L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__799509425_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ProjectionMatrix(): Matrix3D? {
      val fnPtr = _799509425_VtblPtr!!.getPointer(30L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class IPlaneProjection_Impl(
    ...
    public override val __799509425_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPlaneProjection, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("e6f82bfa6726469ab259a5188347ca8f")
    ...
    public override fun toNative(obj: IPlaneProjection): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__799509425_Ptr))
  }
