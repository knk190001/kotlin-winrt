...
@Signature("{1d56bb07-bda4-478b-8ada-eb04d580cd5e}")
@Guid("1d56bb07bda4478b8adaeb04d580cd5e")
@WinRTInterface("1d56bb07bda4478b8adaeb04d580cd5e")
...
public interface ITimelineFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITimelineFactory {
    public val __1262909757_Ptr: Pointer?

    public val _1262909757_VtblPtr: Pointer?
      get() = __1262909757_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        Timeline? {
      val fnPtr = _1262909757_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Timeline>()
      val hr = fn.invokeHR(arrayOf(__1262909757_Ptr, marshalToNative(baseInterface),
  ...
  public class ITimelineFactory_Impl(
    ...
    public override val __1262909757_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITimelineFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("1d56bb07bda4478b8adaeb04d580cd5e")
    ...
    public override fun toNative(obj: ITimelineFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1262909757_Ptr))
  }
