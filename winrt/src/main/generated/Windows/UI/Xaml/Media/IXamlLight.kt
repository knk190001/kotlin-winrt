...
@Signature("{0cc3fc1f-b327-4a18-9648-7c84db26ce22}")
@Guid("0cc3fc1fb3274a1896487c84db26ce22")
@WinRTInterface("0cc3fc1fb3274a1896487c84db26ce22")
...
public interface IXamlLight : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IXamlLight {
    public val __972925646_Ptr: Pointer?

    public val _972925646_VtblPtr: Pointer?
      get() = __972925646_Ptr?.getPointer(0)
  }

  public class IXamlLight_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __972925646_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IXamlLight, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("0cc3fc1fb3274a1896487c84db26ce22")
    ...
    public override fun toNative(obj: IXamlLight): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__972925646_Ptr))
  }
