...
@Signature("{c61fe488-a17a-4b11-b53b-a4f1a07d4ba9}")
@Guid("c61fe488a17a4b11b53ba4f1a07d4ba9")
@WinRTInterface("c61fe488a17a4b11b53ba4f1a07d4ba9")
...
public interface IDrillInThemeAnimationStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IDrillInThemeAnimationStatics {
    public val __192033392_Ptr: Pointer?

    public val _192033392_VtblPtr: Pointer?
      get() = __192033392_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_EntranceTargetNameProperty(): DependencyProperty? {
      val fnPtr = _192033392_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__192033392_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_EntranceTargetProperty(): DependencyProperty? {
      val fnPtr = _192033392_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__192033392_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ExitTargetNameProperty(): DependencyProperty? {
      val fnPtr = _192033392_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__192033392_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ExitTargetProperty(): DependencyProperty? {
      val fnPtr = _192033392_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__192033392_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IDrillInThemeAnimationStatics_Impl(
    ...
    public override val __192033392_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IDrillInThemeAnimationStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("c61fe488a17a4b11b53ba4f1a07d4ba9")
    ...
    public override fun toNative(obj: IDrillInThemeAnimationStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__192033392_Ptr))
  }
