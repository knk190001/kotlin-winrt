...
import Windows.UI.Xaml.Media.IThemeShadowFactory.ABI.IID
...
@Signature("rc(Windows.UI.Xaml.Media.ThemeShadow;{3eccad09-7985-5f39-8b62-6c10696dca6f})")
...
public open class ThemeShadow(
  ...
  private val __1944762573_Interface: IThemeShadow.WithDefault by lazy {
    as_1944762573()
  }


  public override val __1944762573_Ptr: JNAPointer? by lazy {
    __1944762573_Interface.__1944762573_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1944762573_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1944762573(): IThemeShadow.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<ThemeShadow, MemoryAddress> {
    ...
    public fun createIThemeShadowFactory(): IThemeShadowFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.ThemeShadow".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
