...
@Signature("rc(Windows.UI.Xaml.Media.Animation.BackEase;{e47796e7-f805-4a8f-81c9-38e6472caa94})")
...
public class BackEase(
  ...
  private val __2143711611_Interface: IBackEase.WithDefault by lazy {
    as_2143711611()
  }


  public override val __2143711611_Ptr: JNAPointer? by lazy {
    __2143711611_Interface.__2143711611_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__2143711611_Interface)

  public constructor() : this(ABI.activate())

  private fun as_2143711611(): IBackEase.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<BackEase, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Animation.BackEase".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIBackEaseStatics(): IBackEaseStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Animation.BackEase".toHandle(),refiid,interfacePtr)
