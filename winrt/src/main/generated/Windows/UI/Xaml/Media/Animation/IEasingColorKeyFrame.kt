...
@Signature("{c733d630-f4b9-4934-9bdd-27ac5ed1cfd8}")
@Guid("c733d630f4b949349bdd27ac5ed1cfd8")
@WinRTInterface("c733d630f4b949349bdd27ac5ed1cfd8")
...
public interface IEasingColorKeyFrame : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IEasingColorKeyFrame {
    public val __64540768_Ptr: Pointer?

    public val _64540768_VtblPtr: Pointer?
      get() = __64540768_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_EasingFunction(): EasingFunctionBase? {
      val fnPtr = _64540768_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EasingFunctionBase>()
      val hr = fn.invokeHR(arrayOf(__64540768_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_EasingFunction(value: EasingFunctionBase?): Unit {
      val fnPtr = _64540768_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__64540768_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IEasingColorKeyFrame_Impl(
    ...
    public override val __64540768_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IEasingColorKeyFrame, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("c733d630f4b949349bdd27ac5ed1cfd8")
    ...
    public override fun toNative(obj: IEasingColorKeyFrame): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__64540768_Ptr))
  }
