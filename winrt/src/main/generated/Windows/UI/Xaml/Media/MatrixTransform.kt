...
@Signature("rc(Windows.UI.Xaml.Media.MatrixTransform;{edfdd551-5fed-45fc-ae62-92a4b6cf9707})")
@WinRTByReference(brClass = MatrixTransform.ByReference::class)
public class MatrixTransform(
  ptr: JNAPointer? = NULL
) : Transform(ptr), IMatrixTransform.WithDefault, IWinRTObject {
  private val __1804096303_Interface: IMatrixTransform.WithDefault by lazy {
    as_1804096303()
  }


  public override val __1804096303_Ptr: JNAPointer? by lazy {
    __1804096303_Interface.__1804096303_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1804096303_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1804096303(): IMatrixTransform.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<MatrixTransform, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr = INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.MatrixTransform".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIMatrixTransformStatics(): IMatrixTransformStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.MatrixTransform".toHandle(),refiid,interfacePtr)
