...
@Signature("{e9e9d07d-6340-4828-ad12-690694b9910b}")
@Guid("e9e9d07d63404828ad12690694b9910b")
@WinRTInterface("e9e9d07d63404828ad12690694b9910b")
...
public interface IPointerUpThemeAnimation : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPointerUpThemeAnimation {
    public val __1303043379_Ptr: Pointer?

    public val _1303043379_VtblPtr: Pointer?
      get() = __1303043379_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_TargetName(): String? {
      val fnPtr = _1303043379_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__1303043379_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_TargetName(value: String?): Unit {
      val fnPtr = _1303043379_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1303043379_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IPointerUpThemeAnimation_Impl(
    ...
    public override val __1303043379_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPointerUpThemeAnimation, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("e9e9d07d63404828ad12690694b9910b")
    ...
    public override fun toNative(obj: IPointerUpThemeAnimation): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1303043379_Ptr))
  }
