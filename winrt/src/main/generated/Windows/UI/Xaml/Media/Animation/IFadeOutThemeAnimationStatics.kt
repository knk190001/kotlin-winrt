...
@Signature("{fe17a81a-4168-4f68-a28c-e5dd98cf680f}")
@Guid("fe17a81a41684f68a28ce5dd98cf680f")
@WinRTInterface("fe17a81a41684f68a28ce5dd98cf680f")
...
public interface IFadeOutThemeAnimationStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IFadeOutThemeAnimationStatics {
    public val __1128756098_Ptr: Pointer?

    public val _1128756098_VtblPtr: Pointer?
      get() = __1128756098_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_TargetNameProperty(): DependencyProperty? {
      val fnPtr = _1128756098_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1128756098_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IFadeOutThemeAnimationStatics_Impl(
    ...
    public override val __1128756098_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IFadeOutThemeAnimationStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("fe17a81a41684f68a28ce5dd98cf680f")
    ...
    public override fun toNative(obj: IFadeOutThemeAnimationStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1128756098_Ptr))
  }
