...
@Signature("{059263e9-d2b3-5a77-9cf4-e26d8b542608}")
@Guid("059263e9d2b35a779cf4e26d8b542608")
@WinRTInterface("059263e9d2b35a779cf4e26d8b542608")
...
public interface IDirectConnectedAnimationConfigurationFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IDirectConnectedAnimationConfigurationFactory {
    public val __1797069666_Ptr: Pointer?

    public val _1797069666_VtblPtr: Pointer?
      get() = __1797069666_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        DirectConnectedAnimationConfiguration? {
      val fnPtr = _1797069666_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DirectConnectedAnimationConfiguration>()
      val hr = fn.invokeHR(arrayOf(__1797069666_Ptr, marshalToNative(baseInterface),
  ...
  public class IDirectConnectedAnimationConfigurationFactory_Impl(
    ...
    public override val __1797069666_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IDirectConnectedAnimationConfigurationFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("059263e9d2b35a779cf4e26d8b542608")
    ...
    public override fun toNative(obj: IDirectConnectedAnimationConfigurationFactory): MemoryAddress
        = MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1797069666_Ptr))
  }
