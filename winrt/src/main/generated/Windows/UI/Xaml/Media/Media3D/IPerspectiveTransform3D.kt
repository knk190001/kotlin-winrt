...
@Signature("{9a7b532a-30f9-40a1-96c9-c59d87f95ac3}")
@Guid("9a7b532a30f940a196c9c59d87f95ac3")
@WinRTInterface("9a7b532a30f940a196c9c59d87f95ac3")
...
public interface IPerspectiveTransform3D : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPerspectiveTransform3D {
    public val __490318806_Ptr: Pointer?

    public val _490318806_VtblPtr: Pointer?
      get() = __490318806_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Depth(): Double {
      val fnPtr = _490318806_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__490318806_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Depth(value: Double): Unit {
      val fnPtr = _490318806_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__490318806_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_OffsetX(): Double {
      val fnPtr = _490318806_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__490318806_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_OffsetX(value: Double): Unit {
      val fnPtr = _490318806_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__490318806_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_OffsetY(): Double {
      val fnPtr = _490318806_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__490318806_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_OffsetY(value: Double): Unit {
      val fnPtr = _490318806_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__490318806_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IPerspectiveTransform3D_Impl(
    ...
    public override val __490318806_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPerspectiveTransform3D, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("9a7b532a30f940a196c9c59d87f95ac3")
    ...
    public override fun toNative(obj: IPerspectiveTransform3D): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__490318806_Ptr))
  }
