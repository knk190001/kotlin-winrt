...
@Signature("{7a795033-79f3-4dd9-b267-9cf50fb51f84}")
@Guid("7a79503379f34dd9b2679cf50fb51f84")
@WinRTInterface("7a79503379f34dd9b2679cf50fb51f84")
...
public interface IRepeatBehaviorHelperStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IRepeatBehaviorHelperStatics {
    public val __1941151132_Ptr: Pointer?

    public val _1941151132_VtblPtr: Pointer?
      get() = __1941151132_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Forever(): RepeatBehavior? {
      val fnPtr = _1941151132_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<RepeatBehavior>()
      val hr = fn.invokeHR(arrayOf(__1941151132_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun FromCount(count: Double): RepeatBehavior? {
      val fnPtr = _1941151132_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<RepeatBehavior>()
      val hr = fn.invokeHR(arrayOf(__1941151132_Ptr, count, result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
      val resultValue = marshalFromNative<RepeatBehavior>(result.getValue())
    ...
    public override fun FromDuration(duration: TimeSpan?): RepeatBehavior? {
      val fnPtr = _1941151132_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<RepeatBehavior>()
      val hr = fn.invokeHR(arrayOf(__1941151132_Ptr, marshalToNative(duration), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
      val resultValue = marshalFromNative<RepeatBehavior>(result.getValue())
    ...
    public override fun GetHasCount(target: RepeatBehavior?): Boolean {
      val fnPtr = _1941151132_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1941151132_Ptr, marshalToNative(target), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun GetHasDuration(target: RepeatBehavior?): Boolean {
      val fnPtr = _1941151132_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1941151132_Ptr, marshalToNative(target), result))
      if (hr.toInt() != 0) {
    ...
    public override fun Equals(target: RepeatBehavior?, value: RepeatBehavior?): Boolean {
      val fnPtr = _1941151132_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1941151132_Ptr, marshalToNative(target),
  ...
  public class IRepeatBehaviorHelperStatics_Impl(
    ...
    public override val __1941151132_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IRepeatBehaviorHelperStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("7a79503379f34dd9b2679cf50fb51f84")
    ...
    public override fun toNative(obj: IRepeatBehaviorHelperStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1941151132_Ptr))
  }
