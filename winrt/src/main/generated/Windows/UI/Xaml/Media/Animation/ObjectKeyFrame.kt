...
import Windows.UI.Xaml.Media.Animation.IObjectKeyFrameFactory.ABI.IID
...
@Signature("rc(Windows.UI.Xaml.Media.Animation.ObjectKeyFrame;{9852a851-8593-48ee-a6a4-d5d4720f029a})")
...
public open class ObjectKeyFrame(
  ...
  private val __1985763891_Interface: IObjectKeyFrame.WithDefault by lazy {
    as_1985763891()
  }


  public override val __1985763891_Ptr: JNAPointer? by lazy {
    __1985763891_Interface.__1985763891_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1985763891_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1985763891(): IObjectKeyFrame.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<ObjectKeyFrame, MemoryAddress> {
    ...
    public fun createIObjectKeyFrameStatics(): IObjectKeyFrameStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Animation.ObjectKeyFrame".toHandle(),refiid,interfacePtr)
    ...
    public fun createIObjectKeyFrameFactory(): IObjectKeyFrameFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Animation.ObjectKeyFrame".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
