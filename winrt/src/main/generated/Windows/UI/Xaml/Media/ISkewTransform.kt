...
@Signature("{4e8a3b15-7a0f-4617-9e98-1e65bdc92115}")
@Guid("4e8a3b157a0f46179e981e65bdc92115")
@WinRTInterface("4e8a3b157a0f46179e981e65bdc92115")
...
public interface ISkewTransform : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISkewTransform {
    public val __939243782_Ptr: Pointer?

    public val _939243782_VtblPtr: Pointer?
      get() = __939243782_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_CenterX(): Double {
      val fnPtr = _939243782_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__939243782_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_CenterX(value: Double): Unit {
      val fnPtr = _939243782_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__939243782_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_CenterY(): Double {
      val fnPtr = _939243782_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__939243782_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_CenterY(value: Double): Unit {
      val fnPtr = _939243782_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__939243782_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_AngleX(): Double {
      val fnPtr = _939243782_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__939243782_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_AngleX(value: Double): Unit {
      val fnPtr = _939243782_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__939243782_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_AngleY(): Double {
      val fnPtr = _939243782_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__939243782_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_AngleY(value: Double): Unit {
      val fnPtr = _939243782_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__939243782_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class ISkewTransform_Impl(
    ...
    public override val __939243782_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISkewTransform, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("4e8a3b157a0f46179e981e65bdc92115")
    ...
    public override fun toNative(obj: ISkewTransform): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__939243782_Ptr))
  }
