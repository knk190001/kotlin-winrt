...
@Signature("{109bf2f6-c60f-49aa-abf6-f696d492116b}")
@Guid("109bf2f6c60f49aaabf6f696d492116b")
@WinRTInterface("109bf2f6c60f49aaabf6f696d492116b")
...
public interface IDoubleAnimationUsingKeyFramesStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IDoubleAnimationUsingKeyFramesStatics {
    public val __1126336809_Ptr: Pointer?

    public val _1126336809_VtblPtr: Pointer?
      get() = __1126336809_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_EnableDependentAnimationProperty(): DependencyProperty? {
      val fnPtr = _1126336809_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1126336809_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IDoubleAnimationUsingKeyFramesStatics_Impl(
    ...
    public override val __1126336809_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IDoubleAnimationUsingKeyFramesStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("109bf2f6c60f49aaabf6f696d492116b")
    ...
    public override fun toNative(obj: IDoubleAnimationUsingKeyFramesStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1126336809_Ptr))
  }
