...
@Signature("rc(Windows.UI.Xaml.Media.Animation.PowerEase;{69c80579-eedf-405b-8680-d9606880c937})")
...
public class PowerEase(
  ...
  private val __1564669773_Interface: IPowerEase.WithDefault by lazy {
    as_1564669773()
  }


  public override val __1564669773_Ptr: JNAPointer? by lazy {
    __1564669773_Interface.__1564669773_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1564669773_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1564669773(): IPowerEase.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<PowerEase, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Animation.PowerEase".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIPowerEaseStatics(): IPowerEaseStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Animation.PowerEase".toHandle(),refiid,interfacePtr)
