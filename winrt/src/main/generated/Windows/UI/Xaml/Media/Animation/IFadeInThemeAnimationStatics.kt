...
@Signature("{7f0117e1-bea9-4923-b23a-0ddf4d7b8737}")
@Guid("7f0117e1bea94923b23a0ddf4d7b8737")
@WinRTInterface("7f0117e1bea94923b23a0ddf4d7b8737")
...
public interface IFadeInThemeAnimationStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IFadeInThemeAnimationStatics {
    public val __2008629373_Ptr: Pointer?

    public val _2008629373_VtblPtr: Pointer?
      get() = __2008629373_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_TargetNameProperty(): DependencyProperty? {
      val fnPtr = _2008629373_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__2008629373_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IFadeInThemeAnimationStatics_Impl(
    ...
    public override val __2008629373_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IFadeInThemeAnimationStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("7f0117e1bea94923b23a0ddf4d7b8737")
    ...
    public override fun toNative(obj: IFadeInThemeAnimationStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2008629373_Ptr))
  }
