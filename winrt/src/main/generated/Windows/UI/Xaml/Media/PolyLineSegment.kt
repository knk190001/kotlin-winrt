...
@Signature("rc(Windows.UI.Xaml.Media.PolyLineSegment;{4b397f87-a2e6-479d-bdc8-6f4464646887})")
...
public class PolyLineSegment(
  ...
  private val __984882103_Interface: IPolyLineSegment.WithDefault by lazy {
    as_984882103()
  }


  public override val __984882103_Ptr: JNAPointer? by lazy {
    __984882103_Interface.__984882103_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__984882103_Interface)

  public constructor() : this(ABI.activate())

  private fun as_984882103(): IPolyLineSegment.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<PolyLineSegment, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr = INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.PolyLineSegment".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIPolyLineSegmentStatics(): IPolyLineSegmentStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.PolyLineSegment".toHandle(),refiid,interfacePtr)
