...
@Signature("rc(Windows.UI.Xaml.Media.Animation.EdgeUIThemeTransition;{5c86c19b-49d7-19ec-cf19-83a73c6de75e})")
...
public class EdgeUIThemeTransition(
  ...
  private val __1928525721_Interface: IEdgeUIThemeTransition.WithDefault by lazy {
    as_1928525721()
  }


  public override val __1928525721_Ptr: JNAPointer? by lazy {
    __1928525721_Interface.__1928525721_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1928525721_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1928525721(): IEdgeUIThemeTransition.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<EdgeUIThemeTransition, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Animation.EdgeUIThemeTransition".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIEdgeUIThemeTransitionStatics(): IEdgeUIThemeTransitionStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Animation.EdgeUIThemeTransition".toHandle(),refiid,interfacePtr)
      val result =
