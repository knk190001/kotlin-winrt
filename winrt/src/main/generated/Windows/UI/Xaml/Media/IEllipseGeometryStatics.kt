...
@Signature("{1744db47-f635-4b16-aee6-e052a65defb2}")
@Guid("1744db47f6354b16aee6e052a65defb2")
@WinRTInterface("1744db47f6354b16aee6e052a65defb2")
...
public interface IEllipseGeometryStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IEllipseGeometryStatics {
    public val __163423183_Ptr: Pointer?

    public val _163423183_VtblPtr: Pointer?
      get() = __163423183_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_CenterProperty(): DependencyProperty? {
      val fnPtr = _163423183_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__163423183_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_RadiusXProperty(): DependencyProperty? {
      val fnPtr = _163423183_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__163423183_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_RadiusYProperty(): DependencyProperty? {
      val fnPtr = _163423183_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__163423183_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IEllipseGeometryStatics_Impl(
    ...
    public override val __163423183_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IEllipseGeometryStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("1744db47f6354b16aee6e052a65defb2")
    ...
    public override fun toNative(obj: IEllipseGeometryStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__163423183_Ptr))
  }
