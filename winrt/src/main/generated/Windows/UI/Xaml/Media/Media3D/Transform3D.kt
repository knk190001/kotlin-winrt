...
import Windows.UI.Xaml.Media.Media3D.ITransform3DFactory.ABI.IID
...
@Signature("rc(Windows.UI.Xaml.Media.Media3D.Transform3D;{ae3ed43a-a9fc-4c31-86cd-56d9ca251a69})")
...
public open class Transform3D(
  ...
  private val __1491040984_Interface: ITransform3D.WithDefault by lazy {
    as_1491040984()
  }


  public override val __1491040984_Ptr: JNAPointer? by lazy {
    __1491040984_Interface.__1491040984_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1491040984_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1491040984(): ITransform3D.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<Transform3D, MemoryAddress> {
    ...
    public fun createITransform3DFactory(): ITransform3DFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Media3D.Transform3D".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
