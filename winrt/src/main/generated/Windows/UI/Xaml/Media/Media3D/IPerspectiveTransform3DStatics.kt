...
@Signature("{8e6f6400-620c-48c7-844d-3f0984da5b17}")
@Guid("8e6f6400620c48c7844d3f0984da5b17")
@WinRTInterface("8e6f6400620c48c7844d3f0984da5b17")
...
public interface IPerspectiveTransform3DStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPerspectiveTransform3DStatics {
    public val __1912606479_Ptr: Pointer?

    public val _1912606479_VtblPtr: Pointer?
      get() = __1912606479_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_DepthProperty(): DependencyProperty? {
      val fnPtr = _1912606479_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1912606479_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_OffsetXProperty(): DependencyProperty? {
      val fnPtr = _1912606479_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1912606479_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_OffsetYProperty(): DependencyProperty? {
      val fnPtr = _1912606479_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1912606479_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IPerspectiveTransform3DStatics_Impl(
    ...
    public override val __1912606479_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPerspectiveTransform3DStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("8e6f6400620c48c7844d3f0984da5b17")
    ...
    public override fun toNative(obj: IPerspectiveTransform3DStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1912606479_Ptr))
  }
