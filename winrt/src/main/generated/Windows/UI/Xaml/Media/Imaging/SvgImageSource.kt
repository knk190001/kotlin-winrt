...
import Windows.UI.Xaml.Media.Imaging.ISvgImageSourceFactory.ABI.IID
...
@Signature("rc(Windows.UI.Xaml.Media.Imaging.SvgImageSource;{03e1cec3-0ca8-4a4e-8d7c-c808a0838586})")
...
public open class SvgImageSource(
  ...
  private val __386741700_Interface: ISvgImageSource.WithDefault by lazy {
    as_386741700()
  }


  public override val __386741700_Ptr: JNAPointer? by lazy {
    __386741700_Interface.__386741700_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__386741700_Interface)

  public constructor() : this(ABI.activate())

  public constructor(uriSource: Uri) : this(ABI.activate(uriSource))

  private fun as_386741700(): ISvgImageSource.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<SvgImageSource, MemoryAddress> {
    ...
    public fun createISvgImageSourceStatics(): ISvgImageSourceStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Imaging.SvgImageSource".toHandle(),refiid,interfacePtr)
    ...
    public fun createISvgImageSourceFactory(): ISvgImageSourceFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Imaging.SvgImageSource".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
