...
@Signature("rc(Windows.UI.Xaml.Media.Animation.PopupThemeTransition;{47843552-4283-545e-c791-268dca22ce4b})")
...
public class PopupThemeTransition(
  ...
  private val __898545848_Interface: IPopupThemeTransition.WithDefault by lazy {
    as_898545848()
  }


  public override val __898545848_Ptr: JNAPointer? by lazy {
    __898545848_Interface.__898545848_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__898545848_Interface)

  public constructor() : this(ABI.activate())

  private fun as_898545848(): IPopupThemeTransition.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<PopupThemeTransition, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Animation.PopupThemeTransition".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIPopupThemeTransitionStatics(): IPopupThemeTransitionStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Animation.PopupThemeTransition".toHandle(),refiid,interfacePtr)
      val result =
