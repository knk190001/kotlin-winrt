...
@Signature("rc(Windows.UI.Xaml.Media.Imaging.DownloadProgressEventArgs;{7311e0d4-fe94-4e70-9b90-cdd47ac23afb})")
...
public class DownloadProgressEventArgs(
  ...
  private val __151868048_Interface: IDownloadProgressEventArgs.WithDefault by lazy {
    as_151868048()
  }


  public override val __151868048_Ptr: JNAPointer? by lazy {
    __151868048_Interface.__151868048_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__151868048_Interface)

  private fun as_151868048(): IDownloadProgressEventArgs.WithDefault {
    if(pointer == NULL) {
