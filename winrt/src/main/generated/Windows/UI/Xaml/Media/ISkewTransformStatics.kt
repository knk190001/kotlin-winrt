...
@Signature("{ecd11d73-5614-4b31-b6af-beae10105624}")
@Guid("ecd11d7356144b31b6afbeae10105624")
@WinRTInterface("ecd11d7356144b31b6afbeae10105624")
...
public interface ISkewTransformStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISkewTransformStatics {
    public val __41798623_Ptr: Pointer?

    public val _41798623_VtblPtr: Pointer?
      get() = __41798623_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_CenterXProperty(): DependencyProperty? {
      val fnPtr = _41798623_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__41798623_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_CenterYProperty(): DependencyProperty? {
      val fnPtr = _41798623_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__41798623_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_AngleXProperty(): DependencyProperty? {
      val fnPtr = _41798623_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__41798623_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_AngleYProperty(): DependencyProperty? {
      val fnPtr = _41798623_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__41798623_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ISkewTransformStatics_Impl(
    ...
    public override val __41798623_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISkewTransformStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("ecd11d7356144b31b6afbeae10105624")
    ...
    public override fun toNative(obj: ISkewTransformStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__41798623_Ptr))
  }
