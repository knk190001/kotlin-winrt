...
@Signature("{1a4a5941-1fe0-473a-8efe-4316d8c86229}")
@Guid("1a4a59411fe0473a8efe4316d8c86229")
@WinRTInterface("1a4a59411fe0473a8efe4316d8c86229")
...
public interface ISplineColorKeyFrame : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISplineColorKeyFrame {
    public val __945544518_Ptr: Pointer?

    public val _945544518_VtblPtr: Pointer?
      get() = __945544518_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_KeySpline(): KeySpline? {
      val fnPtr = _945544518_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<KeySpline>()
      val hr = fn.invokeHR(arrayOf(__945544518_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_KeySpline(value: KeySpline?): Unit {
      val fnPtr = _945544518_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__945544518_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class ISplineColorKeyFrame_Impl(
    ...
    public override val __945544518_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISplineColorKeyFrame, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("1a4a59411fe0473a8efe4316d8c86229")
    ...
    public override fun toNative(obj: ISplineColorKeyFrame): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__945544518_Ptr))
  }
