...
@Signature("{665f44fe-2e59-4c4a-ab53-076a100ccd81}")
@Guid("665f44fe2e594c4aab53076a100ccd81")
@WinRTInterface("665f44fe2e594c4aab53076a100ccd81")
...
public interface IGradientStop : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IGradientStop {
    public val __776055986_Ptr: Pointer?

    public val _776055986_VtblPtr: Pointer?
      get() = __776055986_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Color(): Color? {
      val fnPtr = _776055986_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__776055986_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Color(value: Color?): Unit {
      val fnPtr = _776055986_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__776055986_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Offset(): Double {
      val fnPtr = _776055986_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Offset(value: Double): Unit {
      val fnPtr = _776055986_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__776055986_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IGradientStop_Impl(
    ...
    public override val __776055986_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IGradientStop, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("665f44fe2e594c4aab53076a100ccd81")
    ...
    public override fun toNative(obj: IGradientStop): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__776055986_Ptr))
  }
