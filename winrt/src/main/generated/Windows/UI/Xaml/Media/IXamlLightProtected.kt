...
import Windows.UI.Composition.CompositionLight
...
@Signature("{5ecf220b-1252-43d0-9729-6ea692046838}")
@Guid("5ecf220b125243d097296ea692046838")
@WinRTInterface("5ecf220b125243d097296ea692046838")
...
public interface IXamlLightProtected : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IXamlLightProtected {
    public val __1213329052_Ptr: Pointer?

    public val _1213329052_VtblPtr: Pointer?
      get() = __1213329052_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_CompositionLight(): CompositionLight? {
      val fnPtr = _1213329052_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CompositionLight>()
      val hr = fn.invokeHR(arrayOf(__1213329052_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_CompositionLight(value: CompositionLight?): Unit {
      val fnPtr = _1213329052_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1213329052_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IXamlLightProtected_Impl(
    ...
    public override val __1213329052_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IXamlLightProtected, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("5ecf220b125243d097296ea692046838")
    ...
    public override fun toNative(obj: IXamlLightProtected): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1213329052_Ptr))
  }
