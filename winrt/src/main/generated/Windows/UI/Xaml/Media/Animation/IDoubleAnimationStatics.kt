...
@Signature("{e27a935d-f111-43b7-b824-832b58d7786b}")
@Guid("e27a935df11143b7b824832b58d7786b")
@WinRTInterface("e27a935df11143b7b824832b58d7786b")
...
public interface IDoubleAnimationStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IDoubleAnimationStatics {
    public val __853744408_Ptr: Pointer?

    public val _853744408_VtblPtr: Pointer?
      get() = __853744408_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_FromProperty(): DependencyProperty? {
      val fnPtr = _853744408_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__853744408_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ToProperty(): DependencyProperty? {
      val fnPtr = _853744408_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__853744408_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ByProperty(): DependencyProperty? {
      val fnPtr = _853744408_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__853744408_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_EasingFunctionProperty(): DependencyProperty? {
      val fnPtr = _853744408_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__853744408_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_EnableDependentAnimationProperty(): DependencyProperty? {
      val fnPtr = _853744408_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__853744408_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IDoubleAnimationStatics_Impl(
    ...
    public override val __853744408_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IDoubleAnimationStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("e27a935df11143b7b824832b58d7786b")
    ...
    public override fun toNative(obj: IDoubleAnimationStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__853744408_Ptr))
  }
