...
@Signature("{b5ea9d69-b508-4e9c-bd27-6b044b5f78a0}")
@Guid("b5ea9d69b5084e9cbd276b044b5f78a0")
@WinRTInterface("b5ea9d69b5084e9cbd276b044b5f78a0")
...
public interface IXamlLightStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IXamlLightStatics {
    public val __742169037_Ptr: Pointer?

    public val _742169037_VtblPtr: Pointer?
      get() = __742169037_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun AddTargetElement(lightId: String?, element: UIElement?): Unit {
      val fnPtr = _742169037_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__742169037_Ptr, marshalToNative(lightId),
    ...
    public override fun RemoveTargetElement(lightId: String?, element: UIElement?): Unit {
      val fnPtr = _742169037_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__742169037_Ptr, marshalToNative(lightId),
          marshalToNative(element),))
      if (hr.toInt() != 0) {
    ...
    public override fun AddTargetBrush(lightId: String?, brush: Brush?): Unit {
      val fnPtr = _742169037_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__742169037_Ptr, marshalToNative(lightId),
    ...
    public override fun RemoveTargetBrush(lightId: String?, brush: Brush?): Unit {
      val fnPtr = _742169037_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__742169037_Ptr, marshalToNative(lightId),
          marshalToNative(brush),))
      if (hr.toInt() != 0) {
  ...
  public class IXamlLightStatics_Impl(
    ...
    public override val __742169037_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IXamlLightStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("b5ea9d69b5084e9cbd276b044b5f78a0")
    ...
    public override fun toNative(obj: IXamlLightStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__742169037_Ptr))
  }
