...
@Signature("{c043ae99-210c-430f-9da5-df1082692055}")
@Guid("c043ae99210c430f9da5df1082692055")
@WinRTInterface("c043ae99210c430f9da5df1082692055")
...
public interface IColorKeyFrameStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IColorKeyFrameStatics {
    public val __93733562_Ptr: Pointer?

    public val _93733562_VtblPtr: Pointer?
      get() = __93733562_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ValueProperty(): DependencyProperty? {
      val fnPtr = _93733562_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__93733562_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_KeyTimeProperty(): DependencyProperty? {
      val fnPtr = _93733562_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__93733562_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IColorKeyFrameStatics_Impl(
    ...
    public override val __93733562_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IColorKeyFrameStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("c043ae99210c430f9da5df1082692055")
    ...
    public override fun toNative(obj: IColorKeyFrameStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__93733562_Ptr))
  }
