...
@Signature("{adec852e-4424-4dab-99c1-3a04e36a3c48}")
@Guid("adec852e44244dab99c13a04e36a3c48")
@WinRTInterface("adec852e44244dab99c13a04e36a3c48")
...
public interface IAddDeleteThemeTransition : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IAddDeleteThemeTransition {
    public val __1644795720_Ptr: Pointer?

    public val _1644795720_VtblPtr: Pointer?
      get() = __1644795720_Ptr?.getPointer(0)
  }

  public class IAddDeleteThemeTransition_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __1644795720_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IAddDeleteThemeTransition, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("adec852e44244dab99c13a04e36a3c48")
    ...
    public override fun toNative(obj: IAddDeleteThemeTransition): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1644795720_Ptr))
  }
