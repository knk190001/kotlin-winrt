...
@Signature("{7fa2612c-22a9-45e9-9af7-c7416efff7a5}")
@Guid("7fa2612c22a945e99af7c7416efff7a5")
@WinRTInterface("7fa2612c22a945e99af7c7416efff7a5")
...
public interface IKeyTimeHelperStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IKeyTimeHelperStatics {
    public val __1932168401_Ptr: Pointer?

    public val _1932168401_VtblPtr: Pointer?
      get() = __1932168401_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun FromTimeSpan(timeSpan: TimeSpan?): KeyTime? {
      val fnPtr = _1932168401_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<KeyTime>()
      val hr = fn.invokeHR(arrayOf(__1932168401_Ptr, marshalToNative(timeSpan), result))
      if (hr.toInt() != 0) {
  ...
  public class IKeyTimeHelperStatics_Impl(
    ...
    public override val __1932168401_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IKeyTimeHelperStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("7fa2612c22a945e99af7c7416efff7a5")
    ...
    public override fun toNative(obj: IKeyTimeHelperStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1932168401_Ptr))
  }
