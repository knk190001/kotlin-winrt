...
@Signature("rc(Windows.UI.Xaml.Media.GradientStop;{665f44fe-2e59-4c4a-ab53-076a100ccd81})")
@WinRTByReference(brClass = GradientStop.ByReference::class)
public class GradientStop(
  ptr: JNAPointer? = NULL
) : DependencyObject(ptr), IGradientStop.WithDefault, IWinRTObject {
  private val __776055986_Interface: IGradientStop.WithDefault by lazy {
    as_776055986()
  }


  public override val __776055986_Ptr: JNAPointer? by lazy {
    __776055986_Interface.__776055986_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__776055986_Interface)

  public constructor() : this(ABI.activate())

  private fun as_776055986(): IGradientStop.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<GradientStop, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr = INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.GradientStop".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIGradientStopStatics(): IGradientStopStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.GradientStop".toHandle(),refiid,interfacePtr)
