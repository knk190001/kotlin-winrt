...
@Signature("{e47796e7-f805-4a8f-81c9-38e6472caa94}")
@Guid("e47796e7f8054a8f81c938e6472caa94")
@WinRTInterface("e47796e7f8054a8f81c938e6472caa94")
...
public interface IBackEase : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IBackEase {
    public val __2143711611_Ptr: Pointer?

    public val _2143711611_VtblPtr: Pointer?
      get() = __2143711611_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Amplitude(): Double {
      val fnPtr = _2143711611_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__2143711611_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Amplitude(value: Double): Unit {
      val fnPtr = _2143711611_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2143711611_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IBackEase_Impl(
    ...
    public override val __2143711611_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IBackEase, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("e47796e7f8054a8f81c938e6472caa94")
    ...
    public override fun toNative(obj: IBackEase): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2143711611_Ptr))
  }
