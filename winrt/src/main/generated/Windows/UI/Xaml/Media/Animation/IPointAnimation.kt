...
@Signature("{30f04312-7726-4f88-b8e2-2fa54518963b}")
@Guid("30f0431277264f88b8e22fa54518963b")
@WinRTInterface("30f0431277264f88b8e22fa54518963b")
...
public interface IPointAnimation : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPointAnimation {
    public val __1289612122_Ptr: Pointer?

    public val _1289612122_VtblPtr: Pointer?
      get() = __1289612122_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_From(): IReference<Point?>? {
      val fnPtr = _1289612122_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IReference<Point?>>()
      val hr = fn.invokeHR(arrayOf(__1289612122_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_From(value: IReference<Point?>?): Unit {
      val fnPtr = _1289612122_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1289612122_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_To(): IReference<Point?>? {
      val fnPtr = _1289612122_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IReference<Point?>>()
      val hr = fn.invokeHR(arrayOf(__1289612122_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_To(value: IReference<Point?>?): Unit {
      val fnPtr = _1289612122_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1289612122_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_By(): IReference<Point?>? {
      val fnPtr = _1289612122_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IReference<Point?>>()
      val hr = fn.invokeHR(arrayOf(__1289612122_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_By(value: IReference<Point?>?): Unit {
      val fnPtr = _1289612122_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1289612122_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_EasingFunction(): EasingFunctionBase? {
      val fnPtr = _1289612122_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_EasingFunction(value: EasingFunctionBase?): Unit {
      val fnPtr = _1289612122_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1289612122_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_EnableDependentAnimation(): Boolean {
      val fnPtr = _1289612122_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_EnableDependentAnimation(value: Boolean): Unit {
      val fnPtr = _1289612122_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1289612122_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IPointAnimation_Impl(
    ...
    public override val __1289612122_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPointAnimation, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("30f0431277264f88b8e22fa54518963b")
    ...
    public override fun toNative(obj: IPointAnimation): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1289612122_Ptr))
  }
