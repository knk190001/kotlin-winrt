...
@Signature("{c0701da2-4f73-41c9-b2cb-2ea3105107ff}")
@Guid("c0701da24f7341c9b2cb2ea3105107ff")
@WinRTInterface("c0701da24f7341c9b2cb2ea3105107ff")
...
public interface IBounceEaseStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IBounceEaseStatics {
    public val __19947767_Ptr: Pointer?

    public val _19947767_VtblPtr: Pointer?
      get() = __19947767_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_BouncesProperty(): DependencyProperty? {
      val fnPtr = _19947767_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__19947767_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_BouncinessProperty(): DependencyProperty? {
      val fnPtr = _19947767_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__19947767_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IBounceEaseStatics_Impl(
    ...
    public override val __19947767_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IBounceEaseStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("c0701da24f7341c9b2cb2ea3105107ff")
    ...
    public override fun toNative(obj: IBounceEaseStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__19947767_Ptr))
  }
