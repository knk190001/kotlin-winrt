...
@Signature("rc(Windows.UI.Xaml.Media.QuadraticBezierSegment;{2c509a5b-bf18-455a-a078-914b5232d8af})")
...
public class QuadraticBezierSegment(
  ...
  private val __316837912_Interface: IQuadraticBezierSegment.WithDefault by lazy {
    as_316837912()
  }


  public override val __316837912_Ptr: JNAPointer? by lazy {
    __316837912_Interface.__316837912_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__316837912_Interface)

  public constructor() : this(ABI.activate())

  private fun as_316837912(): IQuadraticBezierSegment.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<QuadraticBezierSegment, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.QuadraticBezierSegment".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIQuadraticBezierSegmentStatics(): IQuadraticBezierSegmentStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.QuadraticBezierSegment".toHandle(),refiid,interfacePtr)
      val result =
