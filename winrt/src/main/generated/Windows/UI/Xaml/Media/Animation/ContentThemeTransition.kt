...
@Signature("rc(Windows.UI.Xaml.Media.Animation.ContentThemeTransition;{f66fc5c3-5915-437d-8e3b-adf8e7f0ab57})")
...
public class ContentThemeTransition(
  ...
  private val __1593874379_Interface: IContentThemeTransition.WithDefault by lazy {
    as_1593874379()
  }


  public override val __1593874379_Ptr: JNAPointer? by lazy {
    __1593874379_Interface.__1593874379_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1593874379_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1593874379(): IContentThemeTransition.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<ContentThemeTransition, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Animation.ContentThemeTransition".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIContentThemeTransitionStatics(): IContentThemeTransitionStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Animation.ContentThemeTransition".toHandle(),refiid,interfacePtr)
      val result =
