...
@Signature("rc(Windows.UI.Xaml.Media.Animation.DoubleAnimationUsingKeyFrames;{4fee628f-bfee-4f75-83c2-a93b39488473})")
...
public class DoubleAnimationUsingKeyFrames(
  ...
  private val __1802106126_Interface: IDoubleAnimationUsingKeyFrames.WithDefault by lazy {
    as_1802106126()
  }


  public override val __1802106126_Ptr: JNAPointer? by lazy {
    __1802106126_Interface.__1802106126_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1802106126_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1802106126(): IDoubleAnimationUsingKeyFrames.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<DoubleAnimationUsingKeyFrames, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Animation.DoubleAnimationUsingKeyFrames".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIDoubleAnimationUsingKeyFramesStatics():
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Animation.DoubleAnimationUsingKeyFrames".toHandle(),refiid,interfacePtr)
      val result =
