...
@Signature("rc(Windows.UI.Xaml.Media.LineSegment;{ef6a2e25-3ff0-4420-a411-7182a4cecb15})")
@WinRTByReference(brClass = LineSegment.ByReference::class)
public class LineSegment(
  ptr: JNAPointer? = NULL
) : PathSegment(ptr), ILineSegment.WithDefault, IWinRTObject {
  private val __518751523_Interface: ILineSegment.WithDefault by lazy {
    as_518751523()
  }


  public override val __518751523_Ptr: JNAPointer? by lazy {
    __518751523_Interface.__518751523_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__518751523_Interface)

  public constructor() : this(ABI.activate())

  private fun as_518751523(): ILineSegment.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<LineSegment, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr = INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.LineSegment".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createILineSegmentStatics(): ILineSegmentStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.LineSegment".toHandle(),refiid,interfacePtr)
