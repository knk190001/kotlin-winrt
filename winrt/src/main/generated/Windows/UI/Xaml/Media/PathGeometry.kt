...
@Signature("rc(Windows.UI.Xaml.Media.PathGeometry;{081b9df8-bae6-4bcb-813c-bde0e46dc8b7})")
...
public class PathGeometry(
  ...
  private val __607857741_Interface: IPathGeometry.WithDefault by lazy {
    as_607857741()
  }


  public override val __607857741_Ptr: JNAPointer? by lazy {
    __607857741_Interface.__607857741_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__607857741_Interface)

  public constructor() : this(ABI.activate())

  private fun as_607857741(): IPathGeometry.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<PathGeometry, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr = INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.PathGeometry".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIPathGeometryStatics(): IPathGeometryStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.PathGeometry".toHandle(),refiid,interfacePtr)
