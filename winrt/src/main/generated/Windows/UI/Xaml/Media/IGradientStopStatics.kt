...
@Signature("{602a6d75-6193-4fe5-8e82-c7c6f6febafd}")
@Guid("602a6d7561934fe58e82c7c6f6febafd")
@WinRTInterface("602a6d7561934fe58e82c7c6f6febafd")
...
public interface IGradientStopStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IGradientStopStatics {
    public val __154234729_Ptr: Pointer?

    public val _154234729_VtblPtr: Pointer?
      get() = __154234729_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ColorProperty(): DependencyProperty? {
      val fnPtr = _154234729_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__154234729_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_OffsetProperty(): DependencyProperty? {
      val fnPtr = _154234729_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__154234729_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IGradientStopStatics_Impl(
    ...
    public override val __154234729_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IGradientStopStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("602a6d7561934fe58e82c7c6f6febafd")
    ...
    public override fun toNative(obj: IGradientStopStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__154234729_Ptr))
  }
