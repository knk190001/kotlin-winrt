...
@Signature("{3e25dd53-b18f-4bf1-b3bc-92f516f29903}")
@Guid("3e25dd53b18f4bf1b3bc92f516f29903")
@WinRTInterface("3e25dd53b18f4bf1b3bc92f516f29903")
...
public interface IContinuumNavigationTransitionInfoStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IContinuumNavigationTransitionInfoStatics {
    public val __563008382_Ptr: Pointer?

    public val _563008382_VtblPtr: Pointer?
      get() = __563008382_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ExitElementProperty(): DependencyProperty? {
      val fnPtr = _563008382_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__563008382_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsEntranceElementProperty(): DependencyProperty? {
      val fnPtr = _563008382_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__563008382_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetIsEntranceElement(element: UIElement?): Boolean {
      val fnPtr = _563008382_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__563008382_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun SetIsEntranceElement(element: UIElement?, value: Boolean): Unit {
      val fnPtr = _563008382_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__563008382_Ptr, marshalToNative(element), value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_IsExitElementProperty(): DependencyProperty? {
      val fnPtr = _563008382_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__563008382_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetIsExitElement(element: UIElement?): Boolean {
      val fnPtr = _563008382_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__563008382_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
    ...
    public override fun SetIsExitElement(element: UIElement?, value: Boolean): Unit {
      val fnPtr = _563008382_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__563008382_Ptr, marshalToNative(element), value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ExitElementContainerProperty(): DependencyProperty? {
      val fnPtr = _563008382_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__563008382_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetExitElementContainer(element: ListViewBase?): Boolean {
      val fnPtr = _563008382_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__563008382_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
    ...
    public override fun SetExitElementContainer(element: ListViewBase?, value: Boolean): Unit {
      val fnPtr = _563008382_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__563008382_Ptr, marshalToNative(element), value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IContinuumNavigationTransitionInfoStatics_Impl(
    ...
    public override val __563008382_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IContinuumNavigationTransitionInfoStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("3e25dd53b18f4bf1b3bc92f516f29903")
    ...
    public override fun toNative(obj: IContinuumNavigationTransitionInfoStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__563008382_Ptr))
  }
