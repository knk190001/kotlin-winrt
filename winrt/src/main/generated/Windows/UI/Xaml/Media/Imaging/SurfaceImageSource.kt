...
import Windows.UI.Xaml.Media.Imaging.ISurfaceImageSourceFactory.ABI.IID
...
@Signature("rc(Windows.UI.Xaml.Media.Imaging.SurfaceImageSource;{62f7d416-c714-4c4c-8273-f839bc58135c})")
...
public open class SurfaceImageSource(
  ...
  private val __1980786395_Interface: ISurfaceImageSource.WithDefault by lazy {
    as_1980786395()
  }


  public override val __1980786395_Ptr: JNAPointer? by lazy {
    __1980786395_Interface.__1980786395_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1980786395_Interface)
  ...
  private fun as_1980786395(): ISurfaceImageSource.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<SurfaceImageSource, MemoryAddress> {
    ...
    public fun createISurfaceImageSourceFactory(): ISurfaceImageSourceFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Imaging.SurfaceImageSource".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
