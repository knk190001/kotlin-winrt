...
@Signature("{ae80f486-2e56-4513-bf18-d77470164ae5}")
@Guid("ae80f4862e564513bf18d77470164ae5")
@WinRTInterface("ae80f4862e564513bf18d77470164ae5")
...
public interface IDropTargetItemThemeAnimationStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IDropTargetItemThemeAnimationStatics {
    public val __2037084401_Ptr: Pointer?

    public val _2037084401_VtblPtr: Pointer?
      get() = __2037084401_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_TargetNameProperty(): DependencyProperty? {
      val fnPtr = _2037084401_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__2037084401_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IDropTargetItemThemeAnimationStatics_Impl(
    ...
    public override val __2037084401_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IDropTargetItemThemeAnimationStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("ae80f4862e564513bf18d77470164ae5")
    ...
    public override fun toNative(obj: IDropTargetItemThemeAnimationStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2037084401_Ptr))
  }
