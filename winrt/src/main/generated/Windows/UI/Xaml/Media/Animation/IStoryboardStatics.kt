...
@Signature("{d82f07d8-73d5-4379-bd48-7e05184a8bad}")
@Guid("d82f07d873d54379bd487e05184a8bad")
@WinRTInterface("d82f07d873d54379bd487e05184a8bad")
...
public interface IStoryboardStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IStoryboardStatics {
    public val __131117614_Ptr: Pointer?

    public val _131117614_VtblPtr: Pointer?
      get() = __131117614_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_TargetPropertyProperty(): DependencyProperty? {
      val fnPtr = _131117614_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__131117614_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetTargetProperty(element: Timeline?): String? {
      val fnPtr = _131117614_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__131117614_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun SetTargetProperty(element: Timeline?, path: String?): Unit {
      val fnPtr = _131117614_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__131117614_Ptr, marshalToNative(element),
    ...
    public override fun get_TargetNameProperty(): DependencyProperty? {
      val fnPtr = _131117614_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__131117614_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetTargetName(element: Timeline?): String? {
      val fnPtr = _131117614_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__131117614_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
    ...
    public override fun SetTargetName(element: Timeline?, name: String?): Unit {
      val fnPtr = _131117614_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__131117614_Ptr, marshalToNative(element),
    ...
    public override fun SetTarget(timeline: Timeline?, target: DependencyObject?): Unit {
      val fnPtr = _131117614_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__131117614_Ptr, marshalToNative(timeline),
  ...
  public class IStoryboardStatics_Impl(
    ...
    public override val __131117614_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IStoryboardStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("d82f07d873d54379bd487e05184a8bad")
    ...
    public override fun toNative(obj: IStoryboardStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__131117614_Ptr))
  }
