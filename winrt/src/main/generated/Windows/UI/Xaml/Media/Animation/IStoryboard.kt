...
@Signature("{d45c1e6e-3594-460e-981a-32271bd3aa06}")
@Guid("d45c1e6e3594460e981a32271bd3aa06")
@WinRTInterface("d45c1e6e3594460e981a32271bd3aa06")
...
public interface IStoryboard : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IStoryboard {
    public val __1954103913_Ptr: Pointer?

    public val _1954103913_VtblPtr: Pointer?
      get() = __1954103913_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Children(): TimelineCollection? {
      val fnPtr = _1954103913_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<TimelineCollection>()
      val hr = fn.invokeHR(arrayOf(__1954103913_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun Seek(offset: TimeSpan?): Unit {
      val fnPtr = _1954103913_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1954103913_Ptr, marshalToNative(offset),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun Stop(): Unit {
      val fnPtr = _1954103913_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1954103913_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun Begin(): Unit {
      val fnPtr = _1954103913_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1954103913_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun Pause(): Unit {
      val fnPtr = _1954103913_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1954103913_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun Resume(): Unit {
      val fnPtr = _1954103913_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1954103913_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun GetCurrentState(): ClockState? {
      val fnPtr = _1954103913_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun GetCurrentTime(): TimeSpan? {
      val fnPtr = _1954103913_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun SeekAlignedToLastTick(offset: TimeSpan?): Unit {
      val fnPtr = _1954103913_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1954103913_Ptr, marshalToNative(offset),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun SkipToFill(): Unit {
      val fnPtr = _1954103913_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1954103913_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IStoryboard_Impl(
    ...
    public override val __1954103913_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IStoryboard, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("d45c1e6e3594460e981a32271bd3aa06")
    ...
    public override fun toNative(obj: IStoryboard): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1954103913_Ptr))
  }
