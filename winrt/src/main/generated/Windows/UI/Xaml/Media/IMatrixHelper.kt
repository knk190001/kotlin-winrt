...
@Signature("{f3cf4882-06b5-48c8-9eb2-1763e9364038}")
@Guid("f3cf488206b548c89eb21763e9364038")
@WinRTInterface("f3cf488206b548c89eb21763e9364038")
...
public interface IMatrixHelper : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IMatrixHelper {
    public val __90175179_Ptr: Pointer?

    public val _90175179_VtblPtr: Pointer?
      get() = __90175179_Ptr?.getPointer(0)
  }

  public class IMatrixHelper_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __90175179_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IMatrixHelper, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("f3cf488206b548c89eb21763e9364038")
    ...
    public override fun toNative(obj: IMatrixHelper): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__90175179_Ptr))
  }
