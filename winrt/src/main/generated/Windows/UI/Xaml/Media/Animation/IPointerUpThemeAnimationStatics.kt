...
@Signature("{7c618f9c-7992-4139-8bfc-0883b9727a7e}")
@Guid("7c618f9c799241398bfc0883b9727a7e")
@WinRTInterface("7c618f9c799241398bfc0883b9727a7e")
...
public interface IPointerUpThemeAnimationStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPointerUpThemeAnimationStatics {
    public val __42589128_Ptr: Pointer?

    public val _42589128_VtblPtr: Pointer?
      get() = __42589128_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_TargetNameProperty(): DependencyProperty? {
      val fnPtr = _42589128_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__42589128_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IPointerUpThemeAnimationStatics_Impl(
    ...
    public override val __42589128_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPointerUpThemeAnimationStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("7c618f9c799241398bfc0883b9727a7e")
    ...
    public override fun toNative(obj: IPointerUpThemeAnimationStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__42589128_Ptr))
  }
