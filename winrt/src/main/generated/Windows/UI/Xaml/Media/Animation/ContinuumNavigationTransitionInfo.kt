...
@Signature("rc(Windows.UI.Xaml.Media.Animation.ContinuumNavigationTransitionInfo;{4be1dbad-8ba6-4004-8438-8a9017978543})")
...
public class ContinuumNavigationTransitionInfo(
  ...
  private val __1270380103_Interface: IContinuumNavigationTransitionInfo.WithDefault by lazy {
    as_1270380103()
  }


  public override val __1270380103_Ptr: JNAPointer? by lazy {
    __1270380103_Interface.__1270380103_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1270380103_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1270380103(): IContinuumNavigationTransitionInfo.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<ContinuumNavigationTransitionInfo, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Animation.ContinuumNavigationTransitionInfo".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIContinuumNavigationTransitionInfoStatics():
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Animation.ContinuumNavigationTransitionInfo".toHandle(),refiid,interfacePtr)
      val result =
