...
@Signature("rc(Windows.UI.Xaml.Media.PolyBezierSegment;{36805271-38c4-4bcf-96cd-028a6d38af25})")
...
public class PolyBezierSegment(
  ...
  private val __1036818540_Interface: IPolyBezierSegment.WithDefault by lazy {
    as_1036818540()
  }


  public override val __1036818540_Ptr: JNAPointer? by lazy {
    __1036818540_Interface.__1036818540_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1036818540_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1036818540(): IPolyBezierSegment.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<PolyBezierSegment, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr = INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.PolyBezierSegment".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIPolyBezierSegmentStatics(): IPolyBezierSegmentStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.PolyBezierSegment".toHandle(),refiid,interfacePtr)
