...
@Signature("{6f3837fc-8e3d-4522-9b0f-003db8609851}")
@Guid("6f3837fc8e3d45229b0f003db8609851")
@WinRTInterface("6f3837fc8e3d45229b0f003db8609851")
...
public interface IEasingColorKeyFrameStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IEasingColorKeyFrameStatics {
    public val __1877568507_Ptr: Pointer?

    public val _1877568507_VtblPtr: Pointer?
      get() = __1877568507_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_EasingFunctionProperty(): DependencyProperty? {
      val fnPtr = _1877568507_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1877568507_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IEasingColorKeyFrameStatics_Impl(
    ...
    public override val __1877568507_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IEasingColorKeyFrameStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("6f3837fc8e3d45229b0f003db8609851")
    ...
    public override fun toNative(obj: IEasingColorKeyFrameStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1877568507_Ptr))
  }
