...
@Signature("rc(Windows.UI.Xaml.Media.Animation.ColorKeyFrameCollection;pinterface({913337e9-11a1-4345-a3a2-4e7f956e222d};rc(Windows.UI.Xaml.Media.Animation.ColorKeyFrame;{b51d82d9-0910-4589-a284-b0c9205858e9})))")
...
public class ColorKeyFrameCollection(
  ...
  public object ABI : IABI<ColorKeyFrameCollection, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Animation.ColorKeyFrameCollection".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
