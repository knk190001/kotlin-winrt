...
@Signature("{a9f566ec-fe9c-4b2b-8e52-bb785d562185}")
@Guid("a9f566ecfe9c4b2b8e52bb785d562185")
@WinRTInterface("a9f566ecfe9c4b2b8e52bb785d562185")
...
public interface IElasticEaseStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IElasticEaseStatics {
    public val __980773480_Ptr: Pointer?

    public val _980773480_VtblPtr: Pointer?
      get() = __980773480_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_OscillationsProperty(): DependencyProperty? {
      val fnPtr = _980773480_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__980773480_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_SpringinessProperty(): DependencyProperty? {
      val fnPtr = _980773480_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__980773480_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IElasticEaseStatics_Impl(
    ...
    public override val __980773480_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IElasticEaseStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("a9f566ecfe9c4b2b8e52bb785d562185")
    ...
    public override fun toNative(obj: IElasticEaseStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__980773480_Ptr))
  }
