...
@Signature("rc(Windows.UI.Xaml.Media.Animation.Storyboard;{d45c1e6e-3594-460e-981a-32271bd3aa06})")
@WinRTByReference(brClass = Storyboard.ByReference::class)
public class Storyboard(
  ptr: JNAPointer? = NULL
) : Timeline(ptr), IStoryboard.WithDefault, IWinRTObject {
  private val __1954103913_Interface: IStoryboard.WithDefault by lazy {
    as_1954103913()
  }


  public override val __1954103913_Ptr: JNAPointer? by lazy {
    __1954103913_Interface.__1954103913_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1954103913_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1954103913(): IStoryboard.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<Storyboard, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Animation.Storyboard".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIStoryboardStatics(): IStoryboardStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Animation.Storyboard".toHandle(),refiid,interfacePtr)
