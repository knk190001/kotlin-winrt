...
@Signature("{12cff18c-aa91-4c4a-b82f-df34fc57f94b}")
@Guid("12cff18caa914c4ab82fdf34fc57f94b")
@WinRTInterface("12cff18caa914c4ab82fdf34fc57f94b")
...
public interface IBeginStoryboardStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IBeginStoryboardStatics {
    public val __229267281_Ptr: Pointer?

    public val _229267281_VtblPtr: Pointer?
      get() = __229267281_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_StoryboardProperty(): DependencyProperty? {
      val fnPtr = _229267281_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__229267281_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IBeginStoryboardStatics_Impl(
    ...
    public override val __229267281_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IBeginStoryboardStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("12cff18caa914c4ab82fdf34fc57f94b")
    ...
    public override fun toNative(obj: IBeginStoryboardStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__229267281_Ptr))
  }
