...
@Signature("{8806a321-1e06-422c-a1cc-01696559e021}")
@Guid("8806a3211e06422ca1cc01696559e021")
@WinRTInterface("8806a3211e06422ca1cc01696559e021")
...
public interface IBrush : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IBrush {
    public val __1235051198_Ptr: Pointer?

    public val _1235051198_VtblPtr: Pointer?
      get() = __1235051198_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Opacity(): Double {
      val fnPtr = _1235051198_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1235051198_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Opacity(value: Double): Unit {
      val fnPtr = _1235051198_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1235051198_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Transform(): Transform? {
      val fnPtr = _1235051198_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Transform(value: Transform?): Unit {
      val fnPtr = _1235051198_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1235051198_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_RelativeTransform(): Transform? {
      val fnPtr = _1235051198_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Transform>()
      val hr = fn.invokeHR(arrayOf(__1235051198_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_RelativeTransform(value: Transform?): Unit {
      val fnPtr = _1235051198_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1235051198_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IBrush_Impl(
    ...
    public override val __1235051198_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IBrush, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("8806a3211e06422ca1cc01696559e021")
    ...
    public override fun toNative(obj: IBrush): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1235051198_Ptr))
  }
