...
@Signature("{0c7d5db5-7ed6-4949-b4e6-a78c9f4f978d}")
@Guid("0c7d5db57ed64949b4e6a78c9f4f978d")
@WinRTInterface("0c7d5db57ed64949b4e6a78c9f4f978d")
...
public interface IDragItemThemeAnimation : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IDragItemThemeAnimation {
    public val __1680966536_Ptr: Pointer?

    public val _1680966536_VtblPtr: Pointer?
      get() = __1680966536_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_TargetName(): String? {
      val fnPtr = _1680966536_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__1680966536_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_TargetName(value: String?): Unit {
      val fnPtr = _1680966536_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1680966536_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IDragItemThemeAnimation_Impl(
    ...
    public override val __1680966536_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IDragItemThemeAnimation, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("0c7d5db57ed64949b4e6a78c9f4f978d")
    ...
    public override fun toNative(obj: IDragItemThemeAnimation): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1680966536_Ptr))
  }
