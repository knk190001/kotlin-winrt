...
@Signature("{fdf5eb75-7ad5-4c89-8169-8c9786abd9eb}")
@Guid("fdf5eb757ad54c8981698c9786abd9eb")
@WinRTInterface("fdf5eb757ad54c8981698c9786abd9eb")
...
public interface IPolyQuadraticBezierSegmentStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPolyQuadraticBezierSegmentStatics {
    public val __418108961_Ptr: Pointer?

    public val _418108961_VtblPtr: Pointer?
      get() = __418108961_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_PointsProperty(): DependencyProperty? {
      val fnPtr = _418108961_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__418108961_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IPolyQuadraticBezierSegmentStatics_Impl(
    ...
    public override val __418108961_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPolyQuadraticBezierSegmentStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("fdf5eb757ad54c8981698c9786abd9eb")
    ...
    public override fun toNative(obj: IPolyQuadraticBezierSegmentStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__418108961_Ptr))
  }
