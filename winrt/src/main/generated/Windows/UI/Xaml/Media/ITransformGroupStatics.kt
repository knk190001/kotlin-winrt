...
@Signature("{25312f2a-cfab-4b24-9713-5bdead1929c0}")
@Guid("25312f2acfab4b2497135bdead1929c0")
@WinRTInterface("25312f2acfab4b2497135bdead1929c0")
...
public interface ITransformGroupStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITransformGroupStatics {
    public val __1128490326_Ptr: Pointer?

    public val _1128490326_VtblPtr: Pointer?
      get() = __1128490326_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ChildrenProperty(): DependencyProperty? {
      val fnPtr = _1128490326_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1128490326_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ITransformGroupStatics_Impl(
    ...
    public override val __1128490326_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITransformGroupStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("25312f2acfab4b2497135bdead1929c0")
    ...
    public override fun toNative(obj: ITransformGroupStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1128490326_Ptr))
  }
