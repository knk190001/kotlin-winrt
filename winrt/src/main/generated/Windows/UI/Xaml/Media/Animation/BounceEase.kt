...
@Signature("rc(Windows.UI.Xaml.Media.Animation.BounceEase;{2bf1464e-fc71-47ed-85a1-3ba9577718b4})")
...
public class BounceEase(
  ...
  private val __477445860_Interface: IBounceEase.WithDefault by lazy {
    as_477445860()
  }


  public override val __477445860_Ptr: JNAPointer? by lazy {
    __477445860_Interface.__477445860_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__477445860_Interface)

  public constructor() : this(ABI.activate())

  private fun as_477445860(): IBounceEase.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<BounceEase, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Animation.BounceEase".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIBounceEaseStatics(): IBounceEaseStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Animation.BounceEase".toHandle(),refiid,interfacePtr)
