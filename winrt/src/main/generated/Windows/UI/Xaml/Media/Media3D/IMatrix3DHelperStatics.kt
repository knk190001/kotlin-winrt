...
@Signature("{9264545e-e158-4e74-8899-689160bd2f8c}")
@Guid("9264545ee1584e748899689160bd2f8c")
@WinRTInterface("9264545ee1584e748899689160bd2f8c")
...
public interface IMatrix3DHelperStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IMatrix3DHelperStatics {
    public val __551879696_Ptr: Pointer?

    public val _551879696_VtblPtr: Pointer?
      get() = __551879696_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Identity(): Matrix3D? {
      val fnPtr = _551879696_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Matrix3D>()
      val hr = fn.invokeHR(arrayOf(__551879696_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun Multiply(matrix1: Matrix3D?, matrix2: Matrix3D?): Matrix3D? {
      val fnPtr = _551879696_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Matrix3D>()
      val hr = fn.invokeHR(arrayOf(__551879696_Ptr, marshalToNative(matrix1),
    ...
    public override fun FromElements(
      ...
      val fnPtr = _551879696_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Matrix3D>()
      val hr = fn.invokeHR(arrayOf(__551879696_Ptr, m11, m12, m13, m14, m21, m22, m23, m24, m31,
    ...
    public override fun GetHasInverse(target: Matrix3D?): Boolean {
      val fnPtr = _551879696_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__551879696_Ptr, marshalToNative(target), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun GetIsIdentity(target: Matrix3D?): Boolean {
      val fnPtr = _551879696_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__551879696_Ptr, marshalToNative(target), result))
      if (hr.toInt() != 0) {
    ...
    public override fun Invert(target: Matrix3D?): Matrix3D? {
      val fnPtr = _551879696_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Matrix3D>()
      val hr = fn.invokeHR(arrayOf(__551879696_Ptr, marshalToNative(target), result))
      if (hr.toInt() != 0) {
  ...
  public class IMatrix3DHelperStatics_Impl(
    ...
    public override val __551879696_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IMatrix3DHelperStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("9264545ee1584e748899689160bd2f8c")
    ...
    public override fun toNative(obj: IMatrix3DHelperStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__551879696_Ptr))
  }
