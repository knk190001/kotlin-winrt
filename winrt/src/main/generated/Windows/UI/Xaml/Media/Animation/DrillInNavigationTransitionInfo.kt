...
@Signature("rc(Windows.UI.Xaml.Media.Animation.DrillInNavigationTransitionInfo;{3b86201a-45d3-463b-939e-c8595f439bcc})")
...
public class DrillInNavigationTransitionInfo(
  ...
  private val __1574851823_Interface: IDrillInNavigationTransitionInfo.WithDefault by lazy {
    as_1574851823()
  }


  public override val __1574851823_Ptr: JNAPointer? by lazy {
    __1574851823_Interface.__1574851823_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1574851823_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1574851823(): IDrillInNavigationTransitionInfo.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<DrillInNavigationTransitionInfo, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Animation.DrillInNavigationTransitionInfo".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
