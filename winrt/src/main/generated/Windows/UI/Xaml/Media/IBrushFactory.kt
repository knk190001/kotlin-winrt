...
@Signature("{399658a2-14fb-4b8f-83e6-6e3dab12069b}")
@Guid("399658a214fb4b8f83e66e3dab12069b")
@WinRTInterface("399658a214fb4b8f83e66e3dab12069b")
...
public interface IBrushFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IBrushFactory {
    public val __1976339348_Ptr: Pointer?

    public val _1976339348_VtblPtr: Pointer?
      get() = __1976339348_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        Brush? {
      val fnPtr = _1976339348_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Brush>()
      val hr = fn.invokeHR(arrayOf(__1976339348_Ptr, marshalToNative(baseInterface),
  ...
  public class IBrushFactory_Impl(
    ...
    public override val __1976339348_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IBrushFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("399658a214fb4b8f83e66e3dab12069b")
    ...
    public override fun toNative(obj: IBrushFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1976339348_Ptr))
  }
