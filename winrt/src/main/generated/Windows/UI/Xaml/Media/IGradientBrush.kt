...
@Signature("{2166e69f-935a-4191-8e3c-1c8dfdfcdc78}")
@Guid("2166e69f935a41918e3c1c8dfdfcdc78")
@WinRTInterface("2166e69f935a41918e3c1c8dfdfcdc78")
...
public interface IGradientBrush : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IGradientBrush {
    public val __1696314734_Ptr: Pointer?

    public val _1696314734_VtblPtr: Pointer?
      get() = __1696314734_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_SpreadMethod(): GradientSpreadMethod? {
      val fnPtr = _1696314734_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<GradientSpreadMethod>()
      val hr = fn.invokeHR(arrayOf(__1696314734_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_SpreadMethod(value: GradientSpreadMethod?): Unit {
      val fnPtr = _1696314734_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1696314734_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_MappingMode(): BrushMappingMode? {
      val fnPtr = _1696314734_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_MappingMode(value: BrushMappingMode?): Unit {
      val fnPtr = _1696314734_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1696314734_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ColorInterpolationMode(): ColorInterpolationMode? {
      val fnPtr = _1696314734_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_ColorInterpolationMode(value: ColorInterpolationMode?): Unit {
      val fnPtr = _1696314734_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1696314734_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_GradientStops(): GradientStopCollection? {
      val fnPtr = _1696314734_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_GradientStops(value: GradientStopCollection?): Unit {
      val fnPtr = _1696314734_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1696314734_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IGradientBrush_Impl(
    ...
    public override val __1696314734_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IGradientBrush, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("2166e69f935a41918e3c1c8dfdfcdc78")
    ...
    public override fun toNative(obj: IGradientBrush): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1696314734_Ptr))
  }
