...
import Windows.UI.Composition.CompositionEasingFunction
...
@Signature("{1c6875c9-19bb-4d47-b9aa-66c802dcb9ff}")
@Guid("1c6875c919bb4d47b9aa66c802dcb9ff")
@WinRTInterface("1c6875c919bb4d47b9aa66c802dcb9ff")
...
public interface IConnectedAnimationService : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IConnectedAnimationService {
    public val __1280178292_Ptr: Pointer?

    public val _1280178292_VtblPtr: Pointer?
      get() = __1280178292_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_DefaultDuration(): TimeSpan? {
      val fnPtr = _1280178292_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<TimeSpan>()
      val hr = fn.invokeHR(arrayOf(__1280178292_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_DefaultDuration(value: TimeSpan?): Unit {
      val fnPtr = _1280178292_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1280178292_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_DefaultEasingFunction(): CompositionEasingFunction? {
      val fnPtr = _1280178292_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_DefaultEasingFunction(value: CompositionEasingFunction?): Unit {
      val fnPtr = _1280178292_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1280178292_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun PrepareToAnimate(key: String?, source: UIElement?): ConnectedAnimation? {
      val fnPtr = _1280178292_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ConnectedAnimation>()
      val hr = fn.invokeHR(arrayOf(__1280178292_Ptr, marshalToNative(key), marshalToNative(source),
          result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun GetAnimation(key: String?): ConnectedAnimation? {
      val fnPtr = _1280178292_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ConnectedAnimation>()
      val hr = fn.invokeHR(arrayOf(__1280178292_Ptr, marshalToNative(key), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
      val resultValue = marshalFromNative<ConnectedAnimation>(result.getValue())
  ...
  public class IConnectedAnimationService_Impl(
    ...
    public override val __1280178292_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IConnectedAnimationService, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("1c6875c919bb4d47b9aa66c802dcb9ff")
    ...
    public override fun toNative(obj: IConnectedAnimationService): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1280178292_Ptr))
  }
