...
@Signature("{2a1c0aae-eccd-4464-a148-6ffdb3aa281f}")
@Guid("2a1c0aaeeccd4464a1486ffdb3aa281f")
@WinRTInterface("2a1c0aaeeccd4464a1486ffdb3aa281f")
...
public interface IPathSegmentFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPathSegmentFactory {
    public val __1998073640_Ptr: Pointer?

    public val _1998073640_VtblPtr: Pointer?
      get() = __1998073640_Ptr?.getPointer(0)
  }

  public class IPathSegmentFactory_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __1998073640_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPathSegmentFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("2a1c0aaeeccd4464a1486ffdb3aa281f")
    ...
    public override fun toNative(obj: IPathSegmentFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1998073640_Ptr))
  }
