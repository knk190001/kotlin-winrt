...
@Signature("rc(Windows.UI.Xaml.Media.Animation.ColorAnimation;{b8ae8a15-0f63-4694-9467-bdafac1253ea})")
@WinRTByReference(brClass = ColorAnimation.ByReference::class)
public class ColorAnimation(
  ptr: JNAPointer? = NULL
) : Timeline(ptr), IColorAnimation.WithDefault, IWinRTObject {
  private val __1744736537_Interface: IColorAnimation.WithDefault by lazy {
    as_1744736537()
  }


  public override val __1744736537_Ptr: JNAPointer? by lazy {
    __1744736537_Interface.__1744736537_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1744736537_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1744736537(): IColorAnimation.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<ColorAnimation, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Animation.ColorAnimation".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIColorAnimationStatics(): IColorAnimationStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Animation.ColorAnimation".toHandle(),refiid,interfacePtr)
