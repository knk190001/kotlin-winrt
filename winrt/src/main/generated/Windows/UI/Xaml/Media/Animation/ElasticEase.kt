...
@Signature("rc(Windows.UI.Xaml.Media.Animation.ElasticEase;{ef5ba58c-b0b6-4a6c-9ca8-fb4233f12459})")
...
public class ElasticEase(
  ...
  private val __1835233949_Interface: IElasticEase.WithDefault by lazy {
    as_1835233949()
  }


  public override val __1835233949_Ptr: JNAPointer? by lazy {
    __1835233949_Interface.__1835233949_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1835233949_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1835233949(): IElasticEase.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<ElasticEase, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Animation.ElasticEase".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIElasticEaseStatics(): IElasticEaseStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Animation.ElasticEase".toHandle(),refiid,interfacePtr)
