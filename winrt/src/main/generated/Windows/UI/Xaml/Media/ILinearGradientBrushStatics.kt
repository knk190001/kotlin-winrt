...
@Signature("{7af6e504-2dc3-40e3-be0b-b314c13cb991}")
@Guid("7af6e5042dc340e3be0bb314c13cb991")
@WinRTInterface("7af6e5042dc340e3be0bb314c13cb991")
...
public interface ILinearGradientBrushStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ILinearGradientBrushStatics {
    public val __709338052_Ptr: Pointer?

    public val _709338052_VtblPtr: Pointer?
      get() = __709338052_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_StartPointProperty(): DependencyProperty? {
      val fnPtr = _709338052_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__709338052_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_EndPointProperty(): DependencyProperty? {
      val fnPtr = _709338052_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__709338052_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ILinearGradientBrushStatics_Impl(
    ...
    public override val __709338052_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ILinearGradientBrushStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("7af6e5042dc340e3be0bb314c13cb991")
    ...
    public override fun toNative(obj: ILinearGradientBrushStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__709338052_Ptr))
  }
