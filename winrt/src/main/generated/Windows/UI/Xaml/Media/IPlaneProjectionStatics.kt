...
@Signature("{ad919c67-3bdc-4855-8969-d1f9a3adc27d}")
@Guid("ad919c673bdc48558969d1f9a3adc27d")
@WinRTInterface("ad919c673bdc48558969d1f9a3adc27d")
...
public interface IPlaneProjectionStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPlaneProjectionStatics {
    public val __1516340106_Ptr: Pointer?

    public val _1516340106_VtblPtr: Pointer?
      get() = __1516340106_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_LocalOffsetXProperty(): DependencyProperty? {
      val fnPtr = _1516340106_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1516340106_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_LocalOffsetYProperty(): DependencyProperty? {
      val fnPtr = _1516340106_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1516340106_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_LocalOffsetZProperty(): DependencyProperty? {
      val fnPtr = _1516340106_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1516340106_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_RotationXProperty(): DependencyProperty? {
      val fnPtr = _1516340106_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1516340106_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_RotationYProperty(): DependencyProperty? {
      val fnPtr = _1516340106_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1516340106_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_RotationZProperty(): DependencyProperty? {
      val fnPtr = _1516340106_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1516340106_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_CenterOfRotationXProperty(): DependencyProperty? {
      val fnPtr = _1516340106_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1516340106_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_CenterOfRotationYProperty(): DependencyProperty? {
      val fnPtr = _1516340106_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1516340106_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_CenterOfRotationZProperty(): DependencyProperty? {
      val fnPtr = _1516340106_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1516340106_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_GlobalOffsetXProperty(): DependencyProperty? {
      val fnPtr = _1516340106_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1516340106_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_GlobalOffsetYProperty(): DependencyProperty? {
      val fnPtr = _1516340106_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1516340106_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_GlobalOffsetZProperty(): DependencyProperty? {
      val fnPtr = _1516340106_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1516340106_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ProjectionMatrixProperty(): DependencyProperty? {
      val fnPtr = _1516340106_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1516340106_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IPlaneProjectionStatics_Impl(
    ...
    public override val __1516340106_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPlaneProjectionStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("ad919c673bdc48558969d1f9a3adc27d")
    ...
    public override fun toNative(obj: IPlaneProjectionStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1516340106_Ptr))
  }
