...
@Signature("{f66fc5c3-5915-437d-8e3b-adf8e7f0ab57}")
@Guid("f66fc5c35915437d8e3badf8e7f0ab57")
@WinRTInterface("f66fc5c35915437d8e3badf8e7f0ab57")
...
public interface IContentThemeTransition : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IContentThemeTransition {
    public val __1593874379_Ptr: Pointer?

    public val _1593874379_VtblPtr: Pointer?
      get() = __1593874379_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_HorizontalOffset(): Double {
      val fnPtr = _1593874379_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1593874379_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_HorizontalOffset(value: Double): Unit {
      val fnPtr = _1593874379_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1593874379_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_VerticalOffset(): Double {
      val fnPtr = _1593874379_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1593874379_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_VerticalOffset(value: Double): Unit {
      val fnPtr = _1593874379_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1593874379_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IContentThemeTransition_Impl(
    ...
    public override val __1593874379_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IContentThemeTransition, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("f66fc5c35915437d8e3badf8e7f0ab57")
    ...
    public override fun toNative(obj: IContentThemeTransition): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1593874379_Ptr))
  }
