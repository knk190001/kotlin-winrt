...
@Signature("rc(Windows.UI.Xaml.Media.Media3D.PerspectiveTransform3D;{9a7b532a-30f9-40a1-96c9-c59d87f95ac3})")
...
public class PerspectiveTransform3D(
  ...
  private val __490318806_Interface: IPerspectiveTransform3D.WithDefault by lazy {
    as_490318806()
  }


  public override val __490318806_Ptr: JNAPointer? by lazy {
    __490318806_Interface.__490318806_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__490318806_Interface)

  public constructor() : this(ABI.activate())

  private fun as_490318806(): IPerspectiveTransform3D.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<PerspectiveTransform3D, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Media3D.PerspectiveTransform3D".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIPerspectiveTransform3DStatics(): IPerspectiveTransform3DStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Media3D.PerspectiveTransform3D".toHandle(),refiid,interfacePtr)
      val result =
