...
@Signature("rc(Windows.UI.Xaml.Media.Animation.SplineDoubleKeyFrame;{00d72d38-6b2b-4843-838e-c8b115eec801})")
...
public class SplineDoubleKeyFrame(
  ...
  private val __1084107146_Interface: ISplineDoubleKeyFrame.WithDefault by lazy {
    as_1084107146()
  }


  public override val __1084107146_Ptr: JNAPointer? by lazy {
    __1084107146_Interface.__1084107146_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1084107146_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1084107146(): ISplineDoubleKeyFrame.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<SplineDoubleKeyFrame, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Animation.SplineDoubleKeyFrame".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createISplineDoubleKeyFrameStatics(): ISplineDoubleKeyFrameStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Animation.SplineDoubleKeyFrame".toHandle(),refiid,interfacePtr)
      val result =
