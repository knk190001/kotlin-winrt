...
@Signature("rc(Windows.UI.Xaml.Media.Matrix3DProjection;{6f03e149-bfc9-4c01-b578-50338cec97fc})")
...
public class Matrix3DProjection(
  ...
  private val __682630365_Interface: IMatrix3DProjection.WithDefault by lazy {
    as_682630365()
  }


  public override val __682630365_Ptr: JNAPointer? by lazy {
    __682630365_Interface.__682630365_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__682630365_Interface)

  public constructor() : this(ABI.activate())

  private fun as_682630365(): IMatrix3DProjection.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<Matrix3DProjection, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Matrix3DProjection".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIMatrix3DProjectionStatics(): IMatrix3DProjectionStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Matrix3DProjection".toHandle(),refiid,interfacePtr)
