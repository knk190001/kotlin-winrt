...
@Signature("rc(Windows.UI.Xaml.Media.TranslateTransform;{c975905c-3c36-4229-817b-178f64c0e113})")
...
public class TranslateTransform(
  ...
  private val __976601926_Interface: ITranslateTransform.WithDefault by lazy {
    as_976601926()
  }


  public override val __976601926_Ptr: JNAPointer? by lazy {
    __976601926_Interface.__976601926_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__976601926_Interface)

  public constructor() : this(ABI.activate())

  private fun as_976601926(): ITranslateTransform.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<TranslateTransform, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.TranslateTransform".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createITranslateTransformStatics(): ITranslateTransformStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.TranslateTransform".toHandle(),refiid,interfacePtr)
