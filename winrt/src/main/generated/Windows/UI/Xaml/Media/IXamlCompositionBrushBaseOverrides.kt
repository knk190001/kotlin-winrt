...
@Signature("{d19127f1-38b4-4ea1-8f33-849629a4c9c1}")
@Guid("d19127f138b44ea18f33849629a4c9c1")
@WinRTInterface("d19127f138b44ea18f33849629a4c9c1")
...
public interface IXamlCompositionBrushBaseOverrides : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IXamlCompositionBrushBaseOverrides {
    public val __1782762334_Ptr: Pointer?

    public val _1782762334_VtblPtr: Pointer?
      get() = __1782762334_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun OnConnected(): Unit {
      val fnPtr = _1782762334_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1782762334_Ptr, ))
      if (hr.toInt() != 0) {
    ...
    public override fun OnDisconnected(): Unit {
      val fnPtr = _1782762334_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1782762334_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IXamlCompositionBrushBaseOverrides_Impl(
    ...
    public override val __1782762334_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IXamlCompositionBrushBaseOverrides, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("d19127f138b44ea18f33849629a4c9c1")
    ...
    public override fun toNative(obj: IXamlCompositionBrushBaseOverrides): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1782762334_Ptr))
  }
