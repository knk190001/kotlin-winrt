...
@Signature("{8977cb01-af8d-4af5-b084-c08eb9704abe}")
@Guid("8977cb01af8d4af5b084c08eb9704abe")
@WinRTInterface("8977cb01af8d4af5b084c08eb9704abe")
...
public interface ICompositeTransform3D : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositeTransform3D {
    public val __2060916715_Ptr: Pointer?

    public val _2060916715_VtblPtr: Pointer?
      get() = __2060916715_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_CenterX(): Double {
      val fnPtr = _2060916715_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__2060916715_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_CenterX(value: Double): Unit {
      val fnPtr = _2060916715_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2060916715_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_CenterY(): Double {
      val fnPtr = _2060916715_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__2060916715_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_CenterY(value: Double): Unit {
      val fnPtr = _2060916715_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2060916715_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_CenterZ(): Double {
      val fnPtr = _2060916715_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__2060916715_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_CenterZ(value: Double): Unit {
      val fnPtr = _2060916715_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2060916715_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_RotationX(): Double {
      val fnPtr = _2060916715_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__2060916715_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_RotationX(value: Double): Unit {
      val fnPtr = _2060916715_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2060916715_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_RotationY(): Double {
      val fnPtr = _2060916715_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__2060916715_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_RotationY(value: Double): Unit {
      val fnPtr = _2060916715_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2060916715_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_RotationZ(): Double {
      val fnPtr = _2060916715_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__2060916715_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_RotationZ(value: Double): Unit {
      val fnPtr = _2060916715_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2060916715_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ScaleX(): Double {
      val fnPtr = _2060916715_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__2060916715_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ScaleX(value: Double): Unit {
      val fnPtr = _2060916715_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2060916715_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ScaleY(): Double {
      val fnPtr = _2060916715_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__2060916715_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ScaleY(value: Double): Unit {
      val fnPtr = _2060916715_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2060916715_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ScaleZ(): Double {
      val fnPtr = _2060916715_VtblPtr!!.getPointer(22L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__2060916715_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ScaleZ(value: Double): Unit {
      val fnPtr = _2060916715_VtblPtr!!.getPointer(23L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2060916715_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_TranslateX(): Double {
      val fnPtr = _2060916715_VtblPtr!!.getPointer(24L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__2060916715_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_TranslateX(value: Double): Unit {
      val fnPtr = _2060916715_VtblPtr!!.getPointer(25L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2060916715_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_TranslateY(): Double {
      val fnPtr = _2060916715_VtblPtr!!.getPointer(26L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__2060916715_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_TranslateY(value: Double): Unit {
      val fnPtr = _2060916715_VtblPtr!!.getPointer(27L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2060916715_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_TranslateZ(): Double {
      val fnPtr = _2060916715_VtblPtr!!.getPointer(28L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__2060916715_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_TranslateZ(value: Double): Unit {
      val fnPtr = _2060916715_VtblPtr!!.getPointer(29L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2060916715_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class ICompositeTransform3D_Impl(
    ...
    public override val __2060916715_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositeTransform3D, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("8977cb01af8d4af5b084c08eb9704abe")
    ...
    public override fun toNative(obj: ICompositeTransform3D): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2060916715_Ptr))
  }
