...
@Signature("{72f762f7-7e51-4a6b-b937-dc4b4c1c5458}")
@Guid("72f762f77e514a6bb937dc4b4c1c5458")
@WinRTInterface("72f762f77e514a6bb937dc4b4c1c5458")
...
public interface IDragOverThemeAnimation : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IDragOverThemeAnimation {
    public val __1647943561_Ptr: Pointer?

    public val _1647943561_VtblPtr: Pointer?
      get() = __1647943561_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_TargetName(): String? {
      val fnPtr = _1647943561_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__1647943561_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_TargetName(value: String?): Unit {
      val fnPtr = _1647943561_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1647943561_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_ToOffset(): Double {
      val fnPtr = _1647943561_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_ToOffset(value: Double): Unit {
      val fnPtr = _1647943561_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1647943561_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Direction(): AnimationDirection? {
      val fnPtr = _1647943561_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Direction(value: AnimationDirection?): Unit {
      val fnPtr = _1647943561_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1647943561_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IDragOverThemeAnimation_Impl(
    ...
    public override val __1647943561_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IDragOverThemeAnimation, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("72f762f77e514a6bb937dc4b4c1c5458")
    ...
    public override fun toNative(obj: IDragOverThemeAnimation): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1647943561_Ptr))
  }
