...
@Signature("rc(Windows.UI.Xaml.Media.Animation.EasingPointKeyFrame;{b3c91380-6868-4225-a70b-3981cc0b2947})")
...
public class EasingPointKeyFrame(
  ...
  private val __1906321203_Interface: IEasingPointKeyFrame.WithDefault by lazy {
    as_1906321203()
  }


  public override val __1906321203_Ptr: JNAPointer? by lazy {
    __1906321203_Interface.__1906321203_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1906321203_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1906321203(): IEasingPointKeyFrame.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<EasingPointKeyFrame, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Animation.EasingPointKeyFrame".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIEasingPointKeyFrameStatics(): IEasingPointKeyFrameStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Animation.EasingPointKeyFrame".toHandle(),refiid,interfacePtr)
      val result =
