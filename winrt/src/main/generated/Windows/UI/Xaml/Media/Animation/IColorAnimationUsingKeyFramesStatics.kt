...
@Signature("{b4723cdc-96e9-48f9-8d92-9b648b2f1cc6}")
@Guid("b4723cdc96e948f98d929b648b2f1cc6")
@WinRTInterface("b4723cdc96e948f98d929b648b2f1cc6")
...
public interface IColorAnimationUsingKeyFramesStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IColorAnimationUsingKeyFramesStatics {
    public val __148230115_Ptr: Pointer?

    public val _148230115_VtblPtr: Pointer?
      get() = __148230115_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_EnableDependentAnimationProperty(): DependencyProperty? {
      val fnPtr = _148230115_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__148230115_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IColorAnimationUsingKeyFramesStatics_Impl(
    ...
    public override val __148230115_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IColorAnimationUsingKeyFramesStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("b4723cdc96e948f98d929b648b2f1cc6")
    ...
    public override fun toNative(obj: IColorAnimationUsingKeyFramesStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__148230115_Ptr))
  }
