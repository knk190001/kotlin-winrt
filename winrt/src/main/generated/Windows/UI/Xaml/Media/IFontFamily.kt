...
@Signature("{92467e64-d66a-4cf4-9322-3d23b3c0c361}")
@Guid("92467e64d66a4cf493223d23b3c0c361")
@WinRTInterface("92467e64d66a4cf493223d23b3c0c361")
...
public interface IFontFamily : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IFontFamily {
    public val __314285169_Ptr: Pointer?

    public val _314285169_VtblPtr: Pointer?
      get() = __314285169_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Source(): String? {
      val fnPtr = _314285169_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__314285169_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IFontFamily_Impl(
    ...
    public override val __314285169_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IFontFamily, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("92467e64d66a4cf493223d23b3c0c361")
    ...
    public override fun toNative(obj: IFontFamily): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__314285169_Ptr))
  }
