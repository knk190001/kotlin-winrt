...
@Signature("{0ae0861c-1e7a-4fed-9857-ea8caa798490}")
@Guid("0ae0861c1e7a4fed9857ea8caa798490")
@WinRTInterface("0ae0861c1e7a4fed9857ea8caa798490")
...
public interface ILinearGradientBrushFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ILinearGradientBrushFactory {
    public val __95915393_Ptr: Pointer?

    public val _95915393_VtblPtr: Pointer?
      get() = __95915393_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override
        fun CreateInstanceWithGradientStopCollectionAndAngle(gradientStopCollection: GradientStopCollection?,
        angle: Double): LinearGradientBrush? {
      val fnPtr = _95915393_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<LinearGradientBrush>()
      val hr = fn.invokeHR(arrayOf(__95915393_Ptr, marshalToNative(gradientStopCollection), angle,
          result))
      if (hr.toInt() != 0) {
  ...
  public class ILinearGradientBrushFactory_Impl(
    ...
    public override val __95915393_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ILinearGradientBrushFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("0ae0861c1e7a4fed9857ea8caa798490")
    ...
    public override fun toNative(obj: ILinearGradientBrushFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__95915393_Ptr))
  }
