...
@Signature("{a902ed4e-ef10-4d6f-9a40-93cb8895f4e5}")
@Guid("a902ed4eef104d6f9a4093cb8895f4e5")
@WinRTInterface("a902ed4eef104d6f9a4093cb8895f4e5")
...
public interface ITimelineStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITimelineStatics {
    public val __2068163202_Ptr: Pointer?

    public val _2068163202_VtblPtr: Pointer?
      get() = __2068163202_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_AllowDependentAnimations(): Boolean {
      val fnPtr = _2068163202_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__2068163202_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_AllowDependentAnimations(value: Boolean): Unit {
      val fnPtr = _2068163202_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2068163202_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_AutoReverseProperty(): DependencyProperty? {
      val fnPtr = _2068163202_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_BeginTimeProperty(): DependencyProperty? {
      val fnPtr = _2068163202_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__2068163202_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_DurationProperty(): DependencyProperty? {
      val fnPtr = _2068163202_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__2068163202_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_SpeedRatioProperty(): DependencyProperty? {
      val fnPtr = _2068163202_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__2068163202_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_FillBehaviorProperty(): DependencyProperty? {
      val fnPtr = _2068163202_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__2068163202_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_RepeatBehaviorProperty(): DependencyProperty? {
      val fnPtr = _2068163202_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__2068163202_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ITimelineStatics_Impl(
    ...
    public override val __2068163202_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITimelineStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("a902ed4eef104d6f9a4093cb8895f4e5")
    ...
    public override fun toNative(obj: ITimelineStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2068163202_Ptr))
  }
