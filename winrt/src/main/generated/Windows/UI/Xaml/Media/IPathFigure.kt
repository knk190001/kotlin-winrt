...
@Signature("{5d955c8c-5fa9-4dda-a3cc-10fcdcaa20d7}")
@Guid("5d955c8c5fa94ddaa3cc10fcdcaa20d7")
@WinRTInterface("5d955c8c5fa94ddaa3cc10fcdcaa20d7")
...
public interface IPathFigure : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPathFigure {
    public val __1364144741_Ptr: Pointer?

    public val _1364144741_VtblPtr: Pointer?
      get() = __1364144741_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Segments(): PathSegmentCollection? {
      val fnPtr = _1364144741_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<PathSegmentCollection>()
      val hr = fn.invokeHR(arrayOf(__1364144741_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Segments(value: PathSegmentCollection?): Unit {
      val fnPtr = _1364144741_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1364144741_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_StartPoint(): Point? {
      val fnPtr = _1364144741_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_StartPoint(value: Point?): Unit {
      val fnPtr = _1364144741_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1364144741_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_IsClosed(): Boolean {
      val fnPtr = _1364144741_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_IsClosed(value: Boolean): Unit {
      val fnPtr = _1364144741_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1364144741_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_IsFilled(): Boolean {
      val fnPtr = _1364144741_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1364144741_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_IsFilled(value: Boolean): Unit {
      val fnPtr = _1364144741_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1364144741_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IPathFigure_Impl(
    ...
    public override val __1364144741_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPathFigure, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("5d955c8c5fa94ddaa3cc10fcdcaa20d7")
    ...
    public override fun toNative(obj: IPathFigure): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1364144741_Ptr))
  }
