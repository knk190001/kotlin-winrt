...
@Signature("{674456fd-e81e-4f4e-b4ad-0acfed9ecd68}")
@Guid("674456fde81e4f4eb4ad0acfed9ecd68")
@WinRTInterface("674456fde81e4f4eb4ad0acfed9ecd68")
...
public interface IDoubleKeyFrame : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IDoubleKeyFrame {
    public val __1526890693_Ptr: Pointer?

    public val _1526890693_VtblPtr: Pointer?
      get() = __1526890693_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Value(): Double {
      val fnPtr = _1526890693_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1526890693_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Value(value: Double): Unit {
      val fnPtr = _1526890693_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1526890693_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_KeyTime(): KeyTime? {
      val fnPtr = _1526890693_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_KeyTime(value: KeyTime?): Unit {
      val fnPtr = _1526890693_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1526890693_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IDoubleKeyFrame_Impl(
    ...
    public override val __1526890693_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IDoubleKeyFrame, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("674456fde81e4f4eb4ad0acfed9ecd68")
    ...
    public override fun toNative(obj: IDoubleKeyFrame): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1526890693_Ptr))
  }
