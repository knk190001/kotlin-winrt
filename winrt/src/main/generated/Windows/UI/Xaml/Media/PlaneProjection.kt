...
@Signature("rc(Windows.UI.Xaml.Media.PlaneProjection;{e6f82bfa-6726-469a-b259-a5188347ca8f})")
...
public class PlaneProjection(
  ...
  private val __799509425_Interface: IPlaneProjection.WithDefault by lazy {
    as_799509425()
  }


  public override val __799509425_Ptr: JNAPointer? by lazy {
    __799509425_Interface.__799509425_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__799509425_Interface)

  public constructor() : this(ABI.activate())

  private fun as_799509425(): IPlaneProjection.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<PlaneProjection, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr = INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.PlaneProjection".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIPlaneProjectionStatics(): IPlaneProjectionStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.PlaneProjection".toHandle(),refiid,interfacePtr)
