...
@Signature("rc(Windows.UI.Xaml.Media.RenderingEventArgs;{5bf7d30d-9748-4aed-8380-d7890eb776a0})")
...
public class RenderingEventArgs(
  ...
  private val __1096172441_Interface: IRenderingEventArgs.WithDefault by lazy {
    as_1096172441()
  }


  public override val __1096172441_Ptr: JNAPointer? by lazy {
    __1096172441_Interface.__1096172441_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1096172441_Interface)

  private fun as_1096172441(): IRenderingEventArgs.WithDefault {
    if(pointer == NULL) {
