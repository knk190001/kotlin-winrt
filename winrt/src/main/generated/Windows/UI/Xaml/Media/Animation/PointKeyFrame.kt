...
import Windows.UI.Xaml.Media.Animation.IPointKeyFrameFactory.ABI.IID
...
@Signature("rc(Windows.UI.Xaml.Media.Animation.PointKeyFrame;{fcc88d01-7f82-4dae-8026-7b7e086878b3})")
...
public open class PointKeyFrame(
  ...
  private val __1868962744_Interface: IPointKeyFrame.WithDefault by lazy {
    as_1868962744()
  }


  public override val __1868962744_Ptr: JNAPointer? by lazy {
    __1868962744_Interface.__1868962744_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1868962744_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1868962744(): IPointKeyFrame.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<PointKeyFrame, MemoryAddress> {
    ...
    public fun createIPointKeyFrameStatics(): IPointKeyFrameStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Animation.PointKeyFrame".toHandle(),refiid,interfacePtr)
    ...
    public fun createIPointKeyFrameFactory(): IPointKeyFrameFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Animation.PointKeyFrame".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
