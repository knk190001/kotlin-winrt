...
@Signature("{688ea9b9-1e4e-4596-86e3-428b27334faf}")
@Guid("688ea9b91e4e459686e3428b27334faf")
@WinRTInterface("688ea9b91e4e459686e3428b27334faf")
...
public interface IRotateTransform : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IRotateTransform {
    public val __1216789205_Ptr: Pointer?

    public val _1216789205_VtblPtr: Pointer?
      get() = __1216789205_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_CenterX(): Double {
      val fnPtr = _1216789205_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1216789205_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_CenterX(value: Double): Unit {
      val fnPtr = _1216789205_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1216789205_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_CenterY(): Double {
      val fnPtr = _1216789205_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1216789205_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_CenterY(value: Double): Unit {
      val fnPtr = _1216789205_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1216789205_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Angle(): Double {
      val fnPtr = _1216789205_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1216789205_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Angle(value: Double): Unit {
      val fnPtr = _1216789205_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1216789205_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IRotateTransform_Impl(
    ...
    public override val __1216789205_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IRotateTransform, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("688ea9b91e4e459686e3428b27334faf")
    ...
    public override fun toNative(obj: IRotateTransform): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1216789205_Ptr))
  }
