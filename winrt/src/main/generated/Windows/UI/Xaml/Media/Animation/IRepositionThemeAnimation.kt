...
@Signature("{ecda24e8-8945-4949-a1bf-62109965a7e9}")
@Guid("ecda24e889454949a1bf62109965a7e9")
@WinRTInterface("ecda24e889454949a1bf62109965a7e9")
...
public interface IRepositionThemeAnimation : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IRepositionThemeAnimation {
    public val __366638275_Ptr: Pointer?

    public val _366638275_VtblPtr: Pointer?
      get() = __366638275_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_TargetName(): String? {
      val fnPtr = _366638275_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__366638275_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_TargetName(value: String?): Unit {
      val fnPtr = _366638275_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__366638275_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_FromHorizontalOffset(): Double {
      val fnPtr = _366638275_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_FromHorizontalOffset(value: Double): Unit {
      val fnPtr = _366638275_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__366638275_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_FromVerticalOffset(): Double {
      val fnPtr = _366638275_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__366638275_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_FromVerticalOffset(value: Double): Unit {
      val fnPtr = _366638275_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__366638275_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IRepositionThemeAnimation_Impl(
    ...
    public override val __366638275_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IRepositionThemeAnimation, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("ecda24e889454949a1bf62109965a7e9")
    ...
    public override fun toNative(obj: IRepositionThemeAnimation): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__366638275_Ptr))
  }
