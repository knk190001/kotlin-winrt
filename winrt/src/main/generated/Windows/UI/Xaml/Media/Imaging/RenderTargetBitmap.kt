...
@Signature("rc(Windows.UI.Xaml.Media.Imaging.RenderTargetBitmap;{500dee81-893c-4c0a-8fec-4678ac717589})")
...
public class RenderTargetBitmap(
  ...
  private val __870768824_Interface: IRenderTargetBitmap.WithDefault by lazy {
    as_870768824()
  }


  public override val __870768824_Ptr: JNAPointer? by lazy {
    __870768824_Interface.__870768824_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__870768824_Interface)

  public constructor() : this(ABI.activate())

  private fun as_870768824(): IRenderTargetBitmap.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<RenderTargetBitmap, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Imaging.RenderTargetBitmap".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIRenderTargetBitmapStatics(): IRenderTargetBitmapStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Imaging.RenderTargetBitmap".toHandle(),refiid,interfacePtr)
