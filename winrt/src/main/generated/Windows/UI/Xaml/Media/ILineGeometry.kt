...
@Signature("{30edd4a2-8fc5-40af-a7a2-c27fe7aa1363}")
@Guid("30edd4a28fc540afa7a2c27fe7aa1363")
@WinRTInterface("30edd4a28fc540afa7a2c27fe7aa1363")
...
public interface ILineGeometry : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ILineGeometry {
    public val __308420478_Ptr: Pointer?

    public val _308420478_VtblPtr: Pointer?
      get() = __308420478_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_StartPoint(): Point? {
      val fnPtr = _308420478_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Point>()
      val hr = fn.invokeHR(arrayOf(__308420478_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_StartPoint(value: Point?): Unit {
      val fnPtr = _308420478_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__308420478_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_EndPoint(): Point? {
      val fnPtr = _308420478_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Point>()
      val hr = fn.invokeHR(arrayOf(__308420478_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_EndPoint(value: Point?): Unit {
      val fnPtr = _308420478_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__308420478_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class ILineGeometry_Impl(
    ...
    public override val __308420478_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ILineGeometry, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("30edd4a28fc540afa7a2c27fe7aa1363")
    ...
    public override fun toNative(obj: ILineGeometry): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__308420478_Ptr))
  }
