...
import Windows.UI.Xaml.TriggerAction
...
@Signature("rc(Windows.UI.Xaml.Media.Animation.BeginStoryboard;{64189fcd-49ec-4e52-a6f6-55324c921053})")
...
public class BeginStoryboard(
  ...
  private val __1474251220_Interface: IBeginStoryboard.WithDefault by lazy {
    as_1474251220()
  }


  public override val __1474251220_Ptr: JNAPointer? by lazy {
    __1474251220_Interface.__1474251220_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1474251220_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1474251220(): IBeginStoryboard.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<BeginStoryboard, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Animation.BeginStoryboard".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIBeginStoryboardStatics(): IBeginStoryboardStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Animation.BeginStoryboard".toHandle(),refiid,interfacePtr)
