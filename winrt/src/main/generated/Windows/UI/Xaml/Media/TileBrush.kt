...
import Windows.UI.Xaml.Media.ITileBrushFactory.ABI.IID
...
@Signature("rc(Windows.UI.Xaml.Media.TileBrush;{c201cf06-cd84-48a5-9607-664d7361cd61})")
...
public open class TileBrush(
  ...
  private val __1922644656_Interface: ITileBrush.WithDefault by lazy {
    as_1922644656()
  }


  public override val __1922644656_Ptr: JNAPointer? by lazy {
    __1922644656_Interface.__1922644656_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1922644656_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1922644656(): ITileBrush.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<TileBrush, MemoryAddress> {
    ...
    public fun createITileBrushStatics(): ITileBrushStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.TileBrush".toHandle(),refiid,interfacePtr)
    ...
    public fun createITileBrushFactory(): ITileBrushFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.TileBrush".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
