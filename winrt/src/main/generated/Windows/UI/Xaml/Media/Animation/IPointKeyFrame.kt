...
@Signature("{fcc88d01-7f82-4dae-8026-7b7e086878b3}")
@Guid("fcc88d017f824dae80267b7e086878b3")
@WinRTInterface("fcc88d017f824dae80267b7e086878b3")
...
public interface IPointKeyFrame : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPointKeyFrame {
    public val __1868962744_Ptr: Pointer?

    public val _1868962744_VtblPtr: Pointer?
      get() = __1868962744_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Value(): Point? {
      val fnPtr = _1868962744_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Point>()
      val hr = fn.invokeHR(arrayOf(__1868962744_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Value(value: Point?): Unit {
      val fnPtr = _1868962744_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1868962744_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_KeyTime(): KeyTime? {
      val fnPtr = _1868962744_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_KeyTime(value: KeyTime?): Unit {
      val fnPtr = _1868962744_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1868962744_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IPointKeyFrame_Impl(
    ...
    public override val __1868962744_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPointKeyFrame, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("fcc88d017f824dae80267b7e086878b3")
    ...
    public override fun toNative(obj: IPointKeyFrame): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1868962744_Ptr))
  }
