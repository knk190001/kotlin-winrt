...
@Signature("{8e96d16b-bb84-4c6f-9dbf-9d6c5c6d9c39}")
@Guid("8e96d16bbb844c6f9dbf9d6c5c6d9c39")
@WinRTInterface("8e96d16bbb844c6f9dbf9d6c5c6d9c39")
...
public interface ILinearGradientBrush : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ILinearGradientBrush {
    public val __763877559_Ptr: Pointer?

    public val _763877559_VtblPtr: Pointer?
      get() = __763877559_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_StartPoint(): Point? {
      val fnPtr = _763877559_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Point>()
      val hr = fn.invokeHR(arrayOf(__763877559_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_StartPoint(value: Point?): Unit {
      val fnPtr = _763877559_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__763877559_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_EndPoint(): Point? {
      val fnPtr = _763877559_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Point>()
      val hr = fn.invokeHR(arrayOf(__763877559_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_EndPoint(value: Point?): Unit {
      val fnPtr = _763877559_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__763877559_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class ILinearGradientBrush_Impl(
    ...
    public override val __763877559_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ILinearGradientBrush, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("8e96d16bbb844c6f9dbf9d6c5c6d9c39")
    ...
    public override fun toNative(obj: ILinearGradientBrush): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__763877559_Ptr))
  }
