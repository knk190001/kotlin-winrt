...
@Signature("rc(Windows.UI.Xaml.Media.Animation.PointerDownThemeAnimation;{b58e714e-c49d-4788-a233-0ae85d99dd5a})")
...
public class PointerDownThemeAnimation(
  ...
  private val __902108884_Interface: IPointerDownThemeAnimation.WithDefault by lazy {
    as_902108884()
  }


  public override val __902108884_Ptr: JNAPointer? by lazy {
    __902108884_Interface.__902108884_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__902108884_Interface)

  public constructor() : this(ABI.activate())

  private fun as_902108884(): IPointerDownThemeAnimation.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<PointerDownThemeAnimation, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Animation.PointerDownThemeAnimation".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIPointerDownThemeAnimationStatics(): IPointerDownThemeAnimationStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Animation.PointerDownThemeAnimation".toHandle(),refiid,interfacePtr)
      val result =
