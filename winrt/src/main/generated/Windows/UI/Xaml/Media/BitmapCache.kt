...
@Signature("rc(Windows.UI.Xaml.Media.BitmapCache;{79c2219e-44d2-4610-9735-9bec83809ecf})")
@WinRTByReference(brClass = BitmapCache.ByReference::class)
public class BitmapCache(
  ptr: JNAPointer? = NULL
) : CacheMode(ptr), IBitmapCache.WithDefault, IWinRTObject {
  private val __67351529_Interface: IBitmapCache.WithDefault by lazy {
    as_67351529()
  }


  public override val __67351529_Ptr: JNAPointer? by lazy {
    __67351529_Interface.__67351529_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__67351529_Interface)

  public constructor() : this(ABI.activate())

  private fun as_67351529(): IBitmapCache.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<BitmapCache, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr = INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.BitmapCache".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
