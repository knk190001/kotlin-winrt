...
@Signature("{d9e58bba-2cba-4741-8f8d-3198cf5186b9}")
@Guid("d9e58bba2cba47418f8d3198cf5186b9")
@WinRTInterface("d9e58bba2cba47418f8d3198cf5186b9")
...
public interface IPathGeometryStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPathGeometryStatics {
    public val __1280230546_Ptr: Pointer?

    public val _1280230546_VtblPtr: Pointer?
      get() = __1280230546_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_FillRuleProperty(): DependencyProperty? {
      val fnPtr = _1280230546_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1280230546_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_FiguresProperty(): DependencyProperty? {
      val fnPtr = _1280230546_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1280230546_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IPathGeometryStatics_Impl(
    ...
    public override val __1280230546_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPathGeometryStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("d9e58bba2cba47418f8d3198cf5186b9")
    ...
    public override fun toNative(obj: IPathGeometryStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1280230546_Ptr))
  }
