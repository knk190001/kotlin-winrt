...
@Signature("{95e6844a-4377-503c-bee2-11dfcd5570e6}")
@Guid("95e6844a4377503cbee211dfcd5570e6")
@WinRTInterface("95e6844a4377503cbee211dfcd5570e6")
...
public interface IBasicConnectedAnimationConfigurationFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IBasicConnectedAnimationConfigurationFactory {
    public val __1798807977_Ptr: Pointer?

    public val _1798807977_VtblPtr: Pointer?
      get() = __1798807977_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        BasicConnectedAnimationConfiguration? {
      val fnPtr = _1798807977_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<BasicConnectedAnimationConfiguration>()
      val hr = fn.invokeHR(arrayOf(__1798807977_Ptr, marshalToNative(baseInterface),
  ...
  public class IBasicConnectedAnimationConfigurationFactory_Impl(
    ...
    public override val __1798807977_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IBasicConnectedAnimationConfigurationFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("95e6844a4377503cbee211dfcd5570e6")
    ...
    public override fun toNative(obj: IBasicConnectedAnimationConfigurationFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1798807977_Ptr))
  }
