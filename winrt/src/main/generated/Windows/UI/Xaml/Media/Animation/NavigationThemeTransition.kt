...
@Signature("rc(Windows.UI.Xaml.Media.Animation.NavigationThemeTransition;{8833848c-4eb7-41f2-8799-9eef0a213b73})")
...
public class NavigationThemeTransition(
  ...
  private val __1575712764_Interface: INavigationThemeTransition.WithDefault by lazy {
    as_1575712764()
  }


  public override val __1575712764_Ptr: JNAPointer? by lazy {
    __1575712764_Interface.__1575712764_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1575712764_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1575712764(): INavigationThemeTransition.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<NavigationThemeTransition, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Animation.NavigationThemeTransition".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createINavigationThemeTransitionStatics(): INavigationThemeTransitionStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Animation.NavigationThemeTransition".toHandle(),refiid,interfacePtr)
      val result =
