...
@Signature("rc(Windows.UI.Xaml.Media.SolidColorBrush;{9d850850-66f3-48df-9a8f-824bd5e070af})")
...
public class SolidColorBrush(
  ...
  private val __931578586_Interface: ISolidColorBrush.WithDefault by lazy {
    as_931578586()
  }


  public override val __931578586_Ptr: JNAPointer? by lazy {
    __931578586_Interface.__931578586_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__931578586_Interface)

  public constructor() : this(ABI.activate())

  public constructor(color: Color) : this(ABI.activate(color))

  private fun as_931578586(): ISolidColorBrush.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<SolidColorBrush, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr = INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.SolidColorBrush".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createISolidColorBrushStatics(): ISolidColorBrushStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.SolidColorBrush".toHandle(),refiid,interfacePtr)
    ...
    public fun createISolidColorBrushFactory(): ISolidColorBrushFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.SolidColorBrush".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
