...
@Signature("{b60591d9-2395-4317-9552-3a58526f8c7b}")
@Guid("b60591d92395431795523a58526f8c7b")
@WinRTInterface("b60591d92395431795523a58526f8c7b")
...
public interface IPathFigureStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPathFigureStatics {
    public val __1351604640_Ptr: Pointer?

    public val _1351604640_VtblPtr: Pointer?
      get() = __1351604640_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_SegmentsProperty(): DependencyProperty? {
      val fnPtr = _1351604640_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1351604640_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_StartPointProperty(): DependencyProperty? {
      val fnPtr = _1351604640_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1351604640_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsClosedProperty(): DependencyProperty? {
      val fnPtr = _1351604640_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1351604640_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsFilledProperty(): DependencyProperty? {
      val fnPtr = _1351604640_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1351604640_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IPathFigureStatics_Impl(
    ...
    public override val __1351604640_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPathFigureStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("b60591d92395431795523a58526f8c7b")
    ...
    public override fun toNative(obj: IPathFigureStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1351604640_Ptr))
  }
