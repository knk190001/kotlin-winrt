...
@Signature("rc(Windows.UI.Xaml.Media.EllipseGeometry;{d4f61bba-4ea2-40d6-aa6c-8d38aa87651f})")
...
public class EllipseGeometry(
  ...
  private val __526450932_Interface: IEllipseGeometry.WithDefault by lazy {
    as_526450932()
  }


  public override val __526450932_Ptr: JNAPointer? by lazy {
    __526450932_Interface.__526450932_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__526450932_Interface)

  public constructor() : this(ABI.activate())

  private fun as_526450932(): IEllipseGeometry.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<EllipseGeometry, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr = INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.EllipseGeometry".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIEllipseGeometryStatics(): IEllipseGeometryStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.EllipseGeometry".toHandle(),refiid,interfacePtr)
