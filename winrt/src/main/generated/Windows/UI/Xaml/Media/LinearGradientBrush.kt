...
@Signature("rc(Windows.UI.Xaml.Media.LinearGradientBrush;{8e96d16b-bb84-4c6f-9dbf-9d6c5c6d9c39})")
...
public class LinearGradientBrush(
  ...
  private val __763877559_Interface: ILinearGradientBrush.WithDefault by lazy {
    as_763877559()
  }


  public override val __763877559_Ptr: JNAPointer? by lazy {
    __763877559_Interface.__763877559_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__763877559_Interface)
  ...
  private fun as_763877559(): ILinearGradientBrush.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<LinearGradientBrush, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.LinearGradientBrush".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createILinearGradientBrushStatics(): ILinearGradientBrushStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.LinearGradientBrush".toHandle(),refiid,interfacePtr)
      val result =
    ...
    public fun createILinearGradientBrushFactory(): ILinearGradientBrushFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.LinearGradientBrush".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
