...
@Signature("rc(Windows.UI.Xaml.Media.ImageBrush;{9fd11377-c12a-4493-bf7d-f3a8ad74b554})")
...
public class ImageBrush(
  ...
  private val __559192677_Interface: IImageBrush.WithDefault by lazy {
    as_559192677()
  }


  public override val __559192677_Ptr: JNAPointer? by lazy {
    __559192677_Interface.__559192677_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__559192677_Interface)

  public constructor() : this(ABI.activate())

  private fun as_559192677(): IImageBrush.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<ImageBrush, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr = INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.ImageBrush".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIImageBrushStatics(): IImageBrushStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.ImageBrush".toHandle(),refiid,interfacePtr)
