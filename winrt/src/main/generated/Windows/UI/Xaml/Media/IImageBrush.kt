...
@Signature("{9fd11377-c12a-4493-bf7d-f3a8ad74b554}")
@Guid("9fd11377c12a4493bf7df3a8ad74b554")
@WinRTInterface("9fd11377c12a4493bf7df3a8ad74b554")
...
public interface IImageBrush : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IImageBrush {
    public val __559192677_Ptr: Pointer?

    public val _559192677_VtblPtr: Pointer?
      get() = __559192677_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ImageSource(): ImageSource? {
      val fnPtr = _559192677_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ImageSource>()
      val hr = fn.invokeHR(arrayOf(__559192677_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ImageSource(value: ImageSource?): Unit {
      val fnPtr = _559192677_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__559192677_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun add_ImageFailed(handler: ExceptionRoutedEventHandler?):
      ...
      val fnPtr = _559192677_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__559192677_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun remove_ImageFailed(token: EventRegistrationToken?): Unit {
      val fnPtr = _559192677_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__559192677_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun add_ImageOpened(handler: RoutedEventHandler?): EventRegistrationToken? {
      val fnPtr = _559192677_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__559192677_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
    ...
    public override fun remove_ImageOpened(token: EventRegistrationToken?): Unit {
      val fnPtr = _559192677_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__559192677_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IImageBrush_Impl(
    ...
    public override val __559192677_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IImageBrush, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("9fd11377c12a4493bf7df3a8ad74b554")
    ...
    public override fun toNative(obj: IImageBrush): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__559192677_Ptr))
  }
