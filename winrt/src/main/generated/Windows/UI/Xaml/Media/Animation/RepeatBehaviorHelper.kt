...
@Signature("rc(Windows.UI.Xaml.Media.Animation.RepeatBehaviorHelper;{6863ab72-4997-47f9-87ad-37efb75993ea})")
...
public class RepeatBehaviorHelper(
  ...
  private val __1746746913_Interface: IRepeatBehaviorHelper.WithDefault by lazy {
    as_1746746913()
  }


  public override val __1746746913_Ptr: JNAPointer? by lazy {
    __1746746913_Interface.__1746746913_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1746746913_Interface)

  private fun as_1746746913(): IRepeatBehaviorHelper.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<RepeatBehaviorHelper, MemoryAddress> {
    ...
    public fun createIRepeatBehaviorHelperStatics(): IRepeatBehaviorHelperStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Animation.RepeatBehaviorHelper".toHandle(),refiid,interfacePtr)
      val result =
