...
@Signature("{5bf7d30d-9748-4aed-8380-d7890eb776a0}")
@Guid("5bf7d30d97484aed8380d7890eb776a0")
@WinRTInterface("5bf7d30d97484aed8380d7890eb776a0")
...
public interface IRenderingEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IRenderingEventArgs {
    public val __1096172441_Ptr: Pointer?

    public val _1096172441_VtblPtr: Pointer?
      get() = __1096172441_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_RenderingTime(): TimeSpan? {
      val fnPtr = _1096172441_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<TimeSpan>()
      val hr = fn.invokeHR(arrayOf(__1096172441_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IRenderingEventArgs_Impl(
    ...
    public override val __1096172441_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IRenderingEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("5bf7d30d97484aed8380d7890eb776a0")
    ...
    public override fun toNative(obj: IRenderingEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1096172441_Ptr))
  }
