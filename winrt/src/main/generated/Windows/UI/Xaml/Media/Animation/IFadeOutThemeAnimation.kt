...
@Signature("{89276ba9-ffd4-45b6-9b9a-ced48951e712}")
@Guid("89276ba9ffd445b69b9aced48951e712")
@WinRTInterface("89276ba9ffd445b69b9aced48951e712")
...
public interface IFadeOutThemeAnimation : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IFadeOutThemeAnimation {
    public val __823975239_Ptr: Pointer?

    public val _823975239_VtblPtr: Pointer?
      get() = __823975239_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_TargetName(): String? {
      val fnPtr = _823975239_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__823975239_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_TargetName(value: String?): Unit {
      val fnPtr = _823975239_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__823975239_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IFadeOutThemeAnimation_Impl(
    ...
    public override val __823975239_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IFadeOutThemeAnimation, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("89276ba9ffd445b69b9aced48951e712")
    ...
    public override fun toNative(obj: IFadeOutThemeAnimation): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__823975239_Ptr))
  }
