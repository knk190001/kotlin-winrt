...
@Signature("rc(Windows.UI.Xaml.Media.Imaging.SvgImageSourceFailedEventArgs;{68bb3170-3ccc-4035-ac01-9834543d744e})")
...
public class SvgImageSourceFailedEventArgs(
  ...
  private val __299605110_Interface: ISvgImageSourceFailedEventArgs.WithDefault by lazy {
    as_299605110()
  }


  public override val __299605110_Ptr: JNAPointer? by lazy {
    __299605110_Interface.__299605110_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__299605110_Interface)

  private fun as_299605110(): ISvgImageSourceFailedEventArgs.WithDefault {
    if(pointer == NULL) {
