...
@Signature("{2a5031aa-2c50-4a1d-bb04-d75e07b71548}")
@Guid("2a5031aa2c504a1dbb04d75e07b71548")
@WinRTInterface("2a5031aa2c504a1dbb04d75e07b71548")
...
public interface IEasingFunctionBaseStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IEasingFunctionBaseStatics {
    public val __1197976139_Ptr: Pointer?

    public val _1197976139_VtblPtr: Pointer?
      get() = __1197976139_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_EasingModeProperty(): DependencyProperty? {
      val fnPtr = _1197976139_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1197976139_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IEasingFunctionBaseStatics_Impl(
    ...
    public override val __1197976139_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IEasingFunctionBaseStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("2a5031aa2c504a1dbb04d75e07b71548")
    ...
    public override fun toNative(obj: IEasingFunctionBaseStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1197976139_Ptr))
  }
