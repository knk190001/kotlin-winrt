...
@Signature("{394f0823-2451-4ed8-bd24-488149b3428d}")
@Guid("394f082324514ed8bd24488149b3428d")
@WinRTInterface("394f082324514ed8bd24488149b3428d")
...
public interface IXamlCompositionBrushBaseFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IXamlCompositionBrushBaseFactory {
    public val __520448581_Ptr: Pointer?

    public val _520448581_VtblPtr: Pointer?
      get() = __520448581_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        XamlCompositionBrushBase? {
      val fnPtr = _520448581_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<XamlCompositionBrushBase>()
      val hr = fn.invokeHR(arrayOf(__520448581_Ptr, marshalToNative(baseInterface),
  ...
  public class IXamlCompositionBrushBaseFactory_Impl(
    ...
    public override val __520448581_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IXamlCompositionBrushBaseFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("394f082324514ed8bd24488149b3428d")
    ...
    public override fun toNative(obj: IXamlCompositionBrushBaseFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__520448581_Ptr))
  }
