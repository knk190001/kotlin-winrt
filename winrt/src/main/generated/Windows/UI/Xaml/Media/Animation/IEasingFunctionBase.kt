...
@Signature("{c108383f-2c02-4151-8ecd-68ddaa3f0d9b}")
@Guid("c108383f2c0241518ecd68ddaa3f0d9b")
@WinRTInterface("c108383f2c0241518ecd68ddaa3f0d9b")
...
public interface IEasingFunctionBase : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IEasingFunctionBase {
    public val __1108870118_Ptr: Pointer?

    public val _1108870118_VtblPtr: Pointer?
      get() = __1108870118_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_EasingMode(): EasingMode? {
      val fnPtr = _1108870118_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EasingMode>()
      val hr = fn.invokeHR(arrayOf(__1108870118_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_EasingMode(value: EasingMode?): Unit {
      val fnPtr = _1108870118_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1108870118_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun Ease(normalizedTime: Double): Double {
      val fnPtr = _1108870118_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1108870118_Ptr, normalizedTime, result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
  ...
  public class IEasingFunctionBase_Impl(
    ...
    public override val __1108870118_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IEasingFunctionBase, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("c108383f2c0241518ecd68ddaa3f0d9b")
    ...
    public override fun toNative(obj: IEasingFunctionBase): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1108870118_Ptr))
  }
