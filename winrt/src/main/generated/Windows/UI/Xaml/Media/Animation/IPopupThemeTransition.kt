...
@Signature("{47843552-4283-545e-c791-268dca22ce4b}")
@Guid("478435524283545ec791268dca22ce4b")
@WinRTInterface("478435524283545ec791268dca22ce4b")
...
public interface IPopupThemeTransition : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPopupThemeTransition {
    public val __898545848_Ptr: Pointer?

    public val _898545848_VtblPtr: Pointer?
      get() = __898545848_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_FromHorizontalOffset(): Double {
      val fnPtr = _898545848_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__898545848_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_FromHorizontalOffset(value: Double): Unit {
      val fnPtr = _898545848_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__898545848_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_FromVerticalOffset(): Double {
      val fnPtr = _898545848_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__898545848_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_FromVerticalOffset(value: Double): Unit {
      val fnPtr = _898545848_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__898545848_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IPopupThemeTransition_Impl(
    ...
    public override val __898545848_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPopupThemeTransition, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("478435524283545ec791268dca22ce4b")
    ...
    public override fun toNative(obj: IPopupThemeTransition): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__898545848_Ptr))
  }
