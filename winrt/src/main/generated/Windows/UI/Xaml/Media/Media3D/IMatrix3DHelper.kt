...
@Signature("{e48c10ef-9927-4c9b-8213-07775512ba04}")
@Guid("e48c10ef99274c9b821307775512ba04")
@WinRTInterface("e48c10ef99274c9b821307775512ba04")
...
public interface IMatrix3DHelper : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IMatrix3DHelper {
    public val __1860373013_Ptr: Pointer?

    public val _1860373013_VtblPtr: Pointer?
      get() = __1860373013_Ptr?.getPointer(0)
  }

  public class IMatrix3DHelper_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __1860373013_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IMatrix3DHelper, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("e48c10ef99274c9b821307775512ba04")
    ...
    public override fun toNative(obj: IMatrix3DHelper): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1860373013_Ptr))
  }
