...
@Signature("rc(Windows.UI.Xaml.Media.Animation.SplinePointKeyFrame;{0f19f306-7036-494f-bc3c-780df0cc524a})")
...
public class SplinePointKeyFrame(
  ...
  private val __1507642343_Interface: ISplinePointKeyFrame.WithDefault by lazy {
    as_1507642343()
  }


  public override val __1507642343_Ptr: JNAPointer? by lazy {
    __1507642343_Interface.__1507642343_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1507642343_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1507642343(): ISplinePointKeyFrame.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<SplinePointKeyFrame, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Animation.SplinePointKeyFrame".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createISplinePointKeyFrameStatics(): ISplinePointKeyFrameStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Media.Animation.SplinePointKeyFrame".toHandle(),refiid,interfacePtr)
      val result =
