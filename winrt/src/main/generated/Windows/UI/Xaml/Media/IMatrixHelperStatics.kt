...
@Signature("{c18606a6-39f4-4b8a-8403-28e5e5f033b4}")
@Guid("c18606a639f44b8a840328e5e5f033b4")
@WinRTInterface("c18606a639f44b8a840328e5e5f033b4")
...
public interface IMatrixHelperStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IMatrixHelperStatics {
    public val __1265469830_Ptr: Pointer?

    public val _1265469830_VtblPtr: Pointer?
      get() = __1265469830_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Identity(): Matrix? {
      val fnPtr = _1265469830_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Matrix>()
      val hr = fn.invokeHR(arrayOf(__1265469830_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun FromElements(
      ...
      val fnPtr = _1265469830_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Matrix>()
      val hr = fn.invokeHR(arrayOf(__1265469830_Ptr, m11, m12, m21, m22, offsetX, offsetY, result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
      val resultValue = marshalFromNative<Matrix>(result.getValue())
    ...
    public override fun GetIsIdentity(target: Matrix?): Boolean {
      val fnPtr = _1265469830_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1265469830_Ptr, marshalToNative(target), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun Transform(target: Matrix?, point: Point?): Point? {
      val fnPtr = _1265469830_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Point>()
      val hr = fn.invokeHR(arrayOf(__1265469830_Ptr, marshalToNative(target),
  ...
  public class IMatrixHelperStatics_Impl(
    ...
    public override val __1265469830_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IMatrixHelperStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("c18606a639f44b8a840328e5e5f033b4")
    ...
    public override fun toNative(obj: IMatrixHelperStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1265469830_Ptr))
  }
