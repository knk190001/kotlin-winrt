...
@Signature("{727bdd92-64b0-49cf-a321-a9793e73e2e7}")
@Guid("727bdd9264b049cfa321a9793e73e2e7")
@WinRTInterface("727bdd9264b049cfa321a9793e73e2e7")
...
public interface IPointHelper : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPointHelper {
    public val __1022253004_Ptr: Pointer?

    public val _1022253004_VtblPtr: Pointer?
      get() = __1022253004_Ptr?.getPointer(0)
  }

  public class IPointHelper_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __1022253004_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPointHelper, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("727bdd9264b049cfa321a9793e73e2e7")
    ...
    public override fun toNative(obj: IPointHelper): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1022253004_Ptr))
  }
