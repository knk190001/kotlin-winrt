...
@Signature("{6286c5b2-cf78-4915-aa40-76004a165f5e}")
@Guid("6286c5b2cf784915aa4076004a165f5e")
@WinRTInterface("6286c5b2cf784915aa4076004a165f5e")
...
public interface ISizeHelperStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISizeHelperStatics {
    public val __1988012452_Ptr: Pointer?

    public val _1988012452_VtblPtr: Pointer?
      get() = __1988012452_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Empty(): Size? {
      val fnPtr = _1988012452_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Size>()
      val hr = fn.invokeHR(arrayOf(__1988012452_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun FromDimensions(width: Float, height: Float): Size? {
      val fnPtr = _1988012452_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Size>()
      val hr = fn.invokeHR(arrayOf(__1988012452_Ptr, width, height, result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
      val resultValue = marshalFromNative<Size>(result.getValue())
    ...
    public override fun GetIsEmpty(target: Size?): Boolean {
      val fnPtr = _1988012452_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1988012452_Ptr, marshalToNative(target), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun Equals(target: Size?, value: Size?): Boolean {
      val fnPtr = _1988012452_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1988012452_Ptr, marshalToNative(target),
  ...
  public class ISizeHelperStatics_Impl(
    ...
    public override val __1988012452_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISizeHelperStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("6286c5b2cf784915aa4076004a165f5e")
    ...
    public override fun toNative(obj: ISizeHelperStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1988012452_Ptr))
  }
