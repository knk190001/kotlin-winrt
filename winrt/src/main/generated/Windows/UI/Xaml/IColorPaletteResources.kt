...
@Signature("{258088c4-aef2-5d3f-833b-c36db6278ed9}")
@Guid("258088c4aef25d3f833bc36db6278ed9")
@WinRTInterface("258088c4aef25d3f833bc36db6278ed9")
...
public interface IColorPaletteResources : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IColorPaletteResources {
    public val __399470683_Ptr: Pointer?

    public val _399470683_VtblPtr: Pointer?
      get() = __399470683_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_AltHigh(): IReference<Color?>? {
      val fnPtr = _399470683_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IReference<Color?>>()
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_AltHigh(value: IReference<Color?>?): Unit {
      val fnPtr = _399470683_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_AltLow(): IReference<Color?>? {
      val fnPtr = _399470683_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IReference<Color?>>()
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_AltLow(value: IReference<Color?>?): Unit {
      val fnPtr = _399470683_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_AltMedium(): IReference<Color?>? {
      val fnPtr = _399470683_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IReference<Color?>>()
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_AltMedium(value: IReference<Color?>?): Unit {
      val fnPtr = _399470683_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_AltMediumHigh(): IReference<Color?>? {
      val fnPtr = _399470683_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IReference<Color?>>()
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_AltMediumHigh(value: IReference<Color?>?): Unit {
      val fnPtr = _399470683_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_AltMediumLow(): IReference<Color?>? {
      val fnPtr = _399470683_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IReference<Color?>>()
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_AltMediumLow(value: IReference<Color?>?): Unit {
      val fnPtr = _399470683_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_BaseHigh(): IReference<Color?>? {
      val fnPtr = _399470683_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IReference<Color?>>()
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_BaseHigh(value: IReference<Color?>?): Unit {
      val fnPtr = _399470683_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_BaseLow(): IReference<Color?>? {
      val fnPtr = _399470683_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IReference<Color?>>()
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_BaseLow(value: IReference<Color?>?): Unit {
      val fnPtr = _399470683_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_BaseMedium(): IReference<Color?>? {
      val fnPtr = _399470683_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IReference<Color?>>()
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_BaseMedium(value: IReference<Color?>?): Unit {
      val fnPtr = _399470683_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_BaseMediumHigh(): IReference<Color?>? {
      val fnPtr = _399470683_VtblPtr!!.getPointer(22L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IReference<Color?>>()
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_BaseMediumHigh(value: IReference<Color?>?): Unit {
      val fnPtr = _399470683_VtblPtr!!.getPointer(23L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_BaseMediumLow(): IReference<Color?>? {
      val fnPtr = _399470683_VtblPtr!!.getPointer(24L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IReference<Color?>>()
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_BaseMediumLow(value: IReference<Color?>?): Unit {
      val fnPtr = _399470683_VtblPtr!!.getPointer(25L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ChromeAltLow(): IReference<Color?>? {
      val fnPtr = _399470683_VtblPtr!!.getPointer(26L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IReference<Color?>>()
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ChromeAltLow(value: IReference<Color?>?): Unit {
      val fnPtr = _399470683_VtblPtr!!.getPointer(27L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ChromeBlackHigh(): IReference<Color?>? {
      val fnPtr = _399470683_VtblPtr!!.getPointer(28L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IReference<Color?>>()
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ChromeBlackHigh(value: IReference<Color?>?): Unit {
      val fnPtr = _399470683_VtblPtr!!.getPointer(29L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ChromeBlackLow(): IReference<Color?>? {
      val fnPtr = _399470683_VtblPtr!!.getPointer(30L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IReference<Color?>>()
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ChromeBlackLow(value: IReference<Color?>?): Unit {
      val fnPtr = _399470683_VtblPtr!!.getPointer(31L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ChromeBlackMediumLow(): IReference<Color?>? {
      val fnPtr = _399470683_VtblPtr!!.getPointer(32L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IReference<Color?>>()
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ChromeBlackMediumLow(value: IReference<Color?>?): Unit {
      val fnPtr = _399470683_VtblPtr!!.getPointer(33L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ChromeBlackMedium(): IReference<Color?>? {
      val fnPtr = _399470683_VtblPtr!!.getPointer(34L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IReference<Color?>>()
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ChromeBlackMedium(value: IReference<Color?>?): Unit {
      val fnPtr = _399470683_VtblPtr!!.getPointer(35L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ChromeDisabledHigh(): IReference<Color?>? {
      val fnPtr = _399470683_VtblPtr!!.getPointer(36L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IReference<Color?>>()
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ChromeDisabledHigh(value: IReference<Color?>?): Unit {
      val fnPtr = _399470683_VtblPtr!!.getPointer(37L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ChromeDisabledLow(): IReference<Color?>? {
      val fnPtr = _399470683_VtblPtr!!.getPointer(38L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IReference<Color?>>()
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ChromeDisabledLow(value: IReference<Color?>?): Unit {
      val fnPtr = _399470683_VtblPtr!!.getPointer(39L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ChromeHigh(): IReference<Color?>? {
      val fnPtr = _399470683_VtblPtr!!.getPointer(40L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IReference<Color?>>()
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ChromeHigh(value: IReference<Color?>?): Unit {
      val fnPtr = _399470683_VtblPtr!!.getPointer(41L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ChromeLow(): IReference<Color?>? {
      val fnPtr = _399470683_VtblPtr!!.getPointer(42L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IReference<Color?>>()
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ChromeLow(value: IReference<Color?>?): Unit {
      val fnPtr = _399470683_VtblPtr!!.getPointer(43L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ChromeMedium(): IReference<Color?>? {
      val fnPtr = _399470683_VtblPtr!!.getPointer(44L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IReference<Color?>>()
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ChromeMedium(value: IReference<Color?>?): Unit {
      val fnPtr = _399470683_VtblPtr!!.getPointer(45L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ChromeMediumLow(): IReference<Color?>? {
      val fnPtr = _399470683_VtblPtr!!.getPointer(46L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IReference<Color?>>()
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ChromeMediumLow(value: IReference<Color?>?): Unit {
      val fnPtr = _399470683_VtblPtr!!.getPointer(47L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ChromeWhite(): IReference<Color?>? {
      val fnPtr = _399470683_VtblPtr!!.getPointer(48L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IReference<Color?>>()
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ChromeWhite(value: IReference<Color?>?): Unit {
      val fnPtr = _399470683_VtblPtr!!.getPointer(49L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ChromeGray(): IReference<Color?>? {
      val fnPtr = _399470683_VtblPtr!!.getPointer(50L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IReference<Color?>>()
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ChromeGray(value: IReference<Color?>?): Unit {
      val fnPtr = _399470683_VtblPtr!!.getPointer(51L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ListLow(): IReference<Color?>? {
      val fnPtr = _399470683_VtblPtr!!.getPointer(52L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IReference<Color?>>()
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ListLow(value: IReference<Color?>?): Unit {
      val fnPtr = _399470683_VtblPtr!!.getPointer(53L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ListMedium(): IReference<Color?>? {
      val fnPtr = _399470683_VtblPtr!!.getPointer(54L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IReference<Color?>>()
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ListMedium(value: IReference<Color?>?): Unit {
      val fnPtr = _399470683_VtblPtr!!.getPointer(55L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ErrorText(): IReference<Color?>? {
      val fnPtr = _399470683_VtblPtr!!.getPointer(56L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IReference<Color?>>()
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ErrorText(value: IReference<Color?>?): Unit {
      val fnPtr = _399470683_VtblPtr!!.getPointer(57L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Accent(): IReference<Color?>? {
      val fnPtr = _399470683_VtblPtr!!.getPointer(58L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IReference<Color?>>()
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Accent(value: IReference<Color?>?): Unit {
      val fnPtr = _399470683_VtblPtr!!.getPointer(59L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__399470683_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IColorPaletteResources_Impl(
    ...
    public override val __399470683_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IColorPaletteResources, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("258088c4aef25d3f833bc36db6278ed9")
    ...
    public override fun toNative(obj: IColorPaletteResources): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__399470683_Ptr))
  }
