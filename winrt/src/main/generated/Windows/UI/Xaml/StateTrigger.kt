...
@Signature("rc(Windows.UI.Xaml.StateTrigger;{67adef2e-d8d9-49f7-a1fd-2e35eedd23cd})")
...
public class StateTrigger(
  ...
  private val __1303253191_Interface: IStateTrigger.WithDefault by lazy {
    as_1303253191()
  }


  public override val __1303253191_Ptr: JNAPointer? by lazy {
    __1303253191_Interface.__1303253191_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1303253191_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1303253191(): IStateTrigger.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<StateTrigger, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr = INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.StateTrigger".toHandle(), refiid,
          iAFPtr)
      checkHR(hr)
    ...
    public fun createIStateTriggerStatics(): IStateTriggerStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.StateTrigger".toHandle(),refiid,interfacePtr)
