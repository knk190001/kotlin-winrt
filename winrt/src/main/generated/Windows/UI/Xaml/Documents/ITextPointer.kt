...
@Signature("{ac687aa1-6a41-43ff-851e-45348aa2cf7b}")
@Guid("ac687aa16a4143ff851e45348aa2cf7b")
@WinRTInterface("ac687aa16a4143ff851e45348aa2cf7b")
...
public interface ITextPointer : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITextPointer {
    public val __513362648_Ptr: Pointer?

    public val _513362648_VtblPtr: Pointer?
      get() = __513362648_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Parent(): DependencyObject? {
      val fnPtr = _513362648_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyObject>()
      val hr = fn.invokeHR(arrayOf(__513362648_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_VisualParent(): FrameworkElement? {
      val fnPtr = _513362648_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_LogicalDirection(): LogicalDirection? {
      val fnPtr = _513362648_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_Offset(): Int {
      val fnPtr = _513362648_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun GetCharacterRect(direction: LogicalDirection?): Rect? {
      val fnPtr = _513362648_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Rect>()
      val hr = fn.invokeHR(arrayOf(__513362648_Ptr, marshalToNative(direction), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun GetPositionAtOffset(offset: Int, direction: LogicalDirection?):
        TextPointer? {
      val fnPtr = _513362648_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<TextPointer>()
      val hr = fn.invokeHR(arrayOf(__513362648_Ptr, offset, marshalToNative(direction), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
  ...
  public class ITextPointer_Impl(
    ...
    public override val __513362648_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITextPointer, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("ac687aa16a4143ff851e45348aa2cf7b")
    ...
    public override fun toNative(obj: ITextPointer): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__513362648_Ptr))
  }
