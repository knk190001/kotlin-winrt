...
@Signature("{1416ce81-28ee-452e-b121-5fc4f60b86a6}")
@Guid("1416ce8128ee452eb1215fc4f60b86a6")
@WinRTInterface("1416ce8128ee452eb1215fc4f60b86a6")
...
public interface IInlineUIContainer : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IInlineUIContainer {
    public val __1337271572_Ptr: Pointer?

    public val _1337271572_VtblPtr: Pointer?
      get() = __1337271572_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Child(): UIElement? {
      val fnPtr = _1337271572_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<UIElement>()
      val hr = fn.invokeHR(arrayOf(__1337271572_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Child(value: UIElement?): Unit {
      val fnPtr = _1337271572_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1337271572_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IInlineUIContainer_Impl(
    ...
    public override val __1337271572_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IInlineUIContainer, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("1416ce8128ee452eb1215fc4f60b86a6")
    ...
    public override fun toNative(obj: IInlineUIContainer): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1337271572_Ptr))
  }
