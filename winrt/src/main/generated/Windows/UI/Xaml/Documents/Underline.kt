...
@Signature("rc(Windows.UI.Xaml.Documents.Underline;{a5fa8202-61c0-47d7-93ef-bc0b577c5f26})")
@WinRTByReference(brClass = Underline.ByReference::class)
public class Underline(
  ptr: JNAPointer? = NULL
) : Span(ptr), IUnderline.WithDefault, IWinRTObject {
  private val __131333540_Interface: IUnderline.WithDefault by lazy {
    as_131333540()
  }


  public override val __131333540_Ptr: JNAPointer? by lazy {
    __131333540_Interface.__131333540_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__131333540_Interface)

  public constructor() : this(ABI.activate())

  private fun as_131333540(): IUnderline.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<Underline, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr = INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Documents.Underline".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
