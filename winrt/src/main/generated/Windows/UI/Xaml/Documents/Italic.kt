...
@Signature("rc(Windows.UI.Xaml.Documents.Italic;{91f4619c-fcbb-4157-802c-76f63b5fb657})")
@WinRTByReference(brClass = Italic.ByReference::class)
public class Italic(
  ptr: JNAPointer? = NULL
) : Span(ptr), IItalic.WithDefault, IWinRTObject {
  private val __1358810536_Interface: IItalic.WithDefault by lazy {
    as_1358810536()
  }


  public override val __1358810536_Ptr: JNAPointer? by lazy {
    __1358810536_Interface.__1358810536_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1358810536_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1358810536(): IItalic.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<Italic, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr = INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Documents.Italic".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
