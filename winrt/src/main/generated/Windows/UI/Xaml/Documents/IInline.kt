...
@Signature("{0c92712d-1bc9-4931-8cb1-1aeadf1cc685}")
@Guid("0c92712d1bc949318cb11aeadf1cc685")
@WinRTInterface("0c92712d1bc949318cb11aeadf1cc685")
...
public interface IInline : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IInline {
    public val __1364026687_Ptr: Pointer?

    public val _1364026687_VtblPtr: Pointer?
      get() = __1364026687_Ptr?.getPointer(0)
  }

  public class IInline_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __1364026687_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IInline, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("0c92712d1bc949318cb11aeadf1cc685")
    ...
    public override fun toNative(obj: IInline): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1364026687_Ptr))
  }
