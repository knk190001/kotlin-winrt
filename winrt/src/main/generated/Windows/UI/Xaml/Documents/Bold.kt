...
@Signature("rc(Windows.UI.Xaml.Documents.Bold;{ade73784-1b59-4da4-bb23-0f20e885b4bf})")
@WinRTByReference(brClass = Bold.ByReference::class)
public class Bold(
  ptr: JNAPointer? = NULL
) : Span(ptr), IBold.WithDefault, IWinRTObject {
  private val __551347027_Interface: IBold.WithDefault by lazy {
    as_551347027()
  }


  public override val __551347027_Ptr: JNAPointer? by lazy {
    __551347027_Interface.__551347027_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__551347027_Interface)

  public constructor() : this(ABI.activate())

  private fun as_551347027(): IBold.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<Bold, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr = INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Documents.Bold".toHandle(), refiid,
          iAFPtr)
      checkHR(hr)
