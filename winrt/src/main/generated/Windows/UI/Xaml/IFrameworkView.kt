...
@Signature("{ddba664b-b603-47aa-942d-3833174f0d80}")
@Guid("ddba664bb60347aa942d3833174f0d80")
@WinRTInterface("ddba664bb60347aa942d3833174f0d80")
...
public interface IFrameworkView : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IFrameworkView {
    public val __1652687025_Ptr: Pointer?

    public val _1652687025_VtblPtr: Pointer?
      get() = __1652687025_Ptr?.getPointer(0)
  }

  public class IFrameworkView_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __1652687025_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IFrameworkView, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("ddba664bb60347aa942d3833174f0d80")
    ...
    public override fun toNative(obj: IFrameworkView): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1652687025_Ptr))
  }
