...
@Signature("rc(Windows.UI.Xaml.DurationHelper;{25c1659f-4497-4135-940f-ee96f4d6e934})")
@WinRTByReference(brClass = DurationHelper.ByReference::class)
public class DurationHelper(
  ptr: JNAPointer? = NULL
) : PointerType(ptr), IDurationHelper.WithDefault, IWinRTObject {
  private val __1548674764_Interface: IDurationHelper.WithDefault by lazy {
    as_1548674764()
  }


  public override val __1548674764_Ptr: JNAPointer? by lazy {
    __1548674764_Interface.__1548674764_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1548674764_Interface)

  private fun as_1548674764(): IDurationHelper.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<DurationHelper, MemoryAddress> {
    ...
    public fun createIDurationHelperStatics(): IDurationHelperStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.DurationHelper".toHandle(),refiid,interfacePtr)
