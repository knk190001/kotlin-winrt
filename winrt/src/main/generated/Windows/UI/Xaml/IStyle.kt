...
@Signature("{c4a9f225-9db7-4a7d-b6d1-f74edb9293c2}")
@Guid("c4a9f2259db74a7db6d1f74edb9293c2")
@WinRTInterface("c4a9f2259db74a7db6d1f74edb9293c2")
...
public interface IStyle : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IStyle {
    public val __1841792353_Ptr: Pointer?

    public val _1841792353_VtblPtr: Pointer?
      get() = __1841792353_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_IsSealed(): Boolean {
      val fnPtr = _1841792353_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1841792353_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Setters(): SetterBaseCollection? {
      val fnPtr = _1841792353_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_TargetType(): TypeName? {
      val fnPtr = _1841792353_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_TargetType(value: TypeName?): Unit {
      val fnPtr = _1841792353_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1841792353_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_BasedOn(): Style? {
      val fnPtr = _1841792353_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_BasedOn(value: Style?): Unit {
      val fnPtr = _1841792353_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1841792353_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun Seal(): Unit {
      val fnPtr = _1841792353_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1841792353_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IStyle_Impl(
    ...
    public override val __1841792353_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IStyle, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("c4a9f2259db74a7db6d1f74edb9293c2")
    ...
    public override fun toNative(obj: IStyle): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1841792353_Ptr))
  }
