...
import Windows.UI.Xaml.IDispatcherTimerFactory.ABI.IID
...
@Signature("rc(Windows.UI.Xaml.DispatcherTimer;{d160ce46-cd22-4f5f-8c97-40e61da3e2dc})")
...
public open class DispatcherTimer(
  ...
  private val __1063708596_Interface: IDispatcherTimer.WithDefault by lazy {
    as_1063708596()
  }


  public override val __1063708596_Ptr: JNAPointer? by lazy {
    __1063708596_Interface.__1063708596_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1063708596_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1063708596(): IDispatcherTimer.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<DispatcherTimer, MemoryAddress> {
    ...
    public fun createIDispatcherTimerFactory(): IDispatcherTimerFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.DispatcherTimer".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
