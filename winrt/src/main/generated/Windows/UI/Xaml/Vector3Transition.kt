...
import Windows.UI.Xaml.IVector3TransitionFactory.ABI.IID
...
@Signature("rc(Windows.UI.Xaml.Vector3Transition;{d2e209dc-c4a2-5101-9a68-fa0150505589})")
...
public open class Vector3Transition(
  ...
  private val __453907635_Interface: IVector3Transition.WithDefault by lazy {
    as_453907635()
  }


  public override val __453907635_Ptr: JNAPointer? by lazy {
    __453907635_Interface.__453907635_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__453907635_Interface)

  public constructor() : this(ABI.activate())

  private fun as_453907635(): IVector3Transition.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<Vector3Transition, MemoryAddress> {
    ...
    public fun createIVector3TransitionFactory(): IVector3TransitionFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Vector3Transition".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
