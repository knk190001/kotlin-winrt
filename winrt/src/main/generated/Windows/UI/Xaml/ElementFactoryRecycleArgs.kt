...
import Windows.UI.Xaml.IElementFactoryRecycleArgsFactory.ABI.IID
...
@Signature("rc(Windows.UI.Xaml.ElementFactoryRecycleArgs;{86f16b14-37e8-5dd8-a90c-25d3710318b0})")
...
public open class ElementFactoryRecycleArgs(
  ...
  private val __396275888_Interface: IElementFactoryRecycleArgs.WithDefault by lazy {
    as_396275888()
  }


  public override val __396275888_Ptr: JNAPointer? by lazy {
    __396275888_Interface.__396275888_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__396275888_Interface)

  public constructor() : this(ABI.activate())

  private fun as_396275888(): IElementFactoryRecycleArgs.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<ElementFactoryRecycleArgs, MemoryAddress> {
    ...
    public fun createIElementFactoryRecycleArgsFactory(): IElementFactoryRecycleArgsFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.ElementFactoryRecycleArgs".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
