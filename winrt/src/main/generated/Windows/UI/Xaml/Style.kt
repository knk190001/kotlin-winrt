...
@Signature("rc(Windows.UI.Xaml.Style;{c4a9f225-9db7-4a7d-b6d1-f74edb9293c2})")
@WinRTByReference(brClass = Style.ByReference::class)
public class Style(
  ptr: JNAPointer? = NULL
) : DependencyObject(ptr), IStyle.WithDefault, IWinRTObject {
  private val __1841792353_Interface: IStyle.WithDefault by lazy {
    as_1841792353()
  }


  public override val __1841792353_Ptr: JNAPointer? by lazy {
    __1841792353_Interface.__1841792353_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1841792353_Interface)

  public constructor() : this(ABI.activate())

  public constructor(targetType: TypeName) : this(ABI.activate(targetType))

  private fun as_1841792353(): IStyle.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<Style, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr = INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Style".toHandle(), refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIStyleFactory(): IStyleFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Style".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
