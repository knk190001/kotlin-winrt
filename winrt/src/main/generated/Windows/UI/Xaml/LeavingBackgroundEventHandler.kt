...
public fun interface LeavingBackgroundEventHandlerBody {
  public operator fun invoke(sender: IUnknown?, e: LeavingBackgroundEventArgs?): Unit
}

@ABIMarker(LeavingBackgroundEventHandler.ABI::class)
@Signature("delegate({aaad5dad-4fc6-4aa4-b7cf-877e36ada4f6})")
@WinRTByReference(brClass = LeavingBackgroundEventHandler.ByReference::class)
public class LeavingBackgroundEventHandler(
  ptr: Pointer? = Pointer.NULL
) : Delegate(ptr) {
  public fun invoke(sender: IUnknown?, e: LeavingBackgroundEventArgs?): Unit {
  ...
  public companion object {
    ...
    public fun nativeFn(
      ...
      try {
        ...
        val e_Managed = LeavingBackgroundEventArgs.ABI.fromNative(e) as LeavingBackgroundEventArgs
  ...
  public object ABI : IABI<LeavingBackgroundEventHandler, MemoryAddress> {
    public val IID: Guid.IID = Guid.IID("aaad5dad4fc64aa4b7cf877e36ada4f6")
