...
@Signature("{32c1d013-4dbd-446d-bbb8-0de35048a449}")
@Guid("32c1d0134dbd446dbbb80de35048a449")
@WinRTInterface("32c1d0134dbd446dbbb80de35048a449")
...
public interface IBindingFailedEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IBindingFailedEventArgs {
    public val __1095485031_Ptr: Pointer?

    public val _1095485031_VtblPtr: Pointer?
      get() = __1095485031_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Message(): String? {
      val fnPtr = _1095485031_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__1095485031_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IBindingFailedEventArgs_Impl(
    ...
    public override val __1095485031_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IBindingFailedEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("32c1d0134dbd446dbbb80de35048a449")
    ...
    public override fun toNative(obj: IBindingFailedEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1095485031_Ptr))
  }
