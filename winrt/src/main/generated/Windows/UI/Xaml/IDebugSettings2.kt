...
@Signature("{48d37585-e1a6-469b-83c8-30825037119e}")
@Guid("48d37585e1a6469b83c830825037119e")
@WinRTInterface("48d37585e1a6469b83c830825037119e")
...
public interface IDebugSettings2 : NativeMapped, IWinRTInterface {
  @InterfaceMethod(0)
  public fun get_EnableRedrawRegions(): Boolean

  @InterfaceMethod(1)
  public fun put_EnableRedrawRegions(value: Boolean): Unit
  ...
  public interface WithDefault : IDebugSettings2 {
    public val __915410478_Ptr: Pointer?

    public val _915410478_VtblPtr: Pointer?
      get() = __915410478_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_EnableRedrawRegions(): Boolean {
      val fnPtr = _915410478_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__915410478_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    @InterfaceMethod(1)
    public override fun put_EnableRedrawRegions(value: Boolean): Unit {
      val fnPtr = _915410478_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__915410478_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IDebugSettings2_Impl(
    ...
    public override val __915410478_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IDebugSettings2, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("48d37585e1a6469b83c830825037119e")
    ...
    public override fun toNative(obj: IDebugSettings2): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__915410478_Ptr))
  }
