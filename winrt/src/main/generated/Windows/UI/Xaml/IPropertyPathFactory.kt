...
@Signature("{4e4cdf99-9826-4e56-847c-ca055f162905}")
@Guid("4e4cdf9998264e56847cca055f162905")
@WinRTInterface("4e4cdf9998264e56847cca055f162905")
...
public interface IPropertyPathFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPropertyPathFactory {
    public val __78235774_Ptr: Pointer?

    public val _78235774_VtblPtr: Pointer?
      get() = __78235774_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(path: String?): PropertyPath? {
      val fnPtr = _78235774_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<PropertyPath>()
      val hr = fn.invokeHR(arrayOf(__78235774_Ptr, marshalToNative(path), result))
      if (hr.toInt() != 0) {
  ...
  public class IPropertyPathFactory_Impl(
    ...
    public override val __78235774_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPropertyPathFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("4e4cdf9998264e56847cca055f162905")
    ...
    public override fun toNative(obj: IPropertyPathFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__78235774_Ptr))
  }
