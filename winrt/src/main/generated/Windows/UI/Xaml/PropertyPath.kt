...
import Windows.UI.Xaml.IPropertyPathFactory.ABI.IID
...
@Signature("rc(Windows.UI.Xaml.PropertyPath;{300e5d8a-1ff3-4d2c-95ec-27f81debacb8})")
@WinRTByReference(brClass = PropertyPath.ByReference::class)
public class PropertyPath(
  ptr: JNAPointer? = NULL
) : DependencyObject(ptr), IPropertyPath.WithDefault, IWinRTObject {
  private val __1281253652_Interface: IPropertyPath.WithDefault by lazy {
    as_1281253652()
  }


  public override val __1281253652_Ptr: JNAPointer? by lazy {
    __1281253652_Interface.__1281253652_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1281253652_Interface)

  public constructor(path: String) : this(ABI.activate(path))

  private fun as_1281253652(): IPropertyPath.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<PropertyPath, MemoryAddress> {
    ...
    public fun createIPropertyPathFactory(): IPropertyPathFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.PropertyPath".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
