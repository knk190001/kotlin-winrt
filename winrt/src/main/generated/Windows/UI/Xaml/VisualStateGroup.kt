...
@Signature("rc(Windows.UI.Xaml.VisualStateGroup;{e4f9d9a4-e028-44de-9b15-4929ae0a26c2})")
...
public class VisualStateGroup(
  ...
  private val __1002395104_Interface: IVisualStateGroup.WithDefault by lazy {
    as_1002395104()
  }


  public override val __1002395104_Ptr: JNAPointer? by lazy {
    __1002395104_Interface.__1002395104_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1002395104_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1002395104(): IVisualStateGroup.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<VisualStateGroup, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr = INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.VisualStateGroup".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
