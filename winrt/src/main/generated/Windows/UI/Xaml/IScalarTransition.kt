...
@Signature("{4cb68238-e15d-524e-a73c-9d4dcfbea226}")
@Guid("4cb68238e15d524ea73c9d4dcfbea226")
@WinRTInterface("4cb68238e15d524ea73c9d4dcfbea226")
...
public interface IScalarTransition : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IScalarTransition {
    public val __441559885_Ptr: Pointer?

    public val _441559885_VtblPtr: Pointer?
      get() = __441559885_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Duration(): TimeSpan? {
      val fnPtr = _441559885_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<TimeSpan>()
      val hr = fn.invokeHR(arrayOf(__441559885_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Duration(value: TimeSpan?): Unit {
      val fnPtr = _441559885_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__441559885_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IScalarTransition_Impl(
    ...
    public override val __441559885_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IScalarTransition, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("4cb68238e15d524ea73c9d4dcfbea226")
    ...
    public override fun toNative(obj: IScalarTransition): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__441559885_Ptr))
  }
