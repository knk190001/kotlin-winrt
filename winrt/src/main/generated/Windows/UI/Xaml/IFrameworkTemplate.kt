...
@Signature("{a1e254d8-a446-4a27-9a9d-a0f59e1258a5}")
@Guid("a1e254d8a4464a279a9da0f59e1258a5")
@WinRTInterface("a1e254d8a4464a279a9da0f59e1258a5")
...
public interface IFrameworkTemplate : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IFrameworkTemplate {
    public val __983847802_Ptr: Pointer?

    public val _983847802_VtblPtr: Pointer?
      get() = __983847802_Ptr?.getPointer(0)
  }

  public class IFrameworkTemplate_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __983847802_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IFrameworkTemplate, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("a1e254d8a4464a279a9da0f59e1258a5")
    ...
    public override fun toNative(obj: IFrameworkTemplate): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__983847802_Ptr))
  }
