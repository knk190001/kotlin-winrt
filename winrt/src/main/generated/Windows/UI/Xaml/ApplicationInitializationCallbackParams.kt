...
@Signature("rc(Windows.UI.Xaml.ApplicationInitializationCallbackParams;{751b792e-5772-4488-8b87-f547faa64474})")
...
public class ApplicationInitializationCallbackParams(
  ...
  private val __1786531273_Interface: IApplicationInitializationCallbackParams.WithDefault by lazy {
    as_1786531273()
  }


  public override val __1786531273_Ptr: JNAPointer? by lazy {
    __1786531273_Interface.__1786531273_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1786531273_Interface)

  private fun as_1786531273(): IApplicationInitializationCallbackParams.WithDefault {
    if(pointer == NULL) {
