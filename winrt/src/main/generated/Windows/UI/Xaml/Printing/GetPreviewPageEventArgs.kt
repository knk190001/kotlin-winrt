...
@Signature("rc(Windows.UI.Xaml.Printing.GetPreviewPageEventArgs;{a43d703d-dea9-4df6-a7ed-35049cd485c7})")
...
public class GetPreviewPageEventArgs(
  ...
  private val __340209383_Interface: IGetPreviewPageEventArgs.WithDefault by lazy {
    as_340209383()
  }


  public override val __340209383_Ptr: JNAPointer? by lazy {
    __340209383_Interface.__340209383_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__340209383_Interface)

  public constructor() : this(ABI.activate())

  private fun as_340209383(): IGetPreviewPageEventArgs.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<GetPreviewPageEventArgs, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Printing.GetPreviewPageEventArgs".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
