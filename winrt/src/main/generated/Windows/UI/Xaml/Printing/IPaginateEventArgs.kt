...
@Signature("{ed945fd6-79ab-42b7-930a-3d6e09011d21}")
@Guid("ed945fd679ab42b7930a3d6e09011d21")
@WinRTInterface("ed945fd679ab42b7930a3d6e09011d21")
...
public interface IPaginateEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPaginateEventArgs {
    public val __368385251_Ptr: Pointer?

    public val _368385251_VtblPtr: Pointer?
      get() = __368385251_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_PrintTaskOptions(): PrintTaskOptions? {
      val fnPtr = _368385251_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<PrintTaskOptions>()
      val hr = fn.invokeHR(arrayOf(__368385251_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_CurrentPreviewPageNumber(): Int {
      val fnPtr = _368385251_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class IPaginateEventArgs_Impl(
    ...
    public override val __368385251_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPaginateEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("ed945fd679ab42b7930a3d6e09011d21")
    ...
    public override fun toNative(obj: IPaginateEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__368385251_Ptr))
  }
