...
@Signature("rc(Windows.UI.Xaml.Printing.PaginateEventArgs;{ed945fd6-79ab-42b7-930a-3d6e09011d21})")
...
public class PaginateEventArgs(
  ...
  private val __368385251_Interface: IPaginateEventArgs.WithDefault by lazy {
    as_368385251()
  }


  public override val __368385251_Ptr: JNAPointer? by lazy {
    __368385251_Interface.__368385251_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__368385251_Interface)

  public constructor() : this(ABI.activate())

  private fun as_368385251(): IPaginateEventArgs.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<PaginateEventArgs, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.Printing.PaginateEventArgs".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
