...
@Signature("{a43d703d-dea9-4df6-a7ed-35049cd485c7}")
@Guid("a43d703ddea94df6a7ed35049cd485c7")
@WinRTInterface("a43d703ddea94df6a7ed35049cd485c7")
...
public interface IGetPreviewPageEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IGetPreviewPageEventArgs {
    public val __340209383_Ptr: Pointer?

    public val _340209383_VtblPtr: Pointer?
      get() = __340209383_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_PageNumber(): Int {
      val fnPtr = _340209383_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__340209383_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IGetPreviewPageEventArgs_Impl(
    ...
    public override val __340209383_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IGetPreviewPageEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("a43d703ddea94df6a7ed35049cd485c7")
    ...
    public override fun toNative(obj: IGetPreviewPageEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__340209383_Ptr))
  }
