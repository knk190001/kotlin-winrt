...
@Signature("rc(Windows.UI.Xaml.SizeHelper;{e7225a94-5d03-4a03-ba94-967fc68fcefe})")
@WinRTByReference(brClass = SizeHelper.ByReference::class)
public class SizeHelper(
  ptr: JNAPointer? = NULL
) : PointerType(ptr), ISizeHelper.WithDefault, IWinRTObject {
  private val __1170170143_Interface: ISizeHelper.WithDefault by lazy {
    as_1170170143()
  }


  public override val __1170170143_Ptr: JNAPointer? by lazy {
    __1170170143_Interface.__1170170143_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1170170143_Interface)

  private fun as_1170170143(): ISizeHelper.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<SizeHelper, MemoryAddress> {
    ...
    public fun createISizeHelperStatics(): ISizeHelperStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Xaml.SizeHelper".toHandle(),refiid,interfacePtr)
