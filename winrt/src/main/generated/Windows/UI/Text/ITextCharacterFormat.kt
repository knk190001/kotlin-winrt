...
@Signature("{5adef3db-05fb-442d-8065-642afea02ced}")
@Guid("5adef3db05fb442d8065642afea02ced")
@WinRTInterface("5adef3db05fb442d8065642afea02ced")
...
public interface ITextCharacterFormat : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITextCharacterFormat {
    public val __732582298_Ptr: Pointer?

    public val _732582298_VtblPtr: Pointer?
      get() = __732582298_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_AllCaps(): FormatEffect? {
      val fnPtr = _732582298_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<FormatEffect>()
      val hr = fn.invokeHR(arrayOf(__732582298_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_AllCaps(value: FormatEffect?): Unit {
      val fnPtr = _732582298_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__732582298_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_BackgroundColor(): Color? {
      val fnPtr = _732582298_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_BackgroundColor(value: Color?): Unit {
      val fnPtr = _732582298_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__732582298_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Bold(): FormatEffect? {
      val fnPtr = _732582298_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<FormatEffect>()
      val hr = fn.invokeHR(arrayOf(__732582298_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Bold(value: FormatEffect?): Unit {
      val fnPtr = _732582298_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__732582298_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_FontStretch(): FontStretch? {
      val fnPtr = _732582298_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_FontStretch(value: FontStretch?): Unit {
      val fnPtr = _732582298_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__732582298_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_FontStyle(): FontStyle? {
      val fnPtr = _732582298_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_FontStyle(value: FontStyle?): Unit {
      val fnPtr = _732582298_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__732582298_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ForegroundColor(): Color? {
      val fnPtr = _732582298_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__732582298_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ForegroundColor(value: Color?): Unit {
      val fnPtr = _732582298_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__732582298_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Hidden(): FormatEffect? {
      val fnPtr = _732582298_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<FormatEffect>()
      val hr = fn.invokeHR(arrayOf(__732582298_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Hidden(value: FormatEffect?): Unit {
      val fnPtr = _732582298_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__732582298_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Italic(): FormatEffect? {
      val fnPtr = _732582298_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<FormatEffect>()
      val hr = fn.invokeHR(arrayOf(__732582298_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Italic(value: FormatEffect?): Unit {
      val fnPtr = _732582298_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__732582298_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Kerning(): Float {
      val fnPtr = _732582298_VtblPtr!!.getPointer(22L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Kerning(value: Float): Unit {
      val fnPtr = _732582298_VtblPtr!!.getPointer(23L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__732582298_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_LanguageTag(): String? {
      val fnPtr = _732582298_VtblPtr!!.getPointer(24L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_LanguageTag(value: String?): Unit {
      val fnPtr = _732582298_VtblPtr!!.getPointer(25L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__732582298_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_LinkType(): LinkType? {
      val fnPtr = _732582298_VtblPtr!!.getPointer(26L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_Name(): String? {
      val fnPtr = _732582298_VtblPtr!!.getPointer(27L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__732582298_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Name(value: String?): Unit {
      val fnPtr = _732582298_VtblPtr!!.getPointer(28L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__732582298_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Outline(): FormatEffect? {
      val fnPtr = _732582298_VtblPtr!!.getPointer(29L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<FormatEffect>()
      val hr = fn.invokeHR(arrayOf(__732582298_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Outline(value: FormatEffect?): Unit {
      val fnPtr = _732582298_VtblPtr!!.getPointer(30L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__732582298_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Position(): Float {
      val fnPtr = _732582298_VtblPtr!!.getPointer(31L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__732582298_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Position(value: Float): Unit {
      val fnPtr = _732582298_VtblPtr!!.getPointer(32L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__732582298_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ProtectedText(): FormatEffect? {
      val fnPtr = _732582298_VtblPtr!!.getPointer(33L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<FormatEffect>()
      val hr = fn.invokeHR(arrayOf(__732582298_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ProtectedText(value: FormatEffect?): Unit {
      val fnPtr = _732582298_VtblPtr!!.getPointer(34L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__732582298_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Size(): Float {
      val fnPtr = _732582298_VtblPtr!!.getPointer(35L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__732582298_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Size(value: Float): Unit {
      val fnPtr = _732582298_VtblPtr!!.getPointer(36L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__732582298_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_SmallCaps(): FormatEffect? {
      val fnPtr = _732582298_VtblPtr!!.getPointer(37L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<FormatEffect>()
      val hr = fn.invokeHR(arrayOf(__732582298_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_SmallCaps(value: FormatEffect?): Unit {
      val fnPtr = _732582298_VtblPtr!!.getPointer(38L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__732582298_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Spacing(): Float {
      val fnPtr = _732582298_VtblPtr!!.getPointer(39L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__732582298_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Spacing(value: Float): Unit {
      val fnPtr = _732582298_VtblPtr!!.getPointer(40L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__732582298_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Strikethrough(): FormatEffect? {
      val fnPtr = _732582298_VtblPtr!!.getPointer(41L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<FormatEffect>()
      val hr = fn.invokeHR(arrayOf(__732582298_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Strikethrough(value: FormatEffect?): Unit {
      val fnPtr = _732582298_VtblPtr!!.getPointer(42L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__732582298_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Subscript(): FormatEffect? {
      val fnPtr = _732582298_VtblPtr!!.getPointer(43L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<FormatEffect>()
      val hr = fn.invokeHR(arrayOf(__732582298_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Subscript(value: FormatEffect?): Unit {
      val fnPtr = _732582298_VtblPtr!!.getPointer(44L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__732582298_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Superscript(): FormatEffect? {
      val fnPtr = _732582298_VtblPtr!!.getPointer(45L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<FormatEffect>()
      val hr = fn.invokeHR(arrayOf(__732582298_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Superscript(value: FormatEffect?): Unit {
      val fnPtr = _732582298_VtblPtr!!.getPointer(46L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__732582298_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_TextScript(): TextScript? {
      val fnPtr = _732582298_VtblPtr!!.getPointer(47L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_TextScript(value: TextScript?): Unit {
      val fnPtr = _732582298_VtblPtr!!.getPointer(48L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__732582298_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Underline(): UnderlineType? {
      val fnPtr = _732582298_VtblPtr!!.getPointer(49L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Underline(value: UnderlineType?): Unit {
      val fnPtr = _732582298_VtblPtr!!.getPointer(50L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__732582298_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Weight(): Int {
      val fnPtr = _732582298_VtblPtr!!.getPointer(51L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Weight(value: Int): Unit {
      val fnPtr = _732582298_VtblPtr!!.getPointer(52L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__732582298_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun SetClone(value: ITextCharacterFormat?): Unit {
      val fnPtr = _732582298_VtblPtr!!.getPointer(53L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__732582298_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun GetClone(): ITextCharacterFormat? {
      val fnPtr = _732582298_VtblPtr!!.getPointer(54L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun IsEqual(format: ITextCharacterFormat?): Boolean {
      val fnPtr = _732582298_VtblPtr!!.getPointer(55L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__732582298_Ptr, marshalToNative(format), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
  ...
  public class ITextCharacterFormat_Impl(
    ...
    public override val __732582298_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITextCharacterFormat, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("5adef3db05fb442d8065642afea02ced")
    ...
    public override fun toNative(obj: ITextCharacterFormat): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__732582298_Ptr))
  }
