...
@Signature("rc(Windows.UI.Text.FontWeights;{7880a444-01ab-4997-8517-df822a0c45f1})")
...
public class FontWeights(
  ...
  private val __33524865_Interface: IFontWeights.WithDefault by lazy {
    as_33524865()
  }


  public override val __33524865_Ptr: JNAPointer? by lazy {
    __33524865_Interface.__33524865_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__33524865_Interface)

  private fun as_33524865(): IFontWeights.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<FontWeights, MemoryAddress> {
    ...
    public fun createIFontWeightsStatics(): IFontWeightsStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.UI.Text.FontWeights".toHandle(),refiid,interfacePtr)
