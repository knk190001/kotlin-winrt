...
@Signature("rc(Windows.UI.Colors;{9b8c9326-4ca6-4ce5-8994-9eff65cabdcc})")
@WinRTByReference(brClass = Colors.ByReference::class)
public class Colors(
  ptr: JNAPointer? = NULL
) : PointerType(ptr), IColors.WithDefault, IWinRTObject {
  private val __201038790_Interface: IColors.WithDefault by lazy {
    as_201038790()
  }


  public override val __201038790_Ptr: JNAPointer? by lazy {
    __201038790_Interface.__201038790_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__201038790_Interface)

  private fun as_201038790(): IColors.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<Colors, MemoryAddress> {
    ...
    public fun createIColorsStatics(): IColorsStatics {
      ...
      val hr = INSTANCE.RoGetActivationFactory("Windows.UI.Colors".toHandle(),refiid,interfacePtr)
