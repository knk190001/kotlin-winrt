...
import Windows.ApplicationModel.Activation.ICachedFileUpdaterActivatedEventArgs
...
@ABIMarker(WebUICachedFileUpdaterActivatedEventArgs.ABI::class)
@Signature("rc(Windows.UI.WebUI.WebUICachedFileUpdaterActivatedEventArgs;{d06eb1c7-3805-4ecb-b757-6cf15e26fef3})")
@WinRTByReference(brClass = WebUICachedFileUpdaterActivatedEventArgs.ByReference::class)
public class WebUICachedFileUpdaterActivatedEventArgs(
  ptr: JNAPointer? = NULL
  ...
  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__282490024_Interface, __1721660047_Interface, __1254540095_Interface,
        __988512_Interface)
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<WebUICachedFileUpdaterActivatedEventArgs> {
    public override fun getValue() = WebUICachedFileUpdaterActivatedEventArgs(pointer.getPointer(0))

    public fun setValue(value: WebUICachedFileUpdaterActivatedEventArgs): Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  public object ABI : IABI<WebUICachedFileUpdaterActivatedEventArgs, MemoryAddress> {
    public override val layout: MemoryLayout = ValueLayout.ADDRESS

    public override fun fromNative(segment: MemoryAddress):
        WebUICachedFileUpdaterActivatedEventArgs {
      val address = segment.toRawLongValue()
      return WebUICachedFileUpdaterActivatedEventArgs(Pointer(address))
    }

    public override fun toNative(obj: WebUICachedFileUpdaterActivatedEventArgs): MemoryAddress =
