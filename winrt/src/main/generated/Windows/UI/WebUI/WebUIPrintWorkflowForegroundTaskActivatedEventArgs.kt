...
@ABIMarker(WebUIPrintWorkflowForegroundTaskActivatedEventArgs.ABI::class)
@Signature("rc(Windows.UI.WebUI.WebUIPrintWorkflowForegroundTaskActivatedEventArgs;{cf651713-cd08-4fd8-b697-a281b6544e2e})")
@WinRTByReference(brClass = WebUIPrintWorkflowForegroundTaskActivatedEventArgs.ByReference::class)
public class WebUIPrintWorkflowForegroundTaskActivatedEventArgs(
  ptr: JNAPointer? = NULL
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<WebUIPrintWorkflowForegroundTaskActivatedEventArgs> {
    public override fun getValue() =
        WebUIPrintWorkflowForegroundTaskActivatedEventArgs(pointer.getPointer(0))

    public fun setValue(value: WebUIPrintWorkflowForegroundTaskActivatedEventArgs): Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  public object ABI : IABI<WebUIPrintWorkflowForegroundTaskActivatedEventArgs, MemoryAddress> {
    public override val layout: MemoryLayout = ValueLayout.ADDRESS

    public override fun fromNative(segment: MemoryAddress):
        WebUIPrintWorkflowForegroundTaskActivatedEventArgs {
      val address = segment.toRawLongValue()
      return WebUIPrintWorkflowForegroundTaskActivatedEventArgs(Pointer(address))
    }

    public override fun toNative(obj: WebUIPrintWorkflowForegroundTaskActivatedEventArgs):
