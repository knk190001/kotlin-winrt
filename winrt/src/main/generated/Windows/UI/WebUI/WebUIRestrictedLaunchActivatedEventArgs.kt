...
import Windows.ApplicationModel.Activation.IRestrictedLaunchActivatedEventArgs
...
@ABIMarker(WebUIRestrictedLaunchActivatedEventArgs.ABI::class)
@Signature("rc(Windows.UI.WebUI.WebUIRestrictedLaunchActivatedEventArgs;{e0b7ac81-bfc3-4344-a5da-19fd5a27baae})")
@WinRTByReference(brClass = WebUIRestrictedLaunchActivatedEventArgs.ByReference::class)
public class WebUIRestrictedLaunchActivatedEventArgs(
  ptr: JNAPointer? = NULL
  ...
  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1100793117_Interface, __1721660047_Interface, __1254540095_Interface,
        __988512_Interface)
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<WebUIRestrictedLaunchActivatedEventArgs> {
    public override fun getValue() = WebUIRestrictedLaunchActivatedEventArgs(pointer.getPointer(0))

    public fun setValue(value: WebUIRestrictedLaunchActivatedEventArgs): Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  public object ABI : IABI<WebUIRestrictedLaunchActivatedEventArgs, MemoryAddress> {
    public override val layout: MemoryLayout = ValueLayout.ADDRESS

    public override fun fromNative(segment: MemoryAddress):
        WebUIRestrictedLaunchActivatedEventArgs {
      val address = segment.toRawLongValue()
      return WebUIRestrictedLaunchActivatedEventArgs(Pointer(address))
    }

    public override fun toNative(obj: WebUIRestrictedLaunchActivatedEventArgs): MemoryAddress =
