...
import Windows.ApplicationModel.Activation.IProtocolForResultsActivatedEventArgs
...
@ABIMarker(WebUIProtocolForResultsActivatedEventArgs.ABI::class)
@Signature("rc(Windows.UI.WebUI.WebUIProtocolForResultsActivatedEventArgs;{e75132c2-7ae7-4517-80ac-dbe8d7cc5b9c})")
@WinRTByReference(brClass = WebUIProtocolForResultsActivatedEventArgs.ByReference::class)
public class WebUIProtocolForResultsActivatedEventArgs(
  ptr: JNAPointer? = NULL
  ...
  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1559543508_Interface, __1721660047_Interface, __1709469255_Interface,
        __2110665436_Interface, __1142708526_Interface, __1254540095_Interface, __988512_Interface)
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<WebUIProtocolForResultsActivatedEventArgs> {
    public override fun getValue() =
        WebUIProtocolForResultsActivatedEventArgs(pointer.getPointer(0))

    public fun setValue(value: WebUIProtocolForResultsActivatedEventArgs): Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  public object ABI : IABI<WebUIProtocolForResultsActivatedEventArgs, MemoryAddress> {
    public override val layout: MemoryLayout = ValueLayout.ADDRESS

    public override fun fromNative(segment: MemoryAddress):
        WebUIProtocolForResultsActivatedEventArgs {
      val address = segment.toRawLongValue()
      return WebUIProtocolForResultsActivatedEventArgs(Pointer(address))
    }

    public override fun toNative(obj: WebUIProtocolForResultsActivatedEventArgs): MemoryAddress =
