...
import Windows.ApplicationModel.Activation.ILockScreenActivatedEventArgs
...
@ABIMarker(WebUILockScreenActivatedEventArgs.ABI::class)
@Signature("rc(Windows.UI.WebUI.WebUILockScreenActivatedEventArgs;{3ca77966-6108-4a41-8220-ee7d133c8532})")
@WinRTByReference(brClass = WebUILockScreenActivatedEventArgs.ByReference::class)
public class WebUILockScreenActivatedEventArgs(
  ptr: JNAPointer? = NULL
) : PointerType(ptr), ILockScreenActivatedEventArgs.WithDefault, IActivatedEventArgs.WithDefault,
  ...
  private val __1147723046_Interface: ILockScreenActivatedEventArgs.WithDefault by lazy {
    as_1147723046()
  }
  ...
  public override val __1147723046_Ptr: JNAPointer? by lazy {
    __1147723046_Interface.__1147723046_Ptr
  }
  ...
  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1147723046_Interface, __1721660047_Interface, __1142708526_Interface,
        __1254540095_Interface, __988512_Interface)

  private fun as_1147723046(): ILockScreenActivatedEventArgs.WithDefault {
    if(pointer == NULL) {
      return(ILockScreenActivatedEventArgs.ABI.makeILockScreenActivatedEventArgs(NULL))
    }
    val refiid = Guid.REFIID(guidOf<ILockScreenActivatedEventArgs>())
    val ref = PointerByReference()
    IUnknownVtbl(pointer.getPointer(0)).queryInterface(pointer, refiid, ref)
    return(ILockScreenActivatedEventArgs.ABI.makeILockScreenActivatedEventArgs(ref.value))
  }
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<WebUILockScreenActivatedEventArgs> {
    public override fun getValue() = WebUILockScreenActivatedEventArgs(pointer.getPointer(0))

    public fun setValue(value: WebUILockScreenActivatedEventArgs): Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  public object ABI : IABI<WebUILockScreenActivatedEventArgs, MemoryAddress> {
    public override val layout: MemoryLayout = ValueLayout.ADDRESS

    public override fun fromNative(segment: MemoryAddress): WebUILockScreenActivatedEventArgs {
      val address = segment.toRawLongValue()
      return WebUILockScreenActivatedEventArgs(Pointer(address))
    }

    public override fun toNative(obj: WebUILockScreenActivatedEventArgs): MemoryAddress =
