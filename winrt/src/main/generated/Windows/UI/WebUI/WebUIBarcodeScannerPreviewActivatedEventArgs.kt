...
import Windows.ApplicationModel.Activation.IBarcodeScannerPreviewActivatedEventArgs
...
@ABIMarker(WebUIBarcodeScannerPreviewActivatedEventArgs.ABI::class)
@Signature("rc(Windows.UI.WebUI.WebUIBarcodeScannerPreviewActivatedEventArgs;{6772797c-99bf-4349-af22-e4123560371c})")
@WinRTByReference(brClass = WebUIBarcodeScannerPreviewActivatedEventArgs.ByReference::class)
public class WebUIBarcodeScannerPreviewActivatedEventArgs(
  ptr: JNAPointer? = NULL
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<WebUIBarcodeScannerPreviewActivatedEventArgs> {
    public override fun getValue() =
        WebUIBarcodeScannerPreviewActivatedEventArgs(pointer.getPointer(0))

    public fun setValue(value: WebUIBarcodeScannerPreviewActivatedEventArgs): Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  public object ABI : IABI<WebUIBarcodeScannerPreviewActivatedEventArgs, MemoryAddress> {
    public override val layout: MemoryLayout = ValueLayout.ADDRESS

    public override fun fromNative(segment: MemoryAddress):
        WebUIBarcodeScannerPreviewActivatedEventArgs {
      val address = segment.toRawLongValue()
      return WebUIBarcodeScannerPreviewActivatedEventArgs(Pointer(address))
    }

    public override fun toNative(obj: WebUIBarcodeScannerPreviewActivatedEventArgs): MemoryAddress =
