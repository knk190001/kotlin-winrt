...
import Windows.ApplicationModel.Activation.IUserDataAccountProviderActivatedEventArgs
...
@ABIMarker(WebUIUserDataAccountProviderActivatedEventArgs.ABI::class)
@Signature("rc(Windows.UI.WebUI.WebUIUserDataAccountProviderActivatedEventArgs;{1bc9f723-8ef1-4a51-a63a-fe711eeab607})")
@WinRTByReference(brClass = WebUIUserDataAccountProviderActivatedEventArgs.ByReference::class)
public class WebUIUserDataAccountProviderActivatedEventArgs(
  ptr: JNAPointer? = NULL
  ...
  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1944704806_Interface, __1721660047_Interface, __1254540095_Interface)
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<WebUIUserDataAccountProviderActivatedEventArgs> {
    public override fun getValue() =
        WebUIUserDataAccountProviderActivatedEventArgs(pointer.getPointer(0))

    public fun setValue(value: WebUIUserDataAccountProviderActivatedEventArgs): Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  public object ABI : IABI<WebUIUserDataAccountProviderActivatedEventArgs, MemoryAddress> {
    public override val layout: MemoryLayout = ValueLayout.ADDRESS

    public override fun fromNative(segment: MemoryAddress):
        WebUIUserDataAccountProviderActivatedEventArgs {
      val address = segment.toRawLongValue()
      return WebUIUserDataAccountProviderActivatedEventArgs(Pointer(address))
    }

    public override fun toNative(obj: WebUIUserDataAccountProviderActivatedEventArgs): MemoryAddress
