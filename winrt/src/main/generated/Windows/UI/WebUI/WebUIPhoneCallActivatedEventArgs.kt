...
import Windows.ApplicationModel.Activation.IPhoneCallActivatedEventArgs
...
@ABIMarker(WebUIPhoneCallActivatedEventArgs.ABI::class)
@Signature("rc(Windows.UI.WebUI.WebUIPhoneCallActivatedEventArgs;{54615221-a3c1-4ced-b62f-8c60523619ad})")
@WinRTByReference(brClass = WebUIPhoneCallActivatedEventArgs.ByReference::class)
public class WebUIPhoneCallActivatedEventArgs(
  ptr: JNAPointer? = NULL
) : PointerType(ptr), IPhoneCallActivatedEventArgs.WithDefault, IActivatedEventArgs.WithDefault,
    IActivatedEventArgsWithUser.WithDefault, IActivatedEventArgsDeferral.WithDefault, IWinRTObject {
  private val __1025316137_Interface: IPhoneCallActivatedEventArgs.WithDefault by lazy {
    as_1025316137()
  }
  ...
  public override val __1025316137_Ptr: JNAPointer? by lazy {
    __1025316137_Interface.__1025316137_Ptr
  }
  ...
  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1025316137_Interface, __1721660047_Interface, __988512_Interface,
        __1254540095_Interface)

  private fun as_1025316137(): IPhoneCallActivatedEventArgs.WithDefault {
    if(pointer == NULL) {
      return(IPhoneCallActivatedEventArgs.ABI.makeIPhoneCallActivatedEventArgs(NULL))
    }
    val refiid = Guid.REFIID(guidOf<IPhoneCallActivatedEventArgs>())
    val ref = PointerByReference()
    IUnknownVtbl(pointer.getPointer(0)).queryInterface(pointer, refiid, ref)
    return(IPhoneCallActivatedEventArgs.ABI.makeIPhoneCallActivatedEventArgs(ref.value))
  }
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<WebUIPhoneCallActivatedEventArgs> {
    public override fun getValue() = WebUIPhoneCallActivatedEventArgs(pointer.getPointer(0))

    public fun setValue(value: WebUIPhoneCallActivatedEventArgs): Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  public object ABI : IABI<WebUIPhoneCallActivatedEventArgs, MemoryAddress> {
    public override val layout: MemoryLayout = ValueLayout.ADDRESS

    public override fun fromNative(segment: MemoryAddress): WebUIPhoneCallActivatedEventArgs {
      val address = segment.toRawLongValue()
      return WebUIPhoneCallActivatedEventArgs(Pointer(address))
    }

    public override fun toNative(obj: WebUIPhoneCallActivatedEventArgs): MemoryAddress =
