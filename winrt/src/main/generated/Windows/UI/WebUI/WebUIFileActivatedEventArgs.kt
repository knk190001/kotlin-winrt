...
import Windows.ApplicationModel.Activation.IFileActivatedEventArgs
import Windows.ApplicationModel.Activation.IFileActivatedEventArgsWithNeighboringFiles
...
@ABIMarker(WebUIFileActivatedEventArgs.ABI::class)
@Signature("rc(Windows.UI.WebUI.WebUIFileActivatedEventArgs;{bb2afc33-93b1-42ed-8b26-236dd9c78496})")
@WinRTByReference(brClass = WebUIFileActivatedEventArgs.ByReference::class)
public class WebUIFileActivatedEventArgs(
  ptr: JNAPointer? = NULL
  ...
  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__136556715_Interface, __1721660047_Interface, __1142708526_Interface,
        __1254540095_Interface, __93781288_Interface, __988512_Interface)
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<WebUIFileActivatedEventArgs> {
    public override fun getValue() = WebUIFileActivatedEventArgs(pointer.getPointer(0))

    public fun setValue(value: WebUIFileActivatedEventArgs): Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  public object ABI : IABI<WebUIFileActivatedEventArgs, MemoryAddress> {
    public override val layout: MemoryLayout = ValueLayout.ADDRESS

    public override fun fromNative(segment: MemoryAddress): WebUIFileActivatedEventArgs {
      val address = segment.toRawLongValue()
      return WebUIFileActivatedEventArgs(Pointer(address))
    }

    public override fun toNative(obj: WebUIFileActivatedEventArgs): MemoryAddress =
