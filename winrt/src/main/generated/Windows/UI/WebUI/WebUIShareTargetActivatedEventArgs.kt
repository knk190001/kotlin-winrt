...
import Windows.ApplicationModel.Activation.IShareTargetActivatedEventArgs
...
@ABIMarker(WebUIShareTargetActivatedEventArgs.ABI::class)
@Signature("rc(Windows.UI.WebUI.WebUIShareTargetActivatedEventArgs;{4bdaf9c8-cdb2-4acb-bfc3-6648563378ec})")
@WinRTByReference(brClass = WebUIShareTargetActivatedEventArgs.ByReference::class)
public class WebUIShareTargetActivatedEventArgs(
  ptr: JNAPointer? = NULL
  ...
  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__2028286003_Interface, __1721660047_Interface, __1254540095_Interface,
        __988512_Interface)
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<WebUIShareTargetActivatedEventArgs> {
    public override fun getValue() = WebUIShareTargetActivatedEventArgs(pointer.getPointer(0))

    public fun setValue(value: WebUIShareTargetActivatedEventArgs): Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  public object ABI : IABI<WebUIShareTargetActivatedEventArgs, MemoryAddress> {
    public override val layout: MemoryLayout = ValueLayout.ADDRESS

    public override fun fromNative(segment: MemoryAddress): WebUIShareTargetActivatedEventArgs {
      val address = segment.toRawLongValue()
      return WebUIShareTargetActivatedEventArgs(Pointer(address))
    }

    public override fun toNative(obj: WebUIShareTargetActivatedEventArgs): MemoryAddress =
