...
import Windows.ApplicationModel.Activation.IFolderPickerContinuationEventArgs
...
@ABIMarker(WebUIFolderPickerContinuationEventArgs.ABI::class)
@Signature("rc(Windows.UI.WebUI.WebUIFolderPickerContinuationEventArgs;{51882366-9f4b-498f-beb0-42684f6e1c29})")
@WinRTByReference(brClass = WebUIFolderPickerContinuationEventArgs.ByReference::class)
public class WebUIFolderPickerContinuationEventArgs(
  ptr: JNAPointer? = NULL
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<WebUIFolderPickerContinuationEventArgs> {
    public override fun getValue() = WebUIFolderPickerContinuationEventArgs(pointer.getPointer(0))

    public fun setValue(value: WebUIFolderPickerContinuationEventArgs): Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  public object ABI : IABI<WebUIFolderPickerContinuationEventArgs, MemoryAddress> {
    public override val layout: MemoryLayout = ValueLayout.ADDRESS

    public override fun fromNative(segment: MemoryAddress): WebUIFolderPickerContinuationEventArgs {
      val address = segment.toRawLongValue()
      return WebUIFolderPickerContinuationEventArgs(Pointer(address))
    }

    public override fun toNative(obj: WebUIFolderPickerContinuationEventArgs): MemoryAddress =
