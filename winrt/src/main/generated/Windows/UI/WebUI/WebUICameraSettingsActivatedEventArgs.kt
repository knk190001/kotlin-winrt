...
import Windows.ApplicationModel.Activation.ICameraSettingsActivatedEventArgs
...
@ABIMarker(WebUICameraSettingsActivatedEventArgs.ABI::class)
@Signature("rc(Windows.UI.WebUI.WebUICameraSettingsActivatedEventArgs;{fb67a508-2dad-490a-9170-dca036eb114b})")
@WinRTByReference(brClass = WebUICameraSettingsActivatedEventArgs.ByReference::class)
public class WebUICameraSettingsActivatedEventArgs(
  ptr: JNAPointer? = NULL
  ...
  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1249263447_Interface, __1721660047_Interface, __1254540095_Interface)
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<WebUICameraSettingsActivatedEventArgs> {
    public override fun getValue() = WebUICameraSettingsActivatedEventArgs(pointer.getPointer(0))

    public fun setValue(value: WebUICameraSettingsActivatedEventArgs): Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  public object ABI : IABI<WebUICameraSettingsActivatedEventArgs, MemoryAddress> {
    public override val layout: MemoryLayout = ValueLayout.ADDRESS

    public override fun fromNative(segment: MemoryAddress): WebUICameraSettingsActivatedEventArgs {
      val address = segment.toRawLongValue()
      return WebUICameraSettingsActivatedEventArgs(Pointer(address))
    }

    public override fun toNative(obj: WebUICameraSettingsActivatedEventArgs): MemoryAddress =
