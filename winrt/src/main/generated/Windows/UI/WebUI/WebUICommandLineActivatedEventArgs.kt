...
import Windows.ApplicationModel.Activation.ICommandLineActivatedEventArgs
...
@ABIMarker(WebUICommandLineActivatedEventArgs.ABI::class)
@Signature("rc(Windows.UI.WebUI.WebUICommandLineActivatedEventArgs;{4506472c-006a-48eb-8afb-d07ab25e3366})")
@WinRTByReference(brClass = WebUICommandLineActivatedEventArgs.ByReference::class)
public class WebUICommandLineActivatedEventArgs(
  ptr: JNAPointer? = NULL
) : PointerType(ptr), ICommandLineActivatedEventArgs.WithDefault, IActivatedEventArgs.WithDefault,
    IActivatedEventArgsWithUser.WithDefault, IActivatedEventArgsDeferral.WithDefault, IWinRTObject {
  private val __848624228_Interface: ICommandLineActivatedEventArgs.WithDefault by lazy {
    as_848624228()
  }
  ...
  public override val __848624228_Ptr: JNAPointer? by lazy {
    __848624228_Interface.__848624228_Ptr
  }
  ...
  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__848624228_Interface, __1721660047_Interface, __988512_Interface,
        __1254540095_Interface)

  private fun as_848624228(): ICommandLineActivatedEventArgs.WithDefault {
    if(pointer == NULL) {
      return(ICommandLineActivatedEventArgs.ABI.makeICommandLineActivatedEventArgs(NULL))
    }
    val refiid = Guid.REFIID(guidOf<ICommandLineActivatedEventArgs>())
    val ref = PointerByReference()
    IUnknownVtbl(pointer.getPointer(0)).queryInterface(pointer, refiid, ref)
    return(ICommandLineActivatedEventArgs.ABI.makeICommandLineActivatedEventArgs(ref.value))
  }
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<WebUICommandLineActivatedEventArgs> {
    public override fun getValue() = WebUICommandLineActivatedEventArgs(pointer.getPointer(0))

    public fun setValue(value: WebUICommandLineActivatedEventArgs): Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  public object ABI : IABI<WebUICommandLineActivatedEventArgs, MemoryAddress> {
    public override val layout: MemoryLayout = ValueLayout.ADDRESS

    public override fun fromNative(segment: MemoryAddress): WebUICommandLineActivatedEventArgs {
      val address = segment.toRawLongValue()
      return WebUICommandLineActivatedEventArgs(Pointer(address))
    }

    public override fun toNative(obj: WebUICommandLineActivatedEventArgs): MemoryAddress =
