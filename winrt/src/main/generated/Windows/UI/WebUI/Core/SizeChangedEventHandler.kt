...
public fun interface SizeChangedEventHandlerBody {
  public operator fun invoke(eventArgs: WebUICommandBarSizeChangedEventArgs?): Unit
}

@ABIMarker(SizeChangedEventHandler.ABI::class)
@Signature("delegate({d49cfe3c-dd2e-4c28-b627-303a7f911af5})")
@WinRTByReference(brClass = SizeChangedEventHandler.ByReference::class)
public class SizeChangedEventHandler(
  ptr: Pointer? = Pointer.NULL
) : Delegate(ptr) {
  public fun invoke(eventArgs: WebUICommandBarSizeChangedEventArgs?): Unit {
    val function = Function.getFunction(delegateStruct.fn!!)
    val hr = function.invokeHR(arrayOf(this.pointer,eventArgs))
    checkHR(hr)
  }
  ...
  public companion object {
    ...
    public fun nativeFn(
      ...
      try {
        val eventArgs_Managed = WebUICommandBarSizeChangedEventArgs.ABI.fromNative(eventArgs) as
            WebUICommandBarSizeChangedEventArgs
        fn(eventArgs_Managed)
      } catch (e: Throwable) {
        e.printStackTrace()
        return WinNT.E_FAIL
      }
  ...
  public fun interface Native : StdCallLibrary.StdCallCallback {
    public fun invoke(thisPtr: Pointer, eventArgs: WebUICommandBarSizeChangedEventArgs?):
        WinNT.HRESULT
  }
  ...
  public object ABI : IABI<SizeChangedEventHandler, MemoryAddress> {
    public val IID: Guid.IID = Guid.IID("d49cfe3cdd2e4c28b627303a7f911af5")
