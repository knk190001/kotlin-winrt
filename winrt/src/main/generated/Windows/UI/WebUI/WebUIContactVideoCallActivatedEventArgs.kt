...
import Windows.ApplicationModel.Activation.IContactVideoCallActivatedEventArgs
...
@ABIMarker(WebUIContactVideoCallActivatedEventArgs.ABI::class)
@Signature("rc(Windows.UI.WebUI.WebUIContactVideoCallActivatedEventArgs;{61079db8-e3e7-4b4f-858d-5c63a96ef684})")
@WinRTByReference(brClass = WebUIContactVideoCallActivatedEventArgs.ByReference::class)
public class WebUIContactVideoCallActivatedEventArgs(
  ptr: JNAPointer? = NULL
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<WebUIContactVideoCallActivatedEventArgs> {
    public override fun getValue() = WebUIContactVideoCallActivatedEventArgs(pointer.getPointer(0))

    public fun setValue(value: WebUIContactVideoCallActivatedEventArgs): Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  public object ABI : IABI<WebUIContactVideoCallActivatedEventArgs, MemoryAddress> {
    public override val layout: MemoryLayout = ValueLayout.ADDRESS

    public override fun fromNative(segment: MemoryAddress):
        WebUIContactVideoCallActivatedEventArgs {
      val address = segment.toRawLongValue()
      return WebUIContactVideoCallActivatedEventArgs(Pointer(address))
    }

    public override fun toNative(obj: WebUIContactVideoCallActivatedEventArgs): MemoryAddress =
