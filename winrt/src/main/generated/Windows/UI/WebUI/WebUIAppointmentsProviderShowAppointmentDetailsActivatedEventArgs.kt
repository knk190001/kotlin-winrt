...
import Windows.ApplicationModel.Activation.IAppointmentsProviderShowAppointmentDetailsActivatedEventArgs
...
@ABIMarker(WebUIAppointmentsProviderShowAppointmentDetailsActivatedEventArgs.ABI::class)
@Signature("rc(Windows.UI.WebUI.WebUIAppointmentsProviderShowAppointmentDetailsActivatedEventArgs;{3958f065-9841-4ca5-999b-885198b9ef2a})")
@WinRTByReference(brClass =
    WebUIAppointmentsProviderShowAppointmentDetailsActivatedEventArgs.ByReference::class)
public class WebUIAppointmentsProviderShowAppointmentDetailsActivatedEventArgs(
  ptr: JNAPointer? = NULL
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<WebUIAppointmentsProviderShowAppointmentDetailsActivatedEventArgs> {
    public override fun getValue() =
        WebUIAppointmentsProviderShowAppointmentDetailsActivatedEventArgs(pointer.getPointer(0))

    public fun setValue(value: WebUIAppointmentsProviderShowAppointmentDetailsActivatedEventArgs):
        Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  public object ABI : IABI<WebUIAppointmentsProviderShowAppointmentDetailsActivatedEventArgs,
      MemoryAddress> {
    ...
    public override fun fromNative(segment: MemoryAddress):
      ...
      return WebUIAppointmentsProviderShowAppointmentDetailsActivatedEventArgs(Pointer(address))
    }

    public override
        fun toNative(obj: WebUIAppointmentsProviderShowAppointmentDetailsActivatedEventArgs):
