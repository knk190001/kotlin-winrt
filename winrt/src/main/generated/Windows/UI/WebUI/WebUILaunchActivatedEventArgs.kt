...
import Windows.ApplicationModel.Activation.ILaunchActivatedEventArgs2
import Windows.ApplicationModel.Activation.IPrelaunchActivatedEventArgs
...
@ABIMarker(WebUILaunchActivatedEventArgs.ABI::class)
@Signature("rc(Windows.UI.WebUI.WebUILaunchActivatedEventArgs;{fbc93e26-a14a-4b4f-82b0-33bed920af52})")
@WinRTByReference(brClass = WebUILaunchActivatedEventArgs.ByReference::class)
public class WebUILaunchActivatedEventArgs(
  ptr: JNAPointer? = NULL
) : PointerType(ptr), ILaunchActivatedEventArgs.WithDefault, IActivatedEventArgs.WithDefault,
    IPrelaunchActivatedEventArgs.WithDefault, IApplicationViewActivatedEventArgs.WithDefault,
    IActivatedEventArgsDeferral.WithDefault, IActivatedEventArgsWithUser.WithDefault,
    ILaunchActivatedEventArgs2.WithDefault, IWinRTObject {
  ...
  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__183308062_Interface, __1721660047_Interface, __1820939821_Interface,
        __1142708526_Interface, __1254540095_Interface, __988512_Interface, __1387582576_Interface)
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<WebUILaunchActivatedEventArgs> {
    public override fun getValue() = WebUILaunchActivatedEventArgs(pointer.getPointer(0))

    public fun setValue(value: WebUILaunchActivatedEventArgs): Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  public object ABI : IABI<WebUILaunchActivatedEventArgs, MemoryAddress> {
    public override val layout: MemoryLayout = ValueLayout.ADDRESS

    public override fun fromNative(segment: MemoryAddress): WebUILaunchActivatedEventArgs {
      val address = segment.toRawLongValue()
      return WebUILaunchActivatedEventArgs(Pointer(address))
    }

    public override fun toNative(obj: WebUILaunchActivatedEventArgs): MemoryAddress =
