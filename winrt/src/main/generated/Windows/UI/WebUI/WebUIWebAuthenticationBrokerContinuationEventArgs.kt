...
import Windows.ApplicationModel.Activation.IWebAuthenticationBrokerContinuationEventArgs
...
@ABIMarker(WebUIWebAuthenticationBrokerContinuationEventArgs.ABI::class)
@Signature("rc(Windows.UI.WebUI.WebUIWebAuthenticationBrokerContinuationEventArgs;{75dda3d4-7714-453d-b7ff-b95e3a1709da})")
@WinRTByReference(brClass = WebUIWebAuthenticationBrokerContinuationEventArgs.ByReference::class)
public class WebUIWebAuthenticationBrokerContinuationEventArgs(
  ptr: JNAPointer? = NULL
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<WebUIWebAuthenticationBrokerContinuationEventArgs> {
    public override fun getValue() =
        WebUIWebAuthenticationBrokerContinuationEventArgs(pointer.getPointer(0))

    public fun setValue(value: WebUIWebAuthenticationBrokerContinuationEventArgs): Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  public object ABI : IABI<WebUIWebAuthenticationBrokerContinuationEventArgs, MemoryAddress> {
    public override val layout: MemoryLayout = ValueLayout.ADDRESS

    public override fun fromNative(segment: MemoryAddress):
        WebUIWebAuthenticationBrokerContinuationEventArgs {
      val address = segment.toRawLongValue()
      return WebUIWebAuthenticationBrokerContinuationEventArgs(Pointer(address))
    }

    public override fun toNative(obj: WebUIWebAuthenticationBrokerContinuationEventArgs):
