...
@ABIMarker(ApplicationDataCompositeValue.ABI::class)
@Signature("rc(Windows.Storage.ApplicationDataCompositeValue;{8a43ed9f-f4e6-4421-acf9-1dab2986820c})")
@WinRTByReference(brClass = ApplicationDataCompositeValue.ByReference::class)
public class ApplicationDataCompositeValue(
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<ApplicationDataCompositeValue> {
    public override fun getValue() = ApplicationDataCompositeValue(pointer.getPointer(0))

    public fun setValue(value: ApplicationDataCompositeValue): Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  public object ABI : IABI<ApplicationDataCompositeValue, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Windows.Storage.ApplicationDataCompositeValue".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public override fun fromNative(segment: MemoryAddress): ApplicationDataCompositeValue {
      val address = segment.toRawLongValue()
      return ApplicationDataCompositeValue(Pointer(address))
    }

    public override fun toNative(obj: ApplicationDataCompositeValue): MemoryAddress =
