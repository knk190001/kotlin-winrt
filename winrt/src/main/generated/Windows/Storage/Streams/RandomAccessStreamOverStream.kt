...
@ABIMarker(RandomAccessStreamOverStream.ABI::class)
@Signature("rc(Windows.Storage.Streams.RandomAccessStreamOverStream;{905a0fe1-bc53-11df-8c49-001e4fc686da})")
@WinRTByReference(brClass = RandomAccessStreamOverStream.ByReference::class)
public class RandomAccessStreamOverStream(
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<RandomAccessStreamOverStream> {
    public override fun getValue() = RandomAccessStreamOverStream(pointer.getPointer(0))

    public fun setValue(value: RandomAccessStreamOverStream): Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  public object ABI : IABI<RandomAccessStreamOverStream, MemoryAddress> {
    public override val layout: MemoryLayout = ValueLayout.ADDRESS

    public override fun fromNative(segment: MemoryAddress): RandomAccessStreamOverStream {
      val address = segment.toRawLongValue()
      return RandomAccessStreamOverStream(Pointer(address))
    }

    public override fun toNative(obj: RandomAccessStreamOverStream): MemoryAddress =
