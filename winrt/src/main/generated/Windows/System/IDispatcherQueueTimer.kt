...
@Signature("{5feabb1d-a31c-4727-b1ac-37454649d56a}")
@Guid("5feabb1da31c4727b1ac37454649d56a")
@WinRTInterface("5feabb1da31c4727b1ac37454649d56a")
...
public interface IDispatcherQueueTimer : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IDispatcherQueueTimer {
    public val __746640214_Ptr: Pointer?

    public val _746640214_VtblPtr: Pointer?
      get() = __746640214_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Interval(): TimeSpan? {
      val fnPtr = _746640214_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<TimeSpan>()
      val hr = fn.invokeHR(arrayOf(__746640214_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Interval(value: TimeSpan?): Unit {
      val fnPtr = _746640214_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__746640214_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_IsRunning(): Boolean {
      val fnPtr = _746640214_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_IsRepeating(): Boolean {
      val fnPtr = _746640214_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__746640214_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_IsRepeating(value: Boolean): Unit {
      val fnPtr = _746640214_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__746640214_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun Start(): Unit {
      val fnPtr = _746640214_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__746640214_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun Stop(): Unit {
      val fnPtr = _746640214_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__746640214_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun add_Tick(handler: TypedEventHandler<DispatcherQueueTimer?, IUnknown?>?):
        EventRegistrationToken? {
      val fnPtr = _746640214_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__746640214_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun remove_Tick(token: EventRegistrationToken?): Unit {
      val fnPtr = _746640214_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__746640214_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IDispatcherQueueTimer_Impl(
    ...
    public override val __746640214_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IDispatcherQueueTimer, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("5feabb1da31c4727b1ac37454649d56a")
    ...
    public override fun toNative(obj: IDispatcherQueueTimer): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__746640214_Ptr))
  }
