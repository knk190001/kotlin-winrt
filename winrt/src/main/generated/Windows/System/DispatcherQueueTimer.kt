...
@Signature("rc(Windows.System.DispatcherQueueTimer;{5feabb1d-a31c-4727-b1ac-37454649d56a})")
...
public class DispatcherQueueTimer(
  ...
  private val __746640214_Interface: IDispatcherQueueTimer.WithDefault by lazy {
    as_746640214()
  }


  public override val __746640214_Ptr: JNAPointer? by lazy {
    __746640214_Interface.__746640214_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__746640214_Interface)

  private fun as_746640214(): IDispatcherQueueTimer.WithDefault {
    if(pointer == NULL) {
