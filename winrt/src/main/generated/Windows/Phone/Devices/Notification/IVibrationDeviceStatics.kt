...
@Signature("{332fd2f1-1c69-4c91-949e-4bb67a85bdc7}")
@Guid("332fd2f11c694c91949e4bb67a85bdc7")
@WinRTInterface("332fd2f11c694c91949e4bb67a85bdc7")
...
public interface IVibrationDeviceStatics : NativeMapped, IWinRTInterface {
  @InterfaceMethod(0)
  public fun GetDefault(): VibrationDevice?
  ...
  public interface WithDefault : IVibrationDeviceStatics {
    public val __1910959423_Ptr: Pointer?

    public val _1910959423_VtblPtr: Pointer?
      get() = __1910959423_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun GetDefault(): VibrationDevice? {
      val fnPtr = _1910959423_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<VibrationDevice>()
      val hr = fn.invokeHR(arrayOf(__1910959423_Ptr,  result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
      val resultValue = marshalFromNative<VibrationDevice>(result.getValue())
      return resultValue
    }
  }
  ...
  public class IVibrationDeviceStatics_Impl(
    ...
    public override val __1910959423_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IVibrationDeviceStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("332fd2f11c694c91949e4bb67a85bdc7")
    ...
    public override fun toNative(obj: IVibrationDeviceStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1910959423_Ptr))
  }
