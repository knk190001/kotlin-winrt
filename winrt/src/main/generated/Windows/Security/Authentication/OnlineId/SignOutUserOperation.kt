...
@ABIMarker(SignOutUserOperation.ABI::class)
@Signature("rc(Windows.Security.Authentication.OnlineId.SignOutUserOperation;{5a648006-843a-4da9-865b-9d26e5dfad7b})")
@WinRTByReference(brClass = SignOutUserOperation.ByReference::class)
public class SignOutUserOperation(
  ptr: JNAPointer? = NULL
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<SignOutUserOperation> {
    public override fun getValue() = SignOutUserOperation(pointer.getPointer(0))

    public fun setValue(value: SignOutUserOperation): Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  public object ABI : IABI<SignOutUserOperation, MemoryAddress> {
    public override val layout: MemoryLayout = ValueLayout.ADDRESS

    public override fun fromNative(segment: MemoryAddress): SignOutUserOperation {
      val address = segment.toRawLongValue()
      return SignOutUserOperation(Pointer(address))
    }

    public override fun toNative(obj: SignOutUserOperation): MemoryAddress =
