...
@ABIMarker(PasswordCredentialPropertyStore.ABI::class)
@Signature("rc(Windows.Security.Credentials.PasswordCredentialPropertyStore;{8a43ed9f-f4e6-4421-acf9-1dab2986820c})")
@WinRTByReference(brClass = PasswordCredentialPropertyStore.ByReference::class)
public class PasswordCredentialPropertyStore(
  ptr: JNAPointer? = NULL
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<PasswordCredentialPropertyStore> {
    public override fun getValue() = PasswordCredentialPropertyStore(pointer.getPointer(0))

    public fun setValue(value: PasswordCredentialPropertyStore): Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  public object ABI : IABI<PasswordCredentialPropertyStore, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Windows.Security.Credentials.PasswordCredentialPropertyStore".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public override fun fromNative(segment: MemoryAddress): PasswordCredentialPropertyStore {
      val address = segment.toRawLongValue()
      return PasswordCredentialPropertyStore(Pointer(address))
    }

    public override fun toNative(obj: PasswordCredentialPropertyStore): MemoryAddress =
