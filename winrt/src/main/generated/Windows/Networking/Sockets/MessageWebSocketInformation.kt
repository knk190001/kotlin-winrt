...
@ABIMarker(MessageWebSocketInformation.ABI::class)
@Signature("rc(Windows.Networking.Sockets.MessageWebSocketInformation;{5e01e316-c92a-47a5-b25f-07847639d181})")
@WinRTByReference(brClass = MessageWebSocketInformation.ByReference::class)
public class MessageWebSocketInformation(
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<MessageWebSocketInformation> {
    public override fun getValue() = MessageWebSocketInformation(pointer.getPointer(0))

    public fun setValue(value: MessageWebSocketInformation): Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  public object ABI : IABI<MessageWebSocketInformation, MemoryAddress> {
    public override val layout: MemoryLayout = ValueLayout.ADDRESS

    public override fun fromNative(segment: MemoryAddress): MessageWebSocketInformation {
      val address = segment.toRawLongValue()
      return MessageWebSocketInformation(Pointer(address))
    }

    public override fun toNative(obj: MessageWebSocketInformation): MemoryAddress =
