...
@ABIMarker(ImageStream.ABI::class)
@Signature("rc(Windows.Graphics.Imaging.ImageStream;{cc254827-4b3d-438f-9232-10c76bc7e038})")
@WinRTByReference(brClass = ImageStream.ByReference::class)
public class ImageStream(
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE), IByReference<ImageStream> {
    public override fun getValue() = ImageStream(pointer.getPointer(0))

    public fun setValue(value: ImageStream): Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  public object ABI : IABI<ImageStream, MemoryAddress> {
    public override val layout: MemoryLayout = ValueLayout.ADDRESS

    public override fun fromNative(segment: MemoryAddress): ImageStream {
      val address = segment.toRawLongValue()
      return ImageStream(Pointer(address))
    }

    public override fun toNative(obj: ImageStream): MemoryAddress =
