...
@ABIMarker(PercentFormatter.ABI::class)
@Signature("rc(Windows.Globalization.NumberFormatting.PercentFormatter;{80332d21-aee1-4a39-baa2-07ed8c96daf6})")
@WinRTByReference(brClass = PercentFormatter.ByReference::class)
public class PercentFormatter(
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<PercentFormatter> {
    public override fun getValue() = PercentFormatter(pointer.getPointer(0))

    public fun setValue(value: PercentFormatter): Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  public object ABI : IABI<PercentFormatter, MemoryAddress> {
    public val activationFactory: IActivationFactory by lazy {
      createActivationFactory()
    }


    public val IPercentFormatterFactory_Instance: IPercentFormatterFactory by lazy {
      createIPercentFormatterFactory()
    }
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Windows.Globalization.NumberFormatting.PercentFormatter".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIPercentFormatterFactory(): IPercentFormatterFactory {
      val refiid = Guid.REFIID(IPercentFormatterFactory.ABI.IID)
      val factoryActivatorPtr = PointerByReference()
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.Globalization.NumberFormatting.PercentFormatter".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
      return(IPercentFormatterFactory.ABI.makeIPercentFormatterFactory(factoryActivatorPtr.value))
    }

    public fun activate(languages: IIterable<String?>, geographicRegion: String): JNAPointer? =
        IPercentFormatterFactory_Instance.CreatePercentFormatter(languages,
        geographicRegion)?.pointer

    public override fun fromNative(segment: MemoryAddress): PercentFormatter {
      val address = segment.toRawLongValue()
      return PercentFormatter(Pointer(address))
    }

    public override fun toNative(obj: PercentFormatter): MemoryAddress =
