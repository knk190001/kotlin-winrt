...
@ABIMarker(PermilleFormatter.ABI::class)
@Signature("rc(Windows.Globalization.NumberFormatting.PermilleFormatter;{80332d21-aee1-4a39-baa2-07ed8c96daf6})")
@WinRTByReference(brClass = PermilleFormatter.ByReference::class)
public class PermilleFormatter(
  ptr: JNAPointer? = NULL
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<PermilleFormatter> {
    public override fun getValue() = PermilleFormatter(pointer.getPointer(0))

    public fun setValue(value: PermilleFormatter): Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  public object ABI : IABI<PermilleFormatter, MemoryAddress> {
    public val activationFactory: IActivationFactory by lazy {
      createActivationFactory()
    }


    public val IPermilleFormatterFactory_Instance: IPermilleFormatterFactory by lazy {
      createIPermilleFormatterFactory()
    }
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Windows.Globalization.NumberFormatting.PermilleFormatter".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIPermilleFormatterFactory(): IPermilleFormatterFactory {
      val refiid = Guid.REFIID(IPermilleFormatterFactory.ABI.IID)
      val factoryActivatorPtr = PointerByReference()
      val hr =
          INSTANCE.RoGetActivationFactory("Windows.Globalization.NumberFormatting.PermilleFormatter".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
      return(IPermilleFormatterFactory.ABI.makeIPermilleFormatterFactory(factoryActivatorPtr.value))
    }

    public fun activate(languages: IIterable<String?>, geographicRegion: String): JNAPointer? =
        IPermilleFormatterFactory_Instance.CreatePermilleFormatter(languages,
        geographicRegion)?.pointer

    public override fun fromNative(segment: MemoryAddress): PermilleFormatter {
      val address = segment.toRawLongValue()
      return PermilleFormatter(Pointer(address))
    }

    public override fun toNative(obj: PermilleFormatter): MemoryAddress =
