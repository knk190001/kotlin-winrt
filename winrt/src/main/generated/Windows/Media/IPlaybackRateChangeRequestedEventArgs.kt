...
@Signature("{2ce2c41f-3cd6-4f77-9ba7-eb27c26a2140}")
@Guid("2ce2c41f3cd64f779ba7eb27c26a2140")
@WinRTInterface("2ce2c41f3cd64f779ba7eb27c26a2140")
...
public interface IPlaybackRateChangeRequestedEventArgs : NativeMapped, IWinRTInterface {
  @InterfaceMethod(0)
  public fun get_RequestedPlaybackRate(): Double
  ...
  public interface WithDefault : IPlaybackRateChangeRequestedEventArgs {
    public val __934727068_Ptr: Pointer?

    public val _934727068_VtblPtr: Pointer?
      get() = __934727068_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_RequestedPlaybackRate(): Double {
      val fnPtr = _934727068_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__934727068_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IPlaybackRateChangeRequestedEventArgs_Impl(
    ...
    public override val __934727068_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPlaybackRateChangeRequestedEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("2ce2c41f3cd64f779ba7eb27c26a2140")
    ...
    public override fun toNative(obj: IPlaybackRateChangeRequestedEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__934727068_Ptr))
  }
