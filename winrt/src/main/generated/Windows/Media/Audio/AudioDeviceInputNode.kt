...
@ABIMarker(AudioDeviceInputNode.ABI::class)
@Signature("rc(Windows.Media.Audio.AudioDeviceInputNode;{b01b6be1-6f4e-49e2-ac01-559d62beb3a9})")
@WinRTByReference(brClass = AudioDeviceInputNode.ByReference::class)
public class AudioDeviceInputNode(
  ptr: JNAPointer? = NULL
) : PointerType(ptr), IAudioDeviceInputNode.WithDefault, IAudioInputNode.WithDefault,
    IAudioNode.WithDefault, IClosable.WithDefault, IAudioInputNode2.WithDefault, IWinRTObject {
  private val __646315256_Interface: IAudioDeviceInputNode.WithDefault by lazy {
    as_646315256()
  }
  ...
  public override val __646315256_Ptr: JNAPointer? by lazy {
    __646315256_Interface.__646315256_Ptr
  }
  ...
  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__646315256_Interface, __801834558_Interface, __1950949744_Interface,
        __1260617006_Interface, __912932428_Interface)

  private fun as_646315256(): IAudioDeviceInputNode.WithDefault {
    if(pointer == NULL) {
      return(IAudioDeviceInputNode.ABI.makeIAudioDeviceInputNode(NULL))
    }
    val refiid = Guid.REFIID(guidOf<IAudioDeviceInputNode>())
    val ref = PointerByReference()
    IUnknownVtbl(pointer.getPointer(0)).queryInterface(pointer, refiid, ref)
    return(IAudioDeviceInputNode.ABI.makeIAudioDeviceInputNode(ref.value))
  }
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<AudioDeviceInputNode> {
    public override fun getValue() = AudioDeviceInputNode(pointer.getPointer(0))

    public fun setValue(value: AudioDeviceInputNode): Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  public object ABI : IABI<AudioDeviceInputNode, MemoryAddress> {
    public override val layout: MemoryLayout = ValueLayout.ADDRESS

    public override fun fromNative(segment: MemoryAddress): AudioDeviceInputNode {
      val address = segment.toRawLongValue()
      return AudioDeviceInputNode(Pointer(address))
    }

    public override fun toNative(obj: AudioDeviceInputNode): MemoryAddress =
