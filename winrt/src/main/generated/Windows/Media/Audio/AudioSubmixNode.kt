...
@ABIMarker(AudioSubmixNode.ABI::class)
@Signature("rc(Windows.Media.Audio.AudioSubmixNode;{d148005c-8428-4784-b7fd-a99d468c5d20})")
@WinRTByReference(brClass = AudioSubmixNode.ByReference::class)
public class AudioSubmixNode(
  ptr: JNAPointer? = NULL
) : PointerType(ptr), IAudioInputNode.WithDefault, IAudioNode.WithDefault, IClosable.WithDefault,
    IAudioInputNode2.WithDefault, IWinRTObject {
  ...
  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__801834558_Interface, __1950949744_Interface, __1260617006_Interface,
        __912932428_Interface)
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<AudioSubmixNode> {
    public override fun getValue() = AudioSubmixNode(pointer.getPointer(0))

    public fun setValue(value: AudioSubmixNode): Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  public object ABI : IABI<AudioSubmixNode, MemoryAddress> {
    public override val layout: MemoryLayout = ValueLayout.ADDRESS

    public override fun fromNative(segment: MemoryAddress): AudioSubmixNode {
      val address = segment.toRawLongValue()
      return AudioSubmixNode(Pointer(address))
    }

    public override fun toNative(obj: AudioSubmixNode): MemoryAddress =
