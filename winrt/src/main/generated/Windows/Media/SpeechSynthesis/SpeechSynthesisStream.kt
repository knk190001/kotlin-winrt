...
import Windows.Media.Core.ITimedMetadataTrackProvider
...
@ABIMarker(SpeechSynthesisStream.ABI::class)
@Signature("rc(Windows.Media.SpeechSynthesis.SpeechSynthesisStream;{83e46e93-244c-4622-ba0b-6229c4d0d65d})")
@WinRTByReference(brClass = SpeechSynthesisStream.ByReference::class)
public class SpeechSynthesisStream(
  ptr: JNAPointer? = NULL
) : PointerType(ptr), ISpeechSynthesisStream.WithDefault,
    IRandomAccessStreamWithContentType.WithDefault, IContentTypeProvider.WithDefault,
    IRandomAccessStream.WithDefault, IOutputStream.WithDefault, IClosable.WithDefault,
    IInputStream.WithDefault, ITimedMetadataTrackProvider.WithDefault, IWinRTObject {
  private val __700225626_Interface: ISpeechSynthesisStream.WithDefault by lazy {
    as_700225626()
  }
  ...
  private val __1025802507_Interface: ITimedMetadataTrackProvider.WithDefault by lazy {
    as_1025802507()
  }


  public override val __700225626_Ptr: JNAPointer? by lazy {
    __700225626_Interface.__700225626_Ptr
  }
  ...
  public override val __1025802507_Ptr: JNAPointer? by lazy {
    __1025802507_Interface.__1025802507_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__700225626_Interface, __380663666_Interface, __412040816_Interface,
        __597747131_Interface, __591248843_Interface, __1260617006_Interface, __736491754_Interface,
        __1025802507_Interface)

  private fun as_700225626(): ISpeechSynthesisStream.WithDefault {
    if(pointer == NULL) {
      return(ISpeechSynthesisStream.ABI.makeISpeechSynthesisStream(NULL))
    }
    val refiid = Guid.REFIID(guidOf<ISpeechSynthesisStream>())
    val ref = PointerByReference()
    IUnknownVtbl(pointer.getPointer(0)).queryInterface(pointer, refiid, ref)
    return(ISpeechSynthesisStream.ABI.makeISpeechSynthesisStream(ref.value))
  }
  ...
  private fun as_1025802507(): ITimedMetadataTrackProvider.WithDefault {
    if(pointer == NULL) {
      return(ITimedMetadataTrackProvider.ABI.makeITimedMetadataTrackProvider(NULL))
    }
    val refiid = Guid.REFIID(guidOf<ITimedMetadataTrackProvider>())
    val ref = PointerByReference()
    IUnknownVtbl(pointer.getPointer(0)).queryInterface(pointer, refiid, ref)
    return(ITimedMetadataTrackProvider.ABI.makeITimedMetadataTrackProvider(ref.value))
  }

  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<SpeechSynthesisStream> {
    public override fun getValue() = SpeechSynthesisStream(pointer.getPointer(0))

    public fun setValue(value: SpeechSynthesisStream): Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  public object ABI : IABI<SpeechSynthesisStream, MemoryAddress> {
    public override val layout: MemoryLayout = ValueLayout.ADDRESS

    public override fun fromNative(segment: MemoryAddress): SpeechSynthesisStream {
      val address = segment.toRawLongValue()
      return SpeechSynthesisStream(Pointer(address))
    }

    public override fun toNative(obj: SpeechSynthesisStream): MemoryAddress =
