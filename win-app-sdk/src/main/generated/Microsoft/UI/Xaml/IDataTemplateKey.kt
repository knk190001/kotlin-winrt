...
@Signature("{6e704a95-4b2f-5ba8-ada5-1261c832baed}")
@Guid("6e704a954b2f5ba8ada51261c832baed")
@WinRTInterface("6e704a954b2f5ba8ada51261c832baed")
...
public interface IDataTemplateKey : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IDataTemplateKey {
    public val __244599380_Ptr: Pointer?

    public val _244599380_VtblPtr: Pointer?
      get() = __244599380_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_DataType(): IUnknown? {
      val fnPtr = _244599380_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IUnknown>()
      val hr = fn.invokeHR(arrayOf(__244599380_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_DataType(value: IUnknown?): Unit {
      val fnPtr = _244599380_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__244599380_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IDataTemplateKey_Impl(
    ...
    public override val __244599380_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IDataTemplateKey, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("6e704a954b2f5ba8ada51261c832baed")
    ...
    public override fun toNative(obj: IDataTemplateKey): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__244599380_Ptr))
  }
