...
@Signature("rc(Microsoft.UI.Xaml.DragUI;{35f170e0-93bf-58da-877a-8ec77d8d9f00})")
@WinRTByReference(brClass = DragUI.ByReference::class)
public class DragUI(
  ptr: JNAPointer? = NULL
) : PointerType(ptr), IDragUI.WithDefault, IWinRTObject {
  private val __276029903_Interface: IDragUI.WithDefault by lazy {
    as_276029903()
  }


  public override val __276029903_Ptr: JNAPointer? by lazy {
    __276029903_Interface.__276029903_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__276029903_Interface)

  private fun as_276029903(): IDragUI.WithDefault {
    if(pointer == NULL) {
