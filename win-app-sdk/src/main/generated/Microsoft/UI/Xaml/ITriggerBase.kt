...
@Signature("{d37da89d-0d71-58cf-a901-99a7d3e5e434}")
@Guid("d37da89d0d7158cfa90199a7d3e5e434")
@WinRTInterface("d37da89d0d7158cfa90199a7d3e5e434")
...
public interface ITriggerBase : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITriggerBase {
    public val __1910004226_Ptr: Pointer?

    public val _1910004226_VtblPtr: Pointer?
      get() = __1910004226_Ptr?.getPointer(0)
  }

  public class ITriggerBase_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __1910004226_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITriggerBase, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("d37da89d0d7158cfa90199a7d3e5e434")
    ...
    public override fun toNative(obj: ITriggerBase): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1910004226_Ptr))
  }
