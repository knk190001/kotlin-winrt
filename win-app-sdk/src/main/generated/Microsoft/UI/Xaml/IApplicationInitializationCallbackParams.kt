...
@Signature("{1b1906ea-5b7b-5876-81ab-7c2281ac3d20}")
@Guid("1b1906ea5b7b587681ab7c2281ac3d20")
@WinRTInterface("1b1906ea5b7b587681ab7c2281ac3d20")
...
public interface IApplicationInitializationCallbackParams : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IApplicationInitializationCallbackParams {
    public val __1114096180_Ptr: Pointer?

    public val _1114096180_VtblPtr: Pointer?
      get() = __1114096180_Ptr?.getPointer(0)
  }

  public class IApplicationInitializationCallbackParams_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __1114096180_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IApplicationInitializationCallbackParams, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("1b1906ea5b7b587681ab7c2281ac3d20")
    ...
    public override fun toNative(obj: IApplicationInitializationCallbackParams): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1114096180_Ptr))
  }
