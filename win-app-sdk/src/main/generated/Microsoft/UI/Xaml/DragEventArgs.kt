...
@Signature("rc(Microsoft.UI.Xaml.DragEventArgs;{47ac5757-e4bc-52ba-8ab9-1bf81aad7900})")
@WinRTByReference(brClass = DragEventArgs.ByReference::class)
public class DragEventArgs(
  ptr: JNAPointer? = NULL
) : RoutedEventArgs(ptr), IDragEventArgs.WithDefault, IWinRTObject {
  private val __1626694948_Interface: IDragEventArgs.WithDefault by lazy {
    as_1626694948()
  }


  public override val __1626694948_Ptr: JNAPointer? by lazy {
    __1626694948_Interface.__1626694948_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1626694948_Interface)

  private fun as_1626694948(): IDragEventArgs.WithDefault {
    if(pointer == NULL) {
