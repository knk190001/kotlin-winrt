...
public fun interface EnteredBackgroundEventHandlerBody {
  public operator fun invoke(sender: IUnknown?, e: EnteredBackgroundEventArgs?): Unit
}

@ABIMarker(EnteredBackgroundEventHandler.ABI::class)
@Signature("delegate({f9a5148d-8f72-553f-b479-21b68610899d})")
@WinRTByReference(brClass = EnteredBackgroundEventHandler.ByReference::class)
public class EnteredBackgroundEventHandler(
  ptr: Pointer? = Pointer.NULL
) : Delegate(ptr) {
  public fun invoke(sender: IUnknown?, e: EnteredBackgroundEventArgs?): Unit {
  ...
  public companion object {
    ...
    public fun nativeFn(
      ...
      try {
        ...
        val e_Managed = EnteredBackgroundEventArgs.ABI.fromNative(e) as EnteredBackgroundEventArgs
  ...
  public object ABI : IABI<EnteredBackgroundEventHandler, MemoryAddress> {
    public val IID: Guid.IID = Guid.IID("f9a5148d8f72553fb47921b68610899d")
