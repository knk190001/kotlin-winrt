...
@Signature("{5a5a20c3-1c9b-5d61-9d63-487c8bf16ecb}")
@Guid("5a5a20c31c9b5d619d63487c8bf16ecb")
@WinRTInterface("5a5a20c31c9b5d619d63487c8bf16ecb")
...
public interface IElementSoundPlayerStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IElementSoundPlayerStatics {
    public val __660532874_Ptr: Pointer?

    public val _660532874_VtblPtr: Pointer?
      get() = __660532874_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Volume(): Double {
      val fnPtr = _660532874_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__660532874_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Volume(value: Double): Unit {
      val fnPtr = _660532874_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__660532874_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_State(): ElementSoundPlayerState? {
      val fnPtr = _660532874_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_State(value: ElementSoundPlayerState?): Unit {
      val fnPtr = _660532874_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__660532874_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_SpatialAudioMode(): ElementSpatialAudioMode? {
      val fnPtr = _660532874_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_SpatialAudioMode(value: ElementSpatialAudioMode?): Unit {
      val fnPtr = _660532874_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__660532874_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun Play(sound: ElementSoundKind?): Unit {
      val fnPtr = _660532874_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__660532874_Ptr, marshalToNative(sound),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IElementSoundPlayerStatics_Impl(
    ...
    public override val __660532874_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IElementSoundPlayerStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("5a5a20c31c9b5d619d63487c8bf16ecb")
    ...
    public override fun toNative(obj: IElementSoundPlayerStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__660532874_Ptr))
  }
