...
@Signature("{8dfd691b-710c-5d6d-b71a-7a7f5ed54ac7}")
@Guid("8dfd691b710c5d6db71a7a7f5ed54ac7")
@WinRTInterface("8dfd691b710c5d6db71a7a7f5ed54ac7")
...
public interface IVisualStateGroup : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IVisualStateGroup {
    public val __2104552939_Ptr: Pointer?

    public val _2104552939_VtblPtr: Pointer?
      get() = __2104552939_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Name(): String? {
      val fnPtr = _2104552939_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__2104552939_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Transitions(): IVector<VisualTransition?>? {
      val fnPtr = _2104552939_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_States(): IVector<VisualState?>? {
      val fnPtr = _2104552939_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_CurrentState(): VisualState? {
      val fnPtr = _2104552939_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun add_CurrentStateChanged(handler: VisualStateChangedEventHandler?):
        EventRegistrationToken? {
      val fnPtr = _2104552939_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__2104552939_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun remove_CurrentStateChanged(token: EventRegistrationToken?): Unit {
      val fnPtr = _2104552939_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2104552939_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun add_CurrentStateChanging(handler: VisualStateChangedEventHandler?):
        EventRegistrationToken? {
      val fnPtr = _2104552939_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__2104552939_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
    ...
    public override fun remove_CurrentStateChanging(token: EventRegistrationToken?): Unit {
      val fnPtr = _2104552939_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2104552939_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IVisualStateGroup_Impl(
    ...
    public override val __2104552939_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IVisualStateGroup, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("8dfd691b710c5d6db71a7a7f5ed54ac7")
    ...
    public override fun toNative(obj: IVisualStateGroup): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2104552939_Ptr))
  }
