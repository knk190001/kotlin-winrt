...
@Signature("rc(Microsoft.UI.Xaml.CornerRadiusHelper;{dfcc382d-cfa8-5614-a35a-4091d1a81c9e})")
...
public class CornerRadiusHelper(
  ...
  private val __421857700_Interface: ICornerRadiusHelper.WithDefault by lazy {
    as_421857700()
  }


  public override val __421857700_Ptr: JNAPointer? by lazy {
    __421857700_Interface.__421857700_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__421857700_Interface)

  private fun as_421857700(): ICornerRadiusHelper.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<CornerRadiusHelper, MemoryAddress> {
    ...
    public fun createICornerRadiusHelperStatics(): ICornerRadiusHelperStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.CornerRadiusHelper".toHandle(),refiid,interfacePtr)
