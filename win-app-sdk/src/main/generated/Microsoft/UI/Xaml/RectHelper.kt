...
@Signature("rc(Microsoft.UI.Xaml.RectHelper;{5fece92a-a3d2-5bc0-aca1-e9e1fa86ae9d})")
@WinRTByReference(brClass = RectHelper.ByReference::class)
public class RectHelper(
  ptr: JNAPointer? = NULL
) : PointerType(ptr), IRectHelper.WithDefault, IWinRTObject {
  private val __1284286009_Interface: IRectHelper.WithDefault by lazy {
    as_1284286009()
  }


  public override val __1284286009_Ptr: JNAPointer? by lazy {
    __1284286009_Interface.__1284286009_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1284286009_Interface)

  private fun as_1284286009(): IRectHelper.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<RectHelper, MemoryAddress> {
    ...
    public fun createIRectHelperStatics(): IRectHelperStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.RectHelper".toHandle(),refiid,interfacePtr)
