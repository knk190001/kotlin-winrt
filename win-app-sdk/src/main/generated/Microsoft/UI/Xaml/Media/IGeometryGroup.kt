...
@Signature("{b4dde569-ea96-5883-914c-ebb7d818dd3a}")
@Guid("b4dde569ea965883914cebb7d818dd3a")
@WinRTInterface("b4dde569ea965883914cebb7d818dd3a")
...
public interface IGeometryGroup : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IGeometryGroup {
    public val __2081942372_Ptr: Pointer?

    public val _2081942372_VtblPtr: Pointer?
      get() = __2081942372_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_FillRule(): FillRule? {
      val fnPtr = _2081942372_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<FillRule>()
      val hr = fn.invokeHR(arrayOf(__2081942372_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_FillRule(value: FillRule?): Unit {
      val fnPtr = _2081942372_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2081942372_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Children(): GeometryCollection? {
      val fnPtr = _2081942372_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Children(value: GeometryCollection?): Unit {
      val fnPtr = _2081942372_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2081942372_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IGeometryGroup_Impl(
    ...
    public override val __2081942372_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IGeometryGroup, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("b4dde569ea965883914cebb7d818dd3a")
    ...
    public override fun toNative(obj: IGeometryGroup): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2081942372_Ptr))
  }
