...
@Signature("{76e66278-7804-5439-a50d-14c5ba896714}")
@Guid("76e6627878045439a50d14c5ba896714")
@WinRTInterface("76e6627878045439a50d14c5ba896714")
...
public interface ISvgImageSourceFailedEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISvgImageSourceFailedEventArgs {
    public val __1691411297_Ptr: Pointer?

    public val _1691411297_VtblPtr: Pointer?
      get() = __1691411297_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Status(): SvgImageSourceLoadStatus? {
      val fnPtr = _1691411297_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<SvgImageSourceLoadStatus>()
      val hr = fn.invokeHR(arrayOf(__1691411297_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ISvgImageSourceFailedEventArgs_Impl(
    ...
    public override val __1691411297_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISvgImageSourceFailedEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("76e6627878045439a50d14c5ba896714")
    ...
    public override fun toNative(obj: ISvgImageSourceFailedEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1691411297_Ptr))
  }
