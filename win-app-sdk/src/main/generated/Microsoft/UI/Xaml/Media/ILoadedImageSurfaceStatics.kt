...
@Signature("{25d390c4-4e32-52c2-868f-f2ede74ee442}")
@Guid("25d390c44e3252c2868ff2ede74ee442")
@WinRTInterface("25d390c44e3252c2868ff2ede74ee442")
...
public interface ILoadedImageSurfaceStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ILoadedImageSurfaceStatics {
    public val __1180651203_Ptr: Pointer?

    public val _1180651203_VtblPtr: Pointer?
      get() = __1180651203_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun StartLoadFromUri(uri: Uri?, desiredMaxSize: Size?): LoadedImageSurface? {
      val fnPtr = _1180651203_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<LoadedImageSurface>()
      val hr = fn.invokeHR(arrayOf(__1180651203_Ptr, marshalToNative(uri),
    ...
    public override fun StartLoadFromUri(uri: Uri?): LoadedImageSurface? {
      val fnPtr = _1180651203_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<LoadedImageSurface>()
      val hr = fn.invokeHR(arrayOf(__1180651203_Ptr, marshalToNative(uri), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
      val resultValue = marshalFromNative<LoadedImageSurface>(result.getValue())
    ...
    public override fun StartLoadFromStream(stream: IRandomAccessStream?, desiredMaxSize: Size?):
        LoadedImageSurface? {
      val fnPtr = _1180651203_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<LoadedImageSurface>()
      val hr = fn.invokeHR(arrayOf(__1180651203_Ptr, marshalToNative(stream),
          marshalToNative(desiredMaxSize), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun StartLoadFromStream(stream: IRandomAccessStream?): LoadedImageSurface? {
      val fnPtr = _1180651203_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<LoadedImageSurface>()
      val hr = fn.invokeHR(arrayOf(__1180651203_Ptr, marshalToNative(stream), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
      val resultValue = marshalFromNative<LoadedImageSurface>(result.getValue())
  ...
  public class ILoadedImageSurfaceStatics_Impl(
    ...
    public override val __1180651203_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ILoadedImageSurfaceStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("25d390c44e3252c2868ff2ede74ee442")
    ...
    public override fun toNative(obj: ILoadedImageSurfaceStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1180651203_Ptr))
  }
