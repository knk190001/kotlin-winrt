...
@Signature("{5ba7ccb3-5bc7-5038-99c5-93dc730230cf}")
@Guid("5ba7ccb35bc7503899c593dc730230cf")
@WinRTInterface("5ba7ccb35bc7503899c593dc730230cf")
...
public interface IArcSegmentStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IArcSegmentStatics {
    public val __342304755_Ptr: Pointer?

    public val _342304755_VtblPtr: Pointer?
      get() = __342304755_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_PointProperty(): DependencyProperty? {
      val fnPtr = _342304755_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__342304755_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_SizeProperty(): DependencyProperty? {
      val fnPtr = _342304755_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__342304755_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_RotationAngleProperty(): DependencyProperty? {
      val fnPtr = _342304755_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__342304755_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsLargeArcProperty(): DependencyProperty? {
      val fnPtr = _342304755_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__342304755_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_SweepDirectionProperty(): DependencyProperty? {
      val fnPtr = _342304755_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__342304755_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IArcSegmentStatics_Impl(
    ...
    public override val __342304755_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IArcSegmentStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("5ba7ccb35bc7503899c593dc730230cf")
    ...
    public override fun toNative(obj: IArcSegmentStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__342304755_Ptr))
  }
