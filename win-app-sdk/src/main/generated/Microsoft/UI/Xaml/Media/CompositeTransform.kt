...
@Signature("rc(Microsoft.UI.Xaml.Media.CompositeTransform;{55c5f8f3-20e4-5b80-a046-ce4d0f62f2fe})")
...
public class CompositeTransform(
  ...
  private val __1187688086_Interface: ICompositeTransform.WithDefault by lazy {
    as_1187688086()
  }


  public override val __1187688086_Ptr: JNAPointer? by lazy {
    __1187688086_Interface.__1187688086_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1187688086_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1187688086(): ICompositeTransform.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<CompositeTransform, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.CompositeTransform".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createICompositeTransformStatics(): ICompositeTransformStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.CompositeTransform".toHandle(),refiid,interfacePtr)
