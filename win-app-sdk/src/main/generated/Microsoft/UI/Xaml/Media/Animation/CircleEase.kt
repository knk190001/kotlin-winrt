...
@Signature("rc(Microsoft.UI.Xaml.Media.Animation.CircleEase;{88209080-2929-5924-9b52-f95196568713})")
...
public class CircleEase(
  ...
  private val __665181465_Interface: ICircleEase.WithDefault by lazy {
    as_665181465()
  }


  public override val __665181465_Ptr: JNAPointer? by lazy {
    __665181465_Interface.__665181465_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__665181465_Interface)

  public constructor() : this(ABI.activate())

  private fun as_665181465(): ICircleEase.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<CircleEase, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.Animation.CircleEase".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
