...
@Signature("{c5a9f65b-fc69-5a88-a797-34f46d761381}")
@Guid("c5a9f65bfc695a88a79734f46d761381")
@WinRTInterface("c5a9f65bfc695a88a79734f46d761381")
...
public interface IObjectKeyFrame : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IObjectKeyFrame {
    public val __1525100904_Ptr: Pointer?

    public val _1525100904_VtblPtr: Pointer?
      get() = __1525100904_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Value(): IUnknown? {
      val fnPtr = _1525100904_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IUnknown>()
      val hr = fn.invokeHR(arrayOf(__1525100904_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Value(value: IUnknown?): Unit {
      val fnPtr = _1525100904_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1525100904_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_KeyTime(): KeyTime? {
      val fnPtr = _1525100904_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_KeyTime(value: KeyTime?): Unit {
      val fnPtr = _1525100904_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1525100904_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IObjectKeyFrame_Impl(
    ...
    public override val __1525100904_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IObjectKeyFrame, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("c5a9f65bfc695a88a79734f46d761381")
    ...
    public override fun toNative(obj: IObjectKeyFrame): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1525100904_Ptr))
  }
