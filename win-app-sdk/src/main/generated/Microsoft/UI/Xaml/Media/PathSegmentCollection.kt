...
@Signature("rc(Microsoft.UI.Xaml.Media.PathSegmentCollection;pinterface({913337e9-11a1-4345-a3a2-4e7f956e222d};rc(Microsoft.UI.Xaml.Media.PathSegment;{b922ebbe-08f0-57e9-8785-7e57097f3bd4})))")
...
public class PathSegmentCollection(
  ...
  public object ABI : IABI<PathSegmentCollection, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.PathSegmentCollection".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
