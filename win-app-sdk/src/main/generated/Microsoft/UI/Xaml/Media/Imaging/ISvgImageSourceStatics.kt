...
@Signature("{e3ad1068-f4c6-5513-a777-2980f0ba41bd}")
@Guid("e3ad1068f4c65513a7772980f0ba41bd")
@WinRTInterface("e3ad1068f4c65513a7772980f0ba41bd")
...
public interface ISvgImageSourceStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISvgImageSourceStatics {
    public val __121405260_Ptr: Pointer?

    public val _121405260_VtblPtr: Pointer?
      get() = __121405260_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_UriSourceProperty(): DependencyProperty? {
      val fnPtr = _121405260_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__121405260_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_RasterizePixelWidthProperty(): DependencyProperty? {
      val fnPtr = _121405260_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__121405260_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_RasterizePixelHeightProperty(): DependencyProperty? {
      val fnPtr = _121405260_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__121405260_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ISvgImageSourceStatics_Impl(
    ...
    public override val __121405260_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISvgImageSourceStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("e3ad1068f4c65513a7772980f0ba41bd")
    ...
    public override fun toNative(obj: ISvgImageSourceStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__121405260_Ptr))
  }
