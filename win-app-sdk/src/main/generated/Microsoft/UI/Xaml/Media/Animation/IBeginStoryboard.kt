...
@Signature("{bb364720-ee5a-5b32-91e2-62589729fd3a}")
@Guid("bb364720ee5a5b3291e262589729fd3a")
@WinRTInterface("bb364720ee5a5b3291e262589729fd3a")
...
public interface IBeginStoryboard : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IBeginStoryboard {
    public val __78600511_Ptr: Pointer?

    public val _78600511_VtblPtr: Pointer?
      get() = __78600511_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Storyboard(): Storyboard? {
      val fnPtr = _78600511_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Storyboard>()
      val hr = fn.invokeHR(arrayOf(__78600511_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Storyboard(value: Storyboard?): Unit {
      val fnPtr = _78600511_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__78600511_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IBeginStoryboard_Impl(
    ...
    public override val __78600511_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IBeginStoryboard, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("bb364720ee5a5b3291e262589729fd3a")
    ...
    public override fun toNative(obj: IBeginStoryboard): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__78600511_Ptr))
  }
