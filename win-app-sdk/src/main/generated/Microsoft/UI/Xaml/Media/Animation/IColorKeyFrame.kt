...
@Signature("{02848c7e-c772-5f66-842b-fd494d0da669}")
@Guid("02848c7ec7725f66842bfd494d0da669")
@WinRTInterface("02848c7ec7725f66842bfd494d0da669")
...
public interface IColorKeyFrame : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IColorKeyFrame {
    public val __1291820874_Ptr: Pointer?

    public val _1291820874_VtblPtr: Pointer?
      get() = __1291820874_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Value(): Color? {
      val fnPtr = _1291820874_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1291820874_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Value(value: Color?): Unit {
      val fnPtr = _1291820874_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1291820874_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_KeyTime(): KeyTime? {
      val fnPtr = _1291820874_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_KeyTime(value: KeyTime?): Unit {
      val fnPtr = _1291820874_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1291820874_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IColorKeyFrame_Impl(
    ...
    public override val __1291820874_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IColorKeyFrame, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("02848c7ec7725f66842bfd494d0da669")
    ...
    public override fun toNative(obj: IColorKeyFrame): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1291820874_Ptr))
  }
