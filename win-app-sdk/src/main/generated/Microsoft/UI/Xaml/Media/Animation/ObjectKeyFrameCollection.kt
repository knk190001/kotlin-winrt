...
@Signature("rc(Microsoft.UI.Xaml.Media.Animation.ObjectKeyFrameCollection;pinterface({913337e9-11a1-4345-a3a2-4e7f956e222d};rc(Microsoft.UI.Xaml.Media.Animation.ObjectKeyFrame;{c5a9f65b-fc69-5a88-a797-34f46d761381})))")
...
public class ObjectKeyFrameCollection(
  ...
  public object ABI : IABI<ObjectKeyFrameCollection, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.Animation.ObjectKeyFrameCollection".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
