...
@Signature("{cfa21ca9-b79f-5450-b459-a96c48cb2c8f}")
@Guid("cfa21ca9b79f5450b459a96c48cb2c8f")
@WinRTInterface("cfa21ca9b79f5450b459a96c48cb2c8f")
...
public interface ITranslateTransform : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITranslateTransform {
    public val __1002446929_Ptr: Pointer?

    public val _1002446929_VtblPtr: Pointer?
      get() = __1002446929_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_X(): Double {
      val fnPtr = _1002446929_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1002446929_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_X(value: Double): Unit {
      val fnPtr = _1002446929_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1002446929_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Y(): Double {
      val fnPtr = _1002446929_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1002446929_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Y(value: Double): Unit {
      val fnPtr = _1002446929_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1002446929_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class ITranslateTransform_Impl(
    ...
    public override val __1002446929_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITranslateTransform, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("cfa21ca9b79f5450b459a96c48cb2c8f")
    ...
    public override fun toNative(obj: ITranslateTransform): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1002446929_Ptr))
  }
