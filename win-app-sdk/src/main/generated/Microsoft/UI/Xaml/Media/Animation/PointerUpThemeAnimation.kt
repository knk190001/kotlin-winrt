...
@Signature("rc(Microsoft.UI.Xaml.Media.Animation.PointerUpThemeAnimation;{94896d1c-c938-5d68-84da-552bde815810})")
...
public class PointerUpThemeAnimation(
  ...
  private val __1975478472_Interface: IPointerUpThemeAnimation.WithDefault by lazy {
    as_1975478472()
  }


  public override val __1975478472_Ptr: JNAPointer? by lazy {
    __1975478472_Interface.__1975478472_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1975478472_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1975478472(): IPointerUpThemeAnimation.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<PointerUpThemeAnimation, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.Animation.PointerUpThemeAnimation".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIPointerUpThemeAnimationStatics(): IPointerUpThemeAnimationStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.Animation.PointerUpThemeAnimation".toHandle(),refiid,interfacePtr)
      val result =
