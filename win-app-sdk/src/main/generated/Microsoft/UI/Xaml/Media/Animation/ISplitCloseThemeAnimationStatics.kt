...
@Signature("{32345cdd-2a3c-5571-b2eb-2fcabc2e92c6}")
@Guid("32345cdd2a3c5571b2eb2fcabc2e92c6")
@WinRTInterface("32345cdd2a3c5571b2eb2fcabc2e92c6")
...
public interface ISplitCloseThemeAnimationStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISplitCloseThemeAnimationStatics {
    public val __99802671_Ptr: Pointer?

    public val _99802671_VtblPtr: Pointer?
      get() = __99802671_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_OpenedTargetNameProperty(): DependencyProperty? {
      val fnPtr = _99802671_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__99802671_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_OpenedTargetProperty(): DependencyProperty? {
      val fnPtr = _99802671_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__99802671_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ClosedTargetNameProperty(): DependencyProperty? {
      val fnPtr = _99802671_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__99802671_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ClosedTargetProperty(): DependencyProperty? {
      val fnPtr = _99802671_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__99802671_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ContentTargetNameProperty(): DependencyProperty? {
      val fnPtr = _99802671_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__99802671_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ContentTargetProperty(): DependencyProperty? {
      val fnPtr = _99802671_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__99802671_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_OpenedLengthProperty(): DependencyProperty? {
      val fnPtr = _99802671_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__99802671_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ClosedLengthProperty(): DependencyProperty? {
      val fnPtr = _99802671_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__99802671_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_OffsetFromCenterProperty(): DependencyProperty? {
      val fnPtr = _99802671_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__99802671_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ContentTranslationDirectionProperty(): DependencyProperty? {
      val fnPtr = _99802671_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__99802671_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ContentTranslationOffsetProperty(): DependencyProperty? {
      val fnPtr = _99802671_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__99802671_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ISplitCloseThemeAnimationStatics_Impl(
    ...
    public override val __99802671_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISplitCloseThemeAnimationStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("32345cdd2a3c5571b2eb2fcabc2e92c6")
    ...
    public override fun toNative(obj: ISplitCloseThemeAnimationStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__99802671_Ptr))
  }
