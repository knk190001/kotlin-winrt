...
@Signature("{80173353-611d-5a02-8864-1aaa279dff1c}")
@Guid("80173353611d5a0288641aaa279dff1c")
@WinRTInterface("80173353611d5a0288641aaa279dff1c")
...
public interface IAcrylicBrushFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IAcrylicBrushFactory {
    public val __1601839420_Ptr: Pointer?

    public val _1601839420_VtblPtr: Pointer?
      get() = __1601839420_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        AcrylicBrush? {
      val fnPtr = _1601839420_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AcrylicBrush>()
      val hr = fn.invokeHR(arrayOf(__1601839420_Ptr, marshalToNative(baseInterface),
  ...
  public class IAcrylicBrushFactory_Impl(
    ...
    public override val __1601839420_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IAcrylicBrushFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("80173353611d5a0288641aaa279dff1c")
    ...
    public override fun toNative(obj: IAcrylicBrushFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1601839420_Ptr))
  }
