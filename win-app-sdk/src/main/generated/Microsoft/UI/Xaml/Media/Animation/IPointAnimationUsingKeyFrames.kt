...
@Signature("{bdd63992-df13-5514-8611-4952f722f6d0}")
@Guid("bdd63992df13551486114952f722f6d0")
@WinRTInterface("bdd63992df13551486114952f722f6d0")
...
public interface IPointAnimationUsingKeyFrames : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPointAnimationUsingKeyFrames {
    public val __1924641744_Ptr: Pointer?

    public val _1924641744_VtblPtr: Pointer?
      get() = __1924641744_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_KeyFrames(): PointKeyFrameCollection? {
      val fnPtr = _1924641744_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<PointKeyFrameCollection>()
      val hr = fn.invokeHR(arrayOf(__1924641744_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_EnableDependentAnimation(): Boolean {
      val fnPtr = _1924641744_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_EnableDependentAnimation(value: Boolean): Unit {
      val fnPtr = _1924641744_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1924641744_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IPointAnimationUsingKeyFrames_Impl(
    ...
    public override val __1924641744_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPointAnimationUsingKeyFrames, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("bdd63992df13551486114952f722f6d0")
    ...
    public override fun toNative(obj: IPointAnimationUsingKeyFrames): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1924641744_Ptr))
  }
