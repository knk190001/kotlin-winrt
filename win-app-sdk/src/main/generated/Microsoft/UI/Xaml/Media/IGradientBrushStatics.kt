...
@Signature("{4d3697d7-c6db-501c-8fa2-da30b8c8ca3b}")
@Guid("4d3697d7c6db501c8fa2da30b8c8ca3b")
@WinRTInterface("4d3697d7c6db501c8fa2da30b8c8ca3b")
...
public interface IGradientBrushStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IGradientBrushStatics {
    public val __1212333012_Ptr: Pointer?

    public val _1212333012_VtblPtr: Pointer?
      get() = __1212333012_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_SpreadMethodProperty(): DependencyProperty? {
      val fnPtr = _1212333012_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1212333012_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_MappingModeProperty(): DependencyProperty? {
      val fnPtr = _1212333012_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1212333012_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ColorInterpolationModeProperty(): DependencyProperty? {
      val fnPtr = _1212333012_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1212333012_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_GradientStopsProperty(): DependencyProperty? {
      val fnPtr = _1212333012_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1212333012_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IGradientBrushStatics_Impl(
    ...
    public override val __1212333012_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IGradientBrushStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("4d3697d7c6db501c8fa2da30b8c8ca3b")
    ...
    public override fun toNative(obj: IGradientBrushStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1212333012_Ptr))
  }
