...
@Signature("{76da6306-96fc-553e-bb39-9a4801d06f48}")
@Guid("76da630696fc553ebb399a4801d06f48")
@WinRTInterface("76da630696fc553ebb399a4801d06f48")
...
public interface IXamlLightFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IXamlLightFactory {
    public val __1849789523_Ptr: Pointer?

    public val _1849789523_VtblPtr: Pointer?
      get() = __1849789523_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        XamlLight? {
      val fnPtr = _1849789523_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<XamlLight>()
      val hr = fn.invokeHR(arrayOf(__1849789523_Ptr, marshalToNative(baseInterface),
  ...
  public class IXamlLightFactory_Impl(
    ...
    public override val __1849789523_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IXamlLightFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("76da630696fc553ebb399a4801d06f48")
    ...
    public override fun toNative(obj: IXamlLightFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1849789523_Ptr))
  }
