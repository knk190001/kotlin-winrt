...
@Signature("{2ff1a1cb-0f48-53fd-b1de-e2223dfb2ff6}")
@Guid("2ff1a1cb0f4853fdb1dee2223dfb2ff6")
@WinRTInterface("2ff1a1cb0f4853fdb1dee2223dfb2ff6")
...
public interface ICacheMode : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICacheMode {
    public val __421430476_Ptr: Pointer?

    public val _421430476_VtblPtr: Pointer?
      get() = __421430476_Ptr?.getPointer(0)
  }

  public class ICacheMode_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __421430476_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICacheMode, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("2ff1a1cb0f4853fdb1dee2223dfb2ff6")
    ...
    public override fun toNative(obj: ICacheMode): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__421430476_Ptr))
  }
