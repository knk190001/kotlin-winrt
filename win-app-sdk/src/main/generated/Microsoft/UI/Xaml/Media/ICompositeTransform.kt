...
@Signature("{55c5f8f3-20e4-5b80-a046-ce4d0f62f2fe}")
@Guid("55c5f8f320e45b80a046ce4d0f62f2fe")
@WinRTInterface("55c5f8f320e45b80a046ce4d0f62f2fe")
...
public interface ICompositeTransform : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositeTransform {
    public val __1187688086_Ptr: Pointer?

    public val _1187688086_VtblPtr: Pointer?
      get() = __1187688086_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_CenterX(): Double {
      val fnPtr = _1187688086_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1187688086_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_CenterX(value: Double): Unit {
      val fnPtr = _1187688086_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1187688086_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_CenterY(): Double {
      val fnPtr = _1187688086_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1187688086_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_CenterY(value: Double): Unit {
      val fnPtr = _1187688086_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1187688086_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ScaleX(): Double {
      val fnPtr = _1187688086_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1187688086_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ScaleX(value: Double): Unit {
      val fnPtr = _1187688086_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1187688086_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ScaleY(): Double {
      val fnPtr = _1187688086_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1187688086_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ScaleY(value: Double): Unit {
      val fnPtr = _1187688086_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1187688086_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_SkewX(): Double {
      val fnPtr = _1187688086_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1187688086_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_SkewX(value: Double): Unit {
      val fnPtr = _1187688086_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1187688086_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_SkewY(): Double {
      val fnPtr = _1187688086_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1187688086_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_SkewY(value: Double): Unit {
      val fnPtr = _1187688086_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1187688086_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Rotation(): Double {
      val fnPtr = _1187688086_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1187688086_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Rotation(value: Double): Unit {
      val fnPtr = _1187688086_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1187688086_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_TranslateX(): Double {
      val fnPtr = _1187688086_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1187688086_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_TranslateX(value: Double): Unit {
      val fnPtr = _1187688086_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1187688086_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_TranslateY(): Double {
      val fnPtr = _1187688086_VtblPtr!!.getPointer(22L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1187688086_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_TranslateY(value: Double): Unit {
      val fnPtr = _1187688086_VtblPtr!!.getPointer(23L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1187688086_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class ICompositeTransform_Impl(
    ...
    public override val __1187688086_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositeTransform, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("55c5f8f320e45b80a046ce4d0f62f2fe")
    ...
    public override fun toNative(obj: ICompositeTransform): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1187688086_Ptr))
  }
