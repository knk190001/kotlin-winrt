...
@Signature("rc(Microsoft.UI.Xaml.Media.Animation.QuadraticEase;{db85fda1-03b7-57cd-a1ef-8855cbf62191})")
...
public class QuadraticEase(
  ...
  private val __194572021_Interface: IQuadraticEase.WithDefault by lazy {
    as_194572021()
  }


  public override val __194572021_Ptr: JNAPointer? by lazy {
    __194572021_Interface.__194572021_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__194572021_Interface)

  public constructor() : this(ABI.activate())

  private fun as_194572021(): IQuadraticEase.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<QuadraticEase, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.Animation.QuadraticEase".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
