...
@Signature("rc(Microsoft.UI.Xaml.Media.Animation.ExponentialEase;{4d289262-e832-5fbc-a98b-87a6ecb3b6cc})")
...
public class ExponentialEase(
  ...
  private val __484397944_Interface: IExponentialEase.WithDefault by lazy {
    as_484397944()
  }


  public override val __484397944_Ptr: JNAPointer? by lazy {
    __484397944_Interface.__484397944_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__484397944_Interface)

  public constructor() : this(ABI.activate())

  private fun as_484397944(): IExponentialEase.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<ExponentialEase, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.Animation.ExponentialEase".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIExponentialEaseStatics(): IExponentialEaseStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.Animation.ExponentialEase".toHandle(),refiid,interfacePtr)
