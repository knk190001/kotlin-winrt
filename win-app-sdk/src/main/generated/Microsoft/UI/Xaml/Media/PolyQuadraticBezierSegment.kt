...
@Signature("rc(Microsoft.UI.Xaml.Media.PolyQuadraticBezierSegment;{56372f4c-c531-5c3e-b0e0-1645f5a8d872})")
...
public class PolyQuadraticBezierSegment(
  ...
  private val __1058688263_Interface: IPolyQuadraticBezierSegment.WithDefault by lazy {
    as_1058688263()
  }


  public override val __1058688263_Ptr: JNAPointer? by lazy {
    __1058688263_Interface.__1058688263_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1058688263_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1058688263(): IPolyQuadraticBezierSegment.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<PolyQuadraticBezierSegment, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.PolyQuadraticBezierSegment".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIPolyQuadraticBezierSegmentStatics(): IPolyQuadraticBezierSegmentStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.PolyQuadraticBezierSegment".toHandle(),refiid,interfacePtr)
      val result =
