...
@Signature("{09a26ed2-11b3-5ef1-ac56-20d064ccca34}")
@Guid("09a26ed211b35ef1ac5620d064ccca34")
@WinRTInterface("09a26ed211b35ef1ac5620d064ccca34")
...
public interface ISurfaceImageSourceFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISurfaceImageSourceFactory {
    public val __662796826_Ptr: Pointer?

    public val _662796826_VtblPtr: Pointer?
      get() = __662796826_Ptr?.getPointer(0)
    ...
    public override fun CreateInstanceWithDimensions(
      ...
      val fnPtr = _662796826_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<SurfaceImageSource>()
      val hr = fn.invokeHR(arrayOf(__662796826_Ptr, pixelWidth, pixelHeight,
    ...
    public override fun CreateInstanceWithDimensionsAndOpacity(
      ...
      val fnPtr = _662796826_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<SurfaceImageSource>()
      val hr = fn.invokeHR(arrayOf(__662796826_Ptr, pixelWidth, pixelHeight, isOpaque,
          marshalToNative(baseInterface), marshalToNative(innerInterface), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
  ...
  public class ISurfaceImageSourceFactory_Impl(
    ...
    public override val __662796826_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISurfaceImageSourceFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("09a26ed211b35ef1ac5620d064ccca34")
    ...
    public override fun toNative(obj: ISurfaceImageSourceFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__662796826_Ptr))
  }
