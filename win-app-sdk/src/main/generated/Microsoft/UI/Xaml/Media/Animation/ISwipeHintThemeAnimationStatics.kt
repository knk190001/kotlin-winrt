...
@Signature("{f3308304-4f09-54d7-a4d5-ca558bbfe26f}")
@Guid("f33083044f0954d7a4d5ca558bbfe26f")
@WinRTInterface("f33083044f0954d7a4d5ca558bbfe26f")
...
public interface ISwipeHintThemeAnimationStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISwipeHintThemeAnimationStatics {
    public val __292650468_Ptr: Pointer?

    public val _292650468_VtblPtr: Pointer?
      get() = __292650468_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_TargetNameProperty(): DependencyProperty? {
      val fnPtr = _292650468_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__292650468_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ToHorizontalOffsetProperty(): DependencyProperty? {
      val fnPtr = _292650468_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__292650468_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ToVerticalOffsetProperty(): DependencyProperty? {
      val fnPtr = _292650468_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__292650468_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ISwipeHintThemeAnimationStatics_Impl(
    ...
    public override val __292650468_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISwipeHintThemeAnimationStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("f33083044f0954d7a4d5ca558bbfe26f")
    ...
    public override fun toNative(obj: ISwipeHintThemeAnimationStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__292650468_Ptr))
  }
