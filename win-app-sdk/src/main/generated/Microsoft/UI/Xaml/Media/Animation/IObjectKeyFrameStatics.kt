...
@Signature("{39e59ceb-2859-5a5f-acd8-bc491d49c4b6}")
@Guid("39e59ceb28595a5facd8bc491d49c4b6")
@WinRTInterface("39e59ceb28595a5facd8bc491d49c4b6")
...
public interface IObjectKeyFrameStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IObjectKeyFrameStatics {
    public val __577667389_Ptr: Pointer?

    public val _577667389_VtblPtr: Pointer?
      get() = __577667389_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ValueProperty(): DependencyProperty? {
      val fnPtr = _577667389_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__577667389_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_KeyTimeProperty(): DependencyProperty? {
      val fnPtr = _577667389_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__577667389_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IObjectKeyFrameStatics_Impl(
    ...
    public override val __577667389_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IObjectKeyFrameStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("39e59ceb28595a5facd8bc491d49c4b6")
    ...
    public override fun toNative(obj: IObjectKeyFrameStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__577667389_Ptr))
  }
