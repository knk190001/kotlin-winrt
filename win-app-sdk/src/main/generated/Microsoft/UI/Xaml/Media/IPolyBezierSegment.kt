...
@Signature("{d7f760a0-b93a-562a-8118-6330ed22c307}")
@Guid("d7f760a0b93a562a81186330ed22c307")
@WinRTInterface("d7f760a0b93a562a81186330ed22c307")
...
public interface IPolyBezierSegment : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPolyBezierSegment {
    public val __1867268823_Ptr: Pointer?

    public val _1867268823_VtblPtr: Pointer?
      get() = __1867268823_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Points(): PointCollection? {
      val fnPtr = _1867268823_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<PointCollection>()
      val hr = fn.invokeHR(arrayOf(__1867268823_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Points(value: PointCollection?): Unit {
      val fnPtr = _1867268823_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1867268823_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IPolyBezierSegment_Impl(
    ...
    public override val __1867268823_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPolyBezierSegment, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("d7f760a0b93a562a81186330ed22c307")
    ...
    public override fun toNative(obj: IPolyBezierSegment): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1867268823_Ptr))
  }
