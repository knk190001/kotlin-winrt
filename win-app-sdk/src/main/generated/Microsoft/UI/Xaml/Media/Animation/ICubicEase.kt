...
@Signature("{01a218b4-eb7e-54f9-bfb6-c6ee128013d2}")
@Guid("01a218b4eb7e54f9bfb6c6ee128013d2")
@WinRTInterface("01a218b4eb7e54f9bfb6c6ee128013d2")
...
public interface ICubicEase : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICubicEase {
    public val __999537987_Ptr: Pointer?

    public val _999537987_VtblPtr: Pointer?
      get() = __999537987_Ptr?.getPointer(0)
  }

  public class ICubicEase_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __999537987_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICubicEase, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("01a218b4eb7e54f9bfb6c6ee128013d2")
    ...
    public override fun toNative(obj: ICubicEase): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__999537987_Ptr))
  }
