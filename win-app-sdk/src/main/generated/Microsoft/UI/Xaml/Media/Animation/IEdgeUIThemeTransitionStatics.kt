...
@Signature("{316af8d4-d2a0-5d27-9af6-747797965d46}")
@Guid("316af8d4d2a05d279af6747797965d46")
@WinRTInterface("316af8d4d2a05d279af6747797965d46")
...
public interface IEdgeUIThemeTransitionStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IEdgeUIThemeTransitionStatics {
    public val __315935789_Ptr: Pointer?

    public val _315935789_VtblPtr: Pointer?
      get() = __315935789_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_EdgeProperty(): DependencyProperty? {
      val fnPtr = _315935789_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__315935789_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IEdgeUIThemeTransitionStatics_Impl(
    ...
    public override val __315935789_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IEdgeUIThemeTransitionStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("316af8d4d2a05d279af6747797965d46")
    ...
    public override fun toNative(obj: IEdgeUIThemeTransitionStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__315935789_Ptr))
  }
