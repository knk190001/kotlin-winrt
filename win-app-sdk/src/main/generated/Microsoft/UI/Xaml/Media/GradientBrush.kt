...
import Microsoft.UI.Xaml.Media.IGradientBrushFactory.ABI.IID
...
@Signature("rc(Microsoft.UI.Xaml.Media.GradientBrush;{77c347fa-c4c4-5174-a945-65cab3aa1c75})")
...
public open class GradientBrush(
  ...
  private val __1957737127_Interface: IGradientBrush.WithDefault by lazy {
    as_1957737127()
  }


  public override val __1957737127_Ptr: JNAPointer? by lazy {
    __1957737127_Interface.__1957737127_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1957737127_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1957737127(): IGradientBrush.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<GradientBrush, MemoryAddress> {
    ...
    public fun createIGradientBrushStatics(): IGradientBrushStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.GradientBrush".toHandle(),refiid,interfacePtr)
    ...
    public fun createIGradientBrushFactory(): IGradientBrushFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.GradientBrush".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
