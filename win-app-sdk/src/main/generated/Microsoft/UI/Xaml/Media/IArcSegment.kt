...
@Signature("{6b7ce02b-87be-5acb-9d3b-c9964c6962d0}")
@Guid("6b7ce02b87be5acb9d3bc9964c6962d0")
@WinRTInterface("6b7ce02b87be5acb9d3bc9964c6962d0")
...
public interface IArcSegment : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IArcSegment {
    public val __1882125454_Ptr: Pointer?

    public val _1882125454_VtblPtr: Pointer?
      get() = __1882125454_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Point(): Point? {
      val fnPtr = _1882125454_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Point>()
      val hr = fn.invokeHR(arrayOf(__1882125454_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Point(value: Point?): Unit {
      val fnPtr = _1882125454_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1882125454_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Size(): Size? {
      val fnPtr = _1882125454_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Size(value: Size?): Unit {
      val fnPtr = _1882125454_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1882125454_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_RotationAngle(): Double {
      val fnPtr = _1882125454_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_RotationAngle(value: Double): Unit {
      val fnPtr = _1882125454_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1882125454_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_IsLargeArc(): Boolean {
      val fnPtr = _1882125454_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_IsLargeArc(value: Boolean): Unit {
      val fnPtr = _1882125454_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1882125454_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_SweepDirection(): SweepDirection? {
      val fnPtr = _1882125454_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_SweepDirection(value: SweepDirection?): Unit {
      val fnPtr = _1882125454_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1882125454_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IArcSegment_Impl(
    ...
    public override val __1882125454_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IArcSegment, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("6b7ce02b87be5acb9d3bc9964c6962d0")
    ...
    public override fun toNative(obj: IArcSegment): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1882125454_Ptr))
  }
