...
@Signature("{d7cfbd3b-0d27-5ea1-beb7-f6b847520dc6}")
@Guid("d7cfbd3b0d275ea1beb7f6b847520dc6")
@WinRTInterface("d7cfbd3b0d275ea1beb7f6b847520dc6")
...
public interface INavigationThemeTransition : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : INavigationThemeTransition {
    public val __754224559_Ptr: Pointer?

    public val _754224559_VtblPtr: Pointer?
      get() = __754224559_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_DefaultNavigationTransitionInfo(): NavigationTransitionInfo? {
      val fnPtr = _754224559_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<NavigationTransitionInfo>()
      val hr = fn.invokeHR(arrayOf(__754224559_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_DefaultNavigationTransitionInfo(value: NavigationTransitionInfo?):
        Unit {
      val fnPtr = _754224559_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__754224559_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class INavigationThemeTransition_Impl(
    ...
    public override val __754224559_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<INavigationThemeTransition, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("d7cfbd3b0d275ea1beb7f6b847520dc6")
    ...
    public override fun toNative(obj: INavigationThemeTransition): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__754224559_Ptr))
  }
