...
@Signature("rc(Microsoft.UI.Xaml.Media.Animation.FadeOutThemeAnimation;{114024d6-5d67-5c9c-83c5-54a8bd7b671a})")
...
public class FadeOutThemeAnimation(
  ...
  private val __1683984270_Interface: IFadeOutThemeAnimation.WithDefault by lazy {
    as_1683984270()
  }


  public override val __1683984270_Ptr: JNAPointer? by lazy {
    __1683984270_Interface.__1683984270_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1683984270_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1683984270(): IFadeOutThemeAnimation.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<FadeOutThemeAnimation, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.Animation.FadeOutThemeAnimation".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIFadeOutThemeAnimationStatics(): IFadeOutThemeAnimationStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.Animation.FadeOutThemeAnimation".toHandle(),refiid,interfacePtr)
      val result =
