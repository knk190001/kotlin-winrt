...
@Signature("{c99e5435-facc-50af-b96c-63b14fe7156e}")
@Guid("c99e5435facc50afb96c63b14fe7156e")
@WinRTInterface("c99e5435facc50afb96c63b14fe7156e")
...
public interface IEntranceThemeTransitionStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IEntranceThemeTransitionStatics {
    public val __1336224520_Ptr: Pointer?

    public val _1336224520_VtblPtr: Pointer?
      get() = __1336224520_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_FromHorizontalOffsetProperty(): DependencyProperty? {
      val fnPtr = _1336224520_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1336224520_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_FromVerticalOffsetProperty(): DependencyProperty? {
      val fnPtr = _1336224520_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1336224520_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsStaggeringEnabledProperty(): DependencyProperty? {
      val fnPtr = _1336224520_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1336224520_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IEntranceThemeTransitionStatics_Impl(
    ...
    public override val __1336224520_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IEntranceThemeTransitionStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("c99e5435facc50afb96c63b14fe7156e")
    ...
    public override fun toNative(obj: IEntranceThemeTransitionStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1336224520_Ptr))
  }
