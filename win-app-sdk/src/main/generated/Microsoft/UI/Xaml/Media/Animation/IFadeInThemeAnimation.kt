...
@Signature("{0dca074a-31cc-5e70-8b6b-8dbd7fff01f6}")
@Guid("0dca074a31cc5e708b6b8dbd7fff01f6")
@WinRTInterface("0dca074a31cc5e708b6b8dbd7fff01f6")
...
public interface IFadeInThemeAnimation : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IFadeInThemeAnimation {
    public val __718647639_Ptr: Pointer?

    public val _718647639_VtblPtr: Pointer?
      get() = __718647639_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_TargetName(): String? {
      val fnPtr = _718647639_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__718647639_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_TargetName(value: String?): Unit {
      val fnPtr = _718647639_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__718647639_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IFadeInThemeAnimation_Impl(
    ...
    public override val __718647639_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IFadeInThemeAnimation, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("0dca074a31cc5e708b6b8dbd7fff01f6")
    ...
    public override fun toNative(obj: IFadeInThemeAnimation): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__718647639_Ptr))
  }
