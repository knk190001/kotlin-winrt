...
@Signature("rc(Microsoft.UI.Xaml.Media.Animation.EasingDoubleKeyFrame;{935d9b7e-da61-5bb2-a574-7d2e53b60561})")
...
public class EasingDoubleKeyFrame(
  ...
  private val __1069040069_Interface: IEasingDoubleKeyFrame.WithDefault by lazy {
    as_1069040069()
  }


  public override val __1069040069_Ptr: JNAPointer? by lazy {
    __1069040069_Interface.__1069040069_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1069040069_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1069040069(): IEasingDoubleKeyFrame.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<EasingDoubleKeyFrame, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.Animation.EasingDoubleKeyFrame".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIEasingDoubleKeyFrameStatics(): IEasingDoubleKeyFrameStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.Animation.EasingDoubleKeyFrame".toHandle(),refiid,interfacePtr)
      val result =
