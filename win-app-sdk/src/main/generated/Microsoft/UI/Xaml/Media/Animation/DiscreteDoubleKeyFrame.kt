...
@Signature("rc(Microsoft.UI.Xaml.Media.Animation.DiscreteDoubleKeyFrame;{ec16a555-c083-5a18-805b-a14b90bc80e2})")
...
public class DiscreteDoubleKeyFrame(
  ...
  private val __634169427_Interface: IDiscreteDoubleKeyFrame.WithDefault by lazy {
    as_634169427()
  }


  public override val __634169427_Ptr: JNAPointer? by lazy {
    __634169427_Interface.__634169427_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__634169427_Interface)

  public constructor() : this(ABI.activate())

  private fun as_634169427(): IDiscreteDoubleKeyFrame.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<DiscreteDoubleKeyFrame, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.Animation.DiscreteDoubleKeyFrame".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
