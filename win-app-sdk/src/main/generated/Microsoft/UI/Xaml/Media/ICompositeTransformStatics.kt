...
@Signature("{7701385b-8eab-5071-bfa5-b453e1e52b43}")
@Guid("7701385b8eab5071bfa5b453e1e52b43")
@WinRTInterface("7701385b8eab5071bfa5b453e1e52b43")
...
public interface ICompositeTransformStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositeTransformStatics {
    public val __1049261135_Ptr: Pointer?

    public val _1049261135_VtblPtr: Pointer?
      get() = __1049261135_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_CenterXProperty(): DependencyProperty? {
      val fnPtr = _1049261135_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1049261135_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_CenterYProperty(): DependencyProperty? {
      val fnPtr = _1049261135_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1049261135_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ScaleXProperty(): DependencyProperty? {
      val fnPtr = _1049261135_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1049261135_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ScaleYProperty(): DependencyProperty? {
      val fnPtr = _1049261135_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1049261135_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_SkewXProperty(): DependencyProperty? {
      val fnPtr = _1049261135_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1049261135_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_SkewYProperty(): DependencyProperty? {
      val fnPtr = _1049261135_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1049261135_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_RotationProperty(): DependencyProperty? {
      val fnPtr = _1049261135_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1049261135_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_TranslateXProperty(): DependencyProperty? {
      val fnPtr = _1049261135_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1049261135_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_TranslateYProperty(): DependencyProperty? {
      val fnPtr = _1049261135_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1049261135_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ICompositeTransformStatics_Impl(
    ...
    public override val __1049261135_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositeTransformStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("7701385b8eab5071bfa5b453e1e52b43")
    ...
    public override fun toNative(obj: ICompositeTransformStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1049261135_Ptr))
  }
