...
@Signature("{71cfb43b-bada-554b-8fca-b558d623bbc0}")
@Guid("71cfb43bbada554b8fcab558d623bbc0")
@WinRTInterface("71cfb43bbada554b8fcab558d623bbc0")
...
public interface IPointAnimationStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPointAnimationStatics {
    public val __2038061514_Ptr: Pointer?

    public val _2038061514_VtblPtr: Pointer?
      get() = __2038061514_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_FromProperty(): DependencyProperty? {
      val fnPtr = _2038061514_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__2038061514_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ToProperty(): DependencyProperty? {
      val fnPtr = _2038061514_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__2038061514_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ByProperty(): DependencyProperty? {
      val fnPtr = _2038061514_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__2038061514_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_EasingFunctionProperty(): DependencyProperty? {
      val fnPtr = _2038061514_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__2038061514_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_EnableDependentAnimationProperty(): DependencyProperty? {
      val fnPtr = _2038061514_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__2038061514_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IPointAnimationStatics_Impl(
    ...
    public override val __2038061514_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPointAnimationStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("71cfb43bbada554b8fcab558d623bbc0")
    ...
    public override fun toNative(obj: IPointAnimationStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2038061514_Ptr))
  }
