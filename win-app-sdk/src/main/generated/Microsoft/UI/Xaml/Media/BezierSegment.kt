...
@Signature("rc(Microsoft.UI.Xaml.Media.BezierSegment;{0f36bade-892e-51fe-b94a-3875e86feaae})")
@WinRTByReference(brClass = BezierSegment.ByReference::class)
public class BezierSegment(
  ptr: JNAPointer? = NULL
) : PathSegment(ptr), IBezierSegment.WithDefault, IWinRTObject {
  private val __402845379_Interface: IBezierSegment.WithDefault by lazy {
    as_402845379()
  }


  public override val __402845379_Ptr: JNAPointer? by lazy {
    __402845379_Interface.__402845379_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__402845379_Interface)

  public constructor() : this(ABI.activate())

  private fun as_402845379(): IBezierSegment.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<BezierSegment, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr = INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.BezierSegment".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIBezierSegmentStatics(): IBezierSegmentStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.BezierSegment".toHandle(),refiid,interfacePtr)
