...
@Signature("{09de03d7-4b8a-55e1-afad-5f60598733ea}")
@Guid("09de03d74b8a55e1afad5f60598733ea")
@WinRTInterface("09de03d74b8a55e1afad5f60598733ea")
...
public interface ISwipeHintThemeAnimation : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISwipeHintThemeAnimation {
    public val __1283976543_Ptr: Pointer?

    public val _1283976543_VtblPtr: Pointer?
      get() = __1283976543_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_TargetName(): String? {
      val fnPtr = _1283976543_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__1283976543_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_TargetName(value: String?): Unit {
      val fnPtr = _1283976543_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1283976543_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_ToHorizontalOffset(): Double {
      val fnPtr = _1283976543_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_ToHorizontalOffset(value: Double): Unit {
      val fnPtr = _1283976543_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1283976543_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_ToVerticalOffset(): Double {
      val fnPtr = _1283976543_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1283976543_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ToVerticalOffset(value: Double): Unit {
      val fnPtr = _1283976543_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1283976543_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class ISwipeHintThemeAnimation_Impl(
    ...
    public override val __1283976543_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISwipeHintThemeAnimation, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("09de03d74b8a55e1afad5f60598733ea")
    ...
    public override fun toNative(obj: ISwipeHintThemeAnimation): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1283976543_Ptr))
  }
