...
@Signature("{9a0ea80b-1a17-50d5-83f3-377738212619}")
@Guid("9a0ea80b1a1750d583f3377738212619")
@WinRTInterface("9a0ea80b1a1750d583f3377738212619")
...
public interface IDownloadProgressEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IDownloadProgressEventArgs {
    public val __520567045_Ptr: Pointer?

    public val _520567045_VtblPtr: Pointer?
      get() = __520567045_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Progress(): Int {
      val fnPtr = _520567045_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__520567045_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Progress(value: Int): Unit {
      val fnPtr = _520567045_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__520567045_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IDownloadProgressEventArgs_Impl(
    ...
    public override val __520567045_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IDownloadProgressEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("9a0ea80b1a1750d583f3377738212619")
    ...
    public override fun toNative(obj: IDownloadProgressEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__520567045_Ptr))
  }
