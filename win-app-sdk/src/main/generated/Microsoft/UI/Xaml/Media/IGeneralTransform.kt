...
@Signature("{04eedeeb-31e5-54c0-ae3f-8bd06645d339}")
@Guid("04eedeeb31e554c0ae3f8bd06645d339")
@WinRTInterface("04eedeeb31e554c0ae3f8bd06645d339")
...
public interface IGeneralTransform : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IGeneralTransform {
    public val __475759211_Ptr: Pointer?

    public val _475759211_VtblPtr: Pointer?
      get() = __475759211_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Inverse(): GeneralTransform? {
      val fnPtr = _475759211_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<GeneralTransform>()
      val hr = fn.invokeHR(arrayOf(__475759211_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun TransformPoint(point: Point?): Point? {
      val fnPtr = _475759211_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Point>()
      val hr = fn.invokeHR(arrayOf(__475759211_Ptr, marshalToNative(point), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun TryTransform(inPoint: Point?,
      ...
      val fnPtr = _475759211_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__475759211_Ptr, marshalToNative(inPoint),
    ...
    public override fun TransformBounds(rect: Rect?): Rect? {
      val fnPtr = _475759211_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Rect>()
      val hr = fn.invokeHR(arrayOf(__475759211_Ptr, marshalToNative(rect), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
  ...
  public class IGeneralTransform_Impl(
    ...
    public override val __475759211_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IGeneralTransform, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("04eedeeb31e554c0ae3f8bd06645d339")
    ...
    public override fun toNative(obj: IGeneralTransform): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__475759211_Ptr))
  }
