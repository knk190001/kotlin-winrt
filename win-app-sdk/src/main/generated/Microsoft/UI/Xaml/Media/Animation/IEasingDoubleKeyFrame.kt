...
@Signature("{935d9b7e-da61-5bb2-a574-7d2e53b60561}")
@Guid("935d9b7eda615bb2a5747d2e53b60561")
@WinRTInterface("935d9b7eda615bb2a5747d2e53b60561")
...
public interface IEasingDoubleKeyFrame : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IEasingDoubleKeyFrame {
    public val __1069040069_Ptr: Pointer?

    public val _1069040069_VtblPtr: Pointer?
      get() = __1069040069_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_EasingFunction(): EasingFunctionBase? {
      val fnPtr = _1069040069_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EasingFunctionBase>()
      val hr = fn.invokeHR(arrayOf(__1069040069_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_EasingFunction(value: EasingFunctionBase?): Unit {
      val fnPtr = _1069040069_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1069040069_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IEasingDoubleKeyFrame_Impl(
    ...
    public override val __1069040069_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IEasingDoubleKeyFrame, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("935d9b7eda615bb2a5747d2e53b60561")
    ...
    public override fun toNative(obj: IEasingDoubleKeyFrame): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1069040069_Ptr))
  }
