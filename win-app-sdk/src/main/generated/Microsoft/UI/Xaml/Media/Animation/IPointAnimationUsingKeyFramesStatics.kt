...
@Signature("{04152b3b-f0da-5b28-877d-9ac96d334a77}")
@Guid("04152b3bf0da5b28877d9ac96d334a77")
@WinRTInterface("04152b3bf0da5b28877d9ac96d334a77")
...
public interface IPointAnimationUsingKeyFramesStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPointAnimationUsingKeyFramesStatics {
    public val __1217972875_Ptr: Pointer?

    public val _1217972875_VtblPtr: Pointer?
      get() = __1217972875_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_EnableDependentAnimationProperty(): DependencyProperty? {
      val fnPtr = _1217972875_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1217972875_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IPointAnimationUsingKeyFramesStatics_Impl(
    ...
    public override val __1217972875_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPointAnimationUsingKeyFramesStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("04152b3bf0da5b28877d9ac96d334a77")
    ...
    public override fun toNative(obj: IPointAnimationUsingKeyFramesStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1217972875_Ptr))
  }
