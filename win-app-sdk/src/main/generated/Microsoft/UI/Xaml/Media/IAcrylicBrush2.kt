...
@Signature("{23fad570-43ed-5a73-9de7-a303553d5414}")
@Guid("23fad57043ed5a739de7a303553d5414")
@WinRTInterface("23fad57043ed5a739de7a303553d5414")
...
public interface IAcrylicBrush2 : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IAcrylicBrush2 {
    public val __835419652_Ptr: Pointer?

    public val _835419652_VtblPtr: Pointer?
      get() = __835419652_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_TintLuminosityOpacity(): IReference<Double>? {
      val fnPtr = _835419652_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IReference<Double>>()
      val hr = fn.invokeHR(arrayOf(__835419652_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_TintLuminosityOpacity(value: IReference<Double>?): Unit {
      val fnPtr = _835419652_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__835419652_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IAcrylicBrush2_Impl(
    ...
    public override val __835419652_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IAcrylicBrush2, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("23fad57043ed5a739de7a303553d5414")
    ...
    public override fun toNative(obj: IAcrylicBrush2): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__835419652_Ptr))
  }
