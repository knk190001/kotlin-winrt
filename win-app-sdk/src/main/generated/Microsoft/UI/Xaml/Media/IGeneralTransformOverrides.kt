...
@Signature("{ce8970f1-83f8-543f-9cf5-439c461601f1}")
@Guid("ce8970f183f8543f9cf5439c461601f1")
@WinRTInterface("ce8970f183f8543f9cf5439c461601f1")
...
public interface IGeneralTransformOverrides : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IGeneralTransformOverrides {
    public val __1251309586_Ptr: Pointer?

    public val _1251309586_VtblPtr: Pointer?
      get() = __1251309586_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_InverseCore(): GeneralTransform? {
      val fnPtr = _1251309586_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<GeneralTransform>()
      val hr = fn.invokeHR(arrayOf(__1251309586_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun TryTransformCore(inPoint: Point?,
      ...
      val fnPtr = _1251309586_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1251309586_Ptr, marshalToNative(inPoint),
    ...
    public override fun TransformBoundsCore(rect: Rect?): Rect? {
      val fnPtr = _1251309586_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Rect>()
      val hr = fn.invokeHR(arrayOf(__1251309586_Ptr, marshalToNative(rect), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
  ...
  public class IGeneralTransformOverrides_Impl(
    ...
    public override val __1251309586_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IGeneralTransformOverrides, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("ce8970f183f8543f9cf5439c461601f1")
    ...
    public override fun toNative(obj: IGeneralTransformOverrides): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1251309586_Ptr))
  }
