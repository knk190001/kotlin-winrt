...
@Signature("{20136388-b4e4-5cbb-9cb2-df2ea7e6c44b}")
@Guid("20136388b4e45cbb9cb2df2ea7e6c44b")
@WinRTInterface("20136388b4e45cbb9cb2df2ea7e6c44b")
...
public interface IPopInThemeAnimation : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPopInThemeAnimation {
    public val __304792278_Ptr: Pointer?

    public val _304792278_VtblPtr: Pointer?
      get() = __304792278_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_TargetName(): String? {
      val fnPtr = _304792278_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__304792278_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_TargetName(value: String?): Unit {
      val fnPtr = _304792278_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__304792278_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_FromHorizontalOffset(): Double {
      val fnPtr = _304792278_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_FromHorizontalOffset(value: Double): Unit {
      val fnPtr = _304792278_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__304792278_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_FromVerticalOffset(): Double {
      val fnPtr = _304792278_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__304792278_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_FromVerticalOffset(value: Double): Unit {
      val fnPtr = _304792278_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__304792278_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IPopInThemeAnimation_Impl(
    ...
    public override val __304792278_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPopInThemeAnimation, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("20136388b4e45cbb9cb2df2ea7e6c44b")
    ...
    public override fun toNative(obj: IPopInThemeAnimation): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__304792278_Ptr))
  }
