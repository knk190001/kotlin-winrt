...
@Signature("{372dfad0-5177-5df9-8e1e-920962468714}")
@Guid("372dfad051775df98e1e920962468714")
@WinRTInterface("372dfad051775df98e1e920962468714")
...
public interface IPowerEase : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPowerEase {
    public val __763474680_Ptr: Pointer?

    public val _763474680_VtblPtr: Pointer?
      get() = __763474680_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Power(): Double {
      val fnPtr = _763474680_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__763474680_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Power(value: Double): Unit {
      val fnPtr = _763474680_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__763474680_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IPowerEase_Impl(
    ...
    public override val __763474680_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPowerEase, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("372dfad051775df98e1e920962468714")
    ...
    public override fun toNative(obj: IPowerEase): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__763474680_Ptr))
  }
