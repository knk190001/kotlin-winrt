...
@Signature("{738ef089-a80f-53e0-816f-f787a4461907}")
@Guid("738ef089a80f53e0816ff787a4461907")
@WinRTInterface("738ef089a80f53e0816ff787a4461907")
...
public interface IPolyBezierSegmentStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPolyBezierSegmentStatics {
    public val __1090962670_Ptr: Pointer?

    public val _1090962670_VtblPtr: Pointer?
      get() = __1090962670_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_PointsProperty(): DependencyProperty? {
      val fnPtr = _1090962670_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1090962670_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IPolyBezierSegmentStatics_Impl(
    ...
    public override val __1090962670_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPolyBezierSegmentStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("738ef089a80f53e0816ff787a4461907")
    ...
    public override fun toNative(obj: IPolyBezierSegmentStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1090962670_Ptr))
  }
