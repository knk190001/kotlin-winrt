...
@Signature("{e5a73b84-a4ae-5c38-84da-f7ed30fc9b6e}")
@Guid("e5a73b84a4ae5c3884daf7ed30fc9b6e")
@WinRTInterface("e5a73b84a4ae5c3884daf7ed30fc9b6e")
...
public interface ISplitOpenThemeAnimationStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISplitOpenThemeAnimationStatics {
    public val __196476449_Ptr: Pointer?

    public val _196476449_VtblPtr: Pointer?
      get() = __196476449_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_OpenedTargetNameProperty(): DependencyProperty? {
      val fnPtr = _196476449_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__196476449_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_OpenedTargetProperty(): DependencyProperty? {
      val fnPtr = _196476449_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__196476449_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ClosedTargetNameProperty(): DependencyProperty? {
      val fnPtr = _196476449_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__196476449_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ClosedTargetProperty(): DependencyProperty? {
      val fnPtr = _196476449_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__196476449_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ContentTargetNameProperty(): DependencyProperty? {
      val fnPtr = _196476449_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__196476449_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ContentTargetProperty(): DependencyProperty? {
      val fnPtr = _196476449_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__196476449_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_OpenedLengthProperty(): DependencyProperty? {
      val fnPtr = _196476449_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__196476449_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ClosedLengthProperty(): DependencyProperty? {
      val fnPtr = _196476449_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__196476449_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_OffsetFromCenterProperty(): DependencyProperty? {
      val fnPtr = _196476449_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__196476449_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ContentTranslationDirectionProperty(): DependencyProperty? {
      val fnPtr = _196476449_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__196476449_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ContentTranslationOffsetProperty(): DependencyProperty? {
      val fnPtr = _196476449_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__196476449_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ISplitOpenThemeAnimationStatics_Impl(
    ...
    public override val __196476449_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISplitOpenThemeAnimationStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("e5a73b84a4ae5c3884daf7ed30fc9b6e")
    ...
    public override fun toNative(obj: ISplitOpenThemeAnimationStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__196476449_Ptr))
  }
