...
@Signature("{88209080-2929-5924-9b52-f95196568713}")
@Guid("88209080292959249b52f95196568713")
@WinRTInterface("88209080292959249b52f95196568713")
...
public interface ICircleEase : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICircleEase {
    public val __665181465_Ptr: Pointer?

    public val _665181465_VtblPtr: Pointer?
      get() = __665181465_Ptr?.getPointer(0)
  }

  public class ICircleEase_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __665181465_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICircleEase, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("88209080292959249b52f95196568713")
    ...
    public override fun toNative(obj: ICircleEase): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__665181465_Ptr))
  }
