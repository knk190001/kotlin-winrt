...
@Signature("{f095d058-bc9e-58ee-8877-e084723b4333}")
@Guid("f095d058bc9e58ee8877e084723b4333")
@WinRTInterface("f095d058bc9e58ee8877e084723b4333")
...
public interface ISwipeBackThemeAnimation : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISwipeBackThemeAnimation {
    public val __1195208447_Ptr: Pointer?

    public val _1195208447_VtblPtr: Pointer?
      get() = __1195208447_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_TargetName(): String? {
      val fnPtr = _1195208447_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__1195208447_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_TargetName(value: String?): Unit {
      val fnPtr = _1195208447_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1195208447_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_FromHorizontalOffset(): Double {
      val fnPtr = _1195208447_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_FromHorizontalOffset(value: Double): Unit {
      val fnPtr = _1195208447_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1195208447_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_FromVerticalOffset(): Double {
      val fnPtr = _1195208447_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1195208447_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_FromVerticalOffset(value: Double): Unit {
      val fnPtr = _1195208447_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1195208447_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class ISwipeBackThemeAnimation_Impl(
    ...
    public override val __1195208447_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISwipeBackThemeAnimation, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("f095d058bc9e58ee8877e084723b4333")
    ...
    public override fun toNative(obj: ISwipeBackThemeAnimation): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1195208447_Ptr))
  }
