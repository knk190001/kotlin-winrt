...
@Signature("{8eb681fa-1629-5e29-ac1e-70f3639329f8}")
@Guid("8eb681fa16295e29ac1e70f3639329f8")
@WinRTInterface("8eb681fa16295e29ac1e70f3639329f8")
...
public interface IEntranceThemeTransition : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IEntranceThemeTransition {
    public val __1836987891_Ptr: Pointer?

    public val _1836987891_VtblPtr: Pointer?
      get() = __1836987891_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_FromHorizontalOffset(): Double {
      val fnPtr = _1836987891_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1836987891_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_FromHorizontalOffset(value: Double): Unit {
      val fnPtr = _1836987891_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1836987891_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_FromVerticalOffset(): Double {
      val fnPtr = _1836987891_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1836987891_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_FromVerticalOffset(value: Double): Unit {
      val fnPtr = _1836987891_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1836987891_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_IsStaggeringEnabled(): Boolean {
      val fnPtr = _1836987891_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_IsStaggeringEnabled(value: Boolean): Unit {
      val fnPtr = _1836987891_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1836987891_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IEntranceThemeTransition_Impl(
    ...
    public override val __1836987891_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IEntranceThemeTransition, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("8eb681fa16295e29ac1e70f3639329f8")
    ...
    public override fun toNative(obj: IEntranceThemeTransition): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1836987891_Ptr))
  }
