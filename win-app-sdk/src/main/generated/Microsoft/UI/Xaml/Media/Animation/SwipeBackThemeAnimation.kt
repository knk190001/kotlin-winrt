...
@Signature("rc(Microsoft.UI.Xaml.Media.Animation.SwipeBackThemeAnimation;{f095d058-bc9e-58ee-8877-e084723b4333})")
...
public class SwipeBackThemeAnimation(
  ...
  private val __1195208447_Interface: ISwipeBackThemeAnimation.WithDefault by lazy {
    as_1195208447()
  }


  public override val __1195208447_Ptr: JNAPointer? by lazy {
    __1195208447_Interface.__1195208447_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1195208447_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1195208447(): ISwipeBackThemeAnimation.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<SwipeBackThemeAnimation, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.Animation.SwipeBackThemeAnimation".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createISwipeBackThemeAnimationStatics(): ISwipeBackThemeAnimationStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.Animation.SwipeBackThemeAnimation".toHandle(),refiid,interfacePtr)
      val result =
