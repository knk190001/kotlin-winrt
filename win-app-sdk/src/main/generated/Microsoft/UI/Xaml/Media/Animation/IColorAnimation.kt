...
@Signature("{6df862d2-65f2-53a8-8b1b-1b6c1763c175}")
@Guid("6df862d265f253a88b1b1b6c1763c175")
@WinRTInterface("6df862d265f253a88b1b1b6c1763c175")
...
public interface IColorAnimation : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IColorAnimation {
    public val __2089567772_Ptr: Pointer?

    public val _2089567772_VtblPtr: Pointer?
      get() = __2089567772_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_From(): IReference<Color?>? {
      val fnPtr = _2089567772_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IReference<Color?>>()
      val hr = fn.invokeHR(arrayOf(__2089567772_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_From(value: IReference<Color?>?): Unit {
      val fnPtr = _2089567772_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2089567772_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_To(): IReference<Color?>? {
      val fnPtr = _2089567772_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IReference<Color?>>()
      val hr = fn.invokeHR(arrayOf(__2089567772_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_To(value: IReference<Color?>?): Unit {
      val fnPtr = _2089567772_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2089567772_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_By(): IReference<Color?>? {
      val fnPtr = _2089567772_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IReference<Color?>>()
      val hr = fn.invokeHR(arrayOf(__2089567772_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_By(value: IReference<Color?>?): Unit {
      val fnPtr = _2089567772_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2089567772_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_EasingFunction(): EasingFunctionBase? {
      val fnPtr = _2089567772_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_EasingFunction(value: EasingFunctionBase?): Unit {
      val fnPtr = _2089567772_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2089567772_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_EnableDependentAnimation(): Boolean {
      val fnPtr = _2089567772_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_EnableDependentAnimation(value: Boolean): Unit {
      val fnPtr = _2089567772_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2089567772_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IColorAnimation_Impl(
    ...
    public override val __2089567772_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IColorAnimation, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("6df862d265f253a88b1b1b6c1763c175")
    ...
    public override fun toNative(obj: IColorAnimation): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2089567772_Ptr))
  }
