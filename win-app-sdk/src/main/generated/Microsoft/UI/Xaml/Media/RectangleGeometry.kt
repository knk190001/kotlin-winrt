...
@Signature("rc(Microsoft.UI.Xaml.Media.RectangleGeometry;{b6143890-a5f5-54e0-ab42-d88bab451f04})")
...
public class RectangleGeometry(
  ...
  private val __56587536_Interface: IRectangleGeometry.WithDefault by lazy {
    as_56587536()
  }


  public override val __56587536_Ptr: JNAPointer? by lazy {
    __56587536_Interface.__56587536_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__56587536_Interface)

  public constructor() : this(ABI.activate())

  private fun as_56587536(): IRectangleGeometry.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<RectangleGeometry, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.RectangleGeometry".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIRectangleGeometryStatics(): IRectangleGeometryStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.RectangleGeometry".toHandle(),refiid,interfacePtr)
