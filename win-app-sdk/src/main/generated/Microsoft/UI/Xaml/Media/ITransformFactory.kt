...
@Signature("{7da293f9-b82e-5d15-b623-c08210cbb640}")
@Guid("7da293f9b82e5d15b623c08210cbb640")
@WinRTInterface("7da293f9b82e5d15b623c08210cbb640")
...
public interface ITransformFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITransformFactory {
    public val __1289445935_Ptr: Pointer?

    public val _1289445935_VtblPtr: Pointer?
      get() = __1289445935_Ptr?.getPointer(0)
  }

  public class ITransformFactory_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __1289445935_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITransformFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("7da293f9b82e5d15b623c08210cbb640")
    ...
    public override fun toNative(obj: ITransformFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1289445935_Ptr))
  }
