...
@Signature("{b64d4181-6988-5d46-858a-224db7089dc4}")
@Guid("b64d418169885d46858a224db7089dc4")
@WinRTInterface("b64d418169885d46858a224db7089dc4")
...
public interface ICompositeTransform3DStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositeTransform3DStatics {
    public val __151639813_Ptr: Pointer?

    public val _151639813_VtblPtr: Pointer?
      get() = __151639813_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_CenterXProperty(): DependencyProperty? {
      val fnPtr = _151639813_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__151639813_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_CenterYProperty(): DependencyProperty? {
      val fnPtr = _151639813_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__151639813_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_CenterZProperty(): DependencyProperty? {
      val fnPtr = _151639813_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__151639813_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_RotationXProperty(): DependencyProperty? {
      val fnPtr = _151639813_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__151639813_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_RotationYProperty(): DependencyProperty? {
      val fnPtr = _151639813_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__151639813_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_RotationZProperty(): DependencyProperty? {
      val fnPtr = _151639813_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__151639813_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ScaleXProperty(): DependencyProperty? {
      val fnPtr = _151639813_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__151639813_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ScaleYProperty(): DependencyProperty? {
      val fnPtr = _151639813_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__151639813_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ScaleZProperty(): DependencyProperty? {
      val fnPtr = _151639813_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__151639813_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_TranslateXProperty(): DependencyProperty? {
      val fnPtr = _151639813_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__151639813_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_TranslateYProperty(): DependencyProperty? {
      val fnPtr = _151639813_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__151639813_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_TranslateZProperty(): DependencyProperty? {
      val fnPtr = _151639813_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__151639813_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ICompositeTransform3DStatics_Impl(
    ...
    public override val __151639813_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositeTransform3DStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("b64d418169885d46858a224db7089dc4")
    ...
    public override fun toNative(obj: ICompositeTransform3DStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__151639813_Ptr))
  }
