...
@Signature("rc(Microsoft.UI.Xaml.Media.Animation.LinearColorKeyFrame;{0bce4cd6-3a80-5f2f-932e-619a8546d0bd})")
...
public class LinearColorKeyFrame(
  ...
  private val __1765656017_Interface: ILinearColorKeyFrame.WithDefault by lazy {
    as_1765656017()
  }


  public override val __1765656017_Ptr: JNAPointer? by lazy {
    __1765656017_Interface.__1765656017_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1765656017_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1765656017(): ILinearColorKeyFrame.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<LinearColorKeyFrame, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.Animation.LinearColorKeyFrame".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
