...
@Signature("{8c9378a9-d276-5a1d-8188-f48f07840a16}")
@Guid("8c9378a9d2765a1d8188f48f07840a16")
@WinRTInterface("8c9378a9d2765a1d8188f48f07840a16")
...
public interface IPopInThemeAnimationStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPopInThemeAnimationStatics {
    public val __1995905039_Ptr: Pointer?

    public val _1995905039_VtblPtr: Pointer?
      get() = __1995905039_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_TargetNameProperty(): DependencyProperty? {
      val fnPtr = _1995905039_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1995905039_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_FromHorizontalOffsetProperty(): DependencyProperty? {
      val fnPtr = _1995905039_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1995905039_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_FromVerticalOffsetProperty(): DependencyProperty? {
      val fnPtr = _1995905039_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1995905039_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IPopInThemeAnimationStatics_Impl(
    ...
    public override val __1995905039_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPopInThemeAnimationStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("8c9378a9d2765a1d8188f48f07840a16")
    ...
    public override fun toNative(obj: IPopInThemeAnimationStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1995905039_Ptr))
  }
