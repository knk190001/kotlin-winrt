...
@Signature("{78c824a9-0e43-5f1e-93bc-d046cca82b7e}")
@Guid("78c824a90e435f1e93bcd046cca82b7e")
@WinRTInterface("78c824a90e435f1e93bcd046cca82b7e")
...
public interface IWriteableBitmap : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IWriteableBitmap {
    public val __1571441473_Ptr: Pointer?

    public val _1571441473_VtblPtr: Pointer?
      get() = __1571441473_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_PixelBuffer(): IBuffer? {
      val fnPtr = _1571441473_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IBuffer>()
      val hr = fn.invokeHR(arrayOf(__1571441473_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun Invalidate(): Unit {
      val fnPtr = _1571441473_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1571441473_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IWriteableBitmap_Impl(
    ...
    public override val __1571441473_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IWriteableBitmap, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("78c824a90e435f1e93bcd046cca82b7e")
    ...
    public override fun toNative(obj: IWriteableBitmap): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1571441473_Ptr))
  }
