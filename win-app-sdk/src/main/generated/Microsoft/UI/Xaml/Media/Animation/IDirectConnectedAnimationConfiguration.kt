...
@Signature("{44f192eb-cc11-545e-8fa2-1f0ec9c4438a}")
@Guid("44f192ebcc11545e8fa21f0ec9c4438a")
@WinRTInterface("44f192ebcc11545e8fa21f0ec9c4438a")
...
public interface IDirectConnectedAnimationConfiguration : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IDirectConnectedAnimationConfiguration {
    public val __815283209_Ptr: Pointer?

    public val _815283209_VtblPtr: Pointer?
      get() = __815283209_Ptr?.getPointer(0)
  }

  public class IDirectConnectedAnimationConfiguration_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __815283209_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IDirectConnectedAnimationConfiguration, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("44f192ebcc11545e8fa21f0ec9c4438a")
    ...
    public override fun toNative(obj: IDirectConnectedAnimationConfiguration): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__815283209_Ptr))
  }
