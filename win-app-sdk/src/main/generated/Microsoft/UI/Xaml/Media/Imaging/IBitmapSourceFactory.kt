...
@Signature("{0392f025-1868-5876-ad67-12e94a8da5bf}")
@Guid("0392f02518685876ad6712e94a8da5bf")
@WinRTInterface("0392f02518685876ad6712e94a8da5bf")
...
public interface IBitmapSourceFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IBitmapSourceFactory {
    public val __1879158279_Ptr: Pointer?

    public val _1879158279_VtblPtr: Pointer?
      get() = __1879158279_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        BitmapSource? {
      val fnPtr = _1879158279_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<BitmapSource>()
      val hr = fn.invokeHR(arrayOf(__1879158279_Ptr, marshalToNative(baseInterface),
  ...
  public class IBitmapSourceFactory_Impl(
    ...
    public override val __1879158279_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IBitmapSourceFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("0392f02518685876ad6712e94a8da5bf")
    ...
    public override fun toNative(obj: IBitmapSourceFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1879158279_Ptr))
  }
