...
@Signature("{bc7a71b5-7cda-5bb7-967e-d6a031285a9c}")
@Guid("bc7a71b57cda5bb7967ed6a031285a9c")
@WinRTInterface("bc7a71b57cda5bb7967ed6a031285a9c")
...
public interface IGravityConnectedAnimationConfigurationFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IGravityConnectedAnimationConfigurationFactory {
    public val __189415458_Ptr: Pointer?

    public val _189415458_VtblPtr: Pointer?
      get() = __189415458_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        GravityConnectedAnimationConfiguration? {
      val fnPtr = _189415458_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<GravityConnectedAnimationConfiguration>()
      val hr = fn.invokeHR(arrayOf(__189415458_Ptr, marshalToNative(baseInterface),
  ...
  public class IGravityConnectedAnimationConfigurationFactory_Impl(
    ...
    public override val __189415458_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IGravityConnectedAnimationConfigurationFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("bc7a71b57cda5bb7967ed6a031285a9c")
    ...
    public override fun toNative(obj: IGravityConnectedAnimationConfigurationFactory): MemoryAddress
        = MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__189415458_Ptr))
  }
