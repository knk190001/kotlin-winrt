...
@Signature("rc(Microsoft.UI.Xaml.Media.Animation.DiscreteObjectKeyFrame;{542fa813-6892-559d-9f69-1f2ac666af13})")
...
public class DiscreteObjectKeyFrame(
  ...
  private val __1093042625_Interface: IDiscreteObjectKeyFrame.WithDefault by lazy {
    as_1093042625()
  }


  public override val __1093042625_Ptr: JNAPointer? by lazy {
    __1093042625_Interface.__1093042625_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1093042625_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1093042625(): IDiscreteObjectKeyFrame.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<DiscreteObjectKeyFrame, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.Animation.DiscreteObjectKeyFrame".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
