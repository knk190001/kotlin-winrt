...
@Signature("{cf10407d-fa8b-57a3-9574-710529ae0b04}")
@Guid("cf10407dfa8b57a39574710529ae0b04")
@WinRTInterface("cf10407dfa8b57a39574710529ae0b04")
...
public interface IRenderTargetBitmap : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IRenderTargetBitmap {
    public val __1186267843_Ptr: Pointer?

    public val _1186267843_VtblPtr: Pointer?
      get() = __1186267843_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_PixelWidth(): Int {
      val fnPtr = _1186267843_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__1186267843_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_PixelHeight(): Int {
      val fnPtr = _1186267843_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__1186267843_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun RenderAsync(element: UIElement?): IAsyncAction? {
      val fnPtr = _1186267843_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IAsyncAction>()
      val hr = fn.invokeHR(arrayOf(__1186267843_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun RenderAsync(
      ...
      val fnPtr = _1186267843_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IAsyncAction>()
      val hr = fn.invokeHR(arrayOf(__1186267843_Ptr, marshalToNative(element), scaledWidth,
          scaledHeight, result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun GetPixelsAsync(): IAsyncOperation<IBuffer?>? {
      val fnPtr = _1186267843_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class IRenderTargetBitmap_Impl(
    ...
    public override val __1186267843_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IRenderTargetBitmap, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("cf10407dfa8b57a39574710529ae0b04")
    ...
    public override fun toNative(obj: IRenderTargetBitmap): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1186267843_Ptr))
  }
