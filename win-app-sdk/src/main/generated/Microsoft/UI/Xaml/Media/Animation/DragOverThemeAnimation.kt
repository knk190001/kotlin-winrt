...
@Signature("rc(Microsoft.UI.Xaml.Media.Animation.DragOverThemeAnimation;{633cd3c0-71af-52fd-993e-504e3e6f56d4})")
...
public class DragOverThemeAnimation(
  ...
  private val __1210610110_Interface: IDragOverThemeAnimation.WithDefault by lazy {
    as_1210610110()
  }


  public override val __1210610110_Ptr: JNAPointer? by lazy {
    __1210610110_Interface.__1210610110_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1210610110_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1210610110(): IDragOverThemeAnimation.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<DragOverThemeAnimation, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.Animation.DragOverThemeAnimation".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIDragOverThemeAnimationStatics(): IDragOverThemeAnimationStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.Animation.DragOverThemeAnimation".toHandle(),refiid,interfacePtr)
      val result =
