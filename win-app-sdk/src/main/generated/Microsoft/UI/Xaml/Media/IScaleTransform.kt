...
@Signature("{94b064a4-34f0-5ef9-8b67-444f5699f52a}")
@Guid("94b064a434f05ef98b67444f5699f52a")
@WinRTInterface("94b064a434f05ef98b67444f5699f52a")
...
public interface IScaleTransform : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IScaleTransform {
    public val __1985061811_Ptr: Pointer?

    public val _1985061811_VtblPtr: Pointer?
      get() = __1985061811_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_CenterX(): Double {
      val fnPtr = _1985061811_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1985061811_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_CenterX(value: Double): Unit {
      val fnPtr = _1985061811_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1985061811_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_CenterY(): Double {
      val fnPtr = _1985061811_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1985061811_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_CenterY(value: Double): Unit {
      val fnPtr = _1985061811_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1985061811_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ScaleX(): Double {
      val fnPtr = _1985061811_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1985061811_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ScaleX(value: Double): Unit {
      val fnPtr = _1985061811_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1985061811_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ScaleY(): Double {
      val fnPtr = _1985061811_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1985061811_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ScaleY(value: Double): Unit {
      val fnPtr = _1985061811_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1985061811_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IScaleTransform_Impl(
    ...
    public override val __1985061811_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IScaleTransform, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("94b064a434f05ef98b67444f5699f52a")
    ...
    public override fun toNative(obj: IScaleTransform): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1985061811_Ptr))
  }
