...
@Signature("{538b2114-415c-5f99-b74d-a85966dacc54}")
@Guid("538b2114415c5f99b74da85966dacc54")
@WinRTInterface("538b2114415c5f99b74da85966dacc54")
...
public interface IPopupThemeTransitionStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPopupThemeTransitionStatics {
    public val __706451752_Ptr: Pointer?

    public val _706451752_VtblPtr: Pointer?
      get() = __706451752_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_FromHorizontalOffsetProperty(): DependencyProperty? {
      val fnPtr = _706451752_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__706451752_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_FromVerticalOffsetProperty(): DependencyProperty? {
      val fnPtr = _706451752_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__706451752_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IPopupThemeTransitionStatics_Impl(
    ...
    public override val __706451752_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPopupThemeTransitionStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("538b2114415c5f99b74da85966dacc54")
    ...
    public override fun toNative(obj: IPopupThemeTransitionStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__706451752_Ptr))
  }
