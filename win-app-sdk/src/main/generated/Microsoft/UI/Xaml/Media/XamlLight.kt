...
import Microsoft.UI.Xaml.Media.IXamlLightFactory.ABI.IID
...
@Signature("rc(Microsoft.UI.Xaml.Media.XamlLight;{dcd20139-8cd5-5da5-a25c-2b7b813d8d58})")
...
public open class XamlLight(
  ...
  private val __654088861_Interface: IXamlLight.WithDefault by lazy {
    as_654088861()
  }


  private val __1187484049_Interface: IXamlLightProtected.WithDefault by lazy {
    as_1187484049()
  }


  private val __1046053898_Interface: IXamlLightOverrides.WithDefault by lazy {
    as_1046053898()
  }


  public override val __654088861_Ptr: JNAPointer? by lazy {
    __654088861_Interface.__654088861_Ptr
  }


  public override val __1187484049_Ptr: JNAPointer? by lazy {
    __1187484049_Interface.__1187484049_Ptr
  }


  public override val __1046053898_Ptr: JNAPointer? by lazy {
    __1046053898_Interface.__1046053898_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__654088861_Interface, __1187484049_Interface, __1046053898_Interface)

  public constructor() : this(ABI.activate())

  private fun as_654088861(): IXamlLight.WithDefault {
    if(pointer == NULL) {
  ...
  private fun as_1187484049(): IXamlLightProtected.WithDefault {
    if(pointer == NULL) {
  ...
  private fun as_1046053898(): IXamlLightOverrides.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<XamlLight, MemoryAddress> {
    ...
    public fun createIXamlLightStatics(): IXamlLightStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.XamlLight".toHandle(),refiid,interfacePtr)
    ...
    public fun createIXamlLightFactory(): IXamlLightFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.XamlLight".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
