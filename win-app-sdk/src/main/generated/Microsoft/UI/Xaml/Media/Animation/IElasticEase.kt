...
@Signature("{2b18d50b-4d34-509b-915c-61b1aa6f83d8}")
@Guid("2b18d50b4d34509b915c61b1aa6f83d8")
@WinRTInterface("2b18d50b4d34509b915c61b1aa6f83d8")
...
public interface IElasticEase : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IElasticEase {
    public val __685895560_Ptr: Pointer?

    public val _685895560_VtblPtr: Pointer?
      get() = __685895560_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Oscillations(): Int {
      val fnPtr = _685895560_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__685895560_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Oscillations(value: Int): Unit {
      val fnPtr = _685895560_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__685895560_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Springiness(): Double {
      val fnPtr = _685895560_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Springiness(value: Double): Unit {
      val fnPtr = _685895560_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__685895560_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IElasticEase_Impl(
    ...
    public override val __685895560_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IElasticEase, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("2b18d50b4d34509b915c61b1aa6f83d8")
    ...
    public override fun toNative(obj: IElasticEase): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__685895560_Ptr))
  }
