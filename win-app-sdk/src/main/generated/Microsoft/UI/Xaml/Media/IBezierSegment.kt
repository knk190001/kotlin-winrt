...
@Signature("{0f36bade-892e-51fe-b94a-3875e86feaae}")
@Guid("0f36bade892e51feb94a3875e86feaae")
@WinRTInterface("0f36bade892e51feb94a3875e86feaae")
...
public interface IBezierSegment : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IBezierSegment {
    public val __402845379_Ptr: Pointer?

    public val _402845379_VtblPtr: Pointer?
      get() = __402845379_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Point1(): Point? {
      val fnPtr = _402845379_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Point>()
      val hr = fn.invokeHR(arrayOf(__402845379_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Point1(value: Point?): Unit {
      val fnPtr = _402845379_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__402845379_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Point2(): Point? {
      val fnPtr = _402845379_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Point>()
      val hr = fn.invokeHR(arrayOf(__402845379_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Point2(value: Point?): Unit {
      val fnPtr = _402845379_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__402845379_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Point3(): Point? {
      val fnPtr = _402845379_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Point>()
      val hr = fn.invokeHR(arrayOf(__402845379_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Point3(value: Point?): Unit {
      val fnPtr = _402845379_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__402845379_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IBezierSegment_Impl(
    ...
    public override val __402845379_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IBezierSegment, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("0f36bade892e51feb94a3875e86feaae")
    ...
    public override fun toNative(obj: IBezierSegment): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__402845379_Ptr))
  }
