...
@Signature("rc(Microsoft.UI.Xaml.Media.Animation.DragItemThemeAnimation;{648e690e-a2c0-58ca-b15d-db6fccc663f2})")
...
public class DragItemThemeAnimation(
  ...
  private val __1243633085_Interface: IDragItemThemeAnimation.WithDefault by lazy {
    as_1243633085()
  }


  public override val __1243633085_Ptr: JNAPointer? by lazy {
    __1243633085_Interface.__1243633085_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1243633085_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1243633085(): IDragItemThemeAnimation.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<DragItemThemeAnimation, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.Animation.DragItemThemeAnimation".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIDragItemThemeAnimationStatics(): IDragItemThemeAnimationStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.Animation.DragItemThemeAnimation".toHandle(),refiid,interfacePtr)
      val result =
