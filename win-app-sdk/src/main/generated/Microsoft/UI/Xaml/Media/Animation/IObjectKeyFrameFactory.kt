...
@Signature("{dc59da6e-82b9-55f7-a358-ba2a07665aa9}")
@Guid("dc59da6e82b955f7a358ba2a07665aa9")
@WinRTInterface("dc59da6e82b955f7a358ba2a07665aa9")
...
public interface IObjectKeyFrameFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IObjectKeyFrameFactory {
    public val __1382920834_Ptr: Pointer?

    public val _1382920834_VtblPtr: Pointer?
      get() = __1382920834_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        ObjectKeyFrame? {
      val fnPtr = _1382920834_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ObjectKeyFrame>()
      val hr = fn.invokeHR(arrayOf(__1382920834_Ptr, marshalToNative(baseInterface),
  ...
  public class IObjectKeyFrameFactory_Impl(
    ...
    public override val __1382920834_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IObjectKeyFrameFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("dc59da6e82b955f7a358ba2a07665aa9")
    ...
    public override fun toNative(obj: IObjectKeyFrameFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1382920834_Ptr))
  }
