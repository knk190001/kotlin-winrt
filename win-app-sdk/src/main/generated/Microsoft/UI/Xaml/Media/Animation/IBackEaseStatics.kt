...
@Signature("{1ead2ef9-7901-542d-ae08-7b5937b32ef0}")
@Guid("1ead2ef97901542dae087b5937b32ef0")
@WinRTInterface("1ead2ef97901542dae087b5937b32ef0")
...
public interface IBackEaseStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IBackEaseStatics {
    public val __1114481973_Ptr: Pointer?

    public val _1114481973_VtblPtr: Pointer?
      get() = __1114481973_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_AmplitudeProperty(): DependencyProperty? {
      val fnPtr = _1114481973_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1114481973_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IBackEaseStatics_Impl(
    ...
    public override val __1114481973_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IBackEaseStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("1ead2ef97901542dae087b5937b32ef0")
    ...
    public override fun toNative(obj: IBackEaseStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1114481973_Ptr))
  }
