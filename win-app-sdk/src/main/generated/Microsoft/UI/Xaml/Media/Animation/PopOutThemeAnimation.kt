...
@Signature("rc(Microsoft.UI.Xaml.Media.Animation.PopOutThemeAnimation;{1bb20dd3-5648-541a-a0c9-37a955db10a6})")
...
public class PopOutThemeAnimation(
  ...
  private val __1628598573_Interface: IPopOutThemeAnimation.WithDefault by lazy {
    as_1628598573()
  }


  public override val __1628598573_Ptr: JNAPointer? by lazy {
    __1628598573_Interface.__1628598573_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1628598573_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1628598573(): IPopOutThemeAnimation.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<PopOutThemeAnimation, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.Animation.PopOutThemeAnimation".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIPopOutThemeAnimationStatics(): IPopOutThemeAnimationStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.Animation.PopOutThemeAnimation".toHandle(),refiid,interfacePtr)
      val result =
