...
@Signature("{17c55f3b-899c-588f-8bd4-40fa3a5fcb04}")
@Guid("17c55f3b899c588f8bd440fa3a5fcb04")
@WinRTInterface("17c55f3b899c588f8bd440fa3a5fcb04")
...
public interface ITransformGroup : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITransformGroup {
    public val __1945817884_Ptr: Pointer?

    public val _1945817884_VtblPtr: Pointer?
      get() = __1945817884_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Children(): TransformCollection? {
      val fnPtr = _1945817884_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<TransformCollection>()
      val hr = fn.invokeHR(arrayOf(__1945817884_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Children(value: TransformCollection?): Unit {
      val fnPtr = _1945817884_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1945817884_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Value(): Matrix? {
      val fnPtr = _1945817884_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class ITransformGroup_Impl(
    ...
    public override val __1945817884_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITransformGroup, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("17c55f3b899c588f8bd440fa3a5fcb04")
    ...
    public override fun toNative(obj: ITransformGroup): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1945817884_Ptr))
  }
