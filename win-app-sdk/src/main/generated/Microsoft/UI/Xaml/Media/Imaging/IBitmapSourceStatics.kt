...
@Signature("{efa3745e-4400-5f0b-bdc7-3f2911a3d719}")
@Guid("efa3745e44005f0bbdc73f2911a3d719")
@WinRTInterface("efa3745e44005f0bbdc73f2911a3d719")
...
public interface IBitmapSourceStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IBitmapSourceStatics {
    public val __1610555572_Ptr: Pointer?

    public val _1610555572_VtblPtr: Pointer?
      get() = __1610555572_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_PixelWidthProperty(): DependencyProperty? {
      val fnPtr = _1610555572_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1610555572_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_PixelHeightProperty(): DependencyProperty? {
      val fnPtr = _1610555572_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1610555572_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IBitmapSourceStatics_Impl(
    ...
    public override val __1610555572_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IBitmapSourceStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("efa3745e44005f0bbdc73f2911a3d719")
    ...
    public override fun toNative(obj: IBitmapSourceStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1610555572_Ptr))
  }
