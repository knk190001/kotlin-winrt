...
@Signature("{542fa813-6892-559d-9f69-1f2ac666af13}")
@Guid("542fa8136892559d9f691f2ac666af13")
@WinRTInterface("542fa8136892559d9f691f2ac666af13")
...
public interface IDiscreteObjectKeyFrame : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IDiscreteObjectKeyFrame {
    public val __1093042625_Ptr: Pointer?

    public val _1093042625_VtblPtr: Pointer?
      get() = __1093042625_Ptr?.getPointer(0)
  }

  public class IDiscreteObjectKeyFrame_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __1093042625_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IDiscreteObjectKeyFrame, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("542fa8136892559d9f691f2ac666af13")
    ...
    public override fun toNative(obj: IDiscreteObjectKeyFrame): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1093042625_Ptr))
  }
