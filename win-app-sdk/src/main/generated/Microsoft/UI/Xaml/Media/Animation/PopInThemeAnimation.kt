...
@Signature("rc(Microsoft.UI.Xaml.Media.Animation.PopInThemeAnimation;{20136388-b4e4-5cbb-9cb2-df2ea7e6c44b})")
...
public class PopInThemeAnimation(
  ...
  private val __304792278_Interface: IPopInThemeAnimation.WithDefault by lazy {
    as_304792278()
  }


  public override val __304792278_Ptr: JNAPointer? by lazy {
    __304792278_Interface.__304792278_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__304792278_Interface)

  public constructor() : this(ABI.activate())

  private fun as_304792278(): IPopInThemeAnimation.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<PopInThemeAnimation, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.Animation.PopInThemeAnimation".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIPopInThemeAnimationStatics(): IPopInThemeAnimationStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.Animation.PopInThemeAnimation".toHandle(),refiid,interfacePtr)
      val result =
