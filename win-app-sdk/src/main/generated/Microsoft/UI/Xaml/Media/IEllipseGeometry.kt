...
@Signature("{ababd262-d8e4-5b49-bce9-0108a5209d45}")
@Guid("ababd262d8e45b49bce90108a5209d45")
@WinRTInterface("ababd262d8e45b49bce90108a5209d45")
...
public interface IEllipseGeometry : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IEllipseGeometry {
    public val __2029106657_Ptr: Pointer?

    public val _2029106657_VtblPtr: Pointer?
      get() = __2029106657_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Center(): Point? {
      val fnPtr = _2029106657_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Point>()
      val hr = fn.invokeHR(arrayOf(__2029106657_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Center(value: Point?): Unit {
      val fnPtr = _2029106657_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2029106657_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_RadiusX(): Double {
      val fnPtr = _2029106657_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_RadiusX(value: Double): Unit {
      val fnPtr = _2029106657_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2029106657_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_RadiusY(): Double {
      val fnPtr = _2029106657_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__2029106657_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_RadiusY(value: Double): Unit {
      val fnPtr = _2029106657_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2029106657_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IEllipseGeometry_Impl(
    ...
    public override val __2029106657_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IEllipseGeometry, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("ababd262d8e45b49bce90108a5209d45")
    ...
    public override fun toNative(obj: IEllipseGeometry): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2029106657_Ptr))
  }
