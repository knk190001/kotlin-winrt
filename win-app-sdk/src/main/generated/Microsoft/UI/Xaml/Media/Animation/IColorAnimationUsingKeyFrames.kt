...
@Signature("{96f28c97-67eb-5393-8e37-a81d8fda18b3}")
@Guid("96f28c9767eb53938e37a81d8fda18b3")
@WinRTInterface("96f28c9767eb53938e37a81d8fda18b3")
...
public interface IColorAnimationUsingKeyFrames : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IColorAnimationUsingKeyFrames {
    public val __463203075_Ptr: Pointer?

    public val _463203075_VtblPtr: Pointer?
      get() = __463203075_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_KeyFrames(): ColorKeyFrameCollection? {
      val fnPtr = _463203075_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ColorKeyFrameCollection>()
      val hr = fn.invokeHR(arrayOf(__463203075_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_EnableDependentAnimation(): Boolean {
      val fnPtr = _463203075_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_EnableDependentAnimation(value: Boolean): Unit {
      val fnPtr = _463203075_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__463203075_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IColorAnimationUsingKeyFrames_Impl(
    ...
    public override val __463203075_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IColorAnimationUsingKeyFrames, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("96f28c9767eb53938e37a81d8fda18b3")
    ...
    public override fun toNative(obj: IColorAnimationUsingKeyFrames): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__463203075_Ptr))
  }
