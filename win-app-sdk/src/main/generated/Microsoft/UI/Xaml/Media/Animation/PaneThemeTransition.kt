...
@Signature("rc(Microsoft.UI.Xaml.Media.Animation.PaneThemeTransition;{321bcd80-157c-5e10-b0fe-6440bd92529a})")
...
public class PaneThemeTransition(
  ...
  private val __1582247525_Interface: IPaneThemeTransition.WithDefault by lazy {
    as_1582247525()
  }


  public override val __1582247525_Ptr: JNAPointer? by lazy {
    __1582247525_Interface.__1582247525_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1582247525_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1582247525(): IPaneThemeTransition.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<PaneThemeTransition, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.Animation.PaneThemeTransition".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIPaneThemeTransitionStatics(): IPaneThemeTransitionStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.Animation.PaneThemeTransition".toHandle(),refiid,interfacePtr)
      val result =
