...
@Signature("{feaead28-5cd0-5e58-bcea-8670f832aca9}")
@Guid("feaead285cd05e58bcea8670f832aca9")
@WinRTInterface("feaead285cd05e58bcea8670f832aca9")
...
public interface IXamlCompositionBrushBase : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IXamlCompositionBrushBase {
    public val __878065210_Ptr: Pointer?

    public val _878065210_VtblPtr: Pointer?
      get() = __878065210_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_FallbackColor(): Color? {
      val fnPtr = _878065210_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__878065210_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_FallbackColor(value: Color?): Unit {
      val fnPtr = _878065210_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__878065210_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IXamlCompositionBrushBase_Impl(
    ...
    public override val __878065210_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IXamlCompositionBrushBase, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("feaead285cd05e58bcea8670f832aca9")
    ...
    public override fun toNative(obj: IXamlCompositionBrushBase): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__878065210_Ptr))
  }
