...
@Signature("{96cd72fd-d834-5b23-9a17-1548961dc348}")
@Guid("96cd72fdd8345b239a171548961dc348")
@WinRTInterface("96cd72fdd8345b239a171548961dc348")
...
public interface IPointKeyFrameStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPointKeyFrameStatics {
    public val __302659682_Ptr: Pointer?

    public val _302659682_VtblPtr: Pointer?
      get() = __302659682_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ValueProperty(): DependencyProperty? {
      val fnPtr = _302659682_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__302659682_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_KeyTimeProperty(): DependencyProperty? {
      val fnPtr = _302659682_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__302659682_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IPointKeyFrameStatics_Impl(
    ...
    public override val __302659682_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPointKeyFrameStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("96cd72fdd8345b239a171548961dc348")
    ...
    public override fun toNative(obj: IPointKeyFrameStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__302659682_Ptr))
  }
