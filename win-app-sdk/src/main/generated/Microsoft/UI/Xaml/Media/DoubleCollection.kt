...
@Signature("rc(Microsoft.UI.Xaml.Media.DoubleCollection;pinterface({913337e9-11a1-4345-a3a2-4e7f956e222d};f8))")
...
public class DoubleCollection(
  ...
  public object ABI : IABI<DoubleCollection, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.DoubleCollection".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
