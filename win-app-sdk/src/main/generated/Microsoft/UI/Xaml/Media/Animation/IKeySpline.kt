...
@Signature("{130d8b2b-0b52-5253-881b-36ab48592e6b}")
@Guid("130d8b2b0b525253881b36ab48592e6b")
@WinRTInterface("130d8b2b0b525253881b36ab48592e6b")
...
public interface IKeySpline : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IKeySpline {
    public val __2073384075_Ptr: Pointer?

    public val _2073384075_VtblPtr: Pointer?
      get() = __2073384075_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ControlPoint1(): Point? {
      val fnPtr = _2073384075_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Point>()
      val hr = fn.invokeHR(arrayOf(__2073384075_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ControlPoint1(value: Point?): Unit {
      val fnPtr = _2073384075_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2073384075_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_ControlPoint2(): Point? {
      val fnPtr = _2073384075_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Point>()
      val hr = fn.invokeHR(arrayOf(__2073384075_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ControlPoint2(value: Point?): Unit {
      val fnPtr = _2073384075_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2073384075_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IKeySpline_Impl(
    ...
    public override val __2073384075_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IKeySpline, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("130d8b2b0b525253881b36ab48592e6b")
    ...
    public override fun toNative(obj: IKeySpline): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2073384075_Ptr))
  }
