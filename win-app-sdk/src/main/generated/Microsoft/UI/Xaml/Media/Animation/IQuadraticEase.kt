...
@Signature("{db85fda1-03b7-57cd-a1ef-8855cbf62191}")
@Guid("db85fda103b757cda1ef8855cbf62191")
@WinRTInterface("db85fda103b757cda1ef8855cbf62191")
...
public interface IQuadraticEase : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IQuadraticEase {
    public val __194572021_Ptr: Pointer?

    public val _194572021_VtblPtr: Pointer?
      get() = __194572021_Ptr?.getPointer(0)
  }

  public class IQuadraticEase_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __194572021_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IQuadraticEase, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("db85fda103b757cda1ef8855cbf62191")
    ...
    public override fun toNative(obj: IQuadraticEase): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__194572021_Ptr))
  }
