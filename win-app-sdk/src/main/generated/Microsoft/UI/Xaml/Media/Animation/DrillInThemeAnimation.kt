...
@Signature("rc(Microsoft.UI.Xaml.Media.Animation.DrillInThemeAnimation;{097577e0-3027-5f24-af8c-976d9faed830})")
...
public class DrillInThemeAnimation(
  ...
  private val __1954127968_Interface: IDrillInThemeAnimation.WithDefault by lazy {
    as_1954127968()
  }


  public override val __1954127968_Ptr: JNAPointer? by lazy {
    __1954127968_Interface.__1954127968_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1954127968_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1954127968(): IDrillInThemeAnimation.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<DrillInThemeAnimation, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.Animation.DrillInThemeAnimation".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIDrillInThemeAnimationStatics(): IDrillInThemeAnimationStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.Animation.DrillInThemeAnimation".toHandle(),refiid,interfacePtr)
      val result =
