...
@Signature("rc(Microsoft.UI.Xaml.Media.Animation.CommonNavigationTransitionInfo;{b21cc95f-9e3d-540a-b35a-17b99dc41b1e})")
...
public class CommonNavigationTransitionInfo(
  ...
  private val __150341475_Interface: ICommonNavigationTransitionInfo.WithDefault by lazy {
    as_150341475()
  }


  public override val __150341475_Ptr: JNAPointer? by lazy {
    __150341475_Interface.__150341475_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__150341475_Interface)

  public constructor() : this(ABI.activate())

  private fun as_150341475(): ICommonNavigationTransitionInfo.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<CommonNavigationTransitionInfo, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.Animation.CommonNavigationTransitionInfo".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createICommonNavigationTransitionInfoStatics():
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.Animation.CommonNavigationTransitionInfo".toHandle(),refiid,interfacePtr)
      val result =
