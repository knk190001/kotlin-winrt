...
@Signature("{aea80957-bb56-59b6-bb7a-6295f94bc961}")
@Guid("aea80957bb5659b6bb7a6295f94bc961")
@WinRTInterface("aea80957bb5659b6bb7a6295f94bc961")
...
public interface ISplineDoubleKeyFrame : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISplineDoubleKeyFrame {
    public val __472272405_Ptr: Pointer?

    public val _472272405_VtblPtr: Pointer?
      get() = __472272405_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_KeySpline(): KeySpline? {
      val fnPtr = _472272405_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<KeySpline>()
      val hr = fn.invokeHR(arrayOf(__472272405_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_KeySpline(value: KeySpline?): Unit {
      val fnPtr = _472272405_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__472272405_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class ISplineDoubleKeyFrame_Impl(
    ...
    public override val __472272405_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISplineDoubleKeyFrame, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("aea80957bb5659b6bb7a6295f94bc961")
    ...
    public override fun toNative(obj: ISplineDoubleKeyFrame): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__472272405_Ptr))
  }
