...
@Signature("rc(Microsoft.UI.Xaml.Media.GeometryGroup;{b4dde569-ea96-5883-914c-ebb7d818dd3a})")
...
public class GeometryGroup(
  ...
  private val __2081942372_Interface: IGeometryGroup.WithDefault by lazy {
    as_2081942372()
  }


  public override val __2081942372_Ptr: JNAPointer? by lazy {
    __2081942372_Interface.__2081942372_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__2081942372_Interface)

  public constructor() : this(ABI.activate())

  private fun as_2081942372(): IGeometryGroup.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<GeometryGroup, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr = INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.GeometryGroup".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIGeometryGroupStatics(): IGeometryGroupStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.GeometryGroup".toHandle(),refiid,interfacePtr)
