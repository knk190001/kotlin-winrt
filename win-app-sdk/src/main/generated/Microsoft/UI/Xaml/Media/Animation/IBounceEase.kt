...
@Signature("{c138bfff-87c8-5c60-b280-682a499c58c3}")
@Guid("c138bfff87c85c60b280682a499c58c3")
@WinRTInterface("c138bfff87c85c60b280682a499c58c3")
...
public interface IBounceEase : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IBounceEase {
    public val __455310033_Ptr: Pointer?

    public val _455310033_VtblPtr: Pointer?
      get() = __455310033_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Bounces(): Int {
      val fnPtr = _455310033_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__455310033_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Bounces(value: Int): Unit {
      val fnPtr = _455310033_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__455310033_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Bounciness(): Double {
      val fnPtr = _455310033_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Bounciness(value: Double): Unit {
      val fnPtr = _455310033_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__455310033_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IBounceEase_Impl(
    ...
    public override val __455310033_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IBounceEase, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("c138bfff87c85c60b280682a499c58c3")
    ...
    public override fun toNative(obj: IBounceEase): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__455310033_Ptr))
  }
