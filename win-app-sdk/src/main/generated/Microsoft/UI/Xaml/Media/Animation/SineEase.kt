...
@Signature("rc(Microsoft.UI.Xaml.Media.Animation.SineEase;{6115539b-663d-5131-b7c2-74bb5fdc6a1d})")
...
public class SineEase(
  ...
  private val __500345622_Interface: ISineEase.WithDefault by lazy {
    as_500345622()
  }


  public override val __500345622_Ptr: JNAPointer? by lazy {
    __500345622_Interface.__500345622_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__500345622_Interface)

  public constructor() : this(ABI.activate())

  private fun as_500345622(): ISineEase.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<SineEase, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.Animation.SineEase".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
