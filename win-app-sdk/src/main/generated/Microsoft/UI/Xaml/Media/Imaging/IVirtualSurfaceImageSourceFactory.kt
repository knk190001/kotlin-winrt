...
@Signature("{08490f2c-04a8-5031-b9c7-707060d7cd48}")
@Guid("08490f2c04a85031b9c7707060d7cd48")
@WinRTInterface("08490f2c04a85031b9c7707060d7cd48")
...
public interface IVirtualSurfaceImageSourceFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IVirtualSurfaceImageSourceFactory {
    public val __1905169341_Ptr: Pointer?

    public val _1905169341_VtblPtr: Pointer?
      get() = __1905169341_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstanceWithDimensions(pixelWidth: Int, pixelHeight: Int):
        VirtualSurfaceImageSource? {
      val fnPtr = _1905169341_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<VirtualSurfaceImageSource>()
      val hr = fn.invokeHR(arrayOf(__1905169341_Ptr, pixelWidth, pixelHeight, result))
      if (hr.toInt() != 0) {
    ...
    public override fun CreateInstanceWithDimensionsAndOpacity(
      ...
      val fnPtr = _1905169341_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<VirtualSurfaceImageSource>()
      val hr = fn.invokeHR(arrayOf(__1905169341_Ptr, pixelWidth, pixelHeight, isOpaque, result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
      val resultValue = marshalFromNative<VirtualSurfaceImageSource>(result.getValue())
  ...
  public class IVirtualSurfaceImageSourceFactory_Impl(
    ...
    public override val __1905169341_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IVirtualSurfaceImageSourceFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("08490f2c04a85031b9c7707060d7cd48")
    ...
    public override fun toNative(obj: IVirtualSurfaceImageSourceFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1905169341_Ptr))
  }
