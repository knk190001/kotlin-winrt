...
import Microsoft.UI.Xaml.Media.Animation.IColorKeyFrameFactory.ABI.IID
...
@Signature("rc(Microsoft.UI.Xaml.Media.Animation.ColorKeyFrame;{02848c7e-c772-5f66-842b-fd494d0da669})")
...
public open class ColorKeyFrame(
  ...
  private val __1291820874_Interface: IColorKeyFrame.WithDefault by lazy {
    as_1291820874()
  }


  public override val __1291820874_Ptr: JNAPointer? by lazy {
    __1291820874_Interface.__1291820874_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1291820874_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1291820874(): IColorKeyFrame.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<ColorKeyFrame, MemoryAddress> {
    ...
    public fun createIColorKeyFrameStatics(): IColorKeyFrameStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.Animation.ColorKeyFrame".toHandle(),refiid,interfacePtr)
    ...
    public fun createIColorKeyFrameFactory(): IColorKeyFrameFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.Animation.ColorKeyFrame".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
