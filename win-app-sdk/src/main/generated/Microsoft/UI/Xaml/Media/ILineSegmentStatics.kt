...
@Signature("{c3ec48a9-b9c0-561f-9925-d1d1b2a6bae6}")
@Guid("c3ec48a9b9c0561f9925d1d1b2a6bae6")
@WinRTInterface("c3ec48a9b9c0561f9925d1d1b2a6bae6")
...
public interface ILineSegmentStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ILineSegmentStatics {
    public val __1936209943_Ptr: Pointer?

    public val _1936209943_VtblPtr: Pointer?
      get() = __1936209943_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_PointProperty(): DependencyProperty? {
      val fnPtr = _1936209943_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1936209943_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ILineSegmentStatics_Impl(
    ...
    public override val __1936209943_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ILineSegmentStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("c3ec48a9b9c0561f9925d1d1b2a6bae6")
    ...
    public override fun toNative(obj: ILineSegmentStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1936209943_Ptr))
  }
