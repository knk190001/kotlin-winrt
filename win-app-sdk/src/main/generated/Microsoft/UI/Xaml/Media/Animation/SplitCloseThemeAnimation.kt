...
@Signature("rc(Microsoft.UI.Xaml.Media.Animation.SplitCloseThemeAnimation;{b0dd1490-f646-5c18-b3ef-02f9b17f57df})")
...
public class SplitCloseThemeAnimation(
  ...
  private val __1400065876_Interface: ISplitCloseThemeAnimation.WithDefault by lazy {
    as_1400065876()
  }


  public override val __1400065876_Ptr: JNAPointer? by lazy {
    __1400065876_Interface.__1400065876_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1400065876_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1400065876(): ISplitCloseThemeAnimation.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<SplitCloseThemeAnimation, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.Animation.SplitCloseThemeAnimation".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createISplitCloseThemeAnimationStatics(): ISplitCloseThemeAnimationStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.Animation.SplitCloseThemeAnimation".toHandle(),refiid,interfacePtr)
      val result =
