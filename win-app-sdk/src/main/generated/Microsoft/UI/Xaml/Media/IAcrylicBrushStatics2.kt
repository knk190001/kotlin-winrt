...
@Signature("{6e3eb0bd-20a1-52ea-aede-478061012279}")
@Guid("6e3eb0bd20a152eaaede478061012279")
@WinRTInterface("6e3eb0bd20a152eaaede478061012279")
...
public interface IAcrylicBrushStatics2 : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IAcrylicBrushStatics2 {
    public val __1075638501_Ptr: Pointer?

    public val _1075638501_VtblPtr: Pointer?
      get() = __1075638501_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_TintLuminosityOpacityProperty(): DependencyProperty? {
      val fnPtr = _1075638501_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1075638501_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IAcrylicBrushStatics2_Impl(
    ...
    public override val __1075638501_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IAcrylicBrushStatics2, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("6e3eb0bd20a152eaaede478061012279")
    ...
    public override fun toNative(obj: IAcrylicBrushStatics2): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1075638501_Ptr))
  }
