...
@Signature("rc(Microsoft.UI.Xaml.Media.Media3D.Matrix3DHelper;{d2909be1-9c28-5b38-b63c-88e838644533})")
...
public class Matrix3DHelper(
  ...
  private val __590621322_Interface: IMatrix3DHelper.WithDefault by lazy {
    as_590621322()
  }


  public override val __590621322_Ptr: JNAPointer? by lazy {
    __590621322_Interface.__590621322_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__590621322_Interface)

  private fun as_590621322(): IMatrix3DHelper.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<Matrix3DHelper, MemoryAddress> {
    ...
    public fun createIMatrix3DHelperStatics(): IMatrix3DHelperStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.Media3D.Matrix3DHelper".toHandle(),refiid,interfacePtr)
