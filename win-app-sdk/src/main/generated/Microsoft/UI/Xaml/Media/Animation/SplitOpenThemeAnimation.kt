...
@Signature("rc(Microsoft.UI.Xaml.Media.Animation.SplitOpenThemeAnimation;{79fdfaca-4245-53f0-b5c7-da1ce2b0b851})")
...
public class SplitOpenThemeAnimation(
  ...
  private val __1854319876_Interface: ISplitOpenThemeAnimation.WithDefault by lazy {
    as_1854319876()
  }


  public override val __1854319876_Ptr: JNAPointer? by lazy {
    __1854319876_Interface.__1854319876_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1854319876_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1854319876(): ISplitOpenThemeAnimation.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<SplitOpenThemeAnimation, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.Animation.SplitOpenThemeAnimation".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createISplitOpenThemeAnimationStatics(): ISplitOpenThemeAnimationStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.Animation.SplitOpenThemeAnimation".toHandle(),refiid,interfacePtr)
      val result =
