...
@Signature("{ec16a555-c083-5a18-805b-a14b90bc80e2}")
@Guid("ec16a555c0835a18805ba14b90bc80e2")
@WinRTInterface("ec16a555c0835a18805ba14b90bc80e2")
...
public interface IDiscreteDoubleKeyFrame : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IDiscreteDoubleKeyFrame {
    public val __634169427_Ptr: Pointer?

    public val _634169427_VtblPtr: Pointer?
      get() = __634169427_Ptr?.getPointer(0)
  }

  public class IDiscreteDoubleKeyFrame_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __634169427_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IDiscreteDoubleKeyFrame, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("ec16a555c0835a18805ba14b90bc80e2")
    ...
    public override fun toNative(obj: IDiscreteDoubleKeyFrame): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__634169427_Ptr))
  }
