...
@Signature("rc(Microsoft.UI.Xaml.Media.PathFigure;{0ee00712-bf65-5f27-9c06-14abdf6656d7})")
@WinRTByReference(brClass = PathFigure.ByReference::class)
public class PathFigure(
  ptr: JNAPointer? = NULL
) : DependencyObject(ptr), IPathFigure.WithDefault, IWinRTObject {
  private val __261986906_Interface: IPathFigure.WithDefault by lazy {
    as_261986906()
  }


  public override val __261986906_Ptr: JNAPointer? by lazy {
    __261986906_Interface.__261986906_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__261986906_Interface)

  public constructor() : this(ABI.activate())

  private fun as_261986906(): IPathFigure.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<PathFigure, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr = INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.PathFigure".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIPathFigureStatics(): IPathFigureStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.PathFigure".toHandle(),refiid,interfacePtr)
