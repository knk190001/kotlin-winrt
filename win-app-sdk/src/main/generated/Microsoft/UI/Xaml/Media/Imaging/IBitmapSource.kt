...
@Signature("{8424269d-9b82-534f-8fea-af5b5ef96bf2}")
@Guid("8424269d9b82534f8feaaf5b5ef96bf2")
@WinRTInterface("8424269d9b82534f8feaaf5b5ef96bf2")
...
public interface IBitmapSource : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IBitmapSource {
    public val __1369504209_Ptr: Pointer?

    public val _1369504209_VtblPtr: Pointer?
      get() = __1369504209_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_PixelWidth(): Int {
      val fnPtr = _1369504209_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__1369504209_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_PixelHeight(): Int {
      val fnPtr = _1369504209_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__1369504209_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun SetSource(streamSource: IRandomAccessStream?): Unit {
      val fnPtr = _1369504209_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1369504209_Ptr, marshalToNative(streamSource),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun SetSourceAsync(streamSource: IRandomAccessStream?): IAsyncAction? {
      val fnPtr = _1369504209_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IAsyncAction>()
      val hr = fn.invokeHR(arrayOf(__1369504209_Ptr, marshalToNative(streamSource), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
  ...
  public class IBitmapSource_Impl(
    ...
    public override val __1369504209_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IBitmapSource, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("8424269d9b82534f8feaaf5b5ef96bf2")
    ...
    public override fun toNative(obj: IBitmapSource): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1369504209_Ptr))
  }
