...
@Signature("rc(Microsoft.UI.Xaml.Media.Imaging.SoftwareBitmapSource;{a6aca802-1f24-5a1e-bf08-781a85ed5511})")
...
public class SoftwareBitmapSource(
  ...
  private val __1222694424_Interface: ISoftwareBitmapSource.WithDefault by lazy {
    as_1222694424()
  }
  ...
  public override val __1222694424_Ptr: JNAPointer? by lazy {
    __1222694424_Interface.__1222694424_Ptr
  }
  ...
  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1222694424_Interface, __1260617006_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1222694424(): ISoftwareBitmapSource.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<SoftwareBitmapSource, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.Imaging.SoftwareBitmapSource".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
