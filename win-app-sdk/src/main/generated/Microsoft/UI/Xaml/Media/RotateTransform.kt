...
@Signature("rc(Microsoft.UI.Xaml.Media.RotateTransform;{d4686e7c-a374-5cac-8927-0ef07c5b254d})")
...
public class RotateTransform(
  ...
  private val __1338768384_Interface: IRotateTransform.WithDefault by lazy {
    as_1338768384()
  }


  public override val __1338768384_Ptr: JNAPointer? by lazy {
    __1338768384_Interface.__1338768384_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1338768384_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1338768384(): IRotateTransform.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<RotateTransform, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr = INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.RotateTransform".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIRotateTransformStatics(): IRotateTransformStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Media.RotateTransform".toHandle(),refiid,interfacePtr)
