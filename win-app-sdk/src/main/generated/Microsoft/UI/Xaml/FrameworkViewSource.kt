...
@Signature("rc(Microsoft.UI.Xaml.FrameworkViewSource;{52b5d975-6fa6-5b66-a248-d17443b2bca0})")
...
public class FrameworkViewSource(
  ...
  private val __1180296215_Interface: IFrameworkViewSource.WithDefault by lazy {
    as_1180296215()
  }
  ...
  public override val __1180296215_Ptr: JNAPointer? by lazy {
    __1180296215_Interface.__1180296215_Ptr
  }
  ...
  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1180296215_Interface, __422737506_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1180296215(): IFrameworkViewSource.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<FrameworkViewSource, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr = INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.FrameworkViewSource".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
