...
@Signature("{bd3f2272-3efa-5f92-b759-90b1cc3e784c}")
@Guid("bd3f22723efa5f92b75990b1cc3e784c")
@WinRTInterface("bd3f22723efa5f92b75990b1cc3e784c")
...
public interface IFrameworkElementFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IFrameworkElementFactory {
    public val __286156773_Ptr: Pointer?

    public val _286156773_VtblPtr: Pointer?
      get() = __286156773_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        FrameworkElement? {
      val fnPtr = _286156773_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<FrameworkElement>()
      val hr = fn.invokeHR(arrayOf(__286156773_Ptr, marshalToNative(baseInterface),
  ...
  public class IFrameworkElementFactory_Impl(
    ...
    public override val __286156773_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IFrameworkElementFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("bd3f22723efa5f92b75990b1cc3e784c")
    ...
    public override fun toNative(obj: IFrameworkElementFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__286156773_Ptr))
  }
