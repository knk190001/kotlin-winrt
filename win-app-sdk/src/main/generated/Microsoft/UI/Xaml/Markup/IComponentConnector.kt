...
@Signature("{ad401812-b091-51d0-b915-2d682cd2af10}")
@Guid("ad401812b09151d0b9152d682cd2af10")
@WinRTInterface("ad401812b09151d0b9152d682cd2af10")
...
public interface IComponentConnector : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IComponentConnector {
    public val __1129486885_Ptr: Pointer?

    public val _1129486885_VtblPtr: Pointer?
      get() = __1129486885_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun Connect(connectionId: Int, target: IUnknown?): Unit {
      val fnPtr = _1129486885_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1129486885_Ptr, connectionId, marshalToNative(target),))
      if (hr.toInt() != 0) {
    ...
    public override fun GetBindingConnector(connectionId: Int, target: IUnknown?):
        IComponentConnector? {
      val fnPtr = _1129486885_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IComponentConnector>()
      val hr = fn.invokeHR(arrayOf(__1129486885_Ptr, connectionId, marshalToNative(target), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
  ...
  public class IComponentConnector_Impl(
    ...
    public override val __1129486885_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IComponentConnector, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("ad401812b09151d0b9152d682cd2af10")
    ...
    public override fun toNative(obj: IComponentConnector): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1129486885_Ptr))
  }
