...
@Signature("{82a4cd9e-435e-5aeb-8c4f-300cece45cae}")
@Guid("82a4cd9e435e5aeb8c4f300cece45cae")
@WinRTInterface("82a4cd9e435e5aeb8c4f300cece45cae")
...
public interface IXamlReaderStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IXamlReaderStatics {
    public val __882054949_Ptr: Pointer?

    public val _882054949_VtblPtr: Pointer?
      get() = __882054949_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun Load(xaml: String?): IUnknown? {
      val fnPtr = _882054949_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IUnknown>()
      val hr = fn.invokeHR(arrayOf(__882054949_Ptr, marshalToNative(xaml), result))
      if (hr.toInt() != 0) {
    ...
    public override fun LoadWithInitialTemplateValidation(xaml: String?): IUnknown? {
      val fnPtr = _882054949_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IUnknown>()
      val hr = fn.invokeHR(arrayOf(__882054949_Ptr, marshalToNative(xaml), result))
      if (hr.toInt() != 0) {
  ...
  public class IXamlReaderStatics_Impl(
    ...
    public override val __882054949_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IXamlReaderStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("82a4cd9e435e5aeb8c4f300cece45cae")
    ...
    public override fun toNative(obj: IXamlReaderStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__882054949_Ptr))
  }
