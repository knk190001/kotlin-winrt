...
@Signature("{774907fc-c846-517f-abcc-c3f7e8c3ffc9}")
@Guid("774907fcc846517fabccc3f7e8c3ffc9")
@WinRTInterface("774907fcc846517fabccc3f7e8c3ffc9")
...
public interface IXamlBinaryWriterStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IXamlBinaryWriterStatics {
    public val __1028893876_Ptr: Pointer?

    public val _1028893876_VtblPtr: Pointer?
      get() = __1028893876_Ptr?.getPointer(0)
    ...
    public override fun Write(
      ...
      val fnPtr = _1028893876_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<XamlBinaryWriterErrorInformation>()
      val hr = fn.invokeHR(arrayOf(__1028893876_Ptr, marshalToNative(inputStreams),
  ...
  public class IXamlBinaryWriterStatics_Impl(
    ...
    public override val __1028893876_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IXamlBinaryWriterStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("774907fcc846517fabccc3f7e8c3ffc9")
    ...
    public override fun toNative(obj: IXamlBinaryWriterStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1028893876_Ptr))
  }
