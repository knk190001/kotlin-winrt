...
@Signature("{d9a0f6e3-c6cc-5cb6-8999-85788701f339}")
@Guid("d9a0f6e3c6cc5cb6899985788701f339")
@WinRTInterface("d9a0f6e3c6cc5cb6899985788701f339")
...
public interface IXamlMarkupHelperStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IXamlMarkupHelperStatics {
    public val __1374902702_Ptr: Pointer?

    public val _1374902702_VtblPtr: Pointer?
      get() = __1374902702_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun UnloadObject(element: DependencyObject?): Unit {
      val fnPtr = _1374902702_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1374902702_Ptr, marshalToNative(element),))
      if (hr.toInt() != 0) {
  ...
  public class IXamlMarkupHelperStatics_Impl(
    ...
    public override val __1374902702_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IXamlMarkupHelperStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("d9a0f6e3c6cc5cb6899985788701f339")
    ...
    public override fun toNative(obj: IXamlMarkupHelperStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1374902702_Ptr))
  }
