...
@Signature("{a96251f0-2214-5d53-8746-ce99a2593cd7}")
@Guid("a96251f022145d538746ce99a2593cd7")
@WinRTInterface("a96251f022145d538746ce99a2593cd7")
...
public interface IXamlMetadataProvider : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IXamlMetadataProvider {
    public val __103617981_Ptr: Pointer?

    public val _103617981_VtblPtr: Pointer?
      get() = __103617981_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun GetXamlType(type: TypeName?): IXamlType? {
      val fnPtr = _103617981_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IXamlType>()
      val hr = fn.invokeHR(arrayOf(__103617981_Ptr, marshalToNative(type), result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetXamlType(fullName: String?): IXamlType? {
      val fnPtr = _103617981_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IXamlType>()
      val hr = fn.invokeHR(arrayOf(__103617981_Ptr, marshalToNative(fullName), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
      val resultValue = marshalFromNative<IXamlType>(result.getValue())
    ...
    public override fun GetXmlnsDefinitions(): Array<XmlnsDefinition?>? {
      val fnPtr = _103617981_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeOutArray<XmlnsDefinition>()
      val hr = fn.invokeHR(arrayOf(__103617981_Ptr,  result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
  ...
  public class IXamlMetadataProvider_Impl(
    ...
    public override val __103617981_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IXamlMetadataProvider, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("a96251f022145d538746ce99a2593cd7")
    ...
    public override fun toNative(obj: IXamlMetadataProvider): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__103617981_Ptr))
  }
