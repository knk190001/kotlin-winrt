...
@Signature("{cd677310-3b06-5a13-b31a-401849570858}")
@Guid("cd6773103b065a13b31a401849570858")
@WinRTInterface("cd6773103b065a13b31a401849570858")
...
public interface IXamlMarkupHelper : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IXamlMarkupHelper {
    public val __543331853_Ptr: Pointer?

    public val _543331853_VtblPtr: Pointer?
      get() = __543331853_Ptr?.getPointer(0)
  }

  public class IXamlMarkupHelper_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __543331853_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IXamlMarkupHelper, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("cd6773103b065a13b31a401849570858")
    ...
    public override fun toNative(obj: IXamlMarkupHelper): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__543331853_Ptr))
  }
