...
@Signature("{1743ddf7-38ba-58c9-a2a6-b0ae28713bee}")
@Guid("1743ddf738ba58c9a2a6b0ae28713bee")
@WinRTInterface("1743ddf738ba58c9a2a6b0ae28713bee")
...
public interface IDataTemplateComponent : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IDataTemplateComponent {
    public val __17121116_Ptr: Pointer?

    public val _17121116_VtblPtr: Pointer?
      get() = __17121116_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun Recycle(): Unit {
      val fnPtr = _17121116_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__17121116_Ptr, ))
      if (hr.toInt() != 0) {
    ...
    public override fun ProcessBindings(
      ...
      val fnPtr = _17121116_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__17121116_Ptr, marshalToNative(item), itemIndex, phase,
          nextPhase,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
  ...
  public class IDataTemplateComponent_Impl(
    ...
    public override val __17121116_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IDataTemplateComponent, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("1743ddf738ba58c9a2a6b0ae28713bee")
    ...
    public override fun toNative(obj: IDataTemplateComponent): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__17121116_Ptr))
  }
