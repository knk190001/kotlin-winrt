...
@Signature("{54ce54c8-38c6-50d9-ac98-4b03eddbde9f}")
@Guid("54ce54c838c650d9ac984b03eddbde9f")
@WinRTInterface("54ce54c838c650d9ac984b03eddbde9f")
...
public interface IXamlReader : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IXamlReader {
    public val __367398784_Ptr: Pointer?

    public val _367398784_VtblPtr: Pointer?
      get() = __367398784_Ptr?.getPointer(0)
  }

  public class IXamlReader_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __367398784_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IXamlReader, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("54ce54c838c650d9ac984b03eddbde9f")
    ...
    public override fun toNative(obj: IXamlReader): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__367398784_Ptr))
  }
