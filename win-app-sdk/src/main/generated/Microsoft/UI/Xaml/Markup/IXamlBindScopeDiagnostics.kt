...
@Signature("{3ea84e4e-fdfe-55a8-a561-edf5697846d7}")
@Guid("3ea84e4efdfe55a8a561edf5697846d7")
@WinRTInterface("3ea84e4efdfe55a8a561edf5697846d7")
...
public interface IXamlBindScopeDiagnostics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IXamlBindScopeDiagnostics {
    public val __1939956206_Ptr: Pointer?

    public val _1939956206_VtblPtr: Pointer?
      get() = __1939956206_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun Disable(lineNumber: Int, columnNumber: Int): Unit {
      val fnPtr = _1939956206_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1939956206_Ptr, lineNumber, columnNumber,))
      if (hr.toInt() != 0) {
  ...
  public class IXamlBindScopeDiagnostics_Impl(
    ...
    public override val __1939956206_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IXamlBindScopeDiagnostics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("3ea84e4efdfe55a8a561edf5697846d7")
    ...
    public override fun toNative(obj: IXamlBindScopeDiagnostics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1939956206_Ptr))
  }
