...
@Signature("{bf3a2913-5c63-50ec-8660-61809be7b9b9}")
@Guid("bf3a29135c6350ec866061809be7b9b9")
@WinRTInterface("bf3a29135c6350ec866061809be7b9b9")
...
public interface IXamlMember : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IXamlMember {
    public val __510188969_Ptr: Pointer?

    public val _510188969_VtblPtr: Pointer?
      get() = __510188969_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_IsAttachable(): Boolean {
      val fnPtr = _510188969_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__510188969_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsDependencyProperty(): Boolean {
      val fnPtr = _510188969_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__510188969_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsReadOnly(): Boolean {
      val fnPtr = _510188969_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__510188969_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Name(): String? {
      val fnPtr = _510188969_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_TargetType(): IXamlType? {
      val fnPtr = _510188969_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_Type(): IXamlType? {
      val fnPtr = _510188969_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IXamlType>()
      val hr = fn.invokeHR(arrayOf(__510188969_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetValue(instance: IUnknown?): IUnknown? {
      val fnPtr = _510188969_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IUnknown>()
      val hr = fn.invokeHR(arrayOf(__510188969_Ptr, marshalToNative(instance), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun SetValue(instance: IUnknown?, value: IUnknown?): Unit {
      val fnPtr = _510188969_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__510188969_Ptr, marshalToNative(instance),
  ...
  public class IXamlMember_Impl(
    ...
    public override val __510188969_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IXamlMember, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("bf3a29135c6350ec866061809be7b9b9")
    ...
    public override fun toNative(obj: IXamlMember): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__510188969_Ptr))
  }
