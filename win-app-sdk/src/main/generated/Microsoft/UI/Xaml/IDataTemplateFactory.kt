...
@Signature("{d8e8249d-305b-5ca5-acf8-3e1beffd0219}")
@Guid("d8e8249d305b5ca5acf83e1beffd0219")
@WinRTInterface("d8e8249d305b5ca5acf83e1beffd0219")
...
public interface IDataTemplateFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IDataTemplateFactory {
    public val __1414735233_Ptr: Pointer?

    public val _1414735233_VtblPtr: Pointer?
      get() = __1414735233_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        DataTemplate? {
      val fnPtr = _1414735233_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DataTemplate>()
      val hr = fn.invokeHR(arrayOf(__1414735233_Ptr, marshalToNative(baseInterface),
  ...
  public class IDataTemplateFactory_Impl(
    ...
    public override val __1414735233_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IDataTemplateFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("d8e8249d305b5ca5acf83e1beffd0219")
    ...
    public override fun toNative(obj: IDataTemplateFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1414735233_Ptr))
  }
