...
@Signature("{b3644425-9464-5434-b0ae-aff8d3159fe1}")
@Guid("b364442594645434b0aeaff8d3159fe1")
@WinRTInterface("b364442594645434b0aeaff8d3159fe1")
...
public interface IPropertyMetadata : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPropertyMetadata {
    public val __347103851_Ptr: Pointer?

    public val _347103851_VtblPtr: Pointer?
      get() = __347103851_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_DefaultValue(): IUnknown? {
      val fnPtr = _347103851_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IUnknown>()
      val hr = fn.invokeHR(arrayOf(__347103851_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_CreateDefaultValueCallback(): CreateDefaultValueCallback? {
      val fnPtr = _347103851_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class IPropertyMetadata_Impl(
    ...
    public override val __347103851_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPropertyMetadata, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("b364442594645434b0aeaff8d3159fe1")
    ...
    public override fun toNative(obj: IPropertyMetadata): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__347103851_Ptr))
  }
