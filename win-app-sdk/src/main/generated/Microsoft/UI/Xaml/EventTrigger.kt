...
@Signature("rc(Microsoft.UI.Xaml.EventTrigger;{8c6f0541-c6ac-5f27-9d45-cf8bdbdfabe6})")
@WinRTByReference(brClass = EventTrigger.ByReference::class)
public class EventTrigger(
  ptr: JNAPointer? = NULL
) : TriggerBase(ptr), IEventTrigger.WithDefault, IWinRTObject {
  private val __1419526267_Interface: IEventTrigger.WithDefault by lazy {
    as_1419526267()
  }


  public override val __1419526267_Ptr: JNAPointer? by lazy {
    __1419526267_Interface.__1419526267_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1419526267_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1419526267(): IEventTrigger.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<EventTrigger, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr = INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.EventTrigger".toHandle(), refiid,
          iAFPtr)
      checkHR(hr)
