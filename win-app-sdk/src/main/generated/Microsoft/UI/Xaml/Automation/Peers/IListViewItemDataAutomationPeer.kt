...
@Signature("{88bb28d3-45ed-5415-825f-dd2da536c968}")
@Guid("88bb28d345ed5415825fdd2da536c968")
@WinRTInterface("88bb28d345ed5415825fdd2da536c968")
...
public interface IListViewItemDataAutomationPeer : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IListViewItemDataAutomationPeer {
    public val __1823401924_Ptr: Pointer?

    public val _1823401924_VtblPtr: Pointer?
      get() = __1823401924_Ptr?.getPointer(0)
  }

  public class IListViewItemDataAutomationPeer_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __1823401924_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IListViewItemDataAutomationPeer, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("88bb28d345ed5415825fdd2da536c968")
    ...
    public override fun toNative(obj: IListViewItemDataAutomationPeer): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1823401924_Ptr))
  }
