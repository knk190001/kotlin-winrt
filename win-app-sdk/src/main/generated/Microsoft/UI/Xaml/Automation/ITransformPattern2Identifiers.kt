...
@Signature("{6ef7595c-db8c-51b0-878b-34b7ef12f4da}")
@Guid("6ef7595cdb8c51b0878b34b7ef12f4da")
@WinRTInterface("6ef7595cdb8c51b0878b34b7ef12f4da")
...
public interface ITransformPattern2Identifiers : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITransformPattern2Identifiers {
    public val __320421730_Ptr: Pointer?

    public val _320421730_VtblPtr: Pointer?
      get() = __320421730_Ptr?.getPointer(0)
  }

  public class ITransformPattern2Identifiers_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __320421730_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITransformPattern2Identifiers, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("6ef7595cdb8c51b0878b34b7ef12f4da")
    ...
    public override fun toNative(obj: ITransformPattern2Identifiers): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__320421730_Ptr))
  }
