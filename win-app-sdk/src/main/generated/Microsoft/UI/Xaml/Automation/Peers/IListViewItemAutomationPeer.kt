...
@Signature("{de487f2c-5a61-599e-b9ff-0fd7675d7af3}")
@Guid("de487f2c5a61599eb9ff0fd7675d7af3")
@WinRTInterface("de487f2c5a61599eb9ff0fd7675d7af3")
...
public interface IListViewItemAutomationPeer : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IListViewItemAutomationPeer {
    public val __1980997006_Ptr: Pointer?

    public val _1980997006_VtblPtr: Pointer?
      get() = __1980997006_Ptr?.getPointer(0)
  }

  public class IListViewItemAutomationPeer_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __1980997006_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IListViewItemAutomationPeer, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("de487f2c5a61599eb9ff0fd7675d7af3")
    ...
    public override fun toNative(obj: IListViewItemAutomationPeer): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1980997006_Ptr))
  }
