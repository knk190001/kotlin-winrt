...
@Signature("{7789f700-d565-5dc7-8bcc-d459a4c08fd6}")
@Guid("7789f700d5655dc78bccd459a4c08fd6")
@WinRTInterface("7789f700d5655dc78bccd459a4c08fd6")
...
public interface IToggleMenuFlyoutItemAutomationPeerFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IToggleMenuFlyoutItemAutomationPeerFactory {
    public val __141285043_Ptr: Pointer?

    public val _141285043_VtblPtr: Pointer?
      get() = __141285043_Ptr?.getPointer(0)
    ...
    public override fun CreateInstanceWithOwner(
      ...
      val fnPtr = _141285043_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ToggleMenuFlyoutItemAutomationPeer>()
      val hr = fn.invokeHR(arrayOf(__141285043_Ptr, marshalToNative(owner),
  ...
  public class IToggleMenuFlyoutItemAutomationPeerFactory_Impl(
    ...
    public override val __141285043_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IToggleMenuFlyoutItemAutomationPeerFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("7789f700d5655dc78bccd459a4c08fd6")
    ...
    public override fun toNative(obj: IToggleMenuFlyoutItemAutomationPeerFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__141285043_Ptr))
  }
