...
@Signature("{65b69b50-cbc3-5ae7-bf9c-2794fe56c6b3}")
@Guid("65b69b50cbc35ae7bf9c2794fe56c6b3")
@WinRTInterface("65b69b50cbc35ae7bf9c2794fe56c6b3")
...
public interface IComboBoxItemDataAutomationPeer : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IComboBoxItemDataAutomationPeer {
    public val __94609846_Ptr: Pointer?

    public val _94609846_VtblPtr: Pointer?
      get() = __94609846_Ptr?.getPointer(0)
  }

  public class IComboBoxItemDataAutomationPeer_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __94609846_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IComboBoxItemDataAutomationPeer, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("65b69b50cbc35ae7bf9c2794fe56c6b3")
    ...
    public override fun toNative(obj: IComboBoxItemDataAutomationPeer): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__94609846_Ptr))
  }
