...
@Signature("{2c272096-21e0-5714-9164-1f6a1e0b2181}")
@Guid("2c27209621e0571491641f6a1e0b2181")
@WinRTInterface("2c27209621e0571491641f6a1e0b2181")
...
public interface IToggleButtonAutomationPeerFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IToggleButtonAutomationPeerFactory {
    public val __121593176_Ptr: Pointer?

    public val _121593176_VtblPtr: Pointer?
      get() = __121593176_Ptr?.getPointer(0)
    ...
    public override fun CreateInstanceWithOwner(
      ...
      val fnPtr = _121593176_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ToggleButtonAutomationPeer>()
      val hr = fn.invokeHR(arrayOf(__121593176_Ptr, marshalToNative(owner),
  ...
  public class IToggleButtonAutomationPeerFactory_Impl(
    ...
    public override val __121593176_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IToggleButtonAutomationPeerFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("2c27209621e0571491641f6a1e0b2181")
    ...
    public override fun toNative(obj: IToggleButtonAutomationPeerFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__121593176_Ptr))
  }
