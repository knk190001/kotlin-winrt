...
import Microsoft.UI.Xaml.Automation.Peers.IAppBarButtonAutomationPeerFactory.ABI.IID
...
@Signature("rc(Microsoft.UI.Xaml.Automation.Peers.AppBarButtonAutomationPeer;{439efdb4-141b-5fff-8723-03e6e69f6b36})")
...
public open class AppBarButtonAutomationPeer(
  ...
  private val __1041435680_Interface: IAppBarButtonAutomationPeer.WithDefault by lazy {
    as_1041435680()
  }
  ...
  public override val __1041435680_Ptr: JNAPointer? by lazy {
    __1041435680_Interface.__1041435680_Ptr
  }
  ...
  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1041435680_Interface, __1578214981_Interface)

  public constructor(owner: AppBarButton) : this(ABI.activate(owner))

  private fun as_1041435680(): IAppBarButtonAutomationPeer.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<AppBarButtonAutomationPeer, MemoryAddress> {
    ...
    public fun createIAppBarButtonAutomationPeerFactory(): IAppBarButtonAutomationPeerFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Automation.Peers.AppBarButtonAutomationPeer".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
