...
@Signature("{2438268a-62e8-5d61-95d0-d36f6b42e652}")
@Guid("2438268a62e85d6195d0d36f6b42e652")
@WinRTInterface("2438268a62e85d6195d0d36f6b42e652")
...
public interface ITimePickerFlyoutPresenterAutomationPeer : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITimePickerFlyoutPresenterAutomationPeer {
    public val __867975336_Ptr: Pointer?

    public val _867975336_VtblPtr: Pointer?
      get() = __867975336_Ptr?.getPointer(0)
  }

  public class ITimePickerFlyoutPresenterAutomationPeer_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __867975336_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITimePickerFlyoutPresenterAutomationPeer, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("2438268a62e85d6195d0d36f6b42e652")
    ...
    public override fun toNative(obj: ITimePickerFlyoutPresenterAutomationPeer): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__867975336_Ptr))
  }
