...
@Signature("{d84fe7b9-f5f5-5122-b41c-5575a799d581}")
@Guid("d84fe7b9f5f55122b41c5575a799d581")
@WinRTInterface("d84fe7b9f5f55122b41c5575a799d581")
...
public interface ISelectorAutomationPeerFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISelectorAutomationPeerFactory {
    public val __341951119_Ptr: Pointer?

    public val _341951119_VtblPtr: Pointer?
      get() = __341951119_Ptr?.getPointer(0)
    ...
    public override fun CreateInstanceWithOwner(
      ...
      val fnPtr = _341951119_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<SelectorAutomationPeer>()
      val hr = fn.invokeHR(arrayOf(__341951119_Ptr, marshalToNative(owner),
  ...
  public class ISelectorAutomationPeerFactory_Impl(
    ...
    public override val __341951119_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISelectorAutomationPeerFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("d84fe7b9f5f55122b41c5575a799d581")
    ...
    public override fun toNative(obj: ISelectorAutomationPeerFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__341951119_Ptr))
  }
