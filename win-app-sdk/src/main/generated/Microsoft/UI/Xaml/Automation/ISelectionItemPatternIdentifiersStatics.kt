...
@Signature("{2b8ead7c-4e03-5b84-9e34-8b7384cbd862}")
@Guid("2b8ead7c4e035b849e348b7384cbd862")
@WinRTInterface("2b8ead7c4e035b849e348b7384cbd862")
...
public interface ISelectionItemPatternIdentifiersStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISelectionItemPatternIdentifiersStatics {
    public val __1039938354_Ptr: Pointer?

    public val _1039938354_VtblPtr: Pointer?
      get() = __1039938354_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_IsSelectedProperty(): AutomationProperty? {
      val fnPtr = _1039938354_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AutomationProperty>()
      val hr = fn.invokeHR(arrayOf(__1039938354_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_SelectionContainerProperty(): AutomationProperty? {
      val fnPtr = _1039938354_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AutomationProperty>()
      val hr = fn.invokeHR(arrayOf(__1039938354_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ISelectionItemPatternIdentifiersStatics_Impl(
    ...
    public override val __1039938354_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISelectionItemPatternIdentifiersStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("2b8ead7c4e035b849e348b7384cbd862")
    ...
    public override fun toNative(obj: ISelectionItemPatternIdentifiersStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1039938354_Ptr))
  }
