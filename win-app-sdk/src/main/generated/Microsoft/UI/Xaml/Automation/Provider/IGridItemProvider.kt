...
@Signature("{d2557a0e-6909-5170-a680-60728df339b4}")
@Guid("d2557a0e69095170a68060728df339b4")
@WinRTInterface("d2557a0e69095170a68060728df339b4")
...
public interface IGridItemProvider : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IGridItemProvider {
    public val __2092436759_Ptr: Pointer?

    public val _2092436759_VtblPtr: Pointer?
      get() = __2092436759_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Column(): Int {
      val fnPtr = _2092436759_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__2092436759_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ColumnSpan(): Int {
      val fnPtr = _2092436759_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__2092436759_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ContainingGrid(): IRawElementProviderSimple? {
      val fnPtr = _2092436759_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_Row(): Int {
      val fnPtr = _2092436759_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__2092436759_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_RowSpan(): Int {
      val fnPtr = _2092436759_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__2092436759_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IGridItemProvider_Impl(
    ...
    public override val __2092436759_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IGridItemProvider, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("d2557a0e69095170a68060728df339b4")
    ...
    public override fun toNative(obj: IGridItemProvider): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2092436759_Ptr))
  }
