...
@Signature("{1ebf0f7f-6111-50a5-8398-89c4fdd0dedb}")
@Guid("1ebf0f7f611150a5839889c4fdd0dedb")
@WinRTInterface("1ebf0f7f611150a5839889c4fdd0dedb")
...
public interface ITreeViewListAutomationPeer : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITreeViewListAutomationPeer {
    public val __1093727299_Ptr: Pointer?

    public val _1093727299_VtblPtr: Pointer?
      get() = __1093727299_Ptr?.getPointer(0)
  }

  public class ITreeViewListAutomationPeer_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __1093727299_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITreeViewListAutomationPeer, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("1ebf0f7f611150a5839889c4fdd0dedb")
    ...
    public override fun toNative(obj: ITreeViewListAutomationPeer): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1093727299_Ptr))
  }
