...
@Signature("{9b22e7ea-6f7a-5c05-8072-5bddf54f9bda}")
@Guid("9b22e7ea6f7a5c0580725bddf54f9bda")
@WinRTInterface("9b22e7ea6f7a5c0580725bddf54f9bda")
...
public interface IListViewItemDataAutomationPeerFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IListViewItemDataAutomationPeerFactory {
    public val __693226194_Ptr: Pointer?

    public val _693226194_VtblPtr: Pointer?
      get() = __693226194_Ptr?.getPointer(0)
    ...
    public override fun CreateInstanceWithParentAndItem(
      ...
      val fnPtr = _693226194_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ListViewItemDataAutomationPeer>()
      val hr = fn.invokeHR(arrayOf(__693226194_Ptr, marshalToNative(item), marshalToNative(parent),
  ...
  public class IListViewItemDataAutomationPeerFactory_Impl(
    ...
    public override val __693226194_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IListViewItemDataAutomationPeerFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("9b22e7ea6f7a5c0580725bddf54f9bda")
    ...
    public override fun toNative(obj: IListViewItemDataAutomationPeerFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__693226194_Ptr))
  }
