...
@Signature("{2691e85b-dc9c-5ce6-aec9-21c8da9a4ad1}")
@Guid("2691e85bdc9c5ce6aec921c8da9a4ad1")
@WinRTInterface("2691e85bdc9c5ce6aec921c8da9a4ad1")
...
public interface ISelectorItemAutomationPeerFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISelectorItemAutomationPeerFactory {
    public val __1513442756_Ptr: Pointer?

    public val _1513442756_VtblPtr: Pointer?
      get() = __1513442756_Ptr?.getPointer(0)
    ...
    public override fun CreateInstanceWithParentAndItem(
      ...
      val fnPtr = _1513442756_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<SelectorItemAutomationPeer>()
      val hr = fn.invokeHR(arrayOf(__1513442756_Ptr, marshalToNative(item), marshalToNative(parent),
  ...
  public class ISelectorItemAutomationPeerFactory_Impl(
    ...
    public override val __1513442756_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISelectorItemAutomationPeerFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("2691e85bdc9c5ce6aec921c8da9a4ad1")
    ...
    public override fun toNative(obj: ISelectorItemAutomationPeerFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1513442756_Ptr))
  }
