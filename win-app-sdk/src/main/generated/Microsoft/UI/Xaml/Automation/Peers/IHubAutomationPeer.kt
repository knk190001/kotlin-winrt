...
@Signature("{8fa20cb6-42c1-531e-b54f-fcaf33c943a9}")
@Guid("8fa20cb642c1531eb54ffcaf33c943a9")
@WinRTInterface("8fa20cb642c1531eb54ffcaf33c943a9")
...
public interface IHubAutomationPeer : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IHubAutomationPeer {
    public val __1814856597_Ptr: Pointer?

    public val _1814856597_VtblPtr: Pointer?
      get() = __1814856597_Ptr?.getPointer(0)
  }

  public class IHubAutomationPeer_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __1814856597_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IHubAutomationPeer, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("8fa20cb642c1531eb54ffcaf33c943a9")
    ...
    public override fun toNative(obj: IHubAutomationPeer): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1814856597_Ptr))
  }
