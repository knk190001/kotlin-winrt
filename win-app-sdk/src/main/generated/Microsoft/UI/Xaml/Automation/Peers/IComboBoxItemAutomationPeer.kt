...
@Signature("{3d4195bc-b579-5cda-b56f-1e7399e14122}")
@Guid("3d4195bcb5795cdab56f1e7399e14122")
@WinRTInterface("3d4195bcb5795cdab56f1e7399e14122")
...
public interface IComboBoxItemAutomationPeer : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IComboBoxItemAutomationPeer {
    public val __2069710612_Ptr: Pointer?

    public val _2069710612_VtblPtr: Pointer?
      get() = __2069710612_Ptr?.getPointer(0)
  }

  public class IComboBoxItemAutomationPeer_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __2069710612_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IComboBoxItemAutomationPeer, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("3d4195bcb5795cdab56f1e7399e14122")
    ...
    public override fun toNative(obj: IComboBoxItemAutomationPeer): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2069710612_Ptr))
  }
