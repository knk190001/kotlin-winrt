...
@Signature("{8a6fb8eb-e5f1-58eb-8e72-8b95f236fc47}")
@Guid("8a6fb8ebe5f158eb8e728b95f236fc47")
@WinRTInterface("8a6fb8ebe5f158eb8e728b95f236fc47")
...
public interface IScrollItemProvider : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IScrollItemProvider {
    public val __428448034_Ptr: Pointer?

    public val _428448034_VtblPtr: Pointer?
      get() = __428448034_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun ScrollIntoView(): Unit {
      val fnPtr = _428448034_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__428448034_Ptr, ))
      if (hr.toInt() != 0) {
  ...
  public class IScrollItemProvider_Impl(
    ...
    public override val __428448034_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IScrollItemProvider, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("8a6fb8ebe5f158eb8e728b95f236fc47")
    ...
    public override fun toNative(obj: IScrollItemProvider): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__428448034_Ptr))
  }
