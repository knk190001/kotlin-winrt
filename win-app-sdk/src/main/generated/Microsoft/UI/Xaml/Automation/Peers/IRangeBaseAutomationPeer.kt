...
@Signature("{b5d50512-70a9-5b27-82fe-16f6ba67bac5}")
@Guid("b5d5051270a95b2782fe16f6ba67bac5")
@WinRTInterface("b5d5051270a95b2782fe16f6ba67bac5")
...
public interface IRangeBaseAutomationPeer : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IRangeBaseAutomationPeer {
    public val __1927547812_Ptr: Pointer?

    public val _1927547812_VtblPtr: Pointer?
      get() = __1927547812_Ptr?.getPointer(0)
  }

  public class IRangeBaseAutomationPeer_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __1927547812_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IRangeBaseAutomationPeer, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("b5d5051270a95b2782fe16f6ba67bac5")
    ...
    public override fun toNative(obj: IRangeBaseAutomationPeer): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1927547812_Ptr))
  }
