...
import Microsoft.UI.Xaml.Automation.ScrollAmount
...
@Signature("{7e2e5af3-ff50-5365-bcfe-ef424b2fd590}")
@Guid("7e2e5af3ff505365bcfeef424b2fd590")
@WinRTInterface("7e2e5af3ff505365bcfeef424b2fd590")
...
public interface IScrollProvider : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IScrollProvider {
    public val __1467697237_Ptr: Pointer?

    public val _1467697237_VtblPtr: Pointer?
      get() = __1467697237_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_HorizontallyScrollable(): Boolean {
      val fnPtr = _1467697237_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1467697237_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_HorizontalScrollPercent(): Double {
      val fnPtr = _1467697237_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_HorizontalViewSize(): Double {
      val fnPtr = _1467697237_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1467697237_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_VerticallyScrollable(): Boolean {
      val fnPtr = _1467697237_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1467697237_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_VerticalScrollPercent(): Double {
      val fnPtr = _1467697237_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1467697237_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_VerticalViewSize(): Double {
      val fnPtr = _1467697237_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1467697237_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun Scroll(horizontalAmount: ScrollAmount?, verticalAmount: ScrollAmount?):
        Unit {
      val fnPtr = _1467697237_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1467697237_Ptr, marshalToNative(horizontalAmount),
    ...
    public override fun SetScrollPercent(horizontalPercent: Double, verticalPercent: Double): Unit {
      val fnPtr = _1467697237_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1467697237_Ptr, horizontalPercent, verticalPercent,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IScrollProvider_Impl(
    ...
    public override val __1467697237_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IScrollProvider, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("7e2e5af3ff505365bcfeef424b2fd590")
    ...
    public override fun toNative(obj: IScrollProvider): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1467697237_Ptr))
  }
