...
import Microsoft.UI.Xaml.Automation.Peers.ITreeViewListAutomationPeerFactory.ABI.IID
...
@Signature("rc(Microsoft.UI.Xaml.Automation.Peers.TreeViewListAutomationPeer;{1ebf0f7f-6111-50a5-8398-89c4fdd0dedb})")
@WinRTByReference(brClass = TreeViewListAutomationPeer.ByReference::class)
public open class TreeViewListAutomationPeer(
  ptr: JNAPointer? = NULL
) : ListViewAutomationPeer(ptr), ITreeViewListAutomationPeer.WithDefault, IWinRTObject {
  private val __1093727299_Interface: ITreeViewListAutomationPeer.WithDefault by lazy {
    as_1093727299()
  }


  public override val __1093727299_Ptr: JNAPointer? by lazy {
    __1093727299_Interface.__1093727299_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1093727299_Interface)

  public constructor(owner: TreeViewList) : this(ABI.activate(owner))

  private fun as_1093727299(): ITreeViewListAutomationPeer.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<TreeViewListAutomationPeer, MemoryAddress> {
    ...
    public fun createITreeViewListAutomationPeerFactory(): ITreeViewListAutomationPeerFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Automation.Peers.TreeViewListAutomationPeer".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
