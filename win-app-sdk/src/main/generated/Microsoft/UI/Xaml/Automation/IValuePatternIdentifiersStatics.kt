...
@Signature("{2019faf5-ce64-59a7-bc13-0677c3146724}")
@Guid("2019faf5ce6459a7bc130677c3146724")
@WinRTInterface("2019faf5ce6459a7bc130677c3146724")
...
public interface IValuePatternIdentifiersStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IValuePatternIdentifiersStatics {
    public val __1789571392_Ptr: Pointer?

    public val _1789571392_VtblPtr: Pointer?
      get() = __1789571392_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_IsReadOnlyProperty(): AutomationProperty? {
      val fnPtr = _1789571392_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AutomationProperty>()
      val hr = fn.invokeHR(arrayOf(__1789571392_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ValueProperty(): AutomationProperty? {
      val fnPtr = _1789571392_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AutomationProperty>()
      val hr = fn.invokeHR(arrayOf(__1789571392_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IValuePatternIdentifiersStatics_Impl(
    ...
    public override val __1789571392_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IValuePatternIdentifiersStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("2019faf5ce6459a7bc130677c3146724")
    ...
    public override fun toNative(obj: IValuePatternIdentifiersStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1789571392_Ptr))
  }
