...
@Signature("{7b0d5cba-c5b3-553e-989a-a10ee04144af}")
@Guid("7b0d5cbac5b3553e989aa10ee04144af")
@WinRTInterface("7b0d5cbac5b3553e989aa10ee04144af")
...
public interface IPasswordBoxAutomationPeerFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPasswordBoxAutomationPeerFactory {
    public val __1143926332_Ptr: Pointer?

    public val _1143926332_VtblPtr: Pointer?
      get() = __1143926332_Ptr?.getPointer(0)
    ...
    public override fun CreateInstanceWithOwner(
      ...
      val fnPtr = _1143926332_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<PasswordBoxAutomationPeer>()
      val hr = fn.invokeHR(arrayOf(__1143926332_Ptr, marshalToNative(owner),
  ...
  public class IPasswordBoxAutomationPeerFactory_Impl(
    ...
    public override val __1143926332_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPasswordBoxAutomationPeerFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("7b0d5cbac5b3553e989aa10ee04144af")
    ...
    public override fun toNative(obj: IPasswordBoxAutomationPeerFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1143926332_Ptr))
  }
