...
@Signature("{25a1a202-bd68-5d41-a311-f84af9c8c440}")
@Guid("25a1a202bd685d41a311f84af9c8c440")
@WinRTInterface("25a1a202bd685d41a311f84af9c8c440")
...
public interface IAutomationPeerAnnotationFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IAutomationPeerAnnotationFactory {
    public val __1669345023_Ptr: Pointer?

    public val _1669345023_VtblPtr: Pointer?
      get() = __1669345023_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(type: AnnotationType?): AutomationPeerAnnotation? {
      val fnPtr = _1669345023_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AutomationPeerAnnotation>()
      val hr = fn.invokeHR(arrayOf(__1669345023_Ptr, marshalToNative(type), result))
      if (hr.toInt() != 0) {
    ...
    public override fun CreateWithPeerParameter(type: AnnotationType?, peer: AutomationPeer?):
        AutomationPeerAnnotation? {
      val fnPtr = _1669345023_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AutomationPeerAnnotation>()
      val hr = fn.invokeHR(arrayOf(__1669345023_Ptr, marshalToNative(type), marshalToNative(peer),
          result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
  ...
  public class IAutomationPeerAnnotationFactory_Impl(
    ...
    public override val __1669345023_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IAutomationPeerAnnotationFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("25a1a202bd685d41a311f84af9c8c440")
    ...
    public override fun toNative(obj: IAutomationPeerAnnotationFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1669345023_Ptr))
  }
