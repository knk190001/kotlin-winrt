...
@Signature("rc(Microsoft.UI.Xaml.Automation.AutomationAnnotation;{c2cc46ad-1414-5f1b-808a-89e5d53d82fe})")
...
public class AutomationAnnotation(
  ...
  private val __1391004884_Interface: IAutomationAnnotation.WithDefault by lazy {
    as_1391004884()
  }


  public override val __1391004884_Ptr: JNAPointer? by lazy {
    __1391004884_Interface.__1391004884_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1391004884_Interface)
  ...
  private fun as_1391004884(): IAutomationAnnotation.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<AutomationAnnotation, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Automation.AutomationAnnotation".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIAutomationAnnotationStatics(): IAutomationAnnotationStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Automation.AutomationAnnotation".toHandle(),refiid,interfacePtr)
      val result =
    ...
    public fun createIAutomationAnnotationFactory(): IAutomationAnnotationFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Automation.AutomationAnnotation".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
