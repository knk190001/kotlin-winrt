...
@Signature("{51c1ce89-b21f-592c-8768-0accdefd5738}")
@Guid("51c1ce89b21f592c87680accdefd5738")
@WinRTInterface("51c1ce89b21f592c87680accdefd5738")
...
public interface ISpreadsheetItemProvider : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISpreadsheetItemProvider {
    public val __2023034141_Ptr: Pointer?

    public val _2023034141_VtblPtr: Pointer?
      get() = __2023034141_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Formula(): String? {
      val fnPtr = _2023034141_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__2023034141_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetAnnotationObjects(): Array<IRawElementProviderSimple?>? {
      val fnPtr = _2023034141_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun GetAnnotationTypes(): Array<AnnotationType?>? {
      val fnPtr = _2023034141_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class ISpreadsheetItemProvider_Impl(
    ...
    public override val __2023034141_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISpreadsheetItemProvider, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("51c1ce89b21f592c87680accdefd5738")
    ...
    public override fun toNative(obj: ISpreadsheetItemProvider): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2023034141_Ptr))
  }
