...
@Signature("{005ac3d1-b031-58ab-918d-030fabaeaf87}")
@Guid("005ac3d1b03158ab918d030fabaeaf87")
@WinRTInterface("005ac3d1b03158ab918d030fabaeaf87")
...
public interface IColorSpectrumAutomationPeer : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IColorSpectrumAutomationPeer {
    public val __2021239478_Ptr: Pointer?

    public val _2021239478_VtblPtr: Pointer?
      get() = __2021239478_Ptr?.getPointer(0)
  }

  public class IColorSpectrumAutomationPeer_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __2021239478_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IColorSpectrumAutomationPeer, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("005ac3d1b03158ab918d030fabaeaf87")
    ...
    public override fun toNative(obj: IColorSpectrumAutomationPeer): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2021239478_Ptr))
  }
