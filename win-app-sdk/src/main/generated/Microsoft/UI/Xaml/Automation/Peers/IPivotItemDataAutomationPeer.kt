...
@Signature("{6758ebee-b3e0-5feb-aaba-b7f6c59fe49f}")
@Guid("6758ebeeb3e05febaabab7f6c59fe49f")
@WinRTInterface("6758ebeeb3e05febaabab7f6c59fe49f")
...
public interface IPivotItemDataAutomationPeer : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPivotItemDataAutomationPeer {
    public val __819474059_Ptr: Pointer?

    public val _819474059_VtblPtr: Pointer?
      get() = __819474059_Ptr?.getPointer(0)
  }

  public class IPivotItemDataAutomationPeer_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __819474059_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPivotItemDataAutomationPeer, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("6758ebeeb3e05febaabab7f6c59fe49f")
    ...
    public override fun toNative(obj: IPivotItemDataAutomationPeer): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__819474059_Ptr))
  }
