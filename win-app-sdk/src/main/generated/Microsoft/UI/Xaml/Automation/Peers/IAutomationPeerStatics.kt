...
@Signature("{90b157ff-18d5-5623-850c-612ceae576bd}")
@Guid("90b157ff18d55623850c612ceae576bd")
@WinRTInterface("90b157ff18d55623850c612ceae576bd")
...
public interface IAutomationPeerStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IAutomationPeerStatics {
    public val __1883738345_Ptr: Pointer?

    public val _1883738345_VtblPtr: Pointer?
      get() = __1883738345_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun ListenerExists(eventId: AutomationEvents?): Boolean {
      val fnPtr = _1883738345_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1883738345_Ptr, marshalToNative(eventId), result))
      if (hr.toInt() != 0) {
    ...
    public override fun GenerateRawElementProviderRuntimeId(): RawElementProviderRuntimeId? {
      val fnPtr = _1883738345_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<RawElementProviderRuntimeId>()
      val hr = fn.invokeHR(arrayOf(__1883738345_Ptr,  result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
  ...
  public class IAutomationPeerStatics_Impl(
    ...
    public override val __1883738345_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IAutomationPeerStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("90b157ff18d55623850c612ceae576bd")
    ...
    public override fun toNative(obj: IAutomationPeerStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1883738345_Ptr))
  }
