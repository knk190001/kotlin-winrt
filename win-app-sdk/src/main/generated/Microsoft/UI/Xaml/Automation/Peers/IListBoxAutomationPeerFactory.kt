...
@Signature("{004aaf6f-a12c-5fa4-a1f7-e3b0fbe45ddd}")
@Guid("004aaf6fa12c5fa4a1f7e3b0fbe45ddd")
@WinRTInterface("004aaf6fa12c5fa4a1f7e3b0fbe45ddd")
...
public interface IListBoxAutomationPeerFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IListBoxAutomationPeerFactory {
    public val __1445402695_Ptr: Pointer?

    public val _1445402695_VtblPtr: Pointer?
      get() = __1445402695_Ptr?.getPointer(0)
    ...
    public override fun CreateInstanceWithOwner(
      ...
      val fnPtr = _1445402695_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ListBoxAutomationPeer>()
      val hr = fn.invokeHR(arrayOf(__1445402695_Ptr, marshalToNative(owner),
  ...
  public class IListBoxAutomationPeerFactory_Impl(
    ...
    public override val __1445402695_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IListBoxAutomationPeerFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("004aaf6fa12c5fa4a1f7e3b0fbe45ddd")
    ...
    public override fun toNative(obj: IListBoxAutomationPeerFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1445402695_Ptr))
  }
