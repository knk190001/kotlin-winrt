...
@Signature("{ffe08885-14ac-5859-b031-5f3a4c504e6d}")
@Guid("ffe0888514ac5859b0315f3a4c504e6d")
@WinRTInterface("ffe0888514ac5859b0315f3a4c504e6d")
...
public interface IItemAutomationPeerFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IItemAutomationPeerFactory {
    public val __1311192485_Ptr: Pointer?

    public val _1311192485_VtblPtr: Pointer?
      get() = __1311192485_Ptr?.getPointer(0)
    ...
    public override fun CreateInstanceWithParentAndItem(
      ...
      val fnPtr = _1311192485_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ItemAutomationPeer>()
      val hr = fn.invokeHR(arrayOf(__1311192485_Ptr, marshalToNative(item), marshalToNative(parent),
  ...
  public class IItemAutomationPeerFactory_Impl(
    ...
    public override val __1311192485_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IItemAutomationPeerFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("ffe0888514ac5859b0315f3a4c504e6d")
    ...
    public override fun toNative(obj: IItemAutomationPeerFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1311192485_Ptr))
  }
