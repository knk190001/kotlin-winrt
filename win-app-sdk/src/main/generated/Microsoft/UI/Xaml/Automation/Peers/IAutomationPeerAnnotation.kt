...
@Signature("{2738b92a-2528-5b63-973d-d29eb0593647}")
@Guid("2738b92a25285b63973dd29eb0593647")
@WinRTInterface("2738b92a25285b63973dd29eb0593647")
...
public interface IAutomationPeerAnnotation : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IAutomationPeerAnnotation {
    public val __1039198325_Ptr: Pointer?

    public val _1039198325_VtblPtr: Pointer?
      get() = __1039198325_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Type(): AnnotationType? {
      val fnPtr = _1039198325_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AnnotationType>()
      val hr = fn.invokeHR(arrayOf(__1039198325_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Type(value: AnnotationType?): Unit {
      val fnPtr = _1039198325_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1039198325_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Peer(): AutomationPeer? {
      val fnPtr = _1039198325_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Peer(value: AutomationPeer?): Unit {
      val fnPtr = _1039198325_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1039198325_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IAutomationPeerAnnotation_Impl(
    ...
    public override val __1039198325_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IAutomationPeerAnnotation, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("2738b92a25285b63973dd29eb0593647")
    ...
    public override fun toNative(obj: IAutomationPeerAnnotation): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1039198325_Ptr))
  }
