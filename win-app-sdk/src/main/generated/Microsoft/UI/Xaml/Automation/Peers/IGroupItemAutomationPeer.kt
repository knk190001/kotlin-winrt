...
@Signature("{2ff50701-4164-511d-bb23-d21eb88d5eb9}")
@Guid("2ff507014164511dbb23d21eb88d5eb9")
@WinRTInterface("2ff507014164511dbb23d21eb88d5eb9")
...
public interface IGroupItemAutomationPeer : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IGroupItemAutomationPeer {
    public val __1797090008_Ptr: Pointer?

    public val _1797090008_VtblPtr: Pointer?
      get() = __1797090008_Ptr?.getPointer(0)
  }

  public class IGroupItemAutomationPeer_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __1797090008_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IGroupItemAutomationPeer, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("2ff507014164511dbb23d21eb88d5eb9")
    ...
    public override fun toNative(obj: IGroupItemAutomationPeer): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1797090008_Ptr))
  }
