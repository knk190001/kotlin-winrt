...
@Signature("{50992d5e-d225-56e9-a25a-78c372e81955}")
@Guid("50992d5ed22556e9a25a78c372e81955")
@WinRTInterface("50992d5ed22556e9a25a78c372e81955")
...
public interface IGridProvider : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IGridProvider {
    public val __1401134492_Ptr: Pointer?

    public val _1401134492_VtblPtr: Pointer?
      get() = __1401134492_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ColumnCount(): Int {
      val fnPtr = _1401134492_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__1401134492_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_RowCount(): Int {
      val fnPtr = _1401134492_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__1401134492_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetItem(row: Int, column: Int): IRawElementProviderSimple? {
      val fnPtr = _1401134492_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IRawElementProviderSimple>()
      val hr = fn.invokeHR(arrayOf(__1401134492_Ptr, row, column, result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
  ...
  public class IGridProvider_Impl(
    ...
    public override val __1401134492_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IGridProvider, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("50992d5ed22556e9a25a78c372e81955")
    ...
    public override fun toNative(obj: IGridProvider): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1401134492_Ptr))
  }
