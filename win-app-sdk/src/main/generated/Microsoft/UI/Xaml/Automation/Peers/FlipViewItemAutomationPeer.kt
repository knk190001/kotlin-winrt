...
import Microsoft.UI.Xaml.Automation.Peers.IFlipViewItemAutomationPeerFactory.ABI.IID
...
@Signature("rc(Microsoft.UI.Xaml.Automation.Peers.FlipViewItemAutomationPeer;{3569b1bb-7601-56de-812a-171455d8ad32})")
...
public open class FlipViewItemAutomationPeer(
  ...
  private val __177167617_Interface: IFlipViewItemAutomationPeer.WithDefault by lazy {
    as_177167617()
  }


  public override val __177167617_Ptr: JNAPointer? by lazy {
    __177167617_Interface.__177167617_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__177167617_Interface)

  public constructor(owner: FlipViewItem) : this(ABI.activate(owner))

  private fun as_177167617(): IFlipViewItemAutomationPeer.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<FlipViewItemAutomationPeer, MemoryAddress> {
    ...
    public fun createIFlipViewItemAutomationPeerFactory(): IFlipViewItemAutomationPeerFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Automation.Peers.FlipViewItemAutomationPeer".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
