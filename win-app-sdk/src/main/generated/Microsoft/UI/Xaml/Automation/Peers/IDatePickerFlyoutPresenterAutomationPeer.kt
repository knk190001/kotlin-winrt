...
@Signature("{600b7162-0529-5fd1-b6e4-41dc37eda513}")
@Guid("600b716205295fd1b6e441dc37eda513")
@WinRTInterface("600b716205295fd1b6e441dc37eda513")
...
public interface IDatePickerFlyoutPresenterAutomationPeer : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IDatePickerFlyoutPresenterAutomationPeer {
    public val __581873703_Ptr: Pointer?

    public val _581873703_VtblPtr: Pointer?
      get() = __581873703_Ptr?.getPointer(0)
  }

  public class IDatePickerFlyoutPresenterAutomationPeer_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __581873703_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IDatePickerFlyoutPresenterAutomationPeer, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("600b716205295fd1b6e441dc37eda513")
    ...
    public override fun toNative(obj: IDatePickerFlyoutPresenterAutomationPeer): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__581873703_Ptr))
  }
