...
@Signature("{66778718-8757-56d5-bd3a-f2ff40e83a78}")
@Guid("66778718875756d5bd3af2ff40e83a78")
@WinRTInterface("66778718875756d5bd3af2ff40e83a78")
...
public interface IComboBoxItemDataAutomationPeerFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IComboBoxItemDataAutomationPeerFactory {
    public val __2039550348_Ptr: Pointer?

    public val _2039550348_VtblPtr: Pointer?
      get() = __2039550348_Ptr?.getPointer(0)
    ...
    public override fun CreateInstanceWithParentAndItem(
      ...
      val fnPtr = _2039550348_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ComboBoxItemDataAutomationPeer>()
      val hr = fn.invokeHR(arrayOf(__2039550348_Ptr, marshalToNative(item), marshalToNative(parent),
  ...
  public class IComboBoxItemDataAutomationPeerFactory_Impl(
    ...
    public override val __2039550348_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IComboBoxItemDataAutomationPeerFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("66778718875756d5bd3af2ff40e83a78")
    ...
    public override fun toNative(obj: IComboBoxItemDataAutomationPeerFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2039550348_Ptr))
  }
