...
@Signature("{174e94ab-c033-534a-895c-eaaf1dcc4352}")
@Guid("174e94abc033534a895ceaaf1dcc4352")
@WinRTInterface("174e94abc033534a895ceaaf1dcc4352")
...
public interface IHubSectionAutomationPeer : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IHubSectionAutomationPeer {
    public val __777013196_Ptr: Pointer?

    public val _777013196_VtblPtr: Pointer?
      get() = __777013196_Ptr?.getPointer(0)
  }

  public class IHubSectionAutomationPeer_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __777013196_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IHubSectionAutomationPeer, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("174e94abc033534a895ceaaf1dcc4352")
    ...
    public override fun toNative(obj: IHubSectionAutomationPeer): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__777013196_Ptr))
  }
