...
@Signature("{6d272c12-68a3-586e-879b-571e606803b4}")
@Guid("6d272c1268a3586e879b571e606803b4")
@WinRTInterface("6d272c1268a3586e879b571e606803b4")
...
public interface ICalendarDatePickerAutomationPeerFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICalendarDatePickerAutomationPeerFactory {
    public val __24934740_Ptr: Pointer?

    public val _24934740_VtblPtr: Pointer?
      get() = __24934740_Ptr?.getPointer(0)
    ...
    public override fun CreateInstanceWithOwner(
      ...
      val fnPtr = _24934740_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CalendarDatePickerAutomationPeer>()
      val hr = fn.invokeHR(arrayOf(__24934740_Ptr, marshalToNative(owner),
  ...
  public class ICalendarDatePickerAutomationPeerFactory_Impl(
    ...
    public override val __24934740_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICalendarDatePickerAutomationPeerFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("6d272c1268a3586e879b571e606803b4")
    ...
    public override fun toNative(obj: ICalendarDatePickerAutomationPeerFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__24934740_Ptr))
  }
