...
@Signature("{21356952-4c74-5273-b82d-e5ce1bbcd369}")
@Guid("213569524c745273b82de5ce1bbcd369")
@WinRTInterface("213569524c745273b82de5ce1bbcd369")
...
public interface IToggleSplitButtonAutomationPeer : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IToggleSplitButtonAutomationPeer {
    public val __1650780782_Ptr: Pointer?

    public val _1650780782_VtblPtr: Pointer?
      get() = __1650780782_Ptr?.getPointer(0)
  }

  public class IToggleSplitButtonAutomationPeer_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __1650780782_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IToggleSplitButtonAutomationPeer, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("213569524c745273b82de5ce1bbcd369")
    ...
    public override fun toNative(obj: IToggleSplitButtonAutomationPeer): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1650780782_Ptr))
  }
