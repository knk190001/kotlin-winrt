...
@Signature("{bd1709e5-1940-56fc-b5c3-85e4570951cc}")
@Guid("bd1709e5194056fcb5c385e4570951cc")
@WinRTInterface("bd1709e5194056fcb5c385e4570951cc")
...
public interface IPersonPictureAutomationPeerFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPersonPictureAutomationPeerFactory {
    public val __1113881621_Ptr: Pointer?

    public val _1113881621_VtblPtr: Pointer?
      get() = __1113881621_Ptr?.getPointer(0)
    ...
    public override fun CreateInstanceWithOwner(
      ...
      val fnPtr = _1113881621_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<PersonPictureAutomationPeer>()
      val hr = fn.invokeHR(arrayOf(__1113881621_Ptr, marshalToNative(owner),
  ...
  public class IPersonPictureAutomationPeerFactory_Impl(
    ...
    public override val __1113881621_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPersonPictureAutomationPeerFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("bd1709e5194056fcb5c385e4570951cc")
    ...
    public override fun toNative(obj: IPersonPictureAutomationPeerFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1113881621_Ptr))
  }
