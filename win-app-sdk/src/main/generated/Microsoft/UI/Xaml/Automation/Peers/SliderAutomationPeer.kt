...
import Microsoft.UI.Xaml.Automation.Peers.ISliderAutomationPeerFactory.ABI.IID
...
@Signature("rc(Microsoft.UI.Xaml.Automation.Peers.SliderAutomationPeer;{c321c95f-c917-5714-9d16-ad706e38926a})")
...
public open class SliderAutomationPeer(
  ...
  private val __338301891_Interface: ISliderAutomationPeer.WithDefault by lazy {
    as_338301891()
  }


  public override val __338301891_Ptr: JNAPointer? by lazy {
    __338301891_Interface.__338301891_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__338301891_Interface)

  public constructor(owner: Slider) : this(ABI.activate(owner))

  private fun as_338301891(): ISliderAutomationPeer.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<SliderAutomationPeer, MemoryAddress> {
    ...
    public fun createISliderAutomationPeerFactory(): ISliderAutomationPeerFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Automation.Peers.SliderAutomationPeer".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
