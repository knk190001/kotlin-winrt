...
@Signature("{1e84ac8f-9974-5be1-b6ea-84f309c8b2b8}")
@Guid("1e84ac8f99745be1b6ea84f309c8b2b8")
@WinRTInterface("1e84ac8f99745be1b6ea84f309c8b2b8")
...
public interface ITextBoxAutomationPeerFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITextBoxAutomationPeerFactory {
    public val __11120598_Ptr: Pointer?

    public val _11120598_VtblPtr: Pointer?
      get() = __11120598_Ptr?.getPointer(0)
    ...
    public override fun CreateInstanceWithOwner(
      ...
      val fnPtr = _11120598_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<TextBoxAutomationPeer>()
      val hr = fn.invokeHR(arrayOf(__11120598_Ptr, marshalToNative(owner),
  ...
  public class ITextBoxAutomationPeerFactory_Impl(
    ...
    public override val __11120598_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITextBoxAutomationPeerFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("1e84ac8f99745be1b6ea84f309c8b2b8")
    ...
    public override fun toNative(obj: ITextBoxAutomationPeerFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__11120598_Ptr))
  }
