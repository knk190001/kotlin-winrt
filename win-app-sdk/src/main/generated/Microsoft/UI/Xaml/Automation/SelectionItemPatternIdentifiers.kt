...
@Signature("rc(Microsoft.UI.Xaml.Automation.SelectionItemPatternIdentifiers;{ce3a549d-a2cb-594d-a2a4-44778c09cca5})")
...
public class SelectionItemPatternIdentifiers(
  ...
  private val __139421421_Interface: ISelectionItemPatternIdentifiers.WithDefault by lazy {
    as_139421421()
  }


  public override val __139421421_Ptr: JNAPointer? by lazy {
    __139421421_Interface.__139421421_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__139421421_Interface)

  private fun as_139421421(): ISelectionItemPatternIdentifiers.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<SelectionItemPatternIdentifiers, MemoryAddress> {
    ...
    public fun createISelectionItemPatternIdentifiersStatics():
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Automation.SelectionItemPatternIdentifiers".toHandle(),refiid,interfacePtr)
      val result =
