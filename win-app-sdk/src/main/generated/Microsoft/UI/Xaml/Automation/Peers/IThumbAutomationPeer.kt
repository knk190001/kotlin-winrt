...
@Signature("{b05d6e5b-3586-5157-a497-4f15b87d89eb}")
@Guid("b05d6e5b35865157a4974f15b87d89eb")
@WinRTInterface("b05d6e5b35865157a4974f15b87d89eb")
...
public interface IThumbAutomationPeer : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IThumbAutomationPeer {
    public val __2110017460_Ptr: Pointer?

    public val _2110017460_VtblPtr: Pointer?
      get() = __2110017460_Ptr?.getPointer(0)
  }

  public class IThumbAutomationPeer_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __2110017460_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IThumbAutomationPeer, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("b05d6e5b35865157a4974f15b87d89eb")
    ...
    public override fun toNative(obj: IThumbAutomationPeer): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2110017460_Ptr))
  }
