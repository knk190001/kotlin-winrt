...
@Signature("{e5e1e250-c37c-54a2-8c61-1d9ccd3bb39c}")
@Guid("e5e1e250c37c54a28c611d9ccd3bb39c")
@WinRTInterface("e5e1e250c37c54a28c611d9ccd3bb39c")
...
public interface IGridPatternIdentifiers : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IGridPatternIdentifiers {
    public val __1677691686_Ptr: Pointer?

    public val _1677691686_VtblPtr: Pointer?
      get() = __1677691686_Ptr?.getPointer(0)
  }

  public class IGridPatternIdentifiers_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __1677691686_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IGridPatternIdentifiers, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("e5e1e250c37c54a28c611d9ccd3bb39c")
    ...
    public override fun toNative(obj: IGridPatternIdentifiers): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1677691686_Ptr))
  }
