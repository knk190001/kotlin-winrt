...
import Microsoft.UI.Xaml.Automation.Peers.IDatePickerAutomationPeerFactory.ABI.IID
...
@Signature("rc(Microsoft.UI.Xaml.Automation.Peers.DatePickerAutomationPeer;{f3d7c3e5-c817-58a5-bb47-d9eb228f3ba0})")
...
public open class DatePickerAutomationPeer(
  ...
  private val __945233800_Interface: IDatePickerAutomationPeer.WithDefault by lazy {
    as_945233800()
  }


  public override val __945233800_Ptr: JNAPointer? by lazy {
    __945233800_Interface.__945233800_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__945233800_Interface)

  public constructor(owner: DatePicker) : this(ABI.activate(owner))

  private fun as_945233800(): IDatePickerAutomationPeer.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<DatePickerAutomationPeer, MemoryAddress> {
    ...
    public fun createIDatePickerAutomationPeerFactory(): IDatePickerAutomationPeerFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Automation.Peers.DatePickerAutomationPeer".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
