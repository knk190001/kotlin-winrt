...
@Signature("{dc56cf08-2031-56b6-9ad5-7f8d7475d35d}")
@Guid("dc56cf08203156b69ad57f8d7475d35d")
@WinRTInterface("dc56cf08203156b69ad57f8d7475d35d")
...
public interface IHubSectionAutomationPeerFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IHubSectionAutomationPeerFactory {
    public val __1958044574_Ptr: Pointer?

    public val _1958044574_VtblPtr: Pointer?
      get() = __1958044574_Ptr?.getPointer(0)
    ...
    public override fun CreateInstanceWithOwner(
      ...
      val fnPtr = _1958044574_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<HubSectionAutomationPeer>()
      val hr = fn.invokeHR(arrayOf(__1958044574_Ptr, marshalToNative(owner),
  ...
  public class IHubSectionAutomationPeerFactory_Impl(
    ...
    public override val __1958044574_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IHubSectionAutomationPeerFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("dc56cf08203156b69ad57f8d7475d35d")
    ...
    public override fun toNative(obj: IHubSectionAutomationPeerFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1958044574_Ptr))
  }
