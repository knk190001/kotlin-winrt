...
@Signature("{246d63e3-812f-5f28-8d18-af79409a4f95}")
@Guid("246d63e3812f5f288d18af79409a4f95")
@WinRTInterface("246d63e3812f5f288d18af79409a4f95")
...
public interface ICalendarDatePickerAutomationPeer : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICalendarDatePickerAutomationPeer {
    public val __314928426_Ptr: Pointer?

    public val _314928426_VtblPtr: Pointer?
      get() = __314928426_Ptr?.getPointer(0)
  }

  public class ICalendarDatePickerAutomationPeer_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __314928426_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICalendarDatePickerAutomationPeer, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("246d63e3812f5f288d18af79409a4f95")
    ...
    public override fun toNative(obj: ICalendarDatePickerAutomationPeer): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__314928426_Ptr))
  }
