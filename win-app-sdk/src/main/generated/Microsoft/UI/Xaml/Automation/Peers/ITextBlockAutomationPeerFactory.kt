...
@Signature("{2a04c7bb-6d48-5f8e-9622-54dccdf0a5ca}")
@Guid("2a04c7bb6d485f8e962254dccdf0a5ca")
@WinRTInterface("2a04c7bb6d485f8e962254dccdf0a5ca")
...
public interface ITextBlockAutomationPeerFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITextBlockAutomationPeerFactory {
    public val __1394870868_Ptr: Pointer?

    public val _1394870868_VtblPtr: Pointer?
      get() = __1394870868_Ptr?.getPointer(0)
    ...
    public override fun CreateInstanceWithOwner(
      ...
      val fnPtr = _1394870868_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<TextBlockAutomationPeer>()
      val hr = fn.invokeHR(arrayOf(__1394870868_Ptr, marshalToNative(owner),
  ...
  public class ITextBlockAutomationPeerFactory_Impl(
    ...
    public override val __1394870868_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITextBlockAutomationPeerFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("2a04c7bb6d485f8e962254dccdf0a5ca")
    ...
    public override fun toNative(obj: ITextBlockAutomationPeerFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1394870868_Ptr))
  }
