...
@Signature("{68c4bffa-1685-5936-b219-517e87fd591f}")
@Guid("68c4bffa16855936b219517e87fd591f")
@WinRTInterface("68c4bffa16855936b219517e87fd591f")
...
public interface IDropDownButtonAutomationPeerFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IDropDownButtonAutomationPeerFactory {
    public val __557955179_Ptr: Pointer?

    public val _557955179_VtblPtr: Pointer?
      get() = __557955179_Ptr?.getPointer(0)
    ...
    public override fun CreateInstance(
      ...
      val fnPtr = _557955179_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DropDownButtonAutomationPeer>()
      val hr = fn.invokeHR(arrayOf(__557955179_Ptr, marshalToNative(owner),
  ...
  public class IDropDownButtonAutomationPeerFactory_Impl(
    ...
    public override val __557955179_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IDropDownButtonAutomationPeerFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("68c4bffa16855936b219517e87fd591f")
    ...
    public override fun toNative(obj: IDropDownButtonAutomationPeerFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__557955179_Ptr))
  }
