...
@Signature("rc(Microsoft.UI.Xaml.Automation.TransformPattern2Identifiers;{6ef7595c-db8c-51b0-878b-34b7ef12f4da})")
...
public class TransformPattern2Identifiers(
  ...
  private val __320421730_Interface: ITransformPattern2Identifiers.WithDefault by lazy {
    as_320421730()
  }


  public override val __320421730_Ptr: JNAPointer? by lazy {
    __320421730_Interface.__320421730_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__320421730_Interface)

  private fun as_320421730(): ITransformPattern2Identifiers.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<TransformPattern2Identifiers, MemoryAddress> {
    ...
    public fun createITransformPattern2IdentifiersStatics(): ITransformPattern2IdentifiersStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Automation.TransformPattern2Identifiers".toHandle(),refiid,interfacePtr)
      val result =
