...
@Signature("rc(Microsoft.UI.Xaml.Automation.DropTargetPatternIdentifiers;{133e8ff3-1ddd-5cbb-b908-1484d7c04da7})")
...
public class DropTargetPatternIdentifiers(
  ...
  private val __839167552_Interface: IDropTargetPatternIdentifiers.WithDefault by lazy {
    as_839167552()
  }


  public override val __839167552_Ptr: JNAPointer? by lazy {
    __839167552_Interface.__839167552_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__839167552_Interface)

  private fun as_839167552(): IDropTargetPatternIdentifiers.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<DropTargetPatternIdentifiers, MemoryAddress> {
    ...
    public fun createIDropTargetPatternIdentifiersStatics(): IDropTargetPatternIdentifiersStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Automation.DropTargetPatternIdentifiers".toHandle(),refiid,interfacePtr)
      val result =
