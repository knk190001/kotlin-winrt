...
@Signature("{9de524cc-5e66-51a0-a7e0-a1742d28334b}")
@Guid("9de524cc5e6651a0a7e0a1742d28334b")
@WinRTInterface("9de524cc5e6651a0a7e0a1742d28334b")
...
public interface IItemsControlAutomationPeerFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IItemsControlAutomationPeerFactory {
    public val __978559281_Ptr: Pointer?

    public val _978559281_VtblPtr: Pointer?
      get() = __978559281_Ptr?.getPointer(0)
    ...
    public override fun CreateInstanceWithOwner(
      ...
      val fnPtr = _978559281_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ItemsControlAutomationPeer>()
      val hr = fn.invokeHR(arrayOf(__978559281_Ptr, marshalToNative(owner),
  ...
  public class IItemsControlAutomationPeerFactory_Impl(
    ...
    public override val __978559281_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IItemsControlAutomationPeerFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("9de524cc5e6651a0a7e0a1742d28334b")
    ...
    public override fun toNative(obj: IItemsControlAutomationPeerFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__978559281_Ptr))
  }
