...
@Signature("{7c72e55f-f75d-5522-aeb5-c1f82c32933b}")
@Guid("7c72e55ff75d5522aeb5c1f82c32933b")
@WinRTInterface("7c72e55ff75d5522aeb5c1f82c32933b")
...
public interface ITextChildProvider : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITextChildProvider {
    public val __385364973_Ptr: Pointer?

    public val _385364973_VtblPtr: Pointer?
      get() = __385364973_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_TextContainer(): IRawElementProviderSimple? {
      val fnPtr = _385364973_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IRawElementProviderSimple>()
      val hr = fn.invokeHR(arrayOf(__385364973_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_TextRange(): ITextRangeProvider? {
      val fnPtr = _385364973_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class ITextChildProvider_Impl(
    ...
    public override val __385364973_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITextChildProvider, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("7c72e55ff75d5522aeb5c1f82c32933b")
    ...
    public override fun toNative(obj: ITextChildProvider): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__385364973_Ptr))
  }
