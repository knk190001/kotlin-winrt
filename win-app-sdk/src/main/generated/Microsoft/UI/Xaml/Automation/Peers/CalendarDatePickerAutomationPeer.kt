...
import Microsoft.UI.Xaml.Automation.Peers.ICalendarDatePickerAutomationPeerFactory.ABI.IID
import Microsoft.UI.Xaml.Automation.Provider.IInvokeProvider
import Microsoft.UI.Xaml.Automation.Provider.IValueProvider
import Microsoft.UI.Xaml.Controls.CalendarDatePicker
...
@Signature("rc(Microsoft.UI.Xaml.Automation.Peers.CalendarDatePickerAutomationPeer;{246d63e3-812f-5f28-8d18-af79409a4f95})")
...
public open class CalendarDatePickerAutomationPeer(
  ...
  private val __314928426_Interface: ICalendarDatePickerAutomationPeer.WithDefault by lazy {
    as_314928426()
  }
  ...
  public override val __314928426_Ptr: JNAPointer? by lazy {
    __314928426_Interface.__314928426_Ptr
  }
  ...
  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__314928426_Interface, __840579670_Interface, __1118783765_Interface)

  public constructor(owner: CalendarDatePicker) : this(ABI.activate(owner))

  private fun as_314928426(): ICalendarDatePickerAutomationPeer.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<CalendarDatePickerAutomationPeer, MemoryAddress> {
    ...
    public fun createICalendarDatePickerAutomationPeerFactory():
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Automation.Peers.CalendarDatePickerAutomationPeer".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
