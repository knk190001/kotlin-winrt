...
@Signature("{713daf82-92b3-58f2-8fc1-b0d9a2cad03c}")
@Guid("713daf8292b358f28fc1b0d9a2cad03c")
@WinRTInterface("713daf8292b358f28fc1b0d9a2cad03c")
...
public interface IVisualStateManagerFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IVisualStateManagerFactory {
    public val __974109127_Ptr: Pointer?

    public val _974109127_VtblPtr: Pointer?
      get() = __974109127_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        VisualStateManager? {
      val fnPtr = _974109127_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<VisualStateManager>()
      val hr = fn.invokeHR(arrayOf(__974109127_Ptr, marshalToNative(baseInterface),
  ...
  public class IVisualStateManagerFactory_Impl(
    ...
    public override val __974109127_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IVisualStateManagerFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("713daf8292b358f28fc1b0d9a2cad03c")
    ...
    public override fun toNative(obj: IVisualStateManagerFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__974109127_Ptr))
  }
