...
@Signature("{9c9560bb-4099-5175-9250-45a15e753da8}")
@Guid("9c9560bb40995175925045a15e753da8")
@WinRTInterface("9c9560bb40995175925045a15e753da8")
...
public interface IAdaptiveTriggerFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IAdaptiveTriggerFactory {
    public val __648309071_Ptr: Pointer?

    public val _648309071_VtblPtr: Pointer?
      get() = __648309071_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        AdaptiveTrigger? {
      val fnPtr = _648309071_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AdaptiveTrigger>()
      val hr = fn.invokeHR(arrayOf(__648309071_Ptr, marshalToNative(baseInterface),
  ...
  public class IAdaptiveTriggerFactory_Impl(
    ...
    public override val __648309071_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IAdaptiveTriggerFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("9c9560bb40995175925045a15e753da8")
    ...
    public override fun toNative(obj: IAdaptiveTriggerFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__648309071_Ptr))
  }
