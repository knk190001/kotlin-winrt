...
@Signature("{13735998-c3b6-5c24-b40a-7b166a6ffc2c}")
@Guid("13735998c3b65c24b40a7b166a6ffc2c")
@WinRTInterface("13735998c3b65c24b40a7b166a6ffc2c")
...
public interface IBrushTransitionFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IBrushTransitionFactory {
    public val __1626235166_Ptr: Pointer?

    public val _1626235166_VtblPtr: Pointer?
      get() = __1626235166_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        BrushTransition? {
      val fnPtr = _1626235166_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<BrushTransition>()
      val hr = fn.invokeHR(arrayOf(__1626235166_Ptr, marshalToNative(baseInterface),
  ...
  public class IBrushTransitionFactory_Impl(
    ...
    public override val __1626235166_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IBrushTransitionFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("13735998c3b65c24b40a7b166a6ffc2c")
    ...
    public override fun toNative(obj: IBrushTransitionFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1626235166_Ptr))
  }
