...
@Signature("{59eaeba9-8f9c-5be7-9b3b-820960faa220}")
@Guid("59eaeba98f9c5be79b3b820960faa220")
@WinRTInterface("59eaeba98f9c5be79b3b820960faa220")
...
public interface IUnhandledExceptionEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IUnhandledExceptionEventArgs {
    public val __1880292796_Ptr: Pointer?

    public val _1880292796_VtblPtr: Pointer?
      get() = __1880292796_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Exception(): HResult? {
      val fnPtr = _1880292796_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<HResult>()
      val hr = fn.invokeHR(arrayOf(__1880292796_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Message(): String? {
      val fnPtr = _1880292796_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_Handled(): Boolean {
      val fnPtr = _1880292796_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Handled(value: Boolean): Unit {
      val fnPtr = _1880292796_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1880292796_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IUnhandledExceptionEventArgs_Impl(
    ...
    public override val __1880292796_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IUnhandledExceptionEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("59eaeba98f9c5be79b3b820960faa220")
    ...
    public override fun toNative(obj: IUnhandledExceptionEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1880292796_Ptr))
  }
