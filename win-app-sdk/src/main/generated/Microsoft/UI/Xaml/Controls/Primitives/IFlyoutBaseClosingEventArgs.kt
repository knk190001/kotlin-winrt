...
@Signature("{7cb280b4-1cca-5a5a-8ea4-191a2bbc8b32}")
@Guid("7cb280b41cca5a5a8ea4191a2bbc8b32")
@WinRTInterface("7cb280b41cca5a5a8ea4191a2bbc8b32")
...
public interface IFlyoutBaseClosingEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IFlyoutBaseClosingEventArgs {
    public val __1325625855_Ptr: Pointer?

    public val _1325625855_VtblPtr: Pointer?
      get() = __1325625855_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Cancel(): Boolean {
      val fnPtr = _1325625855_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1325625855_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Cancel(value: Boolean): Unit {
      val fnPtr = _1325625855_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1325625855_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IFlyoutBaseClosingEventArgs_Impl(
    ...
    public override val __1325625855_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IFlyoutBaseClosingEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("7cb280b41cca5a5a8ea4191a2bbc8b32")
    ...
    public override fun toNative(obj: IFlyoutBaseClosingEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1325625855_Ptr))
  }
