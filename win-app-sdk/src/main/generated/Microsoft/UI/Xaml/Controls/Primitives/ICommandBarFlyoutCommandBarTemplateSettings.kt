...
@Signature("{533cc5ca-dcf7-5f9d-a460-934a883acdc1}")
@Guid("533cc5cadcf75f9da460934a883acdc1")
@WinRTInterface("533cc5cadcf75f9da460934a883acdc1")
...
public interface ICommandBarFlyoutCommandBarTemplateSettings : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICommandBarFlyoutCommandBarTemplateSettings {
    public val __440593927_Ptr: Pointer?

    public val _440593927_VtblPtr: Pointer?
      get() = __440593927_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_OpenAnimationStartPosition(): Double {
      val fnPtr = _440593927_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__440593927_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_OpenAnimationEndPosition(): Double {
      val fnPtr = _440593927_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__440593927_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_CloseAnimationEndPosition(): Double {
      val fnPtr = _440593927_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__440593927_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_CurrentWidth(): Double {
      val fnPtr = _440593927_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__440593927_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ExpandedWidth(): Double {
      val fnPtr = _440593927_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__440593927_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_WidthExpansionDelta(): Double {
      val fnPtr = _440593927_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__440593927_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_WidthExpansionAnimationStartPosition(): Double {
      val fnPtr = _440593927_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__440593927_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_WidthExpansionAnimationEndPosition(): Double {
      val fnPtr = _440593927_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__440593927_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_WidthExpansionMoreButtonAnimationStartPosition(): Double {
      val fnPtr = _440593927_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__440593927_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_WidthExpansionMoreButtonAnimationEndPosition(): Double {
      val fnPtr = _440593927_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__440593927_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ExpandUpOverflowVerticalPosition(): Double {
      val fnPtr = _440593927_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__440593927_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ExpandDownOverflowVerticalPosition(): Double {
      val fnPtr = _440593927_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__440593927_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ExpandUpAnimationStartPosition(): Double {
      val fnPtr = _440593927_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__440593927_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ExpandUpAnimationEndPosition(): Double {
      val fnPtr = _440593927_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__440593927_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ExpandUpAnimationHoldPosition(): Double {
      val fnPtr = _440593927_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__440593927_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ExpandDownAnimationStartPosition(): Double {
      val fnPtr = _440593927_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__440593927_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ExpandDownAnimationEndPosition(): Double {
      val fnPtr = _440593927_VtblPtr!!.getPointer(22L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__440593927_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ExpandDownAnimationHoldPosition(): Double {
      val fnPtr = _440593927_VtblPtr!!.getPointer(23L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__440593927_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ContentClipRect(): Rect? {
      val fnPtr = _440593927_VtblPtr!!.getPointer(24L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_OverflowContentClipRect(): Rect? {
      val fnPtr = _440593927_VtblPtr!!.getPointer(25L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Rect>()
      val hr = fn.invokeHR(arrayOf(__440593927_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ICommandBarFlyoutCommandBarTemplateSettings_Impl(
    ...
    public override val __440593927_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICommandBarFlyoutCommandBarTemplateSettings, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("533cc5cadcf75f9da460934a883acdc1")
    ...
    public override fun toNative(obj: ICommandBarFlyoutCommandBarTemplateSettings): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__440593927_Ptr))
  }
