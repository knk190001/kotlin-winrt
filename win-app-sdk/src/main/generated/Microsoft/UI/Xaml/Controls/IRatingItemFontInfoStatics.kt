...
@Signature("{f600f780-a5ed-537f-90c2-eaee8a61f8a5}")
@Guid("f600f780a5ed537f90c2eaee8a61f8a5")
@WinRTInterface("f600f780a5ed537f90c2eaee8a61f8a5")
...
public interface IRatingItemFontInfoStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IRatingItemFontInfoStatics {
    public val __1678636271_Ptr: Pointer?

    public val _1678636271_VtblPtr: Pointer?
      get() = __1678636271_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_DisabledGlyphProperty(): DependencyProperty? {
      val fnPtr = _1678636271_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1678636271_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_GlyphProperty(): DependencyProperty? {
      val fnPtr = _1678636271_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1678636271_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_PlaceholderGlyphProperty(): DependencyProperty? {
      val fnPtr = _1678636271_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1678636271_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_PointerOverGlyphProperty(): DependencyProperty? {
      val fnPtr = _1678636271_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1678636271_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_PointerOverPlaceholderGlyphProperty(): DependencyProperty? {
      val fnPtr = _1678636271_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1678636271_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_UnsetGlyphProperty(): DependencyProperty? {
      val fnPtr = _1678636271_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1678636271_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IRatingItemFontInfoStatics_Impl(
    ...
    public override val __1678636271_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IRatingItemFontInfoStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("f600f780a5ed537f90c2eaee8a61f8a5")
    ...
    public override fun toNative(obj: IRatingItemFontInfoStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1678636271_Ptr))
  }
