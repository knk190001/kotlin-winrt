...
@Signature("{c105a5e5-cea8-5efd-8be8-3d89b54cbd5f}")
@Guid("c105a5e5cea85efd8be83d89b54cbd5f")
@WinRTInterface("c105a5e5cea85efd8be83d89b54cbd5f")
...
public interface ITreeViewNodeFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITreeViewNodeFactory {
    public val __62653470_Ptr: Pointer?

    public val _62653470_VtblPtr: Pointer?
      get() = __62653470_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        TreeViewNode? {
      val fnPtr = _62653470_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<TreeViewNode>()
      val hr = fn.invokeHR(arrayOf(__62653470_Ptr, marshalToNative(baseInterface),
  ...
  public class ITreeViewNodeFactory_Impl(
    ...
    public override val __62653470_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITreeViewNodeFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("c105a5e5cea85efd8be83d89b54cbd5f")
    ...
    public override fun toNative(obj: ITreeViewNodeFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__62653470_Ptr))
  }
