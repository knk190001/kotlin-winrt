...
@Signature("{eb7d591e-1314-5409-9231-5b8e3be187a7}")
@Guid("eb7d591e1314540992315b8e3be187a7")
@WinRTInterface("eb7d591e1314540992315b8e3be187a7")
...
public interface IDatePickerFlyoutItem : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IDatePickerFlyoutItem {
    public val __748202737_Ptr: Pointer?

    public val _748202737_VtblPtr: Pointer?
      get() = __748202737_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_PrimaryText(): String? {
      val fnPtr = _748202737_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__748202737_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_PrimaryText(value: String?): Unit {
      val fnPtr = _748202737_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__748202737_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_SecondaryText(): String? {
      val fnPtr = _748202737_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__748202737_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_SecondaryText(value: String?): Unit {
      val fnPtr = _748202737_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__748202737_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IDatePickerFlyoutItem_Impl(
    ...
    public override val __748202737_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IDatePickerFlyoutItem, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("eb7d591e1314540992315b8e3be187a7")
    ...
    public override fun toNative(obj: IDatePickerFlyoutItem): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__748202737_Ptr))
  }
