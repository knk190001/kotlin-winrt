...
@Signature("{1a05853c-b101-542c-9a1e-775a044c4652}")
@Guid("1a05853cb101542c9a1e775a044c4652")
@WinRTInterface("1a05853cb101542c9a1e775a044c4652")
...
public interface ITreeViewItemInvokedEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITreeViewItemInvokedEventArgs {
    public val __248457096_Ptr: Pointer?

    public val _248457096_VtblPtr: Pointer?
      get() = __248457096_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_InvokedItem(): IUnknown? {
      val fnPtr = _248457096_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IUnknown>()
      val hr = fn.invokeHR(arrayOf(__248457096_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Handled(value: Boolean): Unit {
      val fnPtr = _248457096_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__248457096_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Handled(): Boolean {
      val fnPtr = _248457096_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class ITreeViewItemInvokedEventArgs_Impl(
    ...
    public override val __248457096_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITreeViewItemInvokedEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("1a05853cb101542c9a1e775a044c4652")
    ...
    public override fun toNative(obj: ITreeViewItemInvokedEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__248457096_Ptr))
  }
