...
@ABIMarker(AnimatedBackVisualSource.ABI::class)
@Signature("rc(Microsoft.UI.Xaml.Controls.AnimatedVisuals.AnimatedBackVisualSource;{294765c3-70e3-555c-9657-01fc4051169d})")
@WinRTByReference(brClass = AnimatedBackVisualSource.ByReference::class)
public class AnimatedBackVisualSource(
  ptr: JNAPointer? = NULL
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<AnimatedBackVisualSource> {
    public override fun getValue() = AnimatedBackVisualSource(pointer.getPointer(0))

    public fun setValue(value: AnimatedBackVisualSource): Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  public object ABI : IABI<AnimatedBackVisualSource, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.AnimatedVisuals.AnimatedBackVisualSource".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public override fun fromNative(segment: MemoryAddress): AnimatedBackVisualSource {
      val address = segment.toRawLongValue()
      return AnimatedBackVisualSource(Pointer(address))
    }

    public override fun toNative(obj: AnimatedBackVisualSource): MemoryAddress =
