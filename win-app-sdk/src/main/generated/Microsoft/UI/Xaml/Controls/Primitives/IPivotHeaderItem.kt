...
@Signature("{612d6f77-6c76-5239-8894-efbab0f53e3e}")
@Guid("612d6f776c7652398894efbab0f53e3e")
@WinRTInterface("612d6f776c7652398894efbab0f53e3e")
...
public interface IPivotHeaderItem : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPivotHeaderItem {
    public val __965379249_Ptr: Pointer?

    public val _965379249_VtblPtr: Pointer?
      get() = __965379249_Ptr?.getPointer(0)
  }

  public class IPivotHeaderItem_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __965379249_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPivotHeaderItem, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("612d6f776c7652398894efbab0f53e3e")
    ...
    public override fun toNative(obj: IPivotHeaderItem): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__965379249_Ptr))
  }
