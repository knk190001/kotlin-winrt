...
import Microsoft.UI.Xaml.Controls.IBitmapIconSourceFactory.ABI.IID
...
@Signature("rc(Microsoft.UI.Xaml.Controls.BitmapIconSource;{a6b6cccc-ea8f-53ca-831f-2abe85cd6d8c})")
...
public open class BitmapIconSource(
  ...
  private val __427601846_Interface: IBitmapIconSource.WithDefault by lazy {
    as_427601846()
  }


  public override val __427601846_Ptr: JNAPointer? by lazy {
    __427601846_Interface.__427601846_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__427601846_Interface)

  public constructor() : this(ABI.activate())

  private fun as_427601846(): IBitmapIconSource.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<BitmapIconSource, MemoryAddress> {
    ...
    public fun createIBitmapIconSourceStatics(): IBitmapIconSourceStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.BitmapIconSource".toHandle(),refiid,interfacePtr)
    ...
    public fun createIBitmapIconSourceFactory(): IBitmapIconSourceFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.BitmapIconSource".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
