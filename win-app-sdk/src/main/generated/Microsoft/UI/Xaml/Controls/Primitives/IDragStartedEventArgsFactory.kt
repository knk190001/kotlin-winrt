...
@Signature("{36078aa3-906c-5ef0-9d24-30c09f79c18f}")
@Guid("36078aa3906c5ef09d2430c09f79c18f")
@WinRTInterface("36078aa3906c5ef09d2430c09f79c18f")
...
public interface IDragStartedEventArgsFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IDragStartedEventArgsFactory {
    public val __766099023_Ptr: Pointer?

    public val _766099023_VtblPtr: Pointer?
      get() = __766099023_Ptr?.getPointer(0)
    ...
    public override fun CreateInstanceWithHorizontalOffsetAndVerticalOffset(
      ...
      val fnPtr = _766099023_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DragStartedEventArgs>()
      val hr = fn.invokeHR(arrayOf(__766099023_Ptr, horizontalOffset, verticalOffset,
  ...
  public class IDragStartedEventArgsFactory_Impl(
    ...
    public override val __766099023_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IDragStartedEventArgsFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("36078aa3906c5ef09d2430c09f79c18f")
    ...
    public override fun toNative(obj: IDragStartedEventArgsFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__766099023_Ptr))
  }
