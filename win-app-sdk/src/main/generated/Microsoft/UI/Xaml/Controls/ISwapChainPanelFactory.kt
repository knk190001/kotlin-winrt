...
@Signature("{38d00b69-5759-5f37-9e1c-3ae0d4288b26}")
@Guid("38d00b6957595f379e1c3ae0d4288b26")
@WinRTInterface("38d00b6957595f379e1c3ae0d4288b26")
...
public interface ISwapChainPanelFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISwapChainPanelFactory {
    public val __533516045_Ptr: Pointer?

    public val _533516045_VtblPtr: Pointer?
      get() = __533516045_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        SwapChainPanel? {
      val fnPtr = _533516045_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<SwapChainPanel>()
      val hr = fn.invokeHR(arrayOf(__533516045_Ptr, marshalToNative(baseInterface),
  ...
  public class ISwapChainPanelFactory_Impl(
    ...
    public override val __533516045_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISwapChainPanelFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("38d00b6957595f379e1c3ae0d4288b26")
    ...
    public override fun toNative(obj: ISwapChainPanelFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__533516045_Ptr))
  }
