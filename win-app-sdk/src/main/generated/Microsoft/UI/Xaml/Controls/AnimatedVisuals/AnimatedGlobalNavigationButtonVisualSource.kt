...
@ABIMarker(AnimatedGlobalNavigationButtonVisualSource.ABI::class)
@Signature("rc(Microsoft.UI.Xaml.Controls.AnimatedVisuals.AnimatedGlobalNavigationButtonVisualSource;{294765c3-70e3-555c-9657-01fc4051169d})")
@WinRTByReference(brClass = AnimatedGlobalNavigationButtonVisualSource.ByReference::class)
public class AnimatedGlobalNavigationButtonVisualSource(
  ptr: JNAPointer? = NULL
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<AnimatedGlobalNavigationButtonVisualSource> {
    public override fun getValue() =
        AnimatedGlobalNavigationButtonVisualSource(pointer.getPointer(0))

    public fun setValue(value: AnimatedGlobalNavigationButtonVisualSource): Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  public object ABI : IABI<AnimatedGlobalNavigationButtonVisualSource, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.AnimatedVisuals.AnimatedGlobalNavigationButtonVisualSource".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public override fun fromNative(segment: MemoryAddress):
      ...
      return AnimatedGlobalNavigationButtonVisualSource(Pointer(address))
    }

    public override fun toNative(obj: AnimatedGlobalNavigationButtonVisualSource): MemoryAddress =
