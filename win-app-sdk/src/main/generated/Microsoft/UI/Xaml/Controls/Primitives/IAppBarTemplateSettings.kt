...
@Signature("{fe60e73f-9a52-5e0a-b738-426f97d09768}")
@Guid("fe60e73f9a525e0ab738426f97d09768")
@WinRTInterface("fe60e73f9a525e0ab738426f97d09768")
...
public interface IAppBarTemplateSettings : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IAppBarTemplateSettings {
    public val __828544352_Ptr: Pointer?

    public val _828544352_VtblPtr: Pointer?
      get() = __828544352_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ClipRect(): Rect? {
      val fnPtr = _828544352_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Rect>()
      val hr = fn.invokeHR(arrayOf(__828544352_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_CompactVerticalDelta(): Double {
      val fnPtr = _828544352_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_CompactRootMargin(): Thickness? {
      val fnPtr = _828544352_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_MinimalVerticalDelta(): Double {
      val fnPtr = _828544352_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__828544352_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_MinimalRootMargin(): Thickness? {
      val fnPtr = _828544352_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Thickness>()
      val hr = fn.invokeHR(arrayOf(__828544352_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_HiddenVerticalDelta(): Double {
      val fnPtr = _828544352_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__828544352_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_HiddenRootMargin(): Thickness? {
      val fnPtr = _828544352_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Thickness>()
      val hr = fn.invokeHR(arrayOf(__828544352_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_NegativeCompactVerticalDelta(): Double {
      val fnPtr = _828544352_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__828544352_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_NegativeMinimalVerticalDelta(): Double {
      val fnPtr = _828544352_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__828544352_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_NegativeHiddenVerticalDelta(): Double {
      val fnPtr = _828544352_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__828544352_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IAppBarTemplateSettings_Impl(
    ...
    public override val __828544352_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IAppBarTemplateSettings, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("fe60e73f9a525e0ab738426f97d09768")
    ...
    public override fun toNative(obj: IAppBarTemplateSettings): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__828544352_Ptr))
  }
