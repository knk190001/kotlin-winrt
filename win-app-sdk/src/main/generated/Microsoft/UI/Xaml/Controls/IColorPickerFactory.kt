...
@Signature("{72c350e2-0a20-5b9b-ac54-633b97d7ffde}")
@Guid("72c350e20a205b9bac54633b97d7ffde")
@WinRTInterface("72c350e20a205b9bac54633b97d7ffde")
...
public interface IColorPickerFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IColorPickerFactory {
    public val __1189181440_Ptr: Pointer?

    public val _1189181440_VtblPtr: Pointer?
      get() = __1189181440_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        ColorPicker? {
      val fnPtr = _1189181440_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ColorPicker>()
      val hr = fn.invokeHR(arrayOf(__1189181440_Ptr, marshalToNative(baseInterface),
  ...
  public class IColorPickerFactory_Impl(
    ...
    public override val __1189181440_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IColorPickerFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("72c350e20a205b9bac54633b97d7ffde")
    ...
    public override fun toNative(obj: IColorPickerFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1189181440_Ptr))
  }
