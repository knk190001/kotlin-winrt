...
@Signature("{e2ebe630-6629-5b7b-8666-fdeb9b98db2c}")
@Guid("e2ebe63066295b7b8666fdeb9b98db2c")
@WinRTInterface("e2ebe63066295b7b8666fdeb9b98db2c")
...
public interface IPivotItemStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPivotItemStatics {
    public val __990548137_Ptr: Pointer?

    public val _990548137_VtblPtr: Pointer?
      get() = __990548137_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_HeaderProperty(): DependencyProperty? {
      val fnPtr = _990548137_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__990548137_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IPivotItemStatics_Impl(
    ...
    public override val __990548137_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPivotItemStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("e2ebe63066295b7b8666fdeb9b98db2c")
    ...
    public override fun toNative(obj: IPivotItemStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__990548137_Ptr))
  }
