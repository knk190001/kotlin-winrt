...
@Signature("{44092863-c09e-551e-85bf-951b552950c8}")
@Guid("44092863c09e551e85bf951b552950c8")
@WinRTInterface("44092863c09e551e85bf951b552950c8")
...
public interface IListViewBaseFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IListViewBaseFactory {
    public val __1486612625_Ptr: Pointer?

    public val _1486612625_VtblPtr: Pointer?
      get() = __1486612625_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        ListViewBase? {
      val fnPtr = _1486612625_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ListViewBase>()
      val hr = fn.invokeHR(arrayOf(__1486612625_Ptr, marshalToNative(baseInterface),
  ...
  public class IListViewBaseFactory_Impl(
    ...
    public override val __1486612625_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IListViewBaseFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("44092863c09e551e85bf951b552950c8")
    ...
    public override fun toNative(obj: IListViewBaseFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1486612625_Ptr))
  }
