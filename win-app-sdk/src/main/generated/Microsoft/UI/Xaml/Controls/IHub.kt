...
@Signature("{b867e995-0f2e-51a6-a090-e0be2e7cf3ec}")
@Guid("b867e9950f2e51a6a090e0be2e7cf3ec")
@WinRTInterface("b867e9950f2e51a6a090e0be2e7cf3ec")
...
public interface IHub : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IHub {
    public val __753212878_Ptr: Pointer?

    public val _753212878_VtblPtr: Pointer?
      get() = __753212878_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Header(): IUnknown? {
      val fnPtr = _753212878_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IUnknown>()
      val hr = fn.invokeHR(arrayOf(__753212878_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Header(value: IUnknown?): Unit {
      val fnPtr = _753212878_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__753212878_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_HeaderTemplate(): DataTemplate? {
      val fnPtr = _753212878_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_HeaderTemplate(value: DataTemplate?): Unit {
      val fnPtr = _753212878_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__753212878_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Orientation(): Orientation? {
      val fnPtr = _753212878_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Orientation(value: Orientation?): Unit {
      val fnPtr = _753212878_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__753212878_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_DefaultSectionIndex(): Int {
      val fnPtr = _753212878_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_DefaultSectionIndex(value: Int): Unit {
      val fnPtr = _753212878_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__753212878_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Sections(): IVector<HubSection?>? {
      val fnPtr = _753212878_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_SectionsInView(): IVector<HubSection?>? {
      val fnPtr = _753212878_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IVector<HubSection?>>()
      val hr = fn.invokeHR(arrayOf(__753212878_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_SectionHeaders(): IObservableVector<IUnknown?>? {
      val fnPtr = _753212878_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun add_SectionHeaderClick(handler: HubSectionHeaderClickEventHandler?):
        EventRegistrationToken? {
      val fnPtr = _753212878_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__753212878_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun remove_SectionHeaderClick(token: EventRegistrationToken?): Unit {
      val fnPtr = _753212878_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__753212878_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun add_SectionsInViewChanged(handler: SectionsInViewChangedEventHandler?):
        EventRegistrationToken? {
      val fnPtr = _753212878_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__753212878_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
    ...
    public override fun remove_SectionsInViewChanged(token: EventRegistrationToken?): Unit {
      val fnPtr = _753212878_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__753212878_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun ScrollToSection(section: HubSection?): Unit {
      val fnPtr = _753212878_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__753212878_Ptr, marshalToNative(section),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IHub_Impl(
    ...
    public override val __753212878_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IHub, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("b867e9950f2e51a6a090e0be2e7cf3ec")
    ...
    public override fun toNative(obj: IHub): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__753212878_Ptr))
  }
