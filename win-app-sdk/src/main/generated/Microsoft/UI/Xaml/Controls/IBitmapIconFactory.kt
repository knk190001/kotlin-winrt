...
@Signature("{b43b5ddc-cdb5-5ad6-8ac1-2fcca33be39e}")
@Guid("b43b5ddccdb55ad68ac12fcca33be39e")
@WinRTInterface("b43b5ddccdb55ad68ac12fcca33be39e")
...
public interface IBitmapIconFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IBitmapIconFactory {
    public val __559238843_Ptr: Pointer?

    public val _559238843_VtblPtr: Pointer?
      get() = __559238843_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        BitmapIcon? {
      val fnPtr = _559238843_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<BitmapIcon>()
      val hr = fn.invokeHR(arrayOf(__559238843_Ptr, marshalToNative(baseInterface),
  ...
  public class IBitmapIconFactory_Impl(
    ...
    public override val __559238843_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IBitmapIconFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("b43b5ddccdb55ad68ac12fcca33be39e")
    ...
    public override fun toNative(obj: IBitmapIconFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__559238843_Ptr))
  }
