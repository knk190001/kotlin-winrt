...
@Signature("rc(Microsoft.UI.Xaml.Controls.Primitives.JumpListItemBackgroundConverter;{c475bb52-ea34-5cde-9851-7841febd3d1d})")
...
public class JumpListItemBackgroundConverter(
  ...
  private val __701579262_Interface: IJumpListItemBackgroundConverter.WithDefault by lazy {
    as_701579262()
  }
  ...
  public override val __701579262_Ptr: JNAPointer? by lazy {
    __701579262_Interface.__701579262_Ptr
  }
  ...
  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__701579262_Interface, __82778302_Interface)

  public constructor() : this(ABI.activate())

  private fun as_701579262(): IJumpListItemBackgroundConverter.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<JumpListItemBackgroundConverter, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.Primitives.JumpListItemBackgroundConverter".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIJumpListItemBackgroundConverterStatics():
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.Primitives.JumpListItemBackgroundConverter".toHandle(),refiid,interfacePtr)
      val result =
