...
@Signature("{70437a49-2999-5a97-b19d-354ef59d4f5c}")
@Guid("70437a4929995a97b19d354ef59d4f5c")
@WinRTInterface("70437a4929995a97b19d354ef59d4f5c")
...
public interface ITreeViewItem : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITreeViewItem {
    public val __1371339683_Ptr: Pointer?

    public val _1371339683_VtblPtr: Pointer?
      get() = __1371339683_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_GlyphOpacity(): Double {
      val fnPtr = _1371339683_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1371339683_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_GlyphOpacity(value: Double): Unit {
      val fnPtr = _1371339683_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1371339683_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_GlyphBrush(): Brush? {
      val fnPtr = _1371339683_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_GlyphBrush(value: Brush?): Unit {
      val fnPtr = _1371339683_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1371339683_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_ExpandedGlyph(): String? {
      val fnPtr = _1371339683_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_ExpandedGlyph(value: String?): Unit {
      val fnPtr = _1371339683_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1371339683_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_CollapsedGlyph(): String? {
      val fnPtr = _1371339683_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__1371339683_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_CollapsedGlyph(value: String?): Unit {
      val fnPtr = _1371339683_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1371339683_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_GlyphSize(): Double {
      val fnPtr = _1371339683_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1371339683_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_GlyphSize(value: Double): Unit {
      val fnPtr = _1371339683_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1371339683_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_IsExpanded(): Boolean {
      val fnPtr = _1371339683_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_IsExpanded(value: Boolean): Unit {
      val fnPtr = _1371339683_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1371339683_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_TreeViewItemTemplateSettings(): TreeViewItemTemplateSettings? {
      val fnPtr = _1371339683_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class ITreeViewItem_Impl(
    ...
    public override val __1371339683_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITreeViewItem, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("70437a4929995a97b19d354ef59d4f5c")
    ...
    public override fun toNative(obj: ITreeViewItem): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1371339683_Ptr))
  }
