...
import Microsoft.UI.Xaml.Controls.IRatingItemImageInfoFactory.ABI.IID
...
@Signature("rc(Microsoft.UI.Xaml.Controls.RatingItemImageInfo;{fcdaebd2-6fb5-523f-959e-3516bc0b72b7})")
...
public open class RatingItemImageInfo(
  ...
  private val __927448302_Interface: IRatingItemImageInfo.WithDefault by lazy {
    as_927448302()
  }


  public override val __927448302_Ptr: JNAPointer? by lazy {
    __927448302_Interface.__927448302_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__927448302_Interface)

  public constructor() : this(ABI.activate())

  private fun as_927448302(): IRatingItemImageInfo.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<RatingItemImageInfo, MemoryAddress> {
    ...
    public fun createIRatingItemImageInfoStatics(): IRatingItemImageInfoStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.RatingItemImageInfo".toHandle(),refiid,interfacePtr)
      val result =
    ...
    public fun createIRatingItemImageInfoFactory(): IRatingItemImageInfoFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.RatingItemImageInfo".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
