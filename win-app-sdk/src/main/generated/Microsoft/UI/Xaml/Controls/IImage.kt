...
@Signature("{220d3d8d-66de-53a1-a215-ba9c165565ab}")
@Guid("220d3d8d66de53a1a215ba9c165565ab")
@WinRTInterface("220d3d8d66de53a1a215ba9c165565ab")
...
public interface IImage : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IImage {
    public val __2011209740_Ptr: Pointer?

    public val _2011209740_VtblPtr: Pointer?
      get() = __2011209740_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Source(): ImageSource? {
      val fnPtr = _2011209740_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ImageSource>()
      val hr = fn.invokeHR(arrayOf(__2011209740_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Source(value: ImageSource?): Unit {
      val fnPtr = _2011209740_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2011209740_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Stretch(): Stretch? {
      val fnPtr = _2011209740_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Stretch(value: Stretch?): Unit {
      val fnPtr = _2011209740_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2011209740_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_NineGrid(): Thickness? {
      val fnPtr = _2011209740_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_NineGrid(value: Thickness?): Unit {
      val fnPtr = _2011209740_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2011209740_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun add_ImageFailed(handler: ExceptionRoutedEventHandler?):
      ...
      val fnPtr = _2011209740_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__2011209740_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun remove_ImageFailed(token: EventRegistrationToken?): Unit {
      val fnPtr = _2011209740_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2011209740_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun add_ImageOpened(handler: RoutedEventHandler?): EventRegistrationToken? {
      val fnPtr = _2011209740_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__2011209740_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
    ...
    public override fun remove_ImageOpened(token: EventRegistrationToken?): Unit {
      val fnPtr = _2011209740_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2011209740_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun GetAsCastingSource(): CastingSource? {
      val fnPtr = _2011209740_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun GetAlphaMask(): CompositionBrush? {
      val fnPtr = _2011209740_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class IImage_Impl(
    ...
    public override val __2011209740_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IImage, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("220d3d8d66de53a1a215ba9c165565ab")
    ...
    public override fun toNative(obj: IImage): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2011209740_Ptr))
  }
