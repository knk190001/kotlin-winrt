...
@Signature("{6db6ee42-a333-5e5b-9ce8-f5e2f46f4d66}")
@Guid("6db6ee42a3335e5b9ce8f5e2f46f4d66")
@WinRTInterface("6db6ee42a3335e5b9ce8f5e2f46f4d66")
...
public interface IRichTextBlockOverflowStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IRichTextBlockOverflowStatics {
    public val __1741237286_Ptr: Pointer?

    public val _1741237286_VtblPtr: Pointer?
      get() = __1741237286_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_OverflowContentTargetProperty(): DependencyProperty? {
      val fnPtr = _1741237286_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1741237286_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_PaddingProperty(): DependencyProperty? {
      val fnPtr = _1741237286_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1741237286_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_HasOverflowContentProperty(): DependencyProperty? {
      val fnPtr = _1741237286_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1741237286_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_MaxLinesProperty(): DependencyProperty? {
      val fnPtr = _1741237286_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1741237286_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsTextTrimmedProperty(): DependencyProperty? {
      val fnPtr = _1741237286_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1741237286_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IRichTextBlockOverflowStatics_Impl(
    ...
    public override val __1741237286_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IRichTextBlockOverflowStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("6db6ee42a3335e5b9ce8f5e2f46f4d66")
    ...
    public override fun toNative(obj: IRichTextBlockOverflowStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1741237286_Ptr))
  }
