...
@Signature("{8f7e2159-e61d-576f-8476-f83fde3d689e}")
@Guid("8f7e2159e61d576f8476f83fde3d689e")
@WinRTInterface("8f7e2159e61d576f8476f83fde3d689e")
...
public interface ISelector : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISelector {
    public val __2076328752_Ptr: Pointer?

    public val _2076328752_VtblPtr: Pointer?
      get() = __2076328752_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_SelectedIndex(): Int {
      val fnPtr = _2076328752_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__2076328752_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_SelectedIndex(value: Int): Unit {
      val fnPtr = _2076328752_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2076328752_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_SelectedItem(): IUnknown? {
      val fnPtr = _2076328752_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_SelectedItem(value: IUnknown?): Unit {
      val fnPtr = _2076328752_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2076328752_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_SelectedValue(): IUnknown? {
      val fnPtr = _2076328752_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IUnknown>()
      val hr = fn.invokeHR(arrayOf(__2076328752_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_SelectedValue(value: IUnknown?): Unit {
      val fnPtr = _2076328752_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2076328752_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_SelectedValuePath(): String? {
      val fnPtr = _2076328752_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_SelectedValuePath(value: String?): Unit {
      val fnPtr = _2076328752_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2076328752_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_IsSynchronizedWithCurrentItem(): IReference<Boolean>? {
      val fnPtr = _2076328752_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_IsSynchronizedWithCurrentItem(value: IReference<Boolean>?): Unit {
      val fnPtr = _2076328752_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2076328752_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun add_SelectionChanged(handler: SelectionChangedEventHandler?):
      ...
      val fnPtr = _2076328752_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__2076328752_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun remove_SelectionChanged(token: EventRegistrationToken?): Unit {
      val fnPtr = _2076328752_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2076328752_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class ISelector_Impl(
    ...
    public override val __2076328752_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISelector, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("8f7e2159e61d576f8476f83fde3d689e")
    ...
    public override fun toNative(obj: ISelector): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2076328752_Ptr))
  }
