...
@Signature("{a53b9b73-bff9-548d-a294-ac63d819f78a}")
@Guid("a53b9b73bff9548da294ac63d819f78a")
@WinRTInterface("a53b9b73bff9548da294ac63d819f78a")
...
public interface IRatingControlFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IRatingControlFactory {
    public val __1711858639_Ptr: Pointer?

    public val _1711858639_VtblPtr: Pointer?
      get() = __1711858639_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        RatingControl? {
      val fnPtr = _1711858639_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<RatingControl>()
      val hr = fn.invokeHR(arrayOf(__1711858639_Ptr, marshalToNative(baseInterface),
  ...
  public class IRatingControlFactory_Impl(
    ...
    public override val __1711858639_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IRatingControlFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("a53b9b73bff9548da294ac63d819f78a")
    ...
    public override fun toNative(obj: IRatingControlFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1711858639_Ptr))
  }
