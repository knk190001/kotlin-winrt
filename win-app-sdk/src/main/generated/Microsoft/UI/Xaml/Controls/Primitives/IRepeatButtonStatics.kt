...
@Signature("{b57320f6-a58a-589c-9f41-aab02f51e829}")
@Guid("b57320f6a58a589c9f41aab02f51e829")
@WinRTInterface("b57320f6a58a589c9f41aab02f51e829")
...
public interface IRepeatButtonStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IRepeatButtonStatics {
    public val __647877017_Ptr: Pointer?

    public val _647877017_VtblPtr: Pointer?
      get() = __647877017_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_DelayProperty(): DependencyProperty? {
      val fnPtr = _647877017_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__647877017_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IntervalProperty(): DependencyProperty? {
      val fnPtr = _647877017_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__647877017_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IRepeatButtonStatics_Impl(
    ...
    public override val __647877017_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IRepeatButtonStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("b57320f6a58a589c9f41aab02f51e829")
    ...
    public override fun toNative(obj: IRepeatButtonStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__647877017_Ptr))
  }
