...
import Microsoft.UI.Xaml.Controls.Primitives.ListViewItemTemplateSettings
...
@Signature("{05fe41c2-0451-5d38-9c55-5d10cfd08889}")
@Guid("05fe41c204515d389c555d10cfd08889")
@WinRTInterface("05fe41c204515d389c555d10cfd08889")
...
public interface IListViewItem : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IListViewItem {
    public val __1085423965_Ptr: Pointer?

    public val _1085423965_VtblPtr: Pointer?
      get() = __1085423965_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_TemplateSettings(): ListViewItemTemplateSettings? {
      val fnPtr = _1085423965_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ListViewItemTemplateSettings>()
      val hr = fn.invokeHR(arrayOf(__1085423965_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IListViewItem_Impl(
    ...
    public override val __1085423965_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IListViewItem, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("05fe41c204515d389c555d10cfd08889")
    ...
    public override fun toNative(obj: IListViewItem): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1085423965_Ptr))
  }
