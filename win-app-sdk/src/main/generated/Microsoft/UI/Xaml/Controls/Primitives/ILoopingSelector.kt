...
import Microsoft.UI.Xaml.Controls.SelectionChangedEventHandler
...
@Signature("{077759ac-6b52-5054-bd49-9eba843cf894}")
@Guid("077759ac6b525054bd499eba843cf894")
@WinRTInterface("077759ac6b525054bd499eba843cf894")
...
public interface ILoopingSelector : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ILoopingSelector {
    public val __920935500_Ptr: Pointer?

    public val _920935500_VtblPtr: Pointer?
      get() = __920935500_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ShouldLoop(): Boolean {
      val fnPtr = _920935500_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__920935500_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ShouldLoop(value: Boolean): Unit {
      val fnPtr = _920935500_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__920935500_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Items(): IVector<IUnknown?>? {
      val fnPtr = _920935500_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Items(value: IVector<IUnknown?>?): Unit {
      val fnPtr = _920935500_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__920935500_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_SelectedIndex(): Int {
      val fnPtr = _920935500_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_SelectedIndex(value: Int): Unit {
      val fnPtr = _920935500_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__920935500_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_SelectedItem(): IUnknown? {
      val fnPtr = _920935500_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_SelectedItem(value: IUnknown?): Unit {
      val fnPtr = _920935500_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__920935500_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ItemWidth(): Int {
      val fnPtr = _920935500_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__920935500_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ItemWidth(value: Int): Unit {
      val fnPtr = _920935500_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__920935500_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ItemHeight(): Int {
      val fnPtr = _920935500_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__920935500_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ItemHeight(value: Int): Unit {
      val fnPtr = _920935500_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__920935500_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ItemTemplate(): DataTemplate? {
      val fnPtr = _920935500_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_ItemTemplate(value: DataTemplate?): Unit {
      val fnPtr = _920935500_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__920935500_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun add_SelectionChanged(handler: SelectionChangedEventHandler?):
      ...
      val fnPtr = _920935500_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__920935500_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun remove_SelectionChanged(token: EventRegistrationToken?): Unit {
      val fnPtr = _920935500_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__920935500_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class ILoopingSelector_Impl(
    ...
    public override val __920935500_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ILoopingSelector, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("077759ac6b525054bd499eba843cf894")
    ...
    public override fun toNative(obj: ILoopingSelector): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__920935500_Ptr))
  }
