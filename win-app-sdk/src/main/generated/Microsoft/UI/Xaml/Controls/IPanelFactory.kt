...
@Signature("{f5e7e21c-4c97-5d20-bee6-3e4fc6ab14e9}")
@Guid("f5e7e21c4c975d20bee63e4fc6ab14e9")
@WinRTInterface("f5e7e21c4c975d20bee63e4fc6ab14e9")
...
public interface IPanelFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPanelFactory {
    public val __320369235_Ptr: Pointer?

    public val _320369235_VtblPtr: Pointer?
      get() = __320369235_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        Panel? {
      val fnPtr = _320369235_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Panel>()
      val hr = fn.invokeHR(arrayOf(__320369235_Ptr, marshalToNative(baseInterface),
  ...
  public class IPanelFactory_Impl(
    ...
    public override val __320369235_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPanelFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("f5e7e21c4c975d20bee63e4fc6ab14e9")
    ...
    public override fun toNative(obj: IPanelFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__320369235_Ptr))
  }
