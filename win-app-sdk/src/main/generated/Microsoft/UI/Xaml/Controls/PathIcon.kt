...
import Microsoft.UI.Xaml.Controls.IPathIconFactory.ABI.IID
...
@Signature("rc(Microsoft.UI.Xaml.Controls.PathIcon;{5c8229db-51cd-5a3b-88ef-1d9a8ac97683})")
...
public open class PathIcon(
  ...
  private val __938184965_Interface: IPathIcon.WithDefault by lazy {
    as_938184965()
  }


  public override val __938184965_Ptr: JNAPointer? by lazy {
    __938184965_Interface.__938184965_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__938184965_Interface)

  public constructor() : this(ABI.activate())

  private fun as_938184965(): IPathIcon.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<PathIcon, MemoryAddress> {
    ...
    public fun createIPathIconStatics(): IPathIconStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.PathIcon".toHandle(),refiid,interfacePtr)
    ...
    public fun createIPathIconFactory(): IPathIconFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.PathIcon".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
