...
@Signature("{1e9f68ee-6ce5-5cbf-bbfe-b8cd284b9c23}")
@Guid("1e9f68ee6ce55cbfbbfeb8cd284b9c23")
@WinRTInterface("1e9f68ee6ce55cbfbbfeb8cd284b9c23")
...
public interface IScrollViewerView : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IScrollViewerView {
    public val __1378005429_Ptr: Pointer?

    public val _1378005429_VtblPtr: Pointer?
      get() = __1378005429_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_HorizontalOffset(): Double {
      val fnPtr = _1378005429_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1378005429_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_VerticalOffset(): Double {
      val fnPtr = _1378005429_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1378005429_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ZoomFactor(): Float {
      val fnPtr = _1378005429_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class IScrollViewerView_Impl(
    ...
    public override val __1378005429_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IScrollViewerView, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("1e9f68ee6ce55cbfbbfeb8cd284b9c23")
    ...
    public override fun toNative(obj: IScrollViewerView): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1378005429_Ptr))
  }
