...
@Signature("{3b07f068-a764-549c-b4cf-ebab40ec5dd1}")
@Guid("3b07f068a764549cb4cfebab40ec5dd1")
@WinRTInterface("3b07f068a764549cb4cfebab40ec5dd1")
...
public interface INavigationViewItemPresenterStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : INavigationViewItemPresenterStatics {
    public val __1879472570_Ptr: Pointer?

    public val _1879472570_VtblPtr: Pointer?
      get() = __1879472570_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_IconProperty(): DependencyProperty? {
      val fnPtr = _1879472570_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1879472570_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_TemplateSettingsProperty(): DependencyProperty? {
      val fnPtr = _1879472570_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1879472570_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class INavigationViewItemPresenterStatics_Impl(
    ...
    public override val __1879472570_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<INavigationViewItemPresenterStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("3b07f068a764549cb4cfebab40ec5dd1")
    ...
    public override fun toNative(obj: INavigationViewItemPresenterStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1879472570_Ptr))
  }
