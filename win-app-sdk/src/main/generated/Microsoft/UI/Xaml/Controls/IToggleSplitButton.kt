...
@Signature("{5c0f247b-bd00-5509-88a8-b09007ae22b0}")
@Guid("5c0f247bbd00550988a8b09007ae22b0")
@WinRTInterface("5c0f247bbd00550988a8b09007ae22b0")
...
public interface IToggleSplitButton : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IToggleSplitButton {
    public val __398009327_Ptr: Pointer?

    public val _398009327_VtblPtr: Pointer?
      get() = __398009327_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_IsChecked(): Boolean {
      val fnPtr = _398009327_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__398009327_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_IsChecked(value: Boolean): Unit {
      val fnPtr = _398009327_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__398009327_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun add_IsCheckedChanged(handler: TypedEventHandler<ToggleSplitButton?,
        ToggleSplitButtonIsCheckedChangedEventArgs?>?): EventRegistrationToken? {
      val fnPtr = _398009327_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__398009327_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun remove_IsCheckedChanged(token: EventRegistrationToken?): Unit {
      val fnPtr = _398009327_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__398009327_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IToggleSplitButton_Impl(
    ...
    public override val __398009327_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IToggleSplitButton, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("5c0f247bbd00550988a8b09007ae22b0")
    ...
    public override fun toNative(obj: IToggleSplitButton): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__398009327_Ptr))
  }
