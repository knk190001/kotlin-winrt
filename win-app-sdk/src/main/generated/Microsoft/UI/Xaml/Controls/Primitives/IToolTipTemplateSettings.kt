...
@Signature("{4f725950-ff64-5cf1-9e86-9011fb10e88e}")
@Guid("4f725950ff645cf19e869011fb10e88e")
@WinRTInterface("4f725950ff645cf19e869011fb10e88e")
...
public interface IToolTipTemplateSettings : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IToolTipTemplateSettings {
    public val __1424837967_Ptr: Pointer?

    public val _1424837967_VtblPtr: Pointer?
      get() = __1424837967_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_FromHorizontalOffset(): Double {
      val fnPtr = _1424837967_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1424837967_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_FromVerticalOffset(): Double {
      val fnPtr = _1424837967_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1424837967_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IToolTipTemplateSettings_Impl(
    ...
    public override val __1424837967_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IToolTipTemplateSettings, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("4f725950ff645cf19e869011fb10e88e")
    ...
    public override fun toNative(obj: IToolTipTemplateSettings): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1424837967_Ptr))
  }
