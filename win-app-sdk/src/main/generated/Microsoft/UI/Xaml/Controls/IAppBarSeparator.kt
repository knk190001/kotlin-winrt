...
@Signature("{57bb94a3-1e56-5ebe-8a57-3a243c491d67}")
@Guid("57bb94a31e565ebe8a573a243c491d67")
@WinRTInterface("57bb94a31e565ebe8a573a243c491d67")
...
public interface IAppBarSeparator : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IAppBarSeparator {
    public val __45474772_Ptr: Pointer?

    public val _45474772_VtblPtr: Pointer?
      get() = __45474772_Ptr?.getPointer(0)
  }

  public class IAppBarSeparator_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __45474772_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IAppBarSeparator, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("57bb94a31e565ebe8a573a243c491d67")
    ...
    public override fun toNative(obj: IAppBarSeparator): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__45474772_Ptr))
  }
