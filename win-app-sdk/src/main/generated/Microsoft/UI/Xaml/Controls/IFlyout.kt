...
@Signature("{d4a1eb7d-59b8-5df9-87c3-bd5e3856923f}")
@Guid("d4a1eb7d59b85df987c3bd5e3856923f")
@WinRTInterface("d4a1eb7d59b85df987c3bd5e3856923f")
...
public interface IFlyout : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IFlyout {
    public val __1990919810_Ptr: Pointer?

    public val _1990919810_VtblPtr: Pointer?
      get() = __1990919810_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Content(): UIElement? {
      val fnPtr = _1990919810_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<UIElement>()
      val hr = fn.invokeHR(arrayOf(__1990919810_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Content(value: UIElement?): Unit {
      val fnPtr = _1990919810_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1990919810_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_FlyoutPresenterStyle(): Style? {
      val fnPtr = _1990919810_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_FlyoutPresenterStyle(value: Style?): Unit {
      val fnPtr = _1990919810_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1990919810_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IFlyout_Impl(
    ...
    public override val __1990919810_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IFlyout, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("d4a1eb7d59b85df987c3bd5e3856923f")
    ...
    public override fun toNative(obj: IFlyout): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1990919810_Ptr))
  }
