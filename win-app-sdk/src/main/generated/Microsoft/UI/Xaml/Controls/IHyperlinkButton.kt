...
@Signature("{6dbee605-8df0-50cc-9a42-250eb138f0c6}")
@Guid("6dbee6058df050cc9a42250eb138f0c6")
@WinRTInterface("6dbee6058df050cc9a42250eb138f0c6")
...
public interface IHyperlinkButton : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IHyperlinkButton {
    public val __1049587055_Ptr: Pointer?

    public val _1049587055_VtblPtr: Pointer?
      get() = __1049587055_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_NavigateUri(): Uri? {
      val fnPtr = _1049587055_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Uri>()
      val hr = fn.invokeHR(arrayOf(__1049587055_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_NavigateUri(value: Uri?): Unit {
      val fnPtr = _1049587055_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1049587055_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IHyperlinkButton_Impl(
    ...
    public override val __1049587055_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IHyperlinkButton, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("6dbee6058df050cc9a42250eb138f0c6")
    ...
    public override fun toNative(obj: IHyperlinkButton): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1049587055_Ptr))
  }
