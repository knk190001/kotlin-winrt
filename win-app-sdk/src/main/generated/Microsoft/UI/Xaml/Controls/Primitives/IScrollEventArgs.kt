...
@Signature("{dbd27f11-f937-5ad0-9f75-b962c33254cf}")
@Guid("dbd27f11f9375ad09f75b962c33254cf")
@WinRTInterface("dbd27f11f9375ad09f75b962c33254cf")
...
public interface IScrollEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IScrollEventArgs {
    public val __911306201_Ptr: Pointer?

    public val _911306201_VtblPtr: Pointer?
      get() = __911306201_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_NewValue(): Double {
      val fnPtr = _911306201_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__911306201_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ScrollEventType(): ScrollEventType? {
      val fnPtr = _911306201_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class IScrollEventArgs_Impl(
    ...
    public override val __911306201_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IScrollEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("dbd27f11f9375ad09f75b962c33254cf")
    ...
    public override fun toNative(obj: IScrollEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__911306201_Ptr))
  }
