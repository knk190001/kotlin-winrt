...
@ABIMarker(AnimatedAcceptVisualSource.ABI::class)
@Signature("rc(Microsoft.UI.Xaml.Controls.AnimatedVisuals.AnimatedAcceptVisualSource;{294765c3-70e3-555c-9657-01fc4051169d})")
@WinRTByReference(brClass = AnimatedAcceptVisualSource.ByReference::class)
public class AnimatedAcceptVisualSource(
  ptr: JNAPointer? = NULL
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<AnimatedAcceptVisualSource> {
    public override fun getValue() = AnimatedAcceptVisualSource(pointer.getPointer(0))

    public fun setValue(value: AnimatedAcceptVisualSource): Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  public object ABI : IABI<AnimatedAcceptVisualSource, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.AnimatedVisuals.AnimatedAcceptVisualSource".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public override fun fromNative(segment: MemoryAddress): AnimatedAcceptVisualSource {
      val address = segment.toRawLongValue()
      return AnimatedAcceptVisualSource(Pointer(address))
    }

    public override fun toNative(obj: AnimatedAcceptVisualSource): MemoryAddress =
