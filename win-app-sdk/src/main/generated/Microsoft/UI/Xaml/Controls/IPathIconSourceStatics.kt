...
@Signature("{95df636b-0dc3-5c94-ba43-8980fd030840}")
@Guid("95df636b0dc35c94ba438980fd030840")
@WinRTInterface("95df636b0dc35c94ba438980fd030840")
...
public interface IPathIconSourceStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPathIconSourceStatics {
    public val __178985509_Ptr: Pointer?

    public val _178985509_VtblPtr: Pointer?
      get() = __178985509_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_DataProperty(): DependencyProperty? {
      val fnPtr = _178985509_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__178985509_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IPathIconSourceStatics_Impl(
    ...
    public override val __178985509_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPathIconSourceStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("95df636b0dc35c94ba438980fd030840")
    ...
    public override fun toNative(obj: IPathIconSourceStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__178985509_Ptr))
  }
