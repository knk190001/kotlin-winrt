...
@Signature("{9c6220be-f9eb-518a-b30e-7e41de5efda9}")
@Guid("9c6220bef9eb518ab30e7e41de5efda9")
@WinRTInterface("9c6220bef9eb518ab30e7e41de5efda9")
...
public interface ITreeViewFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITreeViewFactory {
    public val __1235397504_Ptr: Pointer?

    public val _1235397504_VtblPtr: Pointer?
      get() = __1235397504_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        TreeView? {
      val fnPtr = _1235397504_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<TreeView>()
      val hr = fn.invokeHR(arrayOf(__1235397504_Ptr, marshalToNative(baseInterface),
  ...
  public class ITreeViewFactory_Impl(
    ...
    public override val __1235397504_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITreeViewFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("9c6220bef9eb518ab30e7e41de5efda9")
    ...
    public override fun toNative(obj: ITreeViewFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1235397504_Ptr))
  }
