...
@Signature("rc(Microsoft.UI.Xaml.Controls.ListPickerFlyout;{b0154a37-07c1-50ed-834c-32d3fbda5c5f})")
...
public class ListPickerFlyout(
  ...
  private val __454089810_Interface: IListPickerFlyout.WithDefault by lazy {
    as_454089810()
  }


  public override val __454089810_Ptr: JNAPointer? by lazy {
    __454089810_Interface.__454089810_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__454089810_Interface)

  public constructor() : this(ABI.activate())

  private fun as_454089810(): IListPickerFlyout.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<ListPickerFlyout, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.ListPickerFlyout".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIListPickerFlyoutStatics(): IListPickerFlyoutStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.ListPickerFlyout".toHandle(),refiid,interfacePtr)
