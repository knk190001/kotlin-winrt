...
@Signature("{63ce16f2-fb52-5818-836f-c097aa9c072d}")
@Guid("63ce16f2fb525818836fc097aa9c072d")
@WinRTInterface("63ce16f2fb525818836fc097aa9c072d")
...
public interface IHubSectionFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IHubSectionFactory {
    public val __1750882259_Ptr: Pointer?

    public val _1750882259_VtblPtr: Pointer?
      get() = __1750882259_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        HubSection? {
      val fnPtr = _1750882259_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<HubSection>()
      val hr = fn.invokeHR(arrayOf(__1750882259_Ptr, marshalToNative(baseInterface),
  ...
  public class IHubSectionFactory_Impl(
    ...
    public override val __1750882259_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IHubSectionFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("63ce16f2fb525818836fc097aa9c072d")
    ...
    public override fun toNative(obj: IHubSectionFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1750882259_Ptr))
  }
