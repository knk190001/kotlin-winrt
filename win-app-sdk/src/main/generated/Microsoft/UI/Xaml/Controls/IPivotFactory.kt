...
@Signature("{da9d033c-4782-5a69-90af-076ccdf071ae}")
@Guid("da9d033c47825a6990af076ccdf071ae")
@WinRTInterface("da9d033c47825a6990af076ccdf071ae")
...
public interface IPivotFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPivotFactory {
    public val __1074686383_Ptr: Pointer?

    public val _1074686383_VtblPtr: Pointer?
      get() = __1074686383_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        Pivot? {
      val fnPtr = _1074686383_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Pivot>()
      val hr = fn.invokeHR(arrayOf(__1074686383_Ptr, marshalToNative(baseInterface),
  ...
  public class IPivotFactory_Impl(
    ...
    public override val __1074686383_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPivotFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("da9d033c47825a6990af076ccdf071ae")
    ...
    public override fun toNative(obj: IPivotFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1074686383_Ptr))
  }
