...
@Signature("{f7e52fdf-4779-5f63-9999-7d677e3fd2c1}")
@Guid("f7e52fdf47795f6399997d677e3fd2c1")
@WinRTInterface("f7e52fdf47795f6399997d677e3fd2c1")
...
public interface IItemsStackPanel : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IItemsStackPanel {
    public val __516934549_Ptr: Pointer?

    public val _516934549_VtblPtr: Pointer?
      get() = __516934549_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_GroupPadding(): Thickness? {
      val fnPtr = _516934549_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Thickness>()
      val hr = fn.invokeHR(arrayOf(__516934549_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_GroupPadding(value: Thickness?): Unit {
      val fnPtr = _516934549_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__516934549_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Orientation(): Orientation? {
      val fnPtr = _516934549_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Orientation(value: Orientation?): Unit {
      val fnPtr = _516934549_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__516934549_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_FirstCacheIndex(): Int {
      val fnPtr = _516934549_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_FirstVisibleIndex(): Int {
      val fnPtr = _516934549_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__516934549_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_LastVisibleIndex(): Int {
      val fnPtr = _516934549_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__516934549_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_LastCacheIndex(): Int {
      val fnPtr = _516934549_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__516934549_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ScrollingDirection(): PanelScrollingDirection? {
      val fnPtr = _516934549_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_GroupHeaderPlacement(): GroupHeaderPlacement? {
      val fnPtr = _516934549_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_GroupHeaderPlacement(value: GroupHeaderPlacement?): Unit {
      val fnPtr = _516934549_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__516934549_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ItemsUpdatingScrollMode(): ItemsUpdatingScrollMode? {
      val fnPtr = _516934549_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_ItemsUpdatingScrollMode(value: ItemsUpdatingScrollMode?): Unit {
      val fnPtr = _516934549_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__516934549_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_CacheLength(): Double {
      val fnPtr = _516934549_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_CacheLength(value: Double): Unit {
      val fnPtr = _516934549_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__516934549_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_AreStickyGroupHeadersEnabled(): Boolean {
      val fnPtr = _516934549_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_AreStickyGroupHeadersEnabled(value: Boolean): Unit {
      val fnPtr = _516934549_VtblPtr!!.getPointer(22L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__516934549_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IItemsStackPanel_Impl(
    ...
    public override val __516934549_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IItemsStackPanel, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("f7e52fdf47795f6399997d677e3fd2c1")
    ...
    public override fun toNative(obj: IItemsStackPanel): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__516934549_Ptr))
  }
