...
@Signature("{c475bb52-ea34-5cde-9851-7841febd3d1d}")
@Guid("c475bb52ea345cde98517841febd3d1d")
@WinRTInterface("c475bb52ea345cde98517841febd3d1d")
...
public interface IJumpListItemBackgroundConverter : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IJumpListItemBackgroundConverter {
    public val __701579262_Ptr: Pointer?

    public val _701579262_VtblPtr: Pointer?
      get() = __701579262_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Enabled(): Brush? {
      val fnPtr = _701579262_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Brush>()
      val hr = fn.invokeHR(arrayOf(__701579262_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Enabled(value: Brush?): Unit {
      val fnPtr = _701579262_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__701579262_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Disabled(): Brush? {
      val fnPtr = _701579262_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Brush>()
      val hr = fn.invokeHR(arrayOf(__701579262_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Disabled(value: Brush?): Unit {
      val fnPtr = _701579262_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__701579262_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IJumpListItemBackgroundConverter_Impl(
    ...
    public override val __701579262_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IJumpListItemBackgroundConverter, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("c475bb52ea345cde98517841febd3d1d")
    ...
    public override fun toNative(obj: IJumpListItemBackgroundConverter): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__701579262_Ptr))
  }
