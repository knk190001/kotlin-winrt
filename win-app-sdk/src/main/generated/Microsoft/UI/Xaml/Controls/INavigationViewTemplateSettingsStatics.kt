...
@Signature("{be3a88d6-d19b-5543-8b72-d42b459e72ed}")
@Guid("be3a88d6d19b55438b72d42b459e72ed")
@WinRTInterface("be3a88d6d19b55438b72d42b459e72ed")
...
public interface INavigationViewTemplateSettingsStatics : NativeMapped, IWinRTInterface {
  ...
  @InterfaceMethod(7)
  public fun get_PaneToggleButtonWidthProperty(): DependencyProperty?

  @InterfaceMethod(8)
  public fun get_SmallerPaneToggleButtonWidthProperty(): DependencyProperty?
  ...
  public interface WithDefault : INavigationViewTemplateSettingsStatics {
    public val __873553352_Ptr: Pointer?

    public val _873553352_VtblPtr: Pointer?
      get() = __873553352_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_TopPaddingProperty(): DependencyProperty? {
      val fnPtr = _873553352_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__873553352_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_OverflowButtonVisibilityProperty(): DependencyProperty? {
      val fnPtr = _873553352_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__873553352_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_PaneToggleButtonVisibilityProperty(): DependencyProperty? {
      val fnPtr = _873553352_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__873553352_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_BackButtonVisibilityProperty(): DependencyProperty? {
      val fnPtr = _873553352_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__873553352_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_TopPaneVisibilityProperty(): DependencyProperty? {
      val fnPtr = _873553352_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__873553352_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_LeftPaneVisibilityProperty(): DependencyProperty? {
      val fnPtr = _873553352_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__873553352_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_SingleSelectionFollowsFocusProperty(): DependencyProperty? {
      val fnPtr = _873553352_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__873553352_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    @InterfaceMethod(7)
    public override fun get_PaneToggleButtonWidthProperty(): DependencyProperty? {
      val fnPtr = _873553352_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__873553352_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    @InterfaceMethod(8)
    public override fun get_SmallerPaneToggleButtonWidthProperty(): DependencyProperty? {
      val fnPtr = _873553352_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__873553352_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class INavigationViewTemplateSettingsStatics_Impl(
    ...
    public override val __873553352_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<INavigationViewTemplateSettingsStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("be3a88d6d19b55438b72d42b459e72ed")
    ...
    public override fun toNative(obj: INavigationViewTemplateSettingsStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__873553352_Ptr))
  }
