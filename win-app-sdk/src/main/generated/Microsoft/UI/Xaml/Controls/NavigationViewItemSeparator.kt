...
import Microsoft.UI.Xaml.Controls.INavigationViewItemSeparatorFactory.ABI.IID
...
@Signature("rc(Microsoft.UI.Xaml.Controls.NavigationViewItemSeparator;{e3c35630-1d5f-5689-a0cb-8794485caacf})")
...
public open class NavigationViewItemSeparator(
  ...
  private val __626418834_Interface: INavigationViewItemSeparator.WithDefault by lazy {
    as_626418834()
  }


  public override val __626418834_Ptr: JNAPointer? by lazy {
    __626418834_Interface.__626418834_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__626418834_Interface)

  public constructor() : this(ABI.activate())

  private fun as_626418834(): INavigationViewItemSeparator.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<NavigationViewItemSeparator, MemoryAddress> {
    ...
    public fun createINavigationViewItemSeparatorFactory(): INavigationViewItemSeparatorFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.NavigationViewItemSeparator".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
