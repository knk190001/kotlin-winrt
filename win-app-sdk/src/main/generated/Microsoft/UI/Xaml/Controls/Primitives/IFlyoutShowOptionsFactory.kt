...
@Signature("{17426d30-70d9-54d7-bd39-e7c4c940c0f4}")
@Guid("17426d3070d954d7bd39e7c4c940c0f4")
@WinRTInterface("17426d3070d954d7bd39e7c4c940c0f4")
...
public interface IFlyoutShowOptionsFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IFlyoutShowOptionsFactory {
    public val __425928597_Ptr: Pointer?

    public val _425928597_VtblPtr: Pointer?
      get() = __425928597_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        FlyoutShowOptions? {
      val fnPtr = _425928597_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<FlyoutShowOptions>()
      val hr = fn.invokeHR(arrayOf(__425928597_Ptr, marshalToNative(baseInterface),
  ...
  public class IFlyoutShowOptionsFactory_Impl(
    ...
    public override val __425928597_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IFlyoutShowOptionsFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("17426d3070d954d7bd39e7c4c940c0f4")
    ...
    public override fun toNative(obj: IFlyoutShowOptionsFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__425928597_Ptr))
  }
