...
@Signature("{b16bf561-fc6c-57c6-8ebc-0b06ce4513aa}")
@Guid("b16bf561fc6c57c68ebc0b06ce4513aa")
@WinRTInterface("b16bf561fc6c57c68ebc0b06ce4513aa")
...
public interface IGridFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IGridFactory {
    public val __641678659_Ptr: Pointer?

    public val _641678659_VtblPtr: Pointer?
      get() = __641678659_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?): Grid? {
      val fnPtr = _641678659_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Grid>()
      val hr = fn.invokeHR(arrayOf(__641678659_Ptr, marshalToNative(baseInterface),
  ...
  public class IGridFactory_Impl(
    ...
    public override val __641678659_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IGridFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("b16bf561fc6c57c68ebc0b06ce4513aa")
    ...
    public override fun toNative(obj: IGridFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__641678659_Ptr))
  }
