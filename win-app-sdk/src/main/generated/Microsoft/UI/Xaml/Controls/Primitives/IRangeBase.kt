...
@Signature("{540d6d61-8fac-5d5c-b5b0-e172a7dde103}")
@Guid("540d6d618fac5d5cb5b0e172a7dde103")
@WinRTInterface("540d6d618fac5d5cb5b0e172a7dde103")
...
public interface IRangeBase : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IRangeBase {
    public val __905472125_Ptr: Pointer?

    public val _905472125_VtblPtr: Pointer?
      get() = __905472125_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Minimum(): Double {
      val fnPtr = _905472125_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__905472125_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Minimum(value: Double): Unit {
      val fnPtr = _905472125_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__905472125_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Maximum(): Double {
      val fnPtr = _905472125_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__905472125_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Maximum(value: Double): Unit {
      val fnPtr = _905472125_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__905472125_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_SmallChange(): Double {
      val fnPtr = _905472125_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__905472125_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_SmallChange(value: Double): Unit {
      val fnPtr = _905472125_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__905472125_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_LargeChange(): Double {
      val fnPtr = _905472125_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__905472125_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_LargeChange(value: Double): Unit {
      val fnPtr = _905472125_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__905472125_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Value(): Double {
      val fnPtr = _905472125_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__905472125_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Value(value: Double): Unit {
      val fnPtr = _905472125_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__905472125_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun add_ValueChanged(handler: RangeBaseValueChangedEventHandler?):
      ...
      val fnPtr = _905472125_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__905472125_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun remove_ValueChanged(token: EventRegistrationToken?): Unit {
      val fnPtr = _905472125_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__905472125_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IRangeBase_Impl(
    ...
    public override val __905472125_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IRangeBase, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("540d6d618fac5d5cb5b0e172a7dde103")
    ...
    public override fun toNative(obj: IRangeBase): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__905472125_Ptr))
  }
