...
@Signature("{8fee3e46-6e2f-5c0a-9a3b-c0b659818801}")
@Guid("8fee3e466e2f5c0a9a3bc0b659818801")
@WinRTInterface("8fee3e466e2f5c0a9a3bc0b659818801")
...
public interface IVirtualizingStackPanelOverrides : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IVirtualizingStackPanelOverrides {
    public val __1337480126_Ptr: Pointer?

    public val _1337480126_VtblPtr: Pointer?
      get() = __1337480126_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun OnCleanUpVirtualizedItem(e: CleanUpVirtualizedItemEventArgs?): Unit {
      val fnPtr = _1337480126_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1337480126_Ptr, marshalToNative(e),))
      if (hr.toInt() != 0) {
  ...
  public class IVirtualizingStackPanelOverrides_Impl(
    ...
    public override val __1337480126_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IVirtualizingStackPanelOverrides, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("8fee3e466e2f5c0a9a3bc0b659818801")
    ...
    public override fun toNative(obj: IVirtualizingStackPanelOverrides): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1337480126_Ptr))
  }
