...
@Signature("{573293bd-3f6a-56c3-bf95-6254c9bbbc89}")
@Guid("573293bd3f6a56c3bf956254c9bbbc89")
@WinRTInterface("573293bd3f6a56c3bf956254c9bbbc89")
...
public interface ITickBar : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITickBar {
    public val __186092603_Ptr: Pointer?

    public val _186092603_VtblPtr: Pointer?
      get() = __186092603_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Fill(): Brush? {
      val fnPtr = _186092603_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Brush>()
      val hr = fn.invokeHR(arrayOf(__186092603_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Fill(value: Brush?): Unit {
      val fnPtr = _186092603_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__186092603_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class ITickBar_Impl(
    ...
    public override val __186092603_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITickBar, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("573293bd3f6a56c3bf956254c9bbbc89")
    ...
    public override fun toNative(obj: ITickBar): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__186092603_Ptr))
  }
