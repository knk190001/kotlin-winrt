...
@ABIMarker(AnimatedChevronUpDownSmallVisualSource.ABI::class)
@Signature("rc(Microsoft.UI.Xaml.Controls.AnimatedVisuals.AnimatedChevronUpDownSmallVisualSource;{294765c3-70e3-555c-9657-01fc4051169d})")
@WinRTByReference(brClass = AnimatedChevronUpDownSmallVisualSource.ByReference::class)
public class AnimatedChevronUpDownSmallVisualSource(
  ptr: JNAPointer? = NULL
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<AnimatedChevronUpDownSmallVisualSource> {
    public override fun getValue() = AnimatedChevronUpDownSmallVisualSource(pointer.getPointer(0))

    public fun setValue(value: AnimatedChevronUpDownSmallVisualSource): Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  public object ABI : IABI<AnimatedChevronUpDownSmallVisualSource, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.AnimatedVisuals.AnimatedChevronUpDownSmallVisualSource".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public override fun fromNative(segment: MemoryAddress): AnimatedChevronUpDownSmallVisualSource {
      val address = segment.toRawLongValue()
      return AnimatedChevronUpDownSmallVisualSource(Pointer(address))
    }

    public override fun toNative(obj: AnimatedChevronUpDownSmallVisualSource): MemoryAddress =
