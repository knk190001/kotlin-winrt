...
@Signature("{dac61d65-e8f9-5e4d-813d-05c980b2f118}")
@Guid("dac61d65e8f95e4d813d05c980b2f118")
@WinRTInterface("dac61d65e8f95e4d813d05c980b2f118")
...
public interface IRatingControlStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IRatingControlStatics {
    public val __1777855212_Ptr: Pointer?

    public val _1777855212_VtblPtr: Pointer?
      get() = __1777855212_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_CaptionProperty(): DependencyProperty? {
      val fnPtr = _1777855212_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1777855212_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_InitialSetValueProperty(): DependencyProperty? {
      val fnPtr = _1777855212_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1777855212_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsClearEnabledProperty(): DependencyProperty? {
      val fnPtr = _1777855212_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1777855212_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsReadOnlyProperty(): DependencyProperty? {
      val fnPtr = _1777855212_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1777855212_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_MaxRatingProperty(): DependencyProperty? {
      val fnPtr = _1777855212_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1777855212_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_PlaceholderValueProperty(): DependencyProperty? {
      val fnPtr = _1777855212_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1777855212_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ItemInfoProperty(): DependencyProperty? {
      val fnPtr = _1777855212_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1777855212_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ValueProperty(): DependencyProperty? {
      val fnPtr = _1777855212_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1777855212_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IRatingControlStatics_Impl(
    ...
    public override val __1777855212_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IRatingControlStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("dac61d65e8f95e4d813d05c980b2f118")
    ...
    public override fun toNative(obj: IRatingControlStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1777855212_Ptr))
  }
