...
@Signature("rc(Microsoft.UI.Xaml.Controls.Primitives.Popup;{4e3ab19d-2f95-579c-9535-906c58629437})")
...
public class Popup(
  ptr: JNAPointer? = NULL
    ...
    IWinRTObject {
  private val __823118587_Interface: IPopup.WithDefault by lazy {
    as_823118587()
  }


  private val __253127529_Interface: IPopup2.WithDefault by lazy {
    as_253127529()
  }


  private val __253127528_Interface: IPopup3.WithDefault by lazy {
    as_253127528()
  }


  public override val __823118587_Ptr: JNAPointer? by lazy {
    __823118587_Interface.__823118587_Ptr
  }


  public override val __253127529_Ptr: JNAPointer? by lazy {
    __253127529_Interface.__253127529_Ptr
  }


  public override val __253127528_Ptr: JNAPointer? by lazy {
    __253127528_Interface.__253127528_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__823118587_Interface, __253127529_Interface, __253127528_Interface)

  public constructor() : this(ABI.activate())

  private fun as_823118587(): IPopup.WithDefault {
    if(pointer == NULL) {
  ...
  private fun as_253127529(): IPopup2.WithDefault {
    if(pointer == NULL) {
  ...
  private fun as_253127528(): IPopup3.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<Popup, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.Primitives.Popup".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIPopupStatics2(): IPopupStatics2 {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.Primitives.Popup".toHandle(),refiid,interfacePtr)
  ...
  public companion object {
    public fun get_PlacementTargetProperty() =
        ABI.IPopupStatics2_Instance.get_PlacementTargetProperty()

    public fun get_DesiredPlacementProperty() =
        ABI.IPopupStatics2_Instance.get_DesiredPlacementProperty()
    ...
    public fun get_LightDismissOverlayModeProperty() =
        ABI.IPopupStatics_Instance.get_LightDismissOverlayModeProperty()

    public fun get_ShouldConstrainToRootBoundsProperty() =
        ABI.IPopupStatics_Instance.get_ShouldConstrainToRootBoundsProperty()

    public fun get_SystemBackdropProperty() =
        ABI.IPopupStatics3_Instance.get_SystemBackdropProperty()
  }
}
