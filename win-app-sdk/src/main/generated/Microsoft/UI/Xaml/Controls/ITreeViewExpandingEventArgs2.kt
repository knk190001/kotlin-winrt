...
@Signature("{ed7840e5-dbf5-5937-89dd-997a6fde0d5c}")
@Guid("ed7840e5dbf5593789dd997a6fde0d5c")
@WinRTInterface("ed7840e5dbf5593789dd997a6fde0d5c")
...
public interface ITreeViewExpandingEventArgs2 : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITreeViewExpandingEventArgs2 {
    public val __767401753_Ptr: Pointer?

    public val _767401753_VtblPtr: Pointer?
      get() = __767401753_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Item(): IUnknown? {
      val fnPtr = _767401753_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IUnknown>()
      val hr = fn.invokeHR(arrayOf(__767401753_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ITreeViewExpandingEventArgs2_Impl(
    ...
    public override val __767401753_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITreeViewExpandingEventArgs2, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("ed7840e5dbf5593789dd997a6fde0d5c")
    ...
    public override fun toNative(obj: ITreeViewExpandingEventArgs2): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__767401753_Ptr))
  }
