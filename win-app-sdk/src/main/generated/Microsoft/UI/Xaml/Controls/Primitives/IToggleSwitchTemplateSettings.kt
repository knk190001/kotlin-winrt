...
@Signature("{8f9640a3-aa4e-52da-a2c6-9167c800baba}")
@Guid("8f9640a3aa4e52daa2c69167c800baba")
@WinRTInterface("8f9640a3aa4e52daa2c69167c800baba")
...
public interface IToggleSwitchTemplateSettings : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IToggleSwitchTemplateSettings {
    public val __809512106_Ptr: Pointer?

    public val _809512106_VtblPtr: Pointer?
      get() = __809512106_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_KnobCurrentToOnOffset(): Double {
      val fnPtr = _809512106_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__809512106_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_KnobCurrentToOffOffset(): Double {
      val fnPtr = _809512106_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__809512106_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_KnobOnToOffOffset(): Double {
      val fnPtr = _809512106_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__809512106_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_KnobOffToOnOffset(): Double {
      val fnPtr = _809512106_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__809512106_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_CurtainCurrentToOnOffset(): Double {
      val fnPtr = _809512106_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__809512106_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_CurtainCurrentToOffOffset(): Double {
      val fnPtr = _809512106_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__809512106_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_CurtainOnToOffOffset(): Double {
      val fnPtr = _809512106_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__809512106_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_CurtainOffToOnOffset(): Double {
      val fnPtr = _809512106_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__809512106_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IToggleSwitchTemplateSettings_Impl(
    ...
    public override val __809512106_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IToggleSwitchTemplateSettings, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("8f9640a3aa4e52daa2c69167c800baba")
    ...
    public override fun toNative(obj: IToggleSwitchTemplateSettings): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__809512106_Ptr))
  }
