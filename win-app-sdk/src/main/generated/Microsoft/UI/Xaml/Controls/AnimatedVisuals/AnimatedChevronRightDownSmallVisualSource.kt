...
@ABIMarker(AnimatedChevronRightDownSmallVisualSource.ABI::class)
@Signature("rc(Microsoft.UI.Xaml.Controls.AnimatedVisuals.AnimatedChevronRightDownSmallVisualSource;{294765c3-70e3-555c-9657-01fc4051169d})")
@WinRTByReference(brClass = AnimatedChevronRightDownSmallVisualSource.ByReference::class)
public class AnimatedChevronRightDownSmallVisualSource(
  ptr: JNAPointer? = NULL
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<AnimatedChevronRightDownSmallVisualSource> {
    public override fun getValue() =
        AnimatedChevronRightDownSmallVisualSource(pointer.getPointer(0))

    public fun setValue(value: AnimatedChevronRightDownSmallVisualSource): Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  public object ABI : IABI<AnimatedChevronRightDownSmallVisualSource, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.AnimatedVisuals.AnimatedChevronRightDownSmallVisualSource".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public override fun fromNative(segment: MemoryAddress):
      ...
      return AnimatedChevronRightDownSmallVisualSource(Pointer(address))
    }

    public override fun toNative(obj: AnimatedChevronRightDownSmallVisualSource): MemoryAddress =
