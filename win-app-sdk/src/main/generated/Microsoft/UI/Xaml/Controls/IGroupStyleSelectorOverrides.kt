...
@Signature("{80594304-ebeb-5a5d-a794-acdc214cbc94}")
@Guid("80594304ebeb5a5da794acdc214cbc94")
@WinRTInterface("80594304ebeb5a5da794acdc214cbc94")
...
public interface IGroupStyleSelectorOverrides : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IGroupStyleSelectorOverrides {
    public val __1517517169_Ptr: Pointer?

    public val _1517517169_VtblPtr: Pointer?
      get() = __1517517169_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun SelectGroupStyleCore(group: IUnknown?, level: WinDef.UINT): GroupStyle? {
      val fnPtr = _1517517169_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<GroupStyle>()
      val hr = fn.invokeHR(arrayOf(__1517517169_Ptr, marshalToNative(group), level, result))
      if (hr.toInt() != 0) {
  ...
  public class IGroupStyleSelectorOverrides_Impl(
    ...
    public override val __1517517169_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IGroupStyleSelectorOverrides, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("80594304ebeb5a5da794acdc214cbc94")
    ...
    public override fun toNative(obj: IGroupStyleSelectorOverrides): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1517517169_Ptr))
  }
