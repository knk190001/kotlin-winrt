...
@Signature("{d495f2fa-594d-5170-b1e8-8629a179f9fb}")
@Guid("d495f2fa594d5170b1e88629a179f9fb")
@WinRTInterface("d495f2fa594d5170b1e88629a179f9fb")
...
public interface IGridView : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IGridView {
    public val __22232530_Ptr: Pointer?

    public val _22232530_VtblPtr: Pointer?
      get() = __22232530_Ptr?.getPointer(0)
  }

  public class IGridView_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __22232530_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IGridView, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("d495f2fa594d5170b1e88629a179f9fb")
    ...
    public override fun toNative(obj: IGridView): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__22232530_Ptr))
  }
