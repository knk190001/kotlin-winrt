...
@Signature("{a05b3ad7-c60e-545a-9ee4-f098220ed816}")
@Guid("a05b3ad7c60e545a9ee4f098220ed816")
@WinRTInterface("a05b3ad7c60e545a9ee4f098220ed816")
...
public interface IContentDialogFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IContentDialogFactory {
    public val __529615120_Ptr: Pointer?

    public val _529615120_VtblPtr: Pointer?
      get() = __529615120_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        ContentDialog? {
      val fnPtr = _529615120_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ContentDialog>()
      val hr = fn.invokeHR(arrayOf(__529615120_Ptr, marshalToNative(baseInterface),
  ...
  public class IContentDialogFactory_Impl(
    ...
    public override val __529615120_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IContentDialogFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("a05b3ad7c60e545a9ee4f098220ed816")
    ...
    public override fun toNative(obj: IContentDialogFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__529615120_Ptr))
  }
