...
@Signature("{afbf55fa-ff79-552a-a3a1-48e2ef17152a}")
@Guid("afbf55faff79552aa3a148e2ef17152a")
@WinRTInterface("afbf55faff79552aa3a148e2ef17152a")
...
public interface ISymbolIconSourceFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISymbolIconSourceFactory {
    public val __233516055_Ptr: Pointer?

    public val _233516055_VtblPtr: Pointer?
      get() = __233516055_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        SymbolIconSource? {
      val fnPtr = _233516055_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<SymbolIconSource>()
      val hr = fn.invokeHR(arrayOf(__233516055_Ptr, marshalToNative(baseInterface),
  ...
  public class ISymbolIconSourceFactory_Impl(
    ...
    public override val __233516055_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISymbolIconSourceFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("afbf55faff79552aa3a148e2ef17152a")
    ...
    public override fun toNative(obj: ISymbolIconSourceFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__233516055_Ptr))
  }
