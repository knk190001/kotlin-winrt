...
@Signature("{ae9535f6-1678-5066-90bf-147aa610c5dd}")
@Guid("ae9535f61678506690bf147aa610c5dd")
@WinRTInterface("ae9535f61678506690bf147aa610c5dd")
...
public interface ICommandBarTemplateSettings : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICommandBarTemplateSettings {
    public val __175562934_Ptr: Pointer?

    public val _175562934_VtblPtr: Pointer?
      get() = __175562934_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ContentHeight(): Double {
      val fnPtr = _175562934_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__175562934_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_OverflowContentClipRect(): Rect? {
      val fnPtr = _175562934_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_OverflowContentMinWidth(): Double {
      val fnPtr = _175562934_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__175562934_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_OverflowContentMaxWidth(): Double {
      val fnPtr = _175562934_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__175562934_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_OverflowContentMaxHeight(): Double {
      val fnPtr = _175562934_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__175562934_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_OverflowContentHorizontalOffset(): Double {
      val fnPtr = _175562934_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__175562934_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_OverflowContentHeight(): Double {
      val fnPtr = _175562934_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__175562934_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_NegativeOverflowContentHeight(): Double {
      val fnPtr = _175562934_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__175562934_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_EffectiveOverflowButtonVisibility(): Visibility? {
      val fnPtr = _175562934_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_OverflowContentCompactYTranslation(): Double {
      val fnPtr = _175562934_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__175562934_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_OverflowContentMinimalYTranslation(): Double {
      val fnPtr = _175562934_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__175562934_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_OverflowContentHiddenYTranslation(): Double {
      val fnPtr = _175562934_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__175562934_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ICommandBarTemplateSettings_Impl(
    ...
    public override val __175562934_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICommandBarTemplateSettings, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("ae9535f61678506690bf147aa610c5dd")
    ...
    public override fun toNative(obj: ICommandBarTemplateSettings): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__175562934_Ptr))
  }
