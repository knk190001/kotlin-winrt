...
@Signature("{25459d02-0ffc-5c7c-af56-f55aad6db5e7}")
@Guid("25459d020ffc5c7caf56f55aad6db5e7")
@WinRTInterface("25459d020ffc5c7caf56f55aad6db5e7")
...
public interface IToggleSplitButtonFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IToggleSplitButtonFactory {
    public val __408852551_Ptr: Pointer?

    public val _408852551_VtblPtr: Pointer?
      get() = __408852551_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        ToggleSplitButton? {
      val fnPtr = _408852551_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ToggleSplitButton>()
      val hr = fn.invokeHR(arrayOf(__408852551_Ptr, marshalToNative(baseInterface),
  ...
  public class IToggleSplitButtonFactory_Impl(
    ...
    public override val __408852551_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IToggleSplitButtonFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("25459d020ffc5c7caf56f55aad6db5e7")
    ...
    public override fun toNative(obj: IToggleSplitButtonFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__408852551_Ptr))
  }
