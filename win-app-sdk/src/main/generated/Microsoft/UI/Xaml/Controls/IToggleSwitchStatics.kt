...
@Signature("{c9c203d6-0619-504d-9ed8-5054fe3ca51e}")
@Guid("c9c203d60619504d9ed85054fe3ca51e")
@WinRTInterface("c9c203d60619504d9ed85054fe3ca51e")
...
public interface IToggleSwitchStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IToggleSwitchStatics {
    public val __1939427798_Ptr: Pointer?

    public val _1939427798_VtblPtr: Pointer?
      get() = __1939427798_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_IsOnProperty(): DependencyProperty? {
      val fnPtr = _1939427798_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1939427798_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_HeaderProperty(): DependencyProperty? {
      val fnPtr = _1939427798_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1939427798_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_HeaderTemplateProperty(): DependencyProperty? {
      val fnPtr = _1939427798_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1939427798_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_OnContentProperty(): DependencyProperty? {
      val fnPtr = _1939427798_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1939427798_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_OnContentTemplateProperty(): DependencyProperty? {
      val fnPtr = _1939427798_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1939427798_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_OffContentProperty(): DependencyProperty? {
      val fnPtr = _1939427798_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1939427798_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_OffContentTemplateProperty(): DependencyProperty? {
      val fnPtr = _1939427798_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1939427798_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IToggleSwitchStatics_Impl(
    ...
    public override val __1939427798_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IToggleSwitchStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("c9c203d60619504d9ed85054fe3ca51e")
    ...
    public override fun toNative(obj: IToggleSwitchStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1939427798_Ptr))
  }
