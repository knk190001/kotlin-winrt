...
@Signature("{dd06f030-5d47-533c-95cf-de256a0f373a}")
@Guid("dd06f0305d47533c95cfde256a0f373a")
@WinRTInterface("dd06f0305d47533c95cfde256a0f373a")
...
public interface INavigate : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : INavigate {
    public val __1806605368_Ptr: Pointer?

    public val _1806605368_VtblPtr: Pointer?
      get() = __1806605368_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun Navigate(sourcePageType: TypeName?): Boolean {
      val fnPtr = _1806605368_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1806605368_Ptr, marshalToNative(sourcePageType), result))
      if (hr.toInt() != 0) {
  ...
  public class INavigate_Impl(
    ...
    public override val __1806605368_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<INavigate, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("dd06f0305d47533c95cfde256a0f373a")
    ...
    public override fun toNative(obj: INavigate): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1806605368_Ptr))
  }
