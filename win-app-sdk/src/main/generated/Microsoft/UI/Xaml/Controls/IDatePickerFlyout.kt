...
@Signature("{ba7ecf3c-edb1-593b-a4ac-c09802eace99}")
@Guid("ba7ecf3cedb1593ba4acc09802eace99")
@WinRTInterface("ba7ecf3cedb1593ba4acc09802eace99")
...
public interface IDatePickerFlyout : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IDatePickerFlyout {
    public val __239777090_Ptr: Pointer?

    public val _239777090_VtblPtr: Pointer?
      get() = __239777090_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_CalendarIdentifier(): String? {
      val fnPtr = _239777090_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__239777090_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_CalendarIdentifier(value: String?): Unit {
      val fnPtr = _239777090_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__239777090_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Date(): DateTime? {
      val fnPtr = _239777090_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Date(value: DateTime?): Unit {
      val fnPtr = _239777090_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__239777090_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_DayVisible(): Boolean {
      val fnPtr = _239777090_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_DayVisible(value: Boolean): Unit {
      val fnPtr = _239777090_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__239777090_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_MonthVisible(): Boolean {
      val fnPtr = _239777090_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__239777090_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_MonthVisible(value: Boolean): Unit {
      val fnPtr = _239777090_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__239777090_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_YearVisible(): Boolean {
      val fnPtr = _239777090_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__239777090_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_YearVisible(value: Boolean): Unit {
      val fnPtr = _239777090_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__239777090_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_MinYear(): DateTime? {
      val fnPtr = _239777090_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DateTime>()
      val hr = fn.invokeHR(arrayOf(__239777090_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_MinYear(value: DateTime?): Unit {
      val fnPtr = _239777090_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__239777090_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_MaxYear(): DateTime? {
      val fnPtr = _239777090_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DateTime>()
      val hr = fn.invokeHR(arrayOf(__239777090_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_MaxYear(value: DateTime?): Unit {
      val fnPtr = _239777090_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__239777090_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_DayFormat(): String? {
      val fnPtr = _239777090_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__239777090_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_DayFormat(value: String?): Unit {
      val fnPtr = _239777090_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__239777090_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_MonthFormat(): String? {
      val fnPtr = _239777090_VtblPtr!!.getPointer(22L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__239777090_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_MonthFormat(value: String?): Unit {
      val fnPtr = _239777090_VtblPtr!!.getPointer(23L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__239777090_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_YearFormat(): String? {
      val fnPtr = _239777090_VtblPtr!!.getPointer(24L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__239777090_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_YearFormat(value: String?): Unit {
      val fnPtr = _239777090_VtblPtr!!.getPointer(25L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__239777090_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun add_DatePicked(handler: TypedEventHandler<DatePickerFlyout?,
      ...
      val fnPtr = _239777090_VtblPtr!!.getPointer(26L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__239777090_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun remove_DatePicked(token: EventRegistrationToken?): Unit {
      val fnPtr = _239777090_VtblPtr!!.getPointer(27L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__239777090_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun ShowAtAsync(target: FrameworkElement?):
      ...
      val fnPtr = _239777090_VtblPtr!!.getPointer(28L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IAsyncOperation<IReference<DateTime?>?>>()
      val hr = fn.invokeHR(arrayOf(__239777090_Ptr, marshalToNative(target), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
      val resultValue =
  ...
  public class IDatePickerFlyout_Impl(
    ...
    public override val __239777090_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IDatePickerFlyout, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("ba7ecf3cedb1593ba4acc09802eace99")
    ...
    public override fun toNative(obj: IDatePickerFlyout): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__239777090_Ptr))
  }
