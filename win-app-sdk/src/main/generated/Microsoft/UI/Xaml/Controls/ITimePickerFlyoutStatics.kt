...
@Signature("{085a6a2d-68f4-5d4e-b89c-47cc0dd520a8}")
@Guid("085a6a2d68f45d4eb89c47cc0dd520a8")
@WinRTInterface("085a6a2d68f45d4eb89c47cc0dd520a8")
...
public interface ITimePickerFlyoutStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITimePickerFlyoutStatics {
    public val __1241517480_Ptr: Pointer?

    public val _1241517480_VtblPtr: Pointer?
      get() = __1241517480_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ClockIdentifierProperty(): DependencyProperty? {
      val fnPtr = _1241517480_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1241517480_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_TimeProperty(): DependencyProperty? {
      val fnPtr = _1241517480_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1241517480_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_MinuteIncrementProperty(): DependencyProperty? {
      val fnPtr = _1241517480_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1241517480_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ITimePickerFlyoutStatics_Impl(
    ...
    public override val __1241517480_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITimePickerFlyoutStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("085a6a2d68f45d4eb89c47cc0dd520a8")
    ...
    public override fun toNative(obj: ITimePickerFlyoutStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1241517480_Ptr))
  }
