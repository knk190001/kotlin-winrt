...
@Signature("rc(Microsoft.UI.Xaml.Controls.CandidateWindowBoundsChangedEventArgs;{b76faf94-3172-5c50-9507-26cd873815a1})")
...
public class CandidateWindowBoundsChangedEventArgs(
  ...
  private val __565530396_Interface: ICandidateWindowBoundsChangedEventArgs.WithDefault by lazy {
    as_565530396()
  }


  public override val __565530396_Ptr: JNAPointer? by lazy {
    __565530396_Interface.__565530396_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__565530396_Interface)

  private fun as_565530396(): ICandidateWindowBoundsChangedEventArgs.WithDefault {
    if(pointer == NULL) {
