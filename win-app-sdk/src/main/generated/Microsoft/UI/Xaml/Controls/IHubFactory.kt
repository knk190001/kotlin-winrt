...
@Signature("{520d3572-f141-58bd-b2a7-3352630fc1e2}")
@Guid("520d3572f14158bdb2a73352630fc1e2")
@WinRTInterface("520d3572f14158bdb2a73352630fc1e2")
...
public interface IHubFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IHubFactory {
    public val __1293539492_Ptr: Pointer?

    public val _1293539492_VtblPtr: Pointer?
      get() = __1293539492_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?): Hub? {
      val fnPtr = _1293539492_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Hub>()
      val hr = fn.invokeHR(arrayOf(__1293539492_Ptr, marshalToNative(baseInterface),
  ...
  public class IHubFactory_Impl(
    ...
    public override val __1293539492_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IHubFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("520d3572f14158bdb2a73352630fc1e2")
    ...
    public override fun toNative(obj: IHubFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1293539492_Ptr))
  }
