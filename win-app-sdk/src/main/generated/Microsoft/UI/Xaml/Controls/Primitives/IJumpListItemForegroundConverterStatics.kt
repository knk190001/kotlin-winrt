...
@Signature("{9ab3b95d-4061-59b4-9ce9-f45e2c05add7}")
@Guid("9ab3b95d406159b49ce9f45e2c05add7")
@WinRTInterface("9ab3b95d406159b49ce9f45e2c05add7")
...
public interface IJumpListItemForegroundConverterStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IJumpListItemForegroundConverterStatics {
    public val __1721203576_Ptr: Pointer?

    public val _1721203576_VtblPtr: Pointer?
      get() = __1721203576_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_EnabledProperty(): DependencyProperty? {
      val fnPtr = _1721203576_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1721203576_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_DisabledProperty(): DependencyProperty? {
      val fnPtr = _1721203576_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1721203576_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IJumpListItemForegroundConverterStatics_Impl(
    ...
    public override val __1721203576_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IJumpListItemForegroundConverterStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("9ab3b95d406159b49ce9f45e2c05add7")
    ...
    public override fun toNative(obj: IJumpListItemForegroundConverterStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1721203576_Ptr))
  }
