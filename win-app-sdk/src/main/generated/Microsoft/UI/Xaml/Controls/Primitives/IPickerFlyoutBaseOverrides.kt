...
@Signature("{5b090ffc-d423-5756-a01c-aa734579d856}")
@Guid("5b090ffcd4235756a01caa734579d856")
@WinRTInterface("5b090ffcd4235756a01caa734579d856")
...
public interface IPickerFlyoutBaseOverrides : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPickerFlyoutBaseOverrides {
    public val __1173679484_Ptr: Pointer?

    public val _1173679484_VtblPtr: Pointer?
      get() = __1173679484_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun OnConfirmed(): Unit {
      val fnPtr = _1173679484_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1173679484_Ptr, ))
      if (hr.toInt() != 0) {
    ...
    public override fun ShouldShowConfirmationButtons(): Boolean {
      val fnPtr = _1173679484_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1173679484_Ptr,  result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
  ...
  public class IPickerFlyoutBaseOverrides_Impl(
    ...
    public override val __1173679484_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPickerFlyoutBaseOverrides, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("5b090ffcd4235756a01caa734579d856")
    ...
    public override fun toNative(obj: IPickerFlyoutBaseOverrides): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1173679484_Ptr))
  }
