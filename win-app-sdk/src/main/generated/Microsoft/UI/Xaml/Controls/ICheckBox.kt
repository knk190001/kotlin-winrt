...
@Signature("{c5830000-4c9d-5fdd-9346-674c71cd80c5}")
@Guid("c58300004c9d5fdd9346674c71cd80c5")
@WinRTInterface("c58300004c9d5fdd9346674c71cd80c5")
...
public interface ICheckBox : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICheckBox {
    public val __1240971882_Ptr: Pointer?

    public val _1240971882_VtblPtr: Pointer?
      get() = __1240971882_Ptr?.getPointer(0)
  }

  public class ICheckBox_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __1240971882_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICheckBox, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("c58300004c9d5fdd9346674c71cd80c5")
    ...
    public override fun toNative(obj: ICheckBox): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1240971882_Ptr))
  }
