...
@Signature("{fcdaebd2-6fb5-523f-959e-3516bc0b72b7}")
@Guid("fcdaebd26fb5523f959e3516bc0b72b7")
@WinRTInterface("fcdaebd26fb5523f959e3516bc0b72b7")
...
public interface IRatingItemImageInfo : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IRatingItemImageInfo {
    public val __927448302_Ptr: Pointer?

    public val _927448302_VtblPtr: Pointer?
      get() = __927448302_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_DisabledImage(): ImageSource? {
      val fnPtr = _927448302_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ImageSource>()
      val hr = fn.invokeHR(arrayOf(__927448302_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_DisabledImage(value: ImageSource?): Unit {
      val fnPtr = _927448302_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__927448302_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Image(): ImageSource? {
      val fnPtr = _927448302_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ImageSource>()
      val hr = fn.invokeHR(arrayOf(__927448302_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Image(value: ImageSource?): Unit {
      val fnPtr = _927448302_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__927448302_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_PlaceholderImage(): ImageSource? {
      val fnPtr = _927448302_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ImageSource>()
      val hr = fn.invokeHR(arrayOf(__927448302_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_PlaceholderImage(value: ImageSource?): Unit {
      val fnPtr = _927448302_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__927448302_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_PointerOverImage(): ImageSource? {
      val fnPtr = _927448302_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ImageSource>()
      val hr = fn.invokeHR(arrayOf(__927448302_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_PointerOverImage(value: ImageSource?): Unit {
      val fnPtr = _927448302_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__927448302_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_PointerOverPlaceholderImage(): ImageSource? {
      val fnPtr = _927448302_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ImageSource>()
      val hr = fn.invokeHR(arrayOf(__927448302_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_PointerOverPlaceholderImage(value: ImageSource?): Unit {
      val fnPtr = _927448302_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__927448302_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_UnsetImage(): ImageSource? {
      val fnPtr = _927448302_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ImageSource>()
      val hr = fn.invokeHR(arrayOf(__927448302_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_UnsetImage(value: ImageSource?): Unit {
      val fnPtr = _927448302_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__927448302_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IRatingItemImageInfo_Impl(
    ...
    public override val __927448302_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IRatingItemImageInfo, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("fcdaebd26fb5523f959e3516bc0b72b7")
    ...
    public override fun toNative(obj: IRatingItemImageInfo): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__927448302_Ptr))
  }
