...
@ABIMarker(AnimatedFindVisualSource.ABI::class)
@Signature("rc(Microsoft.UI.Xaml.Controls.AnimatedVisuals.AnimatedFindVisualSource;{294765c3-70e3-555c-9657-01fc4051169d})")
@WinRTByReference(brClass = AnimatedFindVisualSource.ByReference::class)
public class AnimatedFindVisualSource(
  ptr: JNAPointer? = NULL
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<AnimatedFindVisualSource> {
    public override fun getValue() = AnimatedFindVisualSource(pointer.getPointer(0))

    public fun setValue(value: AnimatedFindVisualSource): Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  public object ABI : IABI<AnimatedFindVisualSource, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.AnimatedVisuals.AnimatedFindVisualSource".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public override fun fromNative(segment: MemoryAddress): AnimatedFindVisualSource {
      val address = segment.toRawLongValue()
      return AnimatedFindVisualSource(Pointer(address))
    }

    public override fun toNative(obj: AnimatedFindVisualSource): MemoryAddress =
