...
@Signature("{995a16dc-3a0f-5727-9f38-52cfc8143654}")
@Guid("995a16dc3a0f57279f3852cfc8143654")
@WinRTInterface("995a16dc3a0f57279f3852cfc8143654")
...
public interface IRatingItemFontInfo : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IRatingItemFontInfo {
    public val __917917204_Ptr: Pointer?

    public val _917917204_VtblPtr: Pointer?
      get() = __917917204_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_DisabledGlyph(): String? {
      val fnPtr = _917917204_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__917917204_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_DisabledGlyph(value: String?): Unit {
      val fnPtr = _917917204_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__917917204_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Glyph(): String? {
      val fnPtr = _917917204_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__917917204_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Glyph(value: String?): Unit {
      val fnPtr = _917917204_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__917917204_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_PointerOverGlyph(): String? {
      val fnPtr = _917917204_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__917917204_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_PointerOverGlyph(value: String?): Unit {
      val fnPtr = _917917204_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__917917204_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_PointerOverPlaceholderGlyph(): String? {
      val fnPtr = _917917204_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__917917204_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_PointerOverPlaceholderGlyph(value: String?): Unit {
      val fnPtr = _917917204_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__917917204_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_PlaceholderGlyph(): String? {
      val fnPtr = _917917204_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__917917204_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_PlaceholderGlyph(value: String?): Unit {
      val fnPtr = _917917204_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__917917204_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_UnsetGlyph(): String? {
      val fnPtr = _917917204_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__917917204_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_UnsetGlyph(value: String?): Unit {
      val fnPtr = _917917204_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__917917204_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IRatingItemFontInfo_Impl(
    ...
    public override val __917917204_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IRatingItemFontInfo, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("995a16dc3a0f57279f3852cfc8143654")
    ...
    public override fun toNative(obj: IRatingItemFontInfo): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__917917204_Ptr))
  }
