...
@Signature("rc(Microsoft.UI.Xaml.Controls.ItemsPickedEventArgs;{c6e93908-e20d-5614-988a-362d7937d276})")
...
public class ItemsPickedEventArgs(
  ...
  private val __854326878_Interface: IItemsPickedEventArgs.WithDefault by lazy {
    as_854326878()
  }


  public override val __854326878_Ptr: JNAPointer? by lazy {
    __854326878_Interface.__854326878_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__854326878_Interface)

  public constructor() : this(ABI.activate())

  private fun as_854326878(): IItemsPickedEventArgs.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<ItemsPickedEventArgs, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.ItemsPickedEventArgs".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
