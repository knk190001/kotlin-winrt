...
@Signature("{181266a1-d4f8-5af7-810b-aee8a1d452ed}")
@Guid("181266a1d4f85af7810baee8a1d452ed")
@WinRTInterface("181266a1d4f85af7810baee8a1d452ed")
...
public interface INavigationViewItemSeparatorFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : INavigationViewItemSeparatorFactory {
    public val __1543472104_Ptr: Pointer?

    public val _1543472104_VtblPtr: Pointer?
      get() = __1543472104_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        NavigationViewItemSeparator? {
      val fnPtr = _1543472104_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<NavigationViewItemSeparator>()
      val hr = fn.invokeHR(arrayOf(__1543472104_Ptr, marshalToNative(baseInterface),
  ...
  public class INavigationViewItemSeparatorFactory_Impl(
    ...
    public override val __1543472104_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<INavigationViewItemSeparatorFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("181266a1d4f85af7810baee8a1d452ed")
    ...
    public override fun toNative(obj: INavigationViewItemSeparatorFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1543472104_Ptr))
  }
