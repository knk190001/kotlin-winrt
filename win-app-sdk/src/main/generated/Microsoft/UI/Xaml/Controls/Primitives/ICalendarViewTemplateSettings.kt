...
@Signature("{23b0facb-0083-5109-87d3-dbeb13e331a0}")
@Guid("23b0facb0083510987d3dbeb13e331a0")
@WinRTInterface("23b0facb0083510987d3dbeb13e331a0")
...
public interface ICalendarViewTemplateSettings : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICalendarViewTemplateSettings {
    public val __1238038351_Ptr: Pointer?

    public val _1238038351_VtblPtr: Pointer?
      get() = __1238038351_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_MinViewWidth(): Double {
      val fnPtr = _1238038351_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1238038351_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_HeaderText(): String? {
      val fnPtr = _1238038351_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_WeekDay1(): String? {
      val fnPtr = _1238038351_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__1238038351_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_WeekDay2(): String? {
      val fnPtr = _1238038351_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__1238038351_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_WeekDay3(): String? {
      val fnPtr = _1238038351_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__1238038351_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_WeekDay4(): String? {
      val fnPtr = _1238038351_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__1238038351_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_WeekDay5(): String? {
      val fnPtr = _1238038351_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__1238038351_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_WeekDay6(): String? {
      val fnPtr = _1238038351_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__1238038351_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_WeekDay7(): String? {
      val fnPtr = _1238038351_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__1238038351_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_HasMoreContentAfter(): Boolean {
      val fnPtr = _1238038351_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_HasMoreContentBefore(): Boolean {
      val fnPtr = _1238038351_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1238038351_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_HasMoreViews(): Boolean {
      val fnPtr = _1238038351_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1238038351_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ClipRect(): Rect? {
      val fnPtr = _1238038351_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_CenterX(): Double {
      val fnPtr = _1238038351_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1238038351_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_CenterY(): Double {
      val fnPtr = _1238038351_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1238038351_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ICalendarViewTemplateSettings_Impl(
    ...
    public override val __1238038351_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICalendarViewTemplateSettings, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("23b0facb0083510987d3dbeb13e331a0")
    ...
    public override fun toNative(obj: ICalendarViewTemplateSettings): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1238038351_Ptr))
  }
