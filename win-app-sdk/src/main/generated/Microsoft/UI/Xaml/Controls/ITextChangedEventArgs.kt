...
@Signature("{71c37e43-7be7-52fc-bf8c-9867f44be5f4}")
@Guid("71c37e437be752fcbf8c9867f44be5f4")
@WinRTInterface("71c37e437be752fcbf8c9867f44be5f4")
...
public interface ITextChangedEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITextChangedEventArgs {
    public val __411178455_Ptr: Pointer?

    public val _411178455_VtblPtr: Pointer?
      get() = __411178455_Ptr?.getPointer(0)
  }

  public class ITextChangedEventArgs_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __411178455_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITextChangedEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("71c37e437be752fcbf8c9867f44be5f4")
    ...
    public override fun toNative(obj: ITextChangedEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__411178455_Ptr))
  }
