...
import Microsoft.UI.Xaml.Controls.IRatingControlFactory.ABI.IID
...
@Signature("rc(Microsoft.UI.Xaml.Controls.RatingControl;{5488193b-ea4b-52c6-8544-c063219bcd90})")
...
public open class RatingControl(
  ...
  private val __1229897369_Interface: IRatingControl.WithDefault by lazy {
    as_1229897369()
  }


  public override val __1229897369_Ptr: JNAPointer? by lazy {
    __1229897369_Interface.__1229897369_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1229897369_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1229897369(): IRatingControl.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<RatingControl, MemoryAddress> {
    ...
    public fun createIRatingControlStatics(): IRatingControlStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.RatingControl".toHandle(),refiid,interfacePtr)
    ...
    public fun createIRatingControlFactory(): IRatingControlFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.RatingControl".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
