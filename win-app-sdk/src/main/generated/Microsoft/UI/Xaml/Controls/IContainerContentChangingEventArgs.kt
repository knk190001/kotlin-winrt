...
@Signature("{f4c8c937-b070-53ce-a76c-074ee5750a71}")
@Guid("f4c8c937b07053cea76c074ee5750a71")
@WinRTInterface("f4c8c937b07053cea76c074ee5750a71")
...
public interface IContainerContentChangingEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IContainerContentChangingEventArgs {
    public val __189099541_Ptr: Pointer?

    public val _189099541_VtblPtr: Pointer?
      get() = __189099541_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ItemContainer(): SelectorItem? {
      val fnPtr = _189099541_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<SelectorItem>()
      val hr = fn.invokeHR(arrayOf(__189099541_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_InRecycleQueue(): Boolean {
      val fnPtr = _189099541_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_ItemIndex(): Int {
      val fnPtr = _189099541_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_Item(): IUnknown? {
      val fnPtr = _189099541_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_Phase(): WinDef.UINT {
      val fnPtr = _189099541_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_Handled(): Boolean {
      val fnPtr = _189099541_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__189099541_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Handled(value: Boolean): Unit {
      val fnPtr = _189099541_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__189099541_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun RegisterUpdateCallback(callback: TypedEventHandler<ListViewBase?,
        ContainerContentChangingEventArgs?>?): Unit {
      val fnPtr = _189099541_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__189099541_Ptr, marshalToNative(callback),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun RegisterUpdateCallback(callbackPhase: WinDef.UINT,
        callback: TypedEventHandler<ListViewBase?, ContainerContentChangingEventArgs?>?): Unit {
      val fnPtr = _189099541_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__189099541_Ptr, callbackPhase, marshalToNative(callback),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IContainerContentChangingEventArgs_Impl(
    ...
    public override val __189099541_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IContainerContentChangingEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("f4c8c937b07053cea76c074ee5750a71")
    ...
    public override fun toNative(obj: IContainerContentChangingEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__189099541_Ptr))
  }
