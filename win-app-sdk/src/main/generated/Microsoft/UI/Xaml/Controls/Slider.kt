...
import Microsoft.UI.Xaml.Controls.ISliderFactory.ABI.IID
...
@Signature("rc(Microsoft.UI.Xaml.Controls.Slider;{f7418ecf-7c35-5216-8bf1-d82d47cce5df})")
@WinRTByReference(brClass = Slider.ByReference::class)
public open class Slider(
  ptr: JNAPointer? = NULL
) : RangeBase(ptr), ISlider.WithDefault, IWinRTObject {
  private val __1932356248_Interface: ISlider.WithDefault by lazy {
    as_1932356248()
  }


  public override val __1932356248_Ptr: JNAPointer? by lazy {
    __1932356248_Interface.__1932356248_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1932356248_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1932356248(): ISlider.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<Slider, MemoryAddress> {
    ...
    public fun createISliderStatics(): ISliderStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.Slider".toHandle(),refiid,interfacePtr)
    ...
    public fun createISliderFactory(): ISliderFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.Slider".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
  ...
  public companion object {
    ...
    public fun get_HeaderProperty() = ABI.ISliderStatics_Instance.get_HeaderProperty()

    public fun get_HeaderTemplateProperty() =
        ABI.ISliderStatics_Instance.get_HeaderTemplateProperty()
  }
}
