...
@Signature("{bc405765-ed94-5697-8506-a8f3d15272f9}")
@Guid("bc405765ed9456978506a8f3d15272f9")
@WinRTInterface("bc405765ed9456978506a8f3d15272f9")
...
public interface IDragDeltaEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IDragDeltaEventArgs {
    public val __1438308900_Ptr: Pointer?

    public val _1438308900_VtblPtr: Pointer?
      get() = __1438308900_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_HorizontalChange(): Double {
      val fnPtr = _1438308900_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1438308900_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_VerticalChange(): Double {
      val fnPtr = _1438308900_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1438308900_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IDragDeltaEventArgs_Impl(
    ...
    public override val __1438308900_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IDragDeltaEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("bc405765ed9456978506a8f3d15272f9")
    ...
    public override fun toNative(obj: IDragDeltaEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1438308900_Ptr))
  }
