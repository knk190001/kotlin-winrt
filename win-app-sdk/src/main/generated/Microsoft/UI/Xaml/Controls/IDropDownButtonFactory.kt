...
@Signature("{7cf3e13b-668d-57e7-b5d6-f5ca3dbc80bd}")
@Guid("7cf3e13b668d57e7b5d6f5ca3dbc80bd")
@WinRTInterface("7cf3e13b668d57e7b5d6f5ca3dbc80bd")
...
public interface IDropDownButtonFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IDropDownButtonFactory {
    public val __958265696_Ptr: Pointer?

    public val _958265696_VtblPtr: Pointer?
      get() = __958265696_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        DropDownButton? {
      val fnPtr = _958265696_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DropDownButton>()
      val hr = fn.invokeHR(arrayOf(__958265696_Ptr, marshalToNative(baseInterface),
  ...
  public class IDropDownButtonFactory_Impl(
    ...
    public override val __958265696_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IDropDownButtonFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("7cf3e13b668d57e7b5d6f5ca3dbc80bd")
    ...
    public override fun toNative(obj: IDropDownButtonFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__958265696_Ptr))
  }
