...
@Signature("{006d738f-7c91-5ef3-8a80-a548108dab8b}")
@Guid("006d738f7c915ef38a80a548108dab8b")
@WinRTInterface("006d738f7c915ef38a80a548108dab8b")
...
public interface IFlyoutBaseFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IFlyoutBaseFactory {
    public val __853820365_Ptr: Pointer?

    public val _853820365_VtblPtr: Pointer?
      get() = __853820365_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        FlyoutBase? {
      val fnPtr = _853820365_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<FlyoutBase>()
      val hr = fn.invokeHR(arrayOf(__853820365_Ptr, marshalToNative(baseInterface),
  ...
  public class IFlyoutBaseFactory_Impl(
    ...
    public override val __853820365_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IFlyoutBaseFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("006d738f7c915ef38a80a548108dab8b")
    ...
    public override fun toNative(obj: IFlyoutBaseFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__853820365_Ptr))
  }
