...
@Signature("{29b5dd9c-2bfb-5e1c-97cb-cdc3c34a365d}")
@Guid("29b5dd9c2bfb5e1c97cbcdc3c34a365d")
@WinRTInterface("29b5dd9c2bfb5e1c97cbcdc3c34a365d")
...
public interface ITreeViewItemTemplateSettings : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITreeViewItemTemplateSettings {
    public val __321011398_Ptr: Pointer?

    public val _321011398_VtblPtr: Pointer?
      get() = __321011398_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ExpandedGlyphVisibility(): Visibility? {
      val fnPtr = _321011398_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Visibility>()
      val hr = fn.invokeHR(arrayOf(__321011398_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_CollapsedGlyphVisibility(): Visibility? {
      val fnPtr = _321011398_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Visibility>()
      val hr = fn.invokeHR(arrayOf(__321011398_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Indentation(): Thickness? {
      val fnPtr = _321011398_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_DragItemsCount(): Int {
      val fnPtr = _321011398_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class ITreeViewItemTemplateSettings_Impl(
    ...
    public override val __321011398_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITreeViewItemTemplateSettings, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("29b5dd9c2bfb5e1c97cbcdc3c34a365d")
    ...
    public override fun toNative(obj: ITreeViewItemTemplateSettings): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__321011398_Ptr))
  }
