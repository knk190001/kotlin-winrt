...
@Signature("{f6015db1-df63-52fd-a164-0df44715ee0a}")
@Guid("f6015db1df6352fda1640df44715ee0a")
@WinRTInterface("f6015db1df6352fda1640df44715ee0a")
...
public interface IListView : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IListView {
    public val __1049818922_Ptr: Pointer?

    public val _1049818922_VtblPtr: Pointer?
      get() = __1049818922_Ptr?.getPointer(0)
  }

  public class IListView_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __1049818922_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IListView, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("f6015db1df6352fda1640df44715ee0a")
    ...
    public override fun toNative(obj: IListView): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1049818922_Ptr))
  }
