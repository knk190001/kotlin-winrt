...
@Signature("{a16bea02-b3e0-5fdc-b5bb-25f794dc483b}")
@Guid("a16bea02b3e05fdcb5bb25f794dc483b")
@WinRTInterface("a16bea02b3e05fdcb5bb25f794dc483b")
...
public interface IDatePickerFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IDatePickerFactory {
    public val __821749927_Ptr: Pointer?

    public val _821749927_VtblPtr: Pointer?
      get() = __821749927_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        DatePicker? {
      val fnPtr = _821749927_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DatePicker>()
      val hr = fn.invokeHR(arrayOf(__821749927_Ptr, marshalToNative(baseInterface),
  ...
  public class IDatePickerFactory_Impl(
    ...
    public override val __821749927_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IDatePickerFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("a16bea02b3e05fdcb5bb25f794dc483b")
    ...
    public override fun toNative(obj: IDatePickerFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__821749927_Ptr))
  }
