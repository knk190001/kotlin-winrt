...
@Signature("{d1355ed8-64ed-5bbc-9411-5f4dbca7d93f}")
@Guid("d1355ed864ed5bbc94115f4dbca7d93f")
@WinRTInterface("d1355ed864ed5bbc94115f4dbca7d93f")
...
public interface IContentDialogOpenedEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IContentDialogOpenedEventArgs {
    public val __2062559212_Ptr: Pointer?

    public val _2062559212_VtblPtr: Pointer?
      get() = __2062559212_Ptr?.getPointer(0)
  }

  public class IContentDialogOpenedEventArgs_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __2062559212_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IContentDialogOpenedEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("d1355ed864ed5bbc94115f4dbca7d93f")
    ...
    public override fun toNative(obj: IContentDialogOpenedEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2062559212_Ptr))
  }
