...
import Microsoft.UI.Xaml.Controls.IMenuBarItemFactory.ABI.IID
...
@Signature("rc(Microsoft.UI.Xaml.Controls.MenuBarItem;{a7900980-51cc-531d-97c5-356b13573398})")
...
public open class MenuBarItem(
  ...
  private val __405580992_Interface: IMenuBarItem.WithDefault by lazy {
    as_405580992()
  }


  public override val __405580992_Ptr: JNAPointer? by lazy {
    __405580992_Interface.__405580992_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__405580992_Interface)

  public constructor() : this(ABI.activate())

  private fun as_405580992(): IMenuBarItem.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<MenuBarItem, MemoryAddress> {
    ...
    public fun createIMenuBarItemStatics(): IMenuBarItemStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.MenuBarItem".toHandle(),refiid,interfacePtr)
    ...
    public fun createIMenuBarItemFactory(): IMenuBarItemFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.MenuBarItem".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
