...
@Signature("{5a14b68f-1e03-5604-bcd6-7c7403619513}")
@Guid("5a14b68f1e035604bcd67c7403619513")
@WinRTInterface("5a14b68f1e035604bcd67c7403619513")
...
public interface IMediaPlayerPresenterStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IMediaPlayerPresenterStatics {
    public val __1616817115_Ptr: Pointer?

    public val _1616817115_VtblPtr: Pointer?
      get() = __1616817115_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_MediaPlayerProperty(): DependencyProperty? {
      val fnPtr = _1616817115_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1616817115_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_StretchProperty(): DependencyProperty? {
      val fnPtr = _1616817115_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1616817115_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsFullWindowProperty(): DependencyProperty? {
      val fnPtr = _1616817115_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1616817115_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IMediaPlayerPresenterStatics_Impl(
    ...
    public override val __1616817115_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IMediaPlayerPresenterStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("5a14b68f1e035604bcd67c7403619513")
    ...
    public override fun toNative(obj: IMediaPlayerPresenterStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1616817115_Ptr))
  }
