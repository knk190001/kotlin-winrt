...
@Signature("{6497d326-fb55-5cf5-8cc4-c556b1a958fb}")
@Guid("6497d326fb555cf58cc4c556b1a958fb")
@WinRTInterface("6497d326fb555cf58cc4c556b1a958fb")
...
public interface IAppBarSeparatorFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IAppBarSeparatorFactory {
    public val __113908930_Ptr: Pointer?

    public val _113908930_VtblPtr: Pointer?
      get() = __113908930_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        AppBarSeparator? {
      val fnPtr = _113908930_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AppBarSeparator>()
      val hr = fn.invokeHR(arrayOf(__113908930_Ptr, marshalToNative(baseInterface),
  ...
  public class IAppBarSeparatorFactory_Impl(
    ...
    public override val __113908930_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IAppBarSeparatorFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("6497d326fb555cf58cc4c556b1a958fb")
    ...
    public override fun toNative(obj: IAppBarSeparatorFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__113908930_Ptr))
  }
