...
import Microsoft.UI.Xaml.Controls.Primitives.ISelectorItemFactory.ABI.IID
...
@Signature("rc(Microsoft.UI.Xaml.Controls.Primitives.SelectorItem;{5772c4de-60ea-5492-8c5e-b3323d5a3ca6})")
...
public open class SelectorItem(
  ...
  private val __2108693091_Interface: ISelectorItem.WithDefault by lazy {
    as_2108693091()
  }


  public override val __2108693091_Ptr: JNAPointer? by lazy {
    __2108693091_Interface.__2108693091_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__2108693091_Interface)

  public constructor() : this(ABI.activate())

  private fun as_2108693091(): ISelectorItem.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<SelectorItem, MemoryAddress> {
    ...
    public fun createISelectorItemStatics(): ISelectorItemStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.Primitives.SelectorItem".toHandle(),refiid,interfacePtr)
    ...
    public fun createISelectorItemFactory(): ISelectorItemFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.Primitives.SelectorItem".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
