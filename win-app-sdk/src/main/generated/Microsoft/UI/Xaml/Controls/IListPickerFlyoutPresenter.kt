...
@Signature("{7dcc91ab-8694-517b-a4e6-04767410c60b}")
@Guid("7dcc91ab8694517ba4e604767410c60b")
@WinRTInterface("7dcc91ab8694517ba4e604767410c60b")
...
public interface IListPickerFlyoutPresenter : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IListPickerFlyoutPresenter {
    public val __1932426598_Ptr: Pointer?

    public val _1932426598_VtblPtr: Pointer?
      get() = __1932426598_Ptr?.getPointer(0)
  }

  public class IListPickerFlyoutPresenter_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __1932426598_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IListPickerFlyoutPresenter, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("7dcc91ab8694517ba4e604767410c60b")
    ...
    public override fun toNative(obj: IListPickerFlyoutPresenter): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1932426598_Ptr))
  }
