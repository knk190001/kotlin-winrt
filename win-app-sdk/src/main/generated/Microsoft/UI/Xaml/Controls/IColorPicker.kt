...
@Signature("{ae72b24b-f93f-5a19-8ce4-a18b73c3356d}")
@Guid("ae72b24bf93f5a198ce4a18b73c3356d")
@WinRTInterface("ae72b24bf93f5a198ce4a18b73c3356d")
...
public interface IColorPicker : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IColorPicker {
    public val __676827734_Ptr: Pointer?

    public val _676827734_VtblPtr: Pointer?
      get() = __676827734_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Color(): Color? {
      val fnPtr = _676827734_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__676827734_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Color(value: Color?): Unit {
      val fnPtr = _676827734_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__676827734_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_PreviousColor(): IReference<Color?>? {
      val fnPtr = _676827734_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_PreviousColor(value: IReference<Color?>?): Unit {
      val fnPtr = _676827734_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__676827734_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_IsAlphaEnabled(): Boolean {
      val fnPtr = _676827734_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_IsAlphaEnabled(value: Boolean): Unit {
      val fnPtr = _676827734_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__676827734_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_IsColorSpectrumVisible(): Boolean {
      val fnPtr = _676827734_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__676827734_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_IsColorSpectrumVisible(value: Boolean): Unit {
      val fnPtr = _676827734_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__676827734_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_IsColorPreviewVisible(): Boolean {
      val fnPtr = _676827734_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__676827734_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_IsColorPreviewVisible(value: Boolean): Unit {
      val fnPtr = _676827734_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__676827734_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_IsColorSliderVisible(): Boolean {
      val fnPtr = _676827734_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__676827734_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_IsColorSliderVisible(value: Boolean): Unit {
      val fnPtr = _676827734_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__676827734_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_IsAlphaSliderVisible(): Boolean {
      val fnPtr = _676827734_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__676827734_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_IsAlphaSliderVisible(value: Boolean): Unit {
      val fnPtr = _676827734_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__676827734_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_IsMoreButtonVisible(): Boolean {
      val fnPtr = _676827734_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__676827734_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_IsMoreButtonVisible(value: Boolean): Unit {
      val fnPtr = _676827734_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__676827734_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_IsColorChannelTextInputVisible(): Boolean {
      val fnPtr = _676827734_VtblPtr!!.getPointer(22L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__676827734_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_IsColorChannelTextInputVisible(value: Boolean): Unit {
      val fnPtr = _676827734_VtblPtr!!.getPointer(23L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__676827734_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_IsAlphaTextInputVisible(): Boolean {
      val fnPtr = _676827734_VtblPtr!!.getPointer(24L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__676827734_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_IsAlphaTextInputVisible(value: Boolean): Unit {
      val fnPtr = _676827734_VtblPtr!!.getPointer(25L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__676827734_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_IsHexInputVisible(): Boolean {
      val fnPtr = _676827734_VtblPtr!!.getPointer(26L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__676827734_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_IsHexInputVisible(value: Boolean): Unit {
      val fnPtr = _676827734_VtblPtr!!.getPointer(27L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__676827734_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_MinHue(): Int {
      val fnPtr = _676827734_VtblPtr!!.getPointer(28L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_MinHue(value: Int): Unit {
      val fnPtr = _676827734_VtblPtr!!.getPointer(29L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__676827734_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_MaxHue(): Int {
      val fnPtr = _676827734_VtblPtr!!.getPointer(30L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__676827734_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_MaxHue(value: Int): Unit {
      val fnPtr = _676827734_VtblPtr!!.getPointer(31L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__676827734_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_MinSaturation(): Int {
      val fnPtr = _676827734_VtblPtr!!.getPointer(32L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__676827734_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_MinSaturation(value: Int): Unit {
      val fnPtr = _676827734_VtblPtr!!.getPointer(33L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__676827734_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_MaxSaturation(): Int {
      val fnPtr = _676827734_VtblPtr!!.getPointer(34L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__676827734_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_MaxSaturation(value: Int): Unit {
      val fnPtr = _676827734_VtblPtr!!.getPointer(35L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__676827734_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_MinValue(): Int {
      val fnPtr = _676827734_VtblPtr!!.getPointer(36L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__676827734_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_MinValue(value: Int): Unit {
      val fnPtr = _676827734_VtblPtr!!.getPointer(37L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__676827734_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_MaxValue(): Int {
      val fnPtr = _676827734_VtblPtr!!.getPointer(38L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__676827734_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_MaxValue(value: Int): Unit {
      val fnPtr = _676827734_VtblPtr!!.getPointer(39L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__676827734_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ColorSpectrumShape(): ColorSpectrumShape? {
      val fnPtr = _676827734_VtblPtr!!.getPointer(40L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_ColorSpectrumShape(value: ColorSpectrumShape?): Unit {
      val fnPtr = _676827734_VtblPtr!!.getPointer(41L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__676827734_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ColorSpectrumComponents(): ColorSpectrumComponents? {
      val fnPtr = _676827734_VtblPtr!!.getPointer(42L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_ColorSpectrumComponents(value: ColorSpectrumComponents?): Unit {
      val fnPtr = _676827734_VtblPtr!!.getPointer(43L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__676827734_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun add_ColorChanged(handler: TypedEventHandler<ColorPicker?,
      ...
      val fnPtr = _676827734_VtblPtr!!.getPointer(44L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__676827734_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun remove_ColorChanged(token: EventRegistrationToken?): Unit {
      val fnPtr = _676827734_VtblPtr!!.getPointer(45L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__676827734_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IColorPicker_Impl(
    ...
    public override val __676827734_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IColorPicker, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("ae72b24bf93f5a198ce4a18b73c3356d")
    ...
    public override fun toNative(obj: IColorPicker): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__676827734_Ptr))
  }
