...
@Signature("{40d3022b-c82b-5565-a4e4-ad9d7a66b1a9}")
@Guid("40d3022bc82b5565a4e4ad9d7a66b1a9")
@WinRTInterface("40d3022bc82b5565a4e4ad9d7a66b1a9")
...
public interface ISwipeItems : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISwipeItems {
    public val __454447699_Ptr: Pointer?

    public val _454447699_VtblPtr: Pointer?
      get() = __454447699_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Mode(): SwipeMode? {
      val fnPtr = _454447699_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<SwipeMode>()
      val hr = fn.invokeHR(arrayOf(__454447699_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Mode(value: SwipeMode?): Unit {
      val fnPtr = _454447699_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__454447699_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class ISwipeItems_Impl(
    ...
    public override val __454447699_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISwipeItems, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("40d3022bc82b5565a4e4ad9d7a66b1a9")
    ...
    public override fun toNative(obj: ISwipeItems): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__454447699_Ptr))
  }
