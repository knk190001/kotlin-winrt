...
@Signature("{1cf87a70-6348-57ec-9eac-fa0565adc60f}")
@Guid("1cf87a70634857ec9eacfa0565adc60f")
@WinRTInterface("1cf87a70634857ec9eacfa0565adc60f")
...
public interface IItemClickEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IItemClickEventArgs {
    public val __1034117609_Ptr: Pointer?

    public val _1034117609_VtblPtr: Pointer?
      get() = __1034117609_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ClickedItem(): IUnknown? {
      val fnPtr = _1034117609_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IUnknown>()
      val hr = fn.invokeHR(arrayOf(__1034117609_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IItemClickEventArgs_Impl(
    ...
    public override val __1034117609_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IItemClickEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("1cf87a70634857ec9eacfa0565adc60f")
    ...
    public override fun toNative(obj: IItemClickEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1034117609_Ptr))
  }
