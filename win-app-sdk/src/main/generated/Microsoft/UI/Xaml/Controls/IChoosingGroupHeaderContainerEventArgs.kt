...
@Signature("{2db1b0b0-aee9-55fa-8c30-c98f00643d00}")
@Guid("2db1b0b0aee955fa8c30c98f00643d00")
@WinRTInterface("2db1b0b0aee955fa8c30c98f00643d00")
...
public interface IChoosingGroupHeaderContainerEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IChoosingGroupHeaderContainerEventArgs {
    public val __495424519_Ptr: Pointer?

    public val _495424519_VtblPtr: Pointer?
      get() = __495424519_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_GroupHeaderContainer(): ListViewBaseHeaderItem? {
      val fnPtr = _495424519_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ListViewBaseHeaderItem>()
      val hr = fn.invokeHR(arrayOf(__495424519_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_GroupHeaderContainer(value: ListViewBaseHeaderItem?): Unit {
      val fnPtr = _495424519_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__495424519_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_GroupIndex(): Int {
      val fnPtr = _495424519_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_Group(): IUnknown? {
      val fnPtr = _495424519_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class IChoosingGroupHeaderContainerEventArgs_Impl(
    ...
    public override val __495424519_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IChoosingGroupHeaderContainerEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("2db1b0b0aee955fa8c30c98f00643d00")
    ...
    public override fun toNative(obj: IChoosingGroupHeaderContainerEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__495424519_Ptr))
  }
