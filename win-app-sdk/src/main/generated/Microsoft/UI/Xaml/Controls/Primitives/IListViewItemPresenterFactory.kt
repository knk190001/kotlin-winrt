...
@Signature("{f86ac266-2740-505c-95eb-a7331b53b4a3}")
@Guid("f86ac2662740505c95eba7331b53b4a3")
@WinRTInterface("f86ac2662740505c95eba7331b53b4a3")
...
public interface IListViewItemPresenterFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IListViewItemPresenterFactory {
    public val __125858889_Ptr: Pointer?

    public val _125858889_VtblPtr: Pointer?
      get() = __125858889_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        ListViewItemPresenter? {
      val fnPtr = _125858889_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ListViewItemPresenter>()
      val hr = fn.invokeHR(arrayOf(__125858889_Ptr, marshalToNative(baseInterface),
  ...
  public class IListViewItemPresenterFactory_Impl(
    ...
    public override val __125858889_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IListViewItemPresenterFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("f86ac2662740505c95eba7331b53b4a3")
    ...
    public override fun toNative(obj: IListViewItemPresenterFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__125858889_Ptr))
  }
