...
@Signature("{75d36595-bf4f-5393-819f-eb1e321ce1dc}")
@Guid("75d36595bf4f5393819feb1e321ce1dc")
@WinRTInterface("75d36595bf4f5393819feb1e321ce1dc")
...
public interface ILoopingSelectorItem : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ILoopingSelectorItem {
    public val __967329151_Ptr: Pointer?

    public val _967329151_VtblPtr: Pointer?
      get() = __967329151_Ptr?.getPointer(0)
  }

  public class ILoopingSelectorItem_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __967329151_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ILoopingSelectorItem, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("75d36595bf4f5393819feb1e321ce1dc")
    ...
    public override fun toNative(obj: ILoopingSelectorItem): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__967329151_Ptr))
  }
