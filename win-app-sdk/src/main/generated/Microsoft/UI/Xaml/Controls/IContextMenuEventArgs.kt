...
@Signature("{65637bb3-e279-5507-bd16-6f7ba6705f31}")
@Guid("65637bb3e2795507bd166f7ba6705f31")
@WinRTInterface("65637bb3e2795507bd166f7ba6705f31")
...
public interface IContextMenuEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IContextMenuEventArgs {
    public val __250057424_Ptr: Pointer?

    public val _250057424_VtblPtr: Pointer?
      get() = __250057424_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Handled(): Boolean {
      val fnPtr = _250057424_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__250057424_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Handled(value: Boolean): Unit {
      val fnPtr = _250057424_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__250057424_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_CursorLeft(): Double {
      val fnPtr = _250057424_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_CursorTop(): Double {
      val fnPtr = _250057424_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__250057424_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IContextMenuEventArgs_Impl(
    ...
    public override val __250057424_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IContextMenuEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("65637bb3e2795507bd166f7ba6705f31")
    ...
    public override fun toNative(obj: IContextMenuEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__250057424_Ptr))
  }
