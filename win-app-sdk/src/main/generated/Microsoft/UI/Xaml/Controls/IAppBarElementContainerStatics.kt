...
@Signature("{50c068de-72d0-52ba-bb42-ada6527b392f}")
@Guid("50c068de72d052babb42ada6527b392f")
@WinRTInterface("50c068de72d052babb42ada6527b392f")
...
public interface IAppBarElementContainerStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IAppBarElementContainerStatics {
    public val __739032025_Ptr: Pointer?

    public val _739032025_VtblPtr: Pointer?
      get() = __739032025_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_IsCompactProperty(): DependencyProperty? {
      val fnPtr = _739032025_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__739032025_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsInOverflowProperty(): DependencyProperty? {
      val fnPtr = _739032025_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__739032025_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_DynamicOverflowOrderProperty(): DependencyProperty? {
      val fnPtr = _739032025_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__739032025_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IAppBarElementContainerStatics_Impl(
    ...
    public override val __739032025_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IAppBarElementContainerStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("50c068de72d052babb42ada6527b392f")
    ...
    public override fun toNative(obj: IAppBarElementContainerStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__739032025_Ptr))
  }
