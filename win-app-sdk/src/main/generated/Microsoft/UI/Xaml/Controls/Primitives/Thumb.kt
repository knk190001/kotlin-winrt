...
@Signature("rc(Microsoft.UI.Xaml.Controls.Primitives.Thumb;{9b540ae4-98ed-5a19-9512-a56878c52fee})")
@WinRTByReference(brClass = Thumb.ByReference::class)
public class Thumb(
  ptr: JNAPointer? = NULL
) : Control(ptr), IThumb.WithDefault, IWinRTObject {
  private val __826608677_Interface: IThumb.WithDefault by lazy {
    as_826608677()
  }


  public override val __826608677_Ptr: JNAPointer? by lazy {
    __826608677_Interface.__826608677_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__826608677_Interface)

  public constructor() : this(ABI.activate())

  private fun as_826608677(): IThumb.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<Thumb, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.Primitives.Thumb".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIThumbStatics(): IThumbStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.Primitives.Thumb".toHandle(),refiid,interfacePtr)
