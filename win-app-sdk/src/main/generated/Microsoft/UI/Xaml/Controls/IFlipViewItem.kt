...
@Signature("{516f2058-af67-5eb3-b796-e75b34f3fd92}")
@Guid("516f2058af675eb3b796e75b34f3fd92")
@WinRTInterface("516f2058af675eb3b796e75b34f3fd92")
...
public interface IFlipViewItem : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IFlipViewItem {
    public val __179940820_Ptr: Pointer?

    public val _179940820_VtblPtr: Pointer?
      get() = __179940820_Ptr?.getPointer(0)
  }

  public class IFlipViewItem_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __179940820_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IFlipViewItem, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("516f2058af675eb3b796e75b34f3fd92")
    ...
    public override fun toNative(obj: IFlipViewItem): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__179940820_Ptr))
  }
