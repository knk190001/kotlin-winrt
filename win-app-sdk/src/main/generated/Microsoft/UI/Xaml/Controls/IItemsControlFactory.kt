...
@Signature("{b2686273-2dd3-5454-9f25-247e66270336}")
@Guid("b26862732dd354549f25247e66270336")
@WinRTInterface("b26862732dd354549f25247e66270336")
...
public interface IItemsControlFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IItemsControlFactory {
    public val __1563235418_Ptr: Pointer?

    public val _1563235418_VtblPtr: Pointer?
      get() = __1563235418_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        ItemsControl? {
      val fnPtr = _1563235418_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ItemsControl>()
      val hr = fn.invokeHR(arrayOf(__1563235418_Ptr, marshalToNative(baseInterface),
  ...
  public class IItemsControlFactory_Impl(
    ...
    public override val __1563235418_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IItemsControlFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("b26862732dd354549f25247e66270336")
    ...
    public override fun toNative(obj: IItemsControlFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1563235418_Ptr))
  }
