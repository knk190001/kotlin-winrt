...
@Signature("{e887b29a-1551-5868-a5dc-3fcfe7452e6b}")
@Guid("e887b29a15515868a5dc3fcfe7452e6b")
@WinRTInterface("e887b29a15515868a5dc3fcfe7452e6b")
...
public interface IRichEditBoxTextChangingEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IRichEditBoxTextChangingEventArgs {
    public val __298824993_Ptr: Pointer?

    public val _298824993_VtblPtr: Pointer?
      get() = __298824993_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_IsContentChanging(): Boolean {
      val fnPtr = _298824993_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__298824993_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IRichEditBoxTextChangingEventArgs_Impl(
    ...
    public override val __298824993_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IRichEditBoxTextChangingEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("e887b29a15515868a5dc3fcfe7452e6b")
    ...
    public override fun toNative(obj: IRichEditBoxTextChangingEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__298824993_Ptr))
  }
