...
@Signature("rc(Microsoft.UI.Xaml.Controls.ScrollViewerView;{1e9f68ee-6ce5-5cbf-bbfe-b8cd284b9c23})")
...
public class ScrollViewerView(
  ...
  private val __1378005429_Interface: IScrollViewerView.WithDefault by lazy {
    as_1378005429()
  }


  public override val __1378005429_Ptr: JNAPointer? by lazy {
    __1378005429_Interface.__1378005429_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1378005429_Interface)

  private fun as_1378005429(): IScrollViewerView.WithDefault {
    if(pointer == NULL) {
