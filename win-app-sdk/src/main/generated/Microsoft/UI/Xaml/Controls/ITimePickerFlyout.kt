...
@Signature("{479799dc-700a-5a9c-ba0b-9ab2587ed2e8}")
@Guid("479799dc700a5a9cba0b9ab2587ed2e8")
@WinRTInterface("479799dc700a5a9cba0b9ab2587ed2e8")
...
public interface ITimePickerFlyout : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITimePickerFlyout {
    public val __1398933667_Ptr: Pointer?

    public val _1398933667_VtblPtr: Pointer?
      get() = __1398933667_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ClockIdentifier(): String? {
      val fnPtr = _1398933667_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__1398933667_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ClockIdentifier(value: String?): Unit {
      val fnPtr = _1398933667_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1398933667_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Time(): TimeSpan? {
      val fnPtr = _1398933667_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Time(value: TimeSpan?): Unit {
      val fnPtr = _1398933667_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1398933667_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_MinuteIncrement(): Int {
      val fnPtr = _1398933667_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_MinuteIncrement(value: Int): Unit {
      val fnPtr = _1398933667_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1398933667_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun add_TimePicked(handler: TypedEventHandler<TimePickerFlyout?,
      ...
      val fnPtr = _1398933667_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__1398933667_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun remove_TimePicked(token: EventRegistrationToken?): Unit {
      val fnPtr = _1398933667_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1398933667_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun ShowAtAsync(target: FrameworkElement?):
      ...
      val fnPtr = _1398933667_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IAsyncOperation<IReference<TimeSpan?>?>>()
      val hr = fn.invokeHR(arrayOf(__1398933667_Ptr, marshalToNative(target), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
      val resultValue =
  ...
  public class ITimePickerFlyout_Impl(
    ...
    public override val __1398933667_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITimePickerFlyout, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("479799dc700a5a9cba0b9ab2587ed2e8")
    ...
    public override fun toNative(obj: ITimePickerFlyout): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1398933667_Ptr))
  }
