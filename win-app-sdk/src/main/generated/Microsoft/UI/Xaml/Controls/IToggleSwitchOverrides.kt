...
@Signature("{772682db-e3d4-5242-b6de-36705725eeb8}")
@Guid("772682dbe3d45242b6de36705725eeb8")
@WinRTInterface("772682dbe3d45242b6de36705725eeb8")
...
public interface IToggleSwitchOverrides : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IToggleSwitchOverrides {
    public val __1106079736_Ptr: Pointer?

    public val _1106079736_VtblPtr: Pointer?
      get() = __1106079736_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun OnToggled(): Unit {
      val fnPtr = _1106079736_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1106079736_Ptr, ))
      if (hr.toInt() != 0) {
    ...
    public override fun OnOnContentChanged(oldContent: IUnknown?, newContent: IUnknown?): Unit {
      val fnPtr = _1106079736_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1106079736_Ptr, marshalToNative(oldContent),
    ...
    public override fun OnOffContentChanged(oldContent: IUnknown?, newContent: IUnknown?): Unit {
      val fnPtr = _1106079736_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1106079736_Ptr, marshalToNative(oldContent),
          marshalToNative(newContent),))
      if (hr.toInt() != 0) {
    ...
    public override fun OnHeaderChanged(oldContent: IUnknown?, newContent: IUnknown?): Unit {
      val fnPtr = _1106079736_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1106079736_Ptr, marshalToNative(oldContent),
          marshalToNative(newContent),))
      if (hr.toInt() != 0) {
  ...
  public class IToggleSwitchOverrides_Impl(
    ...
    public override val __1106079736_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IToggleSwitchOverrides, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("772682dbe3d45242b6de36705725eeb8")
    ...
    public override fun toNative(obj: IToggleSwitchOverrides): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1106079736_Ptr))
  }
