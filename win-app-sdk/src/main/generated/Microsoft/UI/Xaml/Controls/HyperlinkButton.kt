...
import Microsoft.UI.Xaml.Controls.IHyperlinkButtonFactory.ABI.IID
...
@Signature("rc(Microsoft.UI.Xaml.Controls.HyperlinkButton;{6dbee605-8df0-50cc-9a42-250eb138f0c6})")
...
public open class HyperlinkButton(
  ...
  private val __1049587055_Interface: IHyperlinkButton.WithDefault by lazy {
    as_1049587055()
  }


  public override val __1049587055_Ptr: JNAPointer? by lazy {
    __1049587055_Interface.__1049587055_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1049587055_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1049587055(): IHyperlinkButton.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<HyperlinkButton, MemoryAddress> {
    ...
    public fun createIHyperlinkButtonStatics(): IHyperlinkButtonStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.HyperlinkButton".toHandle(),refiid,interfacePtr)
    ...
    public fun createIHyperlinkButtonFactory(): IHyperlinkButtonFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.HyperlinkButton".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
