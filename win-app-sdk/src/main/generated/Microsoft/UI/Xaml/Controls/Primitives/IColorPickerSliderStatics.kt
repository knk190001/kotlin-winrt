...
@Signature("{82f72b75-e986-587f-9701-8ac6801da932}")
@Guid("82f72b75e986587f97018ac6801da932")
@WinRTInterface("82f72b75e986587f97018ac6801da932")
...
public interface IColorPickerSliderStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IColorPickerSliderStatics {
    public val __1464744612_Ptr: Pointer?

    public val _1464744612_VtblPtr: Pointer?
      get() = __1464744612_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ColorChannelProperty(): DependencyProperty? {
      val fnPtr = _1464744612_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1464744612_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IColorPickerSliderStatics_Impl(
    ...
    public override val __1464744612_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IColorPickerSliderStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("82f72b75e986587f97018ac6801da932")
    ...
    public override fun toNative(obj: IColorPickerSliderStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1464744612_Ptr))
  }
