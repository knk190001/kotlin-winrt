...
@Signature("{e8643304-6db4-5af5-bac2-62733ca037da}")
@Guid("e86433046db45af5bac262733ca037da")
@WinRTInterface("e86433046db45af5bac262733ca037da")
...
public interface INavigationViewPaneClosingEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : INavigationViewPaneClosingEventArgs {
    public val __111896938_Ptr: Pointer?

    public val _111896938_VtblPtr: Pointer?
      get() = __111896938_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Cancel(): Boolean {
      val fnPtr = _111896938_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__111896938_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Cancel(value: Boolean): Unit {
      val fnPtr = _111896938_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__111896938_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class INavigationViewPaneClosingEventArgs_Impl(
    ...
    public override val __111896938_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<INavigationViewPaneClosingEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("e86433046db45af5bac262733ca037da")
    ...
    public override fun toNative(obj: INavigationViewPaneClosingEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__111896938_Ptr))
  }
