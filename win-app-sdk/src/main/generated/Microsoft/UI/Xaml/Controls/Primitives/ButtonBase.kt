...
import Microsoft.UI.Xaml.Controls.Primitives.IButtonBaseFactory.ABI.IID
...
@Signature("rc(Microsoft.UI.Xaml.Controls.Primitives.ButtonBase;{65714269-2473-5327-a652-0ea6bce7f403})")
...
public open class ButtonBase(
  ...
  private val __205289524_Interface: IButtonBase.WithDefault by lazy {
    as_205289524()
  }


  public override val __205289524_Ptr: JNAPointer? by lazy {
    __205289524_Interface.__205289524_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__205289524_Interface)

  public constructor() : this(ABI.activate())

  private fun as_205289524(): IButtonBase.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<ButtonBase, MemoryAddress> {
    ...
    public fun createIButtonBaseStatics(): IButtonBaseStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.Primitives.ButtonBase".toHandle(),refiid,interfacePtr)
    ...
    public fun createIButtonBaseFactory(): IButtonBaseFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.Primitives.ButtonBase".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
