...
@Signature("{9b84e681-1ab6-5485-88b2-d0d3c05b29f3}")
@Guid("9b84e6811ab6548588b2d0d3c05b29f3")
@WinRTInterface("9b84e6811ab6548588b2d0d3c05b29f3")
...
public interface IContentDialogClosedEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IContentDialogClosedEventArgs {
    public val __1055273585_Ptr: Pointer?

    public val _1055273585_VtblPtr: Pointer?
      get() = __1055273585_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Result(): ContentDialogResult? {
      val fnPtr = _1055273585_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ContentDialogResult>()
      val hr = fn.invokeHR(arrayOf(__1055273585_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IContentDialogClosedEventArgs_Impl(
    ...
    public override val __1055273585_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IContentDialogClosedEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("9b84e6811ab6548588b2d0d3c05b29f3")
    ...
    public override fun toNative(obj: IContentDialogClosedEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1055273585_Ptr))
  }
