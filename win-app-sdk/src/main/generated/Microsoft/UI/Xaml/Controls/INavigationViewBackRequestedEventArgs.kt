...
@Signature("{ae752207-bd1b-5afa-a872-e9bbaeea0ede}")
@Guid("ae752207bd1b5afaa872e9bbaeea0ede")
@WinRTInterface("ae752207bd1b5afaa872e9bbaeea0ede")
...
public interface INavigationViewBackRequestedEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : INavigationViewBackRequestedEventArgs {
    public val __827272336_Ptr: Pointer?

    public val _827272336_VtblPtr: Pointer?
      get() = __827272336_Ptr?.getPointer(0)
  }

  public class INavigationViewBackRequestedEventArgs_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __827272336_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<INavigationViewBackRequestedEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("ae752207bd1b5afaa872e9bbaeea0ede")
    ...
    public override fun toNative(obj: INavigationViewBackRequestedEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__827272336_Ptr))
  }
