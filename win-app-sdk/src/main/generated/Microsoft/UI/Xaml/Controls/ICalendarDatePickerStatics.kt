...
@Signature("{e74eb740-1aeb-591f-b84a-ef881c3b527e}")
@Guid("e74eb7401aeb591fb84aef881c3b527e")
@WinRTInterface("e74eb7401aeb591fb84aef881c3b527e")
...
public interface ICalendarDatePickerStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICalendarDatePickerStatics {
    public val __1899034308_Ptr: Pointer?

    public val _1899034308_VtblPtr: Pointer?
      get() = __1899034308_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_DateProperty(): DependencyProperty? {
      val fnPtr = _1899034308_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1899034308_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsCalendarOpenProperty(): DependencyProperty? {
      val fnPtr = _1899034308_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1899034308_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_DateFormatProperty(): DependencyProperty? {
      val fnPtr = _1899034308_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1899034308_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_PlaceholderTextProperty(): DependencyProperty? {
      val fnPtr = _1899034308_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1899034308_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_HeaderProperty(): DependencyProperty? {
      val fnPtr = _1899034308_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1899034308_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_HeaderTemplateProperty(): DependencyProperty? {
      val fnPtr = _1899034308_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1899034308_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_CalendarViewStyleProperty(): DependencyProperty? {
      val fnPtr = _1899034308_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1899034308_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_LightDismissOverlayModeProperty(): DependencyProperty? {
      val fnPtr = _1899034308_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1899034308_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_DescriptionProperty(): DependencyProperty? {
      val fnPtr = _1899034308_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1899034308_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_MinDateProperty(): DependencyProperty? {
      val fnPtr = _1899034308_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1899034308_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_MaxDateProperty(): DependencyProperty? {
      val fnPtr = _1899034308_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1899034308_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsTodayHighlightedProperty(): DependencyProperty? {
      val fnPtr = _1899034308_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1899034308_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_DisplayModeProperty(): DependencyProperty? {
      val fnPtr = _1899034308_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1899034308_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_FirstDayOfWeekProperty(): DependencyProperty? {
      val fnPtr = _1899034308_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1899034308_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_DayOfWeekFormatProperty(): DependencyProperty? {
      val fnPtr = _1899034308_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1899034308_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_CalendarIdentifierProperty(): DependencyProperty? {
      val fnPtr = _1899034308_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1899034308_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsOutOfScopeEnabledProperty(): DependencyProperty? {
      val fnPtr = _1899034308_VtblPtr!!.getPointer(22L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1899034308_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsGroupLabelVisibleProperty(): DependencyProperty? {
      val fnPtr = _1899034308_VtblPtr!!.getPointer(23L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1899034308_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ICalendarDatePickerStatics_Impl(
    ...
    public override val __1899034308_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICalendarDatePickerStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("e74eb7401aeb591fb84aef881c3b527e")
    ...
    public override fun toNative(obj: ICalendarDatePickerStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1899034308_Ptr))
  }
