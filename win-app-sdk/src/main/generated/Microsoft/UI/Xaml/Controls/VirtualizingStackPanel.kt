...
@Signature("rc(Microsoft.UI.Xaml.Controls.VirtualizingStackPanel;{7d6103dc-2427-5576-9a69-bf53e2d7180b})")
...
public class VirtualizingStackPanel(
  ...
  private val __1218941033_Interface: IVirtualizingStackPanel.WithDefault by lazy {
    as_1218941033()
  }


  private val __1337480126_Interface: IVirtualizingStackPanelOverrides.WithDefault by lazy {
    as_1337480126()
  }


  public override val __1218941033_Ptr: JNAPointer? by lazy {
    __1218941033_Interface.__1218941033_Ptr
  }


  public override val __1337480126_Ptr: JNAPointer? by lazy {
    __1337480126_Interface.__1337480126_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1218941033_Interface, __1337480126_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1218941033(): IVirtualizingStackPanel.WithDefault {
    if(pointer == NULL) {
  ...
  private fun as_1337480126(): IVirtualizingStackPanelOverrides.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<VirtualizingStackPanel, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.VirtualizingStackPanel".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIVirtualizingStackPanelStatics(): IVirtualizingStackPanelStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.VirtualizingStackPanel".toHandle(),refiid,interfacePtr)
      val result =
