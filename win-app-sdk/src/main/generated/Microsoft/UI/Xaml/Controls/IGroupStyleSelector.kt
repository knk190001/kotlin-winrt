...
@Signature("{524f5086-3e02-5b71-be7c-8a8fa0feaa2c}")
@Guid("524f50863e025b71be7c8a8fa0feaa2c")
@WinRTInterface("524f50863e025b71be7c8a8fa0feaa2c")
...
public interface IGroupStyleSelector : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IGroupStyleSelector {
    public val __2146124168_Ptr: Pointer?

    public val _2146124168_VtblPtr: Pointer?
      get() = __2146124168_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun SelectGroupStyle(group: IUnknown?, level: WinDef.UINT): GroupStyle? {
      val fnPtr = _2146124168_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<GroupStyle>()
      val hr = fn.invokeHR(arrayOf(__2146124168_Ptr, marshalToNative(group), level, result))
      if (hr.toInt() != 0) {
  ...
  public class IGroupStyleSelector_Impl(
    ...
    public override val __2146124168_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IGroupStyleSelector, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("524f50863e025b71be7c8a8fa0feaa2c")
    ...
    public override fun toNative(obj: IGroupStyleSelector): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2146124168_Ptr))
  }
