...
@Signature("{1d1a66e3-f56d-5d7f-942c-f3a87f5c552e}")
@Guid("1d1a66e3f56d5d7f942cf3a87f5c552e")
@WinRTInterface("1d1a66e3f56d5d7f942cf3a87f5c552e")
...
public interface ITreeViewItemTemplateSettingsFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITreeViewItemTemplateSettingsFactory {
    public val __1098968464_Ptr: Pointer?

    public val _1098968464_VtblPtr: Pointer?
      get() = __1098968464_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        TreeViewItemTemplateSettings? {
      val fnPtr = _1098968464_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<TreeViewItemTemplateSettings>()
      val hr = fn.invokeHR(arrayOf(__1098968464_Ptr, marshalToNative(baseInterface),
  ...
  public class ITreeViewItemTemplateSettingsFactory_Impl(
    ...
    public override val __1098968464_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITreeViewItemTemplateSettingsFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("1d1a66e3f56d5d7f942cf3a87f5c552e")
    ...
    public override fun toNative(obj: ITreeViewItemTemplateSettingsFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1098968464_Ptr))
  }
