...
@Signature("{6cab1e15-c017-5760-828b-dafc21d54eb2}")
@Guid("6cab1e15c0175760828bdafc21d54eb2")
@WinRTInterface("6cab1e15c0175760828bdafc21d54eb2")
...
public interface IToggleSplitButtonIsCheckedChangedEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IToggleSplitButtonIsCheckedChangedEventArgs {
    public val __1753125777_Ptr: Pointer?

    public val _1753125777_VtblPtr: Pointer?
      get() = __1753125777_Ptr?.getPointer(0)
  }

  public class IToggleSplitButtonIsCheckedChangedEventArgs_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __1753125777_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IToggleSplitButtonIsCheckedChangedEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("6cab1e15c0175760828bdafc21d54eb2")
    ...
    public override fun toNative(obj: IToggleSplitButtonIsCheckedChangedEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1753125777_Ptr))
  }
