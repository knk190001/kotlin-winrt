...
@Signature("{c85f1443-d973-50fd-9497-b867f492468f}")
@Guid("c85f1443d97350fd9497b867f492468f")
@WinRTInterface("c85f1443d97350fd9497b867f492468f")
...
public interface IRelativePanelFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IRelativePanelFactory {
    public val __1113117593_Ptr: Pointer?

    public val _1113117593_VtblPtr: Pointer?
      get() = __1113117593_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        RelativePanel? {
      val fnPtr = _1113117593_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<RelativePanel>()
      val hr = fn.invokeHR(arrayOf(__1113117593_Ptr, marshalToNative(baseInterface),
  ...
  public class IRelativePanelFactory_Impl(
    ...
    public override val __1113117593_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IRelativePanelFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("c85f1443d97350fd9497b867f492468f")
    ...
    public override fun toNative(obj: IRelativePanelFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1113117593_Ptr))
  }
