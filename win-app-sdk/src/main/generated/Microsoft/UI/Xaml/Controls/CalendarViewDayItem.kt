...
import Microsoft.UI.Xaml.Controls.ICalendarViewDayItemFactory.ABI.IID
...
@Signature("rc(Microsoft.UI.Xaml.Controls.CalendarViewDayItem;{947d3a07-6fa4-553c-9b12-57ca1bf72e9e})")
...
public open class CalendarViewDayItem(
  ...
  private val __200662821_Interface: ICalendarViewDayItem.WithDefault by lazy {
    as_200662821()
  }


  public override val __200662821_Ptr: JNAPointer? by lazy {
    __200662821_Interface.__200662821_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__200662821_Interface)

  public constructor() : this(ABI.activate())

  private fun as_200662821(): ICalendarViewDayItem.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<CalendarViewDayItem, MemoryAddress> {
    ...
    public fun createICalendarViewDayItemStatics(): ICalendarViewDayItemStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.CalendarViewDayItem".toHandle(),refiid,interfacePtr)
      val result =
    ...
    public fun createICalendarViewDayItemFactory(): ICalendarViewDayItemFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.CalendarViewDayItem".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
