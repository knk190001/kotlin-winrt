...
@Signature("{298d3800-e5c9-5003-b84c-a6538866e2d5}")
@Guid("298d3800e5c95003b84ca6538866e2d5")
@WinRTInterface("298d3800e5c95003b84ca6538866e2d5")
...
public interface ICarouselPanel : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICarouselPanel {
    public val __597962707_Ptr: Pointer?

    public val _597962707_VtblPtr: Pointer?
      get() = __597962707_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_CanVerticallyScroll(): Boolean {
      val fnPtr = _597962707_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__597962707_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_CanVerticallyScroll(value: Boolean): Unit {
      val fnPtr = _597962707_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__597962707_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_CanHorizontallyScroll(): Boolean {
      val fnPtr = _597962707_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__597962707_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_CanHorizontallyScroll(value: Boolean): Unit {
      val fnPtr = _597962707_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__597962707_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ExtentWidth(): Double {
      val fnPtr = _597962707_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_ExtentHeight(): Double {
      val fnPtr = _597962707_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__597962707_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ViewportWidth(): Double {
      val fnPtr = _597962707_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__597962707_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ViewportHeight(): Double {
      val fnPtr = _597962707_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__597962707_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_HorizontalOffset(): Double {
      val fnPtr = _597962707_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__597962707_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_VerticalOffset(): Double {
      val fnPtr = _597962707_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__597962707_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ScrollOwner(): IUnknown? {
      val fnPtr = _597962707_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_ScrollOwner(value: IUnknown?): Unit {
      val fnPtr = _597962707_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__597962707_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun LineUp(): Unit {
      val fnPtr = _597962707_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__597962707_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun LineDown(): Unit {
      val fnPtr = _597962707_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__597962707_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun LineLeft(): Unit {
      val fnPtr = _597962707_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__597962707_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun LineRight(): Unit {
      val fnPtr = _597962707_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__597962707_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun PageUp(): Unit {
      val fnPtr = _597962707_VtblPtr!!.getPointer(22L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__597962707_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun PageDown(): Unit {
      val fnPtr = _597962707_VtblPtr!!.getPointer(23L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__597962707_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun PageLeft(): Unit {
      val fnPtr = _597962707_VtblPtr!!.getPointer(24L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__597962707_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun PageRight(): Unit {
      val fnPtr = _597962707_VtblPtr!!.getPointer(25L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__597962707_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun MouseWheelUp(): Unit {
      val fnPtr = _597962707_VtblPtr!!.getPointer(26L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__597962707_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun MouseWheelDown(): Unit {
      val fnPtr = _597962707_VtblPtr!!.getPointer(27L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__597962707_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun MouseWheelLeft(): Unit {
      val fnPtr = _597962707_VtblPtr!!.getPointer(28L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__597962707_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun MouseWheelRight(): Unit {
      val fnPtr = _597962707_VtblPtr!!.getPointer(29L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__597962707_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun SetHorizontalOffset(offset: Double): Unit {
      val fnPtr = _597962707_VtblPtr!!.getPointer(30L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__597962707_Ptr, offset,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun SetVerticalOffset(offset: Double): Unit {
      val fnPtr = _597962707_VtblPtr!!.getPointer(31L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__597962707_Ptr, offset,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun MakeVisible(visual: UIElement?, rectangle: Rect?): Rect? {
      val fnPtr = _597962707_VtblPtr!!.getPointer(32L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Rect>()
      val hr = fn.invokeHR(arrayOf(__597962707_Ptr, marshalToNative(visual),
  ...
  public class ICarouselPanel_Impl(
    ...
    public override val __597962707_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICarouselPanel, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("298d3800e5c95003b84ca6538866e2d5")
    ...
    public override fun toNative(obj: ICarouselPanel): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__597962707_Ptr))
  }
