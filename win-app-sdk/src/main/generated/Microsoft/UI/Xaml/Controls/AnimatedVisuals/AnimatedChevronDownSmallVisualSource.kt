...
@ABIMarker(AnimatedChevronDownSmallVisualSource.ABI::class)
@Signature("rc(Microsoft.UI.Xaml.Controls.AnimatedVisuals.AnimatedChevronDownSmallVisualSource;{294765c3-70e3-555c-9657-01fc4051169d})")
@WinRTByReference(brClass = AnimatedChevronDownSmallVisualSource.ByReference::class)
public class AnimatedChevronDownSmallVisualSource(
  ptr: JNAPointer? = NULL
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<AnimatedChevronDownSmallVisualSource> {
    public override fun getValue() = AnimatedChevronDownSmallVisualSource(pointer.getPointer(0))

    public fun setValue(value: AnimatedChevronDownSmallVisualSource): Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  public object ABI : IABI<AnimatedChevronDownSmallVisualSource, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.AnimatedVisuals.AnimatedChevronDownSmallVisualSource".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public override fun fromNative(segment: MemoryAddress): AnimatedChevronDownSmallVisualSource {
      val address = segment.toRawLongValue()
      return AnimatedChevronDownSmallVisualSource(Pointer(address))
    }

    public override fun toNative(obj: AnimatedChevronDownSmallVisualSource): MemoryAddress =
