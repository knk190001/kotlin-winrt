...
@Signature("{fb216c88-c1b1-56ac-a5dd-67064d1e47bc}")
@Guid("fb216c88c1b156aca5dd67064d1e47bc")
@WinRTInterface("fb216c88c1b156aca5dd67064d1e47bc")
...
public interface ISwipeControlStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISwipeControlStatics {
    public val __963742629_Ptr: Pointer?

    public val _963742629_VtblPtr: Pointer?
      get() = __963742629_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_LeftItemsProperty(): DependencyProperty? {
      val fnPtr = _963742629_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__963742629_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_RightItemsProperty(): DependencyProperty? {
      val fnPtr = _963742629_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__963742629_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_TopItemsProperty(): DependencyProperty? {
      val fnPtr = _963742629_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__963742629_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_BottomItemsProperty(): DependencyProperty? {
      val fnPtr = _963742629_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__963742629_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ISwipeControlStatics_Impl(
    ...
    public override val __963742629_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISwipeControlStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("fb216c88c1b156aca5dd67064d1e47bc")
    ...
    public override fun toNative(obj: ISwipeControlStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__963742629_Ptr))
  }
