...
@Signature("{b0154a37-07c1-50ed-834c-32d3fbda5c5f}")
@Guid("b0154a3707c150ed834c32d3fbda5c5f")
@WinRTInterface("b0154a3707c150ed834c32d3fbda5c5f")
...
public interface IListPickerFlyout : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IListPickerFlyout {
    public val __454089810_Ptr: Pointer?

    public val _454089810_VtblPtr: Pointer?
      get() = __454089810_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ItemsSource(): IUnknown? {
      val fnPtr = _454089810_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IUnknown>()
      val hr = fn.invokeHR(arrayOf(__454089810_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ItemsSource(value: IUnknown?): Unit {
      val fnPtr = _454089810_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__454089810_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_ItemTemplate(): DataTemplate? {
      val fnPtr = _454089810_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_ItemTemplate(value: DataTemplate?): Unit {
      val fnPtr = _454089810_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__454089810_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_DisplayMemberPath(): String? {
      val fnPtr = _454089810_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_DisplayMemberPath(value: String?): Unit {
      val fnPtr = _454089810_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__454089810_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_SelectionMode(): ListPickerFlyoutSelectionMode? {
      val fnPtr = _454089810_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_SelectionMode(value: ListPickerFlyoutSelectionMode?): Unit {
      val fnPtr = _454089810_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__454089810_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_SelectedIndex(): Int {
      val fnPtr = _454089810_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_SelectedIndex(value: Int): Unit {
      val fnPtr = _454089810_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__454089810_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_SelectedItem(): IUnknown? {
      val fnPtr = _454089810_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IUnknown>()
      val hr = fn.invokeHR(arrayOf(__454089810_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_SelectedItem(value: IUnknown?): Unit {
      val fnPtr = _454089810_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__454089810_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_SelectedValue(): IUnknown? {
      val fnPtr = _454089810_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IUnknown>()
      val hr = fn.invokeHR(arrayOf(__454089810_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_SelectedValue(value: IUnknown?): Unit {
      val fnPtr = _454089810_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__454089810_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_SelectedValuePath(): String? {
      val fnPtr = _454089810_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__454089810_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_SelectedValuePath(value: String?): Unit {
      val fnPtr = _454089810_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__454089810_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_SelectedItems(): IVector<IUnknown?>? {
      val fnPtr = _454089810_VtblPtr!!.getPointer(22L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun add_ItemsPicked(handler: TypedEventHandler<ListPickerFlyout?,
      ...
      val fnPtr = _454089810_VtblPtr!!.getPointer(23L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__454089810_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun remove_ItemsPicked(token: EventRegistrationToken?): Unit {
      val fnPtr = _454089810_VtblPtr!!.getPointer(24L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__454089810_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun ShowAtAsync(target: FrameworkElement?):
      ...
      val fnPtr = _454089810_VtblPtr!!.getPointer(25L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IAsyncOperation<IVectorView<IUnknown?>?>>()
      val hr = fn.invokeHR(arrayOf(__454089810_Ptr, marshalToNative(target), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
      val resultValue =
  ...
  public class IListPickerFlyout_Impl(
    ...
    public override val __454089810_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IListPickerFlyout, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("b0154a3707c150ed834c32d3fbda5c5f")
    ...
    public override fun toNative(obj: IListPickerFlyout): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__454089810_Ptr))
  }
