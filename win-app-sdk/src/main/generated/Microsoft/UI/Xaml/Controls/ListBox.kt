...
import Microsoft.UI.Xaml.Controls.IListBoxFactory.ABI.IID
...
@Signature("rc(Microsoft.UI.Xaml.Controls.ListBox;{f3e7dedf-7a3c-59f1-9e05-ae5026b54293})")
@WinRTByReference(brClass = ListBox.ByReference::class)
public open class ListBox(
  ptr: JNAPointer? = NULL
) : Selector(ptr), IListBox.WithDefault, IWinRTObject {
  private val __1767269210_Interface: IListBox.WithDefault by lazy {
    as_1767269210()
  }


  public override val __1767269210_Ptr: JNAPointer? by lazy {
    __1767269210_Interface.__1767269210_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1767269210_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1767269210(): IListBox.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<ListBox, MemoryAddress> {
    ...
    public fun createIListBoxStatics(): IListBoxStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.ListBox".toHandle(),refiid,interfacePtr)
    ...
    public fun createIListBoxFactory(): IListBoxFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.ListBox".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
  ...
  public companion object {
    ...
    public fun get_SingleSelectionFollowsFocusProperty() =
        ABI.IListBoxStatics_Instance.get_SingleSelectionFollowsFocusProperty()
  }
}
