...
@Signature("rc(Microsoft.UI.Xaml.Controls.ScrollViewerViewChangingEventArgs;{aee37d7c-4696-55f1-96ca-656832fc0fd2})")
...
public class ScrollViewerViewChangingEventArgs(
  ...
  private val __432303713_Interface: IScrollViewerViewChangingEventArgs.WithDefault by lazy {
    as_432303713()
  }


  public override val __432303713_Ptr: JNAPointer? by lazy {
    __432303713_Interface.__432303713_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__432303713_Interface)

  private fun as_432303713(): IScrollViewerViewChangingEventArgs.WithDefault {
    if(pointer == NULL) {
