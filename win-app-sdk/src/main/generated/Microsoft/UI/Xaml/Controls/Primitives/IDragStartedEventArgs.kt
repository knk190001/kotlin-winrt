...
@Signature("{aa27aee4-2bdd-5d9a-8a1c-b37480a2012b}")
@Guid("aa27aee42bdd5d9a8a1cb37480a2012b")
@WinRTInterface("aa27aee42bdd5d9a8a1cb37480a2012b")
...
public interface IDragStartedEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IDragStartedEventArgs {
    public val __1481301445_Ptr: Pointer?

    public val _1481301445_VtblPtr: Pointer?
      get() = __1481301445_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_HorizontalOffset(): Double {
      val fnPtr = _1481301445_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1481301445_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_VerticalOffset(): Double {
      val fnPtr = _1481301445_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1481301445_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IDragStartedEventArgs_Impl(
    ...
    public override val __1481301445_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IDragStartedEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("aa27aee42bdd5d9a8a1cb37480a2012b")
    ...
    public override fun toNative(obj: IDragStartedEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1481301445_Ptr))
  }
