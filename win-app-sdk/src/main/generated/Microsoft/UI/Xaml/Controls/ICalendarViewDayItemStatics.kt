...
@Signature("{2b2c4006-57fa-5f0f-b8ed-26e21f910e3a}")
@Guid("2b2c400657fa5f0fb8ed26e21f910e3a")
@WinRTInterface("2b2c400657fa5f0fb8ed26e21f910e3a")
...
public interface ICalendarViewDayItemStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICalendarViewDayItemStatics {
    public val __1573825312_Ptr: Pointer?

    public val _1573825312_VtblPtr: Pointer?
      get() = __1573825312_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_IsBlackoutProperty(): DependencyProperty? {
      val fnPtr = _1573825312_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1573825312_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_DateProperty(): DependencyProperty? {
      val fnPtr = _1573825312_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1573825312_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ICalendarViewDayItemStatics_Impl(
    ...
    public override val __1573825312_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICalendarViewDayItemStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("2b2c400657fa5f0fb8ed26e21f910e3a")
    ...
    public override fun toNative(obj: ICalendarViewDayItemStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1573825312_Ptr))
  }
