...
@Signature("{a412ae4f-c3bc-5679-8d5f-865eb97e83cd}")
@Guid("a412ae4fc3bc56798d5f865eb97e83cd")
@WinRTInterface("a412ae4fc3bc56798d5f865eb97e83cd")
...
public interface IMenuBarItemFlyout : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IMenuBarItemFlyout {
    public val __638207653_Ptr: Pointer?

    public val _638207653_VtblPtr: Pointer?
      get() = __638207653_Ptr?.getPointer(0)
  }

  public class IMenuBarItemFlyout_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __638207653_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IMenuBarItemFlyout, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("a412ae4fc3bc56798d5f865eb97e83cd")
    ...
    public override fun toNative(obj: IMenuBarItemFlyout): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__638207653_Ptr))
  }
