...
import Microsoft.UI.Xaml.Controls.IStyleSelectorFactory.ABI.IID
...
@Signature("rc(Microsoft.UI.Xaml.Controls.StyleSelector;{7f9cf759-785b-5ef9-9ea7-1555673a475a})")
...
public open class StyleSelector(
  ptr: JNAPointer? = NULL
    ...
    {
  private val __1011106377_Interface: IStyleSelector.WithDefault by lazy {
    as_1011106377()
  }


  private val __857062878_Interface: IStyleSelectorOverrides.WithDefault by lazy {
    as_857062878()
  }


  public override val __1011106377_Ptr: JNAPointer? by lazy {
    __1011106377_Interface.__1011106377_Ptr
  }


  public override val __857062878_Ptr: JNAPointer? by lazy {
    __857062878_Interface.__857062878_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1011106377_Interface, __857062878_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1011106377(): IStyleSelector.WithDefault {
    if(pointer == NULL) {
  ...
  private fun as_857062878(): IStyleSelectorOverrides.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<StyleSelector, MemoryAddress> {
    ...
    public fun createIStyleSelectorFactory(): IStyleSelectorFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.StyleSelector".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
