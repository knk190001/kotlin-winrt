...
@Signature("{0f1af0cd-f3dc-52f6-b632-396742533231}")
@Guid("0f1af0cdf3dc52f6b632396742533231")
@WinRTInterface("0f1af0cdf3dc52f6b632396742533231")
...
public interface ITwoPaneViewFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITwoPaneViewFactory {
    public val __1934683192_Ptr: Pointer?

    public val _1934683192_VtblPtr: Pointer?
      get() = __1934683192_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        TwoPaneView? {
      val fnPtr = _1934683192_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<TwoPaneView>()
      val hr = fn.invokeHR(arrayOf(__1934683192_Ptr, marshalToNative(baseInterface),
  ...
  public class ITwoPaneViewFactory_Impl(
    ...
    public override val __1934683192_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITwoPaneViewFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("0f1af0cdf3dc52f6b632396742533231")
    ...
    public override fun toNative(obj: ITwoPaneViewFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1934683192_Ptr))
  }
