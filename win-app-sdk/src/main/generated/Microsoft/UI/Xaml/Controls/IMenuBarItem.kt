...
@Signature("{a7900980-51cc-531d-97c5-356b13573398}")
@Guid("a790098051cc531d97c5356b13573398")
@WinRTInterface("a790098051cc531d97c5356b13573398")
...
public interface IMenuBarItem : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IMenuBarItem {
    public val __405580992_Ptr: Pointer?

    public val _405580992_VtblPtr: Pointer?
      get() = __405580992_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Title(): String? {
      val fnPtr = _405580992_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__405580992_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Title(value: String?): Unit {
      val fnPtr = _405580992_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__405580992_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Items(): IVector<MenuFlyoutItemBase?>? {
      val fnPtr = _405580992_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class IMenuBarItem_Impl(
    ...
    public override val __405580992_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IMenuBarItem, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("a790098051cc531d97c5356b13573398")
    ...
    public override fun toNative(obj: IMenuBarItem): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__405580992_Ptr))
  }
