...
@Signature("{bae6261c-362f-5342-ba26-5f6990ef726c}")
@Guid("bae6261c362f5342ba265f6990ef726c")
@WinRTInterface("bae6261c362f5342ba265f6990ef726c")
...
public interface IContentDialogButtonClickEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IContentDialogButtonClickEventArgs {
    public val __1821892197_Ptr: Pointer?

    public val _1821892197_VtblPtr: Pointer?
      get() = __1821892197_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Cancel(): Boolean {
      val fnPtr = _1821892197_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1821892197_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Cancel(value: Boolean): Unit {
      val fnPtr = _1821892197_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1821892197_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun GetDeferral(): ContentDialogButtonClickDeferral? {
      val fnPtr = _1821892197_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class IContentDialogButtonClickEventArgs_Impl(
    ...
    public override val __1821892197_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IContentDialogButtonClickEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("bae6261c362f5342ba265f6990ef726c")
    ...
    public override fun toNative(obj: IContentDialogButtonClickEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1821892197_Ptr))
  }
