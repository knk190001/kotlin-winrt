...
@Signature("{7b98953f-c24a-53c6-8a3a-520558508b08}")
@Guid("7b98953fc24a53c68a3a520558508b08")
@WinRTInterface("7b98953fc24a53c68a3a520558508b08")
...
public interface ITimePickerValueChangedEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITimePickerValueChangedEventArgs {
    public val __1412466638_Ptr: Pointer?

    public val _1412466638_VtblPtr: Pointer?
      get() = __1412466638_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_OldTime(): TimeSpan? {
      val fnPtr = _1412466638_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<TimeSpan>()
      val hr = fn.invokeHR(arrayOf(__1412466638_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_NewTime(): TimeSpan? {
      val fnPtr = _1412466638_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<TimeSpan>()
      val hr = fn.invokeHR(arrayOf(__1412466638_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ITimePickerValueChangedEventArgs_Impl(
    ...
    public override val __1412466638_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITimePickerValueChangedEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("7b98953fc24a53c68a3a520558508b08")
    ...
    public override fun toNative(obj: ITimePickerValueChangedEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1412466638_Ptr))
  }
