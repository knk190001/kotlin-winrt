...
@Signature("{8e9e0e6d-4597-5efa-94bc-7ffadc264c28}")
@Guid("8e9e0e6d45975efa94bc7ffadc264c28")
@WinRTInterface("8e9e0e6d45975efa94bc7ffadc264c28")
...
public interface IListBoxItemFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IListBoxItemFactory {
    public val __372247025_Ptr: Pointer?

    public val _372247025_VtblPtr: Pointer?
      get() = __372247025_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        ListBoxItem? {
      val fnPtr = _372247025_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ListBoxItem>()
      val hr = fn.invokeHR(arrayOf(__372247025_Ptr, marshalToNative(baseInterface),
  ...
  public class IListBoxItemFactory_Impl(
    ...
    public override val __372247025_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IListBoxItemFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("8e9e0e6d45975efa94bc7ffadc264c28")
    ...
    public override fun toNative(obj: IListBoxItemFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__372247025_Ptr))
  }
