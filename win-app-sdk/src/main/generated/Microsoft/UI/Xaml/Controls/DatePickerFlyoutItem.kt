...
@Signature("rc(Microsoft.UI.Xaml.Controls.DatePickerFlyoutItem;{eb7d591e-1314-5409-9231-5b8e3be187a7})")
...
public class DatePickerFlyoutItem(
  ptr: JNAPointer? = NULL
    ...
    IWinRTObject {
  private val __748202737_Interface: IDatePickerFlyoutItem.WithDefault by lazy {
    as_748202737()
  }


  private val __417951114_Interface: ICustomPropertyProvider.WithDefault by lazy {
    as_417951114()
  }


  public override val __748202737_Ptr: JNAPointer? by lazy {
    __748202737_Interface.__748202737_Ptr
  }


  public override val __417951114_Ptr: JNAPointer? by lazy {
    __417951114_Interface.__417951114_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__748202737_Interface, __417951114_Interface)

  private fun as_748202737(): IDatePickerFlyoutItem.WithDefault {
    if(pointer == NULL) {
  ...
  private fun as_417951114(): ICustomPropertyProvider.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<DatePickerFlyoutItem, MemoryAddress> {
    ...
    public fun createIDatePickerFlyoutItemStatics(): IDatePickerFlyoutItemStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.DatePickerFlyoutItem".toHandle(),refiid,interfacePtr)
      val result =
