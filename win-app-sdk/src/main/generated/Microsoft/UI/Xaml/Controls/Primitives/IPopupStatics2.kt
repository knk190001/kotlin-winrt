...
@Signature("{79b3285a-1330-5cfd-af2f-88efa00770a9}")
@Guid("79b3285a13305cfdaf2f88efa00770a9")
@WinRTInterface("79b3285a13305cfdaf2f88efa00770a9")
...
public interface IPopupStatics2 : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPopupStatics2 {
    public val __1663892776_Ptr: Pointer?

    public val _1663892776_VtblPtr: Pointer?
      get() = __1663892776_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_PlacementTargetProperty(): DependencyProperty? {
      val fnPtr = _1663892776_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1663892776_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_DesiredPlacementProperty(): DependencyProperty? {
      val fnPtr = _1663892776_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1663892776_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IPopupStatics2_Impl(
    ...
    public override val __1663892776_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPopupStatics2, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("79b3285a13305cfdaf2f88efa00770a9")
    ...
    public override fun toNative(obj: IPopupStatics2): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1663892776_Ptr))
  }
