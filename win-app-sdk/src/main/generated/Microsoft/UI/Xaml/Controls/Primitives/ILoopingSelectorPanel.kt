...
@Signature("{7479c3a4-c5b1-5112-bea9-beef5cc79f57}")
@Guid("7479c3a4c5b15112bea9beef5cc79f57")
@WinRTInterface("7479c3a4c5b15112bea9beef5cc79f57")
...
public interface ILoopingSelectorPanel : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ILoopingSelectorPanel {
    public val __71660264_Ptr: Pointer?

    public val _71660264_VtblPtr: Pointer?
      get() = __71660264_Ptr?.getPointer(0)
  }

  public class ILoopingSelectorPanel_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __71660264_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ILoopingSelectorPanel, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("7479c3a4c5b15112bea9beef5cc79f57")
    ...
    public override fun toNative(obj: ILoopingSelectorPanel): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__71660264_Ptr))
  }
