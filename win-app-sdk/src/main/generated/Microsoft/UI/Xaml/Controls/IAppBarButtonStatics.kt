...
@Signature("{74327a2a-18fa-59c3-8268-ec3732a4d272}")
@Guid("74327a2a18fa59c38268ec3732a4d272")
@WinRTInterface("74327a2a18fa59c38268ec3732a4d272")
...
public interface IAppBarButtonStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IAppBarButtonStatics {
    public val __1367830022_Ptr: Pointer?

    public val _1367830022_VtblPtr: Pointer?
      get() = __1367830022_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_LabelProperty(): DependencyProperty? {
      val fnPtr = _1367830022_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1367830022_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IconProperty(): DependencyProperty? {
      val fnPtr = _1367830022_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1367830022_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_LabelPositionProperty(): DependencyProperty? {
      val fnPtr = _1367830022_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1367830022_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_KeyboardAcceleratorTextOverrideProperty(): DependencyProperty? {
      val fnPtr = _1367830022_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1367830022_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsCompactProperty(): DependencyProperty? {
      val fnPtr = _1367830022_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1367830022_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsInOverflowProperty(): DependencyProperty? {
      val fnPtr = _1367830022_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1367830022_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_DynamicOverflowOrderProperty(): DependencyProperty? {
      val fnPtr = _1367830022_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1367830022_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IAppBarButtonStatics_Impl(
    ...
    public override val __1367830022_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IAppBarButtonStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("74327a2a18fa59c38268ec3732a4d272")
    ...
    public override fun toNative(obj: IAppBarButtonStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1367830022_Ptr))
  }
