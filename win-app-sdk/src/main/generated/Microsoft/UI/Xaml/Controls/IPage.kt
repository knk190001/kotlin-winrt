...
import Microsoft.UI.Xaml.Navigation.NavigationCacheMode
...
@Signature("{eb42988e-6cb5-5dd6-9e59-4c04e5caec6d}")
@Guid("eb42988e6cb55dd69e594c04e5caec6d")
@WinRTInterface("eb42988e6cb55dd69e594c04e5caec6d")
...
public interface IPage : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPage {
    public val __1874982102_Ptr: Pointer?

    public val _1874982102_VtblPtr: Pointer?
      get() = __1874982102_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Frame(): Frame? {
      val fnPtr = _1874982102_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Frame>()
      val hr = fn.invokeHR(arrayOf(__1874982102_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_NavigationCacheMode(): NavigationCacheMode? {
      val fnPtr = _1874982102_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_NavigationCacheMode(value: NavigationCacheMode?): Unit {
      val fnPtr = _1874982102_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1874982102_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_TopAppBar(): AppBar? {
      val fnPtr = _1874982102_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_TopAppBar(value: AppBar?): Unit {
      val fnPtr = _1874982102_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1874982102_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_BottomAppBar(): AppBar? {
      val fnPtr = _1874982102_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AppBar>()
      val hr = fn.invokeHR(arrayOf(__1874982102_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_BottomAppBar(value: AppBar?): Unit {
      val fnPtr = _1874982102_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1874982102_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IPage_Impl(
    ...
    public override val __1874982102_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPage, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("eb42988e6cb55dd69e594c04e5caec6d")
    ...
    public override fun toNative(obj: IPage): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1874982102_Ptr))
  }
