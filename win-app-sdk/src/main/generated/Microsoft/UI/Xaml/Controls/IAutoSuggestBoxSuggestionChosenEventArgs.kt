...
@Signature("{7547c7e9-7429-5045-ad98-338a96b270b1}")
@Guid("7547c7e974295045ad98338a96b270b1")
@WinRTInterface("7547c7e974295045ad98338a96b270b1")
...
public interface IAutoSuggestBoxSuggestionChosenEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IAutoSuggestBoxSuggestionChosenEventArgs {
    public val __1507787492_Ptr: Pointer?

    public val _1507787492_VtblPtr: Pointer?
      get() = __1507787492_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_SelectedItem(): IUnknown? {
      val fnPtr = _1507787492_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IUnknown>()
      val hr = fn.invokeHR(arrayOf(__1507787492_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IAutoSuggestBoxSuggestionChosenEventArgs_Impl(
    ...
    public override val __1507787492_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IAutoSuggestBoxSuggestionChosenEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("7547c7e974295045ad98338a96b270b1")
    ...
    public override fun toNative(obj: IAutoSuggestBoxSuggestionChosenEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1507787492_Ptr))
  }
