...
import Microsoft.UI.Xaml.Controls.IRelativePanelFactory.ABI.IID
...
@Signature("rc(Microsoft.UI.Xaml.Controls.RelativePanel;{c432fcc4-88f2-59d8-9d0e-a237beaeb07f})")
@WinRTByReference(brClass = RelativePanel.ByReference::class)
public open class RelativePanel(
  ptr: JNAPointer? = NULL
) : Panel(ptr), IRelativePanel.WithDefault, IWinRTObject {
  private val __551613391_Interface: IRelativePanel.WithDefault by lazy {
    as_551613391()
  }


  public override val __551613391_Ptr: JNAPointer? by lazy {
    __551613391_Interface.__551613391_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__551613391_Interface)

  public constructor() : this(ABI.activate())

  private fun as_551613391(): IRelativePanel.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<RelativePanel, MemoryAddress> {
    ...
    public fun createIRelativePanelStatics(): IRelativePanelStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.RelativePanel".toHandle(),refiid,interfacePtr)
    ...
    public fun createIRelativePanelFactory(): IRelativePanelFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.RelativePanel".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
  ...
  public companion object {
    public fun get_BackgroundSizingProperty() =
        ABI.IRelativePanelStatics_Instance.get_BackgroundSizingProperty()
