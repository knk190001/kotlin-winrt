...
@Signature("{675f688f-bc30-59f6-83c4-140bd053a09a}")
@Guid("675f688fbc3059f683c4140bd053a09a")
@WinRTInterface("675f688fbc3059f683c4140bd053a09a")
...
public interface ICalendarViewSelectedDatesChangedEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICalendarViewSelectedDatesChangedEventArgs {
    public val __2057030429_Ptr: Pointer?

    public val _2057030429_VtblPtr: Pointer?
      get() = __2057030429_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_AddedDates(): IVectorView<DateTime?>? {
      val fnPtr = _2057030429_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IVectorView<DateTime?>>()
      val hr = fn.invokeHR(arrayOf(__2057030429_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_RemovedDates(): IVectorView<DateTime?>? {
      val fnPtr = _2057030429_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IVectorView<DateTime?>>()
      val hr = fn.invokeHR(arrayOf(__2057030429_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ICalendarViewSelectedDatesChangedEventArgs_Impl(
    ...
    public override val __2057030429_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICalendarViewSelectedDatesChangedEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("675f688fbc3059f683c4140bd053a09a")
    ...
    public override fun toNative(obj: ICalendarViewSelectedDatesChangedEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2057030429_Ptr))
  }
