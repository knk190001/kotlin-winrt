...
@Signature("{510683e8-d0fe-5ef4-85bd-e1131076ac22}")
@Guid("510683e8d0fe5ef485bde1131076ac22")
@WinRTInterface("510683e8d0fe5ef485bde1131076ac22")
...
public interface IViewbox : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IViewbox {
    public val __1494976161_Ptr: Pointer?

    public val _1494976161_VtblPtr: Pointer?
      get() = __1494976161_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Child(): UIElement? {
      val fnPtr = _1494976161_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<UIElement>()
      val hr = fn.invokeHR(arrayOf(__1494976161_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Child(value: UIElement?): Unit {
      val fnPtr = _1494976161_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1494976161_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Stretch(): Stretch? {
      val fnPtr = _1494976161_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Stretch(value: Stretch?): Unit {
      val fnPtr = _1494976161_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1494976161_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_StretchDirection(): StretchDirection? {
      val fnPtr = _1494976161_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_StretchDirection(value: StretchDirection?): Unit {
      val fnPtr = _1494976161_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1494976161_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IViewbox_Impl(
    ...
    public override val __1494976161_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IViewbox, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("510683e8d0fe5ef485bde1131076ac22")
    ...
    public override fun toNative(obj: IViewbox): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1494976161_Ptr))
  }
