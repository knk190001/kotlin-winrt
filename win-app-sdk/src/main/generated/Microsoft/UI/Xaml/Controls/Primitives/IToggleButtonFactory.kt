...
@Signature("{519511bb-d35b-5e2d-966c-8369405a4408}")
@Guid("519511bbd35b5e2d966c8369405a4408")
@WinRTInterface("519511bbd35b5e2d966c8369405a4408")
...
public interface IToggleButtonFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IToggleButtonFactory {
    public val __536697197_Ptr: Pointer?

    public val _536697197_VtblPtr: Pointer?
      get() = __536697197_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        ToggleButton? {
      val fnPtr = _536697197_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ToggleButton>()
      val hr = fn.invokeHR(arrayOf(__536697197_Ptr, marshalToNative(baseInterface),
  ...
  public class IToggleButtonFactory_Impl(
    ...
    public override val __536697197_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IToggleButtonFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("519511bbd35b5e2d966c8369405a4408")
    ...
    public override fun toNative(obj: IToggleButtonFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__536697197_Ptr))
  }
