...
@Signature("{32e8c71b-b58c-5f19-9bd5-eeca5860f387}")
@Guid("32e8c71bb58c5f199bd5eeca5860f387")
@WinRTInterface("32e8c71bb58c5f199bd5eeca5860f387")
...
public interface IVirtualizingPanelFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IVirtualizingPanelFactory {
    public val __2139703091_Ptr: Pointer?

    public val _2139703091_VtblPtr: Pointer?
      get() = __2139703091_Ptr?.getPointer(0)
  }

  public class IVirtualizingPanelFactory_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __2139703091_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IVirtualizingPanelFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("32e8c71bb58c5f199bd5eeca5860f387")
    ...
    public override fun toNative(obj: IVirtualizingPanelFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2139703091_Ptr))
  }
