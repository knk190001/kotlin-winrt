...
@Signature("{763a4986-db3a-5a94-8505-aee2f229af85}")
@Guid("763a4986db3a5a948505aee2f229af85")
@WinRTInterface("763a4986db3a5a948505aee2f229af85")
...
public interface IListBoxStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IListBoxStatics {
    public val __826895297_Ptr: Pointer?

    public val _826895297_VtblPtr: Pointer?
      get() = __826895297_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_SelectionModeProperty(): DependencyProperty? {
      val fnPtr = _826895297_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__826895297_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_SingleSelectionFollowsFocusProperty(): DependencyProperty? {
      val fnPtr = _826895297_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__826895297_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IListBoxStatics_Impl(
    ...
    public override val __826895297_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IListBoxStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("763a4986db3a5a948505aee2f229af85")
    ...
    public override fun toNative(obj: IListBoxStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__826895297_Ptr))
  }
