...
@Signature("{d54ddd05-73e7-55a1-a119-aa342e5f9feb}")
@Guid("d54ddd0573e755a1a119aa342e5f9feb")
@WinRTInterface("d54ddd0573e755a1a119aa342e5f9feb")
...
public interface ISplitButtonStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISplitButtonStatics {
    public val __1047245504_Ptr: Pointer?

    public val _1047245504_VtblPtr: Pointer?
      get() = __1047245504_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_FlyoutProperty(): DependencyProperty? {
      val fnPtr = _1047245504_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1047245504_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_CommandProperty(): DependencyProperty? {
      val fnPtr = _1047245504_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1047245504_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_CommandParameterProperty(): DependencyProperty? {
      val fnPtr = _1047245504_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1047245504_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ISplitButtonStatics_Impl(
    ...
    public override val __1047245504_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISplitButtonStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("d54ddd0573e755a1a119aa342e5f9feb")
    ...
    public override fun toNative(obj: ISplitButtonStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1047245504_Ptr))
  }
