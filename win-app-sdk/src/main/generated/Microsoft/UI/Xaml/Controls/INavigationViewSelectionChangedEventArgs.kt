...
@Signature("{14a064a5-c79d-5f63-ac6e-1c313fe63566}")
@Guid("14a064a5c79d5f63ac6e1c313fe63566")
@WinRTInterface("14a064a5c79d5f63ac6e1c313fe63566")
...
public interface INavigationViewSelectionChangedEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : INavigationViewSelectionChangedEventArgs {
    public val __2137479023_Ptr: Pointer?

    public val _2137479023_VtblPtr: Pointer?
      get() = __2137479023_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_SelectedItem(): IUnknown? {
      val fnPtr = _2137479023_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IUnknown>()
      val hr = fn.invokeHR(arrayOf(__2137479023_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsSettingsSelected(): Boolean {
      val fnPtr = _2137479023_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class INavigationViewSelectionChangedEventArgs_Impl(
    ...
    public override val __2137479023_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<INavigationViewSelectionChangedEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("14a064a5c79d5f63ac6e1c313fe63566")
    ...
    public override fun toNative(obj: INavigationViewSelectionChangedEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2137479023_Ptr))
  }
