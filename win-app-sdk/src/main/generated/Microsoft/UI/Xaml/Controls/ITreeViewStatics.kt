...
@Signature("{71efaf86-4d73-5f5f-8ea6-a42dfe044917}")
@Guid("71efaf864d735f5f8ea6a42dfe044917")
@WinRTInterface("71efaf864d735f5f8ea6a42dfe044917")
...
public interface ITreeViewStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITreeViewStatics {
    public val __430144059_Ptr: Pointer?

    public val _430144059_VtblPtr: Pointer?
      get() = __430144059_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_SelectedItemProperty(): DependencyProperty? {
      val fnPtr = _430144059_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__430144059_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_SelectionModeProperty(): DependencyProperty? {
      val fnPtr = _430144059_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__430144059_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ITreeViewStatics_Impl(
    ...
    public override val __430144059_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITreeViewStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("71efaf864d735f5f8ea6a42dfe044917")
    ...
    public override fun toNative(obj: ITreeViewStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__430144059_Ptr))
  }
