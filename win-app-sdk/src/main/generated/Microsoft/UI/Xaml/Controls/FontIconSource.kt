...
import Microsoft.UI.Xaml.Controls.IFontIconSourceFactory.ABI.IID
...
@Signature("rc(Microsoft.UI.Xaml.Controls.FontIconSource;{b89d614c-e9b5-5b6a-9bec-ad78b1a14b74})")
...
public open class FontIconSource(
  ...
  private val __1690192170_Interface: IFontIconSource.WithDefault by lazy {
    as_1690192170()
  }


  public override val __1690192170_Ptr: JNAPointer? by lazy {
    __1690192170_Interface.__1690192170_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1690192170_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1690192170(): IFontIconSource.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<FontIconSource, MemoryAddress> {
    ...
    public fun createIFontIconSourceStatics(): IFontIconSourceStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.FontIconSource".toHandle(),refiid,interfacePtr)
    ...
    public fun createIFontIconSourceFactory(): IFontIconSourceFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.FontIconSource".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
