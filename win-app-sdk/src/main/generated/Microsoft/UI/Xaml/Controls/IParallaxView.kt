...
@Signature("{e6f4a919-1116-53ae-96c6-efddc59786f3}")
@Guid("e6f4a919111653ae96c6efddc59786f3")
@WinRTInterface("e6f4a919111653ae96c6efddc59786f3")
...
public interface IParallaxView : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IParallaxView {
    public val __1212322851_Ptr: Pointer?

    public val _1212322851_VtblPtr: Pointer?
      get() = __1212322851_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Child(): UIElement? {
      val fnPtr = _1212322851_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<UIElement>()
      val hr = fn.invokeHR(arrayOf(__1212322851_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Child(value: UIElement?): Unit {
      val fnPtr = _1212322851_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1212322851_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_HorizontalShift(): Double {
      val fnPtr = _1212322851_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_HorizontalShift(value: Double): Unit {
      val fnPtr = _1212322851_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1212322851_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_HorizontalSourceEndOffset(): Double {
      val fnPtr = _1212322851_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1212322851_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_HorizontalSourceEndOffset(value: Double): Unit {
      val fnPtr = _1212322851_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1212322851_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_HorizontalSourceOffsetKind(): ParallaxSourceOffsetKind? {
      val fnPtr = _1212322851_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_HorizontalSourceOffsetKind(value: ParallaxSourceOffsetKind?): Unit {
      val fnPtr = _1212322851_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1212322851_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_HorizontalSourceStartOffset(): Double {
      val fnPtr = _1212322851_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1212322851_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_HorizontalSourceStartOffset(value: Double): Unit {
      val fnPtr = _1212322851_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1212322851_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_IsHorizontalShiftClamped(): Boolean {
      val fnPtr = _1212322851_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_IsHorizontalShiftClamped(value: Boolean): Unit {
      val fnPtr = _1212322851_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1212322851_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_IsVerticalShiftClamped(): Boolean {
      val fnPtr = _1212322851_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1212322851_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_IsVerticalShiftClamped(value: Boolean): Unit {
      val fnPtr = _1212322851_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1212322851_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_MaxHorizontalShiftRatio(): Double {
      val fnPtr = _1212322851_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1212322851_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_MaxHorizontalShiftRatio(value: Double): Unit {
      val fnPtr = _1212322851_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1212322851_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_MaxVerticalShiftRatio(): Double {
      val fnPtr = _1212322851_VtblPtr!!.getPointer(22L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1212322851_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_MaxVerticalShiftRatio(value: Double): Unit {
      val fnPtr = _1212322851_VtblPtr!!.getPointer(23L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1212322851_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Source(): UIElement? {
      val fnPtr = _1212322851_VtblPtr!!.getPointer(24L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<UIElement>()
      val hr = fn.invokeHR(arrayOf(__1212322851_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Source(value: UIElement?): Unit {
      val fnPtr = _1212322851_VtblPtr!!.getPointer(25L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1212322851_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_VerticalShift(): Double {
      val fnPtr = _1212322851_VtblPtr!!.getPointer(26L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1212322851_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_VerticalShift(value: Double): Unit {
      val fnPtr = _1212322851_VtblPtr!!.getPointer(27L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1212322851_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_VerticalSourceEndOffset(): Double {
      val fnPtr = _1212322851_VtblPtr!!.getPointer(28L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1212322851_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_VerticalSourceEndOffset(value: Double): Unit {
      val fnPtr = _1212322851_VtblPtr!!.getPointer(29L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1212322851_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_VerticalSourceOffsetKind(): ParallaxSourceOffsetKind? {
      val fnPtr = _1212322851_VtblPtr!!.getPointer(30L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ParallaxSourceOffsetKind>()
      val hr = fn.invokeHR(arrayOf(__1212322851_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_VerticalSourceOffsetKind(value: ParallaxSourceOffsetKind?): Unit {
      val fnPtr = _1212322851_VtblPtr!!.getPointer(31L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1212322851_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_VerticalSourceStartOffset(): Double {
      val fnPtr = _1212322851_VtblPtr!!.getPointer(32L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1212322851_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_VerticalSourceStartOffset(value: Double): Unit {
      val fnPtr = _1212322851_VtblPtr!!.getPointer(33L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1212322851_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun RefreshAutomaticHorizontalOffsets(): Unit {
      val fnPtr = _1212322851_VtblPtr!!.getPointer(34L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1212322851_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun RefreshAutomaticVerticalOffsets(): Unit {
      val fnPtr = _1212322851_VtblPtr!!.getPointer(35L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1212322851_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IParallaxView_Impl(
    ...
    public override val __1212322851_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IParallaxView, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("e6f4a919111653ae96c6efddc59786f3")
    ...
    public override fun toNative(obj: IParallaxView): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1212322851_Ptr))
  }
