...
@Signature("{1b6c4ffc-cd32-5e06-b782-df9f077546c7}")
@Guid("1b6c4ffccd325e06b782df9f077546c7")
@WinRTInterface("1b6c4ffccd325e06b782df9f077546c7")
...
public interface ITreeViewDragItemsStartingEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITreeViewDragItemsStartingEventArgs {
    public val __1889172875_Ptr: Pointer?

    public val _1889172875_VtblPtr: Pointer?
      get() = __1889172875_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Cancel(): Boolean {
      val fnPtr = _1889172875_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1889172875_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Cancel(value: Boolean): Unit {
      val fnPtr = _1889172875_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1889172875_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Data(): DataPackage? {
      val fnPtr = _1889172875_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_Items(): IVector<IUnknown?>? {
      val fnPtr = _1889172875_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class ITreeViewDragItemsStartingEventArgs_Impl(
    ...
    public override val __1889172875_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITreeViewDragItemsStartingEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("1b6c4ffccd325e06b782df9f077546c7")
    ...
    public override fun toNative(obj: ITreeViewDragItemsStartingEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1889172875_Ptr))
  }
