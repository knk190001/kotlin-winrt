...
@ABIMarker(IRichEditBoxStatics.ABI::class)
@Signature("{b3f59239-efd1-5129-bf80-2841a331b24a}")
@Guid("b3f59239efd15129bf802841a331b24a")
@WinRTInterface("b3f59239efd15129bf802841a331b24a")
@JvmDefaultWithoutCompatibility
@WinRTByReference(brClass = IRichEditBoxStatics.ByReference::class)
public interface IRichEditBoxStatics : NativeMapped, IWinRTInterface {
  @InterfaceMethod(0)
  ...
  public class ByReference : com.sun.jna.ptr.ByReference(POINTER_SIZE),
      IByReference<IRichEditBoxStatics> {
    public override fun getValue() = ABI.makeIRichEditBoxStatics(pointer.getPointer(0))

    public fun setValue(value: IRichEditBoxStatics_Impl): Unit {
      pointer.setPointer(0, value.pointer)
    }
  }

  @JvmDefaultWithoutCompatibility
  public interface WithDefault : IRichEditBoxStatics {
    public val __1305484505_Ptr: Pointer?

    public val _1305484505_VtblPtr: Pointer?
      get() = __1305484505_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_IsReadOnlyProperty(): DependencyProperty? {
      val fnPtr = _1305484505_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1305484505_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_AcceptsReturnProperty(): DependencyProperty? {
      val fnPtr = _1305484505_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1305484505_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_TextAlignmentProperty(): DependencyProperty? {
      val fnPtr = _1305484505_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1305484505_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_TextWrappingProperty(): DependencyProperty? {
      val fnPtr = _1305484505_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1305484505_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsSpellCheckEnabledProperty(): DependencyProperty? {
      val fnPtr = _1305484505_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1305484505_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsTextPredictionEnabledProperty(): DependencyProperty? {
      val fnPtr = _1305484505_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1305484505_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_InputScopeProperty(): DependencyProperty? {
      val fnPtr = _1305484505_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1305484505_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_HeaderProperty(): DependencyProperty? {
      val fnPtr = _1305484505_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1305484505_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_HeaderTemplateProperty(): DependencyProperty? {
      val fnPtr = _1305484505_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1305484505_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_PlaceholderTextProperty(): DependencyProperty? {
      val fnPtr = _1305484505_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1305484505_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_SelectionHighlightColorProperty(): DependencyProperty? {
      val fnPtr = _1305484505_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1305484505_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_PreventKeyboardDisplayOnProgrammaticFocusProperty():
        DependencyProperty? {
      val fnPtr = _1305484505_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1305484505_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsColorFontEnabledProperty(): DependencyProperty? {
      val fnPtr = _1305484505_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1305484505_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_SelectionHighlightColorWhenNotFocusedProperty(): DependencyProperty? {
      val fnPtr = _1305484505_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1305484505_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_MaxLengthProperty(): DependencyProperty? {
      val fnPtr = _1305484505_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1305484505_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_HorizontalTextAlignmentProperty(): DependencyProperty? {
      val fnPtr = _1305484505_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1305484505_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_CharacterCasingProperty(): DependencyProperty? {
      val fnPtr = _1305484505_VtblPtr!!.getPointer(22L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1305484505_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_DisabledFormattingAcceleratorsProperty(): DependencyProperty? {
      val fnPtr = _1305484505_VtblPtr!!.getPointer(23L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1305484505_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_SelectionFlyoutProperty(): DependencyProperty? {
      val fnPtr = _1305484505_VtblPtr!!.getPointer(24L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1305484505_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ProofingMenuFlyoutProperty(): DependencyProperty? {
      val fnPtr = _1305484505_VtblPtr!!.getPointer(25L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1305484505_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_DescriptionProperty(): DependencyProperty? {
      val fnPtr = _1305484505_VtblPtr!!.getPointer(26L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1305484505_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_DesiredCandidateWindowAlignmentProperty(): DependencyProperty? {
      val fnPtr = _1305484505_VtblPtr!!.getPointer(27L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1305484505_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_TextReadingOrderProperty(): DependencyProperty? {
      val fnPtr = _1305484505_VtblPtr!!.getPointer(28L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1305484505_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ClipboardCopyFormatProperty(): DependencyProperty? {
      val fnPtr = _1305484505_VtblPtr!!.getPointer(29L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1305484505_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IRichEditBoxStatics_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __1305484505_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IRichEditBoxStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("b3f59239efd15129bf802841a331b24a")

    public override val layout: ValueLayout = ADDRESS

    public fun makeIRichEditBoxStatics(ptr: Pointer?): WithDefault = IRichEditBoxStatics_Impl(ptr)

    public override fun fromNative(segment: MemoryAddress): IRichEditBoxStatics {
      val address = segment.toRawLongValue()
      return makeIRichEditBoxStatics(Pointer(address))
    }

    public override fun toNative(obj: IRichEditBoxStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1305484505_Ptr))
  }

  public companion object {
    public fun makeArray(vararg elements: IRichEditBoxStatics): Array<IRichEditBoxStatics?> =
        (elements as
        Array<IRichEditBoxStatics?>).castToImpl<IRichEditBoxStatics,IRichEditBoxStatics_Impl>()

    public fun makeArrayOfNulls(size: Int): Array<IRichEditBoxStatics?> =
        arrayOfNulls<IRichEditBoxStatics_Impl>(size) as Array<IRichEditBoxStatics?>
  }
}
