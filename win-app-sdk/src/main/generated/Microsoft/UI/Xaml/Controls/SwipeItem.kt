...
import Microsoft.UI.Xaml.Controls.ISwipeItemFactory.ABI.IID
...
@Signature("rc(Microsoft.UI.Xaml.Controls.SwipeItem;{5e8d4950-b826-510a-b309-77afcdc65b1f})")
...
public open class SwipeItem(
  ...
  private val __955171718_Interface: ISwipeItem.WithDefault by lazy {
    as_955171718()
  }


  public override val __955171718_Ptr: JNAPointer? by lazy {
    __955171718_Interface.__955171718_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__955171718_Interface)

  public constructor() : this(ABI.activate())

  private fun as_955171718(): ISwipeItem.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<SwipeItem, MemoryAddress> {
    ...
    public fun createISwipeItemStatics(): ISwipeItemStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.SwipeItem".toHandle(),refiid,interfacePtr)
    ...
    public fun createISwipeItemFactory(): ISwipeItemFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.SwipeItem".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
