...
@Signature("{9d73671f-ea30-555d-8129-5a96aec73a14}")
@Guid("9d73671fea30555d81295a96aec73a14")
@WinRTInterface("9d73671fea30555d81295a96aec73a14")
...
public interface ITextControlCuttingToClipboardEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITextControlCuttingToClipboardEventArgs {
    public val __2013589187_Ptr: Pointer?

    public val _2013589187_VtblPtr: Pointer?
      get() = __2013589187_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Handled(): Boolean {
      val fnPtr = _2013589187_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__2013589187_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Handled(value: Boolean): Unit {
      val fnPtr = _2013589187_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2013589187_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class ITextControlCuttingToClipboardEventArgs_Impl(
    ...
    public override val __2013589187_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITextControlCuttingToClipboardEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("9d73671fea30555d81295a96aec73a14")
    ...
    public override fun toNative(obj: ITextControlCuttingToClipboardEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2013589187_Ptr))
  }
