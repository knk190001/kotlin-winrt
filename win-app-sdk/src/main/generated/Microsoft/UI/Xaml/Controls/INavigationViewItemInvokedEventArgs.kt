...
@Signature("{074cebaa-5d05-547b-8cd6-d19ac2d9bb3b}")
@Guid("074cebaa5d05547b8cd6d19ac2d9bb3b")
@WinRTInterface("074cebaa5d05547b8cd6d19ac2d9bb3b")
...
public interface INavigationViewItemInvokedEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : INavigationViewItemInvokedEventArgs {
    public val __139138370_Ptr: Pointer?

    public val _139138370_VtblPtr: Pointer?
      get() = __139138370_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_InvokedItem(): IUnknown? {
      val fnPtr = _139138370_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IUnknown>()
      val hr = fn.invokeHR(arrayOf(__139138370_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsSettingsInvoked(): Boolean {
      val fnPtr = _139138370_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class INavigationViewItemInvokedEventArgs_Impl(
    ...
    public override val __139138370_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<INavigationViewItemInvokedEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("074cebaa5d05547b8cd6d19ac2d9bb3b")
    ...
    public override fun toNative(obj: INavigationViewItemInvokedEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__139138370_Ptr))
  }
