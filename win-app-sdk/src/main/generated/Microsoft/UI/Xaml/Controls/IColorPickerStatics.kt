...
@Signature("{920d2d62-172e-5771-b677-4069b5134574}")
@Guid("920d2d62172e5771b6774069b5134574")
@WinRTInterface("920d2d62172e5771b6774069b5134574")
...
public interface IColorPickerStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IColorPickerStatics {
    public val __1994434885_Ptr: Pointer?

    public val _1994434885_VtblPtr: Pointer?
      get() = __1994434885_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ColorProperty(): DependencyProperty? {
      val fnPtr = _1994434885_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1994434885_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_PreviousColorProperty(): DependencyProperty? {
      val fnPtr = _1994434885_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1994434885_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsAlphaEnabledProperty(): DependencyProperty? {
      val fnPtr = _1994434885_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1994434885_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsColorSpectrumVisibleProperty(): DependencyProperty? {
      val fnPtr = _1994434885_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1994434885_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsColorPreviewVisibleProperty(): DependencyProperty? {
      val fnPtr = _1994434885_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1994434885_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsColorSliderVisibleProperty(): DependencyProperty? {
      val fnPtr = _1994434885_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1994434885_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsAlphaSliderVisibleProperty(): DependencyProperty? {
      val fnPtr = _1994434885_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1994434885_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsMoreButtonVisibleProperty(): DependencyProperty? {
      val fnPtr = _1994434885_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1994434885_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsColorChannelTextInputVisibleProperty(): DependencyProperty? {
      val fnPtr = _1994434885_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1994434885_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsAlphaTextInputVisibleProperty(): DependencyProperty? {
      val fnPtr = _1994434885_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1994434885_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsHexInputVisibleProperty(): DependencyProperty? {
      val fnPtr = _1994434885_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1994434885_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_MinHueProperty(): DependencyProperty? {
      val fnPtr = _1994434885_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1994434885_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_MaxHueProperty(): DependencyProperty? {
      val fnPtr = _1994434885_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1994434885_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_MinSaturationProperty(): DependencyProperty? {
      val fnPtr = _1994434885_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1994434885_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_MaxSaturationProperty(): DependencyProperty? {
      val fnPtr = _1994434885_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1994434885_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_MinValueProperty(): DependencyProperty? {
      val fnPtr = _1994434885_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1994434885_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_MaxValueProperty(): DependencyProperty? {
      val fnPtr = _1994434885_VtblPtr!!.getPointer(22L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1994434885_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ColorSpectrumShapeProperty(): DependencyProperty? {
      val fnPtr = _1994434885_VtblPtr!!.getPointer(23L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1994434885_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ColorSpectrumComponentsProperty(): DependencyProperty? {
      val fnPtr = _1994434885_VtblPtr!!.getPointer(24L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1994434885_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IColorPickerStatics_Impl(
    ...
    public override val __1994434885_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IColorPickerStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("920d2d62172e5771b6774069b5134574")
    ...
    public override fun toNative(obj: IColorPickerStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1994434885_Ptr))
  }
