...
@Signature("{a194dbe6-4311-5bd2-a8eb-b49c4733a33c}")
@Guid("a194dbe643115bd2a8ebb49c4733a33c")
@WinRTInterface("a194dbe643115bd2a8ebb49c4733a33c")
...
public interface ICommandBarFlyoutFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICommandBarFlyoutFactory {
    public val __955169024_Ptr: Pointer?

    public val _955169024_VtblPtr: Pointer?
      get() = __955169024_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        CommandBarFlyout? {
      val fnPtr = _955169024_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CommandBarFlyout>()
      val hr = fn.invokeHR(arrayOf(__955169024_Ptr, marshalToNative(baseInterface),
  ...
  public class ICommandBarFlyoutFactory_Impl(
    ...
    public override val __955169024_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICommandBarFlyoutFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("a194dbe643115bd2a8ebb49c4733a33c")
    ...
    public override fun toNative(obj: ICommandBarFlyoutFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__955169024_Ptr))
  }
