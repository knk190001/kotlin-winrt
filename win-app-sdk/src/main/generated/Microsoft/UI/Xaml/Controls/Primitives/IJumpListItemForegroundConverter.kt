...
@Signature("{7308e0e4-102f-571a-bfdc-c8f411f07400}")
@Guid("7308e0e4102f571abfdcc8f411f07400")
@WinRTInterface("7308e0e4102f571abfdcc8f411f07400")
...
public interface IJumpListItemForegroundConverter : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IJumpListItemForegroundConverter {
    public val __1029403533_Ptr: Pointer?

    public val _1029403533_VtblPtr: Pointer?
      get() = __1029403533_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Enabled(): Brush? {
      val fnPtr = _1029403533_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Brush>()
      val hr = fn.invokeHR(arrayOf(__1029403533_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Enabled(value: Brush?): Unit {
      val fnPtr = _1029403533_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1029403533_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Disabled(): Brush? {
      val fnPtr = _1029403533_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Brush>()
      val hr = fn.invokeHR(arrayOf(__1029403533_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Disabled(value: Brush?): Unit {
      val fnPtr = _1029403533_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1029403533_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IJumpListItemForegroundConverter_Impl(
    ...
    public override val __1029403533_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IJumpListItemForegroundConverter, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("7308e0e4102f571abfdcc8f411f07400")
    ...
    public override fun toNative(obj: IJumpListItemForegroundConverter): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1029403533_Ptr))
  }
