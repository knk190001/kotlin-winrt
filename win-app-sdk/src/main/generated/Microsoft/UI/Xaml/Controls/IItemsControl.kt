...
@Signature("{bf1ccb54-83e2-5b98-acbc-736f876c3d35}")
@Guid("bf1ccb5483e25b98acbc736f876c3d35")
@WinRTInterface("bf1ccb5483e25b98acbc736f876c3d35")
...
public interface IItemsControl : NativeMapped, IWinRTInterface {
  ...
  @InterfaceMethod(11)
  public fun get_ItemsPanelRoot(): Panel?
  ...
  public interface WithDefault : IItemsControl {
    public val __545798340_Ptr: Pointer?

    public val _545798340_VtblPtr: Pointer?
      get() = __545798340_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ItemsSource(): IUnknown? {
      val fnPtr = _545798340_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IUnknown>()
      val hr = fn.invokeHR(arrayOf(__545798340_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ItemsSource(value: IUnknown?): Unit {
      val fnPtr = _545798340_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__545798340_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Items(): ItemCollection? {
      val fnPtr = _545798340_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_ItemTemplate(): DataTemplate? {
      val fnPtr = _545798340_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_ItemTemplate(value: DataTemplate?): Unit {
      val fnPtr = _545798340_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__545798340_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ItemTemplateSelector(): DataTemplateSelector? {
      val fnPtr = _545798340_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_ItemTemplateSelector(value: DataTemplateSelector?): Unit {
      val fnPtr = _545798340_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__545798340_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ItemsPanel(): ItemsPanelTemplate? {
      val fnPtr = _545798340_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_ItemsPanel(value: ItemsPanelTemplate?): Unit {
      val fnPtr = _545798340_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__545798340_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_DisplayMemberPath(): String? {
      val fnPtr = _545798340_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_DisplayMemberPath(value: String?): Unit {
      val fnPtr = _545798340_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__545798340_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    @InterfaceMethod(11)
    public override fun get_ItemsPanelRoot(): Panel? {
      val fnPtr = _545798340_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_ItemContainerStyle(): Style? {
      val fnPtr = _545798340_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_ItemContainerStyle(value: Style?): Unit {
      val fnPtr = _545798340_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__545798340_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ItemContainerStyleSelector(): StyleSelector? {
      val fnPtr = _545798340_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_ItemContainerStyleSelector(value: StyleSelector?): Unit {
      val fnPtr = _545798340_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__545798340_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ItemContainerGenerator(): ItemContainerGenerator? {
      val fnPtr = _545798340_VtblPtr!!.getPointer(22L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_ItemContainerTransitions(): TransitionCollection? {
      val fnPtr = _545798340_VtblPtr!!.getPointer(23L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_ItemContainerTransitions(value: TransitionCollection?): Unit {
      val fnPtr = _545798340_VtblPtr!!.getPointer(24L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__545798340_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_GroupStyle(): IObservableVector<GroupStyle?>? {
      val fnPtr = _545798340_VtblPtr!!.getPointer(25L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_GroupStyleSelector(): GroupStyleSelector? {
      val fnPtr = _545798340_VtblPtr!!.getPointer(26L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_GroupStyleSelector(value: GroupStyleSelector?): Unit {
      val fnPtr = _545798340_VtblPtr!!.getPointer(27L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__545798340_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_IsGrouping(): Boolean {
      val fnPtr = _545798340_VtblPtr!!.getPointer(28L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun GroupHeaderContainerFromItemContainer(itemContainer: DependencyObject?):
        DependencyObject? {
      val fnPtr = _545798340_VtblPtr!!.getPointer(29L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyObject>()
      val hr = fn.invokeHR(arrayOf(__545798340_Ptr, marshalToNative(itemContainer), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
  ...
  public class IItemsControl_Impl(
    ...
    public override val __545798340_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IItemsControl, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("bf1ccb5483e25b98acbc736f876c3d35")
    ...
    public override fun toNative(obj: IItemsControl): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__545798340_Ptr))
  }
