...
@Signature("{a4b26c3a-3825-5da4-a9e0-dd9b1e405e53}")
@Guid("a4b26c3a38255da4a9e0dd9b1e405e53")
@WinRTInterface("a4b26c3a38255da4a9e0dd9b1e405e53")
...
public interface ICalendarPanel : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICalendarPanel {
    public val __771559605_Ptr: Pointer?

    public val _771559605_VtblPtr: Pointer?
      get() = __771559605_Ptr?.getPointer(0)
  }

  public class ICalendarPanel_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __771559605_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICalendarPanel, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("a4b26c3a38255da4a9e0dd9b1e405e53")
    ...
    public override fun toNative(obj: ICalendarPanel): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__771559605_Ptr))
  }
