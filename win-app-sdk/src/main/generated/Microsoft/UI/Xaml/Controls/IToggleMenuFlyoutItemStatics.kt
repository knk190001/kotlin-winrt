...
@Signature("{7411e854-c59a-5463-beab-64ddb052c6dc}")
@Guid("7411e854c59a5463beab64ddb052c6dc")
@WinRTInterface("7411e854c59a5463beab64ddb052c6dc")
...
public interface IToggleMenuFlyoutItemStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IToggleMenuFlyoutItemStatics {
    public val __921667453_Ptr: Pointer?

    public val _921667453_VtblPtr: Pointer?
      get() = __921667453_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_IsCheckedProperty(): DependencyProperty? {
      val fnPtr = _921667453_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__921667453_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IToggleMenuFlyoutItemStatics_Impl(
    ...
    public override val __921667453_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IToggleMenuFlyoutItemStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("7411e854c59a5463beab64ddb052c6dc")
    ...
    public override fun toNative(obj: IToggleMenuFlyoutItemStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__921667453_Ptr))
  }
