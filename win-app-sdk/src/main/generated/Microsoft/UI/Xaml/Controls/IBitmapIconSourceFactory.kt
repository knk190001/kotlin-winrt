...
@Signature("{7d484c14-f5f6-5e39-b4e4-b6108d2ee095}")
@Guid("7d484c14f5f65e39b4e4b6108d2ee095")
@WinRTInterface("7d484c14f5f65e39b4e4b6108d2ee095")
...
public interface IBitmapIconSourceFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IBitmapIconSourceFactory {
    public val __681741984_Ptr: Pointer?

    public val _681741984_VtblPtr: Pointer?
      get() = __681741984_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        BitmapIconSource? {
      val fnPtr = _681741984_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<BitmapIconSource>()
      val hr = fn.invokeHR(arrayOf(__681741984_Ptr, marshalToNative(baseInterface),
  ...
  public class IBitmapIconSourceFactory_Impl(
    ...
    public override val __681741984_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IBitmapIconSourceFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("7d484c14f5f65e39b4e4b6108d2ee095")
    ...
    public override fun toNative(obj: IBitmapIconSourceFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__681741984_Ptr))
  }
