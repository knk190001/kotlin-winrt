...
import Microsoft.UI.Xaml.Controls.Primitives.IRangeBaseFactory.ABI.IID
...
@Signature("rc(Microsoft.UI.Xaml.Controls.Primitives.RangeBase;{540d6d61-8fac-5d5c-b5b0-e172a7dde103})")
...
public open class RangeBase(
  ...
  private val __905472125_Interface: IRangeBase.WithDefault by lazy {
    as_905472125()
  }


  private val __1771524650_Interface: IRangeBaseOverrides.WithDefault by lazy {
    as_1771524650()
  }


  public override val __905472125_Ptr: JNAPointer? by lazy {
    __905472125_Interface.__905472125_Ptr
  }


  public override val __1771524650_Ptr: JNAPointer? by lazy {
    __1771524650_Interface.__1771524650_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__905472125_Interface, __1771524650_Interface)

  public constructor() : this(ABI.activate())

  private fun as_905472125(): IRangeBase.WithDefault {
    if(pointer == NULL) {
  ...
  private fun as_1771524650(): IRangeBaseOverrides.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<RangeBase, MemoryAddress> {
    ...
    public fun createIRangeBaseStatics(): IRangeBaseStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.Primitives.RangeBase".toHandle(),refiid,interfacePtr)
    ...
    public fun createIRangeBaseFactory(): IRangeBaseFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.Primitives.RangeBase".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
