...
@Signature("{7ec0794c-f2cc-5282-a89d-cd3bb765b71a}")
@Guid("7ec0794cf2cc5282a89dcd3bb765b71a")
@WinRTInterface("7ec0794cf2cc5282a89dcd3bb765b71a")
...
public interface IPersonPictureFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPersonPictureFactory {
    public val __1149109544_Ptr: Pointer?

    public val _1149109544_VtblPtr: Pointer?
      get() = __1149109544_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        PersonPicture? {
      val fnPtr = _1149109544_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<PersonPicture>()
      val hr = fn.invokeHR(arrayOf(__1149109544_Ptr, marshalToNative(baseInterface),
  ...
  public class IPersonPictureFactory_Impl(
    ...
    public override val __1149109544_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPersonPictureFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("7ec0794cf2cc5282a89dcd3bb765b71a")
    ...
    public override fun toNative(obj: IPersonPictureFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1149109544_Ptr))
  }
