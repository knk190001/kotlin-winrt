...
import Microsoft.UI.Xaml.Controls.IPivotItemFactory.ABI.IID
...
@Signature("rc(Microsoft.UI.Xaml.Controls.PivotItem;{8108c195-63f5-5df9-abcf-418fa2dbfbec})")
...
public open class PivotItem(
  ...
  private val __2090896526_Interface: IPivotItem.WithDefault by lazy {
    as_2090896526()
  }


  public override val __2090896526_Ptr: JNAPointer? by lazy {
    __2090896526_Interface.__2090896526_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__2090896526_Interface)

  public constructor() : this(ABI.activate())

  private fun as_2090896526(): IPivotItem.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<PivotItem, MemoryAddress> {
    ...
    public fun createIPivotItemStatics(): IPivotItemStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.PivotItem".toHandle(),refiid,interfacePtr)
    ...
    public fun createIPivotItemFactory(): IPivotItemFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.PivotItem".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
