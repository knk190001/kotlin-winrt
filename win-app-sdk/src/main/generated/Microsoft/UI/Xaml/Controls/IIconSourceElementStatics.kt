...
@Signature("{2cc2539f-69fc-5160-ab84-37e7e04e2691}")
@Guid("2cc2539f69fc5160ab8437e7e04e2691")
@WinRTInterface("2cc2539f69fc5160ab8437e7e04e2691")
...
public interface IIconSourceElementStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IIconSourceElementStatics {
    public val __1840935172_Ptr: Pointer?

    public val _1840935172_VtblPtr: Pointer?
      get() = __1840935172_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_IconSourceProperty(): DependencyProperty? {
      val fnPtr = _1840935172_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1840935172_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IIconSourceElementStatics_Impl(
    ...
    public override val __1840935172_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IIconSourceElementStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("2cc2539f69fc5160ab8437e7e04e2691")
    ...
    public override fun toNative(obj: IIconSourceElementStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1840935172_Ptr))
  }
