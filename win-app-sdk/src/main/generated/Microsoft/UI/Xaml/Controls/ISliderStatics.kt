...
@Signature("{f0541f7b-6d81-59e2-997a-2e65fbcccd21}")
@Guid("f0541f7b6d8159e2997a2e65fbcccd21")
@WinRTInterface("f0541f7b6d8159e2997a2e65fbcccd21")
...
public interface ISliderStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISliderStatics {
    public val __139813571_Ptr: Pointer?

    public val _139813571_VtblPtr: Pointer?
      get() = __139813571_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_IntermediateValueProperty(): DependencyProperty? {
      val fnPtr = _139813571_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__139813571_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_StepFrequencyProperty(): DependencyProperty? {
      val fnPtr = _139813571_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__139813571_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_SnapsToProperty(): DependencyProperty? {
      val fnPtr = _139813571_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__139813571_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_TickFrequencyProperty(): DependencyProperty? {
      val fnPtr = _139813571_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__139813571_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_TickPlacementProperty(): DependencyProperty? {
      val fnPtr = _139813571_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__139813571_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_OrientationProperty(): DependencyProperty? {
      val fnPtr = _139813571_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__139813571_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsDirectionReversedProperty(): DependencyProperty? {
      val fnPtr = _139813571_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__139813571_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsThumbToolTipEnabledProperty(): DependencyProperty? {
      val fnPtr = _139813571_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__139813571_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ThumbToolTipValueConverterProperty(): DependencyProperty? {
      val fnPtr = _139813571_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__139813571_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_HeaderProperty(): DependencyProperty? {
      val fnPtr = _139813571_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__139813571_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_HeaderTemplateProperty(): DependencyProperty? {
      val fnPtr = _139813571_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__139813571_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ISliderStatics_Impl(
    ...
    public override val __139813571_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISliderStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("f0541f7b6d8159e2997a2e65fbcccd21")
    ...
    public override fun toNative(obj: ISliderStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__139813571_Ptr))
  }
