...
@Signature("{61bbb127-e4c4-5e22-a8dc-cfcf957236d0}")
@Guid("61bbb127e4c45e22a8dccfcf957236d0")
@WinRTInterface("61bbb127e4c45e22a8dccfcf957236d0")
...
public interface IProgressBarStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IProgressBarStatics {
    public val __126223430_Ptr: Pointer?

    public val _126223430_VtblPtr: Pointer?
      get() = __126223430_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_IsIndeterminateProperty(): DependencyProperty? {
      val fnPtr = _126223430_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__126223430_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ShowErrorProperty(): DependencyProperty? {
      val fnPtr = _126223430_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__126223430_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ShowPausedProperty(): DependencyProperty? {
      val fnPtr = _126223430_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__126223430_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IProgressBarStatics_Impl(
    ...
    public override val __126223430_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IProgressBarStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("61bbb127e4c45e22a8dccfcf957236d0")
    ...
    public override fun toNative(obj: IProgressBarStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__126223430_Ptr))
  }
