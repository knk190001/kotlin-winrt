...
@Signature("{d83b0621-aaca-534b-afde-5370167176b5}")
@Guid("d83b0621aaca534bafde5370167176b5")
@WinRTInterface("d83b0621aaca534bafde5370167176b5")
...
public interface ISwapChainPanelStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISwapChainPanelStatics {
    public val __271737400_Ptr: Pointer?

    public val _271737400_VtblPtr: Pointer?
      get() = __271737400_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_CompositionScaleXProperty(): DependencyProperty? {
      val fnPtr = _271737400_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__271737400_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_CompositionScaleYProperty(): DependencyProperty? {
      val fnPtr = _271737400_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__271737400_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ISwapChainPanelStatics_Impl(
    ...
    public override val __271737400_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISwapChainPanelStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("d83b0621aaca534bafde5370167176b5")
    ...
    public override fun toNative(obj: ISwapChainPanelStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__271737400_Ptr))
  }
