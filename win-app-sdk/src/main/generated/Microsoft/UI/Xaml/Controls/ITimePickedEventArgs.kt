...
@Signature("{9f85d661-a9e0-5e08-a904-113b74ca3c59}")
@Guid("9f85d661a9e05e08a904113b74ca3c59")
@WinRTInterface("9f85d661a9e05e08a904113b74ca3c59")
...
public interface ITimePickedEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITimePickedEventArgs {
    public val __1654453693_Ptr: Pointer?

    public val _1654453693_VtblPtr: Pointer?
      get() = __1654453693_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_OldTime(): TimeSpan? {
      val fnPtr = _1654453693_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<TimeSpan>()
      val hr = fn.invokeHR(arrayOf(__1654453693_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_NewTime(): TimeSpan? {
      val fnPtr = _1654453693_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<TimeSpan>()
      val hr = fn.invokeHR(arrayOf(__1654453693_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ITimePickedEventArgs_Impl(
    ...
    public override val __1654453693_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITimePickedEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("9f85d661a9e05e08a904113b74ca3c59")
    ...
    public override fun toNative(obj: ITimePickedEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1654453693_Ptr))
  }
