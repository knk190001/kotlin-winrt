...
@Signature("{55d90715-70bc-5b2b-bd12-a940297f935f}")
@Guid("55d9071570bc5b2bbd12a940297f935f")
@WinRTInterface("55d9071570bc5b2bbd12a940297f935f")
...
public interface IAppBarElementContainer : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IAppBarElementContainer {
    public val __1850573246_Ptr: Pointer?

    public val _1850573246_VtblPtr: Pointer?
      get() = __1850573246_Ptr?.getPointer(0)
  }

  public class IAppBarElementContainer_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __1850573246_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IAppBarElementContainer, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("55d9071570bc5b2bbd12a940297f935f")
    ...
    public override fun toNative(obj: IAppBarElementContainer): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1850573246_Ptr))
  }
