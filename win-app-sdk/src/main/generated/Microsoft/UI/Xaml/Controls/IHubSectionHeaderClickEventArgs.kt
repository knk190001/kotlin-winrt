...
@Signature("{b5343aab-37b2-5cdc-9543-118e3ace48b2}")
@Guid("b5343aab37b25cdc9543118e3ace48b2")
@WinRTInterface("b5343aab37b25cdc9543118e3ace48b2")
...
public interface IHubSectionHeaderClickEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IHubSectionHeaderClickEventArgs {
    public val __2085189197_Ptr: Pointer?

    public val _2085189197_VtblPtr: Pointer?
      get() = __2085189197_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Section(): HubSection? {
      val fnPtr = _2085189197_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<HubSection>()
      val hr = fn.invokeHR(arrayOf(__2085189197_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IHubSectionHeaderClickEventArgs_Impl(
    ...
    public override val __2085189197_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IHubSectionHeaderClickEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("b5343aab37b25cdc9543118e3ace48b2")
    ...
    public override fun toNative(obj: IHubSectionHeaderClickEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2085189197_Ptr))
  }
