...
@Signature("{38f30cee-e75a-5ba1-ae64-4474a3abeac7}")
@Guid("38f30ceee75a5ba1ae644474a3abeac7")
@WinRTInterface("38f30ceee75a5ba1ae644474a3abeac7")
...
public interface IRadioButton : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IRadioButton {
    public val __1840946918_Ptr: Pointer?

    public val _1840946918_VtblPtr: Pointer?
      get() = __1840946918_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_GroupName(): String? {
      val fnPtr = _1840946918_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__1840946918_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_GroupName(value: String?): Unit {
      val fnPtr = _1840946918_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1840946918_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IRadioButton_Impl(
    ...
    public override val __1840946918_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IRadioButton, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("38f30ceee75a5ba1ae644474a3abeac7")
    ...
    public override fun toNative(obj: IRadioButton): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1840946918_Ptr))
  }
