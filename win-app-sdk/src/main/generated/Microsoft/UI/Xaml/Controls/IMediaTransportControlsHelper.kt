...
@Signature("{89d393ba-0e04-5e24-b456-ab05429591e4}")
@Guid("89d393ba0e045e24b456ab05429591e4")
@WinRTInterface("89d393ba0e045e24b456ab05429591e4")
...
public interface IMediaTransportControlsHelper : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IMediaTransportControlsHelper {
    public val __756555344_Ptr: Pointer?

    public val _756555344_VtblPtr: Pointer?
      get() = __756555344_Ptr?.getPointer(0)
  }

  public class IMediaTransportControlsHelper_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __756555344_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IMediaTransportControlsHelper, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("89d393ba0e045e24b456ab05429591e4")
    ...
    public override fun toNative(obj: IMediaTransportControlsHelper): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__756555344_Ptr))
  }
