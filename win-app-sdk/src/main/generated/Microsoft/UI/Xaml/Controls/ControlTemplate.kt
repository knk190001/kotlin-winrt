...
@Signature("rc(Microsoft.UI.Xaml.Controls.ControlTemplate;{3a192751-2106-547a-aca0-f15ae8926ea0})")
...
public class ControlTemplate(
  ...
  private val __597953456_Interface: IControlTemplate.WithDefault by lazy {
    as_597953456()
  }


  public override val __597953456_Ptr: JNAPointer? by lazy {
    __597953456_Interface.__597953456_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__597953456_Interface)

  public constructor() : this(ABI.activate())

  private fun as_597953456(): IControlTemplate.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<ControlTemplate, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.ControlTemplate".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
