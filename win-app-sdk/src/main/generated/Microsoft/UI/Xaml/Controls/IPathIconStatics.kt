...
@Signature("{72bba29a-0595-5f6d-a8df-2a0580a2cd78}")
@Guid("72bba29a05955f6da8df2a0580a2cd78")
@WinRTInterface("72bba29a05955f6da8df2a0580a2cd78")
...
public interface IPathIconStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPathIconStatics {
    public val __1649817856_Ptr: Pointer?

    public val _1649817856_VtblPtr: Pointer?
      get() = __1649817856_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_DataProperty(): DependencyProperty? {
      val fnPtr = _1649817856_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1649817856_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IPathIconStatics_Impl(
    ...
    public override val __1649817856_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPathIconStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("72bba29a05955f6da8df2a0580a2cd78")
    ...
    public override fun toNative(obj: IPathIconStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1649817856_Ptr))
  }
