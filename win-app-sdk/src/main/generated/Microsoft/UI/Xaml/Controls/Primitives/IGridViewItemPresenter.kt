...
@Signature("{22772fd8-fe30-5b6f-9b17-5eea5d70d860}")
@Guid("22772fd8fe305b6f9b175eea5d70d860")
@WinRTInterface("22772fd8fe305b6f9b175eea5d70d860")
...
public interface IGridViewItemPresenter : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IGridViewItemPresenter {
    public val __839621593_Ptr: Pointer?

    public val _839621593_VtblPtr: Pointer?
      get() = __839621593_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_SelectionCheckMarkVisualEnabled(): Boolean {
      val fnPtr = _839621593_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__839621593_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_SelectionCheckMarkVisualEnabled(value: Boolean): Unit {
      val fnPtr = _839621593_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__839621593_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_CheckHintBrush(): Brush? {
      val fnPtr = _839621593_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_CheckHintBrush(value: Brush?): Unit {
      val fnPtr = _839621593_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__839621593_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_CheckSelectingBrush(): Brush? {
      val fnPtr = _839621593_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Brush>()
      val hr = fn.invokeHR(arrayOf(__839621593_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_CheckSelectingBrush(value: Brush?): Unit {
      val fnPtr = _839621593_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__839621593_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_CheckBrush(): Brush? {
      val fnPtr = _839621593_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Brush>()
      val hr = fn.invokeHR(arrayOf(__839621593_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_CheckBrush(value: Brush?): Unit {
      val fnPtr = _839621593_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__839621593_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_DragBackground(): Brush? {
      val fnPtr = _839621593_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Brush>()
      val hr = fn.invokeHR(arrayOf(__839621593_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_DragBackground(value: Brush?): Unit {
      val fnPtr = _839621593_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__839621593_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_DragForeground(): Brush? {
      val fnPtr = _839621593_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Brush>()
      val hr = fn.invokeHR(arrayOf(__839621593_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_DragForeground(value: Brush?): Unit {
      val fnPtr = _839621593_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__839621593_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_FocusBorderBrush(): Brush? {
      val fnPtr = _839621593_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Brush>()
      val hr = fn.invokeHR(arrayOf(__839621593_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_FocusBorderBrush(value: Brush?): Unit {
      val fnPtr = _839621593_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__839621593_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_PlaceholderBackground(): Brush? {
      val fnPtr = _839621593_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Brush>()
      val hr = fn.invokeHR(arrayOf(__839621593_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_PlaceholderBackground(value: Brush?): Unit {
      val fnPtr = _839621593_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__839621593_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_PointerOverBackground(): Brush? {
      val fnPtr = _839621593_VtblPtr!!.getPointer(22L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Brush>()
      val hr = fn.invokeHR(arrayOf(__839621593_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_PointerOverBackground(value: Brush?): Unit {
      val fnPtr = _839621593_VtblPtr!!.getPointer(23L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__839621593_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_SelectedBackground(): Brush? {
      val fnPtr = _839621593_VtblPtr!!.getPointer(24L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Brush>()
      val hr = fn.invokeHR(arrayOf(__839621593_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_SelectedBackground(value: Brush?): Unit {
      val fnPtr = _839621593_VtblPtr!!.getPointer(25L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__839621593_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_SelectedForeground(): Brush? {
      val fnPtr = _839621593_VtblPtr!!.getPointer(26L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Brush>()
      val hr = fn.invokeHR(arrayOf(__839621593_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_SelectedForeground(value: Brush?): Unit {
      val fnPtr = _839621593_VtblPtr!!.getPointer(27L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__839621593_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_SelectedPointerOverBackground(): Brush? {
      val fnPtr = _839621593_VtblPtr!!.getPointer(28L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Brush>()
      val hr = fn.invokeHR(arrayOf(__839621593_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_SelectedPointerOverBackground(value: Brush?): Unit {
      val fnPtr = _839621593_VtblPtr!!.getPointer(29L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__839621593_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_SelectedPointerOverBorderBrush(): Brush? {
      val fnPtr = _839621593_VtblPtr!!.getPointer(30L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Brush>()
      val hr = fn.invokeHR(arrayOf(__839621593_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_SelectedPointerOverBorderBrush(value: Brush?): Unit {
      val fnPtr = _839621593_VtblPtr!!.getPointer(31L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__839621593_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_SelectedBorderThickness(): Thickness? {
      val fnPtr = _839621593_VtblPtr!!.getPointer(32L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_SelectedBorderThickness(value: Thickness?): Unit {
      val fnPtr = _839621593_VtblPtr!!.getPointer(33L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__839621593_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_DisabledOpacity(): Double {
      val fnPtr = _839621593_VtblPtr!!.getPointer(34L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_DisabledOpacity(value: Double): Unit {
      val fnPtr = _839621593_VtblPtr!!.getPointer(35L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__839621593_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_DragOpacity(): Double {
      val fnPtr = _839621593_VtblPtr!!.getPointer(36L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__839621593_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_DragOpacity(value: Double): Unit {
      val fnPtr = _839621593_VtblPtr!!.getPointer(37L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__839621593_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ReorderHintOffset(): Double {
      val fnPtr = _839621593_VtblPtr!!.getPointer(38L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__839621593_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ReorderHintOffset(value: Double): Unit {
      val fnPtr = _839621593_VtblPtr!!.getPointer(39L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__839621593_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_GridViewItemPresenterHorizontalContentAlignment():
        HorizontalAlignment? {
      val fnPtr = _839621593_VtblPtr!!.getPointer(40L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override
      ...
      val fnPtr = _839621593_VtblPtr!!.getPointer(41L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__839621593_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_GridViewItemPresenterVerticalContentAlignment(): VerticalAlignment? {
      val fnPtr = _839621593_VtblPtr!!.getPointer(42L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override
      ...
      val fnPtr = _839621593_VtblPtr!!.getPointer(43L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__839621593_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_GridViewItemPresenterPadding(): Thickness? {
      val fnPtr = _839621593_VtblPtr!!.getPointer(44L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Thickness>()
      val hr = fn.invokeHR(arrayOf(__839621593_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_GridViewItemPresenterPadding(value: Thickness?): Unit {
      val fnPtr = _839621593_VtblPtr!!.getPointer(45L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__839621593_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_PointerOverBackgroundMargin(): Thickness? {
      val fnPtr = _839621593_VtblPtr!!.getPointer(46L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Thickness>()
      val hr = fn.invokeHR(arrayOf(__839621593_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_PointerOverBackgroundMargin(value: Thickness?): Unit {
      val fnPtr = _839621593_VtblPtr!!.getPointer(47L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__839621593_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ContentMargin(): Thickness? {
      val fnPtr = _839621593_VtblPtr!!.getPointer(48L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Thickness>()
      val hr = fn.invokeHR(arrayOf(__839621593_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ContentMargin(value: Thickness?): Unit {
      val fnPtr = _839621593_VtblPtr!!.getPointer(49L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__839621593_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IGridViewItemPresenter_Impl(
    ...
    public override val __839621593_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IGridViewItemPresenter, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("22772fd8fe305b6f9b175eea5d70d860")
    ...
    public override fun toNative(obj: IGridViewItemPresenter): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__839621593_Ptr))
  }
