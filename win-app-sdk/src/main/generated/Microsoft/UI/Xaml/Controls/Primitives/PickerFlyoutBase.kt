...
import Microsoft.UI.Xaml.Controls.Primitives.IPickerFlyoutBaseFactory.ABI.IID
...
@Signature("rc(Microsoft.UI.Xaml.Controls.Primitives.PickerFlyoutBase;{8c2cc030-14fe-5fca-8ce3-e11a918632cc})")
...
public open class PickerFlyoutBase(
  ptr: JNAPointer? = NULL
    ...
    IWinRTObject {
  private val __599168789_Interface: IPickerFlyoutBase.WithDefault by lazy {
    as_599168789()
  }


  private val __1173679484_Interface: IPickerFlyoutBaseOverrides.WithDefault by lazy {
    as_1173679484()
  }


  public override val __599168789_Ptr: JNAPointer? by lazy {
    __599168789_Interface.__599168789_Ptr
  }


  public override val __1173679484_Ptr: JNAPointer? by lazy {
    __1173679484_Interface.__1173679484_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__599168789_Interface, __1173679484_Interface)

  public constructor() : this(ABI.activate())

  private fun as_599168789(): IPickerFlyoutBase.WithDefault {
    if(pointer == NULL) {
  ...
  private fun as_1173679484(): IPickerFlyoutBaseOverrides.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<PickerFlyoutBase, MemoryAddress> {
    ...
    public fun createIPickerFlyoutBaseStatics(): IPickerFlyoutBaseStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.Primitives.PickerFlyoutBase".toHandle(),refiid,interfacePtr)
    ...
    public fun createIPickerFlyoutBaseFactory(): IPickerFlyoutBaseFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Controls.Primitives.PickerFlyoutBase".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
