...
@Signature("{6f77bba8-fb23-5e27-97c1-16d437d0702f}")
@Guid("6f77bba8fb235e2797c116d437d0702f")
@WinRTInterface("6f77bba8fb235e2797c116d437d0702f")
...
public interface IMediaPlayerElementStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IMediaPlayerElementStatics {
    public val __1093769081_Ptr: Pointer?

    public val _1093769081_VtblPtr: Pointer?
      get() = __1093769081_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_SourceProperty(): DependencyProperty? {
      val fnPtr = _1093769081_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1093769081_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_AreTransportControlsEnabledProperty(): DependencyProperty? {
      val fnPtr = _1093769081_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1093769081_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_PosterSourceProperty(): DependencyProperty? {
      val fnPtr = _1093769081_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1093769081_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_StretchProperty(): DependencyProperty? {
      val fnPtr = _1093769081_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1093769081_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_AutoPlayProperty(): DependencyProperty? {
      val fnPtr = _1093769081_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1093769081_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsFullWindowProperty(): DependencyProperty? {
      val fnPtr = _1093769081_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1093769081_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_MediaPlayerProperty(): DependencyProperty? {
      val fnPtr = _1093769081_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1093769081_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IMediaPlayerElementStatics_Impl(
    ...
    public override val __1093769081_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IMediaPlayerElementStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("6f77bba8fb235e2797c116d437d0702f")
    ...
    public override fun toNative(obj: IMediaPlayerElementStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1093769081_Ptr))
  }
