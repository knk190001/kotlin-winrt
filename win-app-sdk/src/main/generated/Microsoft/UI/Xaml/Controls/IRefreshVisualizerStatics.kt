...
@Signature("{3540fe79-590d-546f-bf2a-a30d46e8cdfa}")
@Guid("3540fe79590d546fbf2aa30d46e8cdfa")
@WinRTInterface("3540fe79590d546fbf2aa30d46e8cdfa")
...
public interface IRefreshVisualizerStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IRefreshVisualizerStatics {
    public val __997068851_Ptr: Pointer?

    public val _997068851_VtblPtr: Pointer?
      get() = __997068851_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_InfoProviderProperty(): DependencyProperty? {
      val fnPtr = _997068851_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__997068851_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_OrientationProperty(): DependencyProperty? {
      val fnPtr = _997068851_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__997068851_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ContentProperty(): DependencyProperty? {
      val fnPtr = _997068851_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__997068851_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_StateProperty(): DependencyProperty? {
      val fnPtr = _997068851_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__997068851_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IRefreshVisualizerStatics_Impl(
    ...
    public override val __997068851_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IRefreshVisualizerStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("3540fe79590d546fbf2aa30d46e8cdfa")
    ...
    public override fun toNative(obj: IRefreshVisualizerStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__997068851_Ptr))
  }
