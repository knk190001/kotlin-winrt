...
@Signature("{41c1dec7-f34f-51db-9525-5c149b05a527}")
@Guid("41c1dec7f34f51db95255c149b05a527")
@WinRTInterface("41c1dec7f34f51db95255c149b05a527")
...
public interface ISemanticZoomLocation : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISemanticZoomLocation {
    public val __1272180267_Ptr: Pointer?

    public val _1272180267_VtblPtr: Pointer?
      get() = __1272180267_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Item(): IUnknown? {
      val fnPtr = _1272180267_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IUnknown>()
      val hr = fn.invokeHR(arrayOf(__1272180267_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Item(value: IUnknown?): Unit {
      val fnPtr = _1272180267_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1272180267_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Bounds(): Rect? {
      val fnPtr = _1272180267_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Bounds(value: Rect?): Unit {
      val fnPtr = _1272180267_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1272180267_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class ISemanticZoomLocation_Impl(
    ...
    public override val __1272180267_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISemanticZoomLocation, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("41c1dec7f34f51db95255c149b05a527")
    ...
    public override fun toNative(obj: ISemanticZoomLocation): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1272180267_Ptr))
  }
