...
@Signature("{5ff69946-9b27-583b-a3c0-d44244b1bd38}")
@Guid("5ff699469b27583ba3c0d44244b1bd38")
@WinRTInterface("5ff699469b27583ba3c0d44244b1bd38")
...
public interface ICommandBarOverflowPresenter : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICommandBarOverflowPresenter {
    public val __1169844919_Ptr: Pointer?

    public val _1169844919_VtblPtr: Pointer?
      get() = __1169844919_Ptr?.getPointer(0)
  }

  public class ICommandBarOverflowPresenter_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __1169844919_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICommandBarOverflowPresenter, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("5ff699469b27583ba3c0d44244b1bd38")
    ...
    public override fun toNative(obj: ICommandBarOverflowPresenter): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1169844919_Ptr))
  }
