...
@Signature("{61ac9074-aab3-50b8-8b18-d4d2573a5235}")
@Guid("61ac9074aab350b88b18d4d2573a5235")
@WinRTInterface("61ac9074aab350b88b18d4d2573a5235")
...
public interface IUserControlFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IUserControlFactory {
    public val __768758687_Ptr: Pointer?

    public val _768758687_VtblPtr: Pointer?
      get() = __768758687_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        UserControl? {
      val fnPtr = _768758687_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<UserControl>()
      val hr = fn.invokeHR(arrayOf(__768758687_Ptr, marshalToNative(baseInterface),
  ...
  public class IUserControlFactory_Impl(
    ...
    public override val __768758687_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IUserControlFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("61ac9074aab350b88b18d4d2573a5235")
    ...
    public override fun toNative(obj: IUserControlFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__768758687_Ptr))
  }
