...
@Signature("{a2b43dba-1616-527d-9d32-039573b7fce7}")
@Guid("a2b43dba1616527d9d32039573b7fce7")
@WinRTInterface("a2b43dba1616527d9d32039573b7fce7")
...
public interface IColorSpectrumStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IColorSpectrumStatics {
    public val __855742114_Ptr: Pointer?

    public val _855742114_VtblPtr: Pointer?
      get() = __855742114_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ColorProperty(): DependencyProperty? {
      val fnPtr = _855742114_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__855742114_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_HsvColorProperty(): DependencyProperty? {
      val fnPtr = _855742114_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__855742114_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_MinHueProperty(): DependencyProperty? {
      val fnPtr = _855742114_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__855742114_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_MaxHueProperty(): DependencyProperty? {
      val fnPtr = _855742114_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__855742114_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_MinSaturationProperty(): DependencyProperty? {
      val fnPtr = _855742114_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__855742114_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_MaxSaturationProperty(): DependencyProperty? {
      val fnPtr = _855742114_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__855742114_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_MinValueProperty(): DependencyProperty? {
      val fnPtr = _855742114_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__855742114_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_MaxValueProperty(): DependencyProperty? {
      val fnPtr = _855742114_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__855742114_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ShapeProperty(): DependencyProperty? {
      val fnPtr = _855742114_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__855742114_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ComponentsProperty(): DependencyProperty? {
      val fnPtr = _855742114_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__855742114_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IColorSpectrumStatics_Impl(
    ...
    public override val __855742114_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IColorSpectrumStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("a2b43dba1616527d9d32039573b7fce7")
    ...
    public override fun toNative(obj: IColorSpectrumStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__855742114_Ptr))
  }
