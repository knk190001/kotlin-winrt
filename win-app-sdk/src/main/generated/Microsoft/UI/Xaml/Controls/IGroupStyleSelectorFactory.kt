...
@Signature("{0e0699be-50c2-5c15-aed3-e7bd663e5fad}")
@Guid("0e0699be50c25c15aed3e7bd663e5fad")
@WinRTInterface("0e0699be50c25c15aed3e7bd663e5fad")
...
public interface IGroupStyleSelectorFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IGroupStyleSelectorFactory {
    public val __194358414_Ptr: Pointer?

    public val _194358414_VtblPtr: Pointer?
      get() = __194358414_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        GroupStyleSelector? {
      val fnPtr = _194358414_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<GroupStyleSelector>()
      val hr = fn.invokeHR(arrayOf(__194358414_Ptr, marshalToNative(baseInterface),
  ...
  public class IGroupStyleSelectorFactory_Impl(
    ...
    public override val __194358414_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IGroupStyleSelectorFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("0e0699be50c25c15aed3e7bd663e5fad")
    ...
    public override fun toNative(obj: IGroupStyleSelectorFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__194358414_Ptr))
  }
