...
@Signature("{b1442f0e-f66b-531c-979b-193fd344e2a8}")
@Guid("b1442f0ef66b531c979b193fd344e2a8")
@WinRTInterface("b1442f0ef66b531c979b193fd344e2a8")
...
public interface ITargetPropertyPath : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITargetPropertyPath {
    public val __314340270_Ptr: Pointer?

    public val _314340270_VtblPtr: Pointer?
      get() = __314340270_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Path(): PropertyPath? {
      val fnPtr = _314340270_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<PropertyPath>()
      val hr = fn.invokeHR(arrayOf(__314340270_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Path(value: PropertyPath?): Unit {
      val fnPtr = _314340270_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__314340270_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Target(): IUnknown? {
      val fnPtr = _314340270_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Target(value: IUnknown?): Unit {
      val fnPtr = _314340270_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__314340270_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class ITargetPropertyPath_Impl(
    ...
    public override val __314340270_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITargetPropertyPath, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("b1442f0ef66b531c979b193fd344e2a8")
    ...
    public override fun toNative(obj: ITargetPropertyPath): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__314340270_Ptr))
  }
