...
@Signature("{9ed64c77-329d-502f-a257-f58398edab51}")
@Guid("9ed64c77329d502fa257f58398edab51")
@WinRTInterface("9ed64c77329d502fa257f58398edab51")
...
public interface IParagraph : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IParagraph {
    public val __546465743_Ptr: Pointer?

    public val _546465743_VtblPtr: Pointer?
      get() = __546465743_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Inlines(): InlineCollection? {
      val fnPtr = _546465743_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<InlineCollection>()
      val hr = fn.invokeHR(arrayOf(__546465743_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_TextIndent(): Double {
      val fnPtr = _546465743_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_TextIndent(value: Double): Unit {
      val fnPtr = _546465743_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__546465743_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IParagraph_Impl(
    ...
    public override val __546465743_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IParagraph, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("9ed64c77329d502fa257f58398edab51")
    ...
    public override fun toNative(obj: IParagraph): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__546465743_Ptr))
  }
