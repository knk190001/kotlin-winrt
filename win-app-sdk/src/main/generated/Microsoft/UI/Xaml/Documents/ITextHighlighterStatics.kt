...
@Signature("{4975047a-87ad-51a2-977c-e771de4f4035}")
@Guid("4975047a87ad51a2977ce771de4f4035")
@WinRTInterface("4975047a87ad51a2977ce771de4f4035")
...
public interface ITextHighlighterStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITextHighlighterStatics {
    public val __1862095438_Ptr: Pointer?

    public val _1862095438_VtblPtr: Pointer?
      get() = __1862095438_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ForegroundProperty(): DependencyProperty? {
      val fnPtr = _1862095438_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1862095438_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_BackgroundProperty(): DependencyProperty? {
      val fnPtr = _1862095438_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1862095438_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ITextHighlighterStatics_Impl(
    ...
    public override val __1862095438_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITextHighlighterStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("4975047a87ad51a2977ce771de4f4035")
    ...
    public override fun toNative(obj: ITextHighlighterStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1862095438_Ptr))
  }
