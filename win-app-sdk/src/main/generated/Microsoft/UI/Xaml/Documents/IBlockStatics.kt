...
@Signature("{830feedf-9aa6-56cd-983e-055500171b45}")
@Guid("830feedf9aa656cd983e055500171b45")
@WinRTInterface("830feedf9aa656cd983e055500171b45")
...
public interface IBlockStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IBlockStatics {
    public val __799940821_Ptr: Pointer?

    public val _799940821_VtblPtr: Pointer?
      get() = __799940821_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_TextAlignmentProperty(): DependencyProperty? {
      val fnPtr = _799940821_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__799940821_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_HorizontalTextAlignmentProperty(): DependencyProperty? {
      val fnPtr = _799940821_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__799940821_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_LineHeightProperty(): DependencyProperty? {
      val fnPtr = _799940821_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__799940821_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_LineStackingStrategyProperty(): DependencyProperty? {
      val fnPtr = _799940821_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__799940821_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_MarginProperty(): DependencyProperty? {
      val fnPtr = _799940821_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__799940821_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IBlockStatics_Impl(
    ...
    public override val __799940821_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IBlockStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("830feedf9aa656cd983e055500171b45")
    ...
    public override fun toNative(obj: IBlockStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__799940821_Ptr))
  }
