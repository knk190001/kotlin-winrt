...
import Microsoft.UI.Xaml.Documents.ITextHighlighterFactory.ABI.IID
...
@Signature("rc(Microsoft.UI.Xaml.Documents.TextHighlighter;{b756e861-1d2b-5f6f-81fd-c51a5bc068ff})")
...
public open class TextHighlighter(
  ...
  private val __301989513_Interface: ITextHighlighter.WithDefault by lazy {
    as_301989513()
  }


  public override val __301989513_Ptr: JNAPointer? by lazy {
    __301989513_Interface.__301989513_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__301989513_Interface)

  public constructor() : this(ABI.activate())

  private fun as_301989513(): ITextHighlighter.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<TextHighlighter, MemoryAddress> {
    ...
    public fun createITextHighlighterStatics(): ITextHighlighterStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Documents.TextHighlighter".toHandle(),refiid,interfacePtr)
    ...
    public fun createITextHighlighterFactory(): ITextHighlighterFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Documents.TextHighlighter".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
