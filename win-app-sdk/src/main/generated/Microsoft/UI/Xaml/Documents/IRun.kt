...
@Signature("{1f905239-37cb-590b-9132-3ffb7741906e}")
@Guid("1f90523937cb590b91323ffb7741906e")
@WinRTInterface("1f90523937cb590b91323ffb7741906e")
...
public interface IRun : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IRun {
    public val __1717999502_Ptr: Pointer?

    public val _1717999502_VtblPtr: Pointer?
      get() = __1717999502_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Text(): String? {
      val fnPtr = _1717999502_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__1717999502_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Text(value: String?): Unit {
      val fnPtr = _1717999502_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1717999502_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_FlowDirection(): FlowDirection? {
      val fnPtr = _1717999502_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_FlowDirection(value: FlowDirection?): Unit {
      val fnPtr = _1717999502_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1717999502_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IRun_Impl(
    ...
    public override val __1717999502_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IRun, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("1f90523937cb590b91323ffb7741906e")
    ...
    public override fun toNative(obj: IRun): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1717999502_Ptr))
  }
