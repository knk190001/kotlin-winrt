...
@Signature("rc(Microsoft.UI.Xaml.Documents.Typography;{fa27e2e3-be5e-5d21-9a5e-90cf102af828})")
@WinRTByReference(brClass = Typography.ByReference::class)
public class Typography(
  ptr: JNAPointer? = NULL
) : PointerType(ptr), ITypography.WithDefault, IWinRTObject {
  private val __626360628_Interface: ITypography.WithDefault by lazy {
    as_626360628()
  }


  public override val __626360628_Ptr: JNAPointer? by lazy {
    __626360628_Interface.__626360628_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__626360628_Interface)

  private fun as_626360628(): ITypography.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<Typography, MemoryAddress> {
    ...
    public fun createITypographyStatics(): ITypographyStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Documents.Typography".toHandle(),refiid,interfacePtr)
