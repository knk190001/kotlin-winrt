...
import Microsoft.UI.Xaml.Media.StyleSimulations
...
@Signature("{0fbf8cfe-18e7-5e45-9fa3-d2d0927958f4}")
@Guid("0fbf8cfe18e75e459fa3d2d0927958f4")
@WinRTInterface("0fbf8cfe18e75e459fa3d2d0927958f4")
...
public interface IGlyphs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IGlyphs {
    public val __1770071268_Ptr: Pointer?

    public val _1770071268_VtblPtr: Pointer?
      get() = __1770071268_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_UnicodeString(): String? {
      val fnPtr = _1770071268_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__1770071268_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_UnicodeString(value: String?): Unit {
      val fnPtr = _1770071268_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1770071268_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Indices(): String? {
      val fnPtr = _1770071268_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__1770071268_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Indices(value: String?): Unit {
      val fnPtr = _1770071268_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1770071268_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_FontUri(): Uri? {
      val fnPtr = _1770071268_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_FontUri(value: Uri?): Unit {
      val fnPtr = _1770071268_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1770071268_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_StyleSimulations(): StyleSimulations? {
      val fnPtr = _1770071268_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_StyleSimulations(value: StyleSimulations?): Unit {
      val fnPtr = _1770071268_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1770071268_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_FontRenderingEmSize(): Double {
      val fnPtr = _1770071268_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_FontRenderingEmSize(value: Double): Unit {
      val fnPtr = _1770071268_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1770071268_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_OriginX(): Double {
      val fnPtr = _1770071268_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1770071268_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_OriginX(value: Double): Unit {
      val fnPtr = _1770071268_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1770071268_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_OriginY(): Double {
      val fnPtr = _1770071268_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1770071268_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_OriginY(value: Double): Unit {
      val fnPtr = _1770071268_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1770071268_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Fill(): Brush? {
      val fnPtr = _1770071268_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Fill(value: Brush?): Unit {
      val fnPtr = _1770071268_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1770071268_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_IsColorFontEnabled(): Boolean {
      val fnPtr = _1770071268_VtblPtr!!.getPointer(22L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_IsColorFontEnabled(value: Boolean): Unit {
      val fnPtr = _1770071268_VtblPtr!!.getPointer(23L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1770071268_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ColorFontPaletteIndex(): Int {
      val fnPtr = _1770071268_VtblPtr!!.getPointer(24L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_ColorFontPaletteIndex(value: Int): Unit {
      val fnPtr = _1770071268_VtblPtr!!.getPointer(25L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1770071268_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IGlyphs_Impl(
    ...
    public override val __1770071268_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IGlyphs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("0fbf8cfe18e75e459fa3d2d0927958f4")
    ...
    public override fun toNative(obj: IGlyphs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1770071268_Ptr))
  }
