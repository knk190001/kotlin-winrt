...
@Signature("{69c7311f-c019-5b93-b511-81418543bab7}")
@Guid("69c7311fc0195b93b51181418543bab7")
@WinRTInterface("69c7311fc0195b93b51181418543bab7")
...
public interface ITextHighlighterFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITextHighlighterFactory {
    public val __1627618413_Ptr: Pointer?

    public val _1627618413_VtblPtr: Pointer?
      get() = __1627618413_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        TextHighlighter? {
      val fnPtr = _1627618413_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<TextHighlighter>()
      val hr = fn.invokeHR(arrayOf(__1627618413_Ptr, marshalToNative(baseInterface),
  ...
  public class ITextHighlighterFactory_Impl(
    ...
    public override val __1627618413_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITextHighlighterFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("69c7311fc0195b93b51181418543bab7")
    ...
    public override fun toNative(obj: ITextHighlighterFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1627618413_Ptr))
  }
