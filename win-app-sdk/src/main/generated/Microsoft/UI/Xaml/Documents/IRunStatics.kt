...
@Signature("{051b3c5b-7600-51a5-80c5-93eb50fd684f}")
@Guid("051b3c5b760051a580c593eb50fd684f")
@WinRTInterface("051b3c5b760051a580c593eb50fd684f")
...
public interface IRunStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IRunStatics {
    public val __492635223_Ptr: Pointer?

    public val _492635223_VtblPtr: Pointer?
      get() = __492635223_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_FlowDirectionProperty(): DependencyProperty? {
      val fnPtr = _492635223_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__492635223_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IRunStatics_Impl(
    ...
    public override val __492635223_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IRunStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("051b3c5b760051a580c593eb50fd684f")
    ...
    public override fun toNative(obj: IRunStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__492635223_Ptr))
  }
