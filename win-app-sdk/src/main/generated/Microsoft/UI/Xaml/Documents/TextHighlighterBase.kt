...
@Signature("rc(Microsoft.UI.Xaml.Documents.TextHighlighterBase;{5c21aaf0-3a17-5468-8aac-be14db0ed8c1})")
...
public class TextHighlighterBase(
  ...
  private val __46393576_Interface: ITextHighlighterBase.WithDefault by lazy {
    as_46393576()
  }


  public override val __46393576_Ptr: JNAPointer? by lazy {
    __46393576_Interface.__46393576_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__46393576_Interface)

  private fun as_46393576(): ITextHighlighterBase.WithDefault {
    if(pointer == NULL) {
