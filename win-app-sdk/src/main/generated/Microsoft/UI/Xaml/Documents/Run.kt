...
@Signature("rc(Microsoft.UI.Xaml.Documents.Run;{1f905239-37cb-590b-9132-3ffb7741906e})")
@WinRTByReference(brClass = Run.ByReference::class)
public class Run(
  ptr: JNAPointer? = NULL
) : Inline(ptr), IRun.WithDefault, IWinRTObject {
  private val __1717999502_Interface: IRun.WithDefault by lazy {
    as_1717999502()
  }


  public override val __1717999502_Ptr: JNAPointer? by lazy {
    __1717999502_Interface.__1717999502_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1717999502_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1717999502(): IRun.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<Run, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr = INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Documents.Run".toHandle(), refiid,
          iAFPtr)
      checkHR(hr)
    ...
    public fun createIRunStatics(): IRunStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Documents.Run".toHandle(),refiid,interfacePtr)
