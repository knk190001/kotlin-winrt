...
import Microsoft.UI.Xaml.FontCapitals
import Microsoft.UI.Xaml.FontEastAsianLanguage
import Microsoft.UI.Xaml.FontEastAsianWidths
import Microsoft.UI.Xaml.FontFraction
import Microsoft.UI.Xaml.FontNumeralAlignment
import Microsoft.UI.Xaml.FontNumeralStyle
import Microsoft.UI.Xaml.FontVariants
...
@Signature("{55fe4535-2125-533a-ada8-27be2b9e1193}")
@Guid("55fe45352125533aada827be2b9e1193")
@WinRTInterface("55fe45352125533aada827be2b9e1193")
...
public interface ITypographyStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITypographyStatics {
    public val __1069554521_Ptr: Pointer?

    public val _1069554521_VtblPtr: Pointer?
      get() = __1069554521_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_AnnotationAlternatesProperty(): DependencyProperty? {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetAnnotationAlternates(element: DependencyObject?): Int {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun SetAnnotationAlternates(element: DependencyObject?, value: Int): Unit {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_EastAsianExpertFormsProperty(): DependencyProperty? {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetEastAsianExpertForms(element: DependencyObject?): Boolean {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun SetEastAsianExpertForms(element: DependencyObject?, value: Boolean): Unit {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_EastAsianLanguageProperty(): DependencyProperty? {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetEastAsianLanguage(element: DependencyObject?): FontEastAsianLanguage? {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun SetEastAsianLanguage(element: DependencyObject?,
      ...
      val fnPtr = _1069554521_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element),
    ...
    public override fun get_EastAsianWidthsProperty(): DependencyProperty? {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetEastAsianWidths(element: DependencyObject?): FontEastAsianWidths? {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun SetEastAsianWidths(element: DependencyObject?, value: FontEastAsianWidths?):
        Unit {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element),
          marshalToNative(value),))
      if (hr.toInt() != 0) {
    ...
    public override fun get_StandardLigaturesProperty(): DependencyProperty? {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetStandardLigatures(element: DependencyObject?): Boolean {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
    ...
    public override fun SetStandardLigatures(element: DependencyObject?, value: Boolean): Unit {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ContextualLigaturesProperty(): DependencyProperty? {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetContextualLigatures(element: DependencyObject?): Boolean {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(22L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
    ...
    public override fun SetContextualLigatures(element: DependencyObject?, value: Boolean): Unit {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(23L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_DiscretionaryLigaturesProperty(): DependencyProperty? {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(24L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetDiscretionaryLigatures(element: DependencyObject?): Boolean {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(25L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
    ...
    public override fun SetDiscretionaryLigatures(element: DependencyObject?, value: Boolean):
        Unit {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(26L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_HistoricalLigaturesProperty(): DependencyProperty? {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(27L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetHistoricalLigatures(element: DependencyObject?): Boolean {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(28L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
    ...
    public override fun SetHistoricalLigatures(element: DependencyObject?, value: Boolean): Unit {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(29L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_StandardSwashesProperty(): DependencyProperty? {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(30L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetStandardSwashes(element: DependencyObject?): Int {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(31L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
    ...
    public override fun SetStandardSwashes(element: DependencyObject?, value: Int): Unit {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(32L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ContextualSwashesProperty(): DependencyProperty? {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(33L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetContextualSwashes(element: DependencyObject?): Int {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(34L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
    ...
    public override fun SetContextualSwashes(element: DependencyObject?, value: Int): Unit {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(35L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ContextualAlternatesProperty(): DependencyProperty? {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(36L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetContextualAlternates(element: DependencyObject?): Boolean {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(37L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
    ...
    public override fun SetContextualAlternates(element: DependencyObject?, value: Boolean): Unit {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(38L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_StylisticAlternatesProperty(): DependencyProperty? {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(39L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetStylisticAlternates(element: DependencyObject?): Int {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(40L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
    ...
    public override fun SetStylisticAlternates(element: DependencyObject?, value: Int): Unit {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(41L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_StylisticSet1Property(): DependencyProperty? {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(42L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetStylisticSet1(element: DependencyObject?): Boolean {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(43L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
    ...
    public override fun SetStylisticSet1(element: DependencyObject?, value: Boolean): Unit {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(44L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_StylisticSet2Property(): DependencyProperty? {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(45L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetStylisticSet2(element: DependencyObject?): Boolean {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(46L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
    ...
    public override fun SetStylisticSet2(element: DependencyObject?, value: Boolean): Unit {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(47L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_StylisticSet3Property(): DependencyProperty? {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(48L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetStylisticSet3(element: DependencyObject?): Boolean {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(49L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
    ...
    public override fun SetStylisticSet3(element: DependencyObject?, value: Boolean): Unit {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(50L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_StylisticSet4Property(): DependencyProperty? {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(51L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetStylisticSet4(element: DependencyObject?): Boolean {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(52L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
    ...
    public override fun SetStylisticSet4(element: DependencyObject?, value: Boolean): Unit {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(53L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_StylisticSet5Property(): DependencyProperty? {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(54L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetStylisticSet5(element: DependencyObject?): Boolean {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(55L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
    ...
    public override fun SetStylisticSet5(element: DependencyObject?, value: Boolean): Unit {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(56L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_StylisticSet6Property(): DependencyProperty? {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(57L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetStylisticSet6(element: DependencyObject?): Boolean {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(58L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
    ...
    public override fun SetStylisticSet6(element: DependencyObject?, value: Boolean): Unit {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(59L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_StylisticSet7Property(): DependencyProperty? {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(60L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetStylisticSet7(element: DependencyObject?): Boolean {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(61L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
    ...
    public override fun SetStylisticSet7(element: DependencyObject?, value: Boolean): Unit {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(62L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_StylisticSet8Property(): DependencyProperty? {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(63L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetStylisticSet8(element: DependencyObject?): Boolean {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(64L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
    ...
    public override fun SetStylisticSet8(element: DependencyObject?, value: Boolean): Unit {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(65L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_StylisticSet9Property(): DependencyProperty? {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(66L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetStylisticSet9(element: DependencyObject?): Boolean {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(67L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
    ...
    public override fun SetStylisticSet9(element: DependencyObject?, value: Boolean): Unit {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(68L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_StylisticSet10Property(): DependencyProperty? {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(69L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetStylisticSet10(element: DependencyObject?): Boolean {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(70L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
    ...
    public override fun SetStylisticSet10(element: DependencyObject?, value: Boolean): Unit {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(71L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_StylisticSet11Property(): DependencyProperty? {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(72L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetStylisticSet11(element: DependencyObject?): Boolean {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(73L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
    ...
    public override fun SetStylisticSet11(element: DependencyObject?, value: Boolean): Unit {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(74L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_StylisticSet12Property(): DependencyProperty? {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(75L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetStylisticSet12(element: DependencyObject?): Boolean {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(76L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
    ...
    public override fun SetStylisticSet12(element: DependencyObject?, value: Boolean): Unit {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(77L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_StylisticSet13Property(): DependencyProperty? {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(78L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetStylisticSet13(element: DependencyObject?): Boolean {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(79L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
    ...
    public override fun SetStylisticSet13(element: DependencyObject?, value: Boolean): Unit {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(80L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_StylisticSet14Property(): DependencyProperty? {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(81L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetStylisticSet14(element: DependencyObject?): Boolean {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(82L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
    ...
    public override fun SetStylisticSet14(element: DependencyObject?, value: Boolean): Unit {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(83L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_StylisticSet15Property(): DependencyProperty? {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(84L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetStylisticSet15(element: DependencyObject?): Boolean {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(85L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
    ...
    public override fun SetStylisticSet15(element: DependencyObject?, value: Boolean): Unit {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(86L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_StylisticSet16Property(): DependencyProperty? {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(87L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetStylisticSet16(element: DependencyObject?): Boolean {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(88L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
    ...
    public override fun SetStylisticSet16(element: DependencyObject?, value: Boolean): Unit {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(89L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_StylisticSet17Property(): DependencyProperty? {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(90L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetStylisticSet17(element: DependencyObject?): Boolean {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(91L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
    ...
    public override fun SetStylisticSet17(element: DependencyObject?, value: Boolean): Unit {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(92L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_StylisticSet18Property(): DependencyProperty? {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(93L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetStylisticSet18(element: DependencyObject?): Boolean {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(94L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
    ...
    public override fun SetStylisticSet18(element: DependencyObject?, value: Boolean): Unit {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(95L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_StylisticSet19Property(): DependencyProperty? {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(96L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetStylisticSet19(element: DependencyObject?): Boolean {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(97L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
    ...
    public override fun SetStylisticSet19(element: DependencyObject?, value: Boolean): Unit {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(98L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_StylisticSet20Property(): DependencyProperty? {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(99L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetStylisticSet20(element: DependencyObject?): Boolean {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(100L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
    ...
    public override fun SetStylisticSet20(element: DependencyObject?, value: Boolean): Unit {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(101L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_CapitalsProperty(): DependencyProperty? {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(102L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetCapitals(element: DependencyObject?): FontCapitals? {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(103L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun SetCapitals(element: DependencyObject?, value: FontCapitals?): Unit {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(104L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element),
          marshalToNative(value),))
      if (hr.toInt() != 0) {
    ...
    public override fun get_CapitalSpacingProperty(): DependencyProperty? {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(105L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetCapitalSpacing(element: DependencyObject?): Boolean {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(106L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
    ...
    public override fun SetCapitalSpacing(element: DependencyObject?, value: Boolean): Unit {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(107L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_KerningProperty(): DependencyProperty? {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(108L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetKerning(element: DependencyObject?): Boolean {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(109L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
    ...
    public override fun SetKerning(element: DependencyObject?, value: Boolean): Unit {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(110L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_CaseSensitiveFormsProperty(): DependencyProperty? {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(111L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetCaseSensitiveForms(element: DependencyObject?): Boolean {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(112L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
    ...
    public override fun SetCaseSensitiveForms(element: DependencyObject?, value: Boolean): Unit {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(113L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_HistoricalFormsProperty(): DependencyProperty? {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(114L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetHistoricalForms(element: DependencyObject?): Boolean {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(115L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
    ...
    public override fun SetHistoricalForms(element: DependencyObject?, value: Boolean): Unit {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(116L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_FractionProperty(): DependencyProperty? {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(117L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetFraction(element: DependencyObject?): FontFraction? {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(118L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun SetFraction(element: DependencyObject?, value: FontFraction?): Unit {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(119L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element),
          marshalToNative(value),))
      if (hr.toInt() != 0) {
    ...
    public override fun get_NumeralStyleProperty(): DependencyProperty? {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(120L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetNumeralStyle(element: DependencyObject?): FontNumeralStyle? {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(121L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun SetNumeralStyle(element: DependencyObject?, value: FontNumeralStyle?):
        Unit {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(122L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element),
          marshalToNative(value),))
      if (hr.toInt() != 0) {
    ...
    public override fun get_NumeralAlignmentProperty(): DependencyProperty? {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(123L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetNumeralAlignment(element: DependencyObject?): FontNumeralAlignment? {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(124L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun SetNumeralAlignment(element: DependencyObject?,
      ...
      val fnPtr = _1069554521_VtblPtr!!.getPointer(125L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element),
          marshalToNative(value),))
      if (hr.toInt() != 0) {
    ...
    public override fun get_SlashedZeroProperty(): DependencyProperty? {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(126L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetSlashedZero(element: DependencyObject?): Boolean {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(127L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
    ...
    public override fun SetSlashedZero(element: DependencyObject?, value: Boolean): Unit {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(128L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_MathematicalGreekProperty(): DependencyProperty? {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(129L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetMathematicalGreek(element: DependencyObject?): Boolean {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(130L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), result))
      if (hr.toInt() != 0) {
    ...
    public override fun SetMathematicalGreek(element: DependencyObject?, value: Boolean): Unit {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(131L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element), value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_VariantsProperty(): DependencyProperty? {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(132L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetVariants(element: DependencyObject?): FontVariants? {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(133L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun SetVariants(element: DependencyObject?, value: FontVariants?): Unit {
      val fnPtr = _1069554521_VtblPtr!!.getPointer(134L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1069554521_Ptr, marshalToNative(element),
          marshalToNative(value),))
      if (hr.toInt() != 0) {
  ...
  public class ITypographyStatics_Impl(
    ...
    public override val __1069554521_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITypographyStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("55fe45352125533aada827be2b9e1193")
    ...
    public override fun toNative(obj: ITypographyStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1069554521_Ptr))
  }
