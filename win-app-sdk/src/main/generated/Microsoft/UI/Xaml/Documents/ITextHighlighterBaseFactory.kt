...
@Signature("{e091e461-53ab-599e-aaea-800adc72da4f}")
@Guid("e091e46153ab599eaaea800adc72da4f")
@WinRTInterface("e091e46153ab599eaaea800adc72da4f")
...
public interface ITextHighlighterBaseFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITextHighlighterBaseFactory {
    public val __1119587074_Ptr: Pointer?

    public val _1119587074_VtblPtr: Pointer?
      get() = __1119587074_Ptr?.getPointer(0)
  }

  public class ITextHighlighterBaseFactory_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __1119587074_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITextHighlighterBaseFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("e091e46153ab599eaaea800adc72da4f")
    ...
    public override fun toNative(obj: ITextHighlighterBaseFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1119587074_Ptr))
  }
