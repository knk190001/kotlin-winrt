...
@Signature("rc(Microsoft.UI.Xaml.TargetPropertyPath;{b1442f0e-f66b-531c-979b-193fd344e2a8})")
...
public class TargetPropertyPath(
  ...
  private val __314340270_Interface: ITargetPropertyPath.WithDefault by lazy {
    as_314340270()
  }


  public override val __314340270_Ptr: JNAPointer? by lazy {
    __314340270_Interface.__314340270_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__314340270_Interface)

  public constructor() : this(ABI.activate())

  public constructor(targetProperty: DependencyProperty) : this(ABI.activate(targetProperty))

  private fun as_314340270(): ITargetPropertyPath.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<TargetPropertyPath, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr = INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.TargetPropertyPath".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createITargetPropertyPathFactory(): ITargetPropertyPathFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.TargetPropertyPath".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
