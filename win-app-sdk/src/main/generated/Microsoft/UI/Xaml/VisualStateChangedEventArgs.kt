...
@Signature("rc(Microsoft.UI.Xaml.VisualStateChangedEventArgs;{11de9510-a195-577b-88c8-06391618868c})")
...
public class VisualStateChangedEventArgs(
  ...
  private val __866733293_Interface: IVisualStateChangedEventArgs.WithDefault by lazy {
    as_866733293()
  }


  public override val __866733293_Ptr: JNAPointer? by lazy {
    __866733293_Interface.__866733293_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__866733293_Interface)

  public constructor() : this(ABI.activate())

  private fun as_866733293(): IVisualStateChangedEventArgs.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<VisualStateChangedEventArgs, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.VisualStateChangedEventArgs".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
