...
import Microsoft.UI.Xaml.Printing.IPrintDocumentFactory.ABI.IID
...
@Signature("rc(Microsoft.UI.Xaml.Printing.PrintDocument;{1e40f1fc-5d33-5fe9-ba3e-954c0d161524})")
...
public open class PrintDocument(
  ...
  private val __1818896800_Interface: IPrintDocument.WithDefault by lazy {
    as_1818896800()
  }


  public override val __1818896800_Ptr: JNAPointer? by lazy {
    __1818896800_Interface.__1818896800_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1818896800_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1818896800(): IPrintDocument.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<PrintDocument, MemoryAddress> {
    ...
    public fun createIPrintDocumentStatics(): IPrintDocumentStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Printing.PrintDocument".toHandle(),refiid,interfacePtr)
    ...
    public fun createIPrintDocumentFactory(): IPrintDocumentFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Printing.PrintDocument".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
