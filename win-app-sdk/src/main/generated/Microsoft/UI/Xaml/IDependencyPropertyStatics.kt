...
@Signature("{61ddc651-0383-5d6f-98ce-5c046aaaaa8f}")
@Guid("61ddc65103835d6f98ce5c046aaaaa8f")
@WinRTInterface("61ddc65103835d6f98ce5c046aaaaa8f")
...
public interface IDependencyPropertyStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IDependencyPropertyStatics {
    public val __1935127810_Ptr: Pointer?

    public val _1935127810_VtblPtr: Pointer?
      get() = __1935127810_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_UnsetValue(): IUnknown? {
      val fnPtr = _1935127810_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IUnknown>()
      val hr = fn.invokeHR(arrayOf(__1935127810_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun Register(
      ...
      val fnPtr = _1935127810_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1935127810_Ptr, marshalToNative(name),
    ...
    public override fun RegisterAttached(
      ...
      val fnPtr = _1935127810_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1935127810_Ptr, marshalToNative(name),
  ...
  public class IDependencyPropertyStatics_Impl(
    ...
    public override val __1935127810_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IDependencyPropertyStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("61ddc65103835d6f98ce5c046aaaaa8f")
    ...
    public override fun toNative(obj: IDependencyPropertyStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1935127810_Ptr))
  }
