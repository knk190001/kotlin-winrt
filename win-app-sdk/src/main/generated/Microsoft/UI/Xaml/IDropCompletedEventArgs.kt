...
@Signature("{e700082d-c640-5d44-b23a-f213dfbeb245}")
@Guid("e700082dc6405d44b23af213dfbeb245")
@WinRTInterface("e700082dc6405d44b23af213dfbeb245")
...
public interface IDropCompletedEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IDropCompletedEventArgs {
    public val __1002950370_Ptr: Pointer?

    public val _1002950370_VtblPtr: Pointer?
      get() = __1002950370_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_DropResult(): DataPackageOperation? {
      val fnPtr = _1002950370_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DataPackageOperation>()
      val hr = fn.invokeHR(arrayOf(__1002950370_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IDropCompletedEventArgs_Impl(
    ...
    public override val __1002950370_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IDropCompletedEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("e700082dc6405d44b23af213dfbeb245")
    ...
    public override fun toNative(obj: IDropCompletedEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1002950370_Ptr))
  }
