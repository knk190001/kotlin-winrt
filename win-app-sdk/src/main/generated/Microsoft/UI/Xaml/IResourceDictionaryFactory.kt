...
@Signature("{ea22a48f-ab71-56f6-a392-d82310c8aa7b}")
@Guid("ea22a48fab7156f6a392d82310c8aa7b")
@WinRTInterface("ea22a48fab7156f6a392d82310c8aa7b")
...
public interface IResourceDictionaryFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IResourceDictionaryFactory {
    public val __1658737343_Ptr: Pointer?

    public val _1658737343_VtblPtr: Pointer?
      get() = __1658737343_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        ResourceDictionary? {
      val fnPtr = _1658737343_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ResourceDictionary>()
      val hr = fn.invokeHR(arrayOf(__1658737343_Ptr, marshalToNative(baseInterface),
  ...
  public class IResourceDictionaryFactory_Impl(
    ...
    public override val __1658737343_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IResourceDictionaryFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("ea22a48fab7156f6a392d82310c8aa7b")
    ...
    public override fun toNative(obj: IResourceDictionaryFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1658737343_Ptr))
  }
