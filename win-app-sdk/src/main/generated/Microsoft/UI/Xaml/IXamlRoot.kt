...
@Signature("{60cb215a-ad15-520a-8b01-4416824f0441}")
@Guid("60cb215aad15520a8b014416824f0441")
@WinRTInterface("60cb215aad15520a8b014416824f0441")
...
public interface IXamlRoot : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IXamlRoot {
    public val __1913657489_Ptr: Pointer?

    public val _1913657489_VtblPtr: Pointer?
      get() = __1913657489_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Content(): UIElement? {
      val fnPtr = _1913657489_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<UIElement>()
      val hr = fn.invokeHR(arrayOf(__1913657489_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Size(): Size? {
      val fnPtr = _1913657489_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_RasterizationScale(): Double {
      val fnPtr = _1913657489_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_IsHostVisible(): Boolean {
      val fnPtr = _1913657489_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun add_Changed(handler: TypedEventHandler<XamlRoot?,
      ...
      val fnPtr = _1913657489_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__1913657489_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun remove_Changed(token: EventRegistrationToken?): Unit {
      val fnPtr = _1913657489_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1913657489_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IXamlRoot_Impl(
    ...
    public override val __1913657489_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IXamlRoot, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("60cb215aad15520a8b014416824f0441")
    ...
    public override fun toNative(obj: IXamlRoot): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1913657489_Ptr))
  }
