...
@Signature("{636e8159-2d82-538a-8483-cd576e41d0df}")
@Guid("636e81592d82538a8483cd576e41d0df")
@WinRTInterface("636e81592d82538a8483cd576e41d0df")
...
public interface IEffectiveViewportChangedEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IEffectiveViewportChangedEventArgs {
    public val __1653917801_Ptr: Pointer?

    public val _1653917801_VtblPtr: Pointer?
      get() = __1653917801_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_EffectiveViewport(): Rect? {
      val fnPtr = _1653917801_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Rect>()
      val hr = fn.invokeHR(arrayOf(__1653917801_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_MaxViewport(): Rect? {
      val fnPtr = _1653917801_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Rect>()
      val hr = fn.invokeHR(arrayOf(__1653917801_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_BringIntoViewDistanceX(): Double {
      val fnPtr = _1653917801_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_BringIntoViewDistanceY(): Double {
      val fnPtr = _1653917801_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__1653917801_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IEffectiveViewportChangedEventArgs_Impl(
    ...
    public override val __1653917801_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IEffectiveViewportChangedEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("636e81592d82538a8483cd576e41d0df")
    ...
    public override fun toNative(obj: IEffectiveViewportChangedEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1653917801_Ptr))
  }
