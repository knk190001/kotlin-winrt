...
import Microsoft.UI.Xaml.Media.DoubleCollection
import Microsoft.UI.Xaml.Media.PenLineCap
import Microsoft.UI.Xaml.Media.PenLineJoin
...
@Signature("{9941aad3-6af2-5ba2-9085-8506d5f2485e}")
@Guid("9941aad36af25ba290858506d5f2485e")
@WinRTInterface("9941aad36af25ba290858506d5f2485e")
...
public interface IShape : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IShape {
    public val __749576822_Ptr: Pointer?

    public val _749576822_VtblPtr: Pointer?
      get() = __749576822_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Fill(): Brush? {
      val fnPtr = _749576822_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Brush>()
      val hr = fn.invokeHR(arrayOf(__749576822_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Fill(value: Brush?): Unit {
      val fnPtr = _749576822_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__749576822_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Stroke(): Brush? {
      val fnPtr = _749576822_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Brush>()
      val hr = fn.invokeHR(arrayOf(__749576822_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Stroke(value: Brush?): Unit {
      val fnPtr = _749576822_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__749576822_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_StrokeMiterLimit(): Double {
      val fnPtr = _749576822_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_StrokeMiterLimit(value: Double): Unit {
      val fnPtr = _749576822_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__749576822_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_StrokeThickness(): Double {
      val fnPtr = _749576822_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__749576822_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_StrokeThickness(value: Double): Unit {
      val fnPtr = _749576822_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__749576822_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_StrokeStartLineCap(): PenLineCap? {
      val fnPtr = _749576822_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_StrokeStartLineCap(value: PenLineCap?): Unit {
      val fnPtr = _749576822_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__749576822_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_StrokeEndLineCap(): PenLineCap? {
      val fnPtr = _749576822_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<PenLineCap>()
      val hr = fn.invokeHR(arrayOf(__749576822_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_StrokeEndLineCap(value: PenLineCap?): Unit {
      val fnPtr = _749576822_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__749576822_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_StrokeLineJoin(): PenLineJoin? {
      val fnPtr = _749576822_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_StrokeLineJoin(value: PenLineJoin?): Unit {
      val fnPtr = _749576822_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__749576822_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_StrokeDashOffset(): Double {
      val fnPtr = _749576822_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__749576822_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_StrokeDashOffset(value: Double): Unit {
      val fnPtr = _749576822_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__749576822_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_StrokeDashCap(): PenLineCap? {
      val fnPtr = _749576822_VtblPtr!!.getPointer(22L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<PenLineCap>()
      val hr = fn.invokeHR(arrayOf(__749576822_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_StrokeDashCap(value: PenLineCap?): Unit {
      val fnPtr = _749576822_VtblPtr!!.getPointer(23L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__749576822_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_StrokeDashArray(): DoubleCollection? {
      val fnPtr = _749576822_VtblPtr!!.getPointer(24L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_StrokeDashArray(value: DoubleCollection?): Unit {
      val fnPtr = _749576822_VtblPtr!!.getPointer(25L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__749576822_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Stretch(): Stretch? {
      val fnPtr = _749576822_VtblPtr!!.getPointer(26L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Stretch(value: Stretch?): Unit {
      val fnPtr = _749576822_VtblPtr!!.getPointer(27L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__749576822_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_GeometryTransform(): Transform? {
      val fnPtr = _749576822_VtblPtr!!.getPointer(28L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun GetAlphaMask(): CompositionBrush? {
      val fnPtr = _749576822_VtblPtr!!.getPointer(29L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class IShape_Impl(
    ...
    public override val __749576822_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IShape, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("9941aad36af25ba290858506d5f2485e")
    ...
    public override fun toNative(obj: IShape): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__749576822_Ptr))
  }
