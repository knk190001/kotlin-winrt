...
@Signature("{507b3858-af7e-559b-a87e-4cc6a5d8ba96}")
@Guid("507b3858af7e559ba87e4cc6a5d8ba96")
@WinRTInterface("507b3858af7e559ba87e4cc6a5d8ba96")
...
public interface ILine : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ILine {
    public val __855256703_Ptr: Pointer?

    public val _855256703_VtblPtr: Pointer?
      get() = __855256703_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_X1(): Double {
      val fnPtr = _855256703_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__855256703_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_X1(value: Double): Unit {
      val fnPtr = _855256703_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__855256703_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Y1(): Double {
      val fnPtr = _855256703_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__855256703_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Y1(value: Double): Unit {
      val fnPtr = _855256703_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__855256703_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_X2(): Double {
      val fnPtr = _855256703_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__855256703_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_X2(value: Double): Unit {
      val fnPtr = _855256703_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__855256703_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Y2(): Double {
      val fnPtr = _855256703_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__855256703_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Y2(value: Double): Unit {
      val fnPtr = _855256703_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__855256703_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class ILine_Impl(
    ...
    public override val __855256703_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ILine, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("507b3858af7e559ba87e4cc6a5d8ba96")
    ...
    public override fun toNative(obj: ILine): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__855256703_Ptr))
  }
