...
@Signature("{4fecafaf-8265-5252-ba5c-f43639f974a5}")
@Guid("4fecafaf82655252ba5cf43639f974a5")
@WinRTInterface("4fecafaf82655252ba5cf43639f974a5")
...
public interface IShapeFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IShapeFactory {
    public val __688297396_Ptr: Pointer?

    public val _688297396_VtblPtr: Pointer?
      get() = __688297396_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        Shape? {
      val fnPtr = _688297396_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Shape>()
      val hr = fn.invokeHR(arrayOf(__688297396_Ptr, marshalToNative(baseInterface),
  ...
  public class IShapeFactory_Impl(
    ...
    public override val __688297396_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IShapeFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("4fecafaf82655252ba5cf43639f974a5")
    ...
    public override fun toNative(obj: IShapeFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__688297396_Ptr))
  }
