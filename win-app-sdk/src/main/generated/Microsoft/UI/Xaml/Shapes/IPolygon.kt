...
@Signature("{fa126347-d1d4-54dd-b1a4-c35019397944}")
@Guid("fa126347d1d454ddb1a4c35019397944")
@WinRTInterface("fa126347d1d454ddb1a4c35019397944")
...
public interface IPolygon : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPolygon {
    public val __632112847_Ptr: Pointer?

    public val _632112847_VtblPtr: Pointer?
      get() = __632112847_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_FillRule(): FillRule? {
      val fnPtr = _632112847_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<FillRule>()
      val hr = fn.invokeHR(arrayOf(__632112847_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_FillRule(value: FillRule?): Unit {
      val fnPtr = _632112847_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__632112847_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Points(): PointCollection? {
      val fnPtr = _632112847_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Points(value: PointCollection?): Unit {
      val fnPtr = _632112847_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__632112847_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IPolygon_Impl(
    ...
    public override val __632112847_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPolygon, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("fa126347d1d454ddb1a4c35019397944")
    ...
    public override fun toNative(obj: IPolygon): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__632112847_Ptr))
  }
