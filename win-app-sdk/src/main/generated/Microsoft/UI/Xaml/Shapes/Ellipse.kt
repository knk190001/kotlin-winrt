...
@Signature("rc(Microsoft.UI.Xaml.Shapes.Ellipse;{805c39aa-fa8a-5e0b-9847-4ab81b42a3df})")
@WinRTByReference(brClass = Ellipse.ByReference::class)
public class Ellipse(
  ptr: JNAPointer? = NULL
) : Shape(ptr), IEllipse.WithDefault, IWinRTObject {
  private val __626848397_Interface: IEllipse.WithDefault by lazy {
    as_626848397()
  }


  public override val __626848397_Ptr: JNAPointer? by lazy {
    __626848397_Interface.__626848397_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__626848397_Interface)

  public constructor() : this(ABI.activate())

  private fun as_626848397(): IEllipse.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<Ellipse, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr = INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Shapes.Ellipse".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
