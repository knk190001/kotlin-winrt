...
@Signature("{ea407c43-8a09-587a-958a-4dd17d217ce1}")
@Guid("ea407c438a09587a958a4dd17d217ce1")
@WinRTInterface("ea407c438a09587a958a4dd17d217ce1")
...
public interface IShapeStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IShapeStatics {
    public val __116956049_Ptr: Pointer?

    public val _116956049_VtblPtr: Pointer?
      get() = __116956049_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_FillProperty(): DependencyProperty? {
      val fnPtr = _116956049_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__116956049_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_StrokeProperty(): DependencyProperty? {
      val fnPtr = _116956049_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__116956049_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_StrokeMiterLimitProperty(): DependencyProperty? {
      val fnPtr = _116956049_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__116956049_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_StrokeThicknessProperty(): DependencyProperty? {
      val fnPtr = _116956049_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__116956049_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_StrokeStartLineCapProperty(): DependencyProperty? {
      val fnPtr = _116956049_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__116956049_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_StrokeEndLineCapProperty(): DependencyProperty? {
      val fnPtr = _116956049_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__116956049_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_StrokeLineJoinProperty(): DependencyProperty? {
      val fnPtr = _116956049_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__116956049_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_StrokeDashOffsetProperty(): DependencyProperty? {
      val fnPtr = _116956049_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__116956049_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_StrokeDashCapProperty(): DependencyProperty? {
      val fnPtr = _116956049_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__116956049_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_StrokeDashArrayProperty(): DependencyProperty? {
      val fnPtr = _116956049_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__116956049_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_StretchProperty(): DependencyProperty? {
      val fnPtr = _116956049_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__116956049_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IShapeStatics_Impl(
    ...
    public override val __116956049_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IShapeStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("ea407c438a09587a958a4dd17d217ce1")
    ...
    public override fun toNative(obj: IShapeStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__116956049_Ptr))
  }
