...
@Signature("{85ddbada-9e37-5971-a9aa-dce31f9cf67a}")
@Guid("85ddbada9e375971a9aadce31f9cf67a")
@WinRTInterface("85ddbada9e375971a9aadce31f9cf67a")
...
public interface IPolygonStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPolygonStatics {
    public val __288348662_Ptr: Pointer?

    public val _288348662_VtblPtr: Pointer?
      get() = __288348662_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_FillRuleProperty(): DependencyProperty? {
      val fnPtr = _288348662_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__288348662_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_PointsProperty(): DependencyProperty? {
      val fnPtr = _288348662_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__288348662_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IPolygonStatics_Impl(
    ...
    public override val __288348662_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPolygonStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("85ddbada9e375971a9aadce31f9cf67a")
    ...
    public override fun toNative(obj: IPolygonStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__288348662_Ptr))
  }
