...
import Microsoft.UI.Xaml.Shapes.IPathFactory.ABI.IID
...
@Signature("rc(Microsoft.UI.Xaml.Shapes.Path;{757d1cd8-0ec0-55c5-b400-66657e493e78})")
@WinRTByReference(brClass = Path.ByReference::class)
public open class Path(
  ptr: JNAPointer? = NULL
) : Shape(ptr), IPath.WithDefault, IWinRTObject {
  private val __855368368_Interface: IPath.WithDefault by lazy {
    as_855368368()
  }


  public override val __855368368_Ptr: JNAPointer? by lazy {
    __855368368_Interface.__855368368_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__855368368_Interface)

  public constructor() : this(ABI.activate())

  private fun as_855368368(): IPath.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<Path, MemoryAddress> {
    ...
    public fun createIPathStatics(): IPathStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Shapes.Path".toHandle(),refiid,interfacePtr)
    ...
    public fun createIPathFactory(): IPathFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Shapes.Path".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
