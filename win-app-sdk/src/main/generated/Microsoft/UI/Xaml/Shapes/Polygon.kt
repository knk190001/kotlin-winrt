...
@Signature("rc(Microsoft.UI.Xaml.Shapes.Polygon;{fa126347-d1d4-54dd-b1a4-c35019397944})")
@WinRTByReference(brClass = Polygon.ByReference::class)
public class Polygon(
  ptr: JNAPointer? = NULL
) : Shape(ptr), IPolygon.WithDefault, IWinRTObject {
  private val __632112847_Interface: IPolygon.WithDefault by lazy {
    as_632112847()
  }


  public override val __632112847_Ptr: JNAPointer? by lazy {
    __632112847_Interface.__632112847_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__632112847_Interface)

  public constructor() : this(ABI.activate())

  private fun as_632112847(): IPolygon.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<Polygon, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr = INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Shapes.Polygon".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIPolygonStatics(): IPolygonStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Shapes.Polygon".toHandle(),refiid,interfacePtr)
