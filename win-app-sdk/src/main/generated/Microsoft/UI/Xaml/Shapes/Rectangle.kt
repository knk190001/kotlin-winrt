...
@Signature("rc(Microsoft.UI.Xaml.Shapes.Rectangle;{bf7d30b9-152c-556e-9f10-d0b7eba4e52f})")
@WinRTByReference(brClass = Rectangle.ByReference::class)
public class Rectangle(
  ptr: JNAPointer? = NULL
) : Shape(ptr), IRectangle.WithDefault, IWinRTObject {
  private val __1539404348_Interface: IRectangle.WithDefault by lazy {
    as_1539404348()
  }


  public override val __1539404348_Ptr: JNAPointer? by lazy {
    __1539404348_Interface.__1539404348_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1539404348_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1539404348(): IRectangle.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<Rectangle, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr = INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Shapes.Rectangle".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIRectangleStatics(): IRectangleStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Shapes.Rectangle".toHandle(),refiid,interfacePtr)
