...
@Signature("{cc1089ab-8041-5c3e-b753-8397e7358cc6}")
@Guid("cc1089ab80415c3eb7538397e7358cc6")
@WinRTInterface("cc1089ab80415c3eb7538397e7358cc6")
...
public interface IDurationHelper : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IDurationHelper {
    public val __720566889_Ptr: Pointer?

    public val _720566889_VtblPtr: Pointer?
      get() = __720566889_Ptr?.getPointer(0)
  }

  public class IDurationHelper_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __720566889_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IDurationHelper, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("cc1089ab80415c3eb7538397e7358cc6")
    ...
    public override fun toNative(obj: IDurationHelper): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__720566889_Ptr))
  }
