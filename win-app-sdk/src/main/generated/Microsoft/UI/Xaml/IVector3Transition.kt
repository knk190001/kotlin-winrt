...
@Signature("{0c408bb9-f9a2-55d7-8aed-143d36d603f2}")
@Guid("0c408bb9f9a255d78aed143d36d603f2")
@WinRTInterface("0c408bb9f9a255d78aed143d36d603f2")
...
public interface IVector3Transition : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IVector3Transition {
    public val __646753118_Ptr: Pointer?

    public val _646753118_VtblPtr: Pointer?
      get() = __646753118_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Duration(): TimeSpan? {
      val fnPtr = _646753118_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<TimeSpan>()
      val hr = fn.invokeHR(arrayOf(__646753118_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Duration(value: TimeSpan?): Unit {
      val fnPtr = _646753118_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__646753118_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Components(): Vector3TransitionComponents? {
      val fnPtr = _646753118_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Components(value: Vector3TransitionComponents?): Unit {
      val fnPtr = _646753118_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__646753118_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IVector3Transition_Impl(
    ...
    public override val __646753118_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IVector3Transition, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("0c408bb9f9a255d78aed143d36d603f2")
    ...
    public override fun toNative(obj: IVector3Transition): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__646753118_Ptr))
  }
