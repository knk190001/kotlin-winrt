...
@Signature("{a1650cf8-a15b-54fc-b595-c52491318f58}")
@Guid("a1650cf8a15b54fcb595c52491318f58")
@WinRTInterface("a1650cf8a15b54fcb595c52491318f58")
...
public interface IScalarTransitionFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IScalarTransitionFactory {
    public val __748617918_Ptr: Pointer?

    public val _748617918_VtblPtr: Pointer?
      get() = __748617918_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        ScalarTransition? {
      val fnPtr = _748617918_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ScalarTransition>()
      val hr = fn.invokeHR(arrayOf(__748617918_Ptr, marshalToNative(baseInterface),
  ...
  public class IScalarTransitionFactory_Impl(
    ...
    public override val __748617918_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IScalarTransitionFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("a1650cf8a15b54fcb595c52491318f58")
    ...
    public override fun toNative(obj: IScalarTransitionFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__748617918_Ptr))
  }
