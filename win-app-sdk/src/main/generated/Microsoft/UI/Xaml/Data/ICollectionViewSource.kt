...
@Signature("{a45e3b3a-f31e-5bbb-8a7c-70cf5c64bc3f}")
@Guid("a45e3b3af31e5bbb8a7c70cf5c64bc3f")
@WinRTInterface("a45e3b3af31e5bbb8a7c70cf5c64bc3f")
...
public interface ICollectionViewSource : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICollectionViewSource {
    public val __1844067791_Ptr: Pointer?

    public val _1844067791_VtblPtr: Pointer?
      get() = __1844067791_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Source(): IUnknown? {
      val fnPtr = _1844067791_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IUnknown>()
      val hr = fn.invokeHR(arrayOf(__1844067791_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Source(value: IUnknown?): Unit {
      val fnPtr = _1844067791_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1844067791_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_View(): ICollectionView? {
      val fnPtr = _1844067791_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_IsSourceGrouped(): Boolean {
      val fnPtr = _1844067791_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_IsSourceGrouped(value: Boolean): Unit {
      val fnPtr = _1844067791_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1844067791_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_ItemsPath(): PropertyPath? {
      val fnPtr = _1844067791_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_ItemsPath(value: PropertyPath?): Unit {
      val fnPtr = _1844067791_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1844067791_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class ICollectionViewSource_Impl(
    ...
    public override val __1844067791_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICollectionViewSource, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("a45e3b3af31e5bbb8a7c70cf5c64bc3f")
    ...
    public override fun toNative(obj: ICollectionViewSource): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1844067791_Ptr))
  }
