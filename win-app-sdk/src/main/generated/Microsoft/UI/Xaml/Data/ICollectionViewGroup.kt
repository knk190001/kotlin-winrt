...
@Signature("{96a08da8-be38-5ae0-903d-6fb6111e61f5}")
@Guid("96a08da8be385ae0903d6fb6111e61f5")
@WinRTInterface("96a08da8be385ae0903d6fb6111e61f5")
...
public interface ICollectionViewGroup : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICollectionViewGroup {
    public val __1037894057_Ptr: Pointer?

    public val _1037894057_VtblPtr: Pointer?
      get() = __1037894057_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Group(): IUnknown? {
      val fnPtr = _1037894057_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IUnknown>()
      val hr = fn.invokeHR(arrayOf(__1037894057_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_GroupItems(): IObservableVector<IUnknown?>? {
      val fnPtr = _1037894057_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class ICollectionViewGroup_Impl(
    ...
    public override val __1037894057_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICollectionViewGroup, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("96a08da8be385ae0903d6fb6111e61f5")
    ...
    public override fun toNative(obj: ICollectionViewGroup): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1037894057_Ptr))
  }
