...
@Signature("{8518522c-85e3-5ae1-b9e9-28ea43c2051e}")
@Guid("8518522c85e35ae1b9e928ea43c2051e")
@WinRTInterface("8518522c85e35ae1b9e928ea43c2051e")
...
public interface IRelativeSourceFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IRelativeSourceFactory {
    public val __1867829648_Ptr: Pointer?

    public val _1867829648_VtblPtr: Pointer?
      get() = __1867829648_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        RelativeSource? {
      val fnPtr = _1867829648_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<RelativeSource>()
      val hr = fn.invokeHR(arrayOf(__1867829648_Ptr, marshalToNative(baseInterface),
  ...
  public class IRelativeSourceFactory_Impl(
    ...
    public override val __1867829648_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IRelativeSourceFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("8518522c85e35ae1b9e928ea43c2051e")
    ...
    public override fun toNative(obj: IRelativeSourceFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1867829648_Ptr))
  }
