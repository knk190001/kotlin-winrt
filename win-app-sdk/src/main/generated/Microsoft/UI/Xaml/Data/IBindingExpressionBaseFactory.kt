...
@Signature("{41d643b9-2629-5451-a716-596c0848b5dc}")
@Guid("41d643b926295451a716596c0848b5dc")
@WinRTInterface("41d643b926295451a716596c0848b5dc")
...
public interface IBindingExpressionBaseFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IBindingExpressionBaseFactory {
    public val __1896373105_Ptr: Pointer?

    public val _1896373105_VtblPtr: Pointer?
      get() = __1896373105_Ptr?.getPointer(0)
  }

  public class IBindingExpressionBaseFactory_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __1896373105_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IBindingExpressionBaseFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("41d643b926295451a716596c0848b5dc")
    ...
    public override fun toNative(obj: IBindingExpressionBaseFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1896373105_Ptr))
  }
