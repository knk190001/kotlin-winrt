...
public interface ICustomProperty : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICustomProperty {
    public val __1931572103_Ptr: Pointer?

    public val _1931572103_VtblPtr: Pointer?
      get() = __1931572103_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Type(): TypeName? {
      val fnPtr = _1931572103_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<TypeName>()
      val hr = fn.invokeHR(arrayOf(__1931572103_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Name(): String? {
      val fnPtr = _1931572103_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun GetValue(target: IUnknown?): IUnknown? {
      val fnPtr = _1931572103_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IUnknown>()
      val hr = fn.invokeHR(arrayOf(__1931572103_Ptr, marshalToNative(target), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun SetValue(target: IUnknown?, value: IUnknown?): Unit {
      val fnPtr = _1931572103_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1931572103_Ptr, marshalToNative(target),
    ...
    public override fun GetIndexedValue(target: IUnknown?, index: IUnknown?): IUnknown? {
      val fnPtr = _1931572103_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IUnknown>()
      val hr = fn.invokeHR(arrayOf(__1931572103_Ptr, marshalToNative(target),
    ...
    public override fun SetIndexedValue(
      ...
      val fnPtr = _1931572103_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1931572103_Ptr, marshalToNative(target),
    ...
    public override fun get_CanWrite(): Boolean {
      val fnPtr = _1931572103_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_CanRead(): Boolean {
      val fnPtr = _1931572103_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1931572103_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public object ABI : IABI<ICustomProperty, MemoryAddress> {
    ...
    public override fun toNative(obj: ICustomProperty): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1931572103_Ptr))
  }
