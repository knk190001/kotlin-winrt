...
@Signature("{63e42ed6-e14a-51ea-9cb1-72f9c907dc80}")
@Guid("63e42ed6e14a51ea9cb172f9c907dc80")
@WinRTInterface("63e42ed6e14a51ea9cb172f9c907dc80")
...
public interface ICurrentChangingEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICurrentChangingEventArgs {
    public val __1121888388_Ptr: Pointer?

    public val _1121888388_VtblPtr: Pointer?
      get() = __1121888388_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Cancel(): Boolean {
      val fnPtr = _1121888388_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1121888388_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Cancel(value: Boolean): Unit {
      val fnPtr = _1121888388_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1121888388_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_IsCancelable(): Boolean {
      val fnPtr = _1121888388_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1121888388_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ICurrentChangingEventArgs_Impl(
    ...
    public override val __1121888388_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICurrentChangingEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("63e42ed6e14a51ea9cb172f9c907dc80")
    ...
    public override fun toNative(obj: ICurrentChangingEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1121888388_Ptr))
  }
