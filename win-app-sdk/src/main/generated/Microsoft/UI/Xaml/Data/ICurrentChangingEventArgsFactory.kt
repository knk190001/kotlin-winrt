...
@Signature("{3670f48a-ac2c-5352-8a4b-6b977a08e5f8}")
@Guid("3670f48aac2c53528a4b6b977a08e5f8")
@WinRTInterface("3670f48aac2c53528a4b6b977a08e5f8")
...
public interface ICurrentChangingEventArgsFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICurrentChangingEventArgsFactory {
    public val __552385562_Ptr: Pointer?

    public val _552385562_VtblPtr: Pointer?
      get() = __552385562_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        CurrentChangingEventArgs? {
      val fnPtr = _552385562_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CurrentChangingEventArgs>()
      val hr = fn.invokeHR(arrayOf(__552385562_Ptr, marshalToNative(baseInterface),
    ...
    public override fun CreateWithCancelableParameter(
      ...
      val fnPtr = _552385562_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CurrentChangingEventArgs>()
      val hr = fn.invokeHR(arrayOf(__552385562_Ptr, isCancelable, marshalToNative(baseInterface),
          marshalToNative(innerInterface), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
  ...
  public class ICurrentChangingEventArgsFactory_Impl(
    ...
    public override val __552385562_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICurrentChangingEventArgsFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("3670f48aac2c53528a4b6b977a08e5f8")
    ...
    public override fun toNative(obj: ICurrentChangingEventArgsFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__552385562_Ptr))
  }
