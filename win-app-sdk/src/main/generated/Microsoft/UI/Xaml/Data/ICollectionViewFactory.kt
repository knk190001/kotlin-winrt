...
@Signature("{d971f795-5728-5bef-9602-43f2c4250e56}")
@Guid("d971f79557285bef960243f2c4250e56")
@WinRTInterface("d971f79557285bef960243f2c4250e56")
...
public interface ICollectionViewFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICollectionViewFactory {
    public val __401532492_Ptr: Pointer?

    public val _401532492_VtblPtr: Pointer?
      get() = __401532492_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateView(): ICollectionView? {
      val fnPtr = _401532492_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ICollectionView>()
      val hr = fn.invokeHR(arrayOf(__401532492_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ICollectionViewFactory_Impl(
    ...
    public override val __401532492_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICollectionViewFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("d971f79557285bef960243f2c4250e56")
    ...
    public override fun toNative(obj: ICollectionViewFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__401532492_Ptr))
  }
