...
@Signature("rc(Microsoft.UI.Xaml.Data.CollectionViewSource;{a45e3b3a-f31e-5bbb-8a7c-70cf5c64bc3f})")
...
public class CollectionViewSource(
  ...
  private val __1844067791_Interface: ICollectionViewSource.WithDefault by lazy {
    as_1844067791()
  }


  public override val __1844067791_Ptr: JNAPointer? by lazy {
    __1844067791_Interface.__1844067791_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1844067791_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1844067791(): ICollectionViewSource.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<CollectionViewSource, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Data.CollectionViewSource".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createICollectionViewSourceStatics(): ICollectionViewSourceStatics {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Data.CollectionViewSource".toHandle(),refiid,interfacePtr)
      val result =
