...
@Signature("{c8a866c5-f6f3-5f7a-9592-d385af48bd8f}")
@Guid("c8a866c5f6f35f7a9592d385af48bd8f")
@WinRTInterface("c8a866c5f6f35f7a9592d385af48bd8f")
...
public interface IBindingBaseFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IBindingBaseFactory {
    public val __1468446777_Ptr: Pointer?

    public val _1468446777_VtblPtr: Pointer?
      get() = __1468446777_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        BindingBase? {
      val fnPtr = _1468446777_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<BindingBase>()
      val hr = fn.invokeHR(arrayOf(__1468446777_Ptr, marshalToNative(baseInterface),
  ...
  public class IBindingBaseFactory_Impl(
    ...
    public override val __1468446777_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IBindingBaseFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("c8a866c5f6f35f7a9592d385af48bd8f")
    ...
    public override fun toNative(obj: IBindingBaseFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1468446777_Ptr))
  }
