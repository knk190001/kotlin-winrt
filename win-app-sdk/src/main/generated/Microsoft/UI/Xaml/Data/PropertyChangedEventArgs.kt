...
import Microsoft.UI.Xaml.Data.IPropertyChangedEventArgsFactory.ABI.IID
...
@Signature("rc(Microsoft.UI.Xaml.Data.PropertyChangedEventArgs;{63d0c952-396b-54f4-af8c-ba8724a427bf})")
...
public open class PropertyChangedEventArgs(
  ...
  private val __2114731659_Interface: IPropertyChangedEventArgs.WithDefault by lazy {
    as_2114731659()
  }


  public override val __2114731659_Ptr: JNAPointer? by lazy {
    __2114731659_Interface.__2114731659_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__2114731659_Interface)

  public constructor(name: String) : this(ABI.activate(name))

  private fun as_2114731659(): IPropertyChangedEventArgs.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<PropertyChangedEventArgs, MemoryAddress> {
    ...
    public fun createIPropertyChangedEventArgsFactory(): IPropertyChangedEventArgsFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Data.PropertyChangedEventArgs".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
