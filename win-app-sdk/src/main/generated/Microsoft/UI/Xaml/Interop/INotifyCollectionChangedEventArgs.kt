...
@Signature("{da049ff2-d2e0-5fe8-8c7b-f87f26060b6f}")
@Guid("da049ff2d2e05fe88c7bf87f26060b6f")
@WinRTInterface("da049ff2d2e05fe88c7bf87f26060b6f")
...
public interface INotifyCollectionChangedEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : INotifyCollectionChangedEventArgs {
    public val __2098646946_Ptr: Pointer?

    public val _2098646946_VtblPtr: Pointer?
      get() = __2098646946_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Action(): NotifyCollectionChangedAction? {
      val fnPtr = _2098646946_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<NotifyCollectionChangedAction>()
      val hr = fn.invokeHR(arrayOf(__2098646946_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_NewItems(): IBindableVector? {
      val fnPtr = _2098646946_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_OldItems(): IBindableVector? {
      val fnPtr = _2098646946_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IBindableVector>()
      val hr = fn.invokeHR(arrayOf(__2098646946_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_NewStartingIndex(): Int {
      val fnPtr = _2098646946_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_OldStartingIndex(): Int {
      val fnPtr = _2098646946_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__2098646946_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class INotifyCollectionChangedEventArgs_Impl(
    ...
    public override val __2098646946_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<INotifyCollectionChangedEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("da049ff2d2e05fe88c7bf87f26060b6f")
    ...
    public override fun toNative(obj: INotifyCollectionChangedEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2098646946_Ptr))
  }
