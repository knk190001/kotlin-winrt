...
public interface IBindableIterable : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IBindableIterable {
    public val __2104271137_Ptr: Pointer?

    public val _2104271137_VtblPtr: Pointer?
      get() = __2104271137_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun First(): IBindableIterator? {
      val fnPtr = _2104271137_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IBindableIterator>()
      val hr = fn.invokeHR(arrayOf(__2104271137_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IBindableIterable_Impl(
    ...
    public override val __2104271137_Ptr: Pointer?
      get() = pointer
  }
  ...
  public object ABI : IABI<IBindableIterable, MemoryAddress> {
    ...
    public override fun toNative(obj: IBindableIterable): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2104271137_Ptr))
  }
