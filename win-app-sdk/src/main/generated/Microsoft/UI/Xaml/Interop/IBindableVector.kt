...
public interface IBindableVector : NativeMapped, IWinRTInterface, IBindableIterable {
  ...
  public interface WithDefault : IBindableVector, IBindableIterable.WithDefault {
    public val __816324018_Ptr: Pointer?

    public val _816324018_VtblPtr: Pointer?
      get() = __816324018_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun GetAt(index: WinDef.UINT): IUnknown? {
      val fnPtr = _816324018_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IUnknown>()
      val hr = fn.invokeHR(arrayOf(__816324018_Ptr, index, result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Size(): WinDef.UINT {
      val fnPtr = _816324018_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<WinDef.UINT>()
      val hr = fn.invokeHR(arrayOf(__816324018_Ptr,  result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun GetView(): IBindableVectorView? {
      val fnPtr = _816324018_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun IndexOf(value: IUnknown?, index: WinDef.UINT): Boolean {
      val fnPtr = _816324018_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__816324018_Ptr, marshalToNative(value), index, result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun SetAt(index: WinDef.UINT, value: IUnknown?): Unit {
      val fnPtr = _816324018_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__816324018_Ptr, index, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun InsertAt(index: WinDef.UINT, value: IUnknown?): Unit {
      val fnPtr = _816324018_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__816324018_Ptr, index, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun RemoveAt(index: WinDef.UINT): Unit {
      val fnPtr = _816324018_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__816324018_Ptr, index,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun Append(value: IUnknown?): Unit {
      val fnPtr = _816324018_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__816324018_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun RemoveAtEnd(): Unit {
      val fnPtr = _816324018_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__816324018_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun Clear(): Unit {
      val fnPtr = _816324018_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__816324018_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IBindableVector_Impl(
    ...
    public override val __2104271137_Ptr: JNAPointer by lazy {
      ...
      IUnknownVtbl(_816324018_VtblPtr).queryInterface(pointer,refiid,result)
      result.value
    }


    public override val __816324018_Ptr: Pointer?
      get() = pointer
  }
  ...
  public object ABI : IABI<IBindableVector, MemoryAddress> {
    ...
    public override fun toNative(obj: IBindableVector): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__816324018_Ptr))
  }
