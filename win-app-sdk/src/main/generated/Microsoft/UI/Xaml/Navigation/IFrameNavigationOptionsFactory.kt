...
@Signature("{ddf3f748-7127-5cee-9f79-ac281a234632}")
@Guid("ddf3f74871275cee9f79ac281a234632")
@WinRTInterface("ddf3f74871275cee9f79ac281a234632")
...
public interface IFrameNavigationOptionsFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IFrameNavigationOptionsFactory {
    public val __1844110908_Ptr: Pointer?

    public val _1844110908_VtblPtr: Pointer?
      get() = __1844110908_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        FrameNavigationOptions? {
      val fnPtr = _1844110908_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<FrameNavigationOptions>()
      val hr = fn.invokeHR(arrayOf(__1844110908_Ptr, marshalToNative(baseInterface),
  ...
  public class IFrameNavigationOptionsFactory_Impl(
    ...
    public override val __1844110908_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IFrameNavigationOptionsFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("ddf3f74871275cee9f79ac281a234632")
    ...
    public override fun toNative(obj: IFrameNavigationOptionsFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1844110908_Ptr))
  }
