...
@Signature("{f808f9a0-130c-5974-87f8-4433271a35a9}")
@Guid("f808f9a0130c597487f84433271a35a9")
@WinRTInterface("f808f9a0130c597487f84433271a35a9")
...
public interface INavigationFailedEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : INavigationFailedEventArgs {
    public val __300850461_Ptr: Pointer?

    public val _300850461_VtblPtr: Pointer?
      get() = __300850461_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Exception(): HResult? {
      val fnPtr = _300850461_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<HResult>()
      val hr = fn.invokeHR(arrayOf(__300850461_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Handled(): Boolean {
      val fnPtr = _300850461_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Handled(value: Boolean): Unit {
      val fnPtr = _300850461_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__300850461_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_SourcePageType(): TypeName? {
      val fnPtr = _300850461_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class INavigationFailedEventArgs_Impl(
    ...
    public override val __300850461_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<INavigationFailedEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("f808f9a0130c597487f84433271a35a9")
    ...
    public override fun toNative(obj: INavigationFailedEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__300850461_Ptr))
  }
