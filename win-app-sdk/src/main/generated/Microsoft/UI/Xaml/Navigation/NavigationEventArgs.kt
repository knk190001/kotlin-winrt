...
@Signature("rc(Microsoft.UI.Xaml.Navigation.NavigationEventArgs;{876b70b4-2923-5785-9cea-2e44aa0761bd})")
@WinRTByReference(brClass = NavigationEventArgs.ByReference::class)
public class NavigationEventArgs(
  ptr: JNAPointer? = NULL
) : PointerType(ptr), INavigationEventArgs.WithDefault, IWinRTObject {
  private val __91245338_Interface: INavigationEventArgs.WithDefault by lazy {
    as_91245338()
  }


  public override val __91245338_Ptr: JNAPointer? by lazy {
    __91245338_Interface.__91245338_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__91245338_Interface)

  private fun as_91245338(): INavigationEventArgs.WithDefault {
    if(pointer == NULL) {
