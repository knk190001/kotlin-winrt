...
@Signature("{390de593-14cf-5312-af99-6cd8d59ec5d5}")
@Guid("390de59314cf5312af996cd8d59ec5d5")
@WinRTInterface("390de59314cf5312af996cd8d59ec5d5")
...
public interface IFrameNavigationOptions : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IFrameNavigationOptions {
    public val __1065054106_Ptr: Pointer?

    public val _1065054106_VtblPtr: Pointer?
      get() = __1065054106_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_IsNavigationStackEnabled(): Boolean {
      val fnPtr = _1065054106_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1065054106_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_IsNavigationStackEnabled(value: Boolean): Unit {
      val fnPtr = _1065054106_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1065054106_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_TransitionInfoOverride(): NavigationTransitionInfo? {
      val fnPtr = _1065054106_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_TransitionInfoOverride(value: NavigationTransitionInfo?): Unit {
      val fnPtr = _1065054106_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1065054106_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IFrameNavigationOptions_Impl(
    ...
    public override val __1065054106_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IFrameNavigationOptions, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("390de59314cf5312af996cd8d59ec5d5")
    ...
    public override fun toNative(obj: IFrameNavigationOptions): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1065054106_Ptr))
  }
