...
@Signature("{d591f56e-4262-5c91-9d79-29165cd82100}")
@Guid("d591f56e42625c919d7929165cd82100")
@WinRTInterface("d591f56e42625c919d7929165cd82100")
...
public interface IPageStackEntry : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IPageStackEntry {
    public val __801769438_Ptr: Pointer?

    public val _801769438_VtblPtr: Pointer?
      get() = __801769438_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_SourcePageType(): TypeName? {
      val fnPtr = _801769438_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<TypeName>()
      val hr = fn.invokeHR(arrayOf(__801769438_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Parameter(): IUnknown? {
      val fnPtr = _801769438_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_NavigationTransitionInfo(): NavigationTransitionInfo? {
      val fnPtr = _801769438_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class IPageStackEntry_Impl(
    ...
    public override val __801769438_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IPageStackEntry, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("d591f56e42625c919d7929165cd82100")
    ...
    public override fun toNative(obj: IPageStackEntry): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__801769438_Ptr))
  }
