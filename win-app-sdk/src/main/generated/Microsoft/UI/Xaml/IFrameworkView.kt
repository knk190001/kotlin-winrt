...
@Signature("{e60094c3-45af-5a8f-9511-1781d7df1799}")
@Guid("e60094c345af5a8f95111781d7df1799")
@WinRTInterface("e60094c345af5a8f95111781d7df1799")
...
public interface IFrameworkView : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IFrameworkView {
    public val __1033151708_Ptr: Pointer?

    public val _1033151708_VtblPtr: Pointer?
      get() = __1033151708_Ptr?.getPointer(0)
  }

  public class IFrameworkView_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __1033151708_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IFrameworkView, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("e60094c345af5a8f95111781d7df1799")
    ...
    public override fun toNative(obj: IFrameworkView): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1033151708_Ptr))
  }
