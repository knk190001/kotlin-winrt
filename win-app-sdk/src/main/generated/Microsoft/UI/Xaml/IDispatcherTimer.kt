...
@Signature("{58a4abf1-a4a3-53dd-ae21-08f43231e817}")
@Guid("58a4abf1a4a353ddae2108f43231e817")
@WinRTInterface("58a4abf1a4a353ddae2108f43231e817")
...
public interface IDispatcherTimer : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IDispatcherTimer {
    public val __563305911_Ptr: Pointer?

    public val _563305911_VtblPtr: Pointer?
      get() = __563305911_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Interval(): TimeSpan? {
      val fnPtr = _563305911_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<TimeSpan>()
      val hr = fn.invokeHR(arrayOf(__563305911_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Interval(value: TimeSpan?): Unit {
      val fnPtr = _563305911_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__563305911_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_IsEnabled(): Boolean {
      val fnPtr = _563305911_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun add_Tick(handler: EventHandler<IUnknown?>?): EventRegistrationToken? {
      val fnPtr = _563305911_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__563305911_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun remove_Tick(token: EventRegistrationToken?): Unit {
      val fnPtr = _563305911_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__563305911_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun Start(): Unit {
      val fnPtr = _563305911_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__563305911_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun Stop(): Unit {
      val fnPtr = _563305911_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__563305911_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IDispatcherTimer_Impl(
    ...
    public override val __563305911_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IDispatcherTimer, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("58a4abf1a4a353ddae2108f43231e817")
    ...
    public override fun toNative(obj: IDispatcherTimer): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__563305911_Ptr))
  }
