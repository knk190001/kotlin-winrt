...
@Signature("{807de8f9-b1dc-5a63-8101-5ee966841a27}")
@Guid("807de8f9b1dc5a6381015ee966841a27")
@WinRTInterface("807de8f9b1dc5a6381015ee966841a27")
...
public interface IBringIntoViewRequestedEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IBringIntoViewRequestedEventArgs {
    public val __705449255_Ptr: Pointer?

    public val _705449255_VtblPtr: Pointer?
      get() = __705449255_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_TargetElement(): UIElement? {
      val fnPtr = _705449255_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<UIElement>()
      val hr = fn.invokeHR(arrayOf(__705449255_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_TargetElement(value: UIElement?): Unit {
      val fnPtr = _705449255_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__705449255_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_AnimationDesired(): Boolean {
      val fnPtr = _705449255_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_AnimationDesired(value: Boolean): Unit {
      val fnPtr = _705449255_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__705449255_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_TargetRect(): Rect? {
      val fnPtr = _705449255_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_TargetRect(value: Rect?): Unit {
      val fnPtr = _705449255_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__705449255_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_HorizontalAlignmentRatio(): Double {
      val fnPtr = _705449255_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_VerticalAlignmentRatio(): Double {
      val fnPtr = _705449255_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__705449255_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_HorizontalOffset(): Double {
      val fnPtr = _705449255_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__705449255_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_HorizontalOffset(value: Double): Unit {
      val fnPtr = _705449255_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__705449255_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_VerticalOffset(): Double {
      val fnPtr = _705449255_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__705449255_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_VerticalOffset(value: Double): Unit {
      val fnPtr = _705449255_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__705449255_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Handled(): Boolean {
      val fnPtr = _705449255_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__705449255_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Handled(value: Boolean): Unit {
      val fnPtr = _705449255_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__705449255_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IBringIntoViewRequestedEventArgs_Impl(
    ...
    public override val __705449255_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IBringIntoViewRequestedEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("807de8f9b1dc5a6381015ee966841a27")
    ...
    public override fun toNative(obj: IBringIntoViewRequestedEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__705449255_Ptr))
  }
