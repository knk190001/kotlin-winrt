...
@Signature("{a4d5147d-88c3-57ed-ad83-245df5f6b50d}")
@Guid("a4d5147d88c357edad83245df5f6b50d")
@WinRTInterface("a4d5147d88c357edad83245df5f6b50d")
...
public interface IVisualStateManagerStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IVisualStateManagerStatics {
    public val __168855682_Ptr: Pointer?

    public val _168855682_VtblPtr: Pointer?
      get() = __168855682_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun GetVisualStateGroups(obj: FrameworkElement?): IVector<VisualStateGroup?>? {
      val fnPtr = _168855682_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IVector<VisualStateGroup?>>()
      val hr = fn.invokeHR(arrayOf(__168855682_Ptr, marshalToNative(obj), result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_CustomVisualStateManagerProperty(): DependencyProperty? {
      val fnPtr = _168855682_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__168855682_Ptr,  result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun GetCustomVisualStateManager(obj: FrameworkElement?): VisualStateManager? {
      val fnPtr = _168855682_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun SetCustomVisualStateManager(obj: FrameworkElement?,
      ...
      val fnPtr = _168855682_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__168855682_Ptr, marshalToNative(obj), marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun GoToState(
      ...
      val fnPtr = _168855682_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__168855682_Ptr, marshalToNative(control),
  ...
  public class IVisualStateManagerStatics_Impl(
    ...
    public override val __168855682_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IVisualStateManagerStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("a4d5147d88c357edad83245df5f6b50d")
    ...
    public override fun toNative(obj: IVisualStateManagerStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__168855682_Ptr))
  }
