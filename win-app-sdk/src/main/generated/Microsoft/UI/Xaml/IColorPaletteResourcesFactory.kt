...
@Signature("{32fde185-8544-59c0-9e0a-e6e0bad9edcf}")
@Guid("32fde185854459c09e0ae6e0bad9edcf")
@WinRTInterface("32fde185854459c09e0ae6e0bad9edcf")
...
public interface IColorPaletteResourcesFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IColorPaletteResourcesFactory {
    public val __1737331548_Ptr: Pointer?

    public val _1737331548_VtblPtr: Pointer?
      get() = __1737331548_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        ColorPaletteResources? {
      val fnPtr = _1737331548_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ColorPaletteResources>()
      val hr = fn.invokeHR(arrayOf(__1737331548_Ptr, marshalToNative(baseInterface),
  ...
  public class IColorPaletteResourcesFactory_Impl(
    ...
    public override val __1737331548_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IColorPaletteResourcesFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("32fde185854459c09e0ae6e0bad9edcf")
    ...
    public override fun toNative(obj: IColorPaletteResourcesFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1737331548_Ptr))
  }
