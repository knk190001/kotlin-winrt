...
@Signature("{7d2db617-14e7-5d49-aeec-ae10887e595d}")
@Guid("7d2db61714e75d49aeecae10887e595d")
@WinRTInterface("7d2db61714e75d49aeecae10887e595d")
...
public interface IDesktopWindowXamlSourceFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IDesktopWindowXamlSourceFactory {
    public val __1531921770_Ptr: Pointer?

    public val _1531921770_VtblPtr: Pointer?
      get() = __1531921770_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        DesktopWindowXamlSource? {
      val fnPtr = _1531921770_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DesktopWindowXamlSource>()
      val hr = fn.invokeHR(arrayOf(__1531921770_Ptr, marshalToNative(baseInterface),
  ...
  public class IDesktopWindowXamlSourceFactory_Impl(
    ...
    public override val __1531921770_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IDesktopWindowXamlSourceFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("7d2db61714e75d49aeecae10887e595d")
    ...
    public override fun toNative(obj: IDesktopWindowXamlSourceFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1531921770_Ptr))
  }
