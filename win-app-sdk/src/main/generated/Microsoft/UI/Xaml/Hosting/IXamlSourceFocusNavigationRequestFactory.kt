...
@Signature("{7a5124dd-2876-5ed8-b564-5867731d7f1e}")
@Guid("7a5124dd28765ed8b5645867731d7f1e")
@WinRTInterface("7a5124dd28765ed8b5645867731d7f1e")
...
public interface IXamlSourceFocusNavigationRequestFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IXamlSourceFocusNavigationRequestFactory {
    public val __699366121_Ptr: Pointer?

    public val _699366121_VtblPtr: Pointer?
      get() = __699366121_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(reason: XamlSourceFocusNavigationReason?):
        XamlSourceFocusNavigationRequest? {
      val fnPtr = _699366121_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<XamlSourceFocusNavigationRequest>()
      val hr = fn.invokeHR(arrayOf(__699366121_Ptr, marshalToNative(reason), result))
      if (hr.toInt() != 0) {
    ...
    public override fun CreateInstanceWithHintRect(reason: XamlSourceFocusNavigationReason?,
      ...
      val fnPtr = _699366121_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<XamlSourceFocusNavigationRequest>()
      val hr = fn.invokeHR(arrayOf(__699366121_Ptr, marshalToNative(reason),
    ...
    public override fun CreateInstanceWithHintRectAndCorrelationId(
      ...
      val fnPtr = _699366121_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<XamlSourceFocusNavigationRequest>()
      val hr = fn.invokeHR(arrayOf(__699366121_Ptr, marshalToNative(reason),
  ...
  public class IXamlSourceFocusNavigationRequestFactory_Impl(
    ...
    public override val __699366121_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IXamlSourceFocusNavigationRequestFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("7a5124dd28765ed8b5645867731d7f1e")
    ...
    public override fun toNative(obj: IXamlSourceFocusNavigationRequestFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__699366121_Ptr))
  }
