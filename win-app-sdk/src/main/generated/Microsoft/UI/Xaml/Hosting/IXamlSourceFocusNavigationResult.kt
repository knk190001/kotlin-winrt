...
@Signature("{d6bf378e-2aac-5e5b-ac8a-6c5d9a4c1cb8}")
@Guid("d6bf378e2aac5e5bac8a6c5d9a4c1cb8")
@WinRTInterface("d6bf378e2aac5e5bac8a6c5d9a4c1cb8")
...
public interface IXamlSourceFocusNavigationResult : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IXamlSourceFocusNavigationResult {
    public val __906106485_Ptr: Pointer?

    public val _906106485_VtblPtr: Pointer?
      get() = __906106485_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_WasFocusMoved(): Boolean {
      val fnPtr = _906106485_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__906106485_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IXamlSourceFocusNavigationResult_Impl(
    ...
    public override val __906106485_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IXamlSourceFocusNavigationResult, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("d6bf378e2aac5e5bac8a6c5d9a4c1cb8")
    ...
    public override fun toNative(obj: IXamlSourceFocusNavigationResult): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__906106485_Ptr))
  }
