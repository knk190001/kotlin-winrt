...
import Microsoft.UI.Xaml.Hosting.IXamlSourceFocusNavigationResultFactory.ABI.IID
...
@Signature("rc(Microsoft.UI.Xaml.Hosting.XamlSourceFocusNavigationResult;{d6bf378e-2aac-5e5b-ac8a-6c5d9a4c1cb8})")
...
public class XamlSourceFocusNavigationResult(
  ...
  private val __906106485_Interface: IXamlSourceFocusNavigationResult.WithDefault by lazy {
    as_906106485()
  }


  public override val __906106485_Ptr: JNAPointer? by lazy {
    __906106485_Interface.__906106485_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__906106485_Interface)

  public constructor(focusMoved: Boolean) : this(ABI.activate(focusMoved))

  private fun as_906106485(): IXamlSourceFocusNavigationResult.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<XamlSourceFocusNavigationResult, MemoryAddress> {
    ...
    public fun createIXamlSourceFocusNavigationResultFactory():
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Hosting.XamlSourceFocusNavigationResult".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
