...
@Signature("{c883ea8b-4ce2-58be-b547-66dedf620312}")
@Guid("c883ea8b4ce258beb54766dedf620312")
@WinRTInterface("c883ea8b4ce258beb54766dedf620312")
...
public interface IXamlSourceFocusNavigationRequest : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IXamlSourceFocusNavigationRequest {
    public val __1973616353_Ptr: Pointer?

    public val _1973616353_VtblPtr: Pointer?
      get() = __1973616353_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Reason(): XamlSourceFocusNavigationReason? {
      val fnPtr = _1973616353_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<XamlSourceFocusNavigationReason>()
      val hr = fn.invokeHR(arrayOf(__1973616353_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_HintRect(): Rect? {
      val fnPtr = _1973616353_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_CorrelationId(): com.sun.jna.platform.win32.Guid.GUID? {
      val fnPtr = _1973616353_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class IXamlSourceFocusNavigationRequest_Impl(
    ...
    public override val __1973616353_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IXamlSourceFocusNavigationRequest, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("c883ea8b4ce258beb54766dedf620312")
    ...
    public override fun toNative(obj: IXamlSourceFocusNavigationRequest): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1973616353_Ptr))
  }
