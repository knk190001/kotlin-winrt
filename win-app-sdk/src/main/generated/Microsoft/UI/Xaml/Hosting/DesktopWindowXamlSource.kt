...
import Microsoft.UI.Xaml.Hosting.IDesktopWindowXamlSourceFactory.ABI.IID
...
@Signature("rc(Microsoft.UI.Xaml.Hosting.DesktopWindowXamlSource;{553af92c-1381-51d6-bee0-f34beb042ea8})")
...
public open class DesktopWindowXamlSource(
  ...
  private val __816601044_Interface: IDesktopWindowXamlSource.WithDefault by lazy {
    as_816601044()
  }
  ...
  public override val __816601044_Ptr: JNAPointer? by lazy {
    __816601044_Interface.__816601044_Ptr
  }
  ...
  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__816601044_Interface, __1260617006_Interface)

  public constructor() : this(ABI.activate())

  private fun as_816601044(): IDesktopWindowXamlSource.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<DesktopWindowXamlSource, MemoryAddress> {
    ...
    public fun createIDesktopWindowXamlSourceFactory(): IDesktopWindowXamlSourceFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Hosting.DesktopWindowXamlSource".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
