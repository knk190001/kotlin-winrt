...
@Signature("{9fd96657-5294-5a65-a1db-4fea143597da}")
@Guid("9fd9665752945a65a1db4fea143597da")
@WinRTInterface("9fd9665752945a65a1db4fea143597da")
...
public interface IApplicationFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IApplicationFactory {
    public val __1951662559_Ptr: Pointer?

    public val _1951662559_VtblPtr: Pointer?
      get() = __1951662559_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        Application? {
      val fnPtr = _1951662559_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Application>()
      val hr = fn.invokeHR(arrayOf(__1951662559_Ptr, marshalToNative(baseInterface),
  ...
  public class IApplicationFactory_Impl(
    ...
    public override val __1951662559_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IApplicationFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("9fd9665752945a65a1db4fea143597da")
    ...
    public override fun toNative(obj: IApplicationFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1951662559_Ptr))
  }
