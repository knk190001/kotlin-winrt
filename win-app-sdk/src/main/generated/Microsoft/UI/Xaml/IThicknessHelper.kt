...
@Signature("{5e496347-3c49-55ee-b442-530789b42b6f}")
@Guid("5e4963473c4955eeb442530789b42b6f")
@WinRTInterface("5e4963473c4955eeb442530789b42b6f")
...
public interface IThicknessHelper : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IThicknessHelper {
    public val __2089901339_Ptr: Pointer?

    public val _2089901339_VtblPtr: Pointer?
      get() = __2089901339_Ptr?.getPointer(0)
  }

  public class IThicknessHelper_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __2089901339_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IThicknessHelper, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("5e4963473c4955eeb442530789b42b6f")
    ...
    public override fun toNative(obj: IThicknessHelper): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2089901339_Ptr))
  }
