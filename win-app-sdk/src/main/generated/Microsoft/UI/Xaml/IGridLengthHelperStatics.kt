...
@Signature("{cea8881b-4e64-535d-9fcd-b4828d3979b0}")
@Guid("cea8881b4e64535d9fcdb4828d3979b0")
@WinRTInterface("cea8881b4e64535d9fcdb4828d3979b0")
...
public interface IGridLengthHelperStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IGridLengthHelperStatics {
    public val __449223260_Ptr: Pointer?

    public val _449223260_VtblPtr: Pointer?
      get() = __449223260_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Auto(): GridLength? {
      val fnPtr = _449223260_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<GridLength>()
      val hr = fn.invokeHR(arrayOf(__449223260_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun FromPixels(pixels: Double): GridLength? {
      val fnPtr = _449223260_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<GridLength>()
      val hr = fn.invokeHR(arrayOf(__449223260_Ptr, pixels, result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
      val resultValue = marshalFromNative<GridLength>(result.getValue())
    ...
    public override fun FromValueAndType(value: Double, type: GridUnitType?): GridLength? {
      val fnPtr = _449223260_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<GridLength>()
      val hr = fn.invokeHR(arrayOf(__449223260_Ptr, value, marshalToNative(type), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
      val resultValue = marshalFromNative<GridLength>(result.getValue())
    ...
    public override fun GetIsAbsolute(target: GridLength?): Boolean {
      val fnPtr = _449223260_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__449223260_Ptr, marshalToNative(target), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun GetIsAuto(target: GridLength?): Boolean {
      val fnPtr = _449223260_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__449223260_Ptr, marshalToNative(target), result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetIsStar(target: GridLength?): Boolean {
      val fnPtr = _449223260_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__449223260_Ptr, marshalToNative(target), result))
      if (hr.toInt() != 0) {
    ...
    public override fun Equals(target: GridLength?, value: GridLength?): Boolean {
      val fnPtr = _449223260_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__449223260_Ptr, marshalToNative(target), marshalToNative(value),
          result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
  ...
  public class IGridLengthHelperStatics_Impl(
    ...
    public override val __449223260_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IGridLengthHelperStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("cea8881b4e64535d9fcdb4828d3979b0")
    ...
    public override fun toNative(obj: IGridLengthHelperStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__449223260_Ptr))
  }
