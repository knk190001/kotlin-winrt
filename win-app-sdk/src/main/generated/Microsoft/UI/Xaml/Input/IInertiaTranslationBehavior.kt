...
@Signature("{d4f91cf5-3317-5914-b25a-ea6ee55b96d0}")
@Guid("d4f91cf533175914b25aea6ee55b96d0")
@WinRTInterface("d4f91cf533175914b25aea6ee55b96d0")
...
public interface IInertiaTranslationBehavior : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IInertiaTranslationBehavior {
    public val __2022530132_Ptr: Pointer?

    public val _2022530132_VtblPtr: Pointer?
      get() = __2022530132_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_DesiredDeceleration(): Double {
      val fnPtr = _2022530132_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__2022530132_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_DesiredDeceleration(value: Double): Unit {
      val fnPtr = _2022530132_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2022530132_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_DesiredDisplacement(): Double {
      val fnPtr = _2022530132_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Double>()
      val hr = fn.invokeHR(arrayOf(__2022530132_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_DesiredDisplacement(value: Double): Unit {
      val fnPtr = _2022530132_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2022530132_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IInertiaTranslationBehavior_Impl(
    ...
    public override val __2022530132_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IInertiaTranslationBehavior, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("d4f91cf533175914b25aea6ee55b96d0")
    ...
    public override fun toNative(obj: IInertiaTranslationBehavior): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2022530132_Ptr))
  }
