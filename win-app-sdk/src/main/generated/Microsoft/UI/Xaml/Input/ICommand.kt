...
public interface ICommand : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICommand {
    public val __1554456544_Ptr: Pointer?

    public val _1554456544_VtblPtr: Pointer?
      get() = __1554456544_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun add_CanExecuteChanged(handler: EventHandler<IUnknown?>?):
        EventRegistrationToken? {
      val fnPtr = _1554456544_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__1554456544_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
    ...
    public override fun remove_CanExecuteChanged(token: EventRegistrationToken?): Unit {
      val fnPtr = _1554456544_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1554456544_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun CanExecute(parameter: IUnknown?): Boolean {
      val fnPtr = _1554456544_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1554456544_Ptr, marshalToNative(parameter), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun Execute(parameter: IUnknown?): Unit {
      val fnPtr = _1554456544_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1554456544_Ptr, marshalToNative(parameter),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class ICommand_Impl(
    ...
    public override val __1554456544_Ptr: Pointer?
      get() = pointer
  }
  ...
  public object ABI : IABI<ICommand, MemoryAddress> {
    ...
    public override fun toNative(obj: ICommand): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1554456544_Ptr))
  }
