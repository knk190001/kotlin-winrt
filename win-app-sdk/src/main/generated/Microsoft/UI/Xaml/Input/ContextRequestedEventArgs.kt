...
@Signature("rc(Microsoft.UI.Xaml.Input.ContextRequestedEventArgs;{bcedcb98-77b5-53c0-802e-fd52f3806e51})")
...
public class ContextRequestedEventArgs(
  ...
  private val __1753118675_Interface: IContextRequestedEventArgs.WithDefault by lazy {
    as_1753118675()
  }


  public override val __1753118675_Ptr: JNAPointer? by lazy {
    __1753118675_Interface.__1753118675_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1753118675_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1753118675(): IContextRequestedEventArgs.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<ContextRequestedEventArgs, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Input.ContextRequestedEventArgs".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
