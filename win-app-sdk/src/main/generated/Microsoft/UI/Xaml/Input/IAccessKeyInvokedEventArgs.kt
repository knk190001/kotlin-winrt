...
@Signature("{d00c11a4-f9fb-5707-9692-98b80bb8546d}")
@Guid("d00c11a4f9fb5707969298b80bb8546d")
@WinRTInterface("d00c11a4f9fb5707969298b80bb8546d")
...
public interface IAccessKeyInvokedEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IAccessKeyInvokedEventArgs {
    public val __398414555_Ptr: Pointer?

    public val _398414555_VtblPtr: Pointer?
      get() = __398414555_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Handled(): Boolean {
      val fnPtr = _398414555_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__398414555_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Handled(value: Boolean): Unit {
      val fnPtr = _398414555_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__398414555_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IAccessKeyInvokedEventArgs_Impl(
    ...
    public override val __398414555_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IAccessKeyInvokedEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("d00c11a4f9fb5707969298b80bb8546d")
    ...
    public override fun toNative(obj: IAccessKeyInvokedEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__398414555_Ptr))
  }
