...
import Microsoft.UI.Input.HoldingState
...
@Signature("{8272a4b2-2221-551e-b0bb-16e29138ab20}")
@Guid("8272a4b22221551eb0bb16e29138ab20")
@WinRTInterface("8272a4b22221551eb0bb16e29138ab20")
...
public interface IHoldingRoutedEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IHoldingRoutedEventArgs {
    public val __188889892_Ptr: Pointer?

    public val _188889892_VtblPtr: Pointer?
      get() = __188889892_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_PointerDeviceType(): PointerDeviceType? {
      val fnPtr = _188889892_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<PointerDeviceType>()
      val hr = fn.invokeHR(arrayOf(__188889892_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_HoldingState(): HoldingState? {
      val fnPtr = _188889892_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_Handled(): Boolean {
      val fnPtr = _188889892_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Handled(value: Boolean): Unit {
      val fnPtr = _188889892_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__188889892_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun GetPosition(relativeTo: UIElement?): Point? {
      val fnPtr = _188889892_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Point>()
      val hr = fn.invokeHR(arrayOf(__188889892_Ptr, marshalToNative(relativeTo), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
  ...
  public class IHoldingRoutedEventArgs_Impl(
    ...
    public override val __188889892_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IHoldingRoutedEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("8272a4b22221551eb0bb16e29138ab20")
    ...
    public override fun toNative(obj: IHoldingRoutedEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__188889892_Ptr))
  }
