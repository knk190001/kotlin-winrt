...
@Signature("rc(Microsoft.UI.Xaml.Input.AccessKeyDisplayRequestedEventArgs;{c4ed84d8-2b27-59b1-9cf0-7f9164de58cb})")
...
public class AccessKeyDisplayRequestedEventArgs(
  ...
  private val __878229339_Interface: IAccessKeyDisplayRequestedEventArgs.WithDefault by lazy {
    as_878229339()
  }


  public override val __878229339_Ptr: JNAPointer? by lazy {
    __878229339_Interface.__878229339_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__878229339_Interface)

  public constructor() : this(ABI.activate())

  private fun as_878229339(): IAccessKeyDisplayRequestedEventArgs.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<AccessKeyDisplayRequestedEventArgs, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Input.AccessKeyDisplayRequestedEventArgs".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
