...
@Signature("{ab80c197-85cc-5d36-81aa-156cd63be31a}")
@Guid("ab80c19785cc5d3681aa156cd63be31a")
@WinRTInterface("ab80c19785cc5d3681aa156cd63be31a")
...
public interface IStandardUICommandStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IStandardUICommandStatics {
    public val __1299063414_Ptr: Pointer?

    public val _1299063414_VtblPtr: Pointer?
      get() = __1299063414_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_KindProperty(): DependencyProperty? {
      val fnPtr = _1299063414_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1299063414_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IStandardUICommandStatics_Impl(
    ...
    public override val __1299063414_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IStandardUICommandStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("ab80c19785cc5d3681aa156cd63be31a")
    ...
    public override fun toNative(obj: IStandardUICommandStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1299063414_Ptr))
  }
