...
@Signature("rc(Microsoft.UI.Xaml.Input.ProcessKeyboardAcceleratorEventArgs;{9be0d058-3d26-5811-b50a-3bb80ca766c9})")
...
public class ProcessKeyboardAcceleratorEventArgs(
  ...
  private val __2074029033_Interface: IProcessKeyboardAcceleratorEventArgs.WithDefault by lazy {
    as_2074029033()
  }


  public override val __2074029033_Ptr: JNAPointer? by lazy {
    __2074029033_Interface.__2074029033_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__2074029033_Interface)

  private fun as_2074029033(): IProcessKeyboardAcceleratorEventArgs.WithDefault {
    if(pointer == NULL) {
