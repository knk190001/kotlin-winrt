...
@Signature("{7f88e76b-7417-5447-aed4-2fabd291bdc6}")
@Guid("7f88e76b74175447aed42fabd291bdc6")
@WinRTInterface("7f88e76b74175447aed42fabd291bdc6")
...
public interface IFindNextElementOptions : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IFindNextElementOptions {
    public val __129296839_Ptr: Pointer?

    public val _129296839_VtblPtr: Pointer?
      get() = __129296839_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_SearchRoot(): DependencyObject? {
      val fnPtr = _129296839_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyObject>()
      val hr = fn.invokeHR(arrayOf(__129296839_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_SearchRoot(value: DependencyObject?): Unit {
      val fnPtr = _129296839_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__129296839_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_ExclusionRect(): Rect? {
      val fnPtr = _129296839_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_ExclusionRect(value: Rect?): Unit {
      val fnPtr = _129296839_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__129296839_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_HintRect(): Rect? {
      val fnPtr = _129296839_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Rect>()
      val hr = fn.invokeHR(arrayOf(__129296839_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_HintRect(value: Rect?): Unit {
      val fnPtr = _129296839_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__129296839_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_XYFocusNavigationStrategyOverride():
      ...
      val fnPtr = _129296839_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override
      ...
      val fnPtr = _129296839_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__129296839_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IFindNextElementOptions_Impl(
    ...
    public override val __129296839_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IFindNextElementOptions, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("7f88e76b74175447aed42fabd291bdc6")
    ...
    public override fun toNative(obj: IFindNextElementOptions): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__129296839_Ptr))
  }
