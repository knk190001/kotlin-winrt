...
@Signature("rc(Microsoft.UI.Xaml.Input.KeyboardAcceleratorInvokedEventArgs;{62c9fdb0-b574-527d-97eb-5c7f674441e0})")
...
public class KeyboardAcceleratorInvokedEventArgs(
  ptr: JNAPointer? = NULL
) : PointerType(ptr), IKeyboardAcceleratorInvokedEventArgs.WithDefault, IWinRTObject {
  private val __942955452_Interface: IKeyboardAcceleratorInvokedEventArgs.WithDefault by lazy {
    as_942955452()
  }


  public override val __942955452_Ptr: JNAPointer? by lazy {
    __942955452_Interface.__942955452_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__942955452_Interface)

  private fun as_942955452(): IKeyboardAcceleratorInvokedEventArgs.WithDefault {
    if(pointer == NULL) {
