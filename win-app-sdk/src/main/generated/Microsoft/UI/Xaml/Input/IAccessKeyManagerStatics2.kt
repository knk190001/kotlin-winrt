...
@Signature("{512c9f63-24ad-5df2-b8ed-472406db31c0}")
@Guid("512c9f6324ad5df2b8ed472406db31c0")
@WinRTInterface("512c9f6324ad5df2b8ed472406db31c0")
...
public interface IAccessKeyManagerStatics2 : NativeMapped, IWinRTInterface {
  @InterfaceMethod(0)
  public fun EnterDisplayMode(XamlRoot: XamlRoot?): Unit
  ...
  public interface WithDefault : IAccessKeyManagerStatics2 {
    public val __1759501322_Ptr: Pointer?

    public val _1759501322_VtblPtr: Pointer?
      get() = __1759501322_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun EnterDisplayMode(XamlRoot: XamlRoot?): Unit {
      val fnPtr = _1759501322_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1759501322_Ptr, marshalToNative(XamlRoot),))
      if (hr.toInt() != 0) {
  ...
  public class IAccessKeyManagerStatics2_Impl(
    ...
    public override val __1759501322_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IAccessKeyManagerStatics2, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("512c9f6324ad5df2b8ed472406db31c0")
    ...
    public override fun toNative(obj: IAccessKeyManagerStatics2): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1759501322_Ptr))
  }
