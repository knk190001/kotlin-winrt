...
@Signature("{a46259fd-3edd-554b-a188-0a47b71e4e1a}")
@Guid("a46259fd3edd554ba1880a47b71e4e1a")
@WinRTInterface("a46259fd3edd554ba1880a47b71e4e1a")
...
public interface IFocusMovementResult : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IFocusMovementResult {
    public val __433977927_Ptr: Pointer?

    public val _433977927_VtblPtr: Pointer?
      get() = __433977927_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Succeeded(): Boolean {
      val fnPtr = _433977927_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__433977927_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IFocusMovementResult_Impl(
    ...
    public override val __433977927_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IFocusMovementResult, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("a46259fd3edd554ba1880a47b71e4e1a")
    ...
    public override fun toNative(obj: IFocusMovementResult): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__433977927_Ptr))
  }
