...
@Signature("{981dbda6-cdcb-5e35-b24b-c4f60ba148d9}")
@Guid("981dbda6cdcb5e35b24bc4f60ba148d9")
@WinRTInterface("981dbda6cdcb5e35b24bc4f60ba148d9")
...
public interface IXamlUICommandStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IXamlUICommandStatics {
    public val __846966399_Ptr: Pointer?

    public val _846966399_VtblPtr: Pointer?
      get() = __846966399_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_LabelProperty(): DependencyProperty? {
      val fnPtr = _846966399_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__846966399_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IconSourceProperty(): DependencyProperty? {
      val fnPtr = _846966399_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__846966399_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_KeyboardAcceleratorsProperty(): DependencyProperty? {
      val fnPtr = _846966399_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__846966399_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_AccessKeyProperty(): DependencyProperty? {
      val fnPtr = _846966399_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__846966399_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_DescriptionProperty(): DependencyProperty? {
      val fnPtr = _846966399_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__846966399_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_CommandProperty(): DependencyProperty? {
      val fnPtr = _846966399_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__846966399_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IXamlUICommandStatics_Impl(
    ...
    public override val __846966399_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IXamlUICommandStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("981dbda6cdcb5e35b24bc4f60ba148d9")
    ...
    public override fun toNative(obj: IXamlUICommandStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__846966399_Ptr))
  }
