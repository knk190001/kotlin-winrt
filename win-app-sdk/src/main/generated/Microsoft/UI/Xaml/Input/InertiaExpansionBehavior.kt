...
@Signature("rc(Microsoft.UI.Xaml.Input.InertiaExpansionBehavior;{d60029b7-f0cd-5aea-abe5-7410d09118c6})")
...
public class InertiaExpansionBehavior(
  ...
  private val __958505122_Interface: IInertiaExpansionBehavior.WithDefault by lazy {
    as_958505122()
  }


  public override val __958505122_Ptr: JNAPointer? by lazy {
    __958505122_Interface.__958505122_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__958505122_Interface)

  private fun as_958505122(): IInertiaExpansionBehavior.WithDefault {
    if(pointer == NULL) {
