...
@Signature("{51369745-960f-54ac-93fa-763d22910dea}")
@Guid("51369745960f54ac93fa763d22910dea")
@WinRTInterface("51369745960f54ac93fa763d22910dea")
...
public interface IManipulationDeltaRoutedEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IManipulationDeltaRoutedEventArgs {
    public val __2086497036_Ptr: Pointer?

    public val _2086497036_VtblPtr: Pointer?
      get() = __2086497036_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Container(): UIElement? {
      val fnPtr = _2086497036_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<UIElement>()
      val hr = fn.invokeHR(arrayOf(__2086497036_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Position(): Point? {
      val fnPtr = _2086497036_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_IsInertial(): Boolean {
      val fnPtr = _2086497036_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_Delta(): ManipulationDelta? {
      val fnPtr = _2086497036_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_Cumulative(): ManipulationDelta? {
      val fnPtr = _2086497036_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ManipulationDelta>()
      val hr = fn.invokeHR(arrayOf(__2086497036_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Velocities(): ManipulationVelocities? {
      val fnPtr = _2086497036_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_Handled(): Boolean {
      val fnPtr = _2086497036_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__2086497036_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Handled(value: Boolean): Unit {
      val fnPtr = _2086497036_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2086497036_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_PointerDeviceType(): PointerDeviceType? {
      val fnPtr = _2086497036_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun Complete(): Unit {
      val fnPtr = _2086497036_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2086497036_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IManipulationDeltaRoutedEventArgs_Impl(
    ...
    public override val __2086497036_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IManipulationDeltaRoutedEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("51369745960f54ac93fa763d22910dea")
    ...
    public override fun toNative(obj: IManipulationDeltaRoutedEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2086497036_Ptr))
  }
