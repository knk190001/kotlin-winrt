...
@Signature("rc(Microsoft.UI.Xaml.Input.KeyRoutedEventArgs;{ee357007-a2d6-5c75-9431-05fd66ec7915})")
@WinRTByReference(brClass = KeyRoutedEventArgs.ByReference::class)
public class KeyRoutedEventArgs(
  ptr: JNAPointer? = NULL
) : RoutedEventArgs(ptr), IKeyRoutedEventArgs.WithDefault, IWinRTObject {
  private val __1494418824_Interface: IKeyRoutedEventArgs.WithDefault by lazy {
    as_1494418824()
  }


  public override val __1494418824_Ptr: JNAPointer? by lazy {
    __1494418824_Interface.__1494418824_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1494418824_Interface)

  private fun as_1494418824(): IKeyRoutedEventArgs.WithDefault {
    if(pointer == NULL) {
