...
@Signature("rc(Microsoft.UI.Xaml.Input.ManipulationPivot;{286baba4-313d-507c-adc5-f739732cea27})")
...
public class ManipulationPivot(
  ...
  private val __1974945018_Interface: IManipulationPivot.WithDefault by lazy {
    as_1974945018()
  }


  public override val __1974945018_Ptr: JNAPointer? by lazy {
    __1974945018_Interface.__1974945018_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1974945018_Interface)

  public constructor() : this(ABI.activate())

  public constructor(center: Point, radius: Double) : this(ABI.activate(center, radius))

  private fun as_1974945018(): IManipulationPivot.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<ManipulationPivot, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Input.ManipulationPivot".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
    ...
    public fun createIManipulationPivotFactory(): IManipulationPivotFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Input.ManipulationPivot".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
