...
@Signature("rc(Microsoft.UI.Xaml.Input.RightTappedRoutedEventArgs;{3972fafb-2915-5c62-bb6b-54ad84ff400d})")
...
public class RightTappedRoutedEventArgs(
  ...
  private val __1408944641_Interface: IRightTappedRoutedEventArgs.WithDefault by lazy {
    as_1408944641()
  }


  public override val __1408944641_Ptr: JNAPointer? by lazy {
    __1408944641_Interface.__1408944641_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1408944641_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1408944641(): IRightTappedRoutedEventArgs.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<RightTappedRoutedEventArgs, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Input.RightTappedRoutedEventArgs".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
