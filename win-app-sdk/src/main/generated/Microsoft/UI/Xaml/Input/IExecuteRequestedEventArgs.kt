...
@Signature("{e1a9fd0c-34d0-5ae2-8f5d-377e7a8a2708}")
@Guid("e1a9fd0c34d05ae28f5d377e7a8a2708")
@WinRTInterface("e1a9fd0c34d05ae28f5d377e7a8a2708")
...
public interface IExecuteRequestedEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IExecuteRequestedEventArgs {
    public val __257729651_Ptr: Pointer?

    public val _257729651_VtblPtr: Pointer?
      get() = __257729651_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Parameter(): IUnknown? {
      val fnPtr = _257729651_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IUnknown>()
      val hr = fn.invokeHR(arrayOf(__257729651_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IExecuteRequestedEventArgs_Impl(
    ...
    public override val __257729651_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IExecuteRequestedEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("e1a9fd0c34d05ae28f5d377e7a8a2708")
    ...
    public override fun toNative(obj: IExecuteRequestedEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__257729651_Ptr))
  }
