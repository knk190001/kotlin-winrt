...
@Signature("rc(Microsoft.UI.Xaml.Input.TappedRoutedEventArgs;{73f74b8c-3709-547e-8e0c-51c03c89126a})")
...
public class TappedRoutedEventArgs(
  ...
  private val __208957115_Interface: ITappedRoutedEventArgs.WithDefault by lazy {
    as_208957115()
  }


  public override val __208957115_Ptr: JNAPointer? by lazy {
    __208957115_Interface.__208957115_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__208957115_Interface)

  public constructor() : this(ABI.activate())

  private fun as_208957115(): ITappedRoutedEventArgs.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<TappedRoutedEventArgs, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.Input.TappedRoutedEventArgs".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
