...
@Signature("{bd60c019-833b-5432-a41d-89d72410eb47}")
@Guid("bd60c019833b5432a41d89d72410eb47")
@WinRTInterface("bd60c019833b5432a41d89d72410eb47")
...
public interface IStateTriggerStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IStateTriggerStatics {
    public val __1293001161_Ptr: Pointer?

    public val _1293001161_VtblPtr: Pointer?
      get() = __1293001161_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_IsActiveProperty(): DependencyProperty? {
      val fnPtr = _1293001161_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DependencyProperty>()
      val hr = fn.invokeHR(arrayOf(__1293001161_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IStateTriggerStatics_Impl(
    ...
    public override val __1293001161_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IStateTriggerStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("bd60c019833b5432a41d89d72410eb47")
    ...
    public override fun toNative(obj: IStateTriggerStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1293001161_Ptr))
  }
