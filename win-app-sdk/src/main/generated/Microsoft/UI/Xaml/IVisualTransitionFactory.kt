...
@Signature("{f3e74c0d-0b5b-5920-a309-08cb6bf2a739}")
@Guid("f3e74c0d0b5b5920a30908cb6bf2a739")
@WinRTInterface("f3e74c0d0b5b5920a30908cb6bf2a739")
...
public interface IVisualTransitionFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IVisualTransitionFactory {
    public val __1159637614_Ptr: Pointer?

    public val _1159637614_VtblPtr: Pointer?
      get() = __1159637614_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        VisualTransition? {
      val fnPtr = _1159637614_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<VisualTransition>()
      val hr = fn.invokeHR(arrayOf(__1159637614_Ptr, marshalToNative(baseInterface),
  ...
  public class IVisualTransitionFactory_Impl(
    ...
    public override val __1159637614_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IVisualTransitionFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("f3e74c0d0b5b5920a30908cb6bf2a739")
    ...
    public override fun toNative(obj: IVisualTransitionFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1159637614_Ptr))
  }
