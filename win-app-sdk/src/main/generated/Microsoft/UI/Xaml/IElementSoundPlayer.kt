...
@Signature("{0ea67e68-937c-5c00-b609-53b63d9a5d42}")
@Guid("0ea67e68937c5c00b60953b63d9a5d42")
@WinRTInterface("0ea67e68937c5c00b60953b63d9a5d42")
...
public interface IElementSoundPlayer : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IElementSoundPlayer {
    public val __1719890107_Ptr: Pointer?

    public val _1719890107_VtblPtr: Pointer?
      get() = __1719890107_Ptr?.getPointer(0)
  }

  public class IElementSoundPlayer_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __1719890107_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IElementSoundPlayer, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("0ea67e68937c5c00b60953b63d9a5d42")
    ...
    public override fun toNative(obj: IElementSoundPlayer): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1719890107_Ptr))
  }
