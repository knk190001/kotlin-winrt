...
@Signature("rc(Microsoft.UI.Xaml.VisualState;{4bb32ae8-0e28-5521-a7f5-66b661372994})")
@WinRTByReference(brClass = VisualState.ByReference::class)
public class VisualState(
  ptr: JNAPointer? = NULL
) : DependencyObject(ptr), IVisualState.WithDefault, IWinRTObject {
  private val __1257765514_Interface: IVisualState.WithDefault by lazy {
    as_1257765514()
  }


  public override val __1257765514_Ptr: JNAPointer? by lazy {
    __1257765514_Interface.__1257765514_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1257765514_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1257765514(): IVisualState.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<VisualState, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr = INSTANCE.RoGetActivationFactory("Microsoft.UI.Xaml.VisualState".toHandle(), refiid,
          iAFPtr)
      checkHR(hr)
