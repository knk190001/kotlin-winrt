...
@Signature("{a9cf37ad-5430-5086-a39f-74f0d1ed1072}")
@Guid("a9cf37ad54305086a39f74f0d1ed1072")
@WinRTInterface("a9cf37ad54305086a39f74f0d1ed1072")
...
public interface IRectHelperStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IRectHelperStatics {
    public val __732680372_Ptr: Pointer?

    public val _732680372_VtblPtr: Pointer?
      get() = __732680372_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Empty(): Rect? {
      val fnPtr = _732680372_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Rect>()
      val hr = fn.invokeHR(arrayOf(__732680372_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun FromCoordinatesAndDimensions(
      ...
      val fnPtr = _732680372_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Rect>()
      val hr = fn.invokeHR(arrayOf(__732680372_Ptr, x, y, width, height, result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
      val resultValue = marshalFromNative<Rect>(result.getValue())
    ...
    public override fun FromPoints(point1: Point?, point2: Point?): Rect? {
      val fnPtr = _732680372_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Rect>()
      val hr = fn.invokeHR(arrayOf(__732680372_Ptr, marshalToNative(point1),
    ...
    public override fun FromLocationAndSize(location: Point?, size: Size?): Rect? {
      val fnPtr = _732680372_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Rect>()
      val hr = fn.invokeHR(arrayOf(__732680372_Ptr, marshalToNative(location),
    ...
    public override fun GetIsEmpty(target: Rect?): Boolean {
      val fnPtr = _732680372_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__732680372_Ptr, marshalToNative(target), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun GetBottom(target: Rect?): Float {
      val fnPtr = _732680372_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun GetLeft(target: Rect?): Float {
      val fnPtr = _732680372_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__732680372_Ptr, marshalToNative(target), result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetRight(target: Rect?): Float {
      val fnPtr = _732680372_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__732680372_Ptr, marshalToNative(target), result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetTop(target: Rect?): Float {
      val fnPtr = _732680372_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__732680372_Ptr, marshalToNative(target), result))
      if (hr.toInt() != 0) {
    ...
    public override fun Contains(target: Rect?, point: Point?): Boolean {
      val fnPtr = _732680372_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__732680372_Ptr, marshalToNative(target), marshalToNative(point),
          result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun Equals(target: Rect?, value: Rect?): Boolean {
      val fnPtr = _732680372_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__732680372_Ptr, marshalToNative(target), marshalToNative(value),
          result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun Intersect(target: Rect?, rect: Rect?): Rect? {
      val fnPtr = _732680372_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Rect>()
      val hr = fn.invokeHR(arrayOf(__732680372_Ptr, marshalToNative(target), marshalToNative(rect),
          result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun Union(target: Rect?, point: Point?): Rect? {
      val fnPtr = _732680372_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Rect>()
      val hr = fn.invokeHR(arrayOf(__732680372_Ptr, marshalToNative(target), marshalToNative(point),
          result))
    ...
    public override fun Union(target: Rect?, rect: Rect?): Rect? {
      val fnPtr = _732680372_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Rect>()
      val hr = fn.invokeHR(arrayOf(__732680372_Ptr, marshalToNative(target), marshalToNative(rect),
          result))
  ...
  public class IRectHelperStatics_Impl(
    ...
    public override val __732680372_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IRectHelperStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("a9cf37ad54305086a39f74f0d1ed1072")
    ...
    public override fun toNative(obj: IRectHelperStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__732680372_Ptr))
  }
