...
@Signature("{75faba47-2cf2-54ae-91e6-0581556fddaa}")
@Guid("75faba472cf254ae91e60581556fddaa")
@WinRTInterface("75faba472cf254ae91e60581556fddaa")
...
public interface IElementFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IElementFactory {
    public val __1007794571_Ptr: Pointer?

    public val _1007794571_VtblPtr: Pointer?
      get() = __1007794571_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun GetElement(args: ElementFactoryGetArgs?): UIElement? {
      val fnPtr = _1007794571_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<UIElement>()
      val hr = fn.invokeHR(arrayOf(__1007794571_Ptr, marshalToNative(args), result))
      if (hr.toInt() != 0) {
    ...
    public override fun RecycleElement(args: ElementFactoryRecycleArgs?): Unit {
      val fnPtr = _1007794571_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1007794571_Ptr, marshalToNative(args),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IElementFactory_Impl(
    ...
    public override val __1007794571_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IElementFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("75faba472cf254ae91e60581556fddaa")
    ...
    public override fun toNative(obj: IElementFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1007794571_Ptr))
  }
