...
@Signature("{13b2f604-eebc-5daa-8a5b-460c4fabdeb7}")
@Guid("13b2f604eebc5daa8a5b460c4fabdeb7")
@WinRTInterface("13b2f604eebc5daa8a5b460c4fabdeb7")
...
public interface IDataTemplateKeyFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IDataTemplateKeyFactory {
    public val __1911224342_Ptr: Pointer?

    public val _1911224342_VtblPtr: Pointer?
      get() = __1911224342_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateInstance(baseInterface: IUnknown?, innerInterface: IUnknown?):
        DataTemplateKey? {
      val fnPtr = _1911224342_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DataTemplateKey>()
      val hr = fn.invokeHR(arrayOf(__1911224342_Ptr, marshalToNative(baseInterface),
    ...
    public override fun CreateInstanceWithType(
      ...
      val fnPtr = _1911224342_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DataTemplateKey>()
      val hr = fn.invokeHR(arrayOf(__1911224342_Ptr, marshalToNative(dataType),
  ...
  public class IDataTemplateKeyFactory_Impl(
    ...
    public override val __1911224342_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IDataTemplateKeyFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("13b2f604eebc5daa8a5b460c4fabdeb7")
    ...
    public override fun toNative(obj: IDataTemplateKeyFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1911224342_Ptr))
  }
