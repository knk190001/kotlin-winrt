...
@Signature("{06d4abcf-0c06-5d12-a743-85537efd09ea}")
@Guid("06d4abcf0c065d12a74385537efd09ea")
@WinRTInterface("06d4abcf0c065d12a74385537efd09ea")
...
public interface ITextRange : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITextRange {
    public val __1605925810_Ptr: Pointer?

    public val _1605925810_VtblPtr: Pointer?
      get() = __1605925810_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Character(): Char {
      val fnPtr = _1605925810_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Char>()
      val hr = fn.invokeHR(arrayOf(__1605925810_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Character(value: Char): Unit {
      val fnPtr = _1605925810_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1605925810_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_CharacterFormat(): ITextCharacterFormat? {
      val fnPtr = _1605925810_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_CharacterFormat(value: ITextCharacterFormat?): Unit {
      val fnPtr = _1605925810_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1605925810_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_FormattedText(): ITextRange? {
      val fnPtr = _1605925810_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_FormattedText(value: ITextRange?): Unit {
      val fnPtr = _1605925810_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1605925810_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_EndPosition(): Int {
      val fnPtr = _1605925810_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_EndPosition(value: Int): Unit {
      val fnPtr = _1605925810_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1605925810_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Gravity(): RangeGravity? {
      val fnPtr = _1605925810_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Gravity(value: RangeGravity?): Unit {
      val fnPtr = _1605925810_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1605925810_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Length(): Int {
      val fnPtr = _1605925810_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__1605925810_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Link(): String? {
      val fnPtr = _1605925810_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Link(value: String?): Unit {
      val fnPtr = _1605925810_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1605925810_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ParagraphFormat(): ITextParagraphFormat? {
      val fnPtr = _1605925810_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_ParagraphFormat(value: ITextParagraphFormat?): Unit {
      val fnPtr = _1605925810_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1605925810_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_StartPosition(): Int {
      val fnPtr = _1605925810_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__1605925810_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_StartPosition(value: Int): Unit {
      val fnPtr = _1605925810_VtblPtr!!.getPointer(22L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1605925810_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_StoryLength(): Int {
      val fnPtr = _1605925810_VtblPtr!!.getPointer(23L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__1605925810_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Text(): String? {
      val fnPtr = _1605925810_VtblPtr!!.getPointer(24L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__1605925810_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Text(value: String?): Unit {
      val fnPtr = _1605925810_VtblPtr!!.getPointer(25L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1605925810_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun CanPaste(format: Int): Boolean {
      val fnPtr = _1605925810_VtblPtr!!.getPointer(26L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1605925810_Ptr, format, result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun ChangeCase(value: LetterCase?): Unit {
      val fnPtr = _1605925810_VtblPtr!!.getPointer(27L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1605925810_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun Collapse(value: Boolean): Unit {
      val fnPtr = _1605925810_VtblPtr!!.getPointer(28L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1605925810_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun Copy(): Unit {
      val fnPtr = _1605925810_VtblPtr!!.getPointer(29L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1605925810_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun Cut(): Unit {
      val fnPtr = _1605925810_VtblPtr!!.getPointer(30L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1605925810_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun Delete(unit: TextRangeUnit?, count: Int): Int {
      val fnPtr = _1605925810_VtblPtr!!.getPointer(31L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__1605925810_Ptr, marshalToNative(unit), count, result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
      val resultValue = marshalFromNative<Int>(result.getValue())
    ...
    public override fun EndOf(unit: TextRangeUnit?, extend: Boolean): Int {
      val fnPtr = _1605925810_VtblPtr!!.getPointer(32L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__1605925810_Ptr, marshalToNative(unit), extend, result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
      val resultValue = marshalFromNative<Int>(result.getValue())
    ...
    public override fun Expand(unit: TextRangeUnit?): Int {
      val fnPtr = _1605925810_VtblPtr!!.getPointer(33L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__1605925810_Ptr, marshalToNative(unit), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
      val resultValue = marshalFromNative<Int>(result.getValue())
    ...
    public override fun FindText(
      ...
      val fnPtr = _1605925810_VtblPtr!!.getPointer(34L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__1605925810_Ptr, marshalToNative(value), scanLength,
    ...
    public override fun GetCharacterUtf32(value: WinDef.UINT, offset: Int): Unit {
      val fnPtr = _1605925810_VtblPtr!!.getPointer(35L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1605925810_Ptr, value, offset,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun GetClone(): ITextRange? {
      val fnPtr = _1605925810_VtblPtr!!.getPointer(36L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ITextRange>()
      val hr = fn.invokeHR(arrayOf(__1605925810_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetIndex(unit: TextRangeUnit?): Int {
      val fnPtr = _1605925810_VtblPtr!!.getPointer(37L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__1605925810_Ptr, marshalToNative(unit), result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetPoint(
      ...
      val fnPtr = _1605925810_VtblPtr!!.getPointer(38L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1605925810_Ptr, marshalToNative(horizontalAlign),
    ...
    public override fun GetRect(
      ...
      val fnPtr = _1605925810_VtblPtr!!.getPointer(39L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1605925810_Ptr, marshalToNative(options),
          marshalToNative(rect), hit,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun GetText(options: TextGetOptions?, value: String?): Unit {
      val fnPtr = _1605925810_VtblPtr!!.getPointer(40L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1605925810_Ptr, marshalToNative(options),
    ...
    public override fun GetTextViaStream(options: TextGetOptions?, value: IRandomAccessStream?):
        Unit {
      val fnPtr = _1605925810_VtblPtr!!.getPointer(41L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1605925810_Ptr, marshalToNative(options),
          marshalToNative(value),))
      if (hr.toInt() != 0) {
    ...
    public override fun InRange(range: ITextRange?): Boolean {
      val fnPtr = _1605925810_VtblPtr!!.getPointer(42L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1605925810_Ptr, marshalToNative(range), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
      val resultValue = marshalFromNative<Boolean>(result.getValue())
    ...
    public override fun InsertImage(
      ...
      val fnPtr = _1605925810_VtblPtr!!.getPointer(43L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1605925810_Ptr, width, height, ascent,
    ...
    public override fun InStory(range: ITextRange?): Boolean {
      val fnPtr = _1605925810_VtblPtr!!.getPointer(44L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1605925810_Ptr, marshalToNative(range), result))
      if (hr.toInt() != 0) {
    ...
    public override fun IsEqual(range: ITextRange?): Boolean {
      val fnPtr = _1605925810_VtblPtr!!.getPointer(45L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1605925810_Ptr, marshalToNative(range), result))
      if (hr.toInt() != 0) {
    ...
    public override fun Move(unit: TextRangeUnit?, count: Int): Int {
      val fnPtr = _1605925810_VtblPtr!!.getPointer(46L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__1605925810_Ptr, marshalToNative(unit), count, result))
      if (hr.toInt() != 0) {
    ...
    public override fun MoveEnd(unit: TextRangeUnit?, count: Int): Int {
      val fnPtr = _1605925810_VtblPtr!!.getPointer(47L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__1605925810_Ptr, marshalToNative(unit), count, result))
      if (hr.toInt() != 0) {
    ...
    public override fun MoveStart(unit: TextRangeUnit?, count: Int): Int {
      val fnPtr = _1605925810_VtblPtr!!.getPointer(48L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__1605925810_Ptr, marshalToNative(unit), count, result))
      if (hr.toInt() != 0) {
    ...
    public override fun Paste(format: Int): Unit {
      val fnPtr = _1605925810_VtblPtr!!.getPointer(49L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1605925810_Ptr, format,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun ScrollIntoView(value: PointOptions?): Unit {
      val fnPtr = _1605925810_VtblPtr!!.getPointer(50L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1605925810_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun MatchSelection(): Unit {
      val fnPtr = _1605925810_VtblPtr!!.getPointer(51L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1605925810_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun SetIndex(
      ...
      val fnPtr = _1605925810_VtblPtr!!.getPointer(52L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1605925810_Ptr, marshalToNative(unit), index, extend,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun SetPoint(
      ...
      val fnPtr = _1605925810_VtblPtr!!.getPointer(53L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1605925810_Ptr, marshalToNative(point),
          marshalToNative(options), extend,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun SetRange(startPosition: Int, endPosition: Int): Unit {
      val fnPtr = _1605925810_VtblPtr!!.getPointer(54L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1605925810_Ptr, startPosition, endPosition,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun SetText(options: TextSetOptions?, value: String?): Unit {
      val fnPtr = _1605925810_VtblPtr!!.getPointer(55L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1605925810_Ptr, marshalToNative(options),
          marshalToNative(value),))
      if (hr.toInt() != 0) {
    ...
    public override fun SetTextViaStream(options: TextSetOptions?, value: IRandomAccessStream?):
        Unit {
      val fnPtr = _1605925810_VtblPtr!!.getPointer(56L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1605925810_Ptr, marshalToNative(options),
          marshalToNative(value),))
      if (hr.toInt() != 0) {
    ...
    public override fun StartOf(unit: TextRangeUnit?, extend: Boolean): Int {
      val fnPtr = _1605925810_VtblPtr!!.getPointer(57L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__1605925810_Ptr, marshalToNative(unit), extend, result))
      if (hr.toInt() != 0) {
  ...
  public class ITextRange_Impl(
    ...
    public override val __1605925810_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITextRange, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("06d4abcf0c065d12a74385537efd09ea")
    ...
    public override fun toNative(obj: ITextRange): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1605925810_Ptr))
  }
