...
@Signature("{386cd040-5404-5a8d-8bc7-2ca989f5c065}")
@Guid("386cd04054045a8d8bc72ca989f5c065")
@WinRTInterface("386cd04054045a8d8bc72ca989f5c065")
...
public interface IFontWeights : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IFontWeights {
    public val __1463035498_Ptr: Pointer?

    public val _1463035498_VtblPtr: Pointer?
      get() = __1463035498_Ptr?.getPointer(0)
  }

  public class IFontWeights_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __1463035498_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IFontWeights, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("386cd04054045a8d8bc72ca989f5c065")
    ...
    public override fun toNative(obj: IFontWeights): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1463035498_Ptr))
  }
