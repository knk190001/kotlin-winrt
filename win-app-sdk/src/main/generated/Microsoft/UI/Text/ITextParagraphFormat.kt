...
@Signature("{219b6cdf-0d0b-5701-b8a1-6c906b3ebbe1}")
@Guid("219b6cdf0d0b5701b8a16c906b3ebbe1")
@WinRTInterface("219b6cdf0d0b5701b8a16c906b3ebbe1")
...
public interface ITextParagraphFormat : NativeMapped, IWinRTInterface {
  ...
  public fun GetTab(
    index: Int,
    position: Float,
    align: Microsoft.UI.Text.TabAlignment.ByReference?,
    leader: Microsoft.UI.Text.TabLeader.ByReference?
  ): Unit
  ...
  public interface WithDefault : ITextParagraphFormat {
    public val __473379626_Ptr: Pointer?

    public val _473379626_VtblPtr: Pointer?
      get() = __473379626_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Alignment(): ParagraphAlignment? {
      val fnPtr = _473379626_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ParagraphAlignment>()
      val hr = fn.invokeHR(arrayOf(__473379626_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Alignment(value: ParagraphAlignment?): Unit {
      val fnPtr = _473379626_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__473379626_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_FirstLineIndent(): Float {
      val fnPtr = _473379626_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_KeepTogether(): FormatEffect? {
      val fnPtr = _473379626_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_KeepTogether(value: FormatEffect?): Unit {
      val fnPtr = _473379626_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__473379626_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_KeepWithNext(): FormatEffect? {
      val fnPtr = _473379626_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<FormatEffect>()
      val hr = fn.invokeHR(arrayOf(__473379626_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_KeepWithNext(value: FormatEffect?): Unit {
      val fnPtr = _473379626_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__473379626_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_LeftIndent(): Float {
      val fnPtr = _473379626_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__473379626_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_LineSpacing(): Float {
      val fnPtr = _473379626_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__473379626_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_LineSpacingRule(): LineSpacingRule? {
      val fnPtr = _473379626_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_ListAlignment(): MarkerAlignment? {
      val fnPtr = _473379626_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_ListAlignment(value: MarkerAlignment?): Unit {
      val fnPtr = _473379626_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__473379626_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ListLevelIndex(): Int {
      val fnPtr = _473379626_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_ListLevelIndex(value: Int): Unit {
      val fnPtr = _473379626_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__473379626_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_ListStart(): Int {
      val fnPtr = _473379626_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__473379626_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ListStart(value: Int): Unit {
      val fnPtr = _473379626_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__473379626_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ListStyle(): MarkerStyle? {
      val fnPtr = _473379626_VtblPtr!!.getPointer(22L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_ListStyle(value: MarkerStyle?): Unit {
      val fnPtr = _473379626_VtblPtr!!.getPointer(23L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__473379626_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ListTab(): Float {
      val fnPtr = _473379626_VtblPtr!!.getPointer(24L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__473379626_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ListTab(value: Float): Unit {
      val fnPtr = _473379626_VtblPtr!!.getPointer(25L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__473379626_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ListType(): MarkerType? {
      val fnPtr = _473379626_VtblPtr!!.getPointer(26L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_ListType(value: MarkerType?): Unit {
      val fnPtr = _473379626_VtblPtr!!.getPointer(27L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__473379626_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_NoLineNumber(): FormatEffect? {
      val fnPtr = _473379626_VtblPtr!!.getPointer(28L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<FormatEffect>()
      val hr = fn.invokeHR(arrayOf(__473379626_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_NoLineNumber(value: FormatEffect?): Unit {
      val fnPtr = _473379626_VtblPtr!!.getPointer(29L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__473379626_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_PageBreakBefore(): FormatEffect? {
      val fnPtr = _473379626_VtblPtr!!.getPointer(30L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<FormatEffect>()
      val hr = fn.invokeHR(arrayOf(__473379626_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_PageBreakBefore(value: FormatEffect?): Unit {
      val fnPtr = _473379626_VtblPtr!!.getPointer(31L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__473379626_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_RightIndent(): Float {
      val fnPtr = _473379626_VtblPtr!!.getPointer(32L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__473379626_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_RightIndent(value: Float): Unit {
      val fnPtr = _473379626_VtblPtr!!.getPointer(33L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__473379626_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_RightToLeft(): FormatEffect? {
      val fnPtr = _473379626_VtblPtr!!.getPointer(34L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<FormatEffect>()
      val hr = fn.invokeHR(arrayOf(__473379626_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_RightToLeft(value: FormatEffect?): Unit {
      val fnPtr = _473379626_VtblPtr!!.getPointer(35L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__473379626_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Style(): ParagraphStyle? {
      val fnPtr = _473379626_VtblPtr!!.getPointer(36L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Style(value: ParagraphStyle?): Unit {
      val fnPtr = _473379626_VtblPtr!!.getPointer(37L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__473379626_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_SpaceAfter(): Float {
      val fnPtr = _473379626_VtblPtr!!.getPointer(38L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__473379626_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_SpaceAfter(value: Float): Unit {
      val fnPtr = _473379626_VtblPtr!!.getPointer(39L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__473379626_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_SpaceBefore(): Float {
      val fnPtr = _473379626_VtblPtr!!.getPointer(40L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__473379626_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_SpaceBefore(value: Float): Unit {
      val fnPtr = _473379626_VtblPtr!!.getPointer(41L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__473379626_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_WidowControl(): FormatEffect? {
      val fnPtr = _473379626_VtblPtr!!.getPointer(42L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<FormatEffect>()
      val hr = fn.invokeHR(arrayOf(__473379626_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_WidowControl(value: FormatEffect?): Unit {
      val fnPtr = _473379626_VtblPtr!!.getPointer(43L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__473379626_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_TabCount(): Int {
      val fnPtr = _473379626_VtblPtr!!.getPointer(44L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__473379626_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun AddTab(
      ...
      val fnPtr = _473379626_VtblPtr!!.getPointer(45L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__473379626_Ptr, position, marshalToNative(align),
    ...
    public override fun ClearAllTabs(): Unit {
      val fnPtr = _473379626_VtblPtr!!.getPointer(46L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__473379626_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun DeleteTab(position: Float): Unit {
      val fnPtr = _473379626_VtblPtr!!.getPointer(47L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__473379626_Ptr, position,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun GetClone(): ITextParagraphFormat? {
      val fnPtr = _473379626_VtblPtr!!.getPointer(48L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun GetTab(
      ...
      val fnPtr = _473379626_VtblPtr!!.getPointer(49L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__473379626_Ptr, index, position, marshalToNative(align),
          marshalToNative(leader),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun IsEqual(format: ITextParagraphFormat?): Boolean {
      val fnPtr = _473379626_VtblPtr!!.getPointer(50L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__473379626_Ptr, marshalToNative(format), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun SetClone(format: ITextParagraphFormat?): Unit {
      val fnPtr = _473379626_VtblPtr!!.getPointer(51L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__473379626_Ptr, marshalToNative(format),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun SetIndents(
      ...
      val fnPtr = _473379626_VtblPtr!!.getPointer(52L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__473379626_Ptr, start, left, right,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun SetLineSpacing(rule: LineSpacingRule?, spacing: Float): Unit {
      val fnPtr = _473379626_VtblPtr!!.getPointer(53L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__473379626_Ptr, marshalToNative(rule), spacing,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class ITextParagraphFormat_Impl(
    ...
    public override val __473379626_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITextParagraphFormat, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("219b6cdf0d0b5701b8a16c906b3ebbe1")
    ...
    public override fun toNative(obj: ITextParagraphFormat): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__473379626_Ptr))
  }
