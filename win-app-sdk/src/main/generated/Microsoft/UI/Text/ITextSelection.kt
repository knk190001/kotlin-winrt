...
import Microsoft.UI.Text.ITextRange.ABI.IID
...
@Signature("{8f5e6cb1-2b04-589f-bd24-54e5cd8dd399}")
@Guid("8f5e6cb12b04589fbd2454e5cd8dd399")
@WinRTInterface("8f5e6cb12b04589fbd2454e5cd8dd399")
...
public interface ITextSelection : NativeMapped, IWinRTInterface, ITextRange {
  ...
  public interface WithDefault : ITextSelection, ITextRange.WithDefault {
    public val __870173725_Ptr: Pointer?

    public val _870173725_VtblPtr: Pointer?
      get() = __870173725_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Options(): SelectionOptions? {
      val fnPtr = _870173725_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<SelectionOptions>()
      val hr = fn.invokeHR(arrayOf(__870173725_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Options(value: SelectionOptions?): Unit {
      val fnPtr = _870173725_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__870173725_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Type(): SelectionType? {
      val fnPtr = _870173725_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun EndKey(unit: TextRangeUnit?, extend: Boolean): Int {
      val fnPtr = _870173725_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__870173725_Ptr, marshalToNative(unit), extend, result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun HomeKey(unit: TextRangeUnit?, extend: Boolean): Int {
      val fnPtr = _870173725_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__870173725_Ptr, marshalToNative(unit), extend, result))
      if (hr.toInt() != 0) {
    ...
    public override fun MoveDown(
      ...
      val fnPtr = _870173725_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__870173725_Ptr, marshalToNative(unit), count, extend, result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
      val resultValue = marshalFromNative<Int>(result.getValue())
    ...
    public override fun MoveLeft(
      ...
      val fnPtr = _870173725_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__870173725_Ptr, marshalToNative(unit), count, extend, result))
      if (hr.toInt() != 0) {
    ...
    public override fun MoveRight(
      ...
      val fnPtr = _870173725_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__870173725_Ptr, marshalToNative(unit), count, extend, result))
      if (hr.toInt() != 0) {
    ...
    public override fun MoveUp(
      ...
      val fnPtr = _870173725_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__870173725_Ptr, marshalToNative(unit), count, extend, result))
      if (hr.toInt() != 0) {
    ...
    public override fun TypeText(value: String?): Unit {
      val fnPtr = _870173725_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__870173725_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class ITextSelection_Impl(
    ...
    public override val __1605925810_Ptr: JNAPointer by lazy {
      ...
      IUnknownVtbl(_870173725_VtblPtr).queryInterface(pointer,refiid,result)
      result.value
    }


    public override val __870173725_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITextSelection, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("8f5e6cb12b04589fbd2454e5cd8dd399")
    ...
    public override fun toNative(obj: ITextSelection): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__870173725_Ptr))
  }
