...
@Signature("rc(Microsoft.UI.Text.RichEditTextDocument;{1149d57d-86a6-59dd-88d9-196f27bc5c85})")
@WinRTByReference(brClass = RichEditTextDocument.ByReference::class)
public class RichEditTextDocument(
  ptr: JNAPointer? = NULL
) : PointerType(ptr), ITextDocument.WithDefault, IWinRTObject {
  private val __113860714_Interface: ITextDocument.WithDefault by lazy {
    as_113860714()
  }


  public override val __113860714_Ptr: JNAPointer? by lazy {
    __113860714_Interface.__113860714_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__113860714_Interface)

  private fun as_113860714(): ITextDocument.WithDefault {
    if(pointer == NULL) {
