...
@Signature("{cd353b3c-af63-5cfb-918c-0f9c8931a161}")
@Guid("cd353b3caf635cfb918c0f9c8931a161")
@WinRTInterface("cd353b3caf635cfb918c0f9c8931a161")
...
public interface ITextConstantsStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITextConstantsStatics {
    public val __1337749563_Ptr: Pointer?

    public val _1337749563_VtblPtr: Pointer?
      get() = __1337749563_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_AutoColor(): Color? {
      val fnPtr = _1337749563_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1337749563_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_MinUnitCount(): Int {
      val fnPtr = _1337749563_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_MaxUnitCount(): Int {
      val fnPtr = _1337749563_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__1337749563_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_UndefinedColor(): Color? {
      val fnPtr = _1337749563_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1337749563_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_UndefinedFloatValue(): Float {
      val fnPtr = _1337749563_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_UndefinedInt32Value(): Int {
      val fnPtr = _1337749563_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__1337749563_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_UndefinedFontStretch(): FontStretch? {
      val fnPtr = _1337749563_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_UndefinedFontStyle(): FontStyle? {
      val fnPtr = _1337749563_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class ITextConstantsStatics_Impl(
    ...
    public override val __1337749563_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITextConstantsStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("cd353b3caf635cfb918c0f9c8931a161")
    ...
    public override fun toNative(obj: ITextConstantsStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1337749563_Ptr))
  }
