...
@Signature("{c3a01bb5-6076-5e0f-871a-9d94a6a8f82b}")
@Guid("c3a01bb560765e0f871a9d94a6a8f82b")
@WinRTInterface("c3a01bb560765e0f871a9d94a6a8f82b")
...
public interface ITappedEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ITappedEventArgs {
    public val __384019758_Ptr: Pointer?

    public val _384019758_VtblPtr: Pointer?
      get() = __384019758_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_PointerDeviceType(): PointerDeviceType? {
      val fnPtr = _384019758_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<PointerDeviceType>()
      val hr = fn.invokeHR(arrayOf(__384019758_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Position(): Point? {
      val fnPtr = _384019758_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_TapCount(): WinDef.UINT {
      val fnPtr = _384019758_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class ITappedEventArgs_Impl(
    ...
    public override val __384019758_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ITappedEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("c3a01bb560765e0f871a9d94a6a8f82b")
    ...
    public override fun toNative(obj: ITappedEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__384019758_Ptr))
  }
