...
@Signature("{8ff73b39-887e-50a4-8500-77953039dcb4}")
@Guid("8ff73b39887e50a4850077953039dcb4")
@WinRTInterface("8ff73b39887e50a4850077953039dcb4")
...
public interface IRightTappedEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IRightTappedEventArgs {
    public val __74855768_Ptr: Pointer?

    public val _74855768_VtblPtr: Pointer?
      get() = __74855768_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_PointerDeviceType(): PointerDeviceType? {
      val fnPtr = _74855768_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<PointerDeviceType>()
      val hr = fn.invokeHR(arrayOf(__74855768_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Position(): Point? {
      val fnPtr = _74855768_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class IRightTappedEventArgs_Impl(
    ...
    public override val __74855768_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IRightTappedEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("8ff73b39887e50a4850077953039dcb4")
    ...
    public override fun toNative(obj: IRightTappedEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__74855768_Ptr))
  }
