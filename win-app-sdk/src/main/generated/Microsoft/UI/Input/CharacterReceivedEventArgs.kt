...
@Signature("rc(Microsoft.UI.Input.CharacterReceivedEventArgs;{36122718-9263-592b-8d87-8f86543ffc95})")
@WinRTByReference(brClass = CharacterReceivedEventArgs.ByReference::class)
public class CharacterReceivedEventArgs(
  ptr: JNAPointer? = NULL
) : PointerType(ptr), ICharacterReceivedEventArgs.WithDefault, IWinRTObject {
  private val __898417210_Interface: ICharacterReceivedEventArgs.WithDefault by lazy {
    as_898417210()
  }


  public override val __898417210_Ptr: JNAPointer? by lazy {
    __898417210_Interface.__898417210_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__898417210_Interface)

  private fun as_898417210(): ICharacterReceivedEventArgs.WithDefault {
    if(pointer == NULL) {
