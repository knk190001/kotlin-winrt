...
@Signature("rc(Microsoft.UI.Input.DraggingEventArgs;{3efb1b75-3d3b-550e-963d-0828ca76128a})")
@WinRTByReference(brClass = DraggingEventArgs.ByReference::class)
public class DraggingEventArgs(
  ptr: JNAPointer? = NULL
) : PointerType(ptr), IDraggingEventArgs.WithDefault, IWinRTObject {
  private val __1147260335_Interface: IDraggingEventArgs.WithDefault by lazy {
    as_1147260335()
  }


  public override val __1147260335_Ptr: JNAPointer? by lazy {
    __1147260335_Interface.__1147260335_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1147260335_Interface)

  private fun as_1147260335(): IDraggingEventArgs.WithDefault {
    if(pointer == NULL) {
