...
@Signature("rc(Microsoft.UI.Input.HoldingEventArgs;{8e449e85-d223-533c-b0b2-bf7c6d10c2db})")
@WinRTByReference(brClass = HoldingEventArgs.ByReference::class)
public class HoldingEventArgs(
  ptr: JNAPointer? = NULL
) : PointerType(ptr), IHoldingEventArgs.WithDefault, IWinRTObject {
  private val __558844275_Interface: IHoldingEventArgs.WithDefault by lazy {
    as_558844275()
  }


  public override val __558844275_Ptr: JNAPointer? by lazy {
    __558844275_Interface.__558844275_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__558844275_Interface)

  private fun as_558844275(): IHoldingEventArgs.WithDefault {
    if(pointer == NULL) {
