...
@Signature("{406e1961-0c98-5fc0-b3d8-116492ef0053}")
@Guid("406e19610c985fc0b3d8116492ef0053")
@WinRTInterface("406e19610c985fc0b3d8116492ef0053")
...
public interface IManipulationUpdatedEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IManipulationUpdatedEventArgs {
    public val __602924078_Ptr: Pointer?

    public val _602924078_VtblPtr: Pointer?
      get() = __602924078_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Cumulative(): ManipulationDelta? {
      val fnPtr = _602924078_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ManipulationDelta>()
      val hr = fn.invokeHR(arrayOf(__602924078_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Delta(): ManipulationDelta? {
      val fnPtr = _602924078_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ManipulationDelta>()
      val hr = fn.invokeHR(arrayOf(__602924078_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_PointerDeviceType(): PointerDeviceType? {
      val fnPtr = _602924078_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_Position(): Point? {
      val fnPtr = _602924078_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_Velocities(): ManipulationVelocities? {
      val fnPtr = _602924078_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class IManipulationUpdatedEventArgs_Impl(
    ...
    public override val __602924078_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IManipulationUpdatedEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("406e19610c985fc0b3d8116492ef0053")
    ...
    public override fun toNative(obj: IManipulationUpdatedEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__602924078_Ptr))
  }
