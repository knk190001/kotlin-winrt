...
@Signature("rc(Microsoft.UI.Input.ManipulationInertiaStartingEventArgs;{acf9ef71-6e15-56ab-9260-f0d3ce5f66e8})")
...
public class ManipulationInertiaStartingEventArgs(
  ptr: JNAPointer? = NULL
) : PointerType(ptr), IManipulationInertiaStartingEventArgs.WithDefault, IWinRTObject {
  private val __167656531_Interface: IManipulationInertiaStartingEventArgs.WithDefault by lazy {
    as_167656531()
  }


  public override val __167656531_Ptr: JNAPointer? by lazy {
    __167656531_Interface.__167656531_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__167656531_Interface)

  private fun as_167656531(): IManipulationInertiaStartingEventArgs.WithDefault {
    if(pointer == NULL) {
