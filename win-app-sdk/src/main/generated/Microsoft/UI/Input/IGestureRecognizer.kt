...
@Signature("{cda89afc-6bd0-595c-ba37-545fce5bf016}")
@Guid("cda89afc6bd0595cba37545fce5bf016")
@WinRTInterface("cda89afc6bd0595cba37545fce5bf016")
...
public interface IGestureRecognizer : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IGestureRecognizer {
    public val __1839342452_Ptr: Pointer?

    public val _1839342452_VtblPtr: Pointer?
      get() = __1839342452_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_AutoProcessInertia(): Boolean {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_AutoProcessInertia(value: Boolean): Unit {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_CrossSlideExact(): Boolean {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_CrossSlideExact(value: Boolean): Unit {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_CrossSlideHorizontally(): Boolean {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_CrossSlideHorizontally(value: Boolean): Unit {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_CrossSlideThresholds(): CrossSlideThresholds? {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_CrossSlideThresholds(value: CrossSlideThresholds?): Unit {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_GestureSettings(): GestureSettings? {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_GestureSettings(value: GestureSettings?): Unit {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_IsActive(): Boolean {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsInertial(): Boolean {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_PivotCenter(): Point? {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_PivotCenter(value: Point?): Unit {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_PivotRadius(): Float {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_PivotRadius(value: Float): Unit {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_InertiaExpansionDeceleration(): Float {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(22L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_InertiaExpansionDeceleration(value: Float): Unit {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(23L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_InertiaExpansion(): Float {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(24L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_InertiaExpansion(value: Float): Unit {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(25L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_InertiaRotationAngle(): Float {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(26L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_InertiaRotationAngle(value: Float): Unit {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(27L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_InertiaRotationDeceleration(): Float {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(28L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_InertiaRotationDeceleration(value: Float): Unit {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(29L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_InertiaTranslationDeceleration(): Float {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(30L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_InertiaTranslationDeceleration(value: Float): Unit {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(31L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_InertiaTranslationDisplacement(): Float {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(32L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_InertiaTranslationDisplacement(value: Float): Unit {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(33L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ManipulationExact(): Boolean {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(34L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ManipulationExact(value: Boolean): Unit {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(35L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_MouseWheelParameters(): MouseWheelParameters? {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(36L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_ShowGestureFeedback(): Boolean {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(37L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ShowGestureFeedback(value: Boolean): Unit {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(38L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun CanBeDoubleTap(value: PointerPoint?): Boolean {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(39L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr, marshalToNative(value), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
      val resultValue = marshalFromNative<Boolean>(result.getValue())
    ...
    public override fun CompleteGesture(): Unit {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(40L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun ProcessDownEvent(value: PointerPoint?): Unit {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(41L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun ProcessMoveEvents(value: IVector<PointerPoint?>?): Unit {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(42L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun ProcessMouseWheelEvent(
      ...
      val fnPtr = _1839342452_VtblPtr!!.getPointer(43L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr, marshalToNative(value), isShiftKeyDown,
          isControlKeyDown,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun ProcessInertia(): Unit {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(44L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun ProcessUpEvent(value: PointerPoint?): Unit {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(45L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun add_Tapped(handler: TypedEventHandler<GestureRecognizer?,
      ...
      val fnPtr = _1839342452_VtblPtr!!.getPointer(46L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun remove_Tapped(token: EventRegistrationToken?): Unit {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(47L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun add_RightTapped(handler: TypedEventHandler<GestureRecognizer?,
        RightTappedEventArgs?>?): EventRegistrationToken? {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(48L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
    ...
    public override fun remove_RightTapped(token: EventRegistrationToken?): Unit {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(49L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun add_Holding(handler: TypedEventHandler<GestureRecognizer?,
      ...
      val fnPtr = _1839342452_VtblPtr!!.getPointer(50L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
    ...
    public override fun remove_Holding(token: EventRegistrationToken?): Unit {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(51L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun add_Dragging(handler: TypedEventHandler<GestureRecognizer?,
      ...
      val fnPtr = _1839342452_VtblPtr!!.getPointer(52L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
    ...
    public override fun remove_Dragging(token: EventRegistrationToken?): Unit {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(53L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun add_ManipulationStarted(handler: TypedEventHandler<GestureRecognizer?,
        ManipulationStartedEventArgs?>?): EventRegistrationToken? {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(54L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
    ...
    public override fun remove_ManipulationStarted(token: EventRegistrationToken?): Unit {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(55L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun add_ManipulationUpdated(handler: TypedEventHandler<GestureRecognizer?,
        ManipulationUpdatedEventArgs?>?): EventRegistrationToken? {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(56L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
    ...
    public override fun remove_ManipulationUpdated(token: EventRegistrationToken?): Unit {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(57L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override
        ...
        ManipulationInertiaStartingEventArgs?>?): EventRegistrationToken? {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(58L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
    ...
    public override fun remove_ManipulationInertiaStarting(token: EventRegistrationToken?): Unit {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(59L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun add_ManipulationCompleted(handler: TypedEventHandler<GestureRecognizer?,
        ManipulationCompletedEventArgs?>?): EventRegistrationToken? {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(60L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
    ...
    public override fun remove_ManipulationCompleted(token: EventRegistrationToken?): Unit {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(61L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun add_CrossSliding(handler: TypedEventHandler<GestureRecognizer?,
        CrossSlidingEventArgs?>?): EventRegistrationToken? {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(62L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
    ...
    public override fun remove_CrossSliding(token: EventRegistrationToken?): Unit {
      val fnPtr = _1839342452_VtblPtr!!.getPointer(63L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1839342452_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IGestureRecognizer_Impl(
    ...
    public override val __1839342452_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IGestureRecognizer, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("cda89afc6bd0595cba37545fce5bf016")
    ...
    public override fun toNative(obj: IGestureRecognizer): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1839342452_Ptr))
  }
