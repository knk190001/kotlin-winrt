...
@Signature("{acf9ef71-6e15-56ab-9260-f0d3ce5f66e8}")
@Guid("acf9ef716e1556ab9260f0d3ce5f66e8")
@WinRTInterface("acf9ef716e1556ab9260f0d3ce5f66e8")
...
public interface IManipulationInertiaStartingEventArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IManipulationInertiaStartingEventArgs {
    public val __167656531_Ptr: Pointer?

    public val _167656531_VtblPtr: Pointer?
      get() = __167656531_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Cumulative(): ManipulationDelta? {
      val fnPtr = _167656531_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ManipulationDelta>()
      val hr = fn.invokeHR(arrayOf(__167656531_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Delta(): ManipulationDelta? {
      val fnPtr = _167656531_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ManipulationDelta>()
      val hr = fn.invokeHR(arrayOf(__167656531_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_PointerDeviceType(): PointerDeviceType? {
      val fnPtr = _167656531_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_Position(): Point? {
      val fnPtr = _167656531_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_Velocities(): ManipulationVelocities? {
      val fnPtr = _167656531_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class IManipulationInertiaStartingEventArgs_Impl(
    ...
    public override val __167656531_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IManipulationInertiaStartingEventArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("acf9ef716e1556ab9260f0d3ce5f66e8")
    ...
    public override fun toNative(obj: IManipulationInertiaStartingEventArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__167656531_Ptr))
  }
