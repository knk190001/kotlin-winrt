...
@Signature("{d523bd66-a05d-5417-8e07-84ae3caf9752}")
@Guid("d523bd66a05d54178e0784ae3caf9752")
@WinRTInterface("d523bd66a05d54178e0784ae3caf9752")
...
public interface IVisualInteractionSource3 : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IVisualInteractionSource3 {
    public val __1023038704_Ptr: Pointer?

    public val _1023038704_VtblPtr: Pointer?
      get() = __1023038704_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_PointerWheelConfig(): InteractionSourceConfiguration? {
      val fnPtr = _1023038704_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<InteractionSourceConfiguration>()
      val hr = fn.invokeHR(arrayOf(__1023038704_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IVisualInteractionSource3_Impl(
    ...
    public override val __1023038704_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IVisualInteractionSource3, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("d523bd66a05d54178e0784ae3caf9752")
    ...
    public override fun toNative(obj: IVisualInteractionSource3): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1023038704_Ptr))
  }
