...
@Signature("{cc24ab87-9131-5286-b3ce-1ef97e0974e6}")
@Guid("cc24ab8791315286b3ce1ef97e0974e6")
@WinRTInterface("cc24ab8791315286b3ce1ef97e0974e6")
...
public interface IInteractionTrackerVector2InertiaNaturalMotionStatics : NativeMapped,
  ...
  public interface WithDefault : IInteractionTrackerVector2InertiaNaturalMotionStatics {
    public val __474672735_Ptr: Pointer?

    public val _474672735_VtblPtr: Pointer?
      get() = __474672735_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun Create(compositor: Compositor?):
        InteractionTrackerVector2InertiaNaturalMotion? {
      val fnPtr = _474672735_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<InteractionTrackerVector2InertiaNaturalMotion>()
      val hr = fn.invokeHR(arrayOf(__474672735_Ptr, marshalToNative(compositor), result))
      if (hr.toInt() != 0) {
  ...
  public class IInteractionTrackerVector2InertiaNaturalMotionStatics_Impl(
    ...
    public override val __474672735_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IInteractionTrackerVector2InertiaNaturalMotionStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("cc24ab8791315286b3ce1ef97e0974e6")
