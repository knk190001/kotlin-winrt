...
@Signature("{239752cf-266c-5acb-acc3-b3e3ecaf4d3f}")
@Guid("239752cf266c5acbacc3b3e3ecaf4d3f")
@WinRTInterface("239752cf266c5acbacc3b3e3ecaf4d3f")
...
public interface IInteractionTracker3 : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IInteractionTracker3 {
    public val __758668477_Ptr: Pointer?

    public val _758668477_VtblPtr: Pointer?
      get() = __758668477_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override
        fun ConfigureVector2PositionInertiaModifiers(modifiers: IIterable<InteractionTrackerVector2InertiaModifier?>?):
        Unit {
      val fnPtr = _758668477_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__758668477_Ptr, marshalToNative(modifiers),))
      if (hr.toInt() != 0) {
  ...
  public class IInteractionTracker3_Impl(
    ...
    public override val __758668477_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IInteractionTracker3, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("239752cf266c5acbacc3b3e3ecaf4d3f")
    ...
    public override fun toNative(obj: IInteractionTracker3): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__758668477_Ptr))
  }
