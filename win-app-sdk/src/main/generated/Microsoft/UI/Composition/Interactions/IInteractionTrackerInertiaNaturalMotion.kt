...
import Microsoft.UI.Composition.ScalarNaturalMotionAnimation
...
@Signature("{8c7482e0-185d-56b1-b67f-fca4fcd13cd2}")
@Guid("8c7482e0185d56b1b67ffca4fcd13cd2")
@WinRTInterface("8c7482e0185d56b1b67ffca4fcd13cd2")
...
public interface IInteractionTrackerInertiaNaturalMotion : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IInteractionTrackerInertiaNaturalMotion {
    public val __1808397387_Ptr: Pointer?

    public val _1808397387_VtblPtr: Pointer?
      get() = __1808397387_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Condition(): ExpressionAnimation? {
      val fnPtr = _1808397387_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ExpressionAnimation>()
      val hr = fn.invokeHR(arrayOf(__1808397387_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Condition(value: ExpressionAnimation?): Unit {
      val fnPtr = _1808397387_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1808397387_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_NaturalMotion(): ScalarNaturalMotionAnimation? {
      val fnPtr = _1808397387_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_NaturalMotion(value: ScalarNaturalMotionAnimation?): Unit {
      val fnPtr = _1808397387_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1808397387_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IInteractionTrackerInertiaNaturalMotion_Impl(
    ...
    public override val __1808397387_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IInteractionTrackerInertiaNaturalMotion, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("8c7482e0185d56b1b67ffca4fcd13cd2")
    ...
    public override fun toNative(obj: IInteractionTrackerInertiaNaturalMotion): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1808397387_Ptr))
  }
