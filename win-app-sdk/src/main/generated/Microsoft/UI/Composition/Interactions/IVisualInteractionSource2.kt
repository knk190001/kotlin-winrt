...
@Signature("{ff1132ba-dc0d-519e-be49-be301e52306a}")
@Guid("ff1132badc0d519ebe49be301e52306a")
@WinRTInterface("ff1132badc0d519ebe49be301e52306a")
...
public interface IVisualInteractionSource2 : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IVisualInteractionSource2 {
    public val __1023038705_Ptr: Pointer?

    public val _1023038705_VtblPtr: Pointer?
      get() = __1023038705_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_DeltaPosition(): Vector3? {
      val fnPtr = _1023038705_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Vector3>()
      val hr = fn.invokeHR(arrayOf(__1023038705_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_DeltaScale(): Float {
      val fnPtr = _1023038705_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_Position(): Vector3? {
      val fnPtr = _1023038705_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Vector3>()
      val hr = fn.invokeHR(arrayOf(__1023038705_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_PositionVelocity(): Vector3? {
      val fnPtr = _1023038705_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Vector3>()
      val hr = fn.invokeHR(arrayOf(__1023038705_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Scale(): Float {
      val fnPtr = _1023038705_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__1023038705_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ScaleVelocity(): Float {
      val fnPtr = _1023038705_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__1023038705_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override
        fun ConfigureCenterPointXModifiers(conditionalValues: IIterable<CompositionConditionalValue?>?):
        Unit {
      val fnPtr = _1023038705_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1023038705_Ptr, marshalToNative(conditionalValues),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override
        fun ConfigureCenterPointYModifiers(conditionalValues: IIterable<CompositionConditionalValue?>?):
        Unit {
      val fnPtr = _1023038705_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1023038705_Ptr, marshalToNative(conditionalValues),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override
        fun ConfigureDeltaPositionXModifiers(conditionalValues: IIterable<CompositionConditionalValue?>?):
        Unit {
      val fnPtr = _1023038705_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1023038705_Ptr, marshalToNative(conditionalValues),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override
        fun ConfigureDeltaPositionYModifiers(conditionalValues: IIterable<CompositionConditionalValue?>?):
        Unit {
      val fnPtr = _1023038705_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1023038705_Ptr, marshalToNative(conditionalValues),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override
        fun ConfigureDeltaScaleModifiers(conditionalValues: IIterable<CompositionConditionalValue?>?):
        Unit {
      val fnPtr = _1023038705_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1023038705_Ptr, marshalToNative(conditionalValues),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IVisualInteractionSource2_Impl(
    ...
    public override val __1023038705_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IVisualInteractionSource2, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("ff1132badc0d519ebe49be301e52306a")
    ...
    public override fun toNative(obj: IVisualInteractionSource2): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1023038705_Ptr))
  }
