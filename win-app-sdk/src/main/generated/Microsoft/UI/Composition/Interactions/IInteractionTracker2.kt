...
@Signature("{396d7fb1-2fad-5508-8591-4ff0dc5a7484}")
@Guid("396d7fb12fad550885914ff0dc5a7484")
@WinRTInterface("396d7fb12fad550885914ff0dc5a7484")
...
public interface IInteractionTracker2 : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IInteractionTracker2 {
    public val __758668478_Ptr: Pointer?

    public val _758668478_VtblPtr: Pointer?
      get() = __758668478_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override
        fun ConfigureCenterPointXInertiaModifiers(conditionalValues: IIterable<CompositionConditionalValue?>?):
        Unit {
      val fnPtr = _758668478_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__758668478_Ptr, marshalToNative(conditionalValues),))
      if (hr.toInt() != 0) {
    ...
    public override
        fun ConfigureCenterPointYInertiaModifiers(conditionalValues: IIterable<CompositionConditionalValue?>?):
        Unit {
      val fnPtr = _758668478_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__758668478_Ptr, marshalToNative(conditionalValues),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IInteractionTracker2_Impl(
    ...
    public override val __758668478_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IInteractionTracker2, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("396d7fb12fad550885914ff0dc5a7484")
    ...
    public override fun toNative(obj: IInteractionTracker2): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__758668478_Ptr))
  }
