...
@Signature("{5b76c949-a4d0-5c9d-9292-7013ae9656c7}")
@Guid("5b76c949a4d05c9d92927013ae9656c7")
@WinRTInterface("5b76c949a4d05c9d92927013ae9656c7")
...
public interface IInteractionTrackerInertiaStateEnteredArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IInteractionTrackerInertiaStateEnteredArgs {
    public val __811800429_Ptr: Pointer?

    public val _811800429_VtblPtr: Pointer?
      get() = __811800429_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ModifiedRestingPosition(): IReference<Vector3?>? {
      val fnPtr = _811800429_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<IReference<Vector3?>>()
      val hr = fn.invokeHR(arrayOf(__811800429_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ModifiedRestingScale(): IReference<Float>? {
      val fnPtr = _811800429_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_NaturalRestingPosition(): Vector3? {
      val fnPtr = _811800429_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_NaturalRestingScale(): Float {
      val fnPtr = _811800429_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_PositionVelocityInPixelsPerSecond(): Vector3? {
      val fnPtr = _811800429_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Vector3>()
      val hr = fn.invokeHR(arrayOf(__811800429_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_RequestId(): Int {
      val fnPtr = _811800429_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_ScaleVelocityInPercentPerSecond(): Float {
      val fnPtr = _811800429_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__811800429_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IInteractionTrackerInertiaStateEnteredArgs_Impl(
    ...
    public override val __811800429_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IInteractionTrackerInertiaStateEnteredArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("5b76c949a4d05c9d92927013ae9656c7")
    ...
    public override fun toNative(obj: IInteractionTrackerInertiaStateEnteredArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__811800429_Ptr))
  }
