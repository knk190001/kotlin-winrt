...
@Signature("{cf0f0414-7fdf-5284-aeef-28b71b62aa4f}")
@Guid("cf0f04147fdf5284aeef28b71b62aa4f")
@WinRTInterface("cf0f04147fdf5284aeef28b71b62aa4f")
...
public interface IInteractionTrackerInertiaRestingValueStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IInteractionTrackerInertiaRestingValueStatics {
    public val __1227982408_Ptr: Pointer?

    public val _1227982408_VtblPtr: Pointer?
      get() = __1227982408_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun Create(compositor: Compositor?): InteractionTrackerInertiaRestingValue? {
      val fnPtr = _1227982408_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<InteractionTrackerInertiaRestingValue>()
      val hr = fn.invokeHR(arrayOf(__1227982408_Ptr, marshalToNative(compositor), result))
      if (hr.toInt() != 0) {
  ...
  public class IInteractionTrackerInertiaRestingValueStatics_Impl(
    ...
    public override val __1227982408_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IInteractionTrackerInertiaRestingValueStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("cf0f04147fdf5284aeef28b71b62aa4f")
    ...
    public override fun toNative(obj: IInteractionTrackerInertiaRestingValueStatics): MemoryAddress
        = MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1227982408_Ptr))
  }
