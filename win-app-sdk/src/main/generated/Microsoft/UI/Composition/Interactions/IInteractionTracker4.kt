...
@Signature("{a9a9ce02-53c9-5690-a575-f340b7c2fdf2}")
@Guid("a9a9ce0253c95690a575f340b7c2fdf2")
@WinRTInterface("a9a9ce0253c95690a575f340b7c2fdf2")
...
public interface IInteractionTracker4 : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IInteractionTracker4 {
    public val __758668476_Ptr: Pointer?

    public val _758668476_VtblPtr: Pointer?
      get() = __758668476_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun TryUpdatePosition(value: Vector3?,
        option: InteractionTrackerClampingOption?): Int {
      val fnPtr = _758668476_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__758668476_Ptr, marshalToNative(value), marshalToNative(option),
          result))
      if (hr.toInt() != 0) {
    ...
    public override fun TryUpdatePositionBy(amount: Vector3?,
        option: InteractionTrackerClampingOption?): Int {
      val fnPtr = _758668476_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__758668476_Ptr, marshalToNative(amount),
    ...
    public override fun get_IsInertiaFromImpulse(): Boolean {
      val fnPtr = _758668476_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__758668476_Ptr,  result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
  ...
  public class IInteractionTracker4_Impl(
    ...
    public override val __758668476_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IInteractionTracker4, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("a9a9ce0253c95690a575f340b7c2fdf2")
    ...
    public override fun toNative(obj: IInteractionTracker4): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__758668476_Ptr))
  }
