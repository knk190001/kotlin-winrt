...
@Signature("{25658e4c-b99f-5108-aab7-1cc44f11508b}")
@Guid("25658e4cb99f5108aab71cc44f11508b")
@WinRTInterface("25658e4cb99f5108aab71cc44f11508b")
...
public interface IInteractionTrackerStatics2 : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IInteractionTrackerStatics2 {
    public val __9689059_Ptr: Pointer?

    public val _9689059_VtblPtr: Pointer?
      get() = __9689059_Ptr?.getPointer(0)
    ...
    public override fun SetBindingMode(
      ...
      val fnPtr = _9689059_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__9689059_Ptr, marshalToNative(boundTracker1),
    ...
    public override fun GetBindingMode(boundTracker1: InteractionTracker?,
      ...
      val fnPtr = _9689059_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class IInteractionTrackerStatics2_Impl(
    ...
    public override val __9689059_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IInteractionTrackerStatics2, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("25658e4cb99f5108aab71cc44f11508b")
    ...
    public override fun toNative(obj: IInteractionTrackerStatics2): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__9689059_Ptr))
  }
