...
@Signature("{02d8ec1f-8f04-505e-bd1e-47b2a204de51}")
@Guid("02d8ec1f8f04505ebd1e47b2a204de51")
@WinRTInterface("02d8ec1f8f04505ebd1e47b2a204de51")
...
public interface IInteractionTracker : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IInteractionTracker {
    public val __1825588496_Ptr: Pointer?

    public val _1825588496_VtblPtr: Pointer?
      get() = __1825588496_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_InteractionSources(): CompositionInteractionSourceCollection? {
      val fnPtr = _1825588496_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CompositionInteractionSourceCollection>()
      val hr = fn.invokeHR(arrayOf(__1825588496_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IsPositionRoundingSuggested(): Boolean {
      val fnPtr = _1825588496_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_MaxPosition(): Vector3? {
      val fnPtr = _1825588496_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_MaxPosition(value: Vector3?): Unit {
      val fnPtr = _1825588496_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1825588496_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_MaxScale(): Float {
      val fnPtr = _1825588496_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_MaxScale(value: Float): Unit {
      val fnPtr = _1825588496_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1825588496_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_MinPosition(): Vector3? {
      val fnPtr = _1825588496_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Vector3>()
      val hr = fn.invokeHR(arrayOf(__1825588496_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_MinPosition(value: Vector3?): Unit {
      val fnPtr = _1825588496_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1825588496_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_MinScale(): Float {
      val fnPtr = _1825588496_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__1825588496_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_MinScale(value: Float): Unit {
      val fnPtr = _1825588496_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1825588496_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_NaturalRestingPosition(): Vector3? {
      val fnPtr = _1825588496_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Vector3>()
      val hr = fn.invokeHR(arrayOf(__1825588496_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_NaturalRestingScale(): Float {
      val fnPtr = _1825588496_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__1825588496_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Owner(): IInteractionTrackerOwner? {
      val fnPtr = _1825588496_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_Position(): Vector3? {
      val fnPtr = _1825588496_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Vector3>()
      val hr = fn.invokeHR(arrayOf(__1825588496_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_PositionInertiaDecayRate(): IReference<Vector3?>? {
      val fnPtr = _1825588496_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_PositionInertiaDecayRate(value: IReference<Vector3?>?): Unit {
      val fnPtr = _1825588496_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1825588496_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_PositionVelocityInPixelsPerSecond(): Vector3? {
      val fnPtr = _1825588496_VtblPtr!!.getPointer(22L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Vector3>()
      val hr = fn.invokeHR(arrayOf(__1825588496_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Scale(): Float {
      val fnPtr = _1825588496_VtblPtr!!.getPointer(23L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__1825588496_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ScaleInertiaDecayRate(): IReference<Float>? {
      val fnPtr = _1825588496_VtblPtr!!.getPointer(24L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_ScaleInertiaDecayRate(value: IReference<Float>?): Unit {
      val fnPtr = _1825588496_VtblPtr!!.getPointer(25L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1825588496_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ScaleVelocityInPercentPerSecond(): Float {
      val fnPtr = _1825588496_VtblPtr!!.getPointer(26L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__1825588496_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun AdjustPositionXIfGreaterThanThreshold(adjustment: Float,
      ...
      val fnPtr = _1825588496_VtblPtr!!.getPointer(27L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1825588496_Ptr, adjustment, positionThreshold,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun AdjustPositionYIfGreaterThanThreshold(adjustment: Float,
        positionThreshold: Float): Unit {
      val fnPtr = _1825588496_VtblPtr!!.getPointer(28L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1825588496_Ptr, adjustment, positionThreshold,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override
        fun ConfigurePositionXInertiaModifiers(modifiers: IIterable<InteractionTrackerInertiaModifier?>?):
        Unit {
      val fnPtr = _1825588496_VtblPtr!!.getPointer(29L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1825588496_Ptr, marshalToNative(modifiers),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override
        fun ConfigurePositionYInertiaModifiers(modifiers: IIterable<InteractionTrackerInertiaModifier?>?):
        Unit {
      val fnPtr = _1825588496_VtblPtr!!.getPointer(30L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1825588496_Ptr, marshalToNative(modifiers),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override
        fun ConfigureScaleInertiaModifiers(modifiers: IIterable<InteractionTrackerInertiaModifier?>?):
        Unit {
      val fnPtr = _1825588496_VtblPtr!!.getPointer(31L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1825588496_Ptr, marshalToNative(modifiers),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun TryUpdatePosition(value: Vector3?): Int {
      val fnPtr = _1825588496_VtblPtr!!.getPointer(32L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__1825588496_Ptr, marshalToNative(value), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun TryUpdatePositionBy(amount: Vector3?): Int {
      val fnPtr = _1825588496_VtblPtr!!.getPointer(33L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__1825588496_Ptr, marshalToNative(amount), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
      val resultValue = marshalFromNative<Int>(result.getValue())
    ...
    public override fun TryUpdatePositionWithAnimation(animation: CompositionAnimation?): Int {
      val fnPtr = _1825588496_VtblPtr!!.getPointer(34L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__1825588496_Ptr, marshalToNative(animation), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
      val resultValue = marshalFromNative<Int>(result.getValue())
    ...
    public override
      ...
      val fnPtr = _1825588496_VtblPtr!!.getPointer(35L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__1825588496_Ptr, marshalToNative(velocityInPixelsPerSecond),
          result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun TryUpdateScale(value: Float, centerPoint: Vector3?): Int {
      val fnPtr = _1825588496_VtblPtr!!.getPointer(36L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__1825588496_Ptr, value, marshalToNative(centerPoint), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
      val resultValue = marshalFromNative<Int>(result.getValue())
    ...
    public override fun TryUpdateScaleWithAnimation(animation: CompositionAnimation?,
        centerPoint: Vector3?): Int {
      val fnPtr = _1825588496_VtblPtr!!.getPointer(37L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__1825588496_Ptr, marshalToNative(animation),
    ...
    public override fun TryUpdateScaleWithAdditionalVelocity(velocityInPercentPerSecond: Float,
        centerPoint: Vector3?): Int {
      val fnPtr = _1825588496_VtblPtr!!.getPointer(38L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__1825588496_Ptr, velocityInPercentPerSecond,
          marshalToNative(centerPoint), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
  ...
  public class IInteractionTracker_Impl(
    ...
    public override val __1825588496_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IInteractionTracker, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("02d8ec1f8f04505ebd1e47b2a204de51")
    ...
    public override fun toNative(obj: IInteractionTracker): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1825588496_Ptr))
  }
