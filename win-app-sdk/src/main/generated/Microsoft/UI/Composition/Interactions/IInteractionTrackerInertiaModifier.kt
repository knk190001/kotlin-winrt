...
@Signature("{4d3a0c6b-c508-5029-a47a-cbf64636f010}")
@Guid("4d3a0c6bc5085029a47acbf64636f010")
@WinRTInterface("4d3a0c6bc5085029a47acbf64636f010")
...
public interface IInteractionTrackerInertiaModifier : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IInteractionTrackerInertiaModifier {
    public val __661194401_Ptr: Pointer?

    public val _661194401_VtblPtr: Pointer?
      get() = __661194401_Ptr?.getPointer(0)
  }

  public class IInteractionTrackerInertiaModifier_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __661194401_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IInteractionTrackerInertiaModifier, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("4d3a0c6bc5085029a47acbf64636f010")
    ...
    public override fun toNative(obj: IInteractionTrackerInertiaModifier): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__661194401_Ptr))
  }
