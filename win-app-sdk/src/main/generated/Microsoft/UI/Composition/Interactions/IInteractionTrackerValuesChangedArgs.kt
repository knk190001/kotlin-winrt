...
@Signature("{9b495bed-1cf7-55c1-82b9-8022cbf3c766}")
@Guid("9b495bed1cf755c182b98022cbf3c766")
@WinRTInterface("9b495bed1cf755c182b98022cbf3c766")
...
public interface IInteractionTrackerValuesChangedArgs : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IInteractionTrackerValuesChangedArgs {
    public val __612511201_Ptr: Pointer?

    public val _612511201_VtblPtr: Pointer?
      get() = __612511201_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Position(): Vector3? {
      val fnPtr = _612511201_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Vector3>()
      val hr = fn.invokeHR(arrayOf(__612511201_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_RequestId(): Int {
      val fnPtr = _612511201_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_Scale(): Float {
      val fnPtr = _612511201_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class IInteractionTrackerValuesChangedArgs_Impl(
    ...
    public override val __612511201_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IInteractionTrackerValuesChangedArgs, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("9b495bed1cf755c182b98022cbf3c766")
    ...
    public override fun toNative(obj: IInteractionTrackerValuesChangedArgs): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__612511201_Ptr))
  }
