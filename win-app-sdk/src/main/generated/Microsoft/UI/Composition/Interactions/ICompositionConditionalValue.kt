...
@Signature("{3743dda0-fbe2-5ecf-9e80-4638a011f707}")
@Guid("3743dda0fbe25ecf9e804638a011f707")
@WinRTInterface("3743dda0fbe25ecf9e804638a011f707")
...
public interface ICompositionConditionalValue : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionConditionalValue {
    public val __593035925_Ptr: Pointer?

    public val _593035925_VtblPtr: Pointer?
      get() = __593035925_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Condition(): ExpressionAnimation? {
      val fnPtr = _593035925_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ExpressionAnimation>()
      val hr = fn.invokeHR(arrayOf(__593035925_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Condition(value: ExpressionAnimation?): Unit {
      val fnPtr = _593035925_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__593035925_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Value(): ExpressionAnimation? {
      val fnPtr = _593035925_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ExpressionAnimation>()
      val hr = fn.invokeHR(arrayOf(__593035925_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Value(value: ExpressionAnimation?): Unit {
      val fnPtr = _593035925_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__593035925_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class ICompositionConditionalValue_Impl(
    ...
    public override val __593035925_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionConditionalValue, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("3743dda0fbe25ecf9e804638a011f707")
    ...
    public override fun toNative(obj: ICompositionConditionalValue): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__593035925_Ptr))
  }
