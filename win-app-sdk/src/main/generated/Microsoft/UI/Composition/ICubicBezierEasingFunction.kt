...
@Signature("{35e7fcde-f9ce-590a-8b88-64a82a6b4b48}")
@Guid("35e7fcdef9ce590a8b8864a82a6b4b48")
@WinRTInterface("35e7fcdef9ce590a8b8864a82a6b4b48")
...
public interface ICubicBezierEasingFunction : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICubicBezierEasingFunction {
    public val __255629139_Ptr: Pointer?

    public val _255629139_VtblPtr: Pointer?
      get() = __255629139_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ControlPoint1(): Vector2? {
      val fnPtr = _255629139_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Vector2>()
      val hr = fn.invokeHR(arrayOf(__255629139_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ControlPoint2(): Vector2? {
      val fnPtr = _255629139_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Vector2>()
      val hr = fn.invokeHR(arrayOf(__255629139_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ICubicBezierEasingFunction_Impl(
    ...
    public override val __255629139_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICubicBezierEasingFunction, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("35e7fcdef9ce590a8b8864a82a6b4b48")
    ...
    public override fun toNative(obj: ICubicBezierEasingFunction): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__255629139_Ptr))
  }
