...
@Signature("{95ce4859-dd55-5c38-a3eb-13d053cebb1e}")
@Guid("95ce4859dd555c38a3eb13d053cebb1e")
@WinRTInterface("95ce4859dd555c38a3eb13d053cebb1e")
...
public interface ICompositionLight3 : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionLight3 {
    public val __1045121326_Ptr: Pointer?

    public val _1045121326_VtblPtr: Pointer?
      get() = __1045121326_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_IsEnabled(): Boolean {
      val fnPtr = _1045121326_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__1045121326_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_IsEnabled(value: Boolean): Unit {
      val fnPtr = _1045121326_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1045121326_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class ICompositionLight3_Impl(
    ...
    public override val __1045121326_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionLight3, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("95ce4859dd555c38a3eb13d053cebb1e")
    ...
    public override fun toNative(obj: ICompositionLight3): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1045121326_Ptr))
  }
