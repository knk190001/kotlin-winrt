...
@Signature("{f0237928-353c-5867-be93-71547e989f44}")
@Guid("f0237928353c5867be9371547e989f44")
@WinRTInterface("f0237928353c5867be9371547e989f44")
...
public interface IColorKeyFrameAnimation : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IColorKeyFrameAnimation {
    public val __2013243636_Ptr: Pointer?

    public val _2013243636_VtblPtr: Pointer?
      get() = __2013243636_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_InterpolationColorSpace(): CompositionColorSpace? {
      val fnPtr = _2013243636_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CompositionColorSpace>()
      val hr = fn.invokeHR(arrayOf(__2013243636_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_InterpolationColorSpace(value: CompositionColorSpace?): Unit {
      val fnPtr = _2013243636_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2013243636_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun InsertKeyFrame(normalizedProgressKey: Float, value: Color?): Unit {
      val fnPtr = _2013243636_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2013243636_Ptr, normalizedProgressKey,
    ...
    public override fun InsertKeyFrame(
      ...
      val fnPtr = _2013243636_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2013243636_Ptr, normalizedProgressKey, marshalToNative(value),
  ...
  public class IColorKeyFrameAnimation_Impl(
    ...
    public override val __2013243636_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IColorKeyFrameAnimation, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("f0237928353c5867be9371547e989f44")
    ...
    public override fun toNative(obj: IColorKeyFrameAnimation): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2013243636_Ptr))
  }
