...
@Signature("{0bb940a4-05ef-5920-bae1-918b36d44380}")
@Guid("0bb940a405ef5920bae1918b36d44380")
@WinRTInterface("0bb940a405ef5920bae1918b36d44380")
...
public interface ICompositionLight2 : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionLight2 {
    public val __1045121325_Ptr: Pointer?

    public val _1045121325_VtblPtr: Pointer?
      get() = __1045121325_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ExclusionsFromTargets(): VisualUnorderedCollection? {
      val fnPtr = _1045121325_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<VisualUnorderedCollection>()
      val hr = fn.invokeHR(arrayOf(__1045121325_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ICompositionLight2_Impl(
    ...
    public override val __1045121325_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionLight2, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("0bb940a405ef5920bae1918b36d44380")
    ...
    public override fun toNative(obj: ICompositionLight2): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1045121325_Ptr))
  }
