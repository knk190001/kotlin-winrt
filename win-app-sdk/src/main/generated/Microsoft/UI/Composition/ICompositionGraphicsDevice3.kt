...
@Signature("{fbbef487-d5a4-5db2-bf3e-9f488e659d11}")
@Guid("fbbef487d5a45db2bf3e9f488e659d11")
@WinRTInterface("fbbef487d5a45db2bf3e9f488e659d11")
...
public interface ICompositionGraphicsDevice3 : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionGraphicsDevice3 {
    public val __1608775839_Ptr: Pointer?

    public val _1608775839_VtblPtr: Pointer?
      get() = __1608775839_Ptr?.getPointer(0)
    ...
    public override fun CreateMipmapSurface(
      ...
      val fnPtr = _1608775839_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CompositionMipmapSurface>()
      val hr = fn.invokeHR(arrayOf(__1608775839_Ptr, marshalToNative(sizePixels),
    ...
    public override fun Trim(): Unit {
      val fnPtr = _1608775839_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1608775839_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class ICompositionGraphicsDevice3_Impl(
    ...
    public override val __1608775839_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionGraphicsDevice3, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("fbbef487d5a45db2bf3e9f488e659d11")
    ...
    public override fun toNative(obj: ICompositionGraphicsDevice3): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1608775839_Ptr))
  }
