...
@Signature("{df29ecc1-3ffc-565f-9d6c-533586908106}")
@Guid("df29ecc13ffc565f9d6c533586908106")
@WinRTInterface("df29ecc13ffc565f9d6c533586908106")
...
public interface IExponentialEasingFunction : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IExponentialEasingFunction {
    public val __1968416975_Ptr: Pointer?

    public val _1968416975_VtblPtr: Pointer?
      get() = __1968416975_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Mode(): CompositionEasingFunctionMode? {
      val fnPtr = _1968416975_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CompositionEasingFunctionMode>()
      val hr = fn.invokeHR(arrayOf(__1968416975_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Exponent(): Float {
      val fnPtr = _1968416975_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class IExponentialEasingFunction_Impl(
    ...
    public override val __1968416975_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IExponentialEasingFunction, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("df29ecc13ffc565f9d6c533586908106")
    ...
    public override fun toNative(obj: IExponentialEasingFunction): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1968416975_Ptr))
  }
