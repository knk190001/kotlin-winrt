...
@Signature("{ee444bca-735c-5cf2-b79d-a6dd46c16160}")
@Guid("ee444bca735c5cf2b79da6dd46c16160")
@WinRTInterface("ee444bca735c5cf2b79da6dd46c16160")
...
public interface ICompositor4 : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositor4 {
    public val __359760230_Ptr: Pointer?

    public val _359760230_VtblPtr: Pointer?
      get() = __359760230_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateColorGradientStop(): CompositionColorGradientStop? {
      val fnPtr = _359760230_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CompositionColorGradientStop>()
      val hr = fn.invokeHR(arrayOf(__359760230_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun CreateColorGradientStop(offset: Float, color: Color?):
      ...
      val fnPtr = _359760230_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CompositionColorGradientStop>()
      val hr = fn.invokeHR(arrayOf(__359760230_Ptr, offset, marshalToNative(color), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
      val resultValue = marshalFromNative<CompositionColorGradientStop>(result.getValue())
    ...
    public override fun CreateLinearGradientBrush(): CompositionLinearGradientBrush? {
      val fnPtr = _359760230_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun CreateSpringScalarAnimation(): SpringScalarNaturalMotionAnimation? {
      val fnPtr = _359760230_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun CreateSpringVector2Animation(): SpringVector2NaturalMotionAnimation? {
      val fnPtr = _359760230_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun CreateSpringVector3Animation(): SpringVector3NaturalMotionAnimation? {
      val fnPtr = _359760230_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class ICompositor4_Impl(
    ...
    public override val __359760230_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositor4, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("ee444bca735c5cf2b79da6dd46c16160")
    ...
    public override fun toNative(obj: ICompositor4): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__359760230_Ptr))
  }
