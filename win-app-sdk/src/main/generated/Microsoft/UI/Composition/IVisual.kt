...
@Signature("{c0eeab6c-c897-5ac6-a1c9-63abd5055b9b}")
@Guid("c0eeab6cc8975ac6a1c963abd5055b9b")
@WinRTInterface("c0eeab6cc8975ac6a1c963abd5055b9b")
...
public interface IVisual : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IVisual {
    public val __1922832537_Ptr: Pointer?

    public val _1922832537_VtblPtr: Pointer?
      get() = __1922832537_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_AnchorPoint(): Vector2? {
      val fnPtr = _1922832537_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Vector2>()
      val hr = fn.invokeHR(arrayOf(__1922832537_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_AnchorPoint(value: Vector2?): Unit {
      val fnPtr = _1922832537_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1922832537_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_BackfaceVisibility(): CompositionBackfaceVisibility? {
      val fnPtr = _1922832537_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_BackfaceVisibility(value: CompositionBackfaceVisibility?): Unit {
      val fnPtr = _1922832537_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1922832537_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_BorderMode(): CompositionBorderMode? {
      val fnPtr = _1922832537_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_BorderMode(value: CompositionBorderMode?): Unit {
      val fnPtr = _1922832537_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1922832537_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_CenterPoint(): Vector3? {
      val fnPtr = _1922832537_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_CenterPoint(value: Vector3?): Unit {
      val fnPtr = _1922832537_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1922832537_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Clip(): CompositionClip? {
      val fnPtr = _1922832537_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Clip(value: CompositionClip?): Unit {
      val fnPtr = _1922832537_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1922832537_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_CompositeMode(): CompositionCompositeMode? {
      val fnPtr = _1922832537_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_CompositeMode(value: CompositionCompositeMode?): Unit {
      val fnPtr = _1922832537_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1922832537_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_IsVisible(): Boolean {
      val fnPtr = _1922832537_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_IsVisible(value: Boolean): Unit {
      val fnPtr = _1922832537_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1922832537_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Offset(): Vector3? {
      val fnPtr = _1922832537_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Vector3>()
      val hr = fn.invokeHR(arrayOf(__1922832537_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Offset(value: Vector3?): Unit {
      val fnPtr = _1922832537_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1922832537_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Opacity(): Float {
      val fnPtr = _1922832537_VtblPtr!!.getPointer(22L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Opacity(value: Float): Unit {
      val fnPtr = _1922832537_VtblPtr!!.getPointer(23L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1922832537_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Orientation(): Quaternion? {
      val fnPtr = _1922832537_VtblPtr!!.getPointer(24L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Orientation(value: Quaternion?): Unit {
      val fnPtr = _1922832537_VtblPtr!!.getPointer(25L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1922832537_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Parent(): ContainerVisual? {
      val fnPtr = _1922832537_VtblPtr!!.getPointer(26L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_RotationAngle(): Float {
      val fnPtr = _1922832537_VtblPtr!!.getPointer(27L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__1922832537_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_RotationAngle(value: Float): Unit {
      val fnPtr = _1922832537_VtblPtr!!.getPointer(28L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1922832537_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_RotationAngleInDegrees(): Float {
      val fnPtr = _1922832537_VtblPtr!!.getPointer(29L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__1922832537_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_RotationAngleInDegrees(value: Float): Unit {
      val fnPtr = _1922832537_VtblPtr!!.getPointer(30L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1922832537_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_RotationAxis(): Vector3? {
      val fnPtr = _1922832537_VtblPtr!!.getPointer(31L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Vector3>()
      val hr = fn.invokeHR(arrayOf(__1922832537_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_RotationAxis(value: Vector3?): Unit {
      val fnPtr = _1922832537_VtblPtr!!.getPointer(32L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1922832537_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Scale(): Vector3? {
      val fnPtr = _1922832537_VtblPtr!!.getPointer(33L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Vector3>()
      val hr = fn.invokeHR(arrayOf(__1922832537_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Scale(value: Vector3?): Unit {
      val fnPtr = _1922832537_VtblPtr!!.getPointer(34L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1922832537_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Size(): Vector2? {
      val fnPtr = _1922832537_VtblPtr!!.getPointer(35L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Vector2>()
      val hr = fn.invokeHR(arrayOf(__1922832537_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Size(value: Vector2?): Unit {
      val fnPtr = _1922832537_VtblPtr!!.getPointer(36L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1922832537_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_TransformMatrix(): Matrix4x4? {
      val fnPtr = _1922832537_VtblPtr!!.getPointer(37L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_TransformMatrix(value: Matrix4x4?): Unit {
      val fnPtr = _1922832537_VtblPtr!!.getPointer(38L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1922832537_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IVisual_Impl(
    ...
    public override val __1922832537_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IVisual, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("c0eeab6cc8975ac6a1c963abd5055b9b")
    ...
    public override fun toNative(obj: IVisual): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1922832537_Ptr))
  }
