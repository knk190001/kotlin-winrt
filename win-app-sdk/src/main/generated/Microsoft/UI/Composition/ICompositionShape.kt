...
@Signature("{ed75d4d8-437f-5640-9720-faae35ce5895}")
@Guid("ed75d4d8437f56409720faae35ce5895")
@WinRTInterface("ed75d4d8437f56409720faae35ce5895")
...
public interface ICompositionShape : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionShape {
    public val __514046416_Ptr: Pointer?

    public val _514046416_VtblPtr: Pointer?
      get() = __514046416_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_CenterPoint(): Vector2? {
      val fnPtr = _514046416_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Vector2>()
      val hr = fn.invokeHR(arrayOf(__514046416_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_CenterPoint(value: Vector2?): Unit {
      val fnPtr = _514046416_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__514046416_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Offset(): Vector2? {
      val fnPtr = _514046416_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Vector2>()
      val hr = fn.invokeHR(arrayOf(__514046416_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Offset(value: Vector2?): Unit {
      val fnPtr = _514046416_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__514046416_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_RotationAngle(): Float {
      val fnPtr = _514046416_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_RotationAngle(value: Float): Unit {
      val fnPtr = _514046416_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__514046416_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_RotationAngleInDegrees(): Float {
      val fnPtr = _514046416_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__514046416_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_RotationAngleInDegrees(value: Float): Unit {
      val fnPtr = _514046416_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__514046416_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Scale(): Vector2? {
      val fnPtr = _514046416_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Vector2>()
      val hr = fn.invokeHR(arrayOf(__514046416_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Scale(value: Vector2?): Unit {
      val fnPtr = _514046416_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__514046416_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_TransformMatrix(): Matrix3x2? {
      val fnPtr = _514046416_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_TransformMatrix(value: Matrix3x2?): Unit {
      val fnPtr = _514046416_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__514046416_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class ICompositionShape_Impl(
    ...
    public override val __514046416_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionShape, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("ed75d4d8437f56409720faae35ce5895")
    ...
    public override fun toNative(obj: ICompositionShape): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__514046416_Ptr))
  }
