...
@Signature("{d741b99d-e248-5ba7-b728-8beea53fe28e}")
@Guid("d741b99de2485ba7b7288beea53fe28e")
@WinRTInterface("d741b99de2485ba7b7288beea53fe28e")
...
public interface ICompositionVirtualDrawingSurface : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionVirtualDrawingSurface {
    public val __1831225129_Ptr: Pointer?

    public val _1831225129_VtblPtr: Pointer?
      get() = __1831225129_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun Trim(rects: Array<RectInt32?>): Unit {
      val fnPtr = _1831225129_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1831225129_Ptr, rects.size,marshalToNative(rects),))
      if (hr.toInt() != 0) {
  ...
  public class ICompositionVirtualDrawingSurface_Impl(
    ...
    public override val __1831225129_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionVirtualDrawingSurface, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("d741b99de2485ba7b7288beea53fe28e")
    ...
    public override fun toNative(obj: ICompositionVirtualDrawingSurface): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1831225129_Ptr))
  }
