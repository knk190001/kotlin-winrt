...
@Signature("{d002896d-67d8-5f69-ab70-581fa3bf370f}")
@Guid("d002896d67d85f69ab70581fa3bf370f")
@WinRTInterface("d002896d67d85f69ab70581fa3bf370f")
...
public interface IVisualCollection : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IVisualCollection {
    public val __1544845335_Ptr: Pointer?

    public val _1544845335_VtblPtr: Pointer?
      get() = __1544845335_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Count(): Int {
      val fnPtr = _1544845335_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__1544845335_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun InsertAbove(newChild: Visual?, sibling: Visual?): Unit {
      val fnPtr = _1544845335_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1544845335_Ptr, marshalToNative(newChild),
    ...
    public override fun InsertAtBottom(newChild: Visual?): Unit {
      val fnPtr = _1544845335_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1544845335_Ptr, marshalToNative(newChild),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun InsertAtTop(newChild: Visual?): Unit {
      val fnPtr = _1544845335_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1544845335_Ptr, marshalToNative(newChild),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun InsertBelow(newChild: Visual?, sibling: Visual?): Unit {
      val fnPtr = _1544845335_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1544845335_Ptr, marshalToNative(newChild),
          marshalToNative(sibling),))
      if (hr.toInt() != 0) {
    ...
    public override fun Remove(child: Visual?): Unit {
      val fnPtr = _1544845335_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1544845335_Ptr, marshalToNative(child),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun RemoveAll(): Unit {
      val fnPtr = _1544845335_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1544845335_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IVisualCollection_Impl(
    ...
    public override val __1544845335_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IVisualCollection, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("d002896d67d85f69ab70581fa3bf370f")
    ...
    public override fun toNative(obj: IVisualCollection): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1544845335_Ptr))
  }
