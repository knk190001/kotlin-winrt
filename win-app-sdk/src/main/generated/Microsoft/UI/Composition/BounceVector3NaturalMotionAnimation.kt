...
@Signature("rc(Microsoft.UI.Composition.BounceVector3NaturalMotionAnimation;{e3e2ee98-1211-586d-8a6d-fea5efc3957f})")
...
public class BounceVector3NaturalMotionAnimation(
  ptr: JNAPointer? = NULL
    ...
    IWinRTObject {
  private val __1763289108_Interface: IBounceVector3NaturalMotionAnimation.WithDefault by lazy {
    as_1763289108()
  }


  public override val __1763289108_Ptr: JNAPointer? by lazy {
    __1763289108_Interface.__1763289108_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1763289108_Interface)

  private fun as_1763289108(): IBounceVector3NaturalMotionAnimation.WithDefault {
    if(pointer == NULL) {
