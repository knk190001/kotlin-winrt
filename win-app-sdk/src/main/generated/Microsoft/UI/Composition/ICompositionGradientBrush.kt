...
@Signature("{9165d1fb-c738-5f44-addc-309ee071d588}")
@Guid("9165d1fbc7385f44addc309ee071d588")
@WinRTInterface("9165d1fbc7385f44addc309ee071d588")
...
public interface ICompositionGradientBrush : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionGradientBrush {
    public val __981097095_Ptr: Pointer?

    public val _981097095_VtblPtr: Pointer?
      get() = __981097095_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_AnchorPoint(): Vector2? {
      val fnPtr = _981097095_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Vector2>()
      val hr = fn.invokeHR(arrayOf(__981097095_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_AnchorPoint(value: Vector2?): Unit {
      val fnPtr = _981097095_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__981097095_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_CenterPoint(): Vector2? {
      val fnPtr = _981097095_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Vector2>()
      val hr = fn.invokeHR(arrayOf(__981097095_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_CenterPoint(value: Vector2?): Unit {
      val fnPtr = _981097095_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__981097095_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_ColorStops(): CompositionColorGradientStopCollection? {
      val fnPtr = _981097095_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_ExtendMode(): CompositionGradientExtendMode? {
      val fnPtr = _981097095_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_ExtendMode(value: CompositionGradientExtendMode?): Unit {
      val fnPtr = _981097095_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__981097095_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_InterpolationSpace(): CompositionColorSpace? {
      val fnPtr = _981097095_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_InterpolationSpace(value: CompositionColorSpace?): Unit {
      val fnPtr = _981097095_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__981097095_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Offset(): Vector2? {
      val fnPtr = _981097095_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Vector2>()
      val hr = fn.invokeHR(arrayOf(__981097095_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Offset(value: Vector2?): Unit {
      val fnPtr = _981097095_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__981097095_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_RotationAngle(): Float {
      val fnPtr = _981097095_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_RotationAngle(value: Float): Unit {
      val fnPtr = _981097095_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__981097095_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_RotationAngleInDegrees(): Float {
      val fnPtr = _981097095_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__981097095_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_RotationAngleInDegrees(value: Float): Unit {
      val fnPtr = _981097095_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__981097095_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Scale(): Vector2? {
      val fnPtr = _981097095_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Vector2>()
      val hr = fn.invokeHR(arrayOf(__981097095_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Scale(value: Vector2?): Unit {
      val fnPtr = _981097095_VtblPtr!!.getPointer(22L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__981097095_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_TransformMatrix(): Matrix3x2? {
      val fnPtr = _981097095_VtblPtr!!.getPointer(23L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_TransformMatrix(value: Matrix3x2?): Unit {
      val fnPtr = _981097095_VtblPtr!!.getPointer(24L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__981097095_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class ICompositionGradientBrush_Impl(
    ...
    public override val __981097095_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionGradientBrush, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("9165d1fbc7385f44addc309ee071d588")
    ...
    public override fun toNative(obj: ICompositionGradientBrush): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__981097095_Ptr))
  }
