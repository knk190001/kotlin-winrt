...
@Signature("{95213c13-c4cb-57de-b267-d21ab901ae38}")
@Guid("95213c13c4cb57deb267d21ab901ae38")
@WinRTInterface("95213c13c4cb57deb267d21ab901ae38")
...
public interface ICompositor : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositor {
    public val __404036826_Ptr: Pointer?

    public val _404036826_VtblPtr: Pointer?
      get() = __404036826_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateColorKeyFrameAnimation(): ColorKeyFrameAnimation? {
      val fnPtr = _404036826_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ColorKeyFrameAnimation>()
      val hr = fn.invokeHR(arrayOf(__404036826_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun CreateColorBrush(): CompositionColorBrush? {
      val fnPtr = _404036826_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun CreateColorBrush(color: Color?): CompositionColorBrush? {
      val fnPtr = _404036826_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CompositionColorBrush>()
      val hr = fn.invokeHR(arrayOf(__404036826_Ptr, marshalToNative(color), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
      val resultValue = marshalFromNative<CompositionColorBrush>(result.getValue())
    ...
    public override fun CreateContainerVisual(): ContainerVisual? {
      val fnPtr = _404036826_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun CreateCubicBezierEasingFunction(controlPoint1: Vector2?,
      ...
      val fnPtr = _404036826_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CubicBezierEasingFunction>()
      val hr = fn.invokeHR(arrayOf(__404036826_Ptr, marshalToNative(controlPoint1),
    ...
    public override fun CreateEffectFactory(graphicsEffect: IGraphicsEffect?):
      ...
      val fnPtr = _404036826_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CompositionEffectFactory>()
      val hr = fn.invokeHR(arrayOf(__404036826_Ptr, marshalToNative(graphicsEffect), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun CreateEffectFactory(graphicsEffect: IGraphicsEffect?,
        animatableProperties: IIterable<String?>?): CompositionEffectFactory? {
      val fnPtr = _404036826_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CompositionEffectFactory>()
      val hr = fn.invokeHR(arrayOf(__404036826_Ptr, marshalToNative(graphicsEffect),
    ...
    public override fun CreateExpressionAnimation(): ExpressionAnimation? {
      val fnPtr = _404036826_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun CreateExpressionAnimation(expression: String?): ExpressionAnimation? {
      val fnPtr = _404036826_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<ExpressionAnimation>()
      val hr = fn.invokeHR(arrayOf(__404036826_Ptr, marshalToNative(expression), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
      val resultValue = marshalFromNative<ExpressionAnimation>(result.getValue())
    ...
    public override fun CreateInsetClip(): InsetClip? {
      val fnPtr = _404036826_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun CreateInsetClip(
      ...
      val fnPtr = _404036826_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<InsetClip>()
      val hr = fn.invokeHR(arrayOf(__404036826_Ptr, leftInset, topInset, rightInset, bottomInset,
          result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun CreateLinearEasingFunction(): LinearEasingFunction? {
      val fnPtr = _404036826_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun CreatePropertySet(): CompositionPropertySet? {
      val fnPtr = _404036826_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun CreateQuaternionKeyFrameAnimation(): QuaternionKeyFrameAnimation? {
      val fnPtr = _404036826_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun CreateScalarKeyFrameAnimation(): ScalarKeyFrameAnimation? {
      val fnPtr = _404036826_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun CreateScopedBatch(batchType: CompositionBatchTypes?):
      ...
      val fnPtr = _404036826_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CompositionScopedBatch>()
      val hr = fn.invokeHR(arrayOf(__404036826_Ptr, marshalToNative(batchType), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun CreateSpriteVisual(): SpriteVisual? {
      val fnPtr = _404036826_VtblPtr!!.getPointer(22L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun CreateSurfaceBrush(): CompositionSurfaceBrush? {
      val fnPtr = _404036826_VtblPtr!!.getPointer(23L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun CreateSurfaceBrush(surface: ICompositionSurface?):
      ...
      val fnPtr = _404036826_VtblPtr!!.getPointer(24L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CompositionSurfaceBrush>()
      val hr = fn.invokeHR(arrayOf(__404036826_Ptr, marshalToNative(surface), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
      val resultValue = marshalFromNative<CompositionSurfaceBrush>(result.getValue())
    ...
    public override fun CreateVector2KeyFrameAnimation(): Vector2KeyFrameAnimation? {
      val fnPtr = _404036826_VtblPtr!!.getPointer(25L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun CreateVector3KeyFrameAnimation(): Vector3KeyFrameAnimation? {
      val fnPtr = _404036826_VtblPtr!!.getPointer(26L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun CreateVector4KeyFrameAnimation(): Vector4KeyFrameAnimation? {
      val fnPtr = _404036826_VtblPtr!!.getPointer(27L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun GetCommitBatch(batchType: CompositionBatchTypes?): CompositionCommitBatch? {
      val fnPtr = _404036826_VtblPtr!!.getPointer(28L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class ICompositor_Impl(
    ...
    public override val __404036826_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositor, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("95213c13c4cb57deb267d21ab901ae38")
    ...
    public override fun toNative(obj: ICompositor): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__404036826_Ptr))
  }
