...
@Signature("{0144d7ad-6a7d-59cb-a0f9-74a04e85352c}")
@Guid("0144d7ad6a7d59cba0f974a04e85352c")
@WinRTInterface("0144d7ad6a7d59cba0f974a04e85352c")
...
public interface ISceneVisual : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISceneVisual {
    public val __645520968_Ptr: Pointer?

    public val _645520968_VtblPtr: Pointer?
      get() = __645520968_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Root(): SceneNode? {
      val fnPtr = _645520968_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<SceneNode>()
      val hr = fn.invokeHR(arrayOf(__645520968_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Root(value: SceneNode?): Unit {
      val fnPtr = _645520968_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__645520968_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class ISceneVisual_Impl(
    ...
    public override val __645520968_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISceneVisual, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("0144d7ad6a7d59cba0f974a04e85352c")
    ...
    public override fun toNative(obj: ISceneVisual): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__645520968_Ptr))
  }
