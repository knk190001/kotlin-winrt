...
@Signature("{a1bce140-79c2-59e6-9b68-63b1bab0e2a6}")
@Guid("a1bce14079c259e69b6863b1bab0e2a6")
@WinRTInterface("a1bce14079c259e69b6863b1bab0e2a6")
...
public interface ISceneNode : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISceneNode {
    public val __468834550_Ptr: Pointer?

    public val _468834550_VtblPtr: Pointer?
      get() = __468834550_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Children(): SceneNodeCollection? {
      val fnPtr = _468834550_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<SceneNodeCollection>()
      val hr = fn.invokeHR(arrayOf(__468834550_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Components(): SceneComponentCollection? {
      val fnPtr = _468834550_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_Parent(): SceneNode? {
      val fnPtr = _468834550_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_Transform(): SceneModelTransform? {
      val fnPtr = _468834550_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun FindFirstComponentOfType(value: SceneComponentType?): SceneComponent? {
      val fnPtr = _468834550_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<SceneComponent>()
      val hr = fn.invokeHR(arrayOf(__468834550_Ptr, marshalToNative(value), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
  ...
  public class ISceneNode_Impl(
    ...
    public override val __468834550_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISceneNode, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("a1bce14079c259e69b6863b1bab0e2a6")
    ...
    public override fun toNative(obj: ISceneNode): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__468834550_Ptr))
  }
