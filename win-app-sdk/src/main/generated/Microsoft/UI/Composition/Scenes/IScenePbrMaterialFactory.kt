...
@Signature("{9e34d32a-e30c-51f5-84ac-6467950605ca}")
@Guid("9e34d32ae30c51f584ac6467950605ca")
@WinRTInterface("9e34d32ae30c51f584ac6467950605ca")
...
public interface IScenePbrMaterialFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IScenePbrMaterialFactory {
    public val __1371673611_Ptr: Pointer?

    public val _1371673611_VtblPtr: Pointer?
      get() = __1371673611_Ptr?.getPointer(0)
  }

  public class IScenePbrMaterialFactory_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __1371673611_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IScenePbrMaterialFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("9e34d32ae30c51f584ac6467950605ca")
    ...
    public override fun toNative(obj: IScenePbrMaterialFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1371673611_Ptr))
  }
