...
@Signature("{3f05555f-0f67-576e-9d8a-93c1f250c29f}")
@Guid("3f05555f0f67576e9d8a93c1f250c29f")
@WinRTInterface("3f05555f0f67576e9d8a93c1f250c29f")
...
public interface ISceneModelTransform : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISceneModelTransform {
    public val __906419531_Ptr: Pointer?

    public val _906419531_VtblPtr: Pointer?
      get() = __906419531_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Orientation(): Quaternion? {
      val fnPtr = _906419531_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Quaternion>()
      val hr = fn.invokeHR(arrayOf(__906419531_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Orientation(value: Quaternion?): Unit {
      val fnPtr = _906419531_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__906419531_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_RotationAngle(): Float {
      val fnPtr = _906419531_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_RotationAngle(value: Float): Unit {
      val fnPtr = _906419531_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__906419531_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_RotationAngleInDegrees(): Float {
      val fnPtr = _906419531_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__906419531_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_RotationAngleInDegrees(value: Float): Unit {
      val fnPtr = _906419531_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__906419531_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_RotationAxis(): Vector3? {
      val fnPtr = _906419531_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_RotationAxis(value: Vector3?): Unit {
      val fnPtr = _906419531_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__906419531_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Scale(): Vector3? {
      val fnPtr = _906419531_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Vector3>()
      val hr = fn.invokeHR(arrayOf(__906419531_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Scale(value: Vector3?): Unit {
      val fnPtr = _906419531_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__906419531_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Translation(): Vector3? {
      val fnPtr = _906419531_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Vector3>()
      val hr = fn.invokeHR(arrayOf(__906419531_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Translation(value: Vector3?): Unit {
      val fnPtr = _906419531_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__906419531_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class ISceneModelTransform_Impl(
    ...
    public override val __906419531_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISceneModelTransform, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("3f05555f0f67576e9d8a93c1f250c29f")
    ...
    public override fun toNative(obj: ISceneModelTransform): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__906419531_Ptr))
  }
