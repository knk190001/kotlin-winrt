...
@Signature("{6bab8030-89c1-5dbc-a48e-1805ddf9cdd1}")
@Guid("6bab803089c15dbca48e1805ddf9cdd1")
@WinRTInterface("6bab803089c15dbca48e1805ddf9cdd1")
...
public interface ISceneRendererComponent : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISceneRendererComponent {
    public val __2072405134_Ptr: Pointer?

    public val _2072405134_VtblPtr: Pointer?
      get() = __2072405134_Ptr?.getPointer(0)
  }

  public class ISceneRendererComponent_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __2072405134_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISceneRendererComponent, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("6bab803089c15dbca48e1805ddf9cdd1")
    ...
    public override fun toNative(obj: ISceneRendererComponent): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2072405134_Ptr))
  }
