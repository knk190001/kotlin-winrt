...
@Signature("{295d0725-56fe-5954-8057-3f4ca7515b36}")
@Guid("295d072556fe595480573f4ca7515b36")
@WinRTInterface("295d072556fe595480573f4ca7515b36")
...
public interface IScenePbrMaterial : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IScenePbrMaterial {
    public val __1685555199_Ptr: Pointer?

    public val _1685555199_VtblPtr: Pointer?
      get() = __1685555199_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_AlphaCutoff(): Float {
      val fnPtr = _1685555199_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__1685555199_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_AlphaCutoff(value: Float): Unit {
      val fnPtr = _1685555199_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1685555199_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_AlphaMode(): SceneAlphaMode? {
      val fnPtr = _1685555199_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_AlphaMode(value: SceneAlphaMode?): Unit {
      val fnPtr = _1685555199_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1685555199_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_EmissiveInput(): SceneMaterialInput? {
      val fnPtr = _1685555199_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_EmissiveInput(value: SceneMaterialInput?): Unit {
      val fnPtr = _1685555199_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1685555199_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_EmissiveFactor(): Vector3? {
      val fnPtr = _1685555199_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_EmissiveFactor(value: Vector3?): Unit {
      val fnPtr = _1685555199_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1685555199_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_IsDoubleSided(): Boolean {
      val fnPtr = _1685555199_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_IsDoubleSided(value: Boolean): Unit {
      val fnPtr = _1685555199_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1685555199_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_NormalInput(): SceneMaterialInput? {
      val fnPtr = _1685555199_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<SceneMaterialInput>()
      val hr = fn.invokeHR(arrayOf(__1685555199_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_NormalInput(value: SceneMaterialInput?): Unit {
      val fnPtr = _1685555199_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1685555199_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_NormalScale(): Float {
      val fnPtr = _1685555199_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__1685555199_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_NormalScale(value: Float): Unit {
      val fnPtr = _1685555199_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1685555199_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_OcclusionInput(): SceneMaterialInput? {
      val fnPtr = _1685555199_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<SceneMaterialInput>()
      val hr = fn.invokeHR(arrayOf(__1685555199_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_OcclusionInput(value: SceneMaterialInput?): Unit {
      val fnPtr = _1685555199_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1685555199_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_OcclusionStrength(): Float {
      val fnPtr = _1685555199_VtblPtr!!.getPointer(22L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__1685555199_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_OcclusionStrength(value: Float): Unit {
      val fnPtr = _1685555199_VtblPtr!!.getPointer(23L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1685555199_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IScenePbrMaterial_Impl(
    ...
    public override val __1685555199_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IScenePbrMaterial, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("295d072556fe595480573f4ca7515b36")
    ...
    public override fun toNative(obj: IScenePbrMaterial): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1685555199_Ptr))
  }
