...
@Signature("{bd551fcf-2c7f-5125-ac44-50a4f1d8fa76}")
@Guid("bd551fcf2c7f5125ac4450a4f1d8fa76")
@WinRTInterface("bd551fcf2c7f5125ac4450a4f1d8fa76")
...
public interface ICompositionRectangleGeometry : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionRectangleGeometry {
    public val __95277840_Ptr: Pointer?

    public val _95277840_VtblPtr: Pointer?
      get() = __95277840_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Offset(): Vector2? {
      val fnPtr = _95277840_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Vector2>()
      val hr = fn.invokeHR(arrayOf(__95277840_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Offset(value: Vector2?): Unit {
      val fnPtr = _95277840_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__95277840_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Size(): Vector2? {
      val fnPtr = _95277840_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Vector2>()
      val hr = fn.invokeHR(arrayOf(__95277840_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Size(value: Vector2?): Unit {
      val fnPtr = _95277840_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__95277840_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class ICompositionRectangleGeometry_Impl(
    ...
    public override val __95277840_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionRectangleGeometry, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("bd551fcf2c7f5125ac4450a4f1d8fa76")
    ...
    public override fun toNative(obj: ICompositionRectangleGeometry): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__95277840_Ptr))
  }
