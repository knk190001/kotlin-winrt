...
@Signature("rc(Microsoft.UI.Composition.RectangleClip;{bc261502-2259-5c01-8616-556110a09657})")
...
public class RectangleClip(
  ...
  private val __1834721818_Interface: IRectangleClip.WithDefault by lazy {
    as_1834721818()
  }


  public override val __1834721818_Ptr: JNAPointer? by lazy {
    __1834721818_Interface.__1834721818_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1834721818_Interface)

  private fun as_1834721818(): IRectangleClip.WithDefault {
    if(pointer == NULL) {
