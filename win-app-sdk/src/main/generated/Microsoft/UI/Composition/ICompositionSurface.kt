...
@Signature("{9ec612c3-a5d2-4f97-9df3-6b49ce736215}")
@Guid("9ec612c3a5d24f979df36b49ce736215")
@WinRTInterface("9ec612c3a5d24f979df36b49ce736215")
...
public interface ICompositionSurface : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionSurface {
    public val __310213500_Ptr: Pointer?

    public val _310213500_VtblPtr: Pointer?
      get() = __310213500_Ptr?.getPointer(0)
  }

  public class ICompositionSurface_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __310213500_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionSurface, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("9ec612c3a5d24f979df36b49ce736215")
    ...
    public override fun toNative(obj: ICompositionSurface): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__310213500_Ptr))
  }
