...
@Signature("{b66b55cb-b5a5-5bee-8972-ae78233cb34c}")
@Guid("b66b55cbb5a55bee8972ae78233cb34c")
@WinRTInterface("b66b55cbb5a55bee8972ae78233cb34c")
...
public interface ICompositionClip : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionClip {
    public val __1402528031_Ptr: Pointer?

    public val _1402528031_VtblPtr: Pointer?
      get() = __1402528031_Ptr?.getPointer(0)
  }

  public class ICompositionClip_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __1402528031_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionClip, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("b66b55cbb5a55bee8972ae78233cb34c")
    ...
    public override fun toNative(obj: ICompositionClip): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1402528031_Ptr))
  }
