...
@Signature("{cdf6bf80-afd7-57dc-8148-6ccbbb5d78bb}")
@Guid("cdf6bf80afd757dc81486ccbbb5d78bb")
@WinRTInterface("cdf6bf80afd757dc81486ccbbb5d78bb")
...
public interface ICompositionClip2 : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionClip2 {
    public val __528695951_Ptr: Pointer?

    public val _528695951_VtblPtr: Pointer?
      get() = __528695951_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_AnchorPoint(): Vector2? {
      val fnPtr = _528695951_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Vector2>()
      val hr = fn.invokeHR(arrayOf(__528695951_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_AnchorPoint(value: Vector2?): Unit {
      val fnPtr = _528695951_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__528695951_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_CenterPoint(): Vector2? {
      val fnPtr = _528695951_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Vector2>()
      val hr = fn.invokeHR(arrayOf(__528695951_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_CenterPoint(value: Vector2?): Unit {
      val fnPtr = _528695951_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__528695951_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Offset(): Vector2? {
      val fnPtr = _528695951_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Vector2>()
      val hr = fn.invokeHR(arrayOf(__528695951_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Offset(value: Vector2?): Unit {
      val fnPtr = _528695951_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__528695951_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_RotationAngle(): Float {
      val fnPtr = _528695951_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_RotationAngle(value: Float): Unit {
      val fnPtr = _528695951_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__528695951_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_RotationAngleInDegrees(): Float {
      val fnPtr = _528695951_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__528695951_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_RotationAngleInDegrees(value: Float): Unit {
      val fnPtr = _528695951_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__528695951_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Scale(): Vector2? {
      val fnPtr = _528695951_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Vector2>()
      val hr = fn.invokeHR(arrayOf(__528695951_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Scale(value: Vector2?): Unit {
      val fnPtr = _528695951_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__528695951_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_TransformMatrix(): Matrix3x2? {
      val fnPtr = _528695951_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_TransformMatrix(value: Matrix3x2?): Unit {
      val fnPtr = _528695951_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__528695951_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class ICompositionClip2_Impl(
    ...
    public override val __528695951_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionClip2, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("cdf6bf80afd757dc81486ccbbb5d78bb")
    ...
    public override fun toNative(obj: ICompositionClip2): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__528695951_Ptr))
  }
