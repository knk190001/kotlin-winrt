...
@Signature("{3cb43662-9ecf-5128-850d-9eb8437774f0}")
@Guid("3cb436629ecf5128850d9eb8437774f0")
@WinRTInterface("3cb436629ecf5128850d9eb8437774f0")
...
public interface ISpriteVisual2 : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ISpriteVisual2 {
    public val __492493068_Ptr: Pointer?

    public val _492493068_VtblPtr: Pointer?
      get() = __492493068_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Shadow(): CompositionShadow? {
      val fnPtr = _492493068_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CompositionShadow>()
      val hr = fn.invokeHR(arrayOf(__492493068_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Shadow(value: CompositionShadow?): Unit {
      val fnPtr = _492493068_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__492493068_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class ISpriteVisual2_Impl(
    ...
    public override val __492493068_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ISpriteVisual2, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("3cb436629ecf5128850d9eb8437774f0")
    ...
    public override fun toNative(obj: ISpriteVisual2): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__492493068_Ptr))
  }
