...
@Signature("{0e583d49-fb5e-5481-a426-d3c41e059a5a}")
@Guid("0e583d49fb5e5481a426d3c41e059a5a")
@WinRTInterface("0e583d49fb5e5481a426d3c41e059a5a")
...
public interface ICompositionObject : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionObject {
    public val __1124630160_Ptr: Pointer?

    public val _1124630160_VtblPtr: Pointer?
      get() = __1124630160_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Compositor(): Compositor? {
      val fnPtr = _1124630160_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Compositor>()
      val hr = fn.invokeHR(arrayOf(__1124630160_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Properties(): CompositionPropertySet? {
      val fnPtr = _1124630160_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun StartAnimation(propertyName: String?, animation: CompositionAnimation?):
        Unit {
      val fnPtr = _1124630160_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1124630160_Ptr, marshalToNative(propertyName),
    ...
    public override fun StopAnimation(propertyName: String?): Unit {
      val fnPtr = _1124630160_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1124630160_Ptr, marshalToNative(propertyName),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class ICompositionObject_Impl(
    ...
    public override val __1124630160_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionObject, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("0e583d49fb5e5481a426d3c41e059a5a")
    ...
    public override fun toNative(obj: ICompositionObject): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1124630160_Ptr))
  }
