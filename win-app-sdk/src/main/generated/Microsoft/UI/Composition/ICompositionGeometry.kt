...
@Signature("{4e40bdb2-450b-5a81-9e9b-149417980cc4}")
@Guid("4e40bdb2450b5a819e9b149417980cc4")
@WinRTInterface("4e40bdb2450b5a819e9b149417980cc4")
...
public interface ICompositionGeometry : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionGeometry {
    public val __193352579_Ptr: Pointer?

    public val _193352579_VtblPtr: Pointer?
      get() = __193352579_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_TrimEnd(): Float {
      val fnPtr = _193352579_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__193352579_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_TrimEnd(value: Float): Unit {
      val fnPtr = _193352579_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__193352579_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_TrimOffset(): Float {
      val fnPtr = _193352579_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__193352579_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_TrimOffset(value: Float): Unit {
      val fnPtr = _193352579_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__193352579_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_TrimStart(): Float {
      val fnPtr = _193352579_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__193352579_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_TrimStart(value: Float): Unit {
      val fnPtr = _193352579_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__193352579_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class ICompositionGeometry_Impl(
    ...
    public override val __193352579_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionGeometry, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("4e40bdb2450b5a819e9b149417980cc4")
    ...
    public override fun toNative(obj: ICompositionGeometry): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__193352579_Ptr))
  }
