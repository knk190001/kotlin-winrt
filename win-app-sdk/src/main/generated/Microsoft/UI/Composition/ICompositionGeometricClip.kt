...
@Signature("{e3c0a8c5-5297-5d69-8b91-f5330bb1cb27}")
@Guid("e3c0a8c552975d698b91f5330bb1cb27")
@WinRTInterface("e3c0a8c552975d698b91f5330bb1cb27")
...
public interface ICompositionGeometricClip : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionGeometricClip {
    public val __1538913600_Ptr: Pointer?

    public val _1538913600_VtblPtr: Pointer?
      get() = __1538913600_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Geometry(): CompositionGeometry? {
      val fnPtr = _1538913600_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CompositionGeometry>()
      val hr = fn.invokeHR(arrayOf(__1538913600_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Geometry(value: CompositionGeometry?): Unit {
      val fnPtr = _1538913600_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1538913600_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_ViewBox(): CompositionViewBox? {
      val fnPtr = _1538913600_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_ViewBox(value: CompositionViewBox?): Unit {
      val fnPtr = _1538913600_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1538913600_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class ICompositionGeometricClip_Impl(
    ...
    public override val __1538913600_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionGeometricClip, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("e3c0a8c552975d698b91f5330bb1cb27")
    ...
    public override fun toNative(obj: ICompositionGeometricClip): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1538913600_Ptr))
  }
