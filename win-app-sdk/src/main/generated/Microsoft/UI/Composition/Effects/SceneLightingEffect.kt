...
@Signature("rc(Microsoft.UI.Composition.Effects.SceneLightingEffect;{eb1e7316-114c-5950-8480-20a29a3bb1ee})")
...
public class SceneLightingEffect(
  ...
  private val __1990171228_Interface: ISceneLightingEffect.WithDefault by lazy {
    as_1990171228()
  }


  private val __1565765874_Interface: ISceneLightingEffect2.WithDefault by lazy {
    as_1565765874()
  }
  ...
  public override val __1990171228_Ptr: JNAPointer? by lazy {
    __1990171228_Interface.__1990171228_Ptr
  }


  public override val __1565765874_Ptr: JNAPointer? by lazy {
    __1565765874_Interface.__1565765874_Ptr
  }
  ...
  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1990171228_Interface, __1565765874_Interface, __2076412261_Interface,
        __568797846_Interface)

  public constructor() : this(ABI.activate())

  private fun as_1990171228(): ISceneLightingEffect.WithDefault {
    if(pointer == NULL) {
  ...
  private fun as_1565765874(): ISceneLightingEffect2.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<SceneLightingEffect, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Composition.Effects.SceneLightingEffect".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
