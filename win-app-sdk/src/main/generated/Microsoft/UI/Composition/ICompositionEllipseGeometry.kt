...
@Signature("{f2a21042-7a57-58c1-8b47-8bc8b21d3aa0}")
@Guid("f2a210427a5758c18b478bc8b21d3aa0")
@WinRTInterface("f2a210427a5758c18b478bc8b21d3aa0")
...
public interface ICompositionEllipseGeometry : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionEllipseGeometry {
    public val __219093567_Ptr: Pointer?

    public val _219093567_VtblPtr: Pointer?
      get() = __219093567_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Center(): Vector2? {
      val fnPtr = _219093567_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Vector2>()
      val hr = fn.invokeHR(arrayOf(__219093567_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Center(value: Vector2?): Unit {
      val fnPtr = _219093567_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__219093567_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Radius(): Vector2? {
      val fnPtr = _219093567_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Vector2>()
      val hr = fn.invokeHR(arrayOf(__219093567_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Radius(value: Vector2?): Unit {
      val fnPtr = _219093567_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__219093567_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class ICompositionEllipseGeometry_Impl(
    ...
    public override val __219093567_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionEllipseGeometry, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("f2a210427a5758c18b478bc8b21d3aa0")
    ...
    public override fun toNative(obj: ICompositionEllipseGeometry): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__219093567_Ptr))
  }
