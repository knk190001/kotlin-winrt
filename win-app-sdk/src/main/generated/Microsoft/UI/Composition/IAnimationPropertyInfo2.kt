...
@Signature("{ed14fb09-de28-540d-9311-80cfdcc97338}")
@Guid("ed14fb09de28540d931180cfdcc97338")
@WinRTInterface("ed14fb09de28540d931180cfdcc97338")
...
public interface IAnimationPropertyInfo2 : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IAnimationPropertyInfo2 {
    public val __1735955804_Ptr: Pointer?

    public val _1735955804_VtblPtr: Pointer?
      get() = __1735955804_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun GetResolvedCompositionObject(): CompositionObject? {
      val fnPtr = _1735955804_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CompositionObject>()
      val hr = fn.invokeHR(arrayOf(__1735955804_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun GetResolvedCompositionObjectProperty(): String? {
      val fnPtr = _1735955804_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class IAnimationPropertyInfo2_Impl(
    ...
    public override val __1735955804_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IAnimationPropertyInfo2, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("ed14fb09de28540d931180cfdcc97338")
    ...
    public override fun toNative(obj: IAnimationPropertyInfo2): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1735955804_Ptr))
  }
