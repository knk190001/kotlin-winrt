...
@Signature("{3f8ffb69-3e71-55a7-8e79-f27a214c56ae}")
@Guid("3f8ffb693e7155a78e79f27a214c56ae")
@WinRTInterface("3f8ffb693e7155a78e79f27a214c56ae")
...
public interface ICompositionColorBrush : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionColorBrush {
    public val __2107807640_Ptr: Pointer?

    public val _2107807640_VtblPtr: Pointer?
      get() = __2107807640_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Color(): Color? {
      val fnPtr = _2107807640_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__2107807640_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Color(value: Color?): Unit {
      val fnPtr = _2107807640_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2107807640_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class ICompositionColorBrush_Impl(
    ...
    public override val __2107807640_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionColorBrush, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("3f8ffb693e7155a78e79f27a214c56ae")
    ...
    public override fun toNative(obj: ICompositionColorBrush): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2107807640_Ptr))
  }
