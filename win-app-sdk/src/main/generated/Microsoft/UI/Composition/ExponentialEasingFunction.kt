...
@Signature("rc(Microsoft.UI.Composition.ExponentialEasingFunction;{df29ecc1-3ffc-565f-9d6c-533586908106})")
...
public class ExponentialEasingFunction(
  ...
  private val __1968416975_Interface: IExponentialEasingFunction.WithDefault by lazy {
    as_1968416975()
  }


  public override val __1968416975_Ptr: JNAPointer? by lazy {
    __1968416975_Interface.__1968416975_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1968416975_Interface)

  private fun as_1968416975(): IExponentialEasingFunction.WithDefault {
    if(pointer == NULL) {
