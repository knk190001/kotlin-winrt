...
@Signature("{667e4071-addd-5ded-b6c0-09e03a14be7e}")
@Guid("667e4071addd5dedb6c009e03a14be7e")
@WinRTInterface("667e4071addd5dedb6c009e03a14be7e")
...
public interface ICompositionViewBox : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionViewBox {
    public val __1677321291_Ptr: Pointer?

    public val _1677321291_VtblPtr: Pointer?
      get() = __1677321291_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_HorizontalAlignmentRatio(): Float {
      val fnPtr = _1677321291_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__1677321291_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_HorizontalAlignmentRatio(value: Float): Unit {
      val fnPtr = _1677321291_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1677321291_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Offset(): Vector2? {
      val fnPtr = _1677321291_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Offset(value: Vector2?): Unit {
      val fnPtr = _1677321291_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1677321291_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Size(): Vector2? {
      val fnPtr = _1677321291_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Vector2>()
      val hr = fn.invokeHR(arrayOf(__1677321291_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Size(value: Vector2?): Unit {
      val fnPtr = _1677321291_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1677321291_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Stretch(): CompositionStretch? {
      val fnPtr = _1677321291_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Stretch(value: CompositionStretch?): Unit {
      val fnPtr = _1677321291_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1677321291_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_VerticalAlignmentRatio(): Float {
      val fnPtr = _1677321291_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__1677321291_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_VerticalAlignmentRatio(value: Float): Unit {
      val fnPtr = _1677321291_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1677321291_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class ICompositionViewBox_Impl(
    ...
    public override val __1677321291_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionViewBox, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("667e4071addd5dedb6c009e03a14be7e")
    ...
    public override fun toNative(obj: ICompositionViewBox): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1677321291_Ptr))
  }
