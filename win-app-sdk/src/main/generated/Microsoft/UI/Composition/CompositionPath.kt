...
import Microsoft.UI.Composition.ICompositionPathFactory.ABI.IID
...
@Signature("rc(Microsoft.UI.Composition.CompositionPath;{17c518c0-d7a2-54be-ac7f-c408562a6a20})")
...
public class CompositionPath(
  ...
  private val __1402150986_Interface: ICompositionPath.WithDefault by lazy {
    as_1402150986()
  }
  ...
  public override val __1402150986_Ptr: JNAPointer? by lazy {
    __1402150986_Interface.__1402150986_Ptr
  }
  ...
  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__1402150986_Interface, __397532782_Interface)

  public constructor(source: IGeometrySource2D) : this(ABI.activate(source))

  private fun as_1402150986(): ICompositionPath.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<CompositionPath, MemoryAddress> {
    ...
    public fun createICompositionPathFactory(): ICompositionPathFactory {
      ...
      val hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Composition.CompositionPath".toHandle(),refiid,factoryActivatorPtr)
      checkHR(hr)
