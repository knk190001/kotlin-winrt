...
@Signature("{27c75bab-317a-5362-bf25-fffbb98a51b9}")
@Guid("27c75bab317a5362bf25fffbb98a51b9")
@WinRTInterface("27c75bab317a5362bf25fffbb98a51b9")
...
public interface IBackEasingFunction : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IBackEasingFunction {
    public val __1226489539_Ptr: Pointer?

    public val _1226489539_VtblPtr: Pointer?
      get() = __1226489539_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Mode(): CompositionEasingFunctionMode? {
      val fnPtr = _1226489539_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CompositionEasingFunctionMode>()
      val hr = fn.invokeHR(arrayOf(__1226489539_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Amplitude(): Float {
      val fnPtr = _1226489539_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class IBackEasingFunction_Impl(
    ...
    public override val __1226489539_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IBackEasingFunction, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("27c75bab317a5362bf25fffbb98a51b9")
    ...
    public override fun toNative(obj: IBackEasingFunction): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1226489539_Ptr))
  }
