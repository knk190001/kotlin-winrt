...
@Signature("{972b70b0-950d-5656-a380-bd4a70775868}")
@Guid("972b70b0950d5656a380bd4a70775868")
@WinRTInterface("972b70b0950d5656a380bd4a70775868")
...
public interface IVisual3 : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IVisual3 {
    public val __521733446_Ptr: Pointer?

    public val _521733446_VtblPtr: Pointer?
      get() = __521733446_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_IsHitTestVisible(): Boolean {
      val fnPtr = _521733446_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__521733446_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_IsHitTestVisible(value: Boolean): Unit {
      val fnPtr = _521733446_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__521733446_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IVisual3_Impl(
    ...
    public override val __521733446_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IVisual3, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("972b70b0950d5656a380bd4a70775868")
    ...
    public override fun toNative(obj: IVisual3): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__521733446_Ptr))
  }
