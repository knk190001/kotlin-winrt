...
@Signature("{9f97bfec-b6b9-51ee-8480-b546468c748f}")
@Guid("9f97bfecb6b951ee8480b546468c748f")
@WinRTInterface("9f97bfecb6b951ee8480b546468c748f")
...
public interface IDistantLight2 : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IDistantLight2 {
    public val __1844076612_Ptr: Pointer?

    public val _1844076612_VtblPtr: Pointer?
      get() = __1844076612_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Intensity(): Float {
      val fnPtr = _1844076612_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__1844076612_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Intensity(value: Float): Unit {
      val fnPtr = _1844076612_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1844076612_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IDistantLight2_Impl(
    ...
    public override val __1844076612_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IDistantLight2, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("9f97bfecb6b951ee8480b546468c748f")
    ...
    public override fun toNative(obj: IDistantLight2): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1844076612_Ptr))
  }
