...
@Signature("{c7b1d4cf-c562-56b3-b4e6-b21326165f71}")
@Guid("c7b1d4cfc56256b3b4e6b21326165f71")
@WinRTInterface("c7b1d4cfc56256b3b4e6b21326165f71")
...
public interface IStepEasingFunction : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IStepEasingFunction {
    public val __674034712_Ptr: Pointer?

    public val _674034712_VtblPtr: Pointer?
      get() = __674034712_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_FinalStep(): Int {
      val fnPtr = _674034712_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__674034712_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_FinalStep(value: Int): Unit {
      val fnPtr = _674034712_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__674034712_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_InitialStep(): Int {
      val fnPtr = _674034712_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__674034712_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_InitialStep(value: Int): Unit {
      val fnPtr = _674034712_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__674034712_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_IsFinalStepSingleFrame(): Boolean {
      val fnPtr = _674034712_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_IsFinalStepSingleFrame(value: Boolean): Unit {
      val fnPtr = _674034712_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__674034712_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_IsInitialStepSingleFrame(): Boolean {
      val fnPtr = _674034712_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Boolean>()
      val hr = fn.invokeHR(arrayOf(__674034712_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_IsInitialStepSingleFrame(value: Boolean): Unit {
      val fnPtr = _674034712_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__674034712_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_StepCount(): Int {
      val fnPtr = _674034712_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__674034712_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_StepCount(value: Int): Unit {
      val fnPtr = _674034712_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__674034712_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IStepEasingFunction_Impl(
    ...
    public override val __674034712_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IStepEasingFunction, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("c7b1d4cfc56256b3b4e6b21326165f71")
    ...
    public override fun toNative(obj: IStepEasingFunction): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__674034712_Ptr))
  }
