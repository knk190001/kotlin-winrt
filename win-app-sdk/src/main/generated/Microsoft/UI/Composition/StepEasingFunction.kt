...
@Signature("rc(Microsoft.UI.Composition.StepEasingFunction;{c7b1d4cf-c562-56b3-b4e6-b21326165f71})")
...
public class StepEasingFunction(
  ...
  private val __674034712_Interface: IStepEasingFunction.WithDefault by lazy {
    as_674034712()
  }


  public override val __674034712_Ptr: JNAPointer? by lazy {
    __674034712_Interface.__674034712_Ptr
  }


  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__674034712_Interface)

  private fun as_674034712(): IStepEasingFunction.WithDefault {
    if(pointer == NULL) {
