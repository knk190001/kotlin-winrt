...
@Signature("{64d05ca1-3bf6-5d4f-98a1-7500f2f23ebe}")
@Guid("64d05ca13bf65d4f98a17500f2f23ebe")
@WinRTInterface("64d05ca13bf65d4f98a17500f2f23ebe")
...
public interface ILayerVisual : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ILayerVisual {
    public val __1269651912_Ptr: Pointer?

    public val _1269651912_VtblPtr: Pointer?
      get() = __1269651912_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Effect(): CompositionEffectBrush? {
      val fnPtr = _1269651912_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CompositionEffectBrush>()
      val hr = fn.invokeHR(arrayOf(__1269651912_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Effect(value: CompositionEffectBrush?): Unit {
      val fnPtr = _1269651912_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1269651912_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class ILayerVisual_Impl(
    ...
    public override val __1269651912_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ILayerVisual, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("64d05ca13bf65d4f98a17500f2f23ebe")
    ...
    public override fun toNative(obj: ILayerVisual): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1269651912_Ptr))
  }
