package Microsoft.UI.Composition.Core
...
@Signature("{cc107cdc-558f-5d1a-96a5-a735ac04386b}")
@Guid("cc107cdc558f5d1a96a5a735ac04386b")
@WinRTInterface("cc107cdc558f5d1a96a5a735ac04386b")
...
public interface ICompositorController : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositorController {
    public val __980274199_Ptr: Pointer?

    public val _980274199_VtblPtr: Pointer?
      get() = __980274199_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Compositor(): Compositor? {
      val fnPtr = _980274199_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Compositor>()
      val hr = fn.invokeHR(arrayOf(__980274199_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun Commit(): Unit {
      val fnPtr = _980274199_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__980274199_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun EnsurePreviousCommitCompletedAsync(): IAsyncAction? {
      val fnPtr = _980274199_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun add_CommitNeeded(handler: TypedEventHandler<CompositorController?,
      ...
      val fnPtr = _980274199_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<EventRegistrationToken>()
      val hr = fn.invokeHR(arrayOf(__980274199_Ptr, marshalToNative(handler), result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    ...
    public override fun remove_CommitNeeded(token: EventRegistrationToken?): Unit {
      val fnPtr = _980274199_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__980274199_Ptr, marshalToNative(token),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class ICompositorController_Impl(
    ...
    public override val __980274199_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositorController, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("cc107cdc558f5d1a96a5a735ac04386b")
    ...
    public override fun toNative(obj: ICompositorController): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__980274199_Ptr))
  }
