...
@Signature("rc(Microsoft.UI.Composition.Core.CompositorController;{cc107cdc-558f-5d1a-96a5-a735ac04386b})")
...
public class CompositorController(
  ...
  private val __980274199_Interface: ICompositorController.WithDefault by lazy {
    as_980274199()
  }
  ...
  public override val __980274199_Ptr: JNAPointer? by lazy {
    __980274199_Interface.__980274199_Ptr
  }
  ...
  public override val interfaces: Array<IWinRTInterface>
    get() = arrayOf(__980274199_Interface, __1260617006_Interface)

  public constructor() : this(ABI.activate())

  private fun as_980274199(): ICompositorController.WithDefault {
    if(pointer == NULL) {
  ...
  public object ABI : IABI<CompositorController, MemoryAddress> {
    ...
    public fun createActivationFactory(): IActivationFactory {
      ...
      var hr =
          INSTANCE.RoGetActivationFactory("Microsoft.UI.Composition.Core.CompositorController".toHandle(),
          refiid, iAFPtr)
      checkHR(hr)
