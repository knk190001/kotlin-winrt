...
@Signature("{abf2b354-7130-53d9-8324-365d7e02ede7}")
@Guid("abf2b354713053d98324365d7e02ede7")
@WinRTInterface("abf2b354713053d98324365d7e02ede7")
...
public interface ICompositionBrushFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionBrushFactory {
    public val __1508518143_Ptr: Pointer?

    public val _1508518143_VtblPtr: Pointer?
      get() = __1508518143_Ptr?.getPointer(0)
  }

  public class ICompositionBrushFactory_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __1508518143_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionBrushFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("abf2b354713053d98324365d7e02ede7")
    ...
    public override fun toNative(obj: ICompositionBrushFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1508518143_Ptr))
  }
