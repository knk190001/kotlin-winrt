...
@Signature("{9ab2e401-af45-54da-9991-dd31273155d2}")
@Guid("9ab2e401af4554da9991dd31273155d2")
@WinRTInterface("9ab2e401af4554da9991dd31273155d2")
...
public interface ILayerVisual2 : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ILayerVisual2 {
    public val __704503558_Ptr: Pointer?

    public val _704503558_VtblPtr: Pointer?
      get() = __704503558_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Shadow(): CompositionShadow? {
      val fnPtr = _704503558_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CompositionShadow>()
      val hr = fn.invokeHR(arrayOf(__704503558_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Shadow(value: CompositionShadow?): Unit {
      val fnPtr = _704503558_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__704503558_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class ILayerVisual2_Impl(
    ...
    public override val __704503558_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ILayerVisual2, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("9ab2e401af4554da9991dd31273155d2")
    ...
    public override fun toNative(obj: ILayerVisual2): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__704503558_Ptr))
  }
