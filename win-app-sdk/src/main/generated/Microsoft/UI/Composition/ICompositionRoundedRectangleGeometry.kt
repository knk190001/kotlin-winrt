...
@Signature("{02eafc87-8d1f-5445-a416-d81baee8a750}")
@Guid("02eafc878d1f5445a416d81baee8a750")
@WinRTInterface("02eafc878d1f5445a416d81baee8a750")
...
public interface ICompositionRoundedRectangleGeometry : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionRoundedRectangleGeometry {
    public val __896729317_Ptr: Pointer?

    public val _896729317_VtblPtr: Pointer?
      get() = __896729317_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_CornerRadius(): Vector2? {
      val fnPtr = _896729317_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Vector2>()
      val hr = fn.invokeHR(arrayOf(__896729317_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_CornerRadius(value: Vector2?): Unit {
      val fnPtr = _896729317_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__896729317_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Offset(): Vector2? {
      val fnPtr = _896729317_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Vector2>()
      val hr = fn.invokeHR(arrayOf(__896729317_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Offset(value: Vector2?): Unit {
      val fnPtr = _896729317_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__896729317_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Size(): Vector2? {
      val fnPtr = _896729317_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Vector2>()
      val hr = fn.invokeHR(arrayOf(__896729317_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Size(value: Vector2?): Unit {
      val fnPtr = _896729317_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__896729317_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class ICompositionRoundedRectangleGeometry_Impl(
    ...
    public override val __896729317_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionRoundedRectangleGeometry, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("02eafc878d1f5445a416d81baee8a750")
    ...
    public override fun toNative(obj: ICompositionRoundedRectangleGeometry): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__896729317_Ptr))
  }
