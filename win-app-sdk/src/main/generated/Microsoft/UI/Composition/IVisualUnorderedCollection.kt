...
@Signature("{4a97216e-793e-54e3-96e8-f9db790119cd}")
@Guid("4a97216e793e54e396e8f9db790119cd")
@WinRTInterface("4a97216e793e54e396e8f9db790119cd")
...
public interface IVisualUnorderedCollection : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IVisualUnorderedCollection {
    public val __1721123865_Ptr: Pointer?

    public val _1721123865_VtblPtr: Pointer?
      get() = __1721123865_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Count(): Int {
      val fnPtr = _1721123865_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__1721123865_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun Add(newVisual: Visual?): Unit {
      val fnPtr = _1721123865_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1721123865_Ptr, marshalToNative(newVisual),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun Remove(visual: Visual?): Unit {
      val fnPtr = _1721123865_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1721123865_Ptr, marshalToNative(visual),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun RemoveAll(): Unit {
      val fnPtr = _1721123865_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1721123865_Ptr, ))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IVisualUnorderedCollection_Impl(
    ...
    public override val __1721123865_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IVisualUnorderedCollection, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("4a97216e793e54e396e8f9db790119cd")
    ...
    public override fun toNative(obj: IVisualUnorderedCollection): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1721123865_Ptr))
  }
