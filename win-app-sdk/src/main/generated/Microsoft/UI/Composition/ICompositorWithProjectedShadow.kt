...
@Signature("{60ab2bf2-b95c-5944-8b36-c9773b9f5256}")
@Guid("60ab2bf2b95c59448b36c9773b9f5256")
@WinRTInterface("60ab2bf2b95c59448b36c9773b9f5256")
...
public interface ICompositorWithProjectedShadow : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositorWithProjectedShadow {
    public val __145472472_Ptr: Pointer?

    public val _145472472_VtblPtr: Pointer?
      get() = __145472472_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateProjectedShadowCaster(): CompositionProjectedShadowCaster? {
      val fnPtr = _145472472_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CompositionProjectedShadowCaster>()
      val hr = fn.invokeHR(arrayOf(__145472472_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun CreateProjectedShadow(): CompositionProjectedShadow? {
      val fnPtr = _145472472_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun CreateProjectedShadowReceiver(): CompositionProjectedShadowReceiver? {
      val fnPtr = _145472472_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class ICompositorWithProjectedShadow_Impl(
    ...
    public override val __145472472_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositorWithProjectedShadow, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("60ab2bf2b95c59448b36c9773b9f5256")
    ...
    public override fun toNative(obj: ICompositorWithProjectedShadow): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__145472472_Ptr))
  }
