...
@Signature("{492a7995-0c5c-5993-a283-52e4da3050ee}")
@Guid("492a79950c5c5993a28352e4da3050ee")
@WinRTInterface("492a79950c5c5993a28352e4da3050ee")
...
public interface IVisual2 : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IVisual2 {
    public val __521733447_Ptr: Pointer?

    public val _521733447_VtblPtr: Pointer?
      get() = __521733447_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_ParentForTransform(): Visual? {
      val fnPtr = _521733447_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Visual>()
      val hr = fn.invokeHR(arrayOf(__521733447_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_ParentForTransform(value: Visual?): Unit {
      val fnPtr = _521733447_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__521733447_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_RelativeOffsetAdjustment(): Vector3? {
      val fnPtr = _521733447_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_RelativeOffsetAdjustment(value: Vector3?): Unit {
      val fnPtr = _521733447_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__521733447_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_RelativeSizeAdjustment(): Vector2? {
      val fnPtr = _521733447_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_RelativeSizeAdjustment(value: Vector2?): Unit {
      val fnPtr = _521733447_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__521733447_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IVisual2_Impl(
    ...
    public override val __521733447_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IVisual2, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("492a79950c5c5993a28352e4da3050ee")
    ...
    public override fun toNative(obj: IVisual2): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__521733447_Ptr))
  }
