...
@Signature("{1c0c4b76-c4d6-5dd9-8dd6-dbe35c7b7e55}")
@Guid("1c0c4b76c4d65dd98dd6dbe35c7b7e55")
@WinRTInterface("1c0c4b76c4d65dd98dd6dbe35c7b7e55")
...
public interface IBounceScalarNaturalMotionAnimation : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IBounceScalarNaturalMotionAnimation {
    public val __302822546_Ptr: Pointer?

    public val _302822546_VtblPtr: Pointer?
      get() = __302822546_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Acceleration(): Float {
      val fnPtr = _302822546_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__302822546_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Acceleration(value: Float): Unit {
      val fnPtr = _302822546_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__302822546_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_Restitution(): Float {
      val fnPtr = _302822546_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__302822546_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Restitution(value: Float): Unit {
      val fnPtr = _302822546_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__302822546_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IBounceScalarNaturalMotionAnimation_Impl(
    ...
    public override val __302822546_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IBounceScalarNaturalMotionAnimation, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("1c0c4b76c4d65dd98dd6dbe35c7b7e55")
    ...
    public override fun toNative(obj: IBounceScalarNaturalMotionAnimation): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__302822546_Ptr))
  }
