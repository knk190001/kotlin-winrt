...
@Signature("{bc261502-2259-5c01-8616-556110a09657}")
@Guid("bc26150222595c018616556110a09657")
@WinRTInterface("bc26150222595c018616556110a09657")
...
public interface IRectangleClip : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IRectangleClip {
    public val __1834721818_Ptr: Pointer?

    public val _1834721818_VtblPtr: Pointer?
      get() = __1834721818_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Bottom(): Float {
      val fnPtr = _1834721818_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__1834721818_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Bottom(value: Float): Unit {
      val fnPtr = _1834721818_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1834721818_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_BottomLeftRadius(): Vector2? {
      val fnPtr = _1834721818_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_BottomLeftRadius(value: Vector2?): Unit {
      val fnPtr = _1834721818_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1834721818_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_BottomRightRadius(): Vector2? {
      val fnPtr = _1834721818_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Vector2>()
      val hr = fn.invokeHR(arrayOf(__1834721818_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_BottomRightRadius(value: Vector2?): Unit {
      val fnPtr = _1834721818_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1834721818_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Left(): Float {
      val fnPtr = _1834721818_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__1834721818_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Left(value: Float): Unit {
      val fnPtr = _1834721818_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1834721818_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Right(): Float {
      val fnPtr = _1834721818_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__1834721818_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Right(value: Float): Unit {
      val fnPtr = _1834721818_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1834721818_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Top(): Float {
      val fnPtr = _1834721818_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__1834721818_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_Top(value: Float): Unit {
      val fnPtr = _1834721818_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1834721818_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_TopLeftRadius(): Vector2? {
      val fnPtr = _1834721818_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Vector2>()
      val hr = fn.invokeHR(arrayOf(__1834721818_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_TopLeftRadius(value: Vector2?): Unit {
      val fnPtr = _1834721818_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1834721818_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_TopRightRadius(): Vector2? {
      val fnPtr = _1834721818_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Vector2>()
      val hr = fn.invokeHR(arrayOf(__1834721818_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_TopRightRadius(value: Vector2?): Unit {
      val fnPtr = _1834721818_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1834721818_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class IRectangleClip_Impl(
    ...
    public override val __1834721818_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IRectangleClip, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("bc26150222595c018616556110a09657")
    ...
    public override fun toNative(obj: IRectangleClip): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1834721818_Ptr))
  }
