...
@Signature("{3db6d621-3497-55e4-95bf-8ae5e7c34c33}")
@Guid("3db6d621349755e495bf8ae5e7c34c33")
@WinRTInterface("3db6d621349755e495bf8ae5e7c34c33")
...
public interface ICompositionPropertySet2 : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionPropertySet2 {
    public val __1664579050_Ptr: Pointer?

    public val _1664579050_VtblPtr: Pointer?
      get() = __1664579050_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun InsertBoolean(propertyName: String?, value: Boolean): Unit {
      val fnPtr = _1664579050_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1664579050_Ptr, marshalToNative(propertyName), value,))
      if (hr.toInt() != 0) {
    ...
    public override fun TryGetBoolean(propertyName: String?, value: Boolean):
      ...
      val fnPtr = _1664579050_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CompositionGetValueStatus>()
      val hr = fn.invokeHR(arrayOf(__1664579050_Ptr, marshalToNative(propertyName), value, result))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
  ...
  public class ICompositionPropertySet2_Impl(
    ...
    public override val __1664579050_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionPropertySet2, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("3db6d621349755e495bf8ae5e7c34c33")
    ...
    public override fun toNative(obj: ICompositionPropertySet2): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1664579050_Ptr))
  }
