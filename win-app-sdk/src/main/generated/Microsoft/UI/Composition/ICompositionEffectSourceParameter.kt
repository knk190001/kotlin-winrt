...
@Signature("{bece3367-5704-59f7-be8c-d6293af9c95f}")
@Guid("bece3367570459f7be8cd6293af9c95f")
@WinRTInterface("bece3367570459f7be8cd6293af9c95f")
...
public interface ICompositionEffectSourceParameter : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionEffectSourceParameter {
    public val __1153686668_Ptr: Pointer?

    public val _1153686668_VtblPtr: Pointer?
      get() = __1153686668_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Name(): String? {
      val fnPtr = _1153686668_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<String>()
      val hr = fn.invokeHR(arrayOf(__1153686668_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ICompositionEffectSourceParameter_Impl(
    ...
    public override val __1153686668_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionEffectSourceParameter, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("bece3367570459f7be8cd6293af9c95f")
    ...
    public override fun toNative(obj: ICompositionEffectSourceParameter): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1153686668_Ptr))
  }
