...
@Signature("{f726fb52-270c-58b1-a902-89576772dedc}")
@Guid("f726fb52270c58b1a90289576772dedc")
@WinRTInterface("f726fb52270c58b1a90289576772dedc")
...
public interface ICompositionLinearGradientBrush : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionLinearGradientBrush {
    public val __1651334380_Ptr: Pointer?

    public val _1651334380_VtblPtr: Pointer?
      get() = __1651334380_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_EndPoint(): Vector2? {
      val fnPtr = _1651334380_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Vector2>()
      val hr = fn.invokeHR(arrayOf(__1651334380_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_EndPoint(value: Vector2?): Unit {
      val fnPtr = _1651334380_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1651334380_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_StartPoint(): Vector2? {
      val fnPtr = _1651334380_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Vector2>()
      val hr = fn.invokeHR(arrayOf(__1651334380_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_StartPoint(value: Vector2?): Unit {
      val fnPtr = _1651334380_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__1651334380_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class ICompositionLinearGradientBrush_Impl(
    ...
    public override val __1651334380_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionLinearGradientBrush, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("f726fb52270c58b1a90289576772dedc")
    ...
    public override fun toNative(obj: ICompositionLinearGradientBrush): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1651334380_Ptr))
  }
