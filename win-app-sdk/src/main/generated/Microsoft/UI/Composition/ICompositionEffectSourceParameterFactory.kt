...
@Signature("{26185954-4489-5d0e-ae4d-7bc4bbbc6161}")
@Guid("2618595444895d0eae4d7bc4bbbc6161")
@WinRTInterface("2618595444895d0eae4d7bc4bbbc6161")
...
public interface ICompositionEffectSourceParameterFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionEffectSourceParameterFactory {
    public val __575342882_Ptr: Pointer?

    public val _575342882_VtblPtr: Pointer?
      get() = __575342882_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun Create(name: String?): CompositionEffectSourceParameter? {
      val fnPtr = _575342882_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CompositionEffectSourceParameter>()
      val hr = fn.invokeHR(arrayOf(__575342882_Ptr, marshalToNative(name), result))
      if (hr.toInt() != 0) {
  ...
  public class ICompositionEffectSourceParameterFactory_Impl(
    ...
    public override val __575342882_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionEffectSourceParameterFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("2618595444895d0eae4d7bc4bbbc6161")
    ...
    public override fun toNative(obj: ICompositionEffectSourceParameterFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__575342882_Ptr))
  }
