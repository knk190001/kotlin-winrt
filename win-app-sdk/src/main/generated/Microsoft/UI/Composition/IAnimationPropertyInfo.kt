...
@Signature("{3d721a2b-9ccd-57bd-b6c2-ce9e04ae3606}")
@Guid("3d721a2b9ccd57bdb6c2ce9e04ae3606")
@WinRTInterface("3d721a2b9ccd57bdb6c2ce9e04ae3606")
...
public interface IAnimationPropertyInfo : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IAnimationPropertyInfo {
    public val __2022211406_Ptr: Pointer?

    public val _2022211406_VtblPtr: Pointer?
      get() = __2022211406_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_AccessMode(): AnimationPropertyAccessMode? {
      val fnPtr = _2022211406_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AnimationPropertyAccessMode>()
      val hr = fn.invokeHR(arrayOf(__2022211406_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_AccessMode(value: AnimationPropertyAccessMode?): Unit {
      val fnPtr = _2022211406_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__2022211406_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
  ...
  public class IAnimationPropertyInfo_Impl(
    ...
    public override val __2022211406_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IAnimationPropertyInfo, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("3d721a2b9ccd57bdb6c2ce9e04ae3606")
    ...
    public override fun toNative(obj: IAnimationPropertyInfo): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__2022211406_Ptr))
  }
