...
@Signature("{029ad57c-5497-51f3-8b40-e4e235992c6f}")
@Guid("029ad57c549751f38b40e4e235992c6f")
@WinRTInterface("029ad57c549751f38b40e4e235992c6f")
...
public interface ICompositionObject4 : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionObject4 {
    public val __503796644_Ptr: Pointer?

    public val _503796644_VtblPtr: Pointer?
      get() = __503796644_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun TryGetAnimationController(propertyName: String?): AnimationController? {
      val fnPtr = _503796644_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<AnimationController>()
      val hr = fn.invokeHR(arrayOf(__503796644_Ptr, marshalToNative(propertyName), result))
      if (hr.toInt() != 0) {
  ...
  public class ICompositionObject4_Impl(
    ...
    public override val __503796644_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionObject4, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("029ad57c549751f38b40e4e235992c6f")
    ...
    public override fun toNative(obj: ICompositionObject4): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__503796644_Ptr))
  }
