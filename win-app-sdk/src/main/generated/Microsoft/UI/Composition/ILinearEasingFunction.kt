...
@Signature("{79bfeef6-70c7-50a6-bb3a-0e9636148695}")
@Guid("79bfeef670c750a6bb3a0e9636148695")
@WinRTInterface("79bfeef670c750a6bb3a0e9636148695")
...
public interface ILinearEasingFunction : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ILinearEasingFunction {
    public val __514330047_Ptr: Pointer?

    public val _514330047_VtblPtr: Pointer?
      get() = __514330047_Ptr?.getPointer(0)
  }

  public class ILinearEasingFunction_Impl(
    ptr: Pointer? = NULL
  ) : PointerType(ptr), WithDefault, NativeMapped, IWinRTInterface {
    public override val __514330047_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ILinearEasingFunction, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("79bfeef670c750a6bb3a0e9636148695")
    ...
    public override fun toNative(obj: ILinearEasingFunction): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__514330047_Ptr))
  }
