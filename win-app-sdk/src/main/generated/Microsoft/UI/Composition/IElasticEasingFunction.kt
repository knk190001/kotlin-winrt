...
@Signature("{b952e12f-4a50-51a9-a11a-23855f4aae07}")
@Guid("b952e12f4a5051a9a11a23855f4aae07")
@WinRTInterface("b952e12f4a5051a9a11a23855f4aae07")
...
public interface IElasticEasingFunction : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IElasticEasingFunction {
    public val __1266314785_Ptr: Pointer?

    public val _1266314785_VtblPtr: Pointer?
      get() = __1266314785_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_Mode(): CompositionEasingFunctionMode? {
      val fnPtr = _1266314785_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CompositionEasingFunctionMode>()
      val hr = fn.invokeHR(arrayOf(__1266314785_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Oscillations(): Int {
      val fnPtr = _1266314785_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_Springiness(): Float {
      val fnPtr = _1266314785_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class IElasticEasingFunction_Impl(
    ...
    public override val __1266314785_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IElasticEasingFunction, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("b952e12f4a5051a9a11a23855f4aae07")
    ...
    public override fun toNative(obj: IElasticEasingFunction): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1266314785_Ptr))
  }
