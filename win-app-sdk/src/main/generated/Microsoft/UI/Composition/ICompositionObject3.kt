...
@Signature("{d43c5cf1-47df-52b8-b409-d5831503905e}")
@Guid("d43c5cf147df52b8b409d5831503905e")
@WinRTInterface("d43c5cf147df52b8b409d5831503905e")
...
public interface ICompositionObject3 : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionObject3 {
    public val __503796643_Ptr: Pointer?

    public val _503796643_VtblPtr: Pointer?
      get() = __503796643_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_DispatcherQueue(): DispatcherQueue? {
      val fnPtr = _503796643_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DispatcherQueue>()
      val hr = fn.invokeHR(arrayOf(__503796643_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ICompositionObject3_Impl(
    ...
    public override val __503796643_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionObject3, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("d43c5cf147df52b8b409d5831503905e")
    ...
    public override fun toNative(obj: ICompositionObject3): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__503796643_Ptr))
  }
