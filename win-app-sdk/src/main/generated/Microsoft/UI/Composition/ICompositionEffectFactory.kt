...
@Signature("{c50f407a-0231-5ed2-b7a7-ca66d3e14b3b}")
@Guid("c50f407a02315ed2b7a7ca66d3e14b3b")
@WinRTInterface("c50f407a02315ed2b7a7ca66d3e14b3b")
...
public interface ICompositionEffectFactory : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionEffectFactory {
    public val __1561308728_Ptr: Pointer?

    public val _1561308728_VtblPtr: Pointer?
      get() = __1561308728_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun CreateBrush(): CompositionEffectBrush? {
      val fnPtr = _1561308728_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<CompositionEffectBrush>()
      val hr = fn.invokeHR(arrayOf(__1561308728_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ExtendedError(): HResult? {
      val fnPtr = _1561308728_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_LoadStatus(): CompositionEffectFactoryLoadStatus? {
      val fnPtr = _1561308728_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class ICompositionEffectFactory_Impl(
    ...
    public override val __1561308728_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionEffectFactory, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("c50f407a02315ed2b7a7ca66d3e14b3b")
    ...
    public override fun toNative(obj: ICompositionEffectFactory): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1561308728_Ptr))
  }
