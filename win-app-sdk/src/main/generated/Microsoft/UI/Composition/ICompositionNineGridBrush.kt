...
@Signature("{c77a3d21-c7ee-517a-98f4-ad9a7202bc86}")
@Guid("c77a3d21c7ee517a98f4ad9a7202bc86")
@WinRTInterface("c77a3d21c7ee517a98f4ad9a7202bc86")
...
public interface ICompositionNineGridBrush : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionNineGridBrush {
    public val __78750063_Ptr: Pointer?

    public val _78750063_VtblPtr: Pointer?
      get() = __78750063_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_BottomInset(): Float {
      val fnPtr = _78750063_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__78750063_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_BottomInset(value: Float): Unit {
      val fnPtr = _78750063_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__78750063_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_BottomInsetScale(): Float {
      val fnPtr = _78750063_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__78750063_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_BottomInsetScale(value: Float): Unit {
      val fnPtr = _78750063_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__78750063_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_IsCenterHollow(): Boolean {
      val fnPtr = _78750063_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_IsCenterHollow(value: Boolean): Unit {
      val fnPtr = _78750063_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__78750063_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_LeftInset(): Float {
      val fnPtr = _78750063_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__78750063_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_LeftInset(value: Float): Unit {
      val fnPtr = _78750063_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__78750063_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_LeftInsetScale(): Float {
      val fnPtr = _78750063_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__78750063_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_LeftInsetScale(value: Float): Unit {
      val fnPtr = _78750063_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__78750063_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_RightInset(): Float {
      val fnPtr = _78750063_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__78750063_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_RightInset(value: Float): Unit {
      val fnPtr = _78750063_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__78750063_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_RightInsetScale(): Float {
      val fnPtr = _78750063_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__78750063_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_RightInsetScale(value: Float): Unit {
      val fnPtr = _78750063_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__78750063_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_Source(): CompositionBrush? {
      val fnPtr = _78750063_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun put_Source(value: CompositionBrush?): Unit {
      val fnPtr = _78750063_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__78750063_Ptr, marshalToNative(value),))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun get_TopInset(): Float {
      val fnPtr = _78750063_VtblPtr!!.getPointer(22L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__78750063_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_TopInset(value: Float): Unit {
      val fnPtr = _78750063_VtblPtr!!.getPointer(23L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__78750063_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun get_TopInsetScale(): Float {
      val fnPtr = _78750063_VtblPtr!!.getPointer(24L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Float>()
      val hr = fn.invokeHR(arrayOf(__78750063_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun put_TopInsetScale(value: Float): Unit {
      val fnPtr = _78750063_VtblPtr!!.getPointer(25L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__78750063_Ptr, value,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
    ...
    public override fun SetInsets(inset: Float): Unit {
      val fnPtr = _78750063_VtblPtr!!.getPointer(26L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__78750063_Ptr, inset,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun SetInsets(
      ...
      val fnPtr = _78750063_VtblPtr!!.getPointer(27L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__78750063_Ptr, left, top, right, bottom,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun SetInsetScales(scale: Float): Unit {
      val fnPtr = _78750063_VtblPtr!!.getPointer(28L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__78750063_Ptr, scale,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
      }
    }
    ...
    public override fun SetInsetScales(
      ...
      val fnPtr = _78750063_VtblPtr!!.getPointer(29L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val hr = fn.invokeHR(arrayOf(__78750063_Ptr, left, top, right, bottom,))
      if (hr.toInt() != 0) {
        throw RuntimeException(hr.toString())
  ...
  public class ICompositionNineGridBrush_Impl(
    ...
    public override val __78750063_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionNineGridBrush, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("c77a3d21c7ee517a98f4ad9a7202bc86")
    ...
    public override fun toNative(obj: ICompositionNineGridBrush): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__78750063_Ptr))
  }
