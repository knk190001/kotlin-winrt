...
@Signature("{216cab97-a2ee-5a29-ad6b-0bc2df4a1504}")
@Guid("216cab97a2ee5a29ad6b0bc2df4a1504")
@WinRTInterface("216cab97a2ee5a29ad6b0bc2df4a1504")
...
public interface ICompositionDrawingSurface : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : ICompositionDrawingSurface {
    public val __924912896_Ptr: Pointer?

    public val _924912896_VtblPtr: Pointer?
      get() = __924912896_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_AlphaMode(): DirectXAlphaMode? {
      val fnPtr = _924912896_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DirectXAlphaMode>()
      val hr = fn.invokeHR(arrayOf(__924912896_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_PixelFormat(): DirectXPixelFormat? {
      val fnPtr = _924912896_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
    ...
    public override fun get_Size(): Size? {
      val fnPtr = _924912896_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
  ...
  public class ICompositionDrawingSurface_Impl(
    ...
    public override val __924912896_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionDrawingSurface, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("216cab97a2ee5a29ad6b0bc2df4a1504")
    ...
    public override fun toNative(obj: ICompositionDrawingSurface): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__924912896_Ptr))
  }
