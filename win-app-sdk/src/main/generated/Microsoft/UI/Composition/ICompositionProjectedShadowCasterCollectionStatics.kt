...
@Signature("{43a98014-b88b-5b2a-b1e2-5e776ab77538}")
@Guid("43a98014b88b5b2ab1e25e776ab77538")
@WinRTInterface("43a98014b88b5b2ab1e25e776ab77538")
...
public interface ICompositionProjectedShadowCasterCollectionStatics : NativeMapped, IWinRTInterface
  ...
  public interface WithDefault : ICompositionProjectedShadowCasterCollectionStatics {
    public val __573815820_Ptr: Pointer?

    public val _573815820_VtblPtr: Pointer?
      get() = __573815820_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_MaxRespectedCasters(): Int {
      val fnPtr = _573815820_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Int>()
      val hr = fn.invokeHR(arrayOf(__573815820_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class ICompositionProjectedShadowCasterCollectionStatics_Impl(
    ...
    public override val __573815820_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<ICompositionProjectedShadowCasterCollectionStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("43a98014b88b5b2ab1e25e776ab77538")
