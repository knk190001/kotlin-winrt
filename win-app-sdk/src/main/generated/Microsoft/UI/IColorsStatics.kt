...
@Signature("{8620a5b0-015a-57ac-a3f3-895d0b1269ae}")
@Guid("8620a5b0015a57aca3f3895d0b1269ae")
@WinRTInterface("8620a5b0015a57aca3f3895d0b1269ae")
...
public interface IColorsStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IColorsStatics {
    public val __1105726240_Ptr: Pointer?

    public val _1105726240_VtblPtr: Pointer?
      get() = __1105726240_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun get_AliceBlue(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_AntiqueWhite(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(7L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Aqua(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(8L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Aquamarine(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(9L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Azure(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(10L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Beige(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(11L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Bisque(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(12L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Black(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(13L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_BlanchedAlmond(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(14L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Blue(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(15L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_BlueViolet(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(16L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Brown(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(17L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_BurlyWood(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(18L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_CadetBlue(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(19L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Chartreuse(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(20L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Chocolate(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(21L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Coral(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(22L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_CornflowerBlue(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(23L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Cornsilk(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(24L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Crimson(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(25L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Cyan(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(26L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_DarkBlue(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(27L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_DarkCyan(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(28L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_DarkGoldenrod(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(29L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_DarkGray(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(30L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_DarkGreen(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(31L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_DarkKhaki(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(32L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_DarkMagenta(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(33L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_DarkOliveGreen(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(34L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_DarkOrange(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(35L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_DarkOrchid(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(36L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_DarkRed(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(37L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_DarkSalmon(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(38L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_DarkSeaGreen(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(39L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_DarkSlateBlue(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(40L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_DarkSlateGray(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(41L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_DarkTurquoise(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(42L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_DarkViolet(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(43L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_DeepPink(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(44L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_DeepSkyBlue(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(45L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_DimGray(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(46L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_DodgerBlue(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(47L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Firebrick(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(48L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_FloralWhite(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(49L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_ForestGreen(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(50L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Fuchsia(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(51L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Gainsboro(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(52L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_GhostWhite(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(53L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Gold(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(54L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Goldenrod(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(55L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Gray(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(56L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Green(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(57L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_GreenYellow(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(58L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Honeydew(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(59L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_HotPink(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(60L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_IndianRed(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(61L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Indigo(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(62L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Ivory(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(63L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Khaki(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(64L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Lavender(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(65L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_LavenderBlush(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(66L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_LawnGreen(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(67L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_LemonChiffon(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(68L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_LightBlue(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(69L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_LightCoral(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(70L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_LightCyan(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(71L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_LightGoldenrodYellow(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(72L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_LightGreen(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(73L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_LightGray(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(74L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_LightPink(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(75L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_LightSalmon(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(76L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_LightSeaGreen(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(77L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_LightSkyBlue(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(78L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_LightSlateGray(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(79L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_LightSteelBlue(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(80L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_LightYellow(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(81L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Lime(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(82L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_LimeGreen(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(83L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Linen(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(84L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Magenta(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(85L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Maroon(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(86L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_MediumAquamarine(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(87L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_MediumBlue(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(88L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_MediumOrchid(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(89L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_MediumPurple(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(90L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_MediumSeaGreen(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(91L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_MediumSlateBlue(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(92L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_MediumSpringGreen(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(93L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_MediumTurquoise(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(94L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_MediumVioletRed(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(95L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_MidnightBlue(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(96L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_MintCream(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(97L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_MistyRose(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(98L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Moccasin(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(99L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_NavajoWhite(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(100L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Navy(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(101L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_OldLace(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(102L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Olive(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(103L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_OliveDrab(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(104L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Orange(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(105L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_OrangeRed(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(106L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Orchid(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(107L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_PaleGoldenrod(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(108L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_PaleGreen(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(109L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_PaleTurquoise(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(110L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_PaleVioletRed(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(111L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_PapayaWhip(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(112L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_PeachPuff(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(113L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Peru(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(114L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Pink(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(115L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Plum(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(116L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_PowderBlue(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(117L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Purple(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(118L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Red(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(119L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_RosyBrown(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(120L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_RoyalBlue(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(121L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_SaddleBrown(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(122L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Salmon(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(123L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_SandyBrown(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(124L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_SeaGreen(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(125L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_SeaShell(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(126L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Sienna(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(127L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Silver(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(128L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_SkyBlue(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(129L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_SlateBlue(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(130L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_SlateGray(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(131L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Snow(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(132L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_SpringGreen(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(133L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_SteelBlue(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(134L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Tan(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(135L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Teal(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(136L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Thistle(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(137L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Tomato(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(138L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Transparent(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(139L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Turquoise(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(140L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Violet(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(141L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Wheat(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(142L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_White(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(143L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_WhiteSmoke(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(144L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_Yellow(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(145L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
    ...
    public override fun get_YellowGreen(): Color? {
      val fnPtr = _1105726240_VtblPtr!!.getPointer(146L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<Color>()
      val hr = fn.invokeHR(arrayOf(__1105726240_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IColorsStatics_Impl(
    ...
    public override val __1105726240_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IColorsStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("8620a5b0015a57aca3f3895d0b1269ae")
    ...
    public override fun toNative(obj: IColorsStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1105726240_Ptr))
  }
