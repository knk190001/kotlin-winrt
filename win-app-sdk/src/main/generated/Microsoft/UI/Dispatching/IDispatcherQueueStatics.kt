...
@Signature("{cd3382ea-a455-5124-b63a-ca40d34ca23c}")
@Guid("cd3382eaa4555124b63aca40d34ca23c")
@WinRTInterface("cd3382eaa4555124b63aca40d34ca23c")
...
public interface IDispatcherQueueStatics : NativeMapped, IWinRTInterface {
  ...
  public interface WithDefault : IDispatcherQueueStatics {
    public val __1678047190_Ptr: Pointer?

    public val _1678047190_VtblPtr: Pointer?
      get() = __1678047190_Ptr?.getPointer(0)

    @InterfaceMethod(0)
    public override fun GetForCurrentThread(): DispatcherQueue? {
      val fnPtr = _1678047190_VtblPtr!!.getPointer(6L * POINTER_SIZE)
      val fn = Function.getFunction(fnPtr, ALT_CONVENTION)
      val result = makeByReferenceType<DispatcherQueue>()
      val hr = fn.invokeHR(arrayOf(__1678047190_Ptr,  result))
      if (hr.toInt() != 0) {
  ...
  public class IDispatcherQueueStatics_Impl(
    ...
    public override val __1678047190_Ptr: Pointer?
      get() = pointer
  }

  public object ABI : IABI<IDispatcherQueueStatics, MemoryAddress> {
    public val IID: com.sun.jna.platform.win32.Guid.IID =
        com.sun.jna.platform.win32.Guid.IID("cd3382eaa4555124b63aca40d34ca23c")
    ...
    public override fun toNative(obj: IDispatcherQueueStatics): MemoryAddress =
        MemoryAddress.ofLong(Pointer.nativeValue((obj as WithDefault).__1678047190_Ptr))
  }
